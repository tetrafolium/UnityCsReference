...
namespace Unity.CecilTools.Extensions {
  public static class TypeReferenceExtensions {
    ...
    public static bool IsAssignableTo(this TypeReference typeRef,
                                      string typeName) {
      try {
      ...
      } catch (AssemblyResolutionException) // If we can't resolve our typeref
    ...
    public static bool IsEnum(this TypeReference type) {
      return type.IsValueType && !type.IsPrimitive &&
             type.CheckedResolve().IsEnum;
    }

    public static bool IsStruct(this TypeReference type) {
      return type.IsValueType && !type.IsPrimitive && !type.IsEnum() &&
             !IsSystemDecimal(type);
    }
