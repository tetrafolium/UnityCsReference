...
public override void Update() {
	Debug.Assert(m_State == State.TrackingAddOrMove ||
...
private void ProcessNewChange(VisualElement ve) {
	...
	if (m_CurrentChangeParent == null && ve.panel != null) {
		...
		m_State = m_CurrentChangeParent == null ? State.TrackingRemove
	    : State.TrackingAddOrMove;
	}
}
