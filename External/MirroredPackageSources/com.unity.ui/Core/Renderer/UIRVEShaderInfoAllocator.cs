...
internal struct BitmapAllocator32
{
    ...
    public void ForceFirstAlloc(ushort firstPageX, ushort firstPageY)
    {
        ...
        m_Pages.Add(new Page() {
            x = firstPageX, y = firstPageY, freeSlots = kPageWidth * m_PageHeight - 1
        });
    }
    ...
    internal void GetAllocPageAtlasLocation(int page, out UInt16 x, out UInt16 y) {
        var p = m_Pages[page];
        x = p.x;
        y = p.y;
    }
...
internal struct UIRVEShaderInfoAllocator
{
    ...
    static int pageWidth {
        get {
            return BitmapAllocator32.kPageWidth;
        }
    }
...
#pragma warning restore 649
    ...
    public bool isReleased {
        get {
            return m_AtlasReallyCreated && m_Atlas?.IsReleased() == true;
        }
    }
