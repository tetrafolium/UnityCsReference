...
namespace UnityEngine.UIElements {
  internal class ClampedDragger<T> : PointerClickable where T : IComparable<T> {
    ...
    public enum DragDirection {
      ...
      Free = 1 << 2 // i.e. user is dragging using the drag element, free of any
    ...
    public ClampedDragger(BaseSlider<T> slider, System.Action clickHandler,
                          System.Action dragHandler)
        : base(clickHandler, ScrollWaitDefinitions.firstWait,
    ...
    protected override void ProcessMoveEvent(EventBase evt,
