...
namespace UnityEngine.UIElements {
    ...
    internal static void RegisterMakeClientFunc(Func<IDragAndDrop> makeClient) {
      if (s_MakeClientFunc != null)
        throw new UnityException(
            $"The MakeClientFunc has already been registered. Registration denied.");
  ...
  internal class DefaultDragAndDropClient : IDragAndDrop, IDragAndDropData {
    ...
    public IEnumerable<Object> unityObjectReferences =>
        m_StartDragArgs?.unityObjectReferences;
    ...
    public object GetGenericData(string key) {
      ...
      return m_StartDragArgs.genericData.ContainsKey(key)
                 ? m_StartDragArgs.genericData[key]
                 : null;
    }
  }
}
