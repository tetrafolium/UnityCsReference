...
namespace UnityEngine.UIElements {
  ...
  /// </summary>
  /// <remarks>
  /// To use this element, create a new element inheriting from this type and
  /// override the ImmediateRepaint method.
  /// </remarks>
  public abstract class ImmediateModeElement : VisualElement {
    ...
    /// <summary>
    /// When this property is set to true, the Element does not repaint itself
    ...
    /// </summary>
    /// <remarks>
    /// Here it is safe to use any rendering calls using the immediate Graphics
    /// api, eg: Graphics.DrawTexture(contentRect, image); Graphics.DrawMesh,
    /// etc The current transform matrix is set up so (0,0) correspond to the
    /// top-left corner of the element. For IMGUI usage, please use the <see
    /// cref="IMGUIContainer"/> element.
    /// </remarks>
