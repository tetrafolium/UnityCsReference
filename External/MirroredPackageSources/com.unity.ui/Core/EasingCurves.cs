namespace UnityEngine.UIElements.Experimental {
  ...
  public static class Easing {
    ...
    public static float Step(float t) { return t < 0.5f ? 0 : 1; }
    ...
    public static float OutSine(float t) { return Mathf.Sin(t * HalfPi); }
    ...
    public static float OutQuad(float t) { return t * (2 - t); }
    ...
    public static float InCubic(float t) { return InPower(t, 3); }

    public static float OutCubic(float t) { return OutPower(t, 3); }

    public static float InOutCubic(float t) { return InOutPower(t, 3); }
    ...
    public static float OutBack(float t) { return 1 - (InBack(1 - t)); }
