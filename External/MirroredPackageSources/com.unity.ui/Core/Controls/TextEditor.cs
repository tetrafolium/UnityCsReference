namespace UnityEngine.UIElements {
  internal class TextEditorEventHandler {
    ...
    protected TextEditorEventHandler(TextEditorEngine editorEngine,
    ...
    public virtual void ExecuteDefaultAction(EventBase evt) {
      if (evt.eventTypeId == FocusEvent.TypeId()) {
        ...
        // Make sure to select all text, OnFocus() does not call SelectAll for
        // multiline text field. However, in IMGUI it will be call later by the
        // OnMouseUp event.
