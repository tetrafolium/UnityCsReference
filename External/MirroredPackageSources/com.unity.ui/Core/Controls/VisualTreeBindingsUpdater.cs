...
namespace UnityEngine.UIElements {
  internal class VisualTreeBindingsUpdater
      : BaseVisualTreeHierarchyTrackerUpdater {
    ...
    static ProfilerMarker s_MarkerUpdate =
        new ProfilerMarker("Bindings.Update");
    static ProfilerMarker s_MarkerPoll =
        new ProfilerMarker("Bindings.PollElementsWithBindings");
    ...
    public override void OnVersionChanged(VisualElement ve,
      ...
      if ((versionChangeType & VersionChangeType.Bindings) ==
    ...
    protected override void OnHierarchyChange(VisualElement ve,
    ...
    private static long CurrentTime() { return Panel.TimeSinceStartupMs(); }
    ...
    internal void
    PollElementsWithBindings(Action<VisualElement, IBinding> callback) {
      s_MarkerPoll.Begin();
