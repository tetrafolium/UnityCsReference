namespace UnityEngine.UIElements {
  ...
  public class Foldout : BindableElement, INotifyValueChanged<bool> {
    ...
    /// <summary>
    /// Instantiates a <see cref="Foldout"/> using the data read from a UXML
    /// file.
    /// </summary>
    ...
    public new class UxmlTraits : BindableElement.UxmlTraits {
      ...
      UxmlBoolAttributeDescription m_Value =
          new UxmlBoolAttributeDescription{name = "value", defaultValue = true};
    ...
    /// <summary>
    /// Contains the collapse state. True if the Foldout is open and the
    /// contents are visible. False if it's collapsed.
    /// </summary>
    public bool value {
      get { return m_Value; }
      set {
        ...
        using(ChangeEvent<bool> evt =
                  ChangeEvent<bool>.GetPooled(m_Value, value)) {
          evt.target = this;
