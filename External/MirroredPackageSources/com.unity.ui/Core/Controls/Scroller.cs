...
namespace UnityEngine.UIElements {
  ...
  public class Scroller : VisualElement {
    /// <summary>
    /// Instantiates a <see cref="Scroller"/> using the data read from a UXML
    /// file.
    /// </summary>
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits {
      UxmlFloatAttributeDescription m_LowValue =
          new UxmlFloatAttributeDescription{name = "low-value",
                                            obsoleteNames = new[]{"lowValue"}};
      UxmlFloatAttributeDescription m_HighValue =
          new UxmlFloatAttributeDescription{name = "high-value",
                                            obsoleteNames = new[]{"highValue"}};
      UxmlEnumAttributeDescription<SliderDirection> m_Direction =
          new UxmlEnumAttributeDescription<SliderDirection>{
              name = "direction", defaultValue = SliderDirection.Vertical};
      UxmlFloatAttributeDescription m_Value =
          new UxmlFloatAttributeDescription{name = "value"};
      ...
      /// <summary>
      /// Initialize <see cref="Scroller"/> properties using values from the
      /// attribute bag.
      /// </summary>
    ...
    /// <summary>
    /// Value that defines the slider position. It lies between <see
    /// cref="lowValue"/> and <see cref="highValue"/>.
    /// </summary>
    public float value {
    ...
    public SliderDirection direction {
      get {
        return resolvedStyle.flexDirection ==
               FlexDirection.Row ? SliderDirection.Horizontal
    ...
    public Scroller(float lowValue, float highValue,
      ...
      lowButton = new RepeatButton(
          ScrollPageUp, ScrollWaitDefinitions.firstWait,
          ScrollWaitDefinitions.regularWait){name = "unity-low-button"};
      lowButton.AddToClassList(lowButtonUssClassName);
      Add(lowButton);
      highButton = new RepeatButton(
          ScrollPageDown, ScrollWaitDefinitions.firstWait,
          ScrollWaitDefinitions.regularWait){name = "unity-high-button"};
    ...
    /// <summary>
    /// Updates the slider element size as a ratio of total range. A value
    /// greater than 1 will disable the Scroller.
    /// </summary>
    ...
    /// </summary>
    public void ScrollPageUp() { ScrollPageUp(1.0f); }

    /// <summary>
    /// Will change the value according to the current slider pageSize.
    /// </summary>
    public void ScrollPageDown() { ScrollPageDown(1.0f); }
    ...
    public void ScrollPageUp(float factor) {
      value -=
          factor * (slider.pageSize * (slider.lowValue < slider.highValue ? 1f
                                       : -1f));
    }
