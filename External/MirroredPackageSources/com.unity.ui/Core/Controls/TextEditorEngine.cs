namespace UnityEngine.UIElements {
  internal class TextEditorEngine : TextEditor {
    ...
    public TextEditorEngine(OnDetectFocusChangeFunction detectFocusChange,
                            OnIndexChangeFunction indexChangeFunction) {
    ...
    internal override void OnCursorIndexChange() { m_IndexChangeFunction(); }

    internal override void OnSelectIndexChange() { m_IndexChangeFunction(); }
  }
}
