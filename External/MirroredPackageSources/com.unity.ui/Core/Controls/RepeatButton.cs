...
namespace UnityEngine.UIElements {
  ...
  public class RepeatButton : TextElement {
    /// <summary>
    /// Instantiates a <see cref="RepeatButton"/> using the data read from a
    /// UXML file.
    /// </summary>
    ...
    public new class UxmlTraits : TextElement.UxmlTraits {
      UxmlLongAttributeDescription m_Delay =
          new UxmlLongAttributeDescription{name = "delay"};
      UxmlLongAttributeDescription m_Interval =
          new UxmlLongAttributeDescription{name = "interval"};

      /// <summary>
      /// Initialize <see cref="RepeatButton"/> properties using values from the
      /// attribute bag.
      /// </summary>
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        repeatButton.SetAction(null, m_Delay.GetValueFromBag(bag, cc),
                               m_Interval.GetValueFromBag(bag, cc));
      }
    }
    ...
    /// Constructor.
    /// </summary>
    public RepeatButton() { AddToClassList(ussClassName); }

    /// <summary>
    /// Constructor.
    /// </summary>
    /// <param name="clickEvent">The action to execute when the button is
    /// pressed.</param> <param name="delay">The initial delay before the action
    /// is executed for the first time.</param> <param name="interval">The
    /// interval between each execution of the action.</param>
    ...
    /// <param name="delay">The initial delay before the action is executed for
    /// the first time.</param> <param name="interval">The interval between each
    /// execution of the action.</param>
