...
/// <summary>
/// Instantiates a <see cref="Button"/> using the data read from a UXML
/// file.
/// </summary>
...
/// </summary>
[Obsolete(
	 "onClick is obsolete. Use clicked instead (UnityUpgradable) -> clicked",
	 true)]
...
/// Constructs a Button.
/// </summary>
/// <param name="clickEvent">Action triggered when the button is
/// clicked.</param>
