...
// TODO 2020.1 [Obsolete("Use PointerCaptureHelper.GetCapturingElement()
// instead.")]
/// <summary>
/// Checks if there is a handler capturing the mouse.
/// </summary>
/// <returns>True if a handler is capturing the mouse, false
/// otherwise.</returns>
public static bool IsMouseCaptured() {
	return EventDispatcher.editorDispatcher.pointerState.GetCapturingElement(
		PointerId.mousePointerId) != null;
}
...
/// </summary>
/// <param name="handler">The event handler that captures mouse
/// events.</param> <remarks> If an event handler is already set to capture
/// mouse events, the event handler is replaced with the handler specified
/// by this method.
/// </remarks>
...
/// </summary>
/// <param name="handler">The event handler to stop capturing the mouse. If
/// this handler is not assigned to capturing the mouse, nothing
/// happens.</param>
...
// TODO 2020.1 [Obsolete("Use PointerCaptureHelper.ReleasePointer()
// instead.")]
/// <summary>
/// Stops an event handler from capturing the mouse.
/// </summary>
