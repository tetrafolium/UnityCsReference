...
public struct StyleValues {
	...
	/// </summary>
	public float top {
		get { return Values().GetStyleFloat(StylePropertyId.Top).value; }
		set { SetValue(StylePropertyId.Top, value); }
	}
	/// <summary>
	/// Left distance from the element's box during layout.
	/// </summary>
	public float left {
		get { return Values().GetStyleFloat(StylePropertyId.Left).value; }
		set { SetValue(StylePropertyId.Left, value); }
	}
	/// <summary>
	/// Fixed width of an element for the layout.
	/// </summary>
	public float width {
		get { return Values().GetStyleFloat(StylePropertyId.Width).value; }
		set { SetValue(StylePropertyId.Width, value); }
	}
	/// <summary>
	/// Fixed height of an element for the layout.
	/// </summary>
	public float height {
		get { return Values().GetStyleFloat(StylePropertyId.Height).value; }
		set { SetValue(StylePropertyId.Height, value); }
	}
	/// <summary>
	/// Right distance from the element's box during layout.
	/// </summary>
	public float right {
		get { return Values().GetStyleFloat(StylePropertyId.Right).value; }
		set { SetValue(StylePropertyId.Right, value); }
	}
	/// <summary>
	/// Bottom distance from the element's box during layout.
	/// </summary>
	public float bottom {
		get { return Values().GetStyleFloat(StylePropertyId.Bottom).value; }
		set { SetValue(StylePropertyId.Bottom, value); }
	}
	/// <summary>
	/// Color to use when drawing the text of an element.
	/// </summary>
	public Color color {
		get { return Values().GetStyleColor(StylePropertyId.Color).value; }
		set { SetValue(StylePropertyId.Color, value); }
	}
	/// <summary>
	...
	public Color backgroundColor {
		...
		set { SetValue(StylePropertyId.BackgroundColor, value); }
	}
	/// <summary>
	...
	public Color unityBackgroundImageTintColor {
		get {
			return Values()
			       .GetStyleColor(StylePropertyId.UnityBackgroundImageTintColor)
			       .value;
		}
		set { SetValue(StylePropertyId.UnityBackgroundImageTintColor, value); }
	}
	/// <summary>
	/// Color of the border to paint inside the element's box.
	/// </summary>
	public Color borderColor {
		get { return Values().GetStyleColor(StylePropertyId.BorderColor).value; }
		set { SetValue(StylePropertyId.BorderColor, value); }
	}
	/// <summary>
	/// Space reserved for the left edge of the margin during the layout phase.
	/// </summary>
	public float marginLeft {
		get { return Values().GetStyleFloat(StylePropertyId.MarginLeft).value; }
		set { SetValue(StylePropertyId.MarginLeft, value); }
	}
	/// <summary>
	/// Space reserved for the top edge of the margin during the layout phase.
	/// </summary>
	public float marginTop {
		get { return Values().GetStyleFloat(StylePropertyId.MarginTop).value; }
		set { SetValue(StylePropertyId.MarginTop, value); }
	}
	/// <summary>
	/// Space reserved for the right edge of the margin during the layout phase.
	/// </summary>
	public float marginRight {
		get { return Values().GetStyleFloat(StylePropertyId.MarginRight).value; }
		set { SetValue(StylePropertyId.MarginRight, value); }
	}
	/// <summary>
	...
	public float marginBottom {
		get { return Values().GetStyleFloat(StylePropertyId.MarginBottom).value; }
		set { SetValue(StylePropertyId.MarginBottom, value); }
	}
	/// <summary>
	/// Space reserved for the left edge of the padding during the layout phase.
	/// </summary>
	public float paddingLeft {
		get { return Values().GetStyleFloat(StylePropertyId.PaddingLeft).value; }
		set { SetValue(StylePropertyId.PaddingLeft, value); }
	}
	/// <summary>
	/// Space reserved for the top edge of the padding during the layout phase.
	/// </summary>
	public float paddingTop {
		get { return Values().GetStyleFloat(StylePropertyId.PaddingTop).value; }
		set { SetValue(StylePropertyId.PaddingTop, value); }
	}
	/// <summary>
	...
	public float paddingRight {
		get { return Values().GetStyleFloat(StylePropertyId.PaddingRight).value; }
		set { SetValue(StylePropertyId.PaddingRight, value); }
	}
	/// <summary>
	...
	public float paddingBottom {
		...
		set { SetValue(StylePropertyId.PaddingBottom, value); }
	}
	/// <summary>
	...
	public float borderLeftWidth {
		...
		set { SetValue(StylePropertyId.BorderLeftWidth, value); }
	}
	/// <summary>
	...
	public float borderRightWidth {
		...
		set { SetValue(StylePropertyId.BorderRightWidth, value); }
	}
	/// <summary>
	...
	public float borderTopWidth {
		...
		set { SetValue(StylePropertyId.BorderTopWidth, value); }
	}
	/// <summary>
	...
	public float borderBottomWidth {
		...
		set { SetValue(StylePropertyId.BorderBottomWidth, value); }
	}
	/// <summary>
	...
	public float borderTopLeftRadius {
		get {
			return Values()
			       .GetStyleFloat(StylePropertyId.BorderTopLeftRadius)
			       .value;
		}
		set { SetValue(StylePropertyId.BorderTopLeftRadius, value); }
	}
	/// <summary>
	...
	public float borderTopRightRadius {
		get {
			return Values()
			       .GetStyleFloat(StylePropertyId.BorderTopRightRadius)
			       .value;
		}
		set { SetValue(StylePropertyId.BorderTopRightRadius, value); }
	}
	/// <summary>
	...
	public float borderBottomLeftRadius {
		get {
			return Values()
			       .GetStyleFloat(StylePropertyId.BorderBottomLeftRadius)
			       .value;
		}
		set { SetValue(StylePropertyId.BorderBottomLeftRadius, value); }
	}
	/// <summary>
	...
	public float borderBottomRightRadius {
		get {
			return Values()
			       .GetStyleFloat(StylePropertyId.BorderBottomRightRadius)
			       .value;
		}
		set { SetValue(StylePropertyId.BorderBottomRightRadius, value); }
	}
	...
	public float opacity {
		get { return Values().GetStyleFloat(StylePropertyId.Opacity).value; }
		set { SetValue(StylePropertyId.Opacity, value); }
	}
	/// <summary>
	...
	public float flexGrow {
		get { return Values().GetStyleFloat(StylePropertyId.FlexGrow).value; }
		set { SetValue(StylePropertyId.FlexGrow, value); }
	}
	/// <summary>
	...
	public float flexShrink {
		get { return Values().GetStyleFloat(StylePropertyId.FlexShrink).value; }
		set { SetValue(StylePropertyId.FlexGrow, value); }
	}
...
/// <param name="durationMs">Duration of the transition in
/// milliseconds.</param> <param name="onValueChanged">Callback that applies
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<float> Start(float from, float to, int durationMs,
...
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<Rect> Start(Rect from, Rect to, int durationMs,
...
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<Color> Start(Color from, Color to, int durationMs,
...
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<Vector3> Start(
	Vector3 from, Vector3 to, int durationMs,
...
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<Vector2> Start(
	Vector2 from, Vector2 to, int durationMs,
...
/// the interpolated value.</param> <returns>The created animation
/// object.</returns>
ValueAnimation<Quaternion> Start(
	Quaternion from, Quaternion to, int durationMs,
...
/// <param name="to">End value.</param>
/// <param name="durationMs">Duration of the transition in
/// milliseconds.</param> <returns>The created animation object.</returns>
ValueAnimation<StyleValues> Start(StyleValues from, StyleValues to,
                                  int durationMs);
...
/// Starts a transition animation on this VisualElement.
/// </summary>
/// <param name="fromValueGetter">Callback that provides the initial
/// value.</param> <param name="to">End value.</param> <param
/// name="durationMs">Duration of the transition in milliseconds.</param>
/// <param name="onValueChanged">Callback that applies the interpolated
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<float> Start(Func<VisualElement, float> fromValueGetter,
...
/// <param name="onValueChanged">Callback that applies the interpolated
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<Rect> Start(Func<VisualElement, Rect> fromValueGetter,
                           Rect to, int durationMs,
                           Action<VisualElement, Rect> onValueChanged);
...
/// <param name="onValueChanged">Callback that applies the interpolated
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<Color> Start(Func<VisualElement, Color> fromValueGetter,
                            Color to, int durationMs,
                            Action<VisualElement, Color> onValueChanged);
...
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<Vector3> Start(
	Func<VisualElement, Vector3> fromValueGetter, Vector3 to,
	int durationMs, Action<VisualElement, Vector3> onValueChanged);
...
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<Vector2> Start(
	Func<VisualElement, Vector2> fromValueGetter, Vector2 to,
	int durationMs, Action<VisualElement, Vector2> onValueChanged);
...
/// value.</param> <returns>The created animation object.</returns>
ValueAnimation<Quaternion> Start(
	Func<VisualElement, Quaternion> fromValueGetter, Quaternion to,
	int durationMs, Action<VisualElement, Quaternion> onValueChanged);
...
public static Quaternion Interpolate(Quaternion start, Quaternion end,
                                     float ratio) {
	return Quaternion.SlerpUnclamped(start, end, ratio);
}

internal static StyleValues Interpolate(StyleValues start, StyleValues end,
                                        float ratio) {
	...
	foreach (var endValue in end.m_StyleValues.m_Values) {
		...
		if (!start.m_StyleValues.TryGetStyleValue(endValue.id,
		                                          ref startValue)) {
			throw new ArgumentException(
				      "Start StyleValues must contain the same values as end values. Missing property:" +
				      endValue.id);
		}
			...
			// We've got floats!
		{
			result.SetValue(
				endValue.id,
				Lerp.Interpolate(startValue.number, endValue.number, ratio));
		}
		break;
			...
			// We've got colors!
		{
			result.SetValue(
				endValue.id,
				Lerp.Interpolate(startValue.color, endValue.color, ratio));
		}
