...
namespace UnityEngine.UIElements {
  ...
  public abstract class UxmlAttributeDescription {
    protected const string xmlSchemaNamespace =
    ...
    internal bool TryGetValueFromBagAsString(IUxmlAttributes bag,
                                             CreationContext cc,
                                             out string value) {
      // Regardless of whether the attribute is overwridden or not, we want to
      // error here if there is no valid name.
      if (name == null &&
          ...
          if (cc.attributeOverrides[i].m_AttributeName != name) {
            if (m_ObsoleteNames != null) {
              ...
              for (var j = 0; j < m_ObsoleteNames.Length; j++) {
                if (cc.attributeOverrides[i].m_AttributeName ==
                    m_ObsoleteNames[j]) {
      ...
      if (name == null) {
        // Check for:
        // (m_ObsoleteNames == null || m_ObsoleteNames.Length == 0)
        // moved at the top of method so we can assume we have obsolete names
        // here.
    ...
    /// return if the attribute is not found in the bag.</param> <param
    /// name="value">If the attribute could be retrieved, the retrieved value
    /// converted by the conversion function or the default value if the
    /// retrieved value could not de converted.</param> <returns>True if the
    /// value could be retrieved, false otherwise.</returns>
    protected bool TryGetValueFromBag<T>(IUxmlAttributes bag,
                                         CreationContext cc,
                                         Func<string, T, T> converterFunc,
                                         T defaultValue, ref T value) {
      string stringValue;
    ...
    /// retrieved.</param> <param name="converterFunc">A function to convert a
    /// string value to type T.</param> <param name="defaultValue">The value to
    /// return if the attribute is not found in the bag.</param> <remarks> The
    /// attribute is looked up using <see cref="name"/>. If it is not found,
    /// each <see cref="obsoleteNames"/> is tried in turn, from first to last.
    /// </remarks>
    /// <returns>The attribute value from the bag, or defaultValue if the
    /// attribute is not found.</returns>
    protected T GetValueFromBag<T>(IUxmlAttributes bag, CreationContext cc,
                                   Func<string, T, T> converterFunc,
                                   T defaultValue) {
      if (converterFunc == null) {
  ...
  /// </summary>
  public abstract class TypedUxmlAttributeDescription<T>
      : UxmlAttributeDescription {
    /// <summary>
    /// Use this method to obtain the actual value of the attribute.
    /// </summary>
    /// <param name="bag">The bag of attributes where to get the actual
    /// value.</param> <param name="cc">The creation context.</param>
  ...
  public class UxmlStringAttributeDescription
      : TypedUxmlAttributeDescription<string> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the value of this attribute from the attribute bag. Returns it
    /// if it is found, otherwise return <see cref="defaultValue"/>.
    /// </summary>
    /// <param name="bag">The bag of attributes.</param>
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override string GetValueFromBag(IUxmlAttributes bag,
                                           CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, t) => s, defaultValue);
    }

    /// <summary>
    /// Tries to retrieve the value of this attribute from the attribute bag.
    /// Returns true if it is found, otherwise returns false.
    /// </summary>
    /// <param name="bag">The bag of attributes.</param>
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <param name="value">The value of the attribute.</param>
    /// <returns>True if the value could be retrieved, false
    /// otherwise.</returns>
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref string value) {
  ...
  public class UxmlFloatAttributeDescription
      : TypedUxmlAttributeDescription<float> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override float GetValueFromBag(IUxmlAttributes bag,
                                          CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, f) => ConvertValueToFloat(s, f),
                             defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref float value) {
      return TryGetValueFromBag(bag, cc, (s, f) => ConvertValueToFloat(s, f),
  ...
  public class UxmlDoubleAttributeDescription
      : TypedUxmlAttributeDescription<double> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override double GetValueFromBag(IUxmlAttributes bag,
                                           CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, d) => ConvertValueToDouble(s, d),
                             defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref double value) {
      return TryGetValueFromBag(bag, cc, (s, d) => ConvertValueToDouble(s, d),
                                defaultValue, ref value);
    }
  ...
  public class UxmlIntAttributeDescription
      : TypedUxmlAttributeDescription<int> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override int GetValueFromBag(IUxmlAttributes bag,
                                        CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, i) => ConvertValueToInt(s, i),
                             defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref int value) {
      return TryGetValueFromBag(bag, cc, (s, i) => ConvertValueToInt(s, i),
                                defaultValue, ref value);
    }
  ...
  public class UxmlLongAttributeDescription
      : TypedUxmlAttributeDescription<long> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override long GetValueFromBag(IUxmlAttributes bag,
                                         CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, l) => ConvertValueToLong(s, l),
                             defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref long value) {
      return TryGetValueFromBag(bag, cc, (s, l) => ConvertValueToLong(s, l),
                                defaultValue, ref value);
    }
  ...
  public class UxmlBoolAttributeDescription
      : TypedUxmlAttributeDescription<bool> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override bool GetValueFromBag(IUxmlAttributes bag,
                                         CreationContext cc) {
      return GetValueFromBag(bag, cc, (s, b) => ConvertValueToBool(s, b),
                             defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref bool value) {
      return TryGetValueFromBag(bag, cc, (s, b) => ConvertValueToBool(s, b),
                                defaultValue, ref value);
    }
  ...
  /// <summary>
  /// Describes a XML attribute representing a <see cref="Color"/> as a
  /// <c>string</c>.
  /// </summary>
  public class UxmlColorAttributeDescription
      : TypedUxmlAttributeDescription<Color> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <param name="cc">The context in which the values are retrieved.</param>
    /// <returns>The value of the attribute.</returns>
    public override Color GetValueFromBag(IUxmlAttributes bag,
                                          CreationContext cc) {
      return GetValueFromBag(
          bag, cc, (s, color) => ConvertValueToColor(s, color), defaultValue);
    }
    ...
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref Color value) {
      return TryGetValueFromBag(bag, cc,
                                (s, color) => ConvertValueToColor(s, color),
                                defaultValue, ref value);
    }
  ...
  /// </summary>
  public class UxmlTypeAttributeDescription<TBase>
      : TypedUxmlAttributeDescription<Type> {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    /// <summary>
    /// Method that retrieves an attribute's value from an attribute bag.
    /// Returns it if it is found, otherwise return <see cref="defaultValue"/>.
    /// </summary>
    /// <param name="bag">The attribute bag.</param>
    /// <param name="cc">The context in which the method retrieves attribute
    /// values.</param> <returns>The attribute's value. If the method cannot
    /// find the value, returns <see cref="defaultValue"/>.</returns>
    public override Type GetValueFromBag(IUxmlAttributes bag,
                                         CreationContext cc) {
      return GetValueFromBag(
          bag, cc, (s, type1) => ConvertValueToType(s, type1), defaultValue);
    }

    /// <summary>
    /// Method that tries to retrieve an attribute's value from an attribute
    /// bag.. Returns true if it is found, otherwise returns false.
    /// </summary>
    /// <param name="bag">The attribute bag.</param>
    /// <param name="cc">The context in which the method retrieves attribute
    /// values.</param> <param name="value">The attribute's value.</param>
    /// <returns>True if the method can retrieve the attribute's value. False
    /// otherwise.</returns>
    public bool TryGetValueFromBag(IUxmlAttributes bag, CreationContext cc,
                                   ref Type value) {
      return TryGetValueFromBag(bag, cc,
                                (s, type1) => ConvertValueToType(s, type1),
                                defaultValue, ref value);
    }
    ...
    Type ConvertValueToType(string v, Type defaultValue) {
      ...
      try {
        ...
        if (!typeof(TBase).IsAssignableFrom(type))
          Debug.LogError(
              $"Type: Invalid type \"{v}\". Type must derive from {typeof(TBase).FullName}.");
        else
          return type;
      } catch (Exception e) {
  ...
  /// </summary>
  public class UxmlEnumAttributeDescription<T>
      : TypedUxmlAttributeDescription<T> where T : struct, IConvertible {
    /// <summary>
    /// Constructor.
    /// </summary>
    ...
    public override T GetValueFromBag(IUxmlAttributes bag, CreationContext cc) {
      return GetValueFromBag(
          bag, cc, (s, convertible) => ConvertValueToEnum(s, convertible),
          defaultValue);
    }
