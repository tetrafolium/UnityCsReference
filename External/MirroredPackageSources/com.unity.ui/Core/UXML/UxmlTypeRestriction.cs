...
namespace UnityEngine.UIElements {
  ...
  public abstract class UxmlTypeRestriction : IEquatable<UxmlTypeRestriction> {
    /// <summary>
    /// Indicates whether the current <see cref="UxmlTypeRestriction"/> object
  ...
  public class UxmlValueMatches : UxmlTypeRestriction {
    ...
    /// <summary>
    /// Indicates whether the current <see cref="UxmlValueMatches"/> object is
  ...
  public class UxmlValueBounds : UxmlTypeRestriction {
    ...
    /// <summary>
    /// Indicates whether the current <see cref="UxmlValueBounds"/> object is
    /// equal to another object of the same type.
    /// </summary>
    /// <param name="other">The object to compare with.</param>
    /// <returns>True if the otheer object is equal to this one.</returns>
    public override bool Equals(UxmlTypeRestriction other) {
      ...
      return ((min == otherVB.min) && (max == otherVB.max) &&
              (excludeMin == otherVB.excludeMin) &&
              (excludeMax == otherVB.excludeMax));
    }
  }
  ...
  public class UxmlEnumeration : UxmlTypeRestriction {
    ...
    /// <summary>
    /// Indicates whether the current <see cref="UxmlEnumeration"/> object is
    /// equal to another object of the same type.
    /// </summary>
    /// <param name="other">The object to compare with.</param>
    /// <returns>True if the otheer object is equal to this one.</returns>
    public override bool Equals(UxmlTypeRestriction other) {
      ...
      return values.All(otherE.values.Contains) &&
             values.Count() == otherE.values.Count();
    }
  }
}
