...
namespace UnityEngine.UIElements {
  ...
  /// </summary>
  /// <remarks>
  /// This factory does not generate VisualElements. UIElements uses it to
  /// generate schemas.
  /// </remarks>
  public class UxmlRootElementFactory
    ...
    /// Returns null.
    /// </summary>
    public override VisualElement Create(IUxmlAttributes bag,
                                         CreationContext cc) {
      return null;
    }
  }
...
#pragma warning restore
    ...
    /// <c>UxmlChildElementDescription(typeof(VisualElement))</c>, since the
    /// root element can contain VisualElements.
    /// </summary>
  ...
  public class UxmlStyleFactory : UxmlFactory<VisualElement, UxmlStyleTraits> {
    ...
    public override string substituteForTypeNamespace =>
        typeof(VisualElement).Namespace ?? String.Empty;

    public override string substituteForTypeQualifiedName =>
        typeof(VisualElement).FullName;
  ...
  public class UxmlStyleTraits : UxmlTraits {
    UxmlStringAttributeDescription m_Name = new UxmlStringAttributeDescription{
        name = UxmlGenericAttributeNames.k_NameAttributeName};
    UxmlStringAttributeDescription m_Path = new UxmlStringAttributeDescription{
        name = UxmlGenericAttributeNames.k_PathAttributeName};
    UxmlStringAttributeDescription m_Src = new UxmlStringAttributeDescription{
        name = UxmlGenericAttributeNames.k_SrcAttributeName};
  ...
  public class UxmlTemplateFactory
      : UxmlFactory<VisualElement, UxmlTemplateTraits> {
  ...
  public class UxmlAttributeOverridesFactory
      : UxmlFactory<VisualElement, UxmlAttributeOverridesTraits> {
  ...
  public class UxmlAttributeOverridesTraits : UxmlTraits {
    ...
    UxmlStringAttributeDescription m_ElementName =
        new UxmlStringAttributeDescription{
            name = k_ElementNameAttributeName,
            use = UxmlAttributeDescription.Use.Required};

    /// <summary>
    /// Returns an empty enumerable because <AttributeOverrides> cannot have
    /// children.
    /// </summary>
    public override IEnumerable<UxmlChildElementDescription>
        uxmlChildElementsDescription {
