...
namespace UnityEngine.UIElements {
  /// <summary>
  /// This structure manipulates the set of <see cref="StyleSheet"/> objects
  /// attached to the owner <see cref="VisualElement"/>.
  /// </summary>
  /// <remarks>
  ///
  ///                 <see cref="VisualElementStyleSheetSet"/> instances cannot
  ///                 be created directly. Use the <see
  ///                 cref="VisualElement.styleSheets"/> property accessor to
  ///                 work with the style sheets of an element.
  ///
  /// </remarks>
  public struct VisualElementStyleSheetSet
      : IEquatable<VisualElementStyleSheetSet> {
    ...
    public bool Remove(StyleSheet styleSheet) {
      ...
      if (m_Element.styleSheetList != null &&
          m_Element.styleSheetList.Remove(styleSheet)) {
    ...
    /// </summary>
    /// <returns>True if the style sheet is attached to the owner element, false
    /// otherwise.</returns>
    ...
    public override bool Equals(object obj) {
      if (ReferenceEquals(null, obj))
        return false;
      return obj is VisualElementStyleSheetSet &&
             Equals((VisualElementStyleSheetSet) obj);
    }
    ...
    public static bool operator ==(VisualElementStyleSheetSet left,
