...
public partial class VisualElement : ITransitionAnimations
{
    ...
    {
        return experimental.animation.Start((e) => e.transform.scale.x, to, durationMs, (e, c) => {
    ...
    {
        return experimental.animation.Start((e) => e.transform.position, to, durationMs, (e, c) => {
    ...
    {
        return experimental.animation.Start((e) => e.transform.rotation, to, durationMs, (e, c) => {
