...
internal static readonly Dictionary<string, StylePropertyId> s_NameToId =
	new Dictionary<string, StylePropertyId>(){
...
public static int GetEnumIntValue(StyleEnumType enumType, string value) {
	...
	case StyleEnumType.DisplayStyle: {
		...
		else if (string.Equals(value, "none",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.FlexDirection: {
		...
		else if (string.Equals(value, "column-reverse",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) FlexDirection.ColumnReverse;
		else if (string.Equals(value, "row",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) FlexDirection.Row;
		else if (string.Equals(value, "row-reverse",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.FontStyle: {
		...
		else if (string.Equals(value, "bold",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) FontStyle.Bold;
		else if (string.Equals(value, "italic",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) FontStyle.Italic;
		else if (string.Equals(value, "bold-and-italic",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.Justify: {
		if (string.Equals(value, "flex-start",
		                  StringComparison.OrdinalIgnoreCase))
		...
		else if (string.Equals(value, "space-between",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) Justify.SpaceBetween;
		else if (string.Equals(value, "space-around",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.Overflow: {
		...
		else if (string.Equals(value, "hidden",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.OverflowClipBox: {
		if (string.Equals(value, "padding-box",
		                  StringComparison.OrdinalIgnoreCase))
			return (int) OverflowClipBox.PaddingBox;
		else if (string.Equals(value, "content-box",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.OverflowInternal: {
		...
		else if (string.Equals(value, "scroll",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.Position: {
		if (string.Equals(value, "relative",
		                  StringComparison.OrdinalIgnoreCase))
			return (int) Position.Relative;
		else if (string.Equals(value, "absolute",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.ScaleMode: {
		if (string.Equals(value, "stretch-to-fill",
		                  StringComparison.OrdinalIgnoreCase))
			return (int) ScaleMode.StretchToFill;
		else if (string.Equals(value, "scale-and-crop",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) ScaleMode.ScaleAndCrop;
		else if (string.Equals(value, "scale-to-fit",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.TextAnchor: {
		if (string.Equals(value, "upper-left",
		                  StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.UpperLeft;
		else if (string.Equals(value, "upper-center",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.UpperCenter;
		else if (string.Equals(value, "upper-right",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.UpperRight;
		else if (string.Equals(value, "middle-left",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.MiddleLeft;
		else if (string.Equals(value, "middle-center",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.MiddleCenter;
		else if (string.Equals(value, "middle-right",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.MiddleRight;
		else if (string.Equals(value, "lower-left",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.LowerLeft;
		else if (string.Equals(value, "lower-center",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) TextAnchor.LowerCenter;
		else if (string.Equals(value, "lower-right",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.TextOverflow: {
		...
		else if (string.Equals(value, "ellipsis",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.TextOverflowPosition: {
		...
		else if (string.Equals(value, "middle",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.WhiteSpace: {
		...
		else if (string.Equals(value, "nowrap",
		                       StringComparison.OrdinalIgnoreCase))
	...
	case StyleEnumType.Wrap: {
		...
		else if (string.Equals(value, "wrap",
		                       StringComparison.OrdinalIgnoreCase))
			return (int) Wrap.Wrap;
		else if (string.Equals(value, "wrap-reverse",
		                       StringComparison.OrdinalIgnoreCase))
