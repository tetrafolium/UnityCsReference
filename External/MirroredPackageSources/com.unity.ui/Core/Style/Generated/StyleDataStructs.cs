...
namespace UnityEngine.UIElements {
  internal struct InheritedData : IEquatable<InheritedData> {
    ...
    public static bool operator ==(InheritedData lhs, InheritedData rhs) {
      return lhs.color == rhs.color && lhs.fontSize == rhs.fontSize &&
             lhs.unityFont == rhs.unityFont &&
             lhs.unityFontStyleAndWeight.value ==
                 rhs.unityFontStyleAndWeight.value &&
             lhs.unityFontStyleAndWeight.keyword ==
                 rhs.unityFontStyleAndWeight.keyword &&
    ...
    public bool Equals(InheritedData other) { return other == this; }
  ...
  internal struct NonInheritedData : IEquatable<NonInheritedData> {
    ...
    public static bool operator ==(NonInheritedData lhs, NonInheritedData rhs) {
      return lhs.alignContent.value == rhs.alignContent.value &&
             ...
             lhs.bottom == rhs.bottom && lhs.cursor == rhs.cursor &&
             ...
             lhs.flexGrow == rhs.flexGrow && lhs.flexShrink == rhs.flexShrink &&
             ...
             lhs.left == rhs.left && lhs.marginBottom == rhs.marginBottom &&
             lhs.marginLeft == rhs.marginLeft &&
             lhs.marginRight == rhs.marginRight &&
             lhs.marginTop == rhs.marginTop && lhs.maxHeight == rhs.maxHeight &&
             lhs.maxWidth == rhs.maxWidth && lhs.minHeight == rhs.minHeight &&
             lhs.minWidth == rhs.minWidth && lhs.opacity == rhs.opacity &&
             ...
             lhs.top == rhs.top &&
             lhs.unityBackgroundImageTintColor ==
                 rhs.unityBackgroundImageTintColor &&
             lhs.unityBackgroundScaleMode.value ==
                 rhs.unityBackgroundScaleMode.value &&
             lhs.unityBackgroundScaleMode.keyword ==
                 rhs.unityBackgroundScaleMode.keyword &&
             lhs.unityOverflowClipBox.value == rhs.unityOverflowClipBox.value &&
             lhs.unityOverflowClipBox.keyword ==
             ...
             lhs.unityTextOverflowPosition.value ==
                 rhs.unityTextOverflowPosition.value &&
             lhs.unityTextOverflowPosition.keyword ==
                 rhs.unityTextOverflowPosition.keyword &&
             lhs.width == rhs.width;
    }
    ...
    public bool Equals(NonInheritedData other) { return other == this; }

    public override bool Equals(object obj) {
      if (ReferenceEquals(null, obj))
        return false;
      return obj is NonInheritedData && Equals((NonInheritedData) obj);
    }
    ...
    public override int GetHashCode() {
      unchecked {
        ...
        hashCode =
            (hashCode * 397) ^ unityBackgroundImageTintColor.GetHashCode();
