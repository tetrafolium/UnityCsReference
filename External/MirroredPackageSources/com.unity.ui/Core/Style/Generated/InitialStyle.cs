...
namespace UnityEngine.UIElements.StyleSheets {
  internal static class InitialStyle {
    private static ComputedStyle s_InitialStyle =
        ComputedStyle.CreateUninitialized();

    public static ComputedStyle Get() { return s_InitialStyle; }
    ...
    static InitialStyle() {
      ...
      s_InitialStyle.nonInheritedData.backgroundImage =
          default(StyleBackground);
      ...
      s_InitialStyle.nonInheritedData.unityBackgroundImageTintColor =
          Color.white;
      s_InitialStyle.nonInheritedData.unityBackgroundScaleMode =
      ...
      s_InitialStyle.nonInheritedData.unityOverflowClipBox =
      ...
      s_InitialStyle.nonInheritedData.unityTextOverflowPosition =
    ...
    public static StyleEnum<Align> alignContent =>
        s_InitialStyle.nonInheritedData.alignContent;
    public static StyleEnum<Align> alignItems =>
        s_InitialStyle.nonInheritedData.alignItems;
    public static StyleEnum<Align> alignSelf =>
        s_InitialStyle.nonInheritedData.alignSelf;
    public static StyleColor backgroundColor =>
        s_InitialStyle.nonInheritedData.backgroundColor;
    public static StyleBackground backgroundImage =>
        s_InitialStyle.nonInheritedData.backgroundImage;
    public static StyleColor borderBottomColor =>
        s_InitialStyle.nonInheritedData.borderBottomColor;
    public static StyleLength borderBottomLeftRadius =>
        s_InitialStyle.nonInheritedData.borderBottomLeftRadius;
    public static StyleLength borderBottomRightRadius =>
        s_InitialStyle.nonInheritedData.borderBottomRightRadius;
    public static StyleFloat borderBottomWidth =>
        s_InitialStyle.nonInheritedData.borderBottomWidth;
    public static StyleColor borderLeftColor =>
        s_InitialStyle.nonInheritedData.borderLeftColor;
    public static StyleFloat borderLeftWidth =>
        s_InitialStyle.nonInheritedData.borderLeftWidth;
    public static StyleColor borderRightColor =>
        s_InitialStyle.nonInheritedData.borderRightColor;
    public static StyleFloat borderRightWidth =>
        s_InitialStyle.nonInheritedData.borderRightWidth;
    public static StyleColor borderTopColor =>
        s_InitialStyle.nonInheritedData.borderTopColor;
    public static StyleLength borderTopLeftRadius =>
        s_InitialStyle.nonInheritedData.borderTopLeftRadius;
    public static StyleLength borderTopRightRadius =>
        s_InitialStyle.nonInheritedData.borderTopRightRadius;
    public static StyleFloat borderTopWidth =>
        s_InitialStyle.nonInheritedData.borderTopWidth;
    ...
    public static StyleEnum<DisplayStyle> display =>
        s_InitialStyle.nonInheritedData.display;
    public static StyleLength flexBasis =>
        s_InitialStyle.nonInheritedData.flexBasis;
    public static StyleEnum<FlexDirection> flexDirection =>
        s_InitialStyle.nonInheritedData.flexDirection;
    public static StyleFloat flexGrow =>
        s_InitialStyle.nonInheritedData.flexGrow;
    public static StyleFloat flexShrink =>
        s_InitialStyle.nonInheritedData.flexShrink;
    public static StyleEnum<Wrap> flexWrap =>
        s_InitialStyle.nonInheritedData.flexWrap;
    ...
    public static StyleEnum<Justify> justifyContent =>
        s_InitialStyle.nonInheritedData.justifyContent;
    public static StyleLength left => s_InitialStyle.nonInheritedData.left;
    public static StyleLength marginBottom =>
        s_InitialStyle.nonInheritedData.marginBottom;
    public static StyleLength marginLeft =>
        s_InitialStyle.nonInheritedData.marginLeft;
    public static StyleLength marginRight =>
        s_InitialStyle.nonInheritedData.marginRight;
    public static StyleLength marginTop =>
        s_InitialStyle.nonInheritedData.marginTop;
    public static StyleLength maxHeight =>
        s_InitialStyle.nonInheritedData.maxHeight;
    public static StyleLength maxWidth =>
        s_InitialStyle.nonInheritedData.maxWidth;
    public static StyleLength minHeight =>
        s_InitialStyle.nonInheritedData.minHeight;
    public static StyleLength minWidth =>
        s_InitialStyle.nonInheritedData.minWidth;
