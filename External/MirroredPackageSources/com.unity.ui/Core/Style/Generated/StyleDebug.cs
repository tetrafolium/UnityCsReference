...
//              See StyleDebugGenerator class for details
//
/******************************************************************************/
using System;
...
namespace UnityEngine.UIElements {
  internal static partial class StyleDebug {
    public static object GetComputedStyleValue(ComputedStyle computedStyle,
      ...
      default: {
        Debug.LogAssertion(
            $"Cannot get computed style value for property id {id}");
        return null;
      }
      }
    }
    ...
    public static object GetInlineStyleValue(IStyle style, StylePropertyId id) {
      ...
      default: {
        Debug.LogAssertion(
            $"Cannot get inline style value for property id {id}");
        return null;
      }
      }
    }

    public static void SetInlineStyleValue(IStyle style, StylePropertyId id,
                                           object value) {
      switch (id) {
      case StylePropertyId.AlignContent:
      ...
      default:
        Debug.LogAssertion(
            $"Cannot set inline style value for property id {id}");
        break;
      }
    }
    ...
    public static Type GetComputedStyleType(StylePropertyId id) {
      ...
      default: {
        Debug.LogAssertion(
            $"Cannot get computed style type for property id {id}");
        return null;
      }
      }
    }
    ...
    public static string[] GetLonghandPropertyNames(StylePropertyId id) {
      ...
      case StylePropertyId.BorderColor:
        return new string[]{"border-top-color", "border-right-color",
                            "border-bottom-color", "border-left-color"};
      case StylePropertyId.BorderRadius:
        return new string[]{"border-top-left-radius", "border-top-right-radius",
                            "border-bottom-right-radius",
                            "border-bottom-left-radius"};
      case StylePropertyId.BorderWidth:
        return new string[]{"border-top-width", "border-right-width",
                            "border-bottom-width", "border-left-width"};
      case StylePropertyId.Flex:
        return new string[]{"flex-grow", "flex-shrink", "flex-basis"};
      case StylePropertyId.Margin:
        return new string[]{"margin-top", "margin-right", "margin-bottom",
                            "margin-left"};
      case StylePropertyId.Padding:
        return new string[]{"padding-top", "padding-right", "padding-bottom",
                            "padding-left"};
      default: {
        Debug.LogAssertion(
            $"Cannot get longhand property names for property id {id}");
        return null;
      }
      }
    }
    ...
    public static StylePropertyId[] GetInheritedProperties() {
      return new[]{StylePropertyId.Color,
