...
namespace UnityEngine.UIElements.StyleSheets {
  internal static partial class ShorthandApplicator {
    public static void ApplyBorderColor(StylePropertyReader reader,
      ...
      CompileBoxAreaNoKeyword(reader, out borderTopColor, out borderRightColor,
                              out borderBottomColor, out borderLeftColor);
    ...
    public static void ApplyBorderRadius(StylePropertyReader reader,
                                         ComputedStyle computedStyle) {
      ...
      CompileBoxAreaNoKeyword(
          reader, out borderTopLeftRadius, out borderTopRightRadius,
      ...
      computedStyle.nonInheritedData.borderTopRightRadius =
          borderTopRightRadius;
      computedStyle.nonInheritedData.borderBottomRightRadius =
          borderBottomRightRadius;
      computedStyle.nonInheritedData.borderBottomLeftRadius =
          borderBottomLeftRadius;
    }

    public static void ApplyBorderWidth(StylePropertyReader reader,
                                        ComputedStyle computedStyle) {
      ...
      CompileBoxAreaNoKeyword(reader, out borderTopWidth, out borderRightWidth,
                              out borderBottomWidth, out borderLeftWidth);
    ...
    public static void ApplyFlex(StylePropertyReader reader,
                                 ComputedStyle computedStyle) {
      StyleFloat flexGrow;
    ...
    public static void ApplyMargin(StylePropertyReader reader,
                                   ComputedStyle computedStyle) {
      ...
      CompileBoxArea(reader, out marginTop, out marginRight, out marginBottom,
                     out marginLeft);
    ...
    public static void ApplyPadding(StylePropertyReader reader,
                                    ComputedStyle computedStyle) {
      ...
      CompileBoxAreaNoKeyword(reader, out paddingTop, out paddingRight,
                              out paddingBottom, out paddingLeft);
