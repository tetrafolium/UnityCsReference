...
namespace UnityEngine.UIElements {
  /// <summary>
  /// Style value that can be either a <see cref="Background"/> or a <see
  /// cref="StyleKeyword"/>.
  /// </summary>
  public struct StyleBackground : IStyleValue<Background>,
                                  IEquatable<StyleBackground> {
    /// <summary>
    /// The <see cref="Background"/> value.
    /// </summary>
    public Background value {
      get {
        return m_Keyword == StyleKeyword.Undefined ? m_Value : new Background();
      }
      set {
        m_Value = value;
    ...
    /// <summary>
    /// Creates from either a <see cref="Background"/> or a <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleBackground(Background v) : this(v, StyleKeyword.Undefined) {}

    /// <summary>
    /// Creates from either a <see cref="Background"/> or a <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleBackground(Texture2D v) : this(v, StyleKeyword.Undefined) {}

    /// <summary>
    /// Creates from either a <see cref="Background"/> or a <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleBackground(VectorImage v) : this(v, StyleKeyword.Undefined) {}
    ...
    internal StyleBackground(GCHandle gcHandle, StyleKeyword keyword)
        : this(gcHandle.IsAllocated ? Background.FromObject(gcHandle.Target)
               : new Background(), keyword) {}
    ...
    public bool Equals(StyleBackground other) { return other == this; }
    ...
    public override string ToString() { return this.DebugString(); }
  }
}
