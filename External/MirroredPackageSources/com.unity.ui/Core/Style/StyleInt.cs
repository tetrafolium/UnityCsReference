...
namespace UnityEngine.UIElements {
  ...
  public struct StyleInt : IStyleValue<int>, IEquatable<StyleInt> {
    ...
    public int value {
      get {
        return m_Keyword == StyleKeyword.Undefined ? m_Value : default(int);
      }
      set {
        m_Value = value;
    ...
    /// </summary>
    public StyleInt(int v) : this(v, StyleKeyword.Undefined) {}
    ...
    public static implicit operator StyleInt(int v) { return new StyleInt(v); }

    public bool Equals(StyleInt other) { return other == this; }
