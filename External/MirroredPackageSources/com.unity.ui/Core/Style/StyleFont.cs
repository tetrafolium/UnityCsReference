...
namespace UnityEngine.UIElements {
  /// <summary>
  /// Style value that can be either a <see cref="Font"/> or a <see
  /// cref="StyleKeyword"/>.
  /// </summary>
  public struct StyleFont : IStyleValue<Font>, IEquatable<StyleFont> {
    ...
    /// </summary>
    public StyleFont(Font v) : this(v, StyleKeyword.Undefined) {}
    ...
    internal StyleFont(GCHandle gcHandle, StyleKeyword keyword)
        : this(gcHandle.IsAllocated ? gcHandle.Target as Font
               : null, keyword) {}
    ...
    public bool Equals(StyleFont other) { return other == this; }
    ...
    public override int GetHashCode() {
      ...
      hashCode = hashCode * -1521134295 +
                 EqualityComparer<Font>.Default.GetHashCode(m_Value);
      return hashCode;
    }
