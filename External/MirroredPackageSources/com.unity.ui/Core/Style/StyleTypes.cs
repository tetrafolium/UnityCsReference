...
namespace UnityEngine.UIElements {
  ...
  public enum StyleKeyword {
    ...
    Undefined, // No keyword defined
               /// <summary>
               /// Means that an inline style from <see cref="IStyle"/> has no
               /// value or keyword.
               /// </summary>
               /// <remarks>
               /// This can also be used to remove an inline style previously
               /// set on a property.
               /// </remarks>
  ...
  internal static class StyleValueExtensions {
    ...
    internal static StyleEnum<T> ToStyleEnum<T>(this StyleInt styleInt,
                                                T value) where T : struct
    , IConvertible { return new StyleEnum<T>(value, styleInt.keyword); }
    ...
    internal static string DebugString<T>(this IStyleValue<T> styleValue) {
      return styleValue.keyword != StyleKeyword.Undefined ?
                                   $"{styleValue.keyword}"
          : $"{styleValue.value}";
    }
    ...
    internal static StyleKeyword
    ToStyleKeyword(this StyleValueKeyword styleValueKeyword) {
