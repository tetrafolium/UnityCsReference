...
namespace UnityEngine.UIElements {
  /// <summary>
  /// Style value that can be either a <see cref="Cursor"/> or a <see
  /// cref="StyleKeyword"/>.
  /// </summary>
  public struct StyleCursor : IStyleValue<Cursor>, IEquatable<StyleCursor> {
    ...
    /// <summary>
    /// Creates from either a <see cref="Cursor"/> or <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleCursor(Cursor v) : this(v, StyleKeyword.Undefined) {}

    /// <summary>
    /// Creates from either a <see cref="Cursor"/> or <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleCursor(StyleKeyword keyword) : this(default(Cursor), keyword) {}
    ...
    public bool Equals(StyleCursor other) { return other == this; }
