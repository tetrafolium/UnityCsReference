...
namespace UnityEngine.UIElements {
  ...
  public struct StyleFloat : IStyleValue<float>, IEquatable<StyleFloat> {
    ...
    public float value {
      get {
        return m_Keyword == StyleKeyword.Undefined ? m_Value : default(float);
      }
      set {
        m_Value = value;
    ...
    /// </summary>
    public StyleFloat(float v) : this(v, StyleKeyword.Undefined) {}

    /// <summary>
    /// Creates from either a float or a <see cref="StyleKeyword"/>.
    /// </summary>
    public StyleFloat(StyleKeyword keyword) : this(default(float), keyword) {}
