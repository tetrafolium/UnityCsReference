...
namespace UnityEngine.UIElements {
  /// <summary>
  /// Style value that can be either a <see cref="Length"/> or a <see
  /// cref="StyleKeyword"/>.
  /// </summary>
  public struct StyleLength : IStyleValue<Length>, IEquatable<StyleLength> {
    ...
    /// <summary>
    /// Creates from either a <see cref="Length"/> or a <see
    /// cref="StyleKeyword"/>.
    /// </summary>
    ...
    /// cref="StyleKeyword"/>.
    /// </summary>
    public StyleLength(Length v) : this(v, StyleKeyword.Undefined) {}
