...
/// <summary>
/// Define a custom style property for an element to be retrieved with <see
/// cref="CustomStyleResolvedEvent"/>.
/// </summary>
public struct CustomStyleProperty<T> : IEquatable<CustomStyleProperty<T> > {
	...
	/// </summary>
	/// <param name="propertyName">Name of the property. Must start with a --
	/// prefix.</param>
	public CustomStyleProperty(string propertyName) {
		if (!String.IsNullOrEmpty(propertyName) && !propertyName.StartsWith("--"))
			throw new ArgumentException(
				      $"Custom style property \"{propertyName}\" must start with \"--\" prefix.");
	...
	public static bool operator ==(CustomStyleProperty<T> a,
	                               CustomStyleProperty<T> b) {
		return a.Equals(b);
	}
...
/// <summary>
/// This interface exposes methods to read custom style properties applied
/// from USS files to visual elements.
/// </summary>
public interface ICustomStyle {
/// <summary>
/// Gets the value associated with the specified <see
/// cref="CustomStyleProperty"/>.
/// </summary>
...
/// </summary>
/// <returns>True if the property is found, false if not.</returns>
bool TryGetValue(CustomStyleProperty<Texture2D> property,
                 out Texture2D value);
/// <summary>
/// Gets the value associated with the specified <see
/// cref="CustomStyleProperty"/>.
/// </summary>
/// <returns>True if the property is found, false if not.</returns>
bool TryGetValue(CustomStyleProperty<VectorImage> property,
