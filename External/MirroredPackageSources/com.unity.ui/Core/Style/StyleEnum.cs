...
namespace UnityEngine.UIElements {
  ...
  public struct StyleEnum<T> : IStyleValue<T>,
                               IEquatable<StyleEnum<T>> where T : struct,
                                                                  IConvertible {
    /// <summary>
    /// The style value.
    /// </summary>
    ...
    /// </summary>
    public StyleEnum(T v) : this(v, StyleKeyword.Undefined) {}

    /// <summary>
    /// Creates from either an enum or a <see cref="StyleKeyword"/>.
    /// </summary>
    public StyleEnum(StyleKeyword keyword) : this(default(T), keyword) {}
    ...
    public static bool operator ==(StyleEnum<T> lhs, StyleEnum<T> rhs) {
      return lhs.m_Keyword == rhs.m_Keyword &&
             UnsafeUtility.EnumEquals(lhs.m_Value, rhs.m_Value);
    }
    ...
    public bool Equals(StyleEnum<T> other) { return other == this; }
