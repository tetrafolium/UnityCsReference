...
namespace UnityEngine.UIElements {
  ...
  public struct Background : IEquatable<Background> {
    ...
    /// <summary>
    /// The texture to display as a background. You cannot set this and <see
    /// cref="Background.vectorImage"/> at the same time.
    /// </summary>
      ...
      set {
        if (value != null && vectorImage != null)
          throw new InvalidOperationException(
              "Cannot set both texture and vectorImage on Background object");
        m_Texture = value;
      }
    }
    ...
    /// <summary>
    /// The <see cref="VectorImage"/> to display as a background.  You cannot
    /// set this and <see cref="Background.texture"/> at the same time.
    /// </summary>
    ...
    public static bool operator ==(Background lhs, Background rhs) {
      return EqualityComparer<Texture2D>.Default.Equals(lhs.texture,
                                                        rhs.texture);
    }
    ...
    public bool Equals(Background other) { return other == this; }
    ...
    public override int GetHashCode() {
      ...
      if (texture != null)
        hashCode = hashCode * -1521134295 +
                   EqualityComparer<Texture2D>.Default.GetHashCode(texture);
      if (vectorImage != null)
        hashCode =
            hashCode * -1521134295 +
            EqualityComparer<VectorImage>.Default.GetHashCode(vectorImage);
      return hashCode;
    }

    public override string ToString() { return $"{texture}"; }
  }
}
