...
internal enum StyleValueFunction { Unknown, Var, Env, LinearGradient }
...
public static StyleValueFunction FromUssString(string ussValue) {
	...
	default:
		throw new ArgumentOutOfRangeException(nameof(ussValue), ussValue,
...
public static string ToUssString(this StyleValueFunction svf) {
	...
	default:
		throw new ArgumentOutOfRangeException(
			      nameof(svf), svf, $"Unknown {nameof(StyleValueFunction)}");
	}
}
}
}
