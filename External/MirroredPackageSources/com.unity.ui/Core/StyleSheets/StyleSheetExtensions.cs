...
namespace UnityEngine.UIElements.StyleSheets {
  static class StyleSheetExtensions {
    public static string ReadAsString(this StyleSheet sheet,
      ...
      case StyleValueType.ScalableImage:
        ...
        break;
      default:
        value = "Error reading value type (" + handle.valueType +
                ") at index " + handle.valueIndex;
        break;
      }
    ...
    public static bool IsVarFunction(this StyleValueHandle handle) {
      return handle.valueType == StyleValueType.Function &&
             (StyleValueFunction) handle.valueIndex == StyleValueFunction.Var;
    }
  }
}
