...
// Returns a matrix that maps (left, bottom, near) to (-1, -1, -1) and
// (right, top, far) to (1, 1, 1) Warning: Do not confuse this with
// Matrix4x4.Ortho.
public static Matrix4x4 Ortho(float left, float right, float bottom,
