namespace UnityEngine.UIElements {
  ...
  public abstract class PointerManipulator : MouseManipulator {
    ...
    /// <summary>
    /// Checks whether PointerEvent satisfies all of the
    /// ManipulatorActivationFilter requirements.
    /// </summary>
    /// <param name="e">The PointerEvent to validate.</param>
    /// <returns>True if the event satisfies the requirements. False
    /// otherwise.</returns>
    ...
    /// <returns>True if PointerEvent uses the current activator button. False
    /// otherwise.</returns>
