...
public partial class VisualElement : Focusable, ITransform
{
    ...
    public class UxmlTraits : UIElements.UxmlTraits
    {
        ...
        protected UxmlIntAttributeDescription focusIndex {
            get;
            set;
        } = new UxmlIntAttributeDescription { name = null, obsoleteNames = new[] { "focus-index", "focusIndex" }, defaultValue = -1 };
        ...
        protected UxmlBoolAttributeDescription focusable {
            get;
            set;
        } = new UxmlBoolAttributeDescription { name = "focusable", defaultValue = false };
...
#pragma warning restore
    ...
    {
        get {
            return panel == null ? GUIUtility.pixelsPerPoint : (panel as BaseVisualElementPanel).scaledPixelsPerPoint;
        }
    }
