...
/// </summary>
/// <returns>True if the object already has event handlers for the
/// TrickleDown phase.</returns>
...
/// </summary>
/// <returns>True if object has event handlers for the BubbleUp
/// phase.</returns>
...
/// been registered for the same phase (either TrickleDown or BubbleUp) then
/// this method has no effect.
/// </summary>
/// <param name="callback">The event handler to add.</param>
/// <param name="useTrickleDown">By default, this callback is called during
/// the BubbleUp phase. Pass TrickleDown.TrickleDown to call this callback
/// during the TrickleDown phase.</param>
...
new () {
	...
	m_CallbackRegistry.RegisterCallback<TEventType, TUserArgsType>(
		callback, userArgs, useTrickleDown);
	GlobalCallbackRegistry.RegisterListeners<TEventType>(this, callback,
	                                                     useTrickleDown);
}
...
/// <param name="useTrickleDown">Set this parameter to true to remove the
/// callback from the TrickleDown phase. Set this parameter to false to
/// remove the callback from the BubbleUp phase.</param>
...
internal bool TryGetUserArgs<TEventType, TCallbackArgs>(
	...
	TrickleDown useTrickleDown, out TCallbackArgs userData) where TEventType
: EventBase<TEventType>,
new () {
	userData = default(TCallbackArgs);

	if (m_CallbackRegistry != null) {
		return m_CallbackRegistry.TryGetUserArgs(callback, useTrickleDown,
		                                         out userData);
	}
...
/// phase, are attached to this object.
/// </summary>
/// <returns>True if object has event handlers for the TrickleDown
/// phase.</returns>
public bool HasTrickleDownHandlers() {
	return m_CallbackRegistry != null &&
	       m_CallbackRegistry.HasTrickleDownHandlers();
}
...
public bool HasBubbleUpHandlers() {
	return m_CallbackRegistry != null &&
	       m_CallbackRegistry.HasBubbleHandlers();
}
