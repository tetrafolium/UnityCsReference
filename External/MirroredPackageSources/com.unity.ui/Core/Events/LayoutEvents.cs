namespace UnityEngine.UIElements {
  /// <summary>
  /// Event sent after layout calculations, when the position or the dimension
  /// of an element changes. This event cannot be cancelled, it does not trickle
  /// down, and it does not bubble up.
  /// </summary>
  public class GeometryChangedEvent : EventBase<GeometryChangedEvent> {
    /// <summary>
    /// Gets an event from the event pool and initializes the event with the
    /// specified values. Use this method instead of instancing new events. Use
    /// Dispose() to release events back to the event pool.
    /// </summary>
    ...
    /// Constructor.
    /// </summary>
    public GeometryChangedEvent() { LocalInit(); }
  }
}
