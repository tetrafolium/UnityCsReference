...
namespace UnityEngine.UIElements {
  ...
  /// </summary>
  /// <remarks>
  /// This event can be used instead of <see cref="VisualElement.tooltip"/> to
  /// compute tooltips only when they are about to be displayed.
  /// </remarks>
