namespace UnityEngine.UIElements {
  static class PointerDeviceState {
    ...
    public static void SavePointerPosition(int pointerId, Vector2 position,
                                           IPanel panel) {
    ...
    public static IPanel GetPanel(int pointerId) { return m_Panels[pointerId]; }

    public static int GetPressedButtons(int pointerId) {
      return m_PressedButtons[pointerId];
    }

    internal static bool HasAdditionalPressedButtons(int pointerId,
                                                     int exceptButtonId) {
