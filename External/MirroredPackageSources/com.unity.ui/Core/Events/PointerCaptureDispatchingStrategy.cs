...
namespace UnityEngine.UIElements {
  class PointerCaptureDispatchingStrategy : IEventDispatchingStrategy {
    public bool CanDispatchEvent(EventBase evt) { return evt is IPointerEvent; }
    ...
    public void DispatchEvent(EventBase evt, IPanel panel) {
      ...
      IEventHandler targetOverride =
          panel.GetCapturingElement(pointerEvent.pointerId);
      ...
      if (evt.eventTypeId != PointerCaptureOutEvent.TypeId() &&
      ...
      if (evt.eventTypeId != PointerCaptureEvent.TypeId() &&
