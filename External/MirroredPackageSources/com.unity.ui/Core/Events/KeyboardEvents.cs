namespace UnityEngine.UIElements {
  ...
  public interface IKeyboardEvent {
    /// <summary>
    /// Flag set holding the pressed modifier keys (Alt, Control, Shift,
    /// Windows/Command).
    /// </summary>
  ...
  /// </summary>
  public abstract class KeyboardEventBase<T>
      : EventBase<T>, IKeyboardEvent where T : KeyboardEventBase<T>, new () {
    /// <summary>
    ...
    // FIXME: see
    // https://www.w3.org/TR/DOM-Level-3-Events/#interface-keyboardevent for
    // key, code and location values.
    /// <summary>
    ...
    /// <summary>
    /// Gets a keyboard event from the event pool and initializes it with the
    /// given values. Use this function instead of creating new events. Events
    ...
    /// <param name="modifiers">Event modifier keys that are active for this
    /// event.</param> <returns>An initialized event.</returns>
    public static T GetPooled(char c, KeyCode keyCode,
    ...
    protected KeyboardEventBase() { LocalInit(); }
  }

  /// <summary>
  /// Event sent when a key is pressed on the keyboard. This event trickles down
  /// and bubbles up. This event is cancellable.
  /// </summary>
  public class KeyDownEvent : KeyboardEventBase<KeyDownEvent> {}

  /// <summary>
  /// Event sent when a key is released on the keyboard. This event trickles
  /// down and bubbles up. This event is cancellable.
  /// </summary>
