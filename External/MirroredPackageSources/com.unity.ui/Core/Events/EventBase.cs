...
namespace UnityEngine.UIElements {
  ...
  public abstract class EventBase : IDisposable {
    ...
    internal void SetTriggerEventId(ulong id) { triggerEventId = id; }
    ...
    internal PropagationPaths path {
      get {
        if (m_Path == null) {
          PropagationPaths.Type pathTypesRequested =
              (tricklesDown ? PropagationPaths.Type.TrickleDown
               : PropagationPaths.Type.None);
          pathTypesRequested |= (bubbles ? PropagationPaths.Type.BubbleUp
                                 : PropagationPaths.Type.None);
          m_Path = PropagationPaths.Build(leafTarget as VisualElement,
                                          pathTypesRequested);
...
#pragma warning restore 618
    ...
    // Original target. May be different than 'target' when propagating event
    // and 'target.isCompositeRoot' is true
    ...
    /// <summary>
    /// The target visual element that received this event. Unlike
    /// currentTarget, this target does not change when the event is sent to
    /// other elements along the propagation path.
    /// </summary>
    ...
    internal bool Skip(IEventHandler h) { return skipElements.Contains(h); }
    ...
    public bool isPropagationStopped {
      get {
        return (lifeCycleStatus & LifeCycleStatus.PropagationStopped) !=
    ...
    /// <summary>
    /// Stops propagating this event. The event is not sent to other elements
    /// along the propagation path. This method does not prevent other event
    ...
    public bool isImmediatePropagationStopped {
      get {
        return (lifeCycleStatus &
                LifeCycleStatus.ImmediatePropagationStopped) !=
               LifeCycleStatus.None;
      }
      private set {
        if (value) {
    ...
    /// <summary>
    /// Immediately stops the propagation of the event. The event is not sent to
    /// other elements along the propagation path. This method prevents other
    /// event handlers from executing on the current target.
    /// </summary>
    ...
    /// <summary>
    /// Return true if the default actions should not be executed for this
    /// event.
    /// </summary>
    public bool isDefaultPrevented {
      get {
        return (lifeCycleStatus & LifeCycleStatus.DefaultPrevented) !=
               LifeCycleStatus.None;
      }
      private set {
        if (value) {
    ...
    /// <summary>
    /// Whether the default actions are prevented from being executed for this
    /// event.
    /// </summary>
    public void PreventDefault() {
      if ((propagation & EventPropagation.Cancellable) ==
    ...
    /// <summary>
    /// The current target of the event. This is the VisualElement, in the
    ...
    public virtual IEventHandler currentTarget {
      ...
      internal set {
        ...
        if (imguiEvent != null) {
          ...
          if (element != null) {
            imguiEvent.mousePosition =
                element.WorldToLocal(originalMousePosition);
          } else {
    ...
    public bool dispatch {
      get {
        return (lifeCycleStatus & LifeCycleStatus.Dispatching) !=
               LifeCycleStatus.None;
      }
      internal set {
        if (value) {
    ...
    bool dispatched {
      get {
        return (lifeCycleStatus & LifeCycleStatus.Dispatched) !=
               LifeCycleStatus.None;
      }
      set {
        if (value) {
    ...
    internal bool processed {
      get {
        return (lifeCycleStatus & LifeCycleStatus.Processed) !=
               LifeCycleStatus.None;
      }
      private set {
        if (value) {
    ...
    internal bool stopDispatch {
      get {
        return (lifeCycleStatus & LifeCycleStatus.StopDispatch) !=
               LifeCycleStatus.None;
      }
      set {
        if (value) {
    ...
    internal bool propagateToIMGUI {
      get {
        return (lifeCycleStatus & LifeCycleStatus.PropagateToIMGUI) !=
               LifeCycleStatus.None;
      }
      set {
        if (value) {
    ...
    // Since we recycle events (in their pools) and we do not free/reallocate a
    // new imgui event at each recycling (m_ImguiEvent is never null), we use
    // this flag to know whether m_ImguiEvent represents a valid Event.
    bool imguiEventIsValid {
      get {
        return (lifeCycleStatus & LifeCycleStatus.IMGUIEventIsValid) !=
               LifeCycleStatus.None;
      }
      set {
        if (value) {
      ...
      protected set {
        ...
        if (value != null) {
          ...
          originalMousePosition =
              value.mousePosition; // when assigned, it is assumed that the
                                   // imguievent is not touched and therefore in
                                   // world coordinates.
        } else {
    ...
    protected bool pooled {
      get {
        return (lifeCycleStatus & LifeCycleStatus.Pooled) !=
               LifeCycleStatus.None;
      }
      set {
        if (value) {
  ...
  /// <summary>
  /// Generic base class for events, implementing event pooling and automatic
  /// registration to the event type system.
  /// </summary>
  public abstract class EventBase<T> : EventBase where T : EventBase<T>,
                                                           new () {
    ...
    protected EventBase() { m_RefCount = 0; }

    /// <summary>
    /// Retrieves the type ID for this event instance.
    /// </summary>
    /// <returns>The type ID.</returns>
    public static long TypeId() { return s_TypeId; }
    ...
    /// <summary>
    /// Gets an event from the event pool. Use this function instead of creating
    /// new events. Events obtained using this method need to be released back
    /// to the pool. You can use `Dispose()` to release them.
    /// </summary>
    ...
    internal override void Acquire() { m_RefCount++; }

    /// <summary>
    /// Implementation of IDispose.
    /// </summary>
    /// <remarks>
    /// If the event was instantiated from an event pool, the event is released
