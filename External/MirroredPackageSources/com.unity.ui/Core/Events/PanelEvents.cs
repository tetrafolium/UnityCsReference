namespace UnityEngine.UIElements {
  ...
  /// </summary>
  public abstract class PanelChangedEventBase<T> : EventBase<T>,
                                                   IPanelChangedEvent where T
    ...
    /// </summary>
    /// <param name="originPanel">Sets the originPanel property of the
    /// event.</param> <param name="destinationPanel">Sets the destinationPanel
    /// property of the event.</param> <returns>An initialized event.</returns>
    ...
    protected PanelChangedEventBase() { LocalInit(); }
  }

  /// <summary>
  /// Event sent after an element is added to an element that is a descendent of
  /// a panel.
  /// </summary>
  public class AttachToPanelEvent : PanelChangedEventBase<AttachToPanelEvent> {}

  /// <summary>
  /// Event sent just before an element is detach from its parent, if the parent
  /// is the descendant of a panel.
  /// </summary>
  public class DetachFromPanelEvent
      : PanelChangedEventBase<DetachFromPanelEvent> {}
}
