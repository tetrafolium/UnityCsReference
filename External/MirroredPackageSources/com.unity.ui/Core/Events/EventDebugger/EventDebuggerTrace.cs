namespace UnityEngine.UIElements {
  class EventDebuggerTrace {
    ...
    public EventDebuggerTrace(IPanel panel, EventBase evt, long duration,
  ...
  class EventDebuggerCallTrace : EventDebuggerTrace {
    ...
    public EventDebuggerCallTrace(IPanel panel, EventBase evt, int cbHashCode,
                                  string cbName, bool propagationHasStopped,
  ...
  class EventDebuggerDefaultActionTrace : EventDebuggerTrace {
    ...
    public EventDebuggerDefaultActionTrace(IPanel panel, EventBase evt,
  ...
  class EventDebuggerPathTrace : EventDebuggerTrace {
    ...
    public EventDebuggerPathTrace(IPanel panel, EventBase evt,
