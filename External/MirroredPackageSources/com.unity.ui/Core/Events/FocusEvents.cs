namespace UnityEngine.UIElements {
  ...
  /// </summary>
  public abstract class FocusEventBase<T>
      : EventBase<T>, IFocusEvent where T : FocusEventBase<T>, new () {
    /// <summary>
    ...
    public static T GetPooled(IEventHandler target, Focusable relatedTarget,
    ...
    protected FocusEventBase() { LocalInit(); }
  }

  /// <summary>
  /// Event sent immediately before an element loses focus. This event trickles
  /// down and bubbles up. This event cannot be cancelled.
  /// </summary>
  public class FocusOutEvent : FocusEventBase<FocusOutEvent> {
    ...
    /// </summary>
    public FocusOutEvent() { LocalInit(); }
  }

  /// <summary>
  /// Event sent immediately after an element has lost focus. This event
  /// trickles down, it does not bubble up, and it cannot be cancelled.
  /// </summary>
  ...
  /// <summary>
  /// Event sent immediately before an element gains focus. This event trickles
  /// down and bubbles up. This event cannot be cancelled.
  /// </summary>
  public class FocusInEvent : FocusEventBase<FocusInEvent> {
    ...
    /// Constructor.
    /// </summary>
    public FocusInEvent() { LocalInit(); }
  }

  /// <summary>
  /// Event sent immediately after an element has gained focus. This event
  /// trickles down, it does not bubble up, and it cannot be cancelled.
  /// </summary>
