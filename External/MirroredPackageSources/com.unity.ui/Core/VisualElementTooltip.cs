...
/// <summary>
/// Text to display inside an information box after the user hovers the
/// element for a small amount of time.
/// </summary>
public string tooltip {
	get {
		string userArg;
		TryGetUserArgs<TooltipEvent, string>(
			OnTooltip, TrickleDown.NoTrickleDown, out userArg);
