...
namespace UnityEditor.UIElements.Debugger {
  internal class StyleLengthField : TextValueField<StyleLength> {
    ...
    public StyleLengthField(int maxLength) : this(null, maxLength) {}
    ...
    private static StyleLength ParseString(string str,
                                           StyleLength defaultValue) {
    ...
    class LengthInput : TextValueInput {
      ...
      public override void ApplyInputDeviceDelta(Vector3 delta,
                                                 DeltaSpeed speed,
                                                 StyleLength startValue) {
        ...
        double sensitivity =
            NumericFieldDraggerUtility.CalculateIntDragSensitivity(
                (long) startValue.value.value);
        ...
        if (parentLengthField.isDelayed) {
          ...
          Length l = new Length(MathUtils.ClampToInt(v),
                                parentLengthField.value.value.unit);
