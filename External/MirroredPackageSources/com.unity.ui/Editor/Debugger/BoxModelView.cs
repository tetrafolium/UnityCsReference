...
namespace UnityEditor.UIElements.Debugger {
  internal class BoxModelView : VisualElement {
    ...
    enum SideChanged { Left, Right, Top, Bottom }
    ...
    private VisualElement m_BottomTextFieldMarginContainer =
        new VisualElement();
    private VisualElement m_BottomTextFieldBorderContainer =
        new VisualElement();
    private VisualElement m_BottomTextFieldPaddingContainer =
        new VisualElement();
    ...
    public BoxModelView() {
      ...
      m_TopTextFieldMarginContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");

      m_BottomTextFieldMarginContainer.pickingMode = PickingMode.Ignore;
      m_BottomTextFieldMarginContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");

      m_TopTextFieldBorderContainer.pickingMode = PickingMode.Ignore;
      m_TopTextFieldBorderContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");

      m_BottomTextFieldBorderContainer.pickingMode = PickingMode.Ignore;
      m_BottomTextFieldBorderContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");

      m_TopTextFieldPaddingContainer.pickingMode = PickingMode.Ignore;
      m_TopTextFieldPaddingContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");

      m_BottomTextFieldPaddingContainer.pickingMode = PickingMode.Ignore;
      m_BottomTextFieldPaddingContainer.AddToClassList(
          "box-model-textfield-top-bottom-spacer");
    ...
    class BoxModelElement : VisualElement {
      ...
      public BoxModelElement(BoxType boxType, VisualElement content,
                             VisualElement topTextFieldContainer,
                             VisualElement bottomTextFieldContainer) {
        string title = "";
        switch (boxType) {
        case BoxType.Margin:
          title = "margin";
        ...
        m_LeftTextField.RegisterValueChangedCallback(
            e => OnTextFieldValueChanged(e, SideChanged.Left));

        m_RightTextField = new IntegerField();
        m_RightTextField.AddToClassList("box-model-textfield");
        m_RightTextField.RegisterValueChangedCallback(
            e => OnTextFieldValueChanged(e, SideChanged.Right));

        m_TopTextField = new IntegerField();
        m_TopTextField.AddToClassList("box-model-textfield");
        m_TopTextField.RegisterValueChangedCallback(
            e => OnTextFieldValueChanged(e, SideChanged.Top));
        ...
        m_BottomTextField.RegisterValueChangedCallback(
            e => OnTextFieldValueChanged(e, SideChanged.Bottom));
      ...
      private void OnTextFieldValueChanged(ChangeEvent<int> evt,
    ...
    class ContentBox : VisualElement {
      ...
      public void SelectElement(VisualElement ve) {
        ...
        if (ve != null) {
          m_WidthTextField.SetValueWithoutNotify(
              (int) m_SelectedElement.contentRect.width);
          m_HeightTextField.SetValueWithoutNotify(
              (int) m_SelectedElement.contentRect.height);
        } else {
      ...
      private void OnWidthChanged(ChangeEvent<int> evt) {
        ...
        var newValue = evt.newValue + style.paddingLeft + style.paddingRight +
      ...
      private void OnHeightChanged(ChangeEvent<int> evt) {
        var style = m_SelectedElement.resolvedStyle;
        var newValue = evt.newValue + style.paddingTop + style.paddingBottom +
