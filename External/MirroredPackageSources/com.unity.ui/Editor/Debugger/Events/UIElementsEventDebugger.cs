...
class UIElementsEventsDebuggerImpl : PanelDebugger
{
    ...
    static void AddHistogramEntry(VisualElement root, string name, long duration, float percent)
    {
        ...
        var labelNameDuration = new Label(name) {
            name = k_EventsDurationLabelName, text = durationLength + "ms"
        };
        var durationGraphLength = new VisualElement() {
    ...
    public void Initialize(EditorWindow debuggerWindow, VisualElement root)
    {
        ...
        clearLogsButton.clickable.clicked += () => {
            ClearLogs();
        };
        ...
        autoScrollToggle.RegisterValueChangedCallback((e) => {
            m_AutoScroll = e.newValue;
        });
    ...
    {
        m_LegendContainer = new VisualElement() {
