...
// This file is modified to set a managed object reference on the native side
// when a callback is set on a node. The facebook implementation use the YGNode
// context to create a mapping between IntPtr and managed objects (YGNodeHandle
// SetContext and GetManaged). However, this require pinning the managed objects
// in the GC and since there might be quite a few nodes alive at the same time
// we avoid that and use a weak GC handle in the native code instead. END_UNITY
namespace UnityEngine.Yoga {
  internal partial class YogaNode : IEnumerable<YogaNode> {
    // BEGIN_UNITY @jonathanma _ygNode needs to be accessible on UWP (see
    // YogaNodeIntPtrMarshaler)
    ...
    ~YogaNode() { Native.YGNodeFree(_ygNode); }
    ...
    public void Reset() {
      ...
      // BEGIN_UNITY @jonathanma Remove Context usage and YGNodeHandle, native
      // YGNode has a reference of the managed object
    ...
    public bool IsDirty {
      get { return Native.YGNodeIsDirty(_ygNode); }
    }

    public virtual void MarkDirty() { Native.YGNodeMarkDirty(_ygNode); }

    public bool HasNewLayout {
      get { return Native.YGNodeGetHasNewLayout(_ygNode); }
    }
    ...
    public YogaNode Parent {
      get { return _parent != null ? _parent.Target as YogaNode : null; }
    }

    public bool IsMeasureDefined {
      get { return _measureFunction != null; }
    }

    public bool IsBaselineDefined {
      get { return _baselineFunction != null; }
    }
    ...
    public YogaDirection StyleDirection {
      get { return Native.YGNodeStyleGetDirection(_ygNode); }

      set { Native.YGNodeStyleSetDirection(_ygNode, value); }
    }

    public YogaFlexDirection FlexDirection {
      get { return Native.YGNodeStyleGetFlexDirection(_ygNode); }

      set { Native.YGNodeStyleSetFlexDirection(_ygNode, value); }
    }

    public YogaJustify JustifyContent {
      get { return Native.YGNodeStyleGetJustifyContent(_ygNode); }

      set { Native.YGNodeStyleSetJustifyContent(_ygNode, value); }
    }

    public YogaDisplay Display {
      get { return Native.YGNodeStyleGetDisplay(_ygNode); }

      set { Native.YGNodeStyleSetDisplay(_ygNode, value); }
    }

    public YogaAlign AlignItems {
      get { return Native.YGNodeStyleGetAlignItems(_ygNode); }

      set { Native.YGNodeStyleSetAlignItems(_ygNode, value); }
    }

    public YogaAlign AlignSelf {
      get { return Native.YGNodeStyleGetAlignSelf(_ygNode); }

      set { Native.YGNodeStyleSetAlignSelf(_ygNode, value); }
    }

    public YogaAlign AlignContent {
      get { return Native.YGNodeStyleGetAlignContent(_ygNode); }

      set { Native.YGNodeStyleSetAlignContent(_ygNode, value); }
    }

    public YogaPositionType PositionType {
      get { return Native.YGNodeStyleGetPositionType(_ygNode); }

      set { Native.YGNodeStyleSetPositionType(_ygNode, value); }
    }

    public YogaWrap Wrap {
      get { return Native.YGNodeStyleGetFlexWrap(_ygNode); }
    ...
    public float FlexGrow {
      get { return Native.YGNodeStyleGetFlexGrow(_ygNode); }

      set { Native.YGNodeStyleSetFlexGrow(_ygNode, value); }
    }

    public float FlexShrink {
      get { return Native.YGNodeStyleGetFlexShrink(_ygNode); }
    ...
    public float AspectRatio {
      get { return Native.YGNodeStyleGetAspectRatio(_ygNode); }

      set { Native.YGNodeStyleSetAspectRatio(_ygNode, value); }
    }

    public float LayoutX {
      get { return Native.YGNodeLayoutGetLeft(_ygNode); }
    }

    public float LayoutY {
      get { return Native.YGNodeLayoutGetTop(_ygNode); }
    }

    public float LayoutRight {
      get { return Native.YGNodeLayoutGetRight(_ygNode); }
    }

    public float LayoutBottom {
      get { return Native.YGNodeLayoutGetBottom(_ygNode); }
    }

    public float LayoutWidth {
      get { return Native.YGNodeLayoutGetWidth(_ygNode); }
    }

    public float LayoutHeight {
      get { return Native.YGNodeLayoutGetHeight(_ygNode); }
    }

    public YogaDirection LayoutDirection {
      get { return Native.YGNodeLayoutGetDirection(_ygNode); }
    }

    public YogaOverflow Overflow {
      get { return Native.YGNodeStyleGetOverflow(_ygNode); }
    ...
    public void AddChild(YogaNode child) { Insert(Count, child); }
    ...
    public void CalculateLayout(float width = YogaConstants.Undefined,
                                float height = YogaConstants.Undefined) {
      Native.YGNodeCalculateLayout(_ygNode, width, height,
    ...
    // END_UNITY
    public static YogaSize MeasureInternal(YogaNode node, float width,
    ...
    // IntPtr unmanagedNodePtr,
    // END_UNITY
    public static float BaselineInternal(YogaNode node, float width,
                                         float height) {
      if (node == null || node._baselineFunction == null) {
        throw new InvalidOperationException(
            "Baseline function is not defined.");
      }
      return node._baselineFunction(node, width, height);
    }

    public string Print(YogaPrintOptions options = YogaPrintOptions.Layout |
                                                   YogaPrintOptions.Style |
                                                   YogaPrintOptions.Children) {
      StringBuilder sb = new StringBuilder();
      Logger orig = _config.Logger;
      _config.Logger =
          (config, node, level, message) => { sb.Append(message); };
    ...
    public IEnumerator<YogaNode> GetEnumerator() {
      return _children != null ?((IEnumerable<YogaNode>) _children)
                              .GetEnumerator()
          : System.Linq.Enumerable.Empty<YogaNode>()
                              .GetEnumerator();
    }
