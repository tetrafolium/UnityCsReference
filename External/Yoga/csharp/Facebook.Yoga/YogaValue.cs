...
namespace UnityEngine.Yoga {
  ...
  internal struct YogaValue {
    ...
    public static YogaValue Point(float value) {
      return new YogaValue{value = value,
                           unit = YogaConstants.IsUndefined(value)
                                      ? YogaUnit.Undefined
                                      : YogaUnit.Point};
    }
    ...
    public bool Equals(YogaValue other) {
      return Unit == other.Unit &&
             (Value.Equals(other.Value) || Unit == YogaUnit.Undefined);
    }
    ...
    public override int GetHashCode() {
      unchecked { return (Value.GetHashCode() * 397) ^ (int) Unit; }
    }

    public static YogaValue Undefined() {
      return new YogaValue{value = YogaConstants.Undefined,
    ...
    internal static YogaValue MarshalValue(YogaValue value) { return value; }
  }
}
