...
// The facebook implementation use the YGConfig context to keep a mapping
// between the native and managed object. However, since we don't really use
// YogaConfig this has been removed to avoid pinning the object. END_UNITY
namespace UnityEngine.Yoga {
  internal class YogaConfig {
    internal static readonly YogaConfig Default =
        new YogaConfig(Native.YGConfigGetDefault());
    ...
    public void SetExperimentalFeatureEnabled(YogaExperimentalFeature feature,
                                              bool enabled) {
    ...
    public bool UseWebDefaults {
      get { return Native.YGConfigGetUseWebDefaults(_ygConfig); }

      set { Native.YGConfigSetUseWebDefaults(_ygConfig, value); }
    }

    public float PointScaleFactor {
      get { return Native.YGConfigGetPointScaleFactor(_ygConfig); }
