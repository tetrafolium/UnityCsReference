...
internal class StageNavigationManager : ScriptableSingleton<StageNavigationManager>
{
    ...
    {
        get {
            return m_NavigationHistory.currentStage;
        }
    ...
    {
        get {
            return m_NavigationHistory.GetMainStage();
        }
    }
    ...
    {
        get {
            return m_NavigationHistory.GetHistory();
        }
    }
    ...
    internal bool autoSave
    {
        ...
        set {
            m_AutoSave.value = value;
        }
    }
    internal StageUtility.ContextRenderMode contextRenderMode
    {
        get {
            return (StageUtility.ContextRenderMode)m_ContextRenderMode.value;
        }
        set {
            m_ContextRenderMode.value = (int)value;
        }
    }
