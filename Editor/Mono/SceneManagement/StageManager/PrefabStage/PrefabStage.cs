...
public sealed partial class PrefabStage : PreviewSceneStage
{
    ...
    internal static ReadOnlyCollection<PrefabStage> allPrefabStages {
        get {
            return m_AllPrefabStages.AsReadOnly();
        }
    }
    ...
    internal bool analyticsDidUserModify {
        get {
            return m_AnalyticsDidUserModify;
        }
    }
    internal bool analyticsDidUserSave {
        get {
            return m_AnalyticsDidUserSave;
        }
    }
    ...
    {
        get {
            return m_OpenedFromInstanceRoot;
        }
    }
    ...
    {
        get {
            return m_OpenedFromInstanceObject;
        }
    }
    ...
    {
        get {
            return StageUtility.GetCurrentStage() == this;
        }
    }
    ...
    internal override bool hasUnsavedChanges {
        get {
            return scene.dirtyID != m_InitialSceneDirtyID;
        }
    }
    ...
    {
        get {
            return !m_TemporarilyDisableAutoSave && StageNavigationManager.instance.autoSave;
        }
        set {
    ...
    {
        get {
            return m_TemporarilyDisableAutoSave || isAssetMissing;
        }
    }
    ...
    {
        get {
            return m_PrefabContentsRoot != null && m_PrefabContentsRoot.scene == scene;
        }
    }
    ...
    {
        get {
            return EditorGUI.IsEditingTextField() && !EditorGUIUtility.textFieldHasSelection;
        }
    }
    ...
    {
        get {
            return m_PrefabContentsRoot != null && hasUnsavedChanges && GUIUtility.hotControl == 0 && !isTextFieldCaretShowing && !EditorApplication.isCompiling;
        }
    }
