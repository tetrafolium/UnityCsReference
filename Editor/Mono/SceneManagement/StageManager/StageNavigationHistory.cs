...
namespace UnityEditor.SceneManagement {
  ...
  internal class StageNavigationHistory {
    [SerializeField] List<Stage> m_History = new List<Stage>();
    ...
    internal void Init() { SetMainStage(MainStage.CreateMainStage()); }
    ...
    public ReadOnlyCollection<Stage> GetHistory() { return m_ReadOnlyHistory; }
    ...
    public int GetStageCount() { return m_History.Count; }
