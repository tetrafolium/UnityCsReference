...
internal static class SJSON {
  ...
  [NativeThrows]
  public static extern JSONObject Decode([ NotNull ] byte[] sjson);
  [NativeThrows]
  public static extern object DecodeObject([ NotNull ] byte[] sjson);
  ...
  [RequiredByNativeCode]
  internal static void AddJSONKeyValue(JSONObject ht, string key,
                                       object value) {
    ht.Add(key, value);
  }
