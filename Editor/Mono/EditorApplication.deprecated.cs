...
[Obsolete(
	 "Use EditorSceneManager.NewScene (NewSceneSetup.DefaultGameObjects)")]
...
public static void OpenSceneAdditive(string path) {
	...
	// consistent with EditorSceneManager.OpenScene(path,
...
[Obsolete(
	 "Use EditorSceneManager.MarkSceneDirty or EditorSceneManager.MarkAllScenesDirty")]
public static void MarkSceneDirty() {
	EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
}

[Obsolete(
	 "Use Scene.isDirty instead. Use EditorSceneManager.GetScene API to get each open scene")]
