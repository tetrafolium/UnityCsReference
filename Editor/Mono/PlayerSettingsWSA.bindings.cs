...
public sealed partial class PlayerSettings : UnityEngine.Object
{
    ...
    public sealed partial class WSA
    {
        ...
        {
            get {
                return NullIfEmpty(internalCertificateSubject);
            }
        }
        ...
        {
            get {
                return NullIfEmpty(internalCertificateIssuer);
            }
        }
        ...
        {
            get {
                return inputSource == WSAInputSource.IndependentInputSource;
            }
            set {
                inputSource = value ? WSAInputSource.IndependentInputSource : WSAInputSource.CoreWindow;
            }
        }
