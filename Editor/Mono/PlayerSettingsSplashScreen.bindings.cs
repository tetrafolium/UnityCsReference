...
public partial class PlayerSettings {
  partial struct SplashScreenLogo {
    ...
    public static PlayerSettings.SplashScreenLogo
    Create([ DefaultValue("k_MinLogoTime") ] float duration,
           [ DefaultValue("null") ] Sprite logo) {
      return new PlayerSettings.SplashScreenLogo{m_Duration = duration,
                                                 m_Logo = logo};
    }
    ...
    public static PlayerSettings.SplashScreenLogo
    CreateWithUnityLogo([ DefaultValue("k_MinLogoTime") ] float duration) {
  ...
  public partial class SplashScreen {
    ...
    public static extern AnimationMode animationMode {
      get;
      set;
    }
    ...
    public static extern Sprite background {
      [FreeFunction("GetSplashScreenBackgroundSourceLandscape")] get;
      [FreeFunction("SetSplashScreenBackgroundSourceLandscape")] set;
    }

    public static extern Sprite backgroundPortrait {
      [FreeFunction("GetSplashScreenBackgroundSourcePortrait")] get;
      [FreeFunction("SetSplashScreenBackgroundSourcePortrait")] set;
    }

    public static extern bool blurBackgroundImage {
      [FreeFunction("GetBlurSplashScreenBackground")] get;
      [FreeFunction("SetBlurSplashScreenBackground")] set;
    }

    [NativeName("SplashScreenBackgroundColor")]
    public static extern Color backgroundColor {
      get;
      set;
    }

    [NativeName("SplashScreenDrawMode")]
    public static extern DrawMode drawMode {
      get;
      set;
    }

    [NativeName("SplashScreenLogos")]
    public static extern SplashScreenLogo[] logos {
      get;
      [FreeFunction("SetLogos")] set;
    }
    ...
    public static extern UnityLogoStyle unityLogoStyle {
      get;
      set;
    }
  }
