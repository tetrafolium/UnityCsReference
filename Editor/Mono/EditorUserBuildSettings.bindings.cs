...
public enum PS4HardwareTarget {
  ...
  [Obsolete(
      "Enum member PS4HardwareTarget.NeoAndBase has been deprecated. Use PS4HardwareTarget.ProAndBase instead (UnityUpgradable) -> ProAndBase",
      true)] NeoAndBase = 1,
...
[Obsolete(
    "UnityEditor.AndroidBuildSubtarget has been deprecated. Use UnityEditor.MobileTextureSubtarget instead (UnityUpgradable)",
    true)]
[NativeType(Header = "Editor/Src/EditorUserBuildSettings.h")]
...
public enum MobileTextureSubtarget {
  ...
  // SGX530/540 GPU, such as Motorola DROID series; Samsung Galaxy S, Nexus S,
  // and Galaxy Tab; and others.
  PVRTC = 2,
  [ System.Obsolete(
      "UnityEditor.MobileTextureSubtarget.ATC has been deprecated. Use UnityEditor.MobileTextureSubtarget.ETC instead (UnityUpgradable) -> UnityEditor.MobileTextureSubtarget.ETC",
      true) ] ATC = 3,
  // ETC1 texture compression (or RGBA16 for textures with alpha), supported by
  // all devices.
  ETC = 4,
...
public enum AndroidBuildSystem {
  ...
  [Obsolete(
      "Internal build system has been deprecated. Use Gradle instead (UnityUpgradable) -> UnityEditor.AndroidBuildSystem.Gradle",
      true)] Internal = 0,
  Gradle = 1,
  [System.ComponentModel.EditorBrowsable(EditorBrowsableState.Never)]
  [Obsolete(
      "ADT/eclipse project export for Android is no longer supported - please use Gradle export instead",
      true)] ADT = 2,
  /// *undocumented*
  VisualStudio = 3,
}
...
public partial class EditorUserBuildSettings : Object {
  private const string kSettingWaitForManagedDebugger =
  ...
  public static extern BuildTarget selectedStandaloneTarget {
    [NativeMethod("GetSelectedStandaloneTarget")] get;
    [NativeMethod("SetSelectedStandaloneTargetFromBindings")] set;
  }

  /// PS4 Build Subtarget
  public static extern PS4BuildSubtarget ps4BuildSubtarget {
    [NativeMethod("GetSelectedPS4BuildSubtarget")] get;
    [NativeMethod("SetSelectedPS4BuildSubtarget")] set;
  }

  /// PS4 Build Hardware Target
  public static extern PS4HardwareTarget ps4HardwareTarget {
    [NativeMethod("GetPS4HardwareTarget")] get;
    [NativeMethod("SetPS4HardwareTarget")] set;
  }
  ...
  // Should we force an install on the build package, even if there are
  // validation errors
  ...
  // Should we move the package to the Bluray disc outer edge (larger ISO, but
  // faster loading)
  ...
  public static extern XboxBuildSubtarget xboxBuildSubtarget {
    [NativeMethod("GetSelectedXboxBuildSubtarget")] get;
    [NativeMethod("SetSelectedXboxBuildSubtarget")] set;
  }

  // 0..X levels are all considered part of the launch set of streaming install
  // chunks
  ...
  public static extern XboxOneDeployMethod xboxOneDeployMethod {
    [NativeMethod("GetSelectedXboxOneDeployMethod")] get;
    [NativeMethod("SetSelectedXboxOneDeployMethod")] set;
  }

  // selected Xbox One Deployment Drive
  public static extern XboxOneDeployDrive xboxOneDeployDrive {
    [NativeMethod("GetSelectedXboxOneDeployDrive")] get;
    [NativeMethod("SetSelectedXboxOneDeployDrive")] set;
  }

  [Obsolete(
      "xboxOneUsername is deprecated, it is unnecessary and non-functional.")]
  public static string xboxOneUsername {
    get;
    set;
  }

  [Obsolete(
      "xboxOneNetworkSharePath is deprecated, it is unnecessary and non-functional.")]
  public static string xboxOneNetworkSharePath {
    get;
    set;
  }
  ...
  public static extern MobileTextureSubtarget androidBuildSubtarget {
    [NativeMethod("GetSelectedAndroidBuildSubtarget")] get;
    [NativeMethod("SetSelectedAndroidBuildSubtarget")] set;
  }

  // Compression set/get methods for the map containing type for
  // BuildTargetGroup
  ...
  GetCompressionTypeInternal(BuildTargetGroup targetGroup);

  internal static void SetCompressionType(BuildTargetGroup targetGroup,
                                          Compression type) {
  ...
  SetCompressionTypeInternal(BuildTargetGroup targetGroup, int type);

  public static extern AndroidETC2Fallback androidETC2Fallback {
    [NativeMethod("GetSelectedAndroidETC2Fallback")] get;
    [NativeMethod("SetSelectedAndroidETC2Fallback")] set;
  }
  ...
  [Obsolete(
      "androidUseLegacySdkTools has been deprecated. It does not have any effect.")]
  public static extern bool androidUseLegacySdkTools {
    get;
    set;
  }

  public static extern bool androidCreateSymbolsZip {
    get;
    set;
  }

  // *undocumented*
  // NOTE: This setting should probably not be a part of the public API as is.
  // Atm it is used by playmode tests
  //  and applied during build post-processing. We will however move towards
  //  separating building and launching which makes it unclear when connections
  //  should be attempted. In the future, the DeploymentTargets API will most
  //  likely support connecting to named external devices, which might make this
  //  setting obsolete.
  ...
  public static extern WSASubtarget wsaSubtarget {
    [NativeMethod("GetSelectedWSABuildSubtarget")] get;
    [NativeMethod("SetSelectedWSABuildSubtarget")] set;
  }

  [Obsolete(
      "EditorUserBuildSettings.wsaSDK is obsolete and has no effect.It will be removed in a subsequent Unity release.")]
  public static extern WSASDK wsaSDK {
    [NativeMethod("GetSelectedWSASDK")] get;
    [NativeMethod("SetSelectedWSASDK")] set;
  }

  // *undocumented*
  public static extern WSAUWPBuildType wsaUWPBuildType {
    [NativeMethod("GetSelectedWSAUWPBuildType")] get;
    [NativeMethod("SetSelectedWSAUWPBuildType")] set;
  }

  public static extern string wsaUWPSDK {
    [NativeMethod("GetSelectedWSAUWPSDK")] get;
    [NativeMethod("SetSelectedWSAUWPSDK")] set;
  }

  public static extern string wsaMinUWPSDK {
    [NativeMethod("GetSelectedWSAMinUWPSDK")] get;
    [NativeMethod("SetSelectedWSAMinUWPSDK")] set;
  }

  public static extern string wsaArchitecture {
    [NativeMethod("GetSelectedWSAArchitecture")] get;
    [NativeMethod("SetSelectedWSAArchitecture")] set;
  }

  public static extern string wsaUWPVisualStudioVersion {
    [NativeMethod("GetSelectedWSAUWPVSVersion")] get;
    [NativeMethod("SetSelectedWSAUWPVSVersion")] set;
  }

  public static extern string windowsDevicePortalAddress {
    [NativeMethod("GetWindowsDevicePortalAddress")] get;
    [NativeMethod("SetWindowsDevicePortalAddress")] set;
  }

  public static extern string windowsDevicePortalUsername {
    [NativeMethod("GetWindowsDevicePortalUsername")] get;
    [NativeMethod("SetWindowsDevicePortalUsername")] set;
  }

  // WDP password is not to be saved with other settings and only stored in
  // memory until Editor is closed
  ...
  public static extern WSABuildAndRunDeployTarget wsaBuildAndRunDeployTarget {
    [NativeMethod("GetSelectedWSABuildAndRunDeployTarget")] get;
    [NativeMethod("SetSelectedWSABuildAndRunDeployTarget")] set;
  }
  ...
  SwitchActiveBuildTarget(BuildTargetGroup targetGroup, BuildTarget target);
  [NativeMethod("SwitchActiveBuildTargetAsync")]
  public static extern bool
  SwitchActiveBuildTargetAsync(BuildTargetGroup targetGroup,
                               BuildTarget target);

  // DEFINE directives for the compiler.
  public static extern string[] activeScriptCompilationDefines {
    [NativeMethod("GetActiveScriptCompilationDefinesBindingMethod")] get;
  }
  ...
  public static extern void SetBuildLocation(BuildTarget target,
                                             string location);

  public static void SetPlatformSettings(string platformName, string name,
                                         string value) {
    string buildTargetGroup = BuildPipeline.GetBuildTargetGroupName(
        BuildPipeline.GetBuildTargetByName(platformName));
    SetPlatformSettings(buildTargetGroup, platformName, name, value);
  }

  public static extern void SetPlatformSettings(string buildTargetGroup,
                                                string buildTarget, string name,
                                                string value);
  ...
  public static extern string GetPlatformSettings(string buildTargetGroup,
                                                  string platformName,
                                                  string name);
  ...
  [Obsolete("Building with pre-built Engine option is no longer supported.",
            true)]
  ...
  public static extern iOSBuildType iOSBuildConfigType {
    [NativeMethod("GetIOSBuildType")] get;
    [NativeMethod("SetIOSBuildType")] set;
  }

  // Create a .nsp ROM file out of the loose-files .nspd folder
  public static extern bool switchCreateRomFile {
    [NativeMethod("GetCreateRomFileForSwitch")] get;
    [NativeMethod("SetCreateRomFileForSwitch")] set;
  }

  // Enable linkage of NVN Graphics Debugger for Nintendo Switch.
  public static extern bool switchNVNGraphicsDebugger {
    [NativeMethod("GetNVNGraphicsDebuggerForSwitch")] get;
    [NativeMethod("SetNVNGraphicsDebuggerForSwitch")] set;
  }

  // Enable shader debugging using NVN Graphics Debugger
  public static extern bool switchNVNShaderDebugging {
    [NativeMethod("GetNVNShaderDebugging")] get;
    [NativeMethod("SetNVNShaderDebugging")] set;
  }

  // Enable debug validation of NVN drawcalls
  [Obsolete(
      "switchNVNDrawValidation is deprecated, use switchNVNDrawValidation_Heavy instead.")]
  ...
  public static extern bool switchNVNDrawValidation_Light {
    [NativeMethod("GetNVNDrawValidationLight")] get;
    [NativeMethod("SetNVNDrawValidationLight")] set;
  }

  public static extern bool switchNVNDrawValidation_Heavy {
    [NativeMethod("GetNVNDrawValidationHeavy")] get;
    [NativeMethod("SetNVNDrawValidationHeavy")] set;
  }

  // Enable linkage of the Heap inspector tool for Nintendo Switch.
  public static extern bool switchEnableHeapInspector {
    [NativeMethod("GetEnableHeapInspectorForSwitch")] get;
    [NativeMethod("SetEnableHeapInspectorForSwitch")] set;
  }

  // Enable linkage of DebugPad functionality for Nintendo Switch.
  public static extern bool switchEnableDebugPad {
    [NativeMethod("GetEnableDebugPadForSwitch")] get;
    [NativeMethod("SetEnableDebugPadForSwitch")] set;
  }

  // Redirect attempts to write to "rom:" mount, to "host:" mount for Nintendo
  // Switch (for debugging and tests only)
  public static extern bool switchRedirectWritesToHostMount {
    [NativeMethod("GetRedirectWritesToHostMountForSwitch")] get;
    [NativeMethod("SetRedirectWritesToHostMountForSwitch")] set;
  }

  // Enable using the HTC devkit connection for script debugging
  public static extern bool switchHTCSScriptDebugging {
    [NativeMethod("GetHTCSScriptDebuggingForSwitch")] get;
    [NativeMethod("SetHTCSScriptDebuggingForSwitch")] set;
  }

  internal static extern SwitchShaderCompilerConfig switchShaderCompilerConfig {
    [NativeMethod("GetSwitchShaderCompilerConfig")] get;
    [NativeMethod("SetSwitchShaderCompilerConfig")] set;
  }
  ...
  public static bool waitForManagedDebugger {
    get {
      return GetPlatformSettings("Editor", kSettingWaitForManagedDebugger) ==
             "true";
    }

    set {
      SetPlatformSettings("Editor", kSettingWaitForManagedDebugger,
