...
[UsedByNativeCode, NativeHeader("Runtime/Misc/InputEvent.h"),
...
public static extern GUIView current {
	[NativeMethod("GetCurrentGUIView")] get;
}
public static extern GUIView focusedView {
	[NativeMethod("GetFocusedGUIView")] get;
}
public static extern GUIView mouseOverView {
	[NativeMethod("GetMouseOverGUIView")] get;
}

public extern bool hasFocus {
	[NativeMethod("IsViewFocused")] get;
}
...
internal extern bool mouseRayInvisible {
	[NativeMethod("IsMouseRayInvisible")] get;
	[NativeMethod("SetMouseRayInvisible")] set;
}
internal extern bool disableInputEvents {
	[NativeMethod("AreInputEventsDisabled")] get;
	[NativeMethod("SetDisableInputEvents")] set;
}

internal extern bool hdrActive {
	[NativeMethod("IsHDRActive")] get;
}

internal extern void SetTitle(string title);
internal extern void AddToAuxWindowList();
internal extern void SetInternalGameViewDimensions(Rect rect,
                                                   Rect clippedRect,
                                                   Vector2 targetSize);
...
internal extern System.IntPtr nativeHandle {
	[NativeMethod("GetGUIViewHandle")] get;
}
