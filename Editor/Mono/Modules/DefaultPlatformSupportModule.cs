...
internal abstract class DefaultPlatformSupportModule
	: IPlatformSupportModule {
...
public virtual IPreferenceWindowExtension
CreatePreferenceWindowExtension() {
	return null;
}

public virtual ITextureImportSettingsExtension
CreateTextureImportSettingsExtension() {
	return textureSettingsExtension != null ? textureSettingsExtension
	  : textureSettingsExtension =
		       new DefaultTextureImportSettingsExtension();
}
...
public virtual ICompilationExtension CreateCompilationExtension() {
	return compilationExtension != null ? compilationExtension
	  : compilationExtension = new DefaultCompilationExtension();
}
...
public virtual IUserAssembliesValidator
CreateUserAssembliesValidatorExtension() {
	return null;
}

public virtual IDeploymentTargetsExtension
