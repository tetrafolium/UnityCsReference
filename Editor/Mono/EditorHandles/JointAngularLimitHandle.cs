...
public class JointAngularLimitHandle
{
    ...
    {
        get {
            return m_XMinHandle.angleHandleDrawFunction;
        }
        set
        {
    ...
    {
        get {
            return m_XMinHandle.angleHandleSizeFunction;
        }
        set
        {
