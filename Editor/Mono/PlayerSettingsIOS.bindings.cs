...
internal partial class iOSDeviceRequirementGroup
{
    ...
    public int count {
        get {
            return GetCountForVariantImpl(m_VariantName);
        }
    }
...
public partial class PlayerSettings : UnityEngine.Object
{
    ...
    public partial class iOS
    {
        ...
        {
            get {
                return PlayerSettings.GetBuildNumber(BuildTargetGroup.iOS);
            }
            set {
                PlayerSettings.SetBuildNumber(BuildTargetGroup.iOS, value);
            }
        }
        ...
        public static ScriptCallOptimizationLevel scriptCallOptimization
        {
            ...
            set {
                scriptCallOptimizationInternal = (int)value;
            }
        }
        ...
        {
            get {
                return (iOSSdkVersion)sdkVersionInternal;
            }
            set {
                sdkVersionInternal = (int)value;
            }
        }
        ...
        {
            get {
                return (iOSTargetDevice)targetDeviceInternal;
            }
            set {
                targetDeviceInternal = (int)value;
            }
        }
        ...
        {
            get {
                return (iOSStatusBarStyle)statusBarStyleInternal;
            }
            set {
                statusBarStyleInternal = (int)value;
            }
        }
        ...
        {
            get {
                return (UnityEngine.iOS.SystemGestureDeferMode)deferSystemGesturesModeInternal;
            }
            set {
                deferSystemGesturesModeInternal = (int)value;
            }
        }
        ...
        public static iOSAppInBackgroundBehavior appInBackgroundBehavior
        {
            ...
            set {
                appInBackgroundBehaviorInternal = (int)value;
            }
        }
        ...
        {
            get {
                return (iOSBackgroundMode)backgroundModesInternal;
            }
            set {
                backgroundModesInternal = (int)value;
            }
        }
        ...
        public static string appleDeveloperTeamID
        {
            ...
            set {
                appleDeveloperTeamIDInternal = value;
            }
        }
        ...
        {
            get {
                return (iOSShowActivityIndicatorOnLoading)showActivityIndicatorOnLoadingInternal;
            }
            set {
                showActivityIndicatorOnLoadingInternal = (int)value;
            }
        }
