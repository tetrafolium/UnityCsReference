...
public enum AppleMobileArchitecture : uint {
  ...
  [Obsolete("ARMv7 is no longer supported", true)] ARMv7 = 0,
...
public enum iOSStatusBarStyle {
  ...
  [System.ComponentModel.EditorBrowsable(
      System.ComponentModel.EditorBrowsableState.Never)]
  [Obsolete(
      "BlackTranslucent has no effect, use LightContent instead (UnityUpgradable) -> LightContent",
      true)] BlackTranslucent = -1,

  [System.ComponentModel.EditorBrowsable(
      System.ComponentModel.EditorBrowsableState.Never)]
  [Obsolete(
      "BlackOpaque has no effect, use LightContent instead (UnityUpgradable) -> LightContent",
      true)] BlackOpaque = -1,
}
...
public enum iOSAppInBackgroundBehavior {
  ...
  [ Obsolete(
      "UIApplicationExitsOnSuspend is no longer supported in iOS 13, use Custom or Suspend instead (UnityUpgradable) -> Custom",
      true) ] Exit = 1,
}
...
public enum iOSLaunchScreenType {
  ...
  [ Obsolete(
      "Launch Images are no longer supported by Apple. (UnityUpgradable) -> Default",
      true) ] None = 3,
}
...
public enum ProvisioningProfileType { Automatic, Development, Distribution }

public class iOSDeviceRequirement {
  SortedDictionary<string, string> m_Values =
...
internal partial class iOSDeviceRequirementGroup {
  ...
  [FreeFunction(
      "PlayerSettingsIOSBindings::SetOrAddDeviceRequirementForVariantNameImpl")] extern private static void
  SetOrAddDeviceRequirementForVariantNameImpl(string name, int index,
                                              string[] keys, string[] values);

  [NativeMethod(Name = "GetIOSDeviceRequirementCountForVariantName")]
  [StaticAccessor("GetPlayerSettings()",
                  StaticAccessorType.Dot)] extern private static int
  GetCountForVariantImpl(string name);

  //[NativeMethod("RemoveIOSDeviceRequirementForVariantName")]
  [NativeMethod(Name = "RemoveIOSDeviceRequirementForVariantName")]
  [StaticAccessor("GetPlayerSettings()",
                  StaticAccessorType.Dot)] extern private static void
  RemoveAtImpl(string name, int index);
  ...
  [FreeFunction(
      "PlayerSettingsIOSBindings::GetDeviceRequirementForVariantNameImpl")] extern private static void
  GetDeviceRequirementForVariantNameImplInternal(string name, int index,
                                                 [ Out ] string[] keys,
                                                 [ Out ] string[] values);

  [FreeFunction(
      "PlayerSettingsIOSBindings::GetDeviceRequirementForVariantCount")] extern private static int
  GetDeviceRequirementForVariantCount(string name, int index);

  private static void GetDeviceRequirementForVariantNameImpl(
      string name, int index, out string[] keys, out string[] values) {
  ...
  public int count {
    get { return GetCountForVariantImpl(m_VariantName); }
  }
  ...
  public iOSDeviceRequirement this[int index] {
    get {
      string[] keys;
      string[] values;
      GetDeviceRequirementForVariantNameImpl(m_VariantName, index, out keys,
                                             out values);
    ...
    set {
      SetOrAddDeviceRequirementForVariantNameImpl(
          m_VariantName, index, value.values.Keys.ToArray(),
          value.values.Values.ToArray());
    }
  }

  public void RemoveAt(int index) { RemoveAtImpl(m_VariantName, index); }

  public void Add(iOSDeviceRequirement requirement) {
    SetOrAddDeviceRequirementForVariantNameImpl(
        m_VariantName, -1, requirement.values.Keys.ToArray(),
...
public partial class PlayerSettings : UnityEngine.Object {
  ...
  public partial class iOS {
    ...
    private extern static int scriptCallOptimizationInternal {
      [NativeMethod("GetiPhoneScriptCallOptimization")] get;
      [NativeMethod("SetiPhoneScriptCallOptimization")] set;
    }

    public static ScriptCallOptimizationLevel scriptCallOptimization {
      get {
        return (ScriptCallOptimizationLevel) scriptCallOptimizationInternal;
      }
      set { scriptCallOptimizationInternal = (int) value; }
    }
    private extern static int sdkVersionInternal {
      [NativeMethod("GetiPhoneSdkVersion")] get;
      [NativeMethod("SetiPhoneSdkVersion")] set;
    }
    ...
    [FreeFunction]
    private extern static string
    iOSTargetOSVersionObsoleteEnumToString(int val);

    [FreeFunction]
    private extern static int
    iOSTargetOSVersionStringToObsoleteEnum(string val);

    // Deployment minimal version of iOS
    [Obsolete(
        "OBSOLETE warning targetOSVersion is obsolete, use targetOSVersionString")]
    public static iOSTargetOSVersion targetOSVersion {
      get {
        return (iOSTargetOSVersion)
            iOSTargetOSVersionStringToObsoleteEnum(targetOSVersionString);
      }
      set {
        targetOSVersionString =
            iOSTargetOSVersionObsoleteEnumToString((int) value);
      }
    }
    ...
    internal static readonly Version minimumOsVersion =
        new Version(GetMinimumVersionString());

    [NativeProperty("iOSTargetOSVersion")]
    public extern static string targetOSVersionString {
      [NativeMethod("GetiOSTargetOSVersion")] get;
      [NativeMethod("SetiOSTargetOSVersion")] set;
    }

    // Targeted device
    [NativeProperty("TargetDevice")]
    private extern static int targetDeviceInternal {
      get;
      set;
    }
    ...
    private extern static int statusBarStyleInternal {
      get;
      set;
    }
    ...
    // On iPhone 10 the home button is implemented as a system gesture. (swipe
    // up from the lower edge). This might interfere with games that use swipes
    // as an interaction method. iOS provides a way to reduce the chance of
    // unwanted interaction by marking edges as "protected" edges, so the system
    // gesture is not recognized on the first swipe, but on the second if it
    // comes immediately afterwards.
    [NativeProperty("DeferSystemGesturesMode")]
    private extern static int deferSystemGesturesModeInternal {
      get;
      set;
    }

    public static UnityEngine.iOS
        .SystemGestureDeferMode deferSystemGesturesMode {
      get {
        return (UnityEngine.iOS.SystemGestureDeferMode)
            deferSystemGesturesModeInternal;
      }
    ...
    private extern static int appInBackgroundBehaviorInternal {
      [FreeFunction(
          "PlayerSettingsIOSBindings::GetAppInBackgroundBehavior")] get;

      [FreeFunction(
          "PlayerSettingsIOSBindings::SetAppInBackgroundBehavior")] set;
    }

    public static iOSAppInBackgroundBehavior appInBackgroundBehavior {
      get {
        return (iOSAppInBackgroundBehavior) appInBackgroundBehaviorInternal;
      }
      set { appInBackgroundBehaviorInternal = (int) value; }
    }

    [NativeProperty("IOSBackgroundModes")]
    private extern static int backgroundModesInternal {
      get;
      set;
    }
    ...
    public static string appleDeveloperTeamID {
      get {
        return appleDeveloperTeamIDInternal.Length < 1
                   ? EditorPrefs.GetString("DefaultiOSAutomaticSignTeamId")
                   : appleDeveloperTeamIDInternal;
      }
    ...
    public static string iOSManualProvisioningProfileID {
      get {
        return String.IsNullOrEmpty(iOSManualProvisioningProfileIDInternal)
                   ? EditorPrefs.GetString("DefaultiOSProvisioningProfileUUID")
                   : iOSManualProvisioningProfileIDInternal;
      }
    ...
    public static string tvOSManualProvisioningProfileID {
      get {
        return String.IsNullOrEmpty(tvOSManualProvisioningProfileIDInternal)
                   ? EditorPrefs.GetString("DefaulttvOSProvisioningProfileUUID")
    ...
    public static extern ProvisioningProfileType
    ...
    public static bool appleEnableAutomaticSigning {
      get {
        return appleEnableAutomaticSigningInternal ==
               (int) iOSAutomaticallySignValue
                   .AutomaticallySignValueNotSet ? EditorPrefs.GetBool(
                       "DefaultiOSAutomaticallySignBuild")
            : (iOSAutomaticallySignValue) appleEnableAutomaticSigningInternal ==
               iOSAutomaticallySignValue.AutomaticallySignValueTrue;
      }
      set {
        appleEnableAutomaticSigningInternal =
            value ?(int) iOSAutomaticallySignValue
    ...
    private extern static int showActivityIndicatorOnLoadingInternal {
      get;
      set;
    }
    ...
    [NativeProperty("IOSAppInBackgroundBehavior")]
    public static iOSShowActivityIndicatorOnLoading
        showActivityIndicatorOnLoading {
      get {
        return (iOSShowActivityIndicatorOnLoading)
    ...
    [NativeMethod(
        Name =
            "GetIOSVariantsWithDeviceRequirements")] extern internal static string
        [] GetAssetBundleVariantsWithDeviceRequirements();

    private static extern int
    GetIOSDeviceRequirementCountForVariantName(string name);

    private static bool
    CheckAssetBundleVariantHasDeviceRequirements(string name) {
    ...
    private extern static void SetLaunchScreenImageInternal(Texture2D image,
                                                            int type);

    public static void SetLaunchScreenImage(Texture2D image,
    ...
    // will be public
    internal static iOSDeviceRequirementGroup
    GetDeviceRequirementsForAssetBundleVariant(string name) {
    ...
    RemoveDeviceRequirementsForAssetBundleVariant(string name) {
    ...
    // will be public
    internal static iOSDeviceRequirementGroup
    AddDeviceRequirementsForAssetBundleVariant(string name) {
      return new iOSDeviceRequirementGroup(name);
    }
    ...
    internal static string[] GetURLSchemes() { return iOSUrlSchemes; }
  }
}
}
