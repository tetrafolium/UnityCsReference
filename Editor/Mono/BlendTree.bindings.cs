...
namespace UnityEditor.Animations {
  ...
  public struct ChildMotion {
    ...
    public string directBlendParameter {
      ...
      set { m_DirectBlendParameter = value; }
    }
    public bool mirror {
      get { return m_Mirror; }
      set { m_Mirror = value; }
  ...
  public partial class BlendTree : Motion {
    public BlendTree() { Internal_Create(this); }

    [FreeFunction(
        "BlendTreeBindings::Internal_Create")] extern private static void
    Internal_Create([ Writable ] BlendTree self);
    ...
    [NativeMethod("GetChildMotion")] extern internal
        Motion Internal_GetChildMotion(int index);

    [NativeMethod("SetDirectBlendParameter")] extern internal void
    SetDirectBlendTreeParameter(int index, string parameter);

    [NativeMethod("GetDirectBlendParameter")] extern internal
        string GetDirectBlendTreeParameter(int index);
    ...
    extern internal int recursiveBlendParameterCount { get; }
    ...
    [NativeMethod("GetAnimationClips")] extern internal
        AnimationClip[] GetAnimationClipsFlattened();
  }
}
