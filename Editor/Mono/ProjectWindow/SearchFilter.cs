...
internal class SearchFilter {
  ...
  private bool m_ShowAllHits =
      false; // If true then just one filter must match to show an object, if
             // false then all filters must match to show an object
  [SerializeField]
  private bool m_SkipHidden = false;
  [SerializeField] SearchArea m_SearchArea = SearchArea.InAssetsOnly;
  // Folder browsing
  [SerializeField]
  ...
  public string[] classNames {
    get { return m_ClassNames; }
    set { m_ClassNames = value; }
  }
  public string[] assetLabels {
    get { return m_AssetLabels; }
    set { m_AssetLabels = value; }
  }
  public string[] versionControlStates {
    get { return m_VersionControlStates; }
    set { m_VersionControlStates = value; }
  }
  public string[] softLockControlStates {
    get { return m_SoftLockControlStates; }
    set { m_SoftLockControlStates = value; }
  }
  public string[] assetBundleNames {
    get { return m_AssetBundleNames; }
    set { m_AssetBundleNames = value; }
  }
  public int[] referencingInstanceIDs {
    get { return m_ReferencingInstanceIDs; }
    set { m_ReferencingInstanceIDs = value; }
  }
  public int[] sceneHandles {
    get { return m_SceneHandles; }
    set { m_SceneHandles = value; }
  }
  public bool showAllHits {
    get { return m_ShowAllHits; }
    set { m_ShowAllHits = value; }
  }
  public bool skipHidden {
    get { return m_SkipHidden; }
    set { m_SkipHidden = value; }
  }
  ...
  bool IsNullOrEmpty<T>(T[] list) { return (list == null || list.Length == 0); }

  public State GetState() {
    bool isSearchActive =
        !string.IsNullOrEmpty(m_NameFilter) || !IsNullOrEmpty(m_AssetLabels) ||
        !IsNullOrEmpty(m_ClassNames) || !IsNullOrEmpty(m_AssetBundleNames) ||
        !IsNullOrEmpty(m_Globs) || !IsNullOrEmpty(m_ReferencingInstanceIDs);
  ...
  public override string ToString() {
    ...
    result +=
        string.Format("[Area: {0}, State: {1}]", m_SearchArea, GetState());
    ...
    if (m_ClassNames != null && m_ClassNames.Length > 0)
      result +=
          "[Types: " + m_ClassNames[0] + " (" + m_ClassNames.Length + ")]";
