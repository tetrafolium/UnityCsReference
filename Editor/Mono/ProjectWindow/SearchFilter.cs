...
internal class SearchFilter
{
    ...
    public string[] versionControlStates {
        get {
            return m_VersionControlStates;
        }
        set {
            m_VersionControlStates = value;
        }
    }
    public string[] softLockControlStates {
        get {
            return m_SoftLockControlStates;
        }
        set {
            m_SoftLockControlStates = value;
        }
    }
    public string[] assetBundleNames {
        ...
        set {
            m_AssetBundleNames = value;
        }
    }
    public int[] referencingInstanceIDs {
        get {
            return m_ReferencingInstanceIDs;
        }
        set {
            m_ReferencingInstanceIDs = value;
        }
    }
    public int[] sceneHandles {
        get {
            return m_SceneHandles;
        }
        set {
            m_SceneHandles = value;
        }
    }
    public bool showAllHits {
        get {
            return m_ShowAllHits;
        }
        set {
            m_ShowAllHits = value;
        }
