...
internal class FilteredHierarchyProperty : IHierarchyProperty
{
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].name;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].hasChildren;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].isMainRepresentation;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].hasFullPreviewImage;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].iconDrawStyle;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].isFolder;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].colorCode;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].guid;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results != null && m_Position < m_Hierarchy.results.Length && m_Position >= 0;
        }
    }
    ...
    {
        get {
            return m_Hierarchy.results[m_Position].icon;
        }
    }
