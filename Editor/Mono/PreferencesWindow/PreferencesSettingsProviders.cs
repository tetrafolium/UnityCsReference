...
internal class PreferencesProvider : SettingsProvider
{
    ...
    {
        var settings = new PreferencesProvider("Preferences/_General", GetSearchKeywordsFromGUIContentProperties<GeneralProperties>()) {
            label = "General"
        };
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.ShowGeneral);
        };
        settings.activateHandler = (searchContext, rootElement) => {
            settings.EnableGeneral();
        };
        return settings;
    }
    ...
    internal static SettingsProvider CreateColorsProvider()
    {
        ...
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.ShowColors);
        };
        return settings;
    }
    ...
    internal static SettingsProvider CreateGICacheProvider()
    {
        ...
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.ShowGICache);
        };
        return settings;
    }
    ...
    internal static SettingsProvider Create2DProvider()
    {
        ...
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.Show2D);
        };
        return settings;
    }
    ...
    internal static SettingsProvider CreateSceneViewProvider()
    {
        ...
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.ShowSceneView);
        };
        return settings;
    }
    ...
    internal static SettingsProvider CreateLanguagesProvider()
    {
        ...
        if (editorLanguages.Length > 1)
        {
            ...
            settings.guiHandler = searchContext => {
                OnGUI(searchContext, settings.ShowLanguage);
            };
            return settings;
        }
    ...
    internal static SettingsProvider CreateUIScalingProvider()
    {
        ...
        {
            var settings = new PreferencesProvider("Preferences/UIScaling", GetSearchKeywordsFromGUIContentProperties<UIScalingProperties>()) {
                label = "UI Scaling"
            };
            settings.guiHandler = searchContext => {
                OnGUI(searchContext, settings.ShowUIScaling);
            };
            return settings;
        }
    ...
    internal static SettingsProvider CreateDeveloperModeProvider()
    {
        ...
        settings.guiHandler = searchContext => {
            OnGUI(searchContext, settings.ShowDeveloperMode);
        };
        return settings;
    }
...
#pragma warning disable 618
    ...
    {
        get {
            return Mathf.RoundToInt(GUIUtility.pixelsPerPoint * 100);
        }
    }
