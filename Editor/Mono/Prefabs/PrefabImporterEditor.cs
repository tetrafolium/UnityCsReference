...
internal class PrefabImporterEditor : AssetImporterEditor
{
    ...
    {
        get {
            return !m_SavingHasFailed && !hasMissingScripts && GUIUtility.hotControl == 0 && !isTextFieldCaretShowing && !EditorApplication.isCompiling;
        }
    }
    ...
    {
        get {
            return m_PrefabsWithMissingScript.Count > 0;
        }
    }
