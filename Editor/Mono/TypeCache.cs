...
public static partial class TypeCache {
  ...
  public static MethodCollection GetMethodsWithAttribute<T>() where T
      : Attribute {
    return GetMethodsWithAttribute(typeof(T));
  }

  public static FieldInfoCollection GetFieldsWithAttribute<T>() where T
      : Attribute {
  ...
  public static TypeCollection GetTypesDerivedFrom(Type parentType) {
    return parentType.IsInterface ? GetTypesDerivedFromInterface(parentType)
        : GetTypesDerivedFromType(parentType);
  }
}
}
