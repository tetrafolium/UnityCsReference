...
internal class AudioUtil {
  [StaticAccessor("GetAudioManager()",
  ...
  [StaticAccessor("GetAudioManager()",
                  StaticAccessorType.Dot)] extern public static float
  ...
  [StaticAccessor("GetAudioManager()",
                  StaticAccessorType.Dot)] extern public static void
  SetPreviewClipSamplePosition(AudioClip clip, int iSamplePosition);
  ...
  extern public static AudioCompressionFormat
  GetSoundCompressionFormat(AudioClip clip);
  extern public static AudioCompressionFormat
  GetTargetPlatformSoundCompressionFormat(AudioClip clip);

  extern public static bool canUseSpatializerEffect {
    [FreeFunction(Name = "GetAudioManager().CanUseSpatializerEffect")] get;
  }
  ...
  [FreeFunction(
      Name = "GetAudioManager().GetMemoryAllocated")] extern public static int
  GetFMODMemoryAllocated();

  [FreeFunction(
      Name = "GetAudioManager().GetCPUUsage")] extern public static float
  GetFMODCPUUsage();
  ...
  GetLowpassCurve(AudioLowPassFilter lowPassFilter);
  ...
  extern public static float GetCustomFilterMaxIn(MonoBehaviour behaviour,
                                                  int channel);
  extern public static float GetCustomFilterMaxOut(MonoBehaviour behaviour,
                                                   int channel);
