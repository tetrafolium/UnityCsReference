...
public override bool SetFloatParameter(string name, float value) {
	m_Effect.SetValueForParameter(m_Controller, m_Controller.TargetSnapshot,
	                              name, value);
	return true;
}

public override bool GetFloatParameter(string name, out float value) {
	value = m_Effect.GetValueForParameter(m_Controller,
	                                      m_Controller.TargetSnapshot, name);
	return true;
}

public override bool GetFloatParameterInfo(string name, out float minRange,
                                           out float maxRange,
...
public override bool GetFloatBuffer(string name, out float[] data,
                                    int numsamples) {
