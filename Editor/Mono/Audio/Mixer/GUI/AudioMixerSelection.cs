...
internal class AudioMixerSelection {
  ...
  // We rely on SyncToUnitySelection is being called after setting
  // Selection.objects through AudioWindow::OnSelectionChange ()
  ...
  public void SetChannelStrips(List<AudioMixerGroupController> newSelection) {
    ...
    // Debug.Log("SetChannelStrips " +
    // DebugUtils.ListToString(Selection.instanceIDs));
  }

  public void SetSingleChannelStrip(AudioMixerGroupController group) {
    Selection.objects = new[]{group};
    // Debug.Log("SetSingleChannelStrip " +
    // DebugUtils.ListToString(Selection.instanceIDs));
  }
  ...
  private void RefreshCachedChannelStripSelection() {
    ...
    List<AudioMixerGroupController> allGroups =
        m_Controller.GetAllAudioGroupsSlow();
  ...
  public void Sanitize() { RefreshCachedChannelStripSelection(); }
}
}
