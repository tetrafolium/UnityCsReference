...
internal static class AudioMixerColorCodes {
  ...
  static Color[] darkSkinColors =
      new[]{new Color(0.5f, 0.5f, 0.5f, 0.2f),
  ...
  static string[] colorNames =
      new[]{"No Color", "Yellow", "Orange", "Red",  "Magenta",
            "Violet",   "Blue",   "Cyan",   "Green"};

  static string[] GetColorNames() { return colorNames; }
  ...
  public static void
  AddColorItemsToGenericMenu(GenericMenu menu,
    ...
    for (int i = 0; i < colors.Length; i++) {
      ...
      menu.AddItem(new GUIContent(names[i]), selected, ItemCallback,
                   new ItemData{groups = groups, index = i});
    }
  }
