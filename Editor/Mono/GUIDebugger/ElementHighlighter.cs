...
internal class ElementHighlighter {
  internal static readonly Color kSizePaddingSecondaryColor =
      new Color(194f / 255, 237f / 255, 138f / 255);
  internal static readonly Color kSizeSecondaryColor =
      new Color(139f / 255, 181f / 255, 192f / 255);
  ...
  public ElementHighlighter() { IsEnabled = true; }

  public void ClearElement() {
    if (m_PaddingHighlighter != null &&
        m_PaddingHighlighter.hierarchy.parent != null) {
  ...
  public void HighlightElement(VisualElement rootElement, Rect elementRect,
                               GUIStyle style = null) {
    if (!IsEnabled)
      return;
