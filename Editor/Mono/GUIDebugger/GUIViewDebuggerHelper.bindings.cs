...
internal static partial class GUIViewDebuggerHelper {
  ...
  [RequiredByNativeCode]
  private static GUIContent CreateGUIContent(string text, Texture image,
                                             string tooltip) {
    return new GUIContent(text, image, tooltip);
  }

  internal static extern void
  GetDrawInstructions(List<IMGUIDrawInstruction> drawInstructions);

  internal static extern void
  GetClipInstructions(List<IMGUIClipInstruction> clipInstructions);

  internal static extern void GetNamedControlInstructions(
      List<IMGUINamedControlInstruction> namedControlInstructions);

  internal static extern void GetPropertyInstructions(
      List<IMGUIPropertyInstruction> namedControlInstructions);

  internal static extern void
  GetLayoutInstructions(List<IMGUILayoutInstruction> layoutInstructions);

  internal static extern void
  GetUnifiedInstructions(List<IMGUIInstruction> layoutInstructions);
