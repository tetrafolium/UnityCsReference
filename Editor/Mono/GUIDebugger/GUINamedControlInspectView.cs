...
class GUINamedControlInspectView : BaseInspectView {
  private readonly List<IMGUINamedControlInstruction>
      m_NamedControlInstructions = new List<IMGUINamedControlInstruction>();
  ...
  public override void UpdateInstructions() {
    ...
    GUIViewDebuggerHelper.GetNamedControlInstructions(
  ...
  internal override string GetInstructionListName(int index) {
    IMGUINamedControlInstruction instruction =
        m_NamedControlInstructions[index];
