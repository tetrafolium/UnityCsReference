...
public sealed partial class PlayerSettings : UnityEngine.Object
{
    ...
    {
        get {
            return stereoRenderingPath == StereoRenderingPath.SinglePass;
        }
        set {
            stereoRenderingPath = value ? StereoRenderingPath.SinglePass : StereoRenderingPath.MultiPass;
        }
    }
    ...
    {
        get {
            return GetApplicationIdentifier(BuildTargetGroup.iOS);
        }
        set {
            SetApplicationIdentifier(BuildTargetGroup.iOS, value);
        }
    }
    ...
    {
        get {
            return ScriptingRuntimeVersion.Latest;
        }
    ...
    {
        get {
            return GetGraphicsJobsForPlatform(EditorUserBuildSettings.activeBuildTarget);
        }
        set {
            SetGraphicsJobsForPlatform(EditorUserBuildSettings.activeBuildTarget, value);
        }
    }
    ...
    {
        get {
            return GetGraphicsJobModeForPlatform(EditorUserBuildSettings.activeBuildTarget);
        }
        set {
            SetGraphicsJobModeForPlatform(EditorUserBuildSettings.activeBuildTarget, value);
        }
    }
    ...
    {
        get {
            return GetApplicationIdentifier(EditorUserBuildSettings.activeBuildTargetGroup);
        }
        set
        {
    ...
    {
        get {
            return GetApiCompatibilityLevel(EditorUserBuildSettings.activeBuildTargetGroup);
        }
        set {
            SetApiCompatibilityLevel(EditorUserBuildSettings.activeBuildTargetGroup, value);
        }
    }
    ...
    {
        get {
            return GetUseDefaultGraphicsAPIs(BuildTarget.StandaloneWindows);
        }
