...
// Must be in sync with Il2CppCompilerConfiguration enum in
// SerializationMetaFlags.h
...
public enum MacFullscreenMode {
	[Obsolete(
		 "Capture Display mode is deprecated, Use FullscreenWindow instead")] CaptureDisplay =
		0,
...
public enum D3D9FullscreenMode {
	[Obsolete("D3D9 support has been removed")] ExclusiveMode = 0,
	[ Obsolete("D3D9 support has been removed") ] FullscreenWindow = 1,
}
...
// Managed code stripping level - must be in sync with StrippingLevel enum in
// BuildTargetPlatformSpecific.h
public enum StrippingLevel {
	...
	// Lightweight mscorlib version will be used at expense of limited
	// compatibility.
	UseMicroMSCorlib = 3
}
...
public enum ScriptCallOptimizationLevel {
	...
	// Script method call overhead decreased at the expense of limited
	// compatibility.
...
[Obsolete(
	 "ScriptingRuntimeVersion has been deprecated in 2019.3 now that legacy mono has been removed")]
...
public enum ApiCompatibilityLevel {
	...
	// micro profile, used by Mono scripting backend if stripping level is set to
	// "Use micro mscorlib"
	NET_Micro = 5,
...
[Obsolete(
	 "SplashScreenStyle deprecated, Use PlayerSettings.SplashScreen.UnityLogoStyle instead")]
...
public enum GraphicsJobMode { Native = 0, Legacy = 1 }
...
internal enum LightmapEncodingQuality { Low = 0, Normal = 1, High = 2 }

// Player Settings is where you define various parameters for the final game
// that you will build in Unity. Some of these values are used in the Resolution
...
internal static SerializedObject GetSerializedObject() {
	if (_serializedObject == null)
		_serializedObject =
			new SerializedObject(InternalGetPlayerSettingsObject());
...
public static extern void SetPropertyInt(string name, int value,
...
[Obsolete("Use explicit API instead.")]
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
public static extern void SetPropertyBool(string name, bool value,
                                          BuildTargetGroup target);
...
[Obsolete("Use explicit API instead.")]
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
public static extern bool GetPropertyBool(string name,
                                          BuildTargetGroup target);
...
[Obsolete("Use explicit API instead.")]
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
public static extern void SetPropertyString(string name, string value,
                                            BuildTargetGroup target);
...
[Obsolete("Use explicit API instead.")]
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
public static extern string GetPropertyString(string name,
                                              BuildTargetGroup target);
...
internal static extern void SetCloudServiceEnabled(string serviceKey,
                                                   bool enabled);
...
public static extern void SetAspectRatio(AspectRatio aspectRatio,
                                         bool enable);
...
[Obsolete(
	 "singlePassStereoRendering will be deprecated. Use stereoRenderingPath instead.")]
public static bool singlePassStereoRendering {
	get { return stereoRenderingPath == StereoRenderingPath.SinglePass; }
	set {
		stereoRenderingPath =
			value ? StereoRenderingPath.SinglePass : StereoRenderingPath.MultiPass;
	}
}
...
[Obsolete("protectGraphicsMemory is deprecated. This field has no effect.",
          false)]
...
public static extern bool enableFrameTimingStats {
	get;
	set;
}
...
public static extern D3DHDRDisplayBitDepth D3DHDRBitDepth {
	get;
	set;
}
...
// What happens the user presses OS specific full screen switch key
// combination
...
public static extern bool useFlipModelSwapchain {
	get;
	set;
}
...
public static extern bool openGLRequireES31 {
	[StaticAccessor("GetPlayerSettings().GetEditorOnly()")] get;

	[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")] set;
}
...
[Obsolete(
	 "iPhoneBundleIdentifier is deprecated. Use PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS) instead.")]
...
// Note: If an empty list is returned, no icons are assigned specifically to
// the specified platform at this point,
...
SetIconsForPlatform(string platform, Texture2D[] icons, IconKind kind);
...
internal static string GetPlatformName(BuildTargetGroup targetGroup) {
	BuildPlatform platform = BuildPlatforms.instance.GetValidPlatforms().Find(
		p => p.targetGroup == targetGroup);
	return (platform == null ? string.Empty : platform.name);
}

// Get the texture that will be used as the display icon at a specified size
// for the specified platform.
[NativeMethod("GetPlatformIconForSize")]
internal static extern Texture2D
GetIconForPlatformAtSize(string platform, int width, int height,
                         IconKind kind);

[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
internal static extern void GetBatchingForPlatform(BuildTarget platform,
                                                   out int staticBatching,
                                                   out int dynamicBatching);

[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
internal static extern void SetBatchingForPlatform(BuildTarget platform,
                                                   int staticBatching,
                                                   int dynamicBatching);

[NativeMethod("GetLightmapEncodingQuality")]
internal static extern LightmapEncodingQuality
GetLightmapEncodingQualityForPlatformGroup(BuildTargetGroup platformGroup);

[NativeMethod("SetLightmapEncodingQuality")]
internal static extern void SetLightmapEncodingQualityForPlatformGroup(
	BuildTargetGroup platformGroup, LightmapEncodingQuality encodingQuality);

[FreeFunction("GetTargetPlatformGraphicsAPIAvailability")]
internal static extern UnityEngine.Rendering
.GraphicsDeviceType[] GetSupportedGraphicsAPIs(BuildTarget platform);

[NativeMethod("GetPlatformGraphicsAPIs")]
public static extern UnityEngine.Rendering
.GraphicsDeviceType[] GetGraphicsAPIs(BuildTarget platform);

public static void
SetGraphicsAPIs(BuildTarget platform,
                UnityEngine.Rendering.GraphicsDeviceType[] apis) {
	SetGraphicsAPIsImpl(platform, apis);
	// we do cache api list in player settings editor, so if we update from
	// script we should forcibly update cache
	PlayerSettingsEditor.SyncPlatformAPIsList(platform);
}

[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
private static extern void
SetGraphicsAPIsImpl(BuildTarget platform,
                    UnityEngine.Rendering.GraphicsDeviceType[] apis);
...
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
public static extern void SetUseDefaultGraphicsAPIs(BuildTarget platform,
                                                    bool automatic);
...
internal static extern string spritePackerPolicy {
	...
	[NativeMethod("c_str")] get;

	[StaticAccessor("PlayerSettingsBindings",
	                StaticAccessorType.DoubleColon)] set;
}

// Get user-specified symbols for script compilation for the given build
// target group.
[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
[NativeMethod("GetUserScriptingDefineSymbolsForGroup")]
public static extern string
GetScriptingDefineSymbolsForGroup(BuildTargetGroup targetGroup);
...
// Set user-specified symbols for script compilation for the given build
// target group.
public static void
SetScriptingDefineSymbolsForGroup(BuildTargetGroup targetGroup,
                                  string defines) {
	if (!string.IsNullOrEmpty(defines))
		defines = string.Join(
			";",
			defines.Split(defineSplits, StringSplitOptions.RemoveEmptyEntries));
...
private static extern void
SetScriptingDefineSymbolsForGroupInternal(BuildTargetGroup targetGroup,
                                          string defines);
...
public static extern void SetArchitecture(BuildTargetGroup targetGroup,
                                          int architecture);

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
[NativeMethod("GetPlatformScriptingBackend")]
public static extern ScriptingImplementation
GetScriptingBackend(BuildTargetGroup targetGroup);

[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")]
public static extern void
SetApplicationIdentifier(BuildTargetGroup targetGroup, string identifier);

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
public static extern string
GetApplicationIdentifier(BuildTargetGroup targetGroup);

[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")]
[NativeMethod("SetApplicationBuildNumber")]
internal static extern void SetBuildNumber(BuildTargetGroup targetGroup,
                                           string buildNumber);
...
public static extern void
SetScriptingBackend(BuildTargetGroup targetGroup,
                    ScriptingImplementation backend);

[FreeFunction("GetDefaultScriptingBackendForGroup")]
public static extern ScriptingImplementation
GetDefaultScriptingBackend(BuildTargetGroup targetGroup);

public static void
SetIl2CppCompilerConfiguration(BuildTargetGroup targetGroup,
                               Il2CppCompilerConfiguration configuration) {
	var scriptingImpl = ModuleManager.GetScriptingImplementations(targetGroup);
	if (scriptingImpl != null &&
	    !scriptingImpl.AllowIL2CPPCompilerConfigurationSelection()) {
		Debug.LogWarning(
			$"The C++ compiler configuration option does not apply to the {targetGroup} platform as it is configured. Set the configuration in the generated IDE project instead.");
		return;
	}
...
private static extern void SetIl2CppCompilerConfigurationInternal(
	BuildTargetGroup targetGroup, Il2CppCompilerConfiguration configuration);

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
public static extern Il2CppCompilerConfiguration
GetIl2CppCompilerConfiguration(BuildTargetGroup targetGroup);

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
[NativeMethod("GetPlatformIncrementalIl2CppBuild")]
public static extern bool
GetIncrementalIl2CppBuild(BuildTargetGroup targetGroup);

[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")]
[NativeMethod("SetPlatformIncrementalIl2CppBuild")]
public static extern void
SetIncrementalIl2CppBuild(BuildTargetGroup targetGroup, bool enabled);
...
[Obsolete(
	 "ScriptingRuntimeVersion has been deprecated in 2019.3 due to the removal of legacy mono")]
...
public static extern string keystorePass {
	[StaticAccessor(
		 "GetPlayerSettings().GetEditorOnlyNotPersistent().AndroidKeystorePass")]
	[NativeMethod("c_str")] get;
...
public static extern string keyaliasPass {
	[StaticAccessor(
		 "GetPlayerSettings().GetEditorOnlyNotPersistent().AndroidKeyaliasPass")]
	[NativeMethod("c_str")] get;
...
public static bool graphicsJobs {
	get {
		return GetGraphicsJobsForPlatform(
			EditorUserBuildSettings.activeBuildTarget);
	}
	set {
		SetGraphicsJobsForPlatform(EditorUserBuildSettings.activeBuildTarget,
		                           value);
	}
}
...
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
internal static extern void SetGraphicsJobsForPlatform(BuildTarget platform,
                                                       bool graphicsJobs);

public static GraphicsJobMode graphicsJobMode {
	get {
		return GetGraphicsJobModeForPlatform(
			EditorUserBuildSettings.activeBuildTarget);
	}
	set {
		SetGraphicsJobModeForPlatform(EditorUserBuildSettings.activeBuildTarget,
		                              value);
	}
}

[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
internal static extern GraphicsJobMode
GetGraphicsJobModeForPlatform(BuildTarget platform);

[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
internal static extern void
SetGraphicsJobModeForPlatform(BuildTarget platform,
                              GraphicsJobMode gfxJobMode);
...
public static extern ActionOnDotNetUnhandledException
...
// Application (before 5.6 bundle) identifier was shared between iOS, Android
// and Tizen TV platforms before 5.6.
public static string applicationIdentifier {
	...
	set {
		Debug.LogWarning(
			"PlayerSettings.applicationIdentifier only changes the identifier for the currently active platform. Please use SetApplicationIdentifier to set it for any platform");
		SetApplicationIdentifier(EditorUserBuildSettings.activeBuildTargetGroup,
		                         value);
	}
}
...
[Obsolete(
	 "strippingLevel is deprecated, Use PlayerSettings.GetManagedStrippingLevel()/PlayerSettings.SetManagedStrippingLevel() instead. StripByteCode and UseMicroMSCorlib are no longer supported.")]
[StaticAccessor("PlayerSettingsBindings", StaticAccessorType.DoubleColon)]
...
[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")]
public static extern void
SetManagedStrippingLevel(BuildTargetGroup targetGroup,
                         ManagedStrippingLevel level);

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
public static extern ManagedStrippingLevel
GetManagedStrippingLevel(BuildTargetGroup targetGroup);
...
// Preserve framebuffer alpha, iOS and Android only. Enables rendering Unity
// on top of native UI.
...
// .NET API compatibility level
[Obsolete(
	 "apiCompatibilityLevel is deprecated. Use PlayerSettings.GetApiCompatibilityLevel()/PlayerSettings.SetApiCompatibilityLevel() instead.")]
public static ApiCompatibilityLevel apiCompatibilityLevel {
	get {
		return GetApiCompatibilityLevel(
			EditorUserBuildSettings.activeBuildTargetGroup);
	}
	set {
		SetApiCompatibilityLevel(EditorUserBuildSettings.activeBuildTargetGroup,
		                         value);
	}
}

[StaticAccessor("GetPlayerSettings().GetEditorOnly()")]
public static extern ApiCompatibilityLevel
GetApiCompatibilityLevel(BuildTargetGroup buildTargetGroup);

[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()")]
public static extern void
SetApiCompatibilityLevel(BuildTargetGroup buildTargetGroup,
...
public static extern bool mipStripping {
	get;
	set;
}
...
public static extern Vector2 cursorHotspot {
	get;
	set;
}
...
public static extern void SetMobileMTRendering(BuildTargetGroup targetGroup,
                                               bool enable);
...
[Obsolete(
	 "Use UnityEditor.PlayerSettings.SetGraphicsAPIs/GetGraphicsAPIs instead")]
...
// Defines whether the application will request audio focus, muting all other
// audio sources.
...
// Defines whether the BlendShape weight range in SkinnedMeshRenderers is
// clamped
public static extern bool legacyClampBlendShapeWeights {
	get;
	set;
}
...
public static extern bool enableMetalAPIValidation {
	[StaticAccessor("GetPlayerSettings().GetEditorOnly()",
	                StaticAccessorType.Dot)] get;
	[StaticAccessor("GetPlayerSettings().GetEditorOnlyForUpdate()",
	                StaticAccessorType.Dot)] set;
}

[FreeFunction("GetPlayerSettings().GetLightmapStreamingEnabled")]
internal static extern bool
GetLightmapStreamingEnabledForPlatformGroup(BuildTargetGroup platformGroup);

[FreeFunction("GetPlayerSettings().SetLightmapStreamingEnabled")]
internal static extern void
SetLightmapStreamingEnabledForPlatformGroup(BuildTargetGroup platformGroup,
                                            bool lightmapStreamingEnabled);

[FreeFunction("GetPlayerSettings().GetLightmapStreamingPriority")]
internal static extern int
GetLightmapStreamingPriorityForPlatformGroup(BuildTargetGroup platformGroup);

[FreeFunction("GetPlayerSettings().SetLightmapStreamingPriority")]
internal static extern void
SetLightmapStreamingPriorityForPlatformGroup(BuildTargetGroup platformGroup,
                                             int lightmapStreamingPriority);

internal static extern bool disableOldInputManagerSupport {
	get;
}
