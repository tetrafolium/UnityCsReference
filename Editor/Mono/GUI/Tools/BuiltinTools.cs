...
class TransformTool : ManipulationTool<TransformTool>
{
    ...
    {
        get {
            return EditorGUIUtility.TrTextContentWithIcon("Transform Tool", "Transform Tool", "TransformTool");
        }
    }
...
class MoveTool : ManipulationTool<MoveTool>
{
    ...
    {
        get {
            return EditorGUIUtility.TrTextContentWithIcon("Move Tool", "Move Tool", "MoveTool");
        }
    }
...
class RotateTool : ManipulationTool<RotateTool>
{
    ...
    {
        get {
            return EditorGUIUtility.TrTextContentWithIcon("Rotate Tool", "Rotate Tool", "RotateTool");
        }
    }
...
class ScaleTool : ManipulationTool<ScaleTool>
{
    ...
    {
        get {
            return EditorGUIUtility.TrTextContentWithIcon("Scale Tool", "Scale Tool", "ScaleTool");
        }
    }
...
class RectTool : ManipulationTool<RectTool>
{
    ...
    {
        get {
            return EditorGUIUtility.TrTextContentWithIcon("Rect Tool", "Rect Tool", "RectTool");
        }
    }
