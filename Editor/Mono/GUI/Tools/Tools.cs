...
#pragma warning restore 618
    ...
    {
        get {
            return EditorToolUtility.GetEnumWithEditorTool(EditorToolContext.GetActiveTool());
        }
        set {
            EditorToolContext.activeTool = EditorToolUtility.GetEditorToolWithEnum(value);
        }
    }
    ...
    {
        get {
            return get.m_LayerSettings.visibleLayersValue;
        }
        set
        {
    ...
    {
        get {
            return get.m_LayerSettings.lockedLayersValue;
        }
        set
        {
