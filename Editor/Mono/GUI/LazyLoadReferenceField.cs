...
//----------------------------------------------------------------------------------------------------------------------
// What is this : Custom drawer for fields of type LazyLoadReference<T> that
// filters presented candidate list to assets of type 'T'. Motivation(s):
// default object field drawer is not aware that the generic argument of
// LazyLoadReference<> should be used
