...
abstract class FlexibleMenuModifyItemUI : PopupWindowContent {
  ...
  public override void OnClose() {
    ...
    EditorApplication
        .RequestRepaintAllViews(); // When closed ensure FlexibileMenu gets
                                   // repainted so hover can be removed
  }

  public void Init(MenuType menuType, object obj,
                   Action<object> acceptedCallback) {
    m_MenuType = menuType;
    m_Object = obj;
  ...
  public bool IsShowing() { return m_IsInitialized; }
}
} // namespace
