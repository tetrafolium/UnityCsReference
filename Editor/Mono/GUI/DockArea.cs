...
internal class DockArea : HostView, IDropArea
{
    private static class Styles
    {
        ...
        public static readonly GUIStyle tabLabel = new GUIStyle("dragtab") {
            name = "dragtab-label"
        };
    ...
    public int selected
    {
        ...
        set {
            SetSelectedPrivate(value, sendEvents: true);
        }
    }
...
internal class MaximizedHostView : HostView
{
    static class Styles
    {
        ...
        public static readonly GUIStyle titleLabel = new GUIStyle("dragtab") {
            name = "dragtab-label"
        };
        public static readonly GUIStyle background = "dockarea";
        public static SVC<float> genericMenuTopOffset = new SVC<float>("--window-generic-menu-top-offset", 20f);
