...
internal class TreeViewController
{
    ...
    public System.Action<int[], bool> dragEndedCallback {
        get;    // dragged ids, if null then drag was not allowed, bool == true if dragging tree view items from own treeview, false if drag was started outside
        set;
    }
    ...
    {
        get {
            return m_DragSelection != null && m_DragSelection.Count > 0;
        }
    }
    ...
    {
        get {
            return m_VisibleRect.height > 0 && m_ContentRect.height > m_VisibleRect.height;
        }
    }
    ...
    {
        get {
            return m_VisibleRect.width > 0 && m_ContentRect.width > m_VisibleRect.width;
        }
    }
    ...
    {
        get {
            return m_UseScrollView;
        }
        set {
            m_UseScrollView = value;
        }
    }
    ...
    public bool animatingExpansion {
        get {
            return m_UseExpansionAnimation && m_ExpansionAnimator.isAnimating;
        }
    }
