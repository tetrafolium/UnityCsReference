...
namespace UnityEditor.IMGUI.Controls {
  public partial class MultiColumnHeader {
    ...
    public static class DefaultStyles {
      // Column header uses same colors as label, but slightly dimmed to let
      // list items stand out more (similar to win 10) Use middle alignment to
      // ensure labels are aligned regardless of icon size
      ...
      public static GUIStyle background =
          "MultiColumnTopBar"; // Use bar background with 1 pixel line at the
                               // bottom to let items have someting to clip
                               // against when scrolled
