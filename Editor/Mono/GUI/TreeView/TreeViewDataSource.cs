...
internal abstract class TreeViewDataSource : ITreeViewDataSource
{
    ...
    public bool alwaysAddFirstItemToSearchResult {
        get;    // is only used in searches when showRootItem is false. It Doesn't make sense for visible roots
        set;
    }
    ...
    {
        get {
            return m_TreeView.state.expandedIDs;
        }
        set {
            m_TreeView.state.expandedIDs = value;
        }
    }
    ...
    {
        get {
            return m_RootItem != null && m_Rows != null;
        }
    }
