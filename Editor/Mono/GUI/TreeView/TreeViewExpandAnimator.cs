...
internal class TreeViewItemExpansionAnimator
{
    ...
    {
        get {
            return Mathf.Floor(m_Setup.rowsRect.height - m_Setup.rowsRect.height * expandedValueNormalized);
        }
    }
    ...
    {
        get {
            return s_Debug && (m_Setup != null) && (m_Setup.treeView != null) && (Event.current.type == EventType.Repaint);
        }
    }
