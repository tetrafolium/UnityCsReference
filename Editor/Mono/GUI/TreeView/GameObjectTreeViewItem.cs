...
public GameObjectTreeViewItem(int id, int depth, TreeViewItem parent,
                              string displayName)
	...
	get {
		...
		if (base.displayName == null) {
			if (SubSceneGUI.IsUsingSubScenes()) {
				var subSceneHeaderName =
					SubSceneGUI.GetSubSceneHeaderText((GameObject) objectPPTR);
