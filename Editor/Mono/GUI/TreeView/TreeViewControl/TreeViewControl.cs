...
public abstract partial class TreeView
{
    ...
    {
        set {
            m_TreeView.getNewSelectionOverride = (x, y, z) => value(x, y, z);
        }
    }
    ...
    public TreeViewState state {
        get {
            return m_TreeView.state;
        }
    }
    public MultiColumnHeader multiColumnHeader {
        get {
            return m_MultiColumnHeader;
        }
        set {
            m_MultiColumnHeader = value;
        }
    }
    ...
    {
        get {
            return m_DataSource.isInitialized;
        }
    }
    ...
    {
        get {
            return m_GUI.k_BaseIndent;
        }
        set {
            m_GUI.k_BaseIndent = value;
        }
    }
    ...
    {
        get {
            return m_GUI.extraSpaceBeforeIconAndLabel;
        }
        set {
            m_GUI.extraSpaceBeforeIconAndLabel = value;
        }
    }
    ...
    {
        get {
            return m_GUI.customFoldoutYOffset;
        }
        set {
            m_GUI.customFoldoutYOffset = value;
        }
    }
    ...
    {
        get {
            return m_GUI.columnIndexForTreeFoldouts;
        }
        set
        {
    ...
    {
        get {
            return m_TreeView.useScrollView;
        }
        set {
            m_TreeView.useScrollView = value;
        }
    }
    ...
    {
        get {
            return m_GUI.k_IndentWidth;
        }
        set {
            m_GUI.k_IndentWidth = value;
        }
    }
    ...
    protected bool showingHorizontalScrollBar {
        get {
            return m_TreeView.showingHorizontalScrollBar;
        }
    }
    protected bool showingVerticalScrollBar {
        get {
            return m_TreeView.showingVerticalScrollBar;
        }
    }
    ...
    {
        get {
            return m_GUI.cellMargin;
        }
        set {
            m_GUI.cellMargin = value;
        }
    }
    ...
    {
        get {
            return m_GUI.k_LineHeight;
        }
        set {
            m_GUI.k_LineHeight = Mathf.Max(value, EditorGUIUtility.singleLineHeight);
        }
    }
    ...
    {
        get {
            return m_TreeViewKeyControlID;
        }
        set {
            m_TreeViewKeyControlID = value;
        }
    }
    ...
    {
        get {
            return m_TreeView.searchString;
        }
        set {
            m_TreeView.searchString = value;
        }
    }
