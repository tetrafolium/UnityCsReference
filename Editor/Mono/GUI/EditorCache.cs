...
internal class EditorWrapper : System.IDisposable {
  ...
  private bool Init(Object obj, EditorFeatures requirements) {
    ...
    if ((int)(requirements & EditorFeatures.PreviewGUI) > 0 &&
    ...
    onSceneDragMi =
        t.GetMethod("OnSceneDrag", BindingFlags.Instance | BindingFlags.Public |
                                       BindingFlags.NonPublic);
    if (onSceneDragMi != null)
      OnSceneDrag = (VoidDelegate) System.Delegate.CreateDelegate(
          typeof(VoidDelegate), editor, onSceneDragMi);
...
internal class EditorCache : System.IDisposable {
  ...
  ~EditorCache() { Debug.LogError("Failed to dispose EditorCache."); }
}
} // namespace
