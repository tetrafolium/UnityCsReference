...
abstract class EditModeTool : EditorTool {
  ...
  protected EditModeTool() {
    m_CanEditMultipleObjects =
        editorType.GetCustomAttributes(typeof(CanEditMultipleObjects), false)
            .Length > 0;
  }
  ...
  void OnActivate() { EditMode.EditModeToolStateChanged(owner, editMode); }
