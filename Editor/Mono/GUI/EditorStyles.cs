...
public sealed class EditorStyles {
  ...
  public static GUIStyle miniButtonLeft {
    get { return s_Current.m_MiniButtonLeft; }
  }
  ...
  public static GUIStyle objectField {
    get { return s_Current.m_ObjectField; }
  }
  private GUIStyle m_ObjectField;

  internal static GUIStyle objectFieldButton {
    get { return s_Current.m_ObjectFieldButton; }
  }
  ...
  public static Font miniBoldFont =>
      EditorResources.GetFont(FontDef.Style.Bold);

  // Toolbar background from top of windows.
  public static GUIStyle toolbar {
    get { return s_Current.m_Toolbar; }
  }
  private GUIStyle m_Toolbar;
  internal static GUIStyle contentToolbar {
    get { return s_Current.m_ContentToolbar; }
  }
  private GUIStyle m_ContentToolbar;

  // Style for Button and Toggles in toolbars.
  public static GUIStyle toolbarButton {
    get { return s_Current.m_ToolbarButton; }
  }
  private GUIStyle m_ToolbarButton;
  internal static GUIStyle toolbarButtonLeft {
    get { return s_Current.m_ToolbarButtonLeft; }
  }
  private GUIStyle m_ToolbarButtonLeft;

  internal static GUIStyle toolbarButtonRight {
    get { return s_Current.m_ToolbarButtonRight; }
  }
  private GUIStyle m_ToolbarButtonRight;

  // Toolbar Popup
  public static GUIStyle toolbarPopup {
    get { return s_Current.m_ToolbarPopup; }
  }
  private GUIStyle m_ToolbarPopup;

  internal static GUIStyle toolbarPopupLeft {
    get { return s_Current.m_ToolbarPopupLeft; }
  }
  private GUIStyle m_ToolbarPopupLeft;

  internal static GUIStyle toolbarPopupRight {
    get { return s_Current.m_ToolbarPopupRight; }
  }
  private GUIStyle m_ToolbarPopupRight;

  internal static GUIStyle toolbarDropDownLeft {
    get { return s_Current.m_ToolbarDropDownLeft; }
  }
  private GUIStyle m_ToolbarDropDownLeft;

  public static GUIStyle toolbarDropDown {
    get { return s_Current.m_ToolbarDropDown; }
  }
  private GUIStyle m_ToolbarDropDown;

  // Toolbar Dropdown Right
  internal static GUIStyle toolbarDropDownRight {
    get { return s_Current.m_ToolbarDropDownRight; }
  }
  private GUIStyle m_ToolbarDropDownRight;

  // Toolbar Dropdown Toggle
  internal static GUIStyle toolbarDropDownToggle {
    get { return s_Current.m_ToolbarDropDownToggle; }
  }
  private GUIStyle m_ToolbarDropDownToggle;

  // Toolbar Dropdown Toggle Right
  internal static GUIStyle toolbarDropDownToggleRight {
    get { return s_Current.m_ToolbarDropDownToggleRight; }
  }
  private GUIStyle m_ToolbarDropDownToggleRight;

  // Toolbar Dropdown
  internal static GUIStyle toolbarCreateAddNewDropDown {
    get { return s_Current.m_ToolbarCreateAddNewDropDown; }
  }
  private GUIStyle m_ToolbarCreateAddNewDropDown;

  // Toolbar text field
  public static GUIStyle toolbarTextField {
    get { return s_Current.m_ToolbarTextField; }
  }
  private GUIStyle m_ToolbarTextField;

  internal static GUIStyle toolbarLabel {
    get { return s_Current.m_ToolbarLabel; }
  }
  private GUIStyle m_ToolbarLabel;

  public static GUIStyle inspectorDefaultMargins {
    get { return s_Current.m_InspectorDefaultMargins; }
  }
  private GUIStyle m_InspectorDefaultMargins;

  public static GUIStyle inspectorFullWidthMargins {
    get { return s_Current.m_InspectorFullWidthMargins; }
  }
  private GUIStyle m_InspectorFullWidthMargins;

  internal static GUIStyle defaultContentMargins {
    get { return s_Current.m_DefaultContentMargins; }
  }
  ...
  [ExcludeFromDocs]
  public static GUIStyle FromUSS(string ussStyleRuleName,
                                 string ussInPlaceStyleOverride = null) {
    return GUIStyleExtensions.FromUSS(ussStyleRuleName,
                                      ussInPlaceStyleOverride);
  }

  [ExcludeFromDocs]
  public static GUIStyle FromUSS(GUIStyle baseStyle, string ussStyleRuleName,
                                 string ussInPlaceStyleOverride = null) {
    return GUIStyleExtensions.FromUSS(baseStyle, ussStyleRuleName,
                                      ussInPlaceStyleOverride);
  }

  [ExcludeFromDocs]
  public static GUIStyle ApplyUSS(GUIStyle style, string ussStyleRuleName,
                                  string ussInPlaceStyleOverride = null) {
    return GUIStyleExtensions.ApplyUSS(style, ussStyleRuleName,
                                       ussInPlaceStyleOverride);
  }
  ...
  private void InitSharedStyles() {
    ...
    m_ToolbarSearchFieldCancelButtonEmpty =
    ...
    m_InspectorDefaultMargins = new GUIStyle{
        padding = new RectOffset(kInspectorPaddingLeft, kInspectorPaddingRight,
                                 kInspectorPaddingTop, 0)};

    // For the full width margins, use padding from right side in both sides,
    // though adjust for overdraw by adding one in left side to get even
    // margins.
    m_InspectorFullWidthMargins =
        new GUIStyle{padding = new RectOffset(kInspectorPaddingRight + 1,
                                              kInspectorPaddingRight, 0, 0)};

    m_DefaultContentMargins =
        new GUIStyle{padding = new RectOffset(4, 4, 4, 4)};
