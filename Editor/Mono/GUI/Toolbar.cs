...
class Toolbar : GUIView {
  ...
  static class Styles {
    ...
    public static readonly GUIStyle paneOptions =
        new GUIStyle("PaneOptions"){fixedHeight = k_ToolbarHeight};
  }
  ...
  [SerializeField] List<EditorToolbar> m_LoadedToolbars;
  ...
  [SerializeField] EditorToolbar m_MainToolbar;

  internal EditorToolbar mainToolbar {
    get {
      if (m_MainToolbar == null)
        m_MainToolbar =
            GetSingleton(EditorUIService.instance.GetDefaultToolbarType());
    ...
    set {
      ...
      m_MainToolbar =
          value ==
          null ? GetSingleton(EditorUIService.instance.GetDefaultToolbarType())
          : value;
      ...
      if (m_MainToolbar.rootVisualElement != null) {
        ...
        var visualTree =
            windowBackend.visualTree as UnityEngine.UIElements.VisualElement;
  ...
  [SerializeField] string m_LastLoadedLayoutName;
  ...
  internal static string lastLoadedLayoutName {
    get {
      ...
      return string.IsNullOrEmpty(get.m_LastLoadedLayoutName)
                 ? "Layout"
                 : get.m_LastLoadedLayoutName;
    }
    set {
      if (!get)
        return;
  ...
  protected override void OnEnable() {
    ...
    if (m_MainToolbar == null)
      m_MainToolbar = (EditorToolbar)
          CreateInstance(EditorUIService.instance.GetDefaultToolbarType());
  ...
  protected override bool OnFocus() { return false; }
  ...
  public float CalcHeight() { return k_ToolbarHeight; }
  ...
  public Rect GetToolbarPosition() { return position; }
