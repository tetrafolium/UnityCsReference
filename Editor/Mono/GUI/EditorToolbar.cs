...
class MainToolbarAttribute : Attribute {
  ...
  public MainToolbarAttribute(string name) { m_DisplayName = name; }
}
...
class EditorToolbar : ScriptableObject {
  ...
  // Static functions for setting the main app toolbar are in EditorToolbar for
  // lack of any better place to put them. However EditorToolbar could be used
