...
[StructLayout(LayoutKind.Sequential)] struct DrawGridParameters {
  public int gridID;
...
public sealed partial class Handles {
  ...
  internal static PrefColor s_XAxisColor =
      new PrefColor("Scene/X Axis", 219f / 255, 62f / 255, 29f / 255, .93f);
  public static Color xAxisColor {
    get { return s_XAxisColor; }
  }
  // Color of the Y axis handle
  internal static PrefColor s_YAxisColor =
      new PrefColor("Scene/Y Axis", 154f / 255, 243f / 255, 72f / 255, .93f);
  public static Color yAxisColor {
    get { return s_YAxisColor; }
  }
  // Color of the Z axis handle
  internal static PrefColor s_ZAxisColor =
      new PrefColor("Scene/Z Axis", 58f / 255, 122f / 255, 248f / 255, .93f);
  public static Color zAxisColor {
    get { return s_ZAxisColor; }
  }
  // Color of the center handle
  internal static PrefColor s_CenterColor =
      new PrefColor("Scene/Center Axis", .8f, .8f, .8f, .93f);
  public static Color centerColor {
    get { return s_CenterColor; }
  }
  // color for handles the currently active handle
  internal static PrefColor s_SelectedColor = new PrefColor(
      "Scene/Selected Axis", 246f / 255, 242f / 255, 50f / 255, .89f);
  public static Color selectedColor {
    get { return s_SelectedColor; }
  }
  // color for handles the currently hovered handle
  internal static PrefColor s_PreselectionColor =
      new PrefColor("Scene/Preselection Highlight", 201f / 255, 200f / 255,
                    144f / 255, 0.89f);
  public static Color preselectionColor {
    get { return s_PreselectionColor; }
  }
  // soft color for general stuff - used to draw e.g. the arc selection while
  // dragging
  internal static PrefColor s_SecondaryColor =
      new PrefColor("Scene/Guide Line", .5f, .5f, .5f, .2f);
  public static Color secondaryColor {
    get { return s_SecondaryColor; }
  }
  ...
  internal static Color s_ColliderHandleColor =
      new Color(145f, 244f, 139f, 210f) / 255;
  internal static Color s_ColliderHandleColorDisabled =
      new Color(84, 200f, 77f, 140f) / 255;
  internal static Color s_BoundingBoxHandleColor =
      new Color(255, 255, 255, 150) / 255;

  internal readonly static GUIContent s_StaticLabel =
      EditorGUIUtility.TrTextContent("Static");
  internal readonly static GUIContent s_PrefabLabel =
      EditorGUIUtility.TrTextContent("Prefab");

  internal static int s_SliderHash = "SliderHash".GetHashCode();
  internal static int s_Slider2DHash = "Slider2DHash".GetHashCode();
  internal static int s_FreeRotateHandleHash =
      "FreeRotateHandleHash".GetHashCode();
  internal static int s_RadiusHandleHash = "RadiusHandleHash".GetHashCode();
  internal static int s_xAxisMoveHandleHash =
      "xAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_yAxisMoveHandleHash =
      "yAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_zAxisMoveHandleHash =
      "zAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_FreeMoveHandleHash = "FreeMoveHandleHash".GetHashCode();
  internal static int s_xzAxisMoveHandleHash =
      "xzAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_xyAxisMoveHandleHash =
      "xyAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_yzAxisMoveHandleHash =
      "yzAxisFreeMoveHandleHash".GetHashCode();
  internal static int s_xAxisScaleHandleHash =
      "xAxisScaleHandleHash".GetHashCode();
  internal static int s_yAxisScaleHandleHash =
      "yAxisScaleHandleHash".GetHashCode();
  internal static int s_zAxisScaleHandleHash =
      "zAxisScaleHandleHash".GetHashCode();
  internal static int s_ScaleSliderHash = "ScaleSliderHash".GetHashCode();
  internal static int s_ScaleValueHandleHash =
      "ScaleValueHandleHash".GetHashCode();
  ...
  static readonly int kPropArcCenterRadius =
      Shader.PropertyToID("_ArcCenterRadius");
  static readonly int kPropArcNormalAngle =
      Shader.PropertyToID("_ArcNormalAngle");
  static readonly int kPropArcFromCount = Shader.PropertyToID("_ArcFromCount");
  static readonly int kPropArcThicknessSides =
      Shader.PropertyToID("_ArcThicknessSides");
  static readonly int kPropHandlesMatrix =
      Shader.PropertyToID("_HandlesMatrix");
  ...
  internal static int s_cameraAxisRotateHandleHash =
      "cameraAxisRotateHandleHash".GetHashCode();
  internal static int s_xyzRotateHandleHash =
      "xyzRotateHandleHash".GetHashCode();
  ...
  internal static SavedFloat s_LineThickness =
      new SavedFloat("SceneView.handleLineThickness", 2.0f);
  public static float lineThickness => s_LineThickness.value;

  // When hovering over some handle axis/control, this is the indication that it
  // would get picked on mouse press: Color gets a bit more bright and less
  // opaque,
  ...
  // When axis is looking away from camera, fade it out along 25 -> 15 degrees
  // range
  static readonly float kCameraViewLerpStart1 =
      Mathf.Cos(Mathf.Deg2Rad * 25.0f);
  static readonly float kCameraViewLerpEnd1 = Mathf.Cos(Mathf.Deg2Rad * 15.0f);
  // When axis is looking towards the camera, fade it out along 170 -> 175
  // degrees range
  static readonly float kCameraViewLerpStart2 =
      Mathf.Cos(Mathf.Deg2Rad * 170.0f);
  ...
  // The function for calling AddControl in Layout event and draw the handle in
  // Repaint event.
  public delegate void CapFunction(int controlID, Vector3 position,
                                   Quaternion rotation, float size,
                                   EventType eventType);
  ...
  internal static Color s_DisabledHandleColor =
      new Color(0.5f, 0.5f, 0.5f, 0.5f);

  internal static Color GetColorByAxis(int axis) { return s_AxisColor[axis]; }
  ...
  static Vector3 GetAxisVector(int axis) { return s_AxisVector[axis]; }

  internal static bool IsHovering(int controlID, Event evt) {
    return controlID == HandleUtility.nearestControl &&
           GUIUtility.hotControl == 0 && !Tools.viewToolActive;
  }

  static internal void SetupHandleColor(int controlID, Event evt,
                                        out Color prevColor,
                                        out float thickness) {
  ...
  static void CalcDrawOrder(Vector3 viewDir, int[] ordering) {
    ...
    if (viewDir.y > viewDir.x)
      Swap(ref viewDir, ordering, 1, 0);
    if (viewDir.z > viewDir.y)
      Swap(ref viewDir, ordering, 2, 1);
    if (viewDir.y > viewDir.x)
      Swap(ref viewDir, ordering, 1, 0);
  }
  ...
  static float ThicknessToPixels(float thickness) {
    var halfThicknessPixels =
        thickness * EditorGUIUtility.pixelsPerPoint * 0.5f;
  ...
  public static void DrawLine(Vector3 p1, Vector3 p2,
    ...
    mat.SetVector(kPropArcThicknessSides,
                  new Vector4(thickness, kArcSides, 0, 0));
    mat.SetPass(1);

    var indexBuffer = HandleUtility.GetArcIndexBuffer(kArcSegments, kArcSides);
    Graphics.DrawProceduralNow(MeshTopology.Triangles, indexBuffer,
                               kArcSides * 6);
  }
  ...
  public static void DrawDottedLine(Vector3 p1, Vector3 p2,
    ...
    GL.MultiTexCoord2(2, dashSize, 0);
    GL.Vertex(p1);
    GL.MultiTexCoord(1, p1);
    GL.MultiTexCoord2(2, dashSize, 0);
    GL.Vertex(p2);
  ...
  public static Quaternion Disc(int id, Quaternion rotation, Vector3 position,
                                Vector3 axis, float size, bool cutoffPlane,
                                float snap) {
    return UnityEditorInternal.Disc.Do(id, rotation, position, axis, size,
                                       cutoffPlane, snap);
  }

  public static Quaternion FreeRotateHandle(int id, Quaternion rotation,
  ...
  public static Vector3 Slider(Vector3 position, Vector3 direction) {
    return Slider(position, direction, HandleUtility.GetHandleSize(position),
                  ArrowHandleCap, -1);
  }

  public static Vector3 Slider(Vector3 position, Vector3 direction, float size,
                               CapFunction capFunction, float snap) {
    int id = GUIUtility.GetControlID(s_SliderHash, FocusType.Passive);
    return UnityEditorInternal.Slider1D.Do(id, position, direction, size,
                                           capFunction, snap);
  }

  public static Vector3 Slider(int controlID, Vector3 position,
                               Vector3 direction, float size,
                               CapFunction capFunction, float snap) {
    return UnityEditorInternal.Slider1D.Do(controlID, position, direction, size,
                                           capFunction, snap);
  }

  public static Vector3 Slider(int controlID, Vector3 position, Vector3 offset,
                               Vector3 direction, float size,
                               CapFunction capFunction, float snap) {
    return UnityEditorInternal.Slider1D.Do(controlID, position, offset,
                                           direction, direction, size,
                                           capFunction, snap);
  }

  public static Vector3 FreeMoveHandle(Vector3 position, Quaternion rotation,
                                       float size, Vector3 snap,
                                       CapFunction capFunction) {
    int id = GUIUtility.GetControlID(s_FreeMoveHandleHash, FocusType.Passive);
    return UnityEditorInternal.FreeMove.Do(id, position, rotation, size, snap,
                                           capFunction);
  }

  public static Vector3 FreeMoveHandle(int controlID, Vector3 position,
                                       Quaternion rotation, float size,
                                       Vector3 snap, CapFunction capFunction) {
    return UnityEditorInternal.FreeMove.Do(controlID, position, rotation, size,
                                           snap, capFunction);
  }

  // Make a single-float draggable handle.
  public static float ScaleValueHandle(float value, Vector3 position,
                                       Quaternion rotation, float size,
                                       CapFunction capFunction, float snap) {
    int id = GUIUtility.GetControlID(s_ScaleValueHandleHash, FocusType.Passive);
    return UnityEditorInternal.SliderScale.DoCenter(
        id, value, position, rotation, size, capFunction, snap);
  }

  public static float ScaleValueHandle(int controlID, float value,
                                       Vector3 position, Quaternion rotation,
                                       float size, CapFunction capFunction,
                                       float snap) {
    return UnityEditorInternal.SliderScale.DoCenter(
        controlID, value, position, rotation, size, capFunction, snap);
  }

  // Make a 3D Button.
  public static bool Button(Vector3 position, Quaternion direction, float size,
                            float pickSize, CapFunction capFunction) {
    int id = GUIUtility.GetControlID(s_ButtonHash, FocusType.Passive);
    return UnityEditorInternal.Button.Do(id, position, direction, size,
                                         pickSize, capFunction);
  }

  internal static bool Button(int controlID, Vector3 position,
                              Quaternion direction, float size, float pickSize,
                              CapFunction capFunction) {
    return UnityEditorInternal.Button.Do(controlID, position, direction, size,
                                         pickSize, capFunction);
  }

  // Draw a cube. Pass this into handle functions.
  public static void CubeHandleCap(int controlID, Vector3 position,
                                   Quaternion rotation, float size,
                                   EventType eventType) {
    switch (eventType) {
    ...
    case EventType.MouseMove:
      HandleUtility.AddControl(
          controlID, HandleUtility.DistanceToCube(position, rotation, size));
      break;
  ...
  public static void SphereHandleCap(int controlID, Vector3 position,
                                     Quaternion rotation, float size,
                                     EventType eventType) {
    switch (eventType) {
    case EventType.Layout:
  ...
  public static void ConeHandleCap(int controlID, Vector3 position,
                                   Quaternion rotation, float size,
                                   EventType eventType) {
    switch (eventType) {
    case EventType.Layout:
    case EventType.MouseMove:
      HandleUtility.AddControl(
          controlID, HandleUtility.DistanceToCone(position, rotation, size));
      break;
    case (EventType.Repaint):
  ...
  public static void CylinderHandleCap(int controlID, Vector3 position,
                                       Quaternion rotation, float size,
                                       EventType eventType) {
    switch (eventType) {
    case EventType.Layout:
    case EventType.MouseMove:
      ...
      break;
    case (EventType.Repaint):
      Graphics.DrawMeshNow(cylinderMesh,
  ...
  public static void RectangleHandleCap(int controlID, Vector3 position,
                                        Quaternion rotation, float size,
                                        EventType eventType) {
    RectangleHandleCap(controlID, position, rotation, new Vector2(size, size),
                       eventType);
  }

  internal static void RectangleHandleCap(int controlID, Vector3 position,
    ...
    case EventType.MouseMove:
      ...
      HandleUtility.AddControl(
          controlID,
          HandleUtility.DistanceToRectangleInternal(position, rotation, size));
      break;
    case (EventType.Repaint):
  ...
  internal static void RectangleHandleCapWorldSpace(int controlID,
                                                    Vector3 position,
                                                    Quaternion rotation,
                                                    float size,
                                                    EventType eventType) {
    RectangleHandleCapWorldSpace(controlID, position, rotation,
                                 new Vector2(size, size), eventType);
  }
  ...
  internal static void RectangleHandleCapWorldSpace(int controlID,
    ...
    case EventType.MouseMove:
      HandleUtility.AddControl(
          controlID, HandleUtility.DistanceToRectangleInternalWorldSpace(
  ...
  public static void DotHandleCap(int controlID, Vector3 position,
                                  Quaternion rotation, float size,
                                  EventType eventType) {
    switch (eventType) {
    case EventType.Layout:
    case EventType.MouseMove:
      HandleUtility.AddControl(controlID, HandleUtility.DistanceToRectangle(
                                              position, rotation, size));
      break;
    case (EventType.Repaint):
      ...
      Vector3 sideways = (Camera.current == null ? Vector3.right
                          : Camera.current.transform.right) *
                         size;
      Vector3 up = (Camera.current == null ? Vector3.up
  ...
  public static void CircleHandleCap(int controlID, Vector3 position,
                                     Quaternion rotation, float size,
                                     EventType eventType) {
    switch (eventType) {
    case EventType.Layout:
  ...
  public static void ArrowHandleCap(int controlID, Vector3 position,
                                    Quaternion rotation, float size,
                                    EventType eventType) {
    ArrowHandleCap(controlID, position, rotation, size, eventType,
                   Vector3.zero);
  }

  internal static void ArrowHandleCap(int controlID, Vector3 position,
                                      Quaternion rotation, float size,
                                      EventType eventType, Vector3 coneOffset) {
    switch (eventType) {
    case EventType.Layout:
    case EventType.MouseMove: {
      ...
      HandleUtility.AddControl(
          ...
          HandleUtility.DistanceToLine(
              position, position + (direction + coneOffset) * (size * .9f)));
      HandleUtility.AddControl(controlID,
                               HandleUtility.DistanceToCone(
                                   position + (direction + coneOffset) * size,
                                   rotation, size * .2f));
      break;
    }
    case EventType.Repaint: {
      ...
      ConeHandleCap(controlID, position + (direction + coneOffset) * size,
                    rotation, coneSize, eventType);
      Handles.DrawLine(position,
                       position + (direction + coneOffset) * (size * .9f),
                       thickness);
      break;
    }
    }
  ...
  public static void DrawSelectionFrame(int controlID, Vector3 position,
                                        Quaternion rotation, float size,
                                        EventType eventType) {
  ...
  internal static Color GetFadedAxisColor(Color col, float fade, int id) {
    // never fade out axes that are being hover-highlighted or currently
    // interacted with
    if (id != 0 && id == GUIUtility.hotControl ||
        id == HandleUtility.nearestControl)
      fade = 0;
    col = Color.Lerp(col, Color.clear, fade);
    return col;
  }

  internal static float GetCameraViewLerpForWorldAxis(Vector3 viewVector,
                                                      Vector3 axis) {
  ...
  internal static Vector3 GetCameraViewFrom(Vector3 position,
                                            Matrix4x4 matrix) {
    Camera camera = Camera.current;
    return camera.orthographic
               ? matrix.MultiplyVector(camera.transform.forward)
        .normalized
        : matrix.MultiplyVector(position - camera.transform.position)
        .normalized;
  }
  ...
  ///*listonly*
  public static float RadiusHandle(Quaternion rotation, Vector3 position,
                                   float radius, bool handlesOnly) {
  ...
  internal static Vector2 ConeHandle(Quaternion rotation, Vector3 position,
                                     Vector2 angleAndRange, float angleScale,
                                     float rangeScale, bool handlesOnly) {
    return DoConeHandle(rotation, position, angleAndRange, angleScale,
                        rangeScale, handlesOnly);
  }

  // Make a Scene View cone frustrum handle
  internal static Vector3
  ConeFrustrumHandle(Quaternion rotation, Vector3 position,
                     Vector3 radiusAngleRange,
                     ConeHandles showHandles = ConeHandles.All) {
    return DoConeFrustrumHandle(rotation, position, radiusAngleRange,
                                showHandles);
  }

  // Slide a handle in a 2D plane
  public static Vector3 Slider2D(int id, Vector3 handlePos, Vector3 offset,
                                 Vector3 handleDir, Vector3 slideDir1,
                                 Vector3 slideDir2, float handleSize,
                                 CapFunction capFunction, Vector2 snap) {
    return Slider2D(id, handlePos, offset, handleDir, slideDir1, slideDir2,
                    handleSize, capFunction, snap, false);
  }
  ...
  public static Vector3 Slider2D(int id, Vector3 handlePos, Vector3 offset,
    ...
    return UnityEditorInternal.Slider2D.Do(id, handlePos, offset, handleDir,
                                           slideDir1, slideDir2, handleSize,
                                           capFunction, snap, drawHelper);
  }

  /// *listonly*
  public static Vector3 Slider2D(Vector3 handlePos, Vector3 handleDir,
                                 Vector3 slideDir1, Vector3 slideDir2,
                                 float handleSize, CapFunction capFunction,
                                 Vector2 snap) {
    return Slider2D(handlePos, handleDir, slideDir1, slideDir2, handleSize,
  ...
  public static Vector3 Slider2D(Vector3 handlePos, Vector3 handleDir,
    ...
    return UnityEditorInternal.Slider2D.Do(
        id, handlePos, new Vector3(0, 0, 0), handleDir, slideDir1, slideDir2,
        handleSize, capFunction, snap, drawHelper);
  }

  /// *listonly*
  public static Vector3 Slider2D(int id, Vector3 handlePos, Vector3 handleDir,
                                 Vector3 slideDir1, Vector3 slideDir2,
                                 float handleSize, CapFunction capFunction,
                                 Vector2 snap) {
    return Slider2D(id, handlePos, handleDir, slideDir1, slideDir2, handleSize,
                    capFunction, snap, false);
  }
  ...
  public static Vector3 Slider2D(Vector3 handlePos, Vector3 handleDir,
                                 ...
                                 [ DefaultValue("false") ] bool drawHelper) {
    int id = GUIUtility.GetControlID(s_Slider2DHash, FocusType.Passive);
    return Slider2D(id, handlePos, new Vector3(0, 0, 0), handleDir, slideDir1,
                    slideDir2, handleSize, capFunction, new Vector2(snap, snap),
                    drawHelper);
  }

  // Make an unconstrained rotation handle.
  public static Quaternion FreeRotateHandle(Quaternion rotation,
                                            Vector3 position, float size) {
  ...
  public static float ScaleSlider(float scale, Vector3 position,
    ...
    return UnityEditorInternal.SliderScale.DoAxis(
        id, scale, position, direction, rotation, size, snap);
  }

  // Make a 3D disc that can be dragged with the mouse
  public static Quaternion Disc(Quaternion rotation, Vector3 position,
                                Vector3 axis, float size, bool cutoffPlane,
                                float snap) {
  ...
  internal static void SetupIgnoreRaySnapObjects() {
    HandleUtility.ignoreRaySnapObjects =
        Selection.GetTransforms(SelectionMode.Editable | SelectionMode.Deep);
  }

  // If snapping is active, return a new value rounded to the nearest increment
  // of snap.
  ...
  public static void SnapToGrid(Transform[] transforms,
    ...
    if (transforms != null && transforms.Length > 0) {
      foreach (var t in transforms) {
        if (t != null)
          t.position = Snapping.Snap(
              t.position,
              Vector3.Scale(GridSettings.size, new SnapAxisFilter(axis)));
      }
    }
  }
  ...
  public Camera currentCamera {
    ...
    set { Internal_SetCurrentCamera(value); }
  }

  internal static Color realHandleColor {
    get {
      return color * new Color(1, 1, 1, .5f) +
             (lighting ? new Color(0, 0, 0, .5f)
              : new Color(0, 0, 0, 0));
    }
  }

  // Draw two-shaded wire-disc that is fully shadowed
  internal static void DrawTwoShadedWireDisc(Vector3 position, Vector3 axis,
                                             float radius) {
  ...
  // Draw two-shaded wire-disc with from and degrees specifying the lit part and
  // the rest being shadowed
  internal static void DrawTwoShadedWireDisc(Vector3 position, Vector3 axis,
                                             Vector3 from, float degrees,
                                             float radius) {
  ...
  // Sets up matrix
  internal static Matrix4x4 StartCapDraw(Vector3 position, Quaternion rotation,
                                         float size) {
  ...
  internal static void RectangleCap(int controlID, Vector3 position,
                                    Quaternion rotation, Vector2 size) {
    if (Event.current.type != EventType.Repaint)
      return;
    Vector3 sideways = rotation * new Vector3(size.x, 0, 0);
  ...
  // Draw a camera facing selection frame.
  public static void SelectionFrame(int controlID, Vector3 position,
                                    Quaternion rotation, float size) {
    if (Event.current.type != EventType.Repaint)
      return;
    Handles.StartCapDraw(position, rotation, size);
  ...
  internal static void DrawAAPolyLine(Color[] colors, Vector3[] points) {
    DoDrawAAPolyLine(colors, points, -1, null, 2, 0.75f);
  }
  internal static void DrawAAPolyLine(float width, Color[] colors,
                                      Vector3[] points) {
    DoDrawAAPolyLine(colors, points, -1, null, width, 0.75f);
  }
  /// *listonly*
  public static void DrawAAPolyLine(params Vector3[] points) {
    DoDrawAAPolyLine(null, points, -1, null, 2, 0.75f);
  }
  /// *listonly*
  ...
  /// *listonly*
  public static void DrawAAPolyLine(Texture2D lineTex,
                                    params Vector3[] points) {
    DoDrawAAPolyLine(null, points, -1, lineTex, lineTex.height / 2, 0.99f);
  }
  /// *listonly*
  ...
  public static void DrawAAPolyLine(Texture2D lineTex, float width,
                                    params Vector3[] points) {
    DoDrawAAPolyLine(null, points, -1, lineTex, width, 0.99f);
  }

  static void DoDrawAAPolyLine(Color[] colors, Vector3[] points,
                               int actualNumberOfPoints, Texture2D lineTex,
    ...
    Internal_DrawAAPolyLine(colors, points, defaultColor, actualNumberOfPoints,
                            lineTex, width, matrix);
  }

  // Draw anti-aliased convex polygon specified with point array.
  public static void DrawAAConvexPolygon(params Vector3[] points) {
    DoDrawAAConvexPolygon(points, -1, 1.0f);
  }

  static void DoDrawAAConvexPolygon(Vector3[] points, int actualNumberOfPoints,
                                    float alpha) {
    if (Event.current.type != EventType.Repaint)
      return;
    ...
    Internal_DrawAAConvexPolygon(points, defaultColor, actualNumberOfPoints,
                                 matrix);
  }

  // Draw textured bezier line through start and end points with the given
  // tangents.  To get an anti-aliased effect use a texture that is 1x2 pixels
  // with one transparent white pixel and one opaque white pixel.  The bezier
  // curve will be swept using this texture.
  public static void DrawBezier(Vector3 startPosition, Vector3 endPosition,
                                Vector3 startTangent, Vector3 endTangent,
                                Color color, Texture2D texture, float width) {
    if (Event.current.type != EventType.Repaint)
      return;

    HandleUtility.ApplyWireMaterial(zTest);
    Internal_DrawBezier(startPosition, endPosition, startTangent, endTangent,
                        color, texture, width, matrix);
  }

  // Draw the outline of a flat disc in 3D space.
  [ExcludeFromDocs]
  public static void DrawWireDisc(Vector3 center, Vector3 normal,
                                  float radius) {
  ...
  [ExcludeFromDocs]
  public static void DrawWireArc(Vector3 center, Vector3 normal, Vector3 from,
  ...
  public static void DrawWireArc(Vector3 center, Vector3 normal, Vector3 from,
    ...
    var mat = SetupArcMaterial();
    mat.SetVector(kPropArcCenterRadius,
                  new Vector4(center.x, center.y, center.z, radius));
    mat.SetVector(kPropArcNormalAngle, new Vector4(normal.x, normal.y, normal.z,
                                                   angle * Mathf.Deg2Rad));
    mat.SetVector(kPropArcFromCount,
                  new Vector4(from.x, from.y, from.z, kArcSegments));
    mat.SetVector(kPropArcThicknessSides,
                  new Vector4(thickness, kArcSides, 0, 0));
    mat.SetPass(0);
    ...
    if (thickness <= 0.0f)
      ...
      var indexBuffer =
          HandleUtility.GetArcIndexBuffer(kArcSegments, kArcSides);
      Graphics.DrawProceduralNow(MeshTopology.Triangles, indexBuffer,
                                 indexBuffer.count);
    }
  }

  public static void DrawSolidRectangleWithOutline(Rect rectangle,
                                                   Color faceColor,
                                                   Color outlineColor) {
    Vector3[] points = {new Vector3(rectangle.xMin, rectangle.yMin, 0.0f),
  ...
  public static void DrawSolidDisc(Vector3 center, Vector3 normal,
                                   float radius) {
    Vector3 tangent = Vector3.Cross(normal, Vector3.up);
    if (tangent.sqrMagnitude < .001f)
      tangent = Vector3.Cross(normal, Vector3.right);
  ...
  public static void DrawSolidArc(Vector3 center, Vector3 normal, Vector3 from,
                                  float angle, float radius) {
    if (Event.current.type != EventType.Repaint)
      return;
  ...
  internal static Mesh s_CubeMesh, s_SphereMesh, s_ConeMesh, s_CylinderMesh,
      s_QuadMesh;
  internal static void Init() {
    if (!s_CubeMesh) {
      GameObject handleGo =
          (GameObject) EditorGUIUtility.Load("SceneView/HandlesGO.fbx");
      if (!handleGo) {
  ...
  public static void Label(Vector3 position, GUIContent content,
    ...
    Handles.BeginGUI();
    GUI.Label(HandleUtility.WorldPointToSizedRect(position, content, style),
              content, style);
    Handles.EndGUI();
  }
  ...
  internal static Rect GetCameraRect(Rect position) {
    ...
    Rect cameraRect = new Rect(screenRect.xMin, Screen.height - screenRect.yMax,
  ...
  public static void ClearCamera(Rect position, Camera camera) {
    ...
    if (camera.targetTexture == null) {
      ...
      Rect cameraRect =
          new Rect(screenRect.xMin, Screen.height - screenRect.yMax,
                   screenRect.width, screenRect.height);
  ...
  internal static void DrawCameraImpl(Rect position, Camera camera,
                                      DrawCameraMode drawMode, bool drawGrid,
                                      DrawGridParameters gridParam, bool finish,
  ...
  // It also sets up the (for now, anyways) undocumented Event.current.mouseRay
  // and Event.current.lastMouseRay for handleutility functions.
  //
  internal static void DrawCamera(Rect position, Camera camera,
                                  DrawCameraMode drawMode,
                                  DrawGridParameters gridParam) {
    DrawCameraImpl(position, camera, drawMode, true, gridParam, true);
  }

  internal static void DrawCameraStep1(Rect position, Camera camera,
                                       DrawCameraMode drawMode,
                                       DrawGridParameters gridParam,
                                       bool drawGizmos) {
  ...
  public static void DrawCamera(Rect position, Camera camera, [
    DefaultValue("UnityEditor.DrawCameraMode.Normal")
  ] DrawCameraMode drawMode) {
    DrawCamera(position, camera, drawMode, true);
  }

  public static void
  DrawCamera(Rect position, Camera camera,
             [
               DefaultValue("UnityEditor.DrawCameraMode.Normal")
             ] DrawCameraMode drawMode,
             bool drawGizmos) {
  ...
  internal enum CameraFilterMode { Off = 0, ShowFiltered = 1 }
  ...
  // Set the current camera so all Handles and Gizmos are draw with its
  // settings.
  ...
  [Obsolete(
      "Please use BeginGUI() with GUILayout.BeginArea(position) / GUILayout.EndArea()")]
  ...
  public static Vector3[] MakeBezierPoints(Vector3 startPosition,
                                           Vector3 endPosition,
                                           Vector3 startTangent,
                                           Vector3 endTangent, int division) {
    if (division < 1)
      throw new ArgumentOutOfRangeException("division",
                                            "Must be greater than zero");
    return Internal_MakeBezierPoints(startPosition, endPosition, startTangent,
                                     endTangent, division);
  }

  public static void
  DrawTexture3DSDF(Texture texture,
    ...
    Vector3 localScale = new Vector3(matrix.GetColumn(0).magnitude,
                                     matrix.GetColumn(1).magnitude,
                                     matrix.GetColumn(2).magnitude);
    Texture3DInspector.PrepareSDFPreview(Texture3DInspector.Materials.SDF,
                                         texture, localScale, stepScale,
                                         surfaceOffset, customColorRamp);
    Texture3DInspector.Materials.SDF.SetPass(0);
    Graphics.DrawMeshNow(cubeMesh, matrix);
  }

  public static void
  DrawTexture3DSlice(Texture texture, Vector3 slicePositions,
                     [
                       DefaultValue("FilterMode.Bilinear")
    ...
    Vector3 localScale = new Vector3(matrix.GetColumn(0).magnitude,
                                     matrix.GetColumn(1).magnitude,
                                     matrix.GetColumn(2).magnitude);
    Texture3DInspector.PrepareSlicePreview(Texture3DInspector.Materials.Slice,
                                           texture, slicePositions, filterMode,
                                           useColorRamp, customColorRamp);
    Texture3DInspector.Materials.Slice.SetPass(0);
    Graphics.DrawMeshNow(cubeMesh, matrix);
  }

  public static void DrawTexture3DVolume(
      Texture texture, [ DefaultValue("1.0f") ] float opacity = 1.0f,
    ...
    Vector3 localScale = new Vector3(matrix.GetColumn(0).magnitude,
                                     matrix.GetColumn(1).magnitude,
                                     matrix.GetColumn(2).magnitude);
    int sampleCount = Texture3DInspector.PrepareVolumePreview(
        Texture3DInspector.Materials.Volume, texture, localScale, opacity,
        filterMode, useColorRamp, customColorRamp, Camera.current, matrix,
        qualityModifier);
