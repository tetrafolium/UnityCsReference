...
internal class LightingWindowEnvironmentTab {
    ...
    Editor environmentEditor {
      get {
        if (m_EnvironmentEditor == null || m_EnvironmentEditor.target == null) {
          Editor.CreateCachedEditor(RenderSettings.GetRenderSettings(),
                                    typeof(LightingEditor),
                                    ref m_EnvironmentEditor);
        }
  ...
  LightingWindowEnvironmentSection environmentEditor {
    get {
      ...
      if (m_EnvironmentSection == null) {
        ...
        LightingWindowEnvironmentSection extension =
            (LightingWindowEnvironmentSection)
  ...
  Editor fogEditor {
    get {
      if (m_FogEditor == null || m_FogEditor.target == null ||
          m_FogEditor.target != RenderSettings.GetRenderSettings()) {
        Editor.CreateCachedEditor(renderSettings, typeof(FogEditor),
                                  ref m_FogEditor);
      }
  ...
  Editor otherRenderingEditor {
    get {
      if (m_OtherRenderingEditor == null ||
          m_OtherRenderingEditor.target == null ||
          m_OtherRenderingEditor.target != RenderSettings.GetRenderSettings()) {
        Editor.CreateCachedEditor(renderSettings, typeof(OtherRenderingEditor),
                                  ref m_OtherRenderingEditor);
      }
  ...
  public void OnEnable() {
    m_ShowOtherSettings =
        new SavedBool($"LightingWindow.ShowOtherSettings", true);
  }

  public void OnDisable() { ClearCachedProperties(); }
  ...
  void OtherSettingsGUI() {
    ...
    m_ShowOtherSettings.value = EditorGUILayout.FoldoutTitlebar(
        m_ShowOtherSettings.value, Styles.OtherSettings, true);
