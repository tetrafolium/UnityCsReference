...
namespace UnityEditor.VersionControl {
  ...
  public partial class Asset {
    ...
    public Asset(string clientPath) { m_Self = Create(clientPath); }
    ...
    [FreeFunction("VersionControlBindings::Asset::Destroy",
                  IsThreadSafe = true)]
    static extern void Destroy(IntPtr asset);

    [FreeFunction("VersionControlBindings::Asset::GetState",
                  IsThreadSafe = true)]
    ...
    public extern bool readOnly {
      [NativeName("IsReadOnly")] get;
    }

    [NativeMethod(IsThreadSafe = true)]
    public extern bool isMeta {
      [NativeName("IsMeta")] get;
    }

    [NativeMethod(IsThreadSafe = true)]
    public extern bool locked {
      [NativeName("IsLocked")] get;
    }
    ...
    public extern bool isInCurrentProject {
      [NativeName("IsInCurrentProject")] get;
    }
  }
}
