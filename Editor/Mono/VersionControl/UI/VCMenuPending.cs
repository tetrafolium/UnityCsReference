...
namespace UnityEditorInternal.VersionControl {
  // Change list window menu; set up and invoked from native code when VCS
  ...
  class PendingWindowContextMenu {
    ...
    static bool SubmitTest(int userData) {
      return Provider.SubmitIsValid(
          null, ListControl.FromID(userData).SelectedAssets);
    }
    ...
    static bool RevertTest(int userData) {
      return Provider.RevertIsValid(ListControl.FromID(userData).SelectedAssets,
                                    RevertMode.Normal);
    }
    ...
    static void RevertUnchanged(int userData) {
      ...
      Provider.Revert(list, RevertMode.Unchanged)
    ...
    static bool ResolveTest(int userData) {
      return Provider.ResolveIsValid(
          ListControl.FromID(userData).SelectedAssets);
    }
    ...
    static bool NewChangeSetTest(int userData) { return Provider.isActive; }
