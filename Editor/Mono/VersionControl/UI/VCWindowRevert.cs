...
namespace UnityEditor.VersionControl {
  // Window allowing you to review files who will be reverted.  As this may be
  ...
  internal class WindowRevert : EditorWindow {
    ...
    static public void Open(AssetList assets) {
      ...
      AssetList revert = task.assetList.Filter(
          includeFolders, Asset.States.CheckedOutLocal,
          Asset.States.DeletedLocal, Asset.States.AddedLocal,
          // Asset.States.Branch,
    ...
    static private WindowRevert GetWindow() {
      return EditorWindow.GetWindow<WindowRevert>(true,
    ...
    void OnGUI() {
      ...
      if (assetList.Count > 0 && GUILayout.Button("Revert")) {
        ...
        if (openScenes.Length > 0) {
          bool continueRevert = EditorUtility.DisplayDialog(
              "Revert open scene(s)?",
