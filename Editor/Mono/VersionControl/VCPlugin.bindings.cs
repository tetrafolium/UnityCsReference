...
namespace UnityEditor.VersionControl {
  ...
  public class ConfigField {
    ...
    [FreeFunction("VersionControlBindings::ConfigField::Destroy",
                  IsThreadSafe = true)]
    ...
    public extern bool isRequired { [NativeMethod("IsRequired")] get; }

    public extern bool isPassword { [NativeMethod("IsPassword")] get; }
  }
  ...
  public class Plugin {
    ...
    [FreeFunction("VersionControlBindings::Plugin::Destroy",
                  IsThreadSafe = true)]
    static extern void Destroy(IntPtr plugin);

    static public extern Plugin[] availablePlugins {
      [FreeFunction("VersionControlBindings::Plugin::GetAvailablePlugins")] get;
    }

    public extern string name { get; }
    public ConfigField[] configFields {
      get { return GetConfigFields(m_Self); }
    }
