...
namespace UnityEditor.VersionControl {
  ...
  public partial class Task {
    ...
    [NativeMethod("GetMonoAssetList")] extern Asset[] Internal_GetAssetList();
    [NativeMethod(
        "GetMonoChangeSets")] extern ChangeSet[] Internal_GetChangeSets();
    ...
    public extern Message[] messages { [NativeName("GetMonoMessages")] get; }
  }
}
