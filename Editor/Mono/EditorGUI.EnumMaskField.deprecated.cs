...
public partial class EditorGUI {
  ...
  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(Rect position, string label,
                                   Enum enumValue) {
  ...
  public static Enum EnumMaskField(Rect position, string label, Enum enumValue,
                                   GUIStyle style) {
    return EnumMaskFieldInternal(position, EditorGUIUtility.TempContent(label),
                                 enumValue, style);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(Rect position, GUIContent label,
                                   Enum enumValue) {
    return EnumMaskField(position, label, enumValue, EditorStyles.popup);
  }
  ...
  public static Enum EnumMaskPopup(Rect position, string label, Enum selected,
    ...
    int changedFlags;
    bool changedToValue;
    return EnumMaskPopup(position, label, selected, out changedFlags,
                         out changedToValue, style);
  }

  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskPopup(Rect position, GUIContent label,
                                   Enum selected) {
    return EnumMaskPopup(position, label, selected, EditorStyles.popup);
  }
  ...
  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskField(Rect position, GUIContent label, Enum enumValue,
                            GUIStyle style, out int changedFlags,
                            out bool changedToValue) {
    return DoEnumMaskField(position, label, enumValue, style, out changedFlags,
                           out changedToValue);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskFieldInternal(Rect position, Enum enumValue,
                                    GUIStyle style) {
    Type enumType = enumValue.GetType();
    if (!enumType.IsEnum)
      throw new ArgumentException(
          "Parameter enumValue must be of type System.Enum", "enumValue");
    ...
    int flags = MaskFieldGUIDeprecated.DoMaskField(
        ...
        Convert.ToInt32(enumValue), names, style);
    return EnumDataUtility.IntToEnumFlags(enumType, flags);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskFieldInternal(Rect position, GUIContent label,
                                    Enum enumValue, GUIStyle style) {
    Type enumType = enumValue.GetType();
    if (!enumType.IsEnum)
      throw new ArgumentException(
    ...
    var names = Enum.GetNames(enumType)
                    ...
                    .ToArray();
    int flags = MaskFieldGUIDeprecated.DoMaskField(
        position2, id, Convert.ToInt32(enumValue), names, style);
    return EnumDataUtility.IntToEnumFlags(enumType, flags);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  static Enum DoEnumMaskField(Rect position, GUIContent label, Enum enumValue,
                              GUIStyle style, out int changedFlags,
                              out bool changedToValue) {
    ...
    var names = Enum.GetNames(enumType)
                    ...
                    .ToArray();
    int flags = MaskFieldGUIDeprecated.DoMaskField(
        PrefixLabel(position, id, label), id, Convert.ToInt32(enumValue), names,
        style, out changedFlags, out changedToValue);
    return EnumDataUtility.IntToEnumFlags(enumType, flags);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskPopup(Rect position, string label, Enum selected,
                            out int changedFlags, out bool changedToValue,
                            GUIStyle style) {
    return EnumMaskPopup(position, EditorGUIUtility.TempContent(label),
                         selected, out changedFlags, out changedToValue, style);
  }

  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  internal static Enum EnumMaskPopup(Rect position, GUIContent label,
                                     Enum selected, out int changedFlags,
                                     out bool changedToValue, GUIStyle style) {
    return EnumMaskPopupInternal(position, label, selected, out changedFlags,
                                 out changedToValue, style);
  }

  // Make an enum mask popup selection field.
  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskPopupInternal(Rect position, GUIContent label,
                                    Enum selected, out int changedFlags,
                                    out bool changedToValue, GUIStyle style) {
    return EnumMaskField(position, label, selected, style, out changedFlags,
                         out changedToValue);
  }
}
...
public partial class EditorGUILayout {
  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(Enum enumValue,
                                   params GUILayoutOption[] options) {
    return EnumMaskField(enumValue, EditorStyles.popup, options);
  }

  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(Enum enumValue, GUIStyle style,
                                   params GUILayoutOption[] options) {
    var r = s_LastRect =
  ...
  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(string label, Enum enumValue, GUIStyle style,
                                   params GUILayoutOption[] options) {
    var r = s_LastRect =
  ...
  [Obsolete("EnumMaskField has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskField(GUIContent label, Enum enumValue,
                                   params GUILayoutOption[] options) {
    return EnumMaskField(label, enumValue, EditorStyles.popup, options);
  }
  ...
  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskPopup(string label, Enum selected, GUIStyle style,
                                   params GUILayoutOption[] options) {
    int changedFlags;
    bool changedToValue;
    return EnumMaskPopup(EditorGUIUtility.TempContent(label), selected,
                         out changedFlags, out changedToValue, style, options);
  }

  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  public static Enum EnumMaskPopup(GUIContent label, Enum selected,
                                   params GUILayoutOption[] options) {
    return EnumMaskPopup(label, selected, EditorStyles.popup, options);
  }
  ...
  public static Enum EnumMaskPopup(GUIContent label, Enum selected,
    ...
    int changedFlags;
    bool changedToValue;
    return EnumMaskPopup(label, selected, out changedFlags, out changedToValue,
                         style, options);
  }

  // Make an enum popup selection field for a bitmask.
  [Obsolete("EnumMaskPopup has been deprecated. Use EnumFlagsField instead.")]
  static Enum EnumMaskPopup(GUIContent label, Enum selected,
                            out int changedFlags, out bool changedToValue,
                            GUIStyle style, params GUILayoutOption[] options) {
    Rect r = s_LastRect =
        GetControlRect(true, EditorGUI.kSingleLineHeight, style, options);
    return EditorGUI.EnumMaskPopup(r, label, selected, out changedFlags,
                                   out changedToValue, style);
  }
}

// Class for storing state for mask menus so we can get the info back to OnGUI
...
static class MaskFieldGUIDeprecated {
  ...
  private class MaskCallbackInfo {
    ...
    public static int GetSelectedValueForControl(int controlID, int mask,
      ...
      if (evt.type == EventType.ExecuteCommand &&
          evt.commandName == kMaskMenuChangedMessage) {
        if (m_Instance == null) {
    ...
    internal void SetMaskValueDelegate(object userData, string[] options,
                                       int selected) {
      switch (selected) {
      case 0:
        m_ClearAll = true;
      ...
      if (m_SourceView)
        m_SourceView.SendEvent(
            EditorGUIUtility.CommandEvent(kMaskMenuChangedMessage));
    }
  }

  /// Make a field for a generic mask.
  internal static int DoMaskField(Rect position, int controlID, int mask,
                                  string[] flagNames, GUIStyle style) {
    int dummyInt;
    bool dummyBool;
    return DoMaskField(position, controlID, mask, flagNames, style,
                       out dummyInt, out dummyBool);
  }

  internal static int DoMaskField(Rect position, int controlID, int mask,
                                  string[] flagNames, int[] flagValues,
                                  GUIStyle style) {
    int dummyInt;
    bool dummyBool;
    return DoMaskField(position, controlID, mask, flagNames, flagValues, style,
                       out dummyInt, out dummyBool);
  }
  ...
  /// Make a field for a generic mask.
  /// This version also gives you back which flags were changed and what they
  /// were changed to. This is useful if you want to make the same change to
  /// multiple objects.
  internal static int DoMaskField(Rect position, int controlID, int mask,
                                  string[] flagNames, int[] flagValues,
                                  GUIStyle style, out int changedFlags,
                                  out bool changedToValue) {
    mask = MaskCallbackInfo.GetSelectedValueForControl(
        controlID, mask, out changedFlags, out changedToValue);
    ...
    if (!EditorGUI.showMixedValue) {
      ...
      default:
        if (selectedFlags.Count >= flagNames.Length) {
          ...
          selectedFlags.Add(1);
          // When every available item is selected, we force to ~0 to keep the
          // mask int value consistent between the cases where all items are
          // individually selected vs. user clicks "everything"
          mask = ~0;
        } else
    ...
    if (evt.type == EventType.Repaint) {
      style.Draw(position, buttonContent, controlID, false);
               ...
               evt.MainActionKeyForControl(controlID)) {
      ...
      EditorUtility.DisplayCustomMenu(
          ...
          EditorGUI.showMixedValue ? new int[]{}
          : selectedFlags.ToArray(),
