...
internal partial class SyncVS : AssetPostprocessor
{
    ...
    internal class SolutionSynchronizationSettings : DefaultSolutionSynchronizationSettings
    {
        ...
        {
            get {
                return UnityEditorInternal.InternalEditorUtility.GetEditorAssemblyPath();
            }
        }
        ...
        {
            get {
                return UnityEditorInternal.InternalEditorUtility.GetEngineAssemblyPath();
            }
        }
        ...
        {
            get {
                return !IsOSX && System.IO.Path.DirectorySeparatorChar == '\\' && System.Environment.NewLine == "\r\n";
            }
        }
    }
...
#pragma warning disable 618
    ...
    private static void GetInstalledVisualStudios(VisualStudioVersion vsVersion, Dictionary<VisualStudioVersion, VisualStudioPath[]> versions)
    {
        ...
        var visualStudioPaths = VisualStudioUtil.ParseRawDevEnvPaths(raw)
                                .Where(vs => !requiredWorkloads.Except(vs.WorkloadsAndComponents).Any()) // All required workloads must be present
