...
public static class StaticOcclusionCulling {
  // Used to generate static occlusion culling data. This function will not
  // return until occlusion data is generated.
  ...
  // Used to check if asynchronous generation of static occlusion culling data
  // is still running.
  public static extern bool isRunning { [NativeName("IsRunning")] get; }
  ...
  internal static extern Object occlusionCullingSettings { [FreeFunction] get; }
  ...
  public static extern float smallestOccluder {
    [NativeName("GetOcclusionBakeSettings().smallestOccluder")] get;
    [NativeName("GetOcclusionBakeSettingsSetDirty().smallestOccluder")] set;
  }

  [StaticAccessor("GetOcclusionCullingSettings()", StaticAccessorType.Dot)]
  [NativeProperty(TargetType = TargetType.Field)]
  public static extern float smallestHole {
    [NativeName("GetOcclusionBakeSettings().smallestHole")] get;
    [NativeName("GetOcclusionBakeSettingsSetDirty().smallestHole")] set;
  }

  [StaticAccessor("GetOcclusionCullingSettings()", StaticAccessorType.Dot)]
  [NativeProperty(TargetType = TargetType.Field)]
  public static extern float backfaceThreshold {
    [NativeName("GetOcclusionBakeSettings().backfaceThreshold")] get;
    [NativeName("GetOcclusionBakeSettingsSetDirty().backfaceThreshold")] set;
  }

  public static extern bool doesSceneHaveManualPortals {
    [NativeName("DoesSceneHaveManualPortals")] get;
  }

  // Returns the size in bytes that the Tome data is currently taking up in this
  // scene on disk
...
public static class StaticOcclusionCullingVisualization {
  ...
  // If set to true, the visualization lines of the PVS volumes will show all
  // cells rather than cells after culling.
  ...
  public static extern bool isPreviewOcclusionCullingCameraInPVS {
    [FreeFunction("IsPreviewOcclusionCullingCameraInPVS")] get;
  }

  public static extern Camera previewOcclusionCamera {
    [FreeFunction("FindPreviewOcclusionCamera")] get;
  }
