...
public GUIContent header =
	EditorGUIUtility.TrTextContent("Create New Library");
...
public GUIContent[] fileLocations =
	new[] {EditorGUIUtility.TrTextContent("Preferences Folder"),
	       EditorGUIUtility.TrTextContent("Project Folder")};
public PresetFileLocation[] fileLocationOrder =
	new[] {PresetFileLocation.PreferencesFolder,
	       PresetFileLocation
	       .ProjectFolder};    // must match order of fileLocations above
}
static Texts s_Texts;

public PopupWindowContentForNewLibrary(
	Func<string, PresetFileLocation, string> createLibraryCallback) {
...
public override void OnGUI(Rect rect) {
	...
	EditorGUI.BeginChangeCheck();
	{
		...
		GUILayout.BeginHorizontal();
		{
			...
			m_SelectedIndexInPopup = EditorGUILayout.Popup(m_SelectedIndexInPopup,
			                                               s_Texts.fileLocations);
		}
		GUILayout.EndHorizontal();
	}
...
void CreateLibraryAndCloseWindow(EditorWindow editorWindow) {
	PresetFileLocation fileLocation =
		s_Texts.fileLocationOrder[m_SelectedIndexInPopup];
