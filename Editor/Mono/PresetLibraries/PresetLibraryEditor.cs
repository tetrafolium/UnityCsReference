...
internal partial class PresetLibraryEditor<T> where T : PresetLibrary
{
    ...
    {
        get {
            return m_PreviewAspect;
        }
        set {
            m_PreviewAspect = value;
        }
    }
    ...
    {
        get {
            return m_State.m_PreviewHeight;
        }
        set
        {
    ...
    {
        get {
            return currentLibraryWithoutExtension + "." + m_SaveLoadHelper.fileExtensionWithoutDot;
        }
    }
