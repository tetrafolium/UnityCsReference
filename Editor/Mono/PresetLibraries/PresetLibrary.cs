...
// Derive and implement interface for your own preset library. See
// GradientPresetLibrary.cs for example.
...
public abstract void Move(int index, int destIndex,
...
public static void MoveListItem<T>(List<T> list, int index, int destIndex,
                                   bool insertAfterDestIndex) {
