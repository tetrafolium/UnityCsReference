...
public static class Unsupported {
  ...
  [FreeFunction]
  public static extern void CaptureScreenshotImmediate(string filePath, int x,
                                                       int y, int width,
                                                       int height);
  ...
  public static extern void PrepareObjectContextMenu(UnityEngine.Object c,
                                                     int contextUserData);

  public static bool IsDeveloperBuild() { return IsSourceBuild(); }
  ...
  SetAllowCursorLock(bool allow, DisallowCursorLockReasons reasons);

  // Remove in 2021.0
  [Obsolete(
      "This method has been marked obsolete, use SetOverrideLightingSettings instead (UnityUpgradable) -> SetOverrideLightingSettings(*)",
      true)]
  ...
  // Remove in 2021.0
  [Obsolete(
      "This method has been marked obsolete, use RestoreOverrideLightingSettings instead (UnityUpgradable) -> RestoreOverrideLightingSettings(*)",
      true)]
  ...
  SetOverrideLightingSettingsInternal(int sceneHandle);
  ...
  SetSceneViewDebugModeExposureNoDirty(float exposure);

  [FreeFunction("GetQualitySettings().SetShadowDistanceTemporarily")]
  public static extern void
  SetQualitySettingsShadowDistanceTemporarily(float distance);
  ...
  public static extern UnityEngine.Object
  GetSerializedAssetInterfaceSingleton(string className);
  ...
  PasteComponentValuesFromPasteboard(Component component);

  [FreeFunction(
      "UnityEditor::StateMachineTransitionCopyPaste::HasParametersInPasteboard")]
  public static extern bool HasStateMachineTransitionDataInPasteboard();

  public static extern bool
  AreAllParametersInDestination(UnityEngine.Object transition,
                                AnimatorController controller,
                                List<string> missingParameters);

  public static extern bool
  DestinationHasCompatibleParameterTypes(UnityEngine.Object transition,
                                         AnimatorController controller,
                                         List<string> mismatchedParameters);

  public static extern bool
  CanPasteParametersToTransition(UnityEngine.Object transition,
                                 AnimatorController controller);

  [FreeFunction(
      "UnityEditor::StateMachineTransitionCopyPaste::CopyParametersToPasteboard")]
  public static extern void CopyStateMachineTransitionParametersToPasteboard(
      UnityEngine.Object transition, AnimatorController controller);

  public static void PasteToStateMachineTransitionParametersFromPasteboard(
      UnityEngine.Object transition, AnimatorController controller,
      bool conditions, bool parameters) {
    Undo.RegisterCompleteObjectUndo(transition, "Paste to Transition");
    PasteToStateMachineTransitionParametersFromPasteboardInternal(
        transition, controller, conditions, parameters);
  }

  [FreeFunction(
      "UnityEditor::StateMachineTransitionCopyPaste::PasteParametersFromPasteboard")]
  internal static extern void
  PasteToStateMachineTransitionParametersFromPasteboardInternal(
      UnityEngine.Object transition, AnimatorController controller,
      bool conditions, bool parameters);
  ...
  public static void
  CopyStateMachineDataToPasteboard(UnityEngine.Object stateMachineObject,
                                   AnimatorController controller,
                                   int layerIndex) {
    CopyStateMachineDataToPasteboard(
        new UnityEngine.Object[]{stateMachineObject}, null,
        new Vector3[]{new Vector3()}, controller, layerIndex);
  }

  [FreeFunction("UnityEditor::StateMachineCopyPaste::CopyDataToPasteboard")]
  internal static extern void CopyStateMachineDataToPasteboard(
      UnityEngine.Object[] stateMachineObjects, AnimatorStateMachine context,
      Vector3[] monoPositions, AnimatorController controller, int layerIndex);

  public static void
  PasteToStateMachineFromPasteboard(AnimatorStateMachine sm,
                                    AnimatorController controller,
                                    int layerIndex, Vector3 position) {
    Undo.RegisterCompleteObjectUndo(sm, "Paste to StateMachine");
    PasteToStateMachineFromPasteboardInternal(sm, controller, layerIndex,
                                              position);
  }

  [FreeFunction("UnityEditor::StateMachineCopyPaste::PasteDataFromPasteboard")]
  internal static extern void
  PasteToStateMachineFromPasteboardInternal(AnimatorStateMachine sm,
                                            AnimatorController controller,
                                            int layerIndex, Vector3 position);
  ...
  [FreeFunction(
      "AssetDatabaseDeprecated::SetApplicationSettingCompressAssetsOnImport")]
  public static extern void
  SetApplicationSettingCompressAssetsOnImport(bool value);
  ...
  [Obsolete(
      "GetLocalIdentifierInFile() is deprecated. Use GetLocalIdentifierInFileForPersistentObject() instead.",
      false)]
  [FreeFunction("GetPersistentManager().GetLocalFileID")]
  public static extern int GetLocalIdentifierInFile(int instanceID);

  [FreeFunction("GetPersistentManager().GetLocalFileID")]
  static extern UInt64
  GetLocalIdentifierInFileForPersistentObjectInternal(int instanceID);

  public static UInt64
  GetLocalIdentifierInFileForPersistentObject(UnityEngine.Object obj) {
    if (obj == null)
    ...
    return GetLocalIdentifierInFileForPersistentObjectInternal(
        obj.GetInstanceID());
  }

  internal static extern UInt64
  GetFileIDHint([ NotNull ] UnityEngine.Object obj);

  [NativeThrows]
  internal static extern UInt64
  GenerateFileIDHint([ NotNull ] UnityEngine.Object obj);
  ...
  internal static UInt64 GetOrGenerateFileIDHint(UnityEngine.Object obj) {
    ...
    if (fileID == 0) {
      ...
      if (instanceHandle != null) {
        bool isPrefabInstanceSaved =
            Unsupported.GetFileIDHint(instanceHandle) != 0;
        if (isPrefabInstanceSaved &&
