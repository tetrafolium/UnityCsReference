...
SetGameObjectHidden([ NotNull ] GameObject gameObject, bool isHidden,
                    bool includeChildren);

public static extern void
SetGameObjectsHidden([ NotNull ] GameObject[] gameObjects, bool isHidden,
                     bool includeChildren);

public static extern bool
IsGameObjectHidden([ NotNull ] GameObject gameObject);

public static extern bool
IsHierarchyHidden([ NotNull ] GameObject gameObject);

public static extern void
SetGameObjectPickingDisabled([ NotNull ] GameObject gameObject,
                             bool pickingDisabled, bool includeChildren);

public static extern void
SetGameObjectsPickingDisabled([ NotNull ] GameObject[] gameObjects,
                              bool pickingDisabled, bool includeChildren);

public static extern bool
IsGameObjectPickingDisabled([ NotNull ] GameObject gameObject);

public static extern bool
IsHierarchyPickingDisabled([ NotNull ] GameObject gameObject);
public static extern bool
AreAllChildrenVisible([ NotNull ] GameObject gameObject);
public static extern bool
IsPickingEnabledOnAllChildren([ NotNull ] GameObject gameObject);

public static extern bool
AreAllChildrenHidden([ NotNull ] GameObject gameObject);
public static extern bool
IsPickingDisabledOnAllChildren([ NotNull ] GameObject gameObject);
...
public static extern bool visibilityActive {
	get;
	set;
}
public static extern bool pickingActive {
	get;
	set;
}
public static extern bool isolation {
	get;
	set;
}
}
