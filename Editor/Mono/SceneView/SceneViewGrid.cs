...
static class GridSettings
{
    ...
    {
        get {
            return new Vector3(s_GridSizeX, s_GridSizeY, s_GridSizeZ);
        }
    }
    ...
    {
        get {
            return ApplyMultiplier(rawSize, s_GridMultiplier);
        }
        set
        {
            if (size == value)
...
class SceneViewGrid
{
    ...
    internal float gridOpacity
    {
        ...
        set {
            m_gridOpacity = Mathf.Clamp01(value);
        }
    }
