...
public class SettingsProvider {
  ...
  public IEnumerable<string> keywords {
    ...
    set { m_Keywords = new HashSet<string>(value); }
  }
  ...
  public Action titleBarGuiHandler {
    get;
    set;
  }
  public Action footerBarGuiHandler {
    get;
    set;
  }
  public Action<string, VisualElement> activateHandler {
    get;
    set;
  }
  ...
  public Func<string, bool> hasSearchInterestHandler {
    get;
    set;
  }
  public Action inspectorUpdateHandler {
    get;
    set;
  }
  ...
  public SettingsProvider(string path, SettingsScope scopes,
    ...
    this.scope = scopes;
    m_Keywords =
        keywords == null ? new HashSet<string>() : new HashSet<string>(keywords);
  }
  ...
  public virtual void OnDeactivate() { deactivateHandler?.Invoke(); }
  ...
  public virtual void OnTitleBarGUI() { titleBarGuiHandler?.Invoke(); }

  public virtual void OnFooterBarGUI() { footerBarGuiHandler?.Invoke(); }

  public virtual void OnInspectorUpdate() { inspectorUpdateHandler?.Invoke(); }

  public void Repaint() { settingsWindow?.Repaint(); }
...
#region Helper
    ...
    return typeof(T)
        ...
        .Concat(
            typeof(T)
                ...
                .Where(
                    prop =>
                        typeof(GUIContent).IsAssignableFrom(prop.PropertyType))
  ...
  public static IEnumerable<string>
  GetSearchKeywordsFromSerializedObject(SerializedObject serializedObject) {
