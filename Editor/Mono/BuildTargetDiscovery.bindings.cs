...
internal static class BuildTargetDiscovery {
  ...
  public enum TargetAttributes {
    ...
    [ Obsolete("Facebook support was removed in 2019.3") ] SupportsFacebook =
        (1 << 12),
  ...
  public static extern bool PlatformHasFlag(BuildTarget platform,
                                            TargetAttributes flag);

  public static extern bool PlatformGroupHasFlag(BuildTargetGroup group,
                                                 TargetAttributes flag);

  public static extern bool PlatformGroupHasVRFlag(BuildTargetGroup group,
                                                   VRAttributes flag);
  ...
  GetModuleNameForBuildTargetGroup(BuildTargetGroup group);
  ...
  public static bool BuildTargetSupportsRenderer(BuildPlatform platform,
    ...
    if (platform.targetGroup == BuildTargetGroup.Standalone)
      buildTarget =
          DesktopStandaloneBuildWindowExtension.GetBestStandaloneTarget(
              buildTarget);
  ...
  public static string GetBuildTargetNiceName(
  ...
  public static string GetScriptAssemblyName(DiscoveredTargetInfo btInfo) {
    return !String.IsNullOrEmpty(btInfo.assemblyName)
               ? btInfo.assemblyName
               : btInfo.nameList[kShortNameIndex];
  }
}
}
