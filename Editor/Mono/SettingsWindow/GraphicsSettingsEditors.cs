...
internal partial class GraphicsSettingsWindow {
  internal class BuiltinShaderSettings {
    internal enum BuiltinShaderMode { None = 0, Builtin, Custom }

    readonly SerializedProperty m_Mode;
    readonly SerializedProperty m_Shader;
    readonly GUIContent m_Label;

    internal BuiltinShaderSettings(GUIContent label, string name,
  ...
  internal class BuiltinShadersEditor : Editor {
    ...
    internal class Styles {
      public static GUIContent deferredString = EditorGUIUtility.TrTextContent(
          "Deferred", "Shader used for Deferred Shading.");
      public static GUIContent deferredReflString =
          EditorGUIUtility.TrTextContent(
              "Deferred Reflections",
              "Shader used for Deferred reflection probes.");
      public static GUIContent legacyDeferredString =
          EditorGUIUtility.TrTextContent(
              "Legacy Deferred",
              "Shader used for Legacy (light prepass) Deferred Lighting.");
      public static GUIContent screenShadowsString =
          EditorGUIUtility.TrTextContent(
              "Screen Space Shadows",
              "Shader used for screen-space cascaded shadows.");
      public static GUIContent depthNormalsString = EditorGUIUtility.TrTextContent(
          "Depth Normals",
          "Shader used for depth and normals texture when enabled on a Camera.");
      public static GUIContent motionVectorsString = EditorGUIUtility.TrTextContent(
          "Motion Vectors",
          "Shader for generation of Motion Vectors when the rendering camera has renderMotionVectors set to true.");
      public static GUIContent lightHaloString = EditorGUIUtility.TrTextContent(
          "Light Halo", "Default Shader used for light halos.");
      public static GUIContent lensFlareString = EditorGUIUtility.TrTextContent(
          "Lens Flare", "Default Shader used for lens flares.");
    }

    public void OnEnable() {
      m_Deferred = new BuiltinShaderSettings(Styles.deferredString,
                                             "m_Deferred", serializedObject);
      m_DeferredReflections = new BuiltinShaderSettings(
          Styles.deferredReflString, "m_DeferredReflections", serializedObject);
      m_LegacyDeferred = new BuiltinShaderSettings(
          Styles.legacyDeferredString, "m_LegacyDeferred", serializedObject);
      m_ScreenSpaceShadows = new BuiltinShaderSettings(
          Styles.screenShadowsString, "m_ScreenSpaceShadows", serializedObject);
      m_DepthNormals = new BuiltinShaderSettings(
          Styles.depthNormalsString, "m_DepthNormals", serializedObject);
      m_MotionVectors = new BuiltinShaderSettings(
          Styles.motionVectorsString, "m_MotionVectors", serializedObject);
      m_LightHalo = new BuiltinShaderSettings(Styles.lightHaloString,
                                              "m_LightHalo", serializedObject);
      m_LensFlare = new BuiltinShaderSettings(Styles.lensFlareString,
                                              "m_LensFlare", serializedObject);
    }
    ...
    public override void OnInspectorGUI() {
      ...
      // deferred reflections being off affects forward vs deferred style probe
      // rendering; need to reload shaders for new platform macro to live update
...
internal partial class GraphicsSettingsWindow {
  internal class VideoShadersEditor : Editor {
    ...
    internal class Styles {
      public static GUIContent modeString = EditorGUIUtility.TrTextContent(
          "Video", "Shaders used by the VideoPlayer decoding and compositing.");
    }

    public void OnEnable() {
      m_VideoShadersIncludeMode =
          serializedObject.FindProperty("m_VideoShadersIncludeMode");
    }
  ...
  internal class AlwaysIncludedShadersEditor : Editor {
    ...
    public void OnEnable() {
      m_AlwaysIncludedShaders =
          serializedObject.FindProperty("m_AlwaysIncludedShaders");
...
internal partial class GraphicsSettingsWindow {
  internal class ShaderStrippingEditor : Editor {
    ...
    public void OnEnable() {
      m_LightmapStripping =
          serializedObject.FindProperty("m_LightmapStripping");
      m_LightmapKeepPlain =
          serializedObject.FindProperty("m_LightmapKeepPlain");
      m_LightmapKeepDirCombined =
          serializedObject.FindProperty("m_LightmapKeepDirCombined");
      m_LightmapKeepDynamicPlain =
          serializedObject.FindProperty("m_LightmapKeepDynamicPlain");
      m_LightmapKeepDynamicDirCombined =
          serializedObject.FindProperty("m_LightmapKeepDynamicDirCombined");
      m_LightmapKeepShadowMask =
          serializedObject.FindProperty("m_LightmapKeepShadowMask");
      m_LightmapKeepSubtractive =
          serializedObject.FindProperty("m_LightmapKeepSubtractive");
    ...
    public override void OnInspectorGUI() {
      ...
      if (m_LightmapStripping.intValue != 0) {
        ...
        EditorGUILayout.PropertyField(m_LightmapKeepPlain,
                                      Styles.lightmapPlain);
        EditorGUILayout.PropertyField(m_LightmapKeepDirCombined,
                                      Styles.lightmapDirCombined);
        EditorGUILayout.PropertyField(m_LightmapKeepDynamicPlain,
                                      Styles.lightmapDynamicPlain);
        EditorGUILayout.PropertyField(m_LightmapKeepDynamicDirCombined,
                                      Styles.lightmapDynamicDirCombined);
        EditorGUILayout.PropertyField(m_LightmapKeepShadowMask,
                                      Styles.lightmapKeepShadowMask);
        EditorGUILayout.PropertyField(m_LightmapKeepSubtractive,
                                      Styles.lightmapKeepSubtractive);
        EditorGUILayout.Space();

        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PrefixLabel(GUIContent.Temp(" "),
                                    EditorStyles.miniButton);

        if (GUILayout.Button(Styles.lightmapFromScene, EditorStyles.miniButton,
      ...
      if (m_FogStripping.intValue != 0) {
        ...
        if (GUILayout.Button(Styles.fogFromScene, EditorStyles.miniButton,
                             GUILayout.ExpandWidth(false)))
      ...
      // need to do these after ApplyModifiedProperties, since it changes their
    ...
    internal partial class Styles {
      public static readonly GUIContent shaderSettings =
          EditorGUIUtility.TrTextContent("Platform shader settings");
      public static readonly GUIContent builtinSettings =
          EditorGUIUtility.TrTextContent("Built-in shader settings");
      public static readonly GUIContent shaderPreloadSettings =
          EditorGUIUtility.TrTextContent("Shader preloading");

      public static readonly GUIContent lightmapModes =
          EditorGUIUtility.TrTextContent("Lightmap Modes");
      public static readonly GUIContent lightmapPlain =
          EditorGUIUtility.TrTextContent(
              "Baked Non-Directional",
              "Include support for baked non-directional lightmaps.");
      public static readonly GUIContent lightmapDirCombined =
          EditorGUIUtility.TrTextContent(
              "Baked Directional",
              "Include support for baked directional lightmaps.");
      public static readonly GUIContent lightmapKeepShadowMask =
          EditorGUIUtility.TrTextContent(
              "Baked Shadowmask",
              "Include support for baked shadow occlusion.");
      public static readonly GUIContent lightmapKeepSubtractive =
          EditorGUIUtility.TrTextContent(
              "Baked Subtractive",
              "Include support for baked subtractive lightmaps.");
      public static readonly GUIContent lightmapDynamicPlain =
          EditorGUIUtility.TrTextContent(
              "Realtime Non-Directional",
              "Include support for realtime non-directional lightmaps.");
      public static readonly GUIContent lightmapDynamicDirCombined =
          EditorGUIUtility.TrTextContent(
              "Realtime Directional",
              "Include support for realtime directional lightmaps.");
      public static readonly GUIContent lightmapFromScene =
          EditorGUIUtility.TrTextContent(
              "Import From Current Scene",
              "Calculate lightmap modes used by the current scene.");

      public static readonly GUIContent fogModes =
          EditorGUIUtility.TrTextContent("Fog Modes");
      public static readonly GUIContent fogLinear =
          EditorGUIUtility.TrTextContent("Linear",
                                         "Include support for Linear fog.");
      public static readonly GUIContent fogExp = EditorGUIUtility.TrTextContent(
          "Exponential", "Include support for Exponential fog.");
      public static readonly GUIContent fogExp2 =
          EditorGUIUtility.TrTextContent(
              "Exponential Squared",
              "Include support for Exponential Squared fog.");
      public static readonly GUIContent fogFromScene =
          EditorGUIUtility.TrTextContent(
              "Import From Current Scene",
              "Calculate fog modes used by the current scene.");

      public static readonly GUIContent instancingVariants =
          EditorGUIUtility.TrTextContent("Instancing Variants");

      public static readonly GUIContent shaderPreloadSave =
          EditorGUIUtility.TrTextContent(
              "Save to asset...",
              "Save currently tracked shaders into a Shader Variant Manifest asset.");
      public static readonly GUIContent shaderPreloadClear =
          EditorGUIUtility.TrTextContent(
              "Clear", "Clear currently tracked shader variant information.");
    }
  }
}
  ...
  internal class ShaderPreloadEditor : Editor {
    ...
    public override void OnInspectorGUI() {
      ...
      GUILayout.Label(string.Format(
          "Currently tracked: {0} shaders {1} total variants",
      ...
      if (GUILayout.Button(Styles.shaderPreloadSave, EditorStyles.miniButton)) {
        ...
        string assetPath = EditorUtility.SaveFilePanelInProject(
            "Save Shader Variant Collection", "NewShaderVariants",
            "shadervariants", message, ProjectWindowUtil.GetActiveFolderPath());
...
internal partial class GraphicsSettingsWindow {
  internal class TierSettingsEditor : Editor {
    ...
    internal void OnFieldLabelsGUI(bool vertical) {
      ...
      if (!vertical)
        EditorGUILayout.LabelField(Styles.standardShaderSettings,
      ...
      if (!vertical) {
        ...
        EditorGUILayout.LabelField(Styles.renderingSettings,
                                   EditorStyles.boldLabel);
      }
    ...
    internal partial class Styles {
      ...
      public static readonly int[] shaderQualityValue = {
          (int) ShaderQuality.Low, (int) ShaderQuality.Medium,
          (int) ShaderQuality.High};
      ...
      public static readonly int[] renderingPathValue = {
          (int) RenderingPath.Forward, (int) RenderingPath.DeferredShading,
          (int) RenderingPath.VertexLit, (int) RenderingPath.DeferredLighting};

      public static readonly GUIContent[] hdrModeName = {
          EditorGUIUtility.TrTextContent("FP16"),
          EditorGUIUtility.TrTextContent("R11G11B10")};
      ...
      public static readonly GUIContent[] realtimeGICPUUsageName = {
          ...
          EditorGUIUtility.TrTextContent("Medium"),
          EditorGUIUtility.TrTextContent("High"),
          EditorGUIUtility.TrTextContent("Unlimited")};
      public static readonly int[] realtimeGICPUUsageValue = {
          (int) RealtimeGICPUUsage.Low, (int) RealtimeGICPUUsage.Medium,
          (int) RealtimeGICPUUsage.High, (int) RealtimeGICPUUsage.Unlimited};
    }

    internal ShaderQuality ShaderQualityPopup(ShaderQuality sq) {
      return (ShaderQuality) EditorGUILayout.IntPopup(
          (int) sq, Styles.shaderQualityName, Styles.shaderQualityValue);
    }

    internal RenderingPath RenderingPathPopup(RenderingPath rp) {
      return (RenderingPath) EditorGUILayout.IntPopup(
          (int) rp, Styles.renderingPathName, Styles.renderingPathValue);
    }

    internal CameraHDRMode HDRModePopup(CameraHDRMode mode) {
      return (CameraHDRMode) EditorGUILayout.IntPopup(
          (int) mode, Styles.hdrModeName, Styles.hdrModeValue);
    }

    internal
        RealtimeGICPUUsage RealtimeGICPUUsagePopup(RealtimeGICPUUsage usage) {
      return (RealtimeGICPUUsage)
          EditorGUILayout.IntPopup((int) usage, Styles.realtimeGICPUUsageName,
                                   Styles.realtimeGICPUUsageValue);
    }
    ...
    internal void OnTierGUI(BuildTargetGroup platform, GraphicsTier tier,
      ...
      if (!usingSRP) {
        ...
        ts.reflectionProbeBlending =
            EditorGUILayout.Toggle(ts.reflectionProbeBlending);
        ts.detailNormalMap = EditorGUILayout.Toggle(ts.detailNormalMap);
        ts.semitransparentShadows =
      ...
      if (!usingSRP) {
        ...
        ts.prefer32BitShadowMaps =
            EditorGUILayout.Toggle(ts.prefer32BitShadowMaps);
      ...
      if (EditorGUI.EndChangeCheck()) {
        // TODO: it should be doable in c# now as we "expose" GraphicsSettings
        // anyway
    ...
    internal void OnGuiHorizontal(BuildTargetGroup platform) {
      ...
      foreach (GraphicsTier tier in Enum.GetValues(typeof(GraphicsTier))) {
        bool autoSettings =
            EditorGraphicsSettings.AreTierSettingsAutomatic(platform, tier);

        EditorGUILayout.BeginVertical();
        EditorGUILayout.LabelField(Styles.tierName[(int) tier],
                                   EditorStyles.boldLabel);
        ...
        if (EditorGUI.EndChangeCheck()) {
          EditorGraphicsSettings.RegisterUndo();
          EditorGraphicsSettings.MakeTierSettingsAutomatic(platform, tier,
                                                           autoSettings);
    ...
    internal void OnGuiVertical(BuildTargetGroup platform) {
      ...
      foreach (GraphicsTier tier in Enum.GetValues(typeof(GraphicsTier))) {
        ...
        EditorGUI.BeginChangeCheck();
        {
          ...
          EditorGUIUtility.labelWidth = 80;
          autoSettings =
              EditorGUILayout.Toggle(Styles.autoSettings, autoSettings);
    ...
    public override void OnInspectorGUI() {
      ...
      BuildTargetGroup platform =
          validPlatforms[EditorGUILayout.BeginPlatformGrouping(
                             validPlatforms, null, EditorStyles.frameBox)]
              .targetGroup;
    ...
    internal partial class Styles {
      public static readonly GUIContent[] tierName = {
          EditorGUIUtility.TrTextContent("Low (Tier1)"),
          EditorGUIUtility.TrTextContent("Medium (Tier 2)"),
          EditorGUIUtility.TrTextContent("High (Tier 3)")};
      ...
      public static readonly GUIContent standardShaderSettings =
          EditorGUIUtility.TrTextContent("Standard Shader");
      ...
      public static readonly GUIContent standardShaderQuality =
          EditorGUIUtility.TrTextContent("Standard Shader Quality");
      public static readonly GUIContent reflectionProbeBoxProjection =
          EditorGUIUtility.TrTextContent("Reflection Probes Box Projection");
      public static readonly GUIContent reflectionProbeBlending =
          EditorGUIUtility.TrTextContent("Reflection Probes Blending");
      public static readonly GUIContent detailNormalMap =
          EditorGUIUtility.TrTextContent("Detail Normal Map");
      public static readonly GUIContent cascadedShadowMaps =
          EditorGUIUtility.TrTextContent("Cascaded Shadows");
      public static readonly GUIContent prefer32BitShadowMaps =
          EditorGUIUtility.TrTextContent("Prefer 32-bit shadow maps");
      public static readonly GUIContent semitransparentShadows =
          EditorGUIUtility.TrTextContent("Enable Semitransparent Shadows");
      public static readonly GUIContent enableLPPV =
          EditorGUIUtility.TrTextContent("Enable Light Probe Proxy Volume");
      public static readonly GUIContent renderingPath =
          EditorGUIUtility.TrTextContent("Rendering Path");
      public static readonly GUIContent useHDR =
          EditorGUIUtility.TrTextContent("Use HDR");
      public static readonly GUIContent hdrMode =
          EditorGUIUtility.TrTextContent("HDR Mode");
