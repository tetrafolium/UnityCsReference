...
public class EditorBuildSettingsScene : IComparable {
  [NativeName("enabled")] bool m_enabled;
  [NativeName("path")] string m_path;
  [NativeName("guid")] GUID m_guid;
  ...
  public static string[] GetActiveSceneList(EditorBuildSettingsScene[] scenes) {
    return scenes.Where(scene => scene.enabled)
...
public partial class EditorBuildSettings : UnityEngine.Object {
  ...
  static extern void
      SetEditorBuildSettingsScenes(EditorBuildSettingsScene[] scenes);
  ...
  static extern ConfigObjectResult
  AddConfigObjectInternal(string name, Object obj, bool overwrite);
  ...
  public static void AddConfigObject(string name, Object obj, bool overwrite) {
    ...
    if (result == ConfigObjectResult.Succeeded)
      return;
    switch (result) {
    case ConfigObjectResult.FailedEntryExists:
      throw new Exception("Config object with name '" + name +
                          "' already exists.");
    case ConfigObjectResult.FailedNonPersistedObj:
      throw new Exception("Cannot add non-persisted config object with name '" +
                          name + "'.");
    case ConfigObjectResult.FailedNullObj:
      throw new Exception("Cannot add null config object with name '" + name +
                          "'.");
    }
  }

  public static bool TryGetConfigObject<T>(string name, out T result) where T
      : Object {
