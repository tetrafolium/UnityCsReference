...
internal class EditorWindowViewData
	: ScriptableSingletonDictionary<
		EditorWindowViewData,
		UnityEditor.UIElements.SerializableJsonDictionary> {
public static UnityEditor.UIElements.SerializableJsonDictionary
GetEditorData(EditorWindow window) {
