...
internal abstract class PlayModeView : EditorWindow
{
    ...
    {
        get {
            return m_PlayModeViewName;
        }
        set {
            m_PlayModeViewName = value;
        }
    }
    ...
    {
        get {
            return m_TextureHideFlags;
        }
        set {
            m_TextureHideFlags = value;
        }
    }
    ...
    {
        get {
            return m_MaximizeOnPlay;
        }
        set {
            m_MaximizeOnPlay = value;
        }
    }
    ...
    {
        var dict = keys.Select((key, val) => new {
            key, val = values[val]
