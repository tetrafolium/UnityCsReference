...
public partial class MaterialEditor : Editor
{
    ...
    public bool isVisible {
        get {
            return firstInspectedEditor || InternalEditorUtility.GetIsInspectorExpanded(target);
        }
    }
    ...
    internal class ReflectionProbePicker : PopupWindowContent
    {
        ...
        {
            get {
                return m_SelectedReflectionProbe != null ? m_SelectedReflectionProbe.transform : null;
            }
        }
    ...
    {
        Material[] materials = Array.ConvertAll(targets, (Object o) => {
            return (Material)o;
        });
