...
internal class LineRendererEditor : IEditablePoint, ICreatablePoint
{
    ...
    {
        get {
            return EditorPrefs.GetFloat("LineRendererEditorCreatePointSeparation", 1.0f);
        }
        set {
            EditorPrefs.SetFloat("LineRendererEditorCreatePointSeparation", value < 0 ? 0 : value);
        }
    }
    ...
    public static float creationOffset
    {
        ...
        set {
            EditorPrefs.SetFloat("LineRendererEditorCreationOffset", value);
        }
    }
    ...
    public static InputMode inputMode
    {
        ...
        set {
            EditorPrefs.SetInt("LineRendererEditorInputMode", (int)value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetInt("LineRendererEditorRaycastMask", -1);
        }
        set {
            EditorPrefs.SetInt("LineRendererEditorRaycastMask", value);
        }
    }
    ...
    public static bool showWireframe
    {
        ...
        set {
            EditorPrefs.SetBool("LineRendererEditorShowWireFrame", value);
        }
    }
    ...
    public int Count {
        get {
            return m_LineRenderer.positionCount;
        }
    }
