...
internal class AvatarPreview
{
    ...
    {
        get {
            return m_ShowIKOnFeetButton;
        }
        set {
            m_ShowIKOnFeetButton = value;
        }
    }
    ...
    {
        get {
            return GetAnimationType(m_SourcePreviewMotion);
        }
    }
    ...
    {
        get {
            return m_PreviewInstance ? m_PreviewInstance.transform.position : Vector3.zero;
        }
    }
