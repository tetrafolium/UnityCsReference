...
internal class LineRendererEditorSettings : ScriptableSingleton<LineRendererEditorSettings>
{
    ...
    {
        get {
            return instance.m_ShowSimplifyPreview;
        }
        set {
            SetValue(ref instance.m_ShowSimplifyPreview, value);
        }
    }
    ...
    {
        get {
            return instance.m_CreatePointSeparation;
        }
        set {
            SetValue(ref instance.m_CreatePointSeparation, value);
        }
    }
    ...
    {
        get {
            return instance.m_CreationOffset;
        }
        set {
            SetValue(ref instance.m_CreationOffset, value);
        }
    }
    ...
    {
        get {
            return instance.m_InputMode;
        }
        set {
            SetValue(ref instance.m_InputMode, value);
        }
    }
    ...
    {
        get {
            return instance.m_RaycastMask;
        }
        set {
            SetValue(ref instance.m_RaycastMask, value);
        }
    }
    ...
    {
        get {
            return instance.m_ShowWireframe;
        }
        set {
            SetValue(ref instance.m_ShowWireframe, value);
        }
    }
    ...
    {
        get {
            return instance.m_SimplifyTolerance;
        }
        set {
            SetValue(ref instance.m_SimplifyTolerance, value);
        }
    }
}
}
