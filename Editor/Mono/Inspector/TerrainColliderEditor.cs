...
internal class TerrainColliderEditor : Collider3DEditorBase {
  ...
  protected GUIContent terrainContent = EditorGUIUtility.TrTextContent(
      "Terrain Data",
      "The TerrainData asset that stores heightmaps, terrain textures, detail meshes and trees.");
  protected GUIContent treeColliderContent = EditorGUIUtility.TrTextContent(
  ...
  public override void OnEnable() {
    ...
    m_EnableTreeColliders =
        serializedObject.FindProperty("m_EnableTreeColliders");
  }
