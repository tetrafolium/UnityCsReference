...
namespace UnityEditor.IMGUI.Controls {
  internal class MultiLevelDataSource : AdvancedDropdownDataSource {
        ...
        for (var j = 0; j < paths.Length; j++) {
          ...
          if (j == paths.Length - 1) {
            ...
            if (i == m_SelectedIndex) {
              ...
              //                            AdvancedDropdownItem searchedItem =
              //                            element;
              // TODO fix selecting
              //                            while (tempParent != null)
              //                            {
              //                                state.SetSelectedIndex(tempParent,
              //                                tempParent.children.IndexOf(searchedItem));
          ...
          var group = parent.children.SingleOrDefault(
              c =>((MultiLevelItem) c).stringId == groupPathId);
          if (group == null) {
    ...
    class MultiLevelItem : AdvancedDropdownItem {
      ...
      public override string ToString() { return stringId; }
    }
  }
}
