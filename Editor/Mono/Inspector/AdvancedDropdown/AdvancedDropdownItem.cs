...
namespace UnityEditor.IMGUI.Controls {
  public class AdvancedDropdownItem : IComparable {
    ...
    static readonly AdvancedDropdownItem k_SeparatorItem =
        new SeparatorDropdownItem();
    ...
    public void AddSeparator() { AddChild(k_SeparatorItem); }

    internal bool IsSeparator() { return k_SeparatorItem == this; }
