...
internal static partial class StatelessAdvancedDropdown {
  public static int SearchablePopup(Rect rect, int selectedIndex,
                                    string[] displayedOptions) {
    return DoSearchablePopup(rect, selectedIndex, displayedOptions,
                             EditorStyles.popup);
  }
  ...
  public static Enum EnumPopup(Rect rect, Enum selected,
                               params GUILayoutOption[] options) {
    return DoEnumPopup(rect, selected, EditorStyles.popup, options);
  }

  public static int Popup(Rect rect, int selectedIndex,
                          string[] displayedOptions) {
    return Popup(rect, selectedIndex,
  ...
  public static int IntPopup(Rect rect, int selectedValue,
