...
public SerializedProperty streamingMipmapBias {
	get;
	private set;
}

internal static class Styles {
public static GUIContent streamingMipmapBias = EditorGUIUtility.TrTextContent(
	"Mip Map Bias",
...
public void OnEnable() {
	streamingMipmapBias =
		serializedObject.FindProperty("m_StreamingMipmapBias");
}
