...
internal class LineRendererInspector : RendererEditorBase
{
    ...
    {
        get {
            return EditorPrefs.GetFloat("LineRendererInspectorSimplifyTolerance", 1.0f);
        }
        set {
            EditorPrefs.SetFloat("LineRendererInspectorSimplifyTolerance", value < 0 ? 0 : value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool("LineRendererEditorShowSimplifyPreview", false);
        }
        set {
            EditorPrefs.SetBool("LineRendererEditorShowSimplifyPreview", value);
        }
    }
    ...
    {
        get {
            return IsLineRendererEditMode(EditMode.editMode) && EditMode.IsOwner(this);
        }
    }
    ...
    {
        get {
            return !m_IsMultiEditing && m_IsGameObjectEditable;
        }
    }
