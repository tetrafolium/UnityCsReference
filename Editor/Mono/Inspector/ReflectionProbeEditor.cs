...
internal class ReflectionProbeEditor : Editor
{
    ...
    {
        get {
            return reflectionProbeTarget.mode;
        }
    }
    ...
    {
        get {
            return s_SphereMesh ?? (s_SphereMesh = Resources.GetBuiltinResource(typeof(Mesh), "New-Sphere.fbx") as Mesh);
        }
    }
