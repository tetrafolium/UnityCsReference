...
internal class ScaleConstraintEditor : ConstraintEditorBase {
  ...
  private class Styles : ConstraintStyleBase {
    ...
    GUIContent m_ScalingAxes =
        EditorGUIUtility.TrTextContent("Freeze Scaling Axes");
  ...
  internal override void ShowFreezeAxesControl() {
    ...
    EditorGUI.MultiPropertyField(
        ...
        serializedObject.FindProperty("m_AffectScalingX"), s_Style.FreezeAxes);
  }
