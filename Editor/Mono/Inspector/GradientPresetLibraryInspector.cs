...
private GenericPresetLibraryInspector<GradientPresetLibrary>
m_GenericPresetLibraryInspector;

public void OnEnable() {
	m_GenericPresetLibraryInspector =
		new GenericPresetLibraryInspector<GradientPresetLibrary>(
			target, "Gradient Preset Library", OnEditButtonClicked);
...
public override void OnInspectorGUI() {
	m_GenericPresetLibraryInspector.itemViewMode =
		PresetLibraryEditorState.GetItemViewMode("Gradient"); // ensure in-sync
	if (m_GenericPresetLibraryInspector != null)
