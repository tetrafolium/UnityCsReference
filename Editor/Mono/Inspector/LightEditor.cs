...
public class LightEditor : Editor
{
    public sealed class Settings
    {
        ...
        public bool isRealtime {
            get {
                return lightmapping.intValue == (int)LightmapBakeType.Realtime;
            }
        }
        public bool isMixed {
            get {
                return lightmapping.intValue == (int)LightmapBakeType.Mixed;
            }
        }
        public bool isCompletelyBaked {
            get {
                return lightmapping.intValue == (int)LightmapBakeType.Baked;
            }
        }
        ...
        public bool isAreaLightType {
            get {
                return lightType.intValue == (int)LightType.Rectangle || lightType.intValue == (int)LightType.Disc;
            }
        }

        internal bool typeIsSame {
            get {
                return !lightType.hasMultipleDifferentValues;
            }
        }
        internal bool shadowTypeIsSame {
            get {
                return !shadowsType.hasMultipleDifferentValues;
            }
        }
        internal bool lightmappingTypeIsSame {
            get {
                return !lightmapping.hasMultipleDifferentValues;
            }
        }
        ...
        public Light light {
            get {
                return m_SerializedObject.targetObject as Light;
            }
        }
        public Texture cookie {
            get {
                return cookieProp.objectReferenceValue as Texture;
            }
        }

        internal bool showMixedModeUnsupportedWarning {
            get {
                return !isPrefabAsset && isMixed && lightmappingTypeIsSame && !SupportedRenderingFeatures.IsLightmapBakeTypeSupported(LightmapBakeType.Mixed);
            }
        }
        internal bool showBakedModeUnsupportedWarning {
            get {
                return !isPrefabAsset && isCompletelyBaked && lightmappingTypeIsSame && !SupportedRenderingFeatures.IsLightmapBakeTypeSupported(LightmapBakeType.Baked);
            }
        }
        ...
        internal bool showBakingWarning {
            get {
                return !isPrefabAsset && !Lightmapping.GetLightingSettingsOrDefaultsFallback().bakedGI && lightmappingTypeIsSame && isBakedOrMixed;
            }
        }
        ...
        public void DrawInnerAndOuterSpotAngle()
        {
            ...
            var sliderRect = new Rect(rect) {
                xMin = minRect.xMax + EditorGUI.kSpacing, xMax = maxRect.xMin - EditorGUI.kSpacing
            };
    ...
    bool spotOptionsValue {
        get {
            return settings.typeIsSame && settings.light.type == LightType.Spot;
        }
    }
    ...
    bool dirOptionsValue {
        get {
            return settings.typeIsSame && settings.light.type == LightType.Directional;
        }
    }
    bool areaOptionsValue {
        get {
            return settings.typeIsSame && settings.isAreaLightType;
        }
    }
    bool runtimeOptionsValue {
        get {
            return settings.typeIsSame && ((settings.light.type != LightType.Rectangle && settings.light.type != LightType.Disc) && !settings.isCompletelyBaked);
        }
    }
    bool bakedShadowRadius {
        get {
            return settings.typeIsSame && (settings.light.type == LightType.Point || settings.light.type == LightType.Spot) && settings.isBakedOrMixed;
        }
    }
    bool bakedShadowAngle {
        get {
            return settings.typeIsSame && settings.light.type == LightType.Directional && settings.isBakedOrMixed;
        }
    }
    bool shadowOptionsValue {
        get {
            return settings.shadowTypeIsSame && settings.light.shadows != LightShadows.None;
        }
    }
