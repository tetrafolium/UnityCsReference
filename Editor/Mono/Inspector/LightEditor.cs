...
public class LightEditor : Editor {
  public sealed class Settings {
    ...
    public SerializedProperty lightShape {
      get;
      private set;
    }
    ...
    public SerializedProperty innerSpotAngle {
      get;
      private set;
    }
    ...
    private enum AreaLightShape { None = 0, Rectangle = 3, Disc = 4 }

    public Settings(SerializedObject so) { m_SerializedObject = so; }

    private static class Styles {
      public static readonly GUIContent Type = EditorGUIUtility.TrTextContent(
          "Type",
          "Specifies the current type of light. Possible types are Directional, Spot, Point, and Area lights.");
      public static readonly GUIContent Shape = EditorGUIUtility.TrTextContent(
          "Shape",
          "Specifies the shape of the Area light. Possible types are Rectangle and Disc.");
      public static readonly GUIContent Range = EditorGUIUtility.TrTextContent(
          "Range",
          "Controls how far the light is emitted from the center of the object.");
      public static readonly GUIContent SpotAngle = EditorGUIUtility.TrTextContent(
          "Spot Angle",
          "Controls the angle in degrees at the base of a Spot light's cone.");
      public static readonly GUIContent InnerOuterSpotAngle =
          EditorGUIUtility.TrTextContent(
              "Inner / Outer Spot Angle",
              "Controls the inner and outer angle in degrees, at the base of a Spot light's cone.");
      public static readonly GUIContent Color = EditorGUIUtility.TrTextContent(
          "Color", "Controls the color being emitted by the light.");
      public static readonly GUIContent UseColorTemperature =
          EditorGUIUtility.TrTextContent(
              "Use color temperature mode",
              "Choose between RGB and temperature mode for light's color.");
      public static readonly GUIContent ColorFilter = EditorGUIUtility.TrTextContent(
          "Filter",
          "A colored gel can be put in front of the light source to tint the light.");
      public static readonly GUIContent ColorTemperature =
          EditorGUIUtility.TrTextContent(
              "Temperature",
              "Also known as CCT (Correlated color temperature). The color temperature of the electromagnetic radiation emitted from an ideal black body is defined as its surface temperature in Kelvin. White is 6500K");
      public static readonly GUIContent Intensity = EditorGUIUtility.TrTextContent(
          "Intensity",
          "Controls the brightness of the light. Light color is multiplied by this value.");
      public static readonly GUIContent LightmappingMode =
          EditorGUIUtility.TrTextContent(
              "Mode",
              "Specifies the light mode used to determine if and how a light will be baked. Possible modes are Baked, Mixed, and Realtime.");
      public static readonly GUIContent LightBounceIntensity =
          EditorGUIUtility.TrTextContent(
              "Indirect Multiplier",
              "Controls the intensity of indirect light being contributed to the scene. A value of 0 will cause Realtime lights to be removed from realtime global illumination and Baked and Mixed lights to no longer emit indirect lighting. Has no effect when both Realtime and Baked Global Illumination are disabled.");
      public static readonly GUIContent ShadowType = EditorGUIUtility.TrTextContent(
          "Shadow Type",
          "Specifies whether Hard Shadows, Soft Shadows, or No Shadows will be cast by the light.");
      public static readonly GUIContent CastShadows = EditorGUIUtility.TrTextContent(
          "Cast Shadows",
          "Specifies whether Soft Shadows or No Shadows will be cast by the light.");
      // realtime
      public static readonly GUIContent ShadowRealtimeSettings =
          EditorGUIUtility.TrTextContent(
              "Realtime Shadows", "Settings for realtime direct shadows.");
      public static readonly GUIContent ShadowStrength =
          EditorGUIUtility.TrTextContent(
              "Strength",
              "Controls how dark the shadows cast by the light will be.");
      public static readonly GUIContent ShadowResolution =
          EditorGUIUtility.TrTextContent(
              "Resolution",
              "Controls the rendered resolution of the shadow maps. A higher resolution will increase the fidelity of shadows at the cost of GPU performance and memory usage.");
      ...
      public static readonly GUIContent ShadowNormalBias =
          EditorGUIUtility.TrTextContent(
              "Normal Bias",
      ...
      public static readonly GUIContent ShadowNearPlane =
          EditorGUIUtility.TrTextContent(
              "Near Plane",
              "Controls the value for the near clip plane when rendering shadows. Currently clamped to 0.1 units or 1% of the lights range property, whichever is lower.");
      // baked
      public static readonly GUIContent BakedShadowRadius =
          EditorGUIUtility.TrTextContent(
              "Baked Shadow Radius",
              "Controls the amount of artificial softening applied to the edges of shadows cast by the Point or Spot light.");
      public static readonly GUIContent BakedShadowAngle =
          EditorGUIUtility.TrTextContent(
              "Baked Shadow Angle",
              "Controls the amount of artificial softening applied to the edges of shadows cast by directional lights.");

      public static readonly GUIContent Cookie = EditorGUIUtility.TrTextContent(
          "Cookie",
          "Specifies the Texture mask to cast shadows, create silhouettes, or patterned illumination for the light.");
      public static readonly GUIContent CookieSize = EditorGUIUtility.TrTextContent(
          "Cookie Size",
          "Controls the size of the cookie mask currently assigned to the light.");
      public static readonly GUIContent DrawHalo = EditorGUIUtility.TrTextContent(
          "Draw Halo",
          "When enabled, draws a spherical halo of light with a radius equal to the lights range value.");
      public static readonly GUIContent Flare = EditorGUIUtility.TrTextContent(
          "Flare",
          "Specifies the flare object to be used by the light to render lens flares in the scene.");
      public static readonly GUIContent RenderMode = EditorGUIUtility.TrTextContent(
          "Render Mode",
          "Specifies the importance of the light which impacts lighting fidelity and performance. Options are Auto, Important, and Not Important. This only affects Forward Rendering.");
      public static readonly GUIContent CullingMask = EditorGUIUtility.TrTextContent(
          "Culling Mask",
          "Specifies which layers will be affected or excluded from the light's effect on objects in the scene.");
      public static readonly GUIContent RenderingLayerMask =
          EditorGUIUtility.TrTextContent(
              "Rendering Layer Mask",
              "Mask that can be used with SRP when drawing shadows to filter renderers outside of the normal layering system.");

      public static readonly GUIContent AreaWidth =
          EditorGUIUtility.TrTextContent(
              "Width", "Controls the width in units of the area light.");
      public static readonly GUIContent AreaHeight =
          EditorGUIUtility.TrTextContent(
              "Height", "Controls the height in units of the area light.");
      public static readonly GUIContent AreaRadius =
          EditorGUIUtility.TrTextContent(
              "Radius", "Controls the radius in units of the disc area light.");

      public static readonly GUIContent BakingWarning =
          EditorGUIUtility.TrTextContent(
              "Light mode is currently overridden to Realtime mode. Enable Baked Global Illumination to use Mixed or Baked light modes.");
      public static readonly GUIContent IndirectBounceShadowWarning =
          EditorGUIUtility.TrTextContent(
              "Realtime indirect bounce shadowing is not supported for Spot and Point lights.");
      public static readonly GUIContent CookieSpotRepeatWarning =
          EditorGUIUtility.TrTextContent(
              "Cookie textures for spot lights should be set to clamp, not repeat, to avoid artifacts.");
      public static readonly GUIContent CookieNotEnabledWarning =
          EditorGUIUtility.TrTextContent(
              "Cookie support for baked lights is not enabled. Please enable it in Project Settings > Editor > Enable baked cookies support");
      public static readonly GUIContent CookieNotEnabledInfo =
          EditorGUIUtility.TrTextContent(
              "Cookie support for mixed lights is not enabled for indirect lighting. You can enable it in Project Settings > Editor > Enable baked cookies support");
      public static readonly GUIContent MixedUnsupportedWarning =
          EditorGUIUtility.TrTextContent(
              "Light mode is currently overridden to Realtime mode. The current render pipeline doesn't support Mixed mode and/or any of the lighting modes.");
      public static readonly GUIContent BakedUnsupportedWarning =
          EditorGUIUtility.TrTextContent(
              "Light mode is currently overridden to Realtime mode. The current render pipeline doesn't support Baked mode.");

      public static readonly GUIContent[] LightmapBakeTypeTitles = {
          EditorGUIUtility.TrTextContent("Realtime"),
          EditorGUIUtility.TrTextContent("Mixed"),
          EditorGUIUtility.TrTextContent("Baked")};
      public static readonly int[] LightmapBakeTypeValues = {
          (int) LightmapBakeType.Realtime, (int) LightmapBakeType.Mixed,
          (int) LightmapBakeType.Baked};

      public static readonly GUIContent[] LightTypeTitles = {
          EditorGUIUtility.TrTextContent("Spot"),
          EditorGUIUtility.TrTextContent("Directional"),
          EditorGUIUtility.TrTextContent("Point"),
          EditorGUIUtility.TrTextContent("Area (baked only)")};
      public static readonly int[] LightTypeValues = {
          (int) LightType.Spot, (int) LightType.Directional,
          (int) LightType.Point, (int) LightType.Rectangle};

      public static readonly GUIContent[] AreaLightShapeTitles = {
          EditorGUIUtility.TrTextContent("Rectangle"),
          EditorGUIUtility.TrTextContent("Disc")};
      public static readonly int[] AreaLightShapeValues = {
          (int) AreaLightShape.Rectangle, (int) AreaLightShape.Disc};
    }

    public bool isRealtime {
      get { return lightmapping.intValue == (int) LightmapBakeType.Realtime; }
    }
    public bool isMixed {
      get { return lightmapping.intValue == (int) LightmapBakeType.Mixed; }
    }
    public bool isCompletelyBaked {
      get { return lightmapping.intValue == (int) LightmapBakeType.Baked; }
    }
    public bool isBakedOrMixed {
      get { return !isRealtime; }
    }
    public bool isAreaLightType {
      get {
        return lightType.intValue == (int) LightType.Rectangle ||
               lightType.intValue == (int) LightType.Disc;
      }
    }

    internal bool typeIsSame {
      get { return !lightType.hasMultipleDifferentValues; }
    }
    internal bool shadowTypeIsSame {
      get { return !shadowsType.hasMultipleDifferentValues; }
    }
    internal bool lightmappingTypeIsSame {
      get { return !lightmapping.hasMultipleDifferentValues; }
    }
    ...
    internal bool isPrefabAsset {
      get {
        ...
        return PrefabUtility.IsPartOfPrefabAsset(
            m_SerializedObject.targetObject);
      }
    }

    public Light light {
      get { return m_SerializedObject.targetObject as Light; }
    }
    public Texture cookie {
      get { return cookieProp.objectReferenceValue as Texture; }
    }

    internal bool showMixedModeUnsupportedWarning {
      get {
        return !isPrefabAsset && isMixed && lightmappingTypeIsSame &&
               !SupportedRenderingFeatures.IsLightmapBakeTypeSupported(
                   LightmapBakeType.Mixed);
      }
    }
    internal bool showBakedModeUnsupportedWarning {
      get {
        return !isPrefabAsset && isCompletelyBaked && lightmappingTypeIsSame &&
               !SupportedRenderingFeatures.IsLightmapBakeTypeSupported(
    ...
    internal bool showBounceWarning {
      get {
        return typeIsSame &&
               ...
               lightmappingTypeIsSame && isRealtime &&
               !bounceIntensity.hasMultipleDifferentValues &&
               bounceIntensity.floatValue > 0.0F;
      }
    }
    internal bool showBakingWarning {
      get {
        return !isPrefabAsset &&
               !Lightmapping.GetLightingSettingsOrDefaultsFallback().bakedGI &&
               lightmappingTypeIsSame && isBakedOrMixed;
      }
    }
    ...
    internal bool showCookieSpotRepeatWarning {
      get {
        return typeIsSame && light.type == LightType.Spot &&
               !cookieProp.hasMultipleDifferentValues && cookie &&
    ...
    internal bool showCookieNotEnabledWarning {
      get {
        return typeIsSame && isCompletelyBaked &&
               !cookieProp.hasMultipleDifferentValues && cookie &&
    ...
    public void OnEnable() {
      ...
      useColorTemperature =
          m_SerializedObject.FindProperty("m_UseColorTemperature");
      ...
      shadowsResolution =
          m_SerializedObject.FindProperty("m_Shadows.m_Resolution");
      shadowsBias = m_SerializedObject.FindProperty("m_Shadows.m_Bias");
      shadowsNormalBias =
          m_SerializedObject.FindProperty("m_Shadows.m_NormalBias");
      shadowsNearPlane =
          m_SerializedObject.FindProperty("m_Shadows.m_NearPlane");
      ...
      renderingLayerMask =
          m_SerializedObject.FindProperty("m_RenderingLayerMask");
      ...
      if (m_KelvinGradientTexture == null)
        m_KelvinGradientTexture = CreateKelvinGradientTexture(
            "KelvinGradientTexture", 300, 16, kMinKelvin, kMaxKelvin);
    }
    ...
    static Texture2D CreateKelvinGradientTexture(string name, int width,
                                                 int height, float minKelvin,
                                                 float maxKelvin) {
      // The texture is draw with a simple internal-GUITexture shader that don't
      // perform any gamma correction so we need to provide value for color
      // temperature texture in gamma space and use a linear format for the
      // texture
      var texture =
    ...
    public void DrawLightType() {
      // To the user, we will only display it as a area light, but under the
      // hood, we have Rectangle and Disc. This is not to confuse people who
      // still use our legacy light inspector.

      int selectedLightType = lightType.intValue;
      int selectedShape =
          isAreaLightType ? lightType.intValue : (int) AreaLightShape.None;
      ...
      int type =
          EditorGUI.IntPopup(rect, Styles.Type, selectedLightType,
                             Styles.LightTypeTitles, Styles.LightTypeValues);
      ...
      if (isAreaLightType && selectedShape != (int) AreaLightShape.None) {
        ...
        EditorGUI.BeginChangeCheck();
        int shape = EditorGUI.IntPopup(rect, Styles.Shape, selectedShape,
    ...
    [Obsolete(
        "showAreaOptions argument for DrawRange(showAreaOptions) has been removed. Use DrawRange() instead (UnityUpgradable).")]
    ...
    public void DrawInnerAndOuterSpotAngle() {
      ...
      // The right hand side of the min max slider will control the reset of the
      // max value The left hand side of the min max slider will control the
      // reset of the min value The label itself will not have a right click and
      // reset value.

      rect = EditorGUI.PrefixLabel(rect, Styles.InnerOuterSpotAngle);
      EditorGUI.BeginProperty(new Rect(rect){width = rect.width * 0.5f},
                              Styles.InnerOuterSpotAngle, innerSpotAngle);
      EditorGUI.BeginProperty(new Rect(rect){xMin = rect.x + rect.width * 0.5f},
                              GUIContent.none, spotAngle);

      var minRect = new Rect(rect){width = textFieldWidth};
      var maxRect = new Rect(rect){xMin = rect.xMax - textFieldWidth};
      var sliderRect = new Rect(rect){xMin = minRect.xMax + EditorGUI.kSpacing,
                                      xMax = maxRect.xMin - EditorGUI.kSpacing};
    ...
    public void DrawColor() {
      if (GraphicsSettings.lightsUseLinearIntensity &&
        ...
        if (useColorTemperature.boolValue) {
          ...
          EditorGUILayout.SliderWithTexture(
              Styles.ColorTemperature, colorTemperature, kMinKelvin, kMaxKelvin,
              kSliderPower, m_KelvinGradientTexture);
          EditorGUI.indentLevel -= 1;
        } else
    ...
    public void DrawLightmapping() {
      ...
      int index = Math.Max(0, Array.IndexOf(Styles.LightmapBakeTypeValues,
                                            lightmapping.intValue));

      if (EditorGUI.DropdownButton(rect, Styles.LightmapBakeTypeTitles[index],
                                   FocusType.Passive)) {
        ...
        for (int i = 0; i < Styles.LightmapBakeTypeValues.Length; i++) {
          ...
          bool selected =
              (lightmappingTypeIsSame && (value == lightmapping.intValue));

          if (((value == (int) LightmapBakeType.Mixed) ||
               (value == (int) LightmapBakeType.Baked)) &&
              ((!SupportedRenderingFeatures.IsLightmapBakeTypeSupported(
                    (LightmapBakeType) value) ||
                !Lightmapping.GetLightingSettingsOrDefaultsFallback()
                     .bakedGI) &&
               !isPrefabAsset)) {
            menu.AddDisabledItem(Styles.LightmapBakeTypeTitles[i], selected);
          } else {
            menu.AddItem(Styles.LightmapBakeTypeTitles[i], selected,
                         OnLightmappingItemSelected, value);
          }
        }
        menu.DropDown(rect);
      }
      ...
      if (showMixedModeUnsupportedWarning)
        EditorGUILayout.HelpBox(Styles.MixedUnsupportedWarning.text,
                                MessageType.Warning);
      else if (showBakedModeUnsupportedWarning)
        EditorGUILayout.HelpBox(Styles.BakedUnsupportedWarning.text,
                                MessageType.Warning);
    ...
    internal void CheckLightmappingConsistency() {
      // Built-in render-pipeline only support baked area light, enforce it as
      // this inspector is the built-in one.
      if (isAreaLightType &&
    ...
    public void DrawBounceIntensity() {
      EditorGUILayout.PropertyField(bounceIntensity,
                                    Styles.LightBounceIntensity);
      // Indirect shadows warning (Should be removed when we support realtime
      // indirect shadows)
      if (showBounceWarning) {
        EditorGUILayout.HelpBox(Styles.IndirectBounceShadowWarning.text,
                                MessageType.Warning);
      }
    }
    ...
    public void DrawCookie() {
      ...
      if (showCookieSpotRepeatWarning) {
        ...
        EditorGUILayout.HelpBox(Styles.CookieSpotRepeatWarning.text,
                                MessageType.Warning);
      }

      if (showCookieNotEnabledWarning) {
        // warn if cookie support is not enabled for baked lights
        EditorGUILayout.HelpBox(Styles.CookieNotEnabledWarning.text,
                                MessageType.Warning);
      }

      if (showCookieNotEnabledInfo) {
        // info if cookie support is not enabled for mixed lights
        EditorGUILayout.HelpBox(Styles.CookieNotEnabledInfo.text,
                                MessageType.Info);
      }
    }
    ...
    public void DrawRenderingLayerMask() {
      ...
      var rect = EditorGUILayout.GetControlRect();
      EditorGUI.BeginProperty(rect, Styles.RenderingLayerMask,
                              renderingLayerMask);
    ...
    public void DrawShadowsType() {
      ...
      if (isAreaLightType) {
        ...
        EditorGUI.BeginChangeCheck();
        bool shadows =
            EditorGUI.Toggle(rect, Styles.CastShadows,
                             shadowsType.intValue != (int) LightShadows.None);

        if (EditorGUI.EndChangeCheck()) {
          shadowsType.intValue =
              shadows ?(int) LightShadows.Soft : (int) LightShadows.None;
        }
        EditorGUI.EndProperty();
      } else {
    ...
    public void DrawBakedShadowRadius() {
      using(new EditorGUI.DisabledScope(shadowsType.intValue !=
                                        (int) LightShadows.Soft)) {
        EditorGUILayout.PropertyField(bakedShadowRadiusProp,
                                      Styles.BakedShadowRadius);
      }
    }
    ...
    public void DrawBakedShadowAngle() {
      using(new EditorGUI.DisabledScope(shadowsType.intValue !=
                                        (int) LightShadows.Soft)) {
        EditorGUILayout.Slider(bakedShadowAngleProp, 0.0F, 90.0F,
                               Styles.BakedShadowAngle);
      }
    }
    ...
    public void DrawRuntimeShadow() {
      ...
      EditorGUILayout.Slider(shadowsNormalBias, 0.0f, 3.0f,
                             Styles.ShadowNormalBias);

      // this min bound should match the calculation in
      // SharedLightData::GetNearPlaneMinBound()
      float nearPlaneMinBound = Mathf.Min(0.01f * range.floatValue, 0.1f);
      EditorGUILayout.Slider(shadowsNearPlane, nearPlaneMinBound, 10.0f,
  ...
  private static class StylesEx {
    public static readonly GUIContent iconRemove =
        EditorGUIUtility.TrIconContent("Toolbar Minus",
                                       "Remove command buffer");
    public static readonly GUIContent DisabledLightWarning =
        EditorGUIUtility.TrTextContent(
            "Lighting has been disabled in at least one Scene view. Any changes applied to lights in the Scene will not be updated in these views until Lighting has been enabled again.");
    public static readonly GUIStyle invisibleButton = "InvisibleButton";
    public static readonly GUIContent noDiscLightInEnlighten =
        EditorGUIUtility.TrTextContent(
            "Only the Progressive lightmapper supports Disc lights. The Enlighten lightmapper doesn't so please consider using a different light shape instead or switch to Progressive in the Lighting window.");
  }

  private Settings m_Settings;
  protected Settings settings =>
      m_Settings ??(m_Settings = new Settings(serializedObject));

  private IMGUI.Controls.SphereBoundsHandle m_BoundsHandle =
      new IMGUI.Controls.SphereBoundsHandle();
  ...
  protected static readonly Color kGizmoLight =
      new Color(254 / 255f, 253 / 255f, 136 / 255f, 128 / 255f);
  protected static readonly Color kGizmoDisabledLight =
      new Color(135 / 255f, 116 / 255f, 50 / 255f, 128 / 255f);
  ...
  private void SetOptions(AnimBool animBool, bool initialize,
                          bool targetValue) {
    if (initialize) {
  ...
  bool spotOptionsValue {
    get { return settings.typeIsSame && settings.light.type == LightType.Spot; }
  }
  bool pointOptionsValue {
    get {
      return settings.typeIsSame && settings.light.type == LightType.Point;
    }
  }
  bool dirOptionsValue {
    get {
      return settings.typeIsSame &&
             settings.light.type == LightType.Directional;
    }
  }
  bool areaOptionsValue {
    get { return settings.typeIsSame && settings.isAreaLightType; }
  }
  bool runtimeOptionsValue {
    get {
      return settings.typeIsSame &&
             ((settings.light.type != LightType.Rectangle &&
               settings.light.type != LightType.Disc) &&
              !settings.isCompletelyBaked);
    }
  }
  bool bakedShadowRadius {
    get {
      return settings.typeIsSame &&
             (settings.light.type == LightType.Point ||
              settings.light.type == LightType.Spot) &&
             settings.isBakedOrMixed;
    }
  }
  bool bakedShadowAngle {
    get {
      return settings.typeIsSame &&
             settings.light.type == LightType.Directional &&
             settings.isBakedOrMixed;
  ...
  bool shadowOptionsValue {
    get {
      return settings.shadowTypeIsSame &&
             settings.light.shadows != LightShadows.None;
    }
  }
  ...
  private void CommandBufferGUI() {
    ...
    m_CommandBuffersShown = GUILayout.Toggle(
        m_CommandBuffersShown, GUIContent.Temp(count + " command buffers"),
        EditorStyles.foldout);
    if (!m_CommandBuffersShown)
      return;
    EditorGUI.indentLevel++;
    foreach (LightEvent le in (LightEvent[])
                 System.Enum.GetValues(typeof(LightEvent))) {
      ...
      foreach (CommandBuffer cb in cbs) {
        using(new GUILayout.HorizontalScope()) {
          ...
          Rect rowRect =
              GUILayoutUtility.GetRect(GUIContent.none, EditorStyles.miniLabel);
          rowRect.xMin += EditorGUI.indent;
          Rect minusRect = GetRemoveButtonRect(rowRect);
          rowRect.xMax = minusRect.x;
          GUI.Label(rowRect,
                    string.Format("{0}: {1} ({2})", le, cb.name,
                                  EditorUtility.FormatBytes(cb.sizeInBytes)),
                    EditorStyles.miniLabel);
          // and a button to remove it
          if (GUI.Button(minusRect, StylesEx.iconRemove,
                         StylesEx.invisibleButton)) {
  ...
  static Rect GetRemoveButtonRect(Rect r) {
    ...
    return new Rect(r.xMax - buttonSize.x,
                    r.y + (int)(r.height / 2 - buttonSize.y / 2), buttonSize.x,
                    buttonSize.y);
  }
  ...
  public override void OnInspectorGUI() {
    ...
    if (Lightmapping.GetLightingSettingsOrDefaultsFallback().lightmapper ==
            LightingSettings.Lightmapper.Enlighten &&
        settings.light.type == LightType.Disc)
      EditorGUILayout.HelpBox(StylesEx.noDiscLightInEnlighten.text,
                              MessageType.Warning);

    EditorGUILayout.Space();

    // When we are switching between two light types that don't show the range
    // (directional lights don't) we want the fade group to stay hidden.
    ...
    if (SceneView.lastActiveSceneView != null &&
      ...
      EditorGUILayout.HelpBox(StylesEx.DisabledLightWarning.text,
                              MessageType.Warning);
  ...
  void ShadowsGUI() {
    // NOTE: FadeGroup's dont support nesting. Thus we just multiply the fade
    // values here.
    ...
    if (EditorGUILayout.BeginFadeGroup(show *
                                       m_AnimBakedShadowRadiusOptions.faded))
      settings.DrawBakedShadowRadius();
    EditorGUILayout.EndFadeGroup();

    // Baked Shadow angle
    if (EditorGUILayout.BeginFadeGroup(show *
                                       m_AnimBakedShadowAngleOptions.faded))
  ...
  protected virtual void OnSceneGUI() {
    ...
    case LightType.Directional:
      ...
      using(new Handles.DrawingScope(
          Matrix4x4.identity)) // be sure no matrix affect the size computation
      {
        lightSize = HandleUtility.GetHandleSize(lightPos);
      }
      float radius = lightSize * 0.2f;
      using(new Handles.DrawingScope(
          Matrix4x4.TRS(lightPos, t.transform.rotation, Vector3.one))) {
    ...
    case LightType.Point:
      thisRange = Handles.RadiusHandle(Quaternion.identity,
                                       t.transform.position, thisRange);
      if (GUI.changed) {
    ...
    case LightType.Spot:
      ...
      angleAndRange =
          Handles.ConeHandle(t.transform.rotation, t.transform.position,
                             angleAndRange, 1.0f, 1.0f, true);
      if (GUI.changed) {
    ...
    case LightType.Rectangle:
      EditorGUI.BeginChangeCheck();
      Vector2 size = Handles.DoRectHandles(
          t.transform.rotation, t.transform.position, t.areaSize, false);
      if (EditorGUI.EndChangeCheck()) {
        Undo.RecordObject(t, "Adjust Rect Light");
        t.areaSize = size;
      }
      // Draw the area light's normal only if it will not overlap with the
      // current tool
    ...
    case LightType.Disc:
      ...
      m_BoundsHandle.axes = IMGUI.Controls.PrimitiveBoundsHandle.Axes.X |
      ...
      mat.SetTRS(t.transform.position, t.transform.rotation,
                 new Vector3(1, 1, 1));
      EditorGUI.BeginChangeCheck();
