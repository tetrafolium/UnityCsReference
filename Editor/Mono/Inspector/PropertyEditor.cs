...
class PropertyEditor : EditorWindow, IPropertyView, IHasCustomMenu
{
    ...
    protected static class Styles
    {
        ...
        public static GUIStyle preMargins = new GUIStyle() {
            margin = new RectOffset(0, 0, 0, 4)
        };
        public static GUIStyle preOptionsButton = new GUIStyle(EditorStyles.toolbarButtonRight) {
    ...
    internal virtual void RebuildContentsContainers()
    {
        ...
        rootVisualElement.RegisterCallback<MouseEnterEvent>((e) => {
            CurrentPropertyEditor = this;
        });
        rootVisualElement.RegisterCallback<MouseLeaveEvent>((e) => {
            CurrentPropertyEditor = null;
        });
    ...
    private void DrawEditors(Editor[] editors)
    {
        ...
        for (int editorIndex = 0; editorIndex < editors.Length; editorIndex++)
        {
            ...
            VisualElement prefabsComponentElement = new VisualElement() {
