...
// **************************************
//
// DO NOT COPY/PASTE! Please do not have the same setting more than once in the
// code. If a setting for one platform needs to be exposed to more platforms,
// change the if statements so the same lines of code are executed for both
// platforms, instead of copying the lines into multiple code blocks. This
// ensures that if we change labels, or headers, or the order of settings, it
// will remain consistent without having to remember to make the same change
// multiple places. THANK YOU!
//
...
internal partial class PlayerSettingsEditor : Editor {
  class Styles {
    ...
    static Styles() { categoryBox.padding.left = 4; }
  }

  class SettingsContent {
    public static readonly GUIContent colorSpaceAndroidWarning =
        EditorGUIUtility.TrTextContent(
            "Linear colorspace requires OpenGL ES 3.0 or Vulkan, uncheck 'Automatic Graphics API' to remove OpenGL ES 2 API, Blit Type for non-SRP projects must be Always Blit or Auto");
    public static readonly GUIContent colorSpaceWebGLWarning =
        EditorGUIUtility.TrTextContent(
            "Linear colorspace requires WebGL 2.0, uncheck 'Automatic Graphics API' to remove WebGL 1.0 API. WARNING: If DXT sRGB is not supported by the browser, texture will be decompressed");
    ...
    public static readonly GUIContent recordingInfo = EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent notApplicableInfo =
        EditorGUIUtility.TrTextContent("Not applicable for this platform.");
    public static readonly GUIContent sharedBetweenPlatformsInfo =
        EditorGUIUtility.TrTextContent(
            "* Shared setting between multiple platforms.");
    public static readonly GUIContent vrOrientationInfo =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent cursorHotspot =
        EditorGUIUtility.TrTextContent("Cursor Hotspot");
    public static readonly GUIContent defaultCursor =
        EditorGUIUtility.TrTextContent("Default Cursor");
    public static readonly GUIContent defaultIcon =
        EditorGUIUtility.TrTextContent("Default Icon");
    ...
    public static readonly GUIContent iconTitle =
        EditorGUIUtility.TrTextContent("Icon");
    public static readonly GUIContent resolutionPresentationTitle =
        EditorGUIUtility.TrTextContent("Resolution and Presentation");
    public static readonly GUIContent resolutionTitle =
        EditorGUIUtility.TrTextContent("Resolution");
    public static readonly GUIContent orientationTitle =
        EditorGUIUtility.TrTextContent("Orientation");
    ...
    public static readonly GUIContent multitaskingSupportTitle =
        EditorGUIUtility.TrTextContent("Multitasking Support");
    public static readonly GUIContent statusBarTitle =
        EditorGUIUtility.TrTextContent("Status Bar");
    public static readonly GUIContent standalonePlayerOptionsTitle =
        EditorGUIUtility.TrTextContent("Standalone Player Options");
    public static readonly GUIContent debuggingCrashReportingTitle =
        EditorGUIUtility.TrTextContent("Debugging and crash reporting");
    public static readonly GUIContent debuggingTitle =
        EditorGUIUtility.TrTextContent("Debugging");
    public static readonly GUIContent crashReportingTitle =
        EditorGUIUtility.TrTextContent("Crash Reporting");
    public static readonly GUIContent otherSettingsTitle =
        EditorGUIUtility.TrTextContent("Other Settings");
    public static readonly GUIContent renderingTitle =
        EditorGUIUtility.TrTextContent("Rendering");
    public static readonly GUIContent vulkanSettingsTitle =
        EditorGUIUtility.TrTextContent("Vulkan Settings");
    public static readonly GUIContent identificationTitle =
        EditorGUIUtility.TrTextContent("Identification");
    public static readonly GUIContent macAppStoreTitle =
        EditorGUIUtility.TrTextContent("Mac App Store Options");
    public static readonly GUIContent configurationTitle =
        EditorGUIUtility.TrTextContent("Configuration");
    public static readonly GUIContent optimizationTitle =
        EditorGUIUtility.TrTextContent("Optimization");
    public static readonly GUIContent loggingTitle =
        EditorGUIUtility.TrTextContent("Stack Trace*");
    public static readonly GUIContent legacyTitle =
        EditorGUIUtility.TrTextContent("Legacy");
    public static readonly GUIContent legacyXRTitle =
        EditorGUIUtility.TrTextContent("XR Settings (Deprecated)");
    public static readonly GUIContent publishingSettingsTitle =
        EditorGUIUtility.TrTextContent("Publishing Settings");

    public static readonly GUIContent bakeCollisionMeshes =
        EditorGUIUtility.TrTextContent(
            "Prebake Collision Meshes*",
            "Bake collision data into the meshes on build time");
    public static readonly GUIContent keepLoadedShadersAlive =
        EditorGUIUtility.TrTextContent("Keep Loaded Shaders Alive*",
                                       "Prevents shaders from being unloaded");
    public static readonly GUIContent preloadedAssets =
        EditorGUIUtility.TrTextContent(
            "Preloaded Assets*",
            "Assets to load at start up in the player and kept alive until the player terminates");
    public static readonly GUIContent stripEngineCode =
        EditorGUIUtility.TrTextContent(
            "Strip Engine Code*",
            "Strip Unused Engine Code - Note that byte code stripping of managed assemblies is always enabled for the IL2CPP scripting backend.");
    public static readonly GUIContent iPhoneScriptCallOptimization =
        EditorGUIUtility.TrTextContent("Script Call Optimization*");
    public static readonly GUIContent enableInternalProfiler =
        EditorGUIUtility.TrTextContent(
            "Enable Internal Profiler* (Deprecated)",
            "Internal profiler counters should be accessed by scripts using UnityEngine.Profiling::Profiler API.");
    public static readonly GUIContent stripUnusedMeshComponents =
        EditorGUIUtility.TrTextContent("Optimize Mesh Data*",
                                       "Remove unused mesh components");
    public static readonly GUIContent mipStripping = EditorGUIUtility.TrTextContent(
        "Texture MipMap Stripping*",
        "Remove unused texture levels from package builds, reducing package size on disk. Limits the texture quality settings to the highest mip that was included during the build.");
    public static readonly GUIContent enableFrameTimingStats =
        EditorGUIUtility.TrTextContent(
            "Frame Timing Stats",
            "Enable gathering of CPU/GPU frame timing statistics.");
    public static readonly GUIContent useOSAutoRotation =
        EditorGUIUtility.TrTextContent(
            "Use Animated Autorotation",
            "If set OS native animated autorotation method will be used. Otherwise orientation will be changed immediately.");
    public static readonly GUIContent UIPrerenderedIcon =
        EditorGUIUtility.TrTextContent("Prerendered Icon");
    public static readonly GUIContent defaultScreenWidth =
        EditorGUIUtility.TrTextContent("Default Screen Width");
    public static readonly GUIContent defaultScreenHeight =
        EditorGUIUtility.TrTextContent("Default Screen Height");
    public static readonly GUIContent macRetinaSupport =
        EditorGUIUtility.TrTextContent("Mac Retina Support");
    public static readonly GUIContent runInBackground =
        EditorGUIUtility.TrTextContent("Run In Background*");
    public static readonly GUIContent defaultScreenOrientation =
        EditorGUIUtility.TrTextContent("Default Orientation*");
    public static readonly GUIContent allowedAutoRotateToPortrait =
        EditorGUIUtility.TrTextContent("Portrait");
    public static readonly GUIContent allowedAutoRotateToPortraitUpsideDown =
        EditorGUIUtility.TrTextContent("Portrait Upside Down");
    public static readonly GUIContent allowedAutoRotateToLandscapeRight =
        EditorGUIUtility.TrTextContent("Landscape Right");
    public static readonly GUIContent allowedAutoRotateToLandscapeLeft =
        EditorGUIUtility.TrTextContent("Landscape Left");
    public static readonly GUIContent UIRequiresFullScreen =
        EditorGUIUtility.TrTextContent("Requires Fullscreen");
    public static readonly GUIContent UIStatusBarHidden =
        EditorGUIUtility.TrTextContent("Status Bar Hidden");
    public static readonly GUIContent UIStatusBarStyle =
        EditorGUIUtility.TrTextContent("Status Bar Style");
    public static readonly GUIContent useMacAppStoreValidation =
        EditorGUIUtility.TrTextContent("Mac App Store Validation");
    public static readonly GUIContent macAppStoreCategory =
        EditorGUIUtility.TrTextContent("Category",
                                       "'LSApplicationCategoryType'");
    public static readonly GUIContent fullscreenMode =
        EditorGUIUtility.TrTextContent("Fullscreen Mode ",
                                       " Not all platforms support all modes");
    public static readonly GUIContent exclusiveFullscreen =
        EditorGUIUtility.TrTextContent("Exclusive Fullscreen");
    public static readonly GUIContent fullscreenWindow =
        EditorGUIUtility.TrTextContent("Fullscreen Window");
    public static readonly GUIContent maximizedWindow =
        EditorGUIUtility.TrTextContent("Maximized Window");
    public static readonly GUIContent windowed =
        EditorGUIUtility.TrTextContent("Windowed");
    public static readonly GUIContent displayResolutionDialogEnabledLabel =
        EditorGUIUtility.TrTextContent("Enabled (Deprecated)");
    public static readonly GUIContent displayResolutionDialogHiddenLabel =
        EditorGUIUtility.TrTextContent("Hidden by Default (Deprecated)");
    public static readonly GUIContent displayResolutionDialogDeprecationWarning =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent visibleInBackground =
        EditorGUIUtility.TrTextContent("Visible In Background");
    public static readonly GUIContent allowFullscreenSwitch =
        EditorGUIUtility.TrTextContent("Allow Fullscreen Switch");
    public static readonly GUIContent useFlipModelSwapChain =
        EditorGUIUtility.TrTextContent(
            "Use DXGI Flip Model Swapchain for D3D11",
            "Flip model ensures the best performance. Disable this to fallback to Windows 7-style BltBlt model. This setting affects only D3D11 graphics API.");
    public static readonly GUIContent use32BitDisplayBuffer =
        EditorGUIUtility.TrTextContent(
            "Use 32-bit Display Buffer*",
            "If set Display Buffer will be created to hold 32-bit color values. Use it only if you see banding, as it has performance implications.");
    public static readonly GUIContent disableDepthAndStencilBuffers =
        EditorGUIUtility.TrTextContent("Disable Depth and Stencil*");
    public static readonly GUIContent preserveFramebufferAlpha =
        EditorGUIUtility.TrTextContent(
            "Render Over Native UI*",
            "Enable this option ONLY if you want Unity to render on top of the native Android or iOS UI.");
    public static readonly GUIContent iosShowActivityIndicatorOnLoading =
        EditorGUIUtility.TrTextContent("Show Loading Indicator");
    ...
    public static readonly GUIContent actionOnDotNetUnhandledException =
        EditorGUIUtility.TrTextContent("On .Net UnhandledException*");
    public static readonly GUIContent logObjCUncaughtExceptions =
        EditorGUIUtility.TrTextContent("Log Obj-C Uncaught Exceptions*");
    public static readonly GUIContent enableCrashReportAPI =
        EditorGUIUtility.TrTextContent("Enable CrashReport API*");
    public static readonly GUIContent activeColorSpace =
        EditorGUIUtility.TrTextContent("Color Space*");
    public static readonly GUIContent colorGamut =
        EditorGUIUtility.TrTextContent("Color Gamut*");
    public static readonly GUIContent colorGamutForMac =
        EditorGUIUtility.TrTextContent("Color Gamut For Mac*");
    public static readonly GUIContent metalForceHardShadows =
        EditorGUIUtility.TrTextContent("Force hard shadows on Metal*");
    public static readonly GUIContent metalEditorSupport =
        EditorGUIUtility.TrTextContent("Metal Editor Support*");
    public static readonly GUIContent metalAPIValidation =
        EditorGUIUtility.TrTextContent("Metal API Validation*");
    public static readonly GUIContent metalFramebufferOnly =
        EditorGUIUtility.TrTextContent(
            "Metal Write-Only Backbuffer",
            "Set framebufferOnly flag on backbuffer. This prevents readback from backbuffer but enables some driver optimizations.");
    public static readonly GUIContent framebufferDepthMemorylessMode =
        EditorGUIUtility.TrTextContent("Memoryless Depth",
                                       "Memoryless mode of framebuffer depth");
    public static readonly GUIContent[] memorylessModeNames = {
        EditorGUIUtility.TrTextContent("Unused"),
        EditorGUIUtility.TrTextContent("Forced"),
        EditorGUIUtility.TrTextContent("Automatic")};
    public static readonly GUIContent vulkanEnableSetSRGBWrite =
        EditorGUIUtility.TrTextContent(
            "SRGB Write Mode*",
            "If set, enables Graphics.SetSRGBWrite() for toggling sRGB write mode during the frame but may decrease performance especially on tiled GPUs.");
    public static readonly GUIContent vulkanNumSwapchainBuffers =
        EditorGUIUtility.TrTextContent("Number of swapchain buffers");
    public static readonly GUIContent vulkanEnablePreTransform =
        EditorGUIUtility.TrTextContent(
            "Apply display rotation during rendering");
    public static readonly GUIContent mTRendering =
        EditorGUIUtility.TrTextContent("Multithreaded Rendering*");
    public static readonly GUIContent staticBatching =
        EditorGUIUtility.TrTextContent("Static Batching");
    public static readonly GUIContent dynamicBatching =
        EditorGUIUtility.TrTextContent("Dynamic Batching");
    public static readonly GUIContent graphicsJobsNonExperimental =
        EditorGUIUtility.TrTextContent("Graphics Jobs");
    public static readonly GUIContent graphicsJobsExperimental =
        EditorGUIUtility.TrTextContent("Graphics Jobs (Experimental)");
    public static readonly GUIContent graphicsJobsMode =
        EditorGUIUtility.TrTextContent("Graphics Jobs Mode");
    ...
    public static readonly GUIContent appleDeveloperTeamID =
        EditorGUIUtility.TrTextContent(
            ...
            "Developers can retrieve their Team ID by visiting the Apple Developer site under Account > Membership.");
    public static readonly GUIContent useOnDemandResources =
        EditorGUIUtility.TrTextContent("Use on-demand resources*");
    public static readonly GUIContent gcIncremental = EditorGUIUtility.TrTextContent(
        "Use incremental GC",
        "With incremental Garbage Collection, the Garbage Collector will try to time-slice the collection task into multiple steps, to avoid long GC times preventing content from running smoothly.");
    public static readonly GUIContent accelerometerFrequency =
        EditorGUIUtility.TrTextContent("Accelerometer Frequency*");
    public static readonly GUIContent cameraUsageDescription =
        EditorGUIUtility.TrTextContent(
            "Camera Usage Description*",
            "String shown to the user when requesting permission to use the device camera. Written to the NSCameraUsageDescription field in Xcode project's info.plist file");
    public static readonly GUIContent locationUsageDescription =
        EditorGUIUtility.TrTextContent(
            "Location Usage Description*",
            "String shown to the user when requesting permission to access the device location. Written to the NSLocationWhenInUseUsageDescription field in Xcode project's info.plist file.");
    public static readonly GUIContent microphoneUsageDescription =
        EditorGUIUtility.TrTextContent(
            "Microphone Usage Description*",
            "String shown to the user when requesting to use the device microphone. Written to the NSMicrophoneUsageDescription field in Xcode project's info.plist file");
    public static readonly GUIContent muteOtherAudioSources =
        EditorGUIUtility.TrTextContent("Mute Other Audio Sources*");
    public static readonly GUIContent prepareIOSForRecording =
        EditorGUIUtility.TrTextContent("Prepare iOS for Recording");
    public static readonly GUIContent forceIOSSpeakersWhenRecording =
        EditorGUIUtility.TrTextContent("Force iOS Speakers when Recording");
    public static readonly GUIContent UIRequiresPersistentWiFi =
        EditorGUIUtility.TrTextContent("Requires Persistent WiFi*");
    ...
    public static readonly GUIContent iOSURLSchemes =
        EditorGUIUtility.TrTextContent("Supported URL schemes*");
    public static readonly GUIContent iOSExternalAudioInputNotSupported =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent aotOptions =
        EditorGUIUtility.TrTextContent("AOT Compilation Options*");
    public static readonly GUIContent require31 =
        EditorGUIUtility.TrTextContent("Require ES3.1");
    public static readonly GUIContent requireAEP =
        EditorGUIUtility.TrTextContent("Require ES3.1+AEP");
    public static readonly GUIContent require32 =
        EditorGUIUtility.TrTextContent("Require ES3.2");
    public static readonly GUIContent skinOnGPU =
        EditorGUIUtility.TrTextContent("GPU Skinning*",
                                       "Use DX11/ES3 GPU Skinning");
    public static readonly GUIContent skinOnGPUCompute =
        EditorGUIUtility.TrTextContent("Compute Skinning*",
                                       "Use Compute pipeline for Skinning");
    public static readonly GUIContent scriptingDefineSymbols =
        EditorGUIUtility.TrTextContent(
            "Scripting Define Symbols",
            "Preprocessor defines passed to the C# script compiler");
    public static readonly GUIContent scriptingDefineSymbolsApply =
        EditorGUIUtility.TrTextContent("Apply");
    public static readonly GUIContent scriptingDefineSymbolsApplyRevert =
        EditorGUIUtility.TrTextContent("Revert");
    public static readonly GUIContent scriptingDefineSymbolsCopyDefines =
        EditorGUIUtility.TrTextContent("Copy Defines", "Copy applied defines");
    public static readonly GUIContent scriptingBackend =
        EditorGUIUtility.TrTextContent("Scripting Backend");
    public static readonly GUIContent managedStrippingLevel =
        EditorGUIUtility.TrTextContent(
            "Managed Stripping Level",
            "If scripting backend is IL2CPP, managed stripping can't be disabled.");
    ...
    public static readonly GUIContent scriptingMono2x =
        EditorGUIUtility.TrTextContent("Mono");
    public static readonly GUIContent scriptingIL2CPP =
        EditorGUIUtility.TrTextContent("IL2CPP");
    public static readonly GUIContent scriptingDefault =
        EditorGUIUtility.TrTextContent("Default");
    public static readonly GUIContent strippingDisabled =
        EditorGUIUtility.TrTextContent("Disabled");
    public static readonly GUIContent strippingLow =
        EditorGUIUtility.TrTextContent("Low");
    public static readonly GUIContent strippingMedium =
        EditorGUIUtility.TrTextContent("Medium");
    public static readonly GUIContent strippingHigh =
    ...
    public static readonly GUIContent apiCompatibilityLevel_NET_2_0 =
        EditorGUIUtility.TrTextContent(".NET 2.0");
    ...
    public static readonly GUIContent apiCompatibilityLevel_NET_4_6 =
        EditorGUIUtility.TrTextContent(".NET 4.x");
    ...
    public static readonly GUIContent allowUnsafeCode =
        EditorGUIUtility.TrTextContent(
            "Allow 'unsafe' Code",
            "Allow compilation of unsafe code for predefined assemblies (Assembly-CSharp.dll, etc.)");
    public static readonly GUIContent useDeterministicCompilation =
        EditorGUIUtility.TrTextContent(
            "Use Deterministic Compilation",
            "Compile with -deterministic compilation flag");
    public static readonly GUIContent useReferenceAssembclies =
        EditorGUIUtility.TrTextContent(
            "Use Roslyn Reference Assemblies",
            "Skips compilation of assembly references if the metadata of the modified assembly does not change.");
    public static readonly GUIContent activeInputHandling =
        EditorGUIUtility.TrTextContent("Active Input Handling*");
    public static readonly GUIContent[] activeInputHandlingOptions =
        new GUIContent[]{
            EditorGUIUtility.TrTextContent("Input Manager (Old)"),
            EditorGUIUtility.TrTextContent("Input System Package (New)"),
            EditorGUIUtility.TrTextContent("Both")};
    public static readonly GUIContent lightmapEncodingLabel =
        EditorGUIUtility.TrTextContent(
            "Lightmap Encoding",
            "Affects the encoding scheme and compression format of the lightmaps.");
    ...
    public static readonly GUIContent lightmapStreamingEnabled =
        EditorGUIUtility.TrTextContent(
            "Lightmap Streaming",
            "Only load larger lightmap mipmaps as needed to render the current game cameras. Requires texture streaming to be enabled in quality settings. This value is applied to the light map textures as they are generated.");
    public static readonly GUIContent lightmapStreamingPriority =
        EditorGUIUtility.TrTextContent(
            "Streaming Priority",
            "Lightmap mipmap streaming priority when there's contention for resources. Positive numbers represent higher priority. Valid range is -128 to 127. This value is applied to the light map textures as they are generated.");
    public static readonly GUIContent lightmapQualityAndroidWarning =
        EditorGUIUtility.TrTextContent(
            "The selected Lightmap Encoding requires OpenGL ES 3.0 or Vulkan. Uncheck 'Automatic Graphics API' and remove OpenGL ES 2 API");
    public static readonly GUIContent lightmapQualityIOSWarning =
        EditorGUIUtility.TrTextContent(
            "The selected Lightmap Encoding requires Metal API only. Uncheck 'Automatic Graphics API' and remove OpenGL ES APIs.");
    public static readonly GUIContent legacyClampBlendShapeWeights =
        EditorGUIUtility.TrTextContent(
            "Clamp BlendShapes (Deprecated)*",
            "If set, the range of BlendShape weights in SkinnedMeshRenderers will be clamped.");
    public static readonly GUIContent virtualTexturingSupportEnabled =
        EditorGUIUtility.TrTextContent(
            "Enable Virtual Texturing*",
            "Enable support for Virtual Texturing. Changing this value requires an Editor restart.");
    public static readonly GUIContent virtualTexturingUnsupportedPlatformWarning =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent virtualTexturingUnsupportedAPI =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent virtualTexturingUnsupportedAPIWin =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent virtualTexturingUnsupportedAPIMac =
        EditorGUIUtility.TrTextContent(
    ...
    public static readonly GUIContent virtualTexturingUnsupportedAPILinux =
        EditorGUIUtility.TrTextContent(
    ...
    public static string undoChangedBundleIdentifierString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed macOS bundleIdentifier");
      }
    }
    public static string undoChangedBuildNumberString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed macOS build number");
      }
    }
    public static string undoChangedBatchingString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed Batching Settings");
      }
    }
    public static string undoChangedIconString {
      get { return LocalizationDatabase.GetLocalizedString("Changed Icon"); }
    }
    public static string undoChangedGraphicsAPIString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed Graphics API Settings");
      }
    }
    public static string undoChangedScriptingDefineString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed Scripting Define Settings");
      }
    }
    public static string undoChangedGraphicsJobsString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed Graphics Jobs Setting");
      }
    }
    public static string undoChangedGraphicsJobModeString {
      get {
        return LocalizationDatabase.GetLocalizedString(
            "Changed Graphics Job Mode Setting");
      }
    }
  }
  ...
  private static GraphicsJobMode[] m_GfxJobModeValues =
      new GraphicsJobMode[]{GraphicsJobMode.Native, GraphicsJobMode.Legacy};
  private static GUIContent[] m_GfxJobModeNames =
      new GUIContent[]{EditorGUIUtility.TrTextContent("Native"),
                       EditorGUIUtility.TrTextContent("Legacy")};
...
#pragma warning disable 169
  ...
  static Dictionary<BuildTarget, ReorderableList> s_GraphicsDeviceLists =
      new Dictionary<BuildTarget, ReorderableList>();

  public static void SyncPlatformAPIsList(BuildTarget target) {
    if (!s_GraphicsDeviceLists.ContainsKey(target))
      return;
    s_GraphicsDeviceLists[target].list =
        PlayerSettings.GetGraphicsAPIs(target).ToList();
  }
  ...
  void OnEnable() {
    ...
    m_StripUnusedMeshComponents =
        FindPropertyAssert("StripUnusedMeshComponents");
    m_MipStripping = FindPropertyAssert("mipStripping");
    m_VertexChannelCompressionMask =
        FindPropertyAssert("VertexChannelCompressionMask");
    ...
    m_FramebufferDepthMemorylessMode =
        FindPropertyAssert("framebufferDepthMemorylessMode");
    ...
    m_ForceIOSSpeakersWhenRecording =
        FindPropertyAssert("Force IOS Speakers When Recording");
    ...
    m_MicrophoneUsageDescription =
        FindPropertyAssert("microphoneUsageDescription");

    m_EnableInternalProfiler = FindPropertyAssert("enableInternalProfiler");
    m_ActionOnDotNetUnhandledException =
        FindPropertyAssert("actionOnDotNetUnhandledException");
    m_LogObjCUncaughtExceptions =
        FindPropertyAssert("logObjCUncaughtExceptions");
    ...
    m_UseDeterministicCompilation =
        FindPropertyAssert("useDeterministicCompilation");
    ...
    m_AllowedAutoRotateToPortrait =
        FindPropertyAssert("allowedAutorotateToPortrait");
    m_AllowedAutoRotateToPortraitUpsideDown =
        FindPropertyAssert("allowedAutorotateToPortraitUpsideDown");
    m_AllowedAutoRotateToLandscapeRight =
        FindPropertyAssert("allowedAutorotateToLandscapeRight");
    m_AllowedAutoRotateToLandscapeLeft =
        FindPropertyAssert("allowedAutorotateToLandscapeLeft");
    ...
    m_DisableDepthAndStencilBuffers =
        FindPropertyAssert("disableDepthAndStencilBuffers");
    m_iosShowActivityIndicatorOnLoading =
        FindPropertyAssert("iosShowActivityIndicatorOnLoading");
    m_androidShowActivityIndicatorOnLoading =
        FindPropertyAssert("androidShowActivityIndicatorOnLoading");

    m_DefaultIsNativeResolution =
        FindPropertyAssert("defaultIsNativeResolution");
    ...
    m_VulkanNumSwapchainBuffers =
        FindPropertyAssert("vulkanNumSwapchainBuffers");
    ...
    m_LegacyClampBlendShapeWeights =
        FindPropertyAssert("legacyClampBlendShapeWeights");
    m_AndroidEnableTango = FindPropertyAssert("AndroidEnableTango");

    m_VirtualTexturingSupportEnabled =
        FindPropertyAssert("virtualTexturingSupportEnabled");

    m_SettingsExtensions = new ISettingEditorExtension[validPlatforms.Length];
    for (int i = 0; i < validPlatforms.Length; i++) {
      string module = ModuleManager.GetTargetStringFromBuildTargetGroup(
          validPlatforms[i].targetGroup);
      m_SettingsExtensions[i] =
          ModuleManager.GetEditorSettingsExtension(module);
    ...
    // we access this cache both from player settings editor and script side
    // when changing api
  ...
  void OnDisable() {
    if (hasScriptDefinesBeenModified) {
      if (EditorUtility.DisplayDialog(
              "Scripting Define Symbols Have Been Modified",
              "Do you want to save changes?", "Apply", "Revert")) {
        PlayerSettings.SetScriptingDefineSymbolsForGroup(
            lastTargetGroup, scriptDefinesList.ToArray());
      }
  ...
  public override void OnInspectorGUI() {
    ...
    selectedPlatform =
        EditorGUILayout.BeginPlatformGrouping(validPlatforms, null);
    if (EditorGUI.EndChangeCheck()) {
      // Awesome hackery to get string from delayed textfield when switching
      // platforms
      if (EditorGUI.s_DelayedTextEditor.IsEditingControl(
        ...
        PlayerSettings.SetScriptingDefineSymbolsForGroup(
            validPlatforms[oldPlatform].targetGroup,
            EditorGUI.s_DelayedTextEditor.text);
      }
      // Reset focus when changing between platforms.
      // If we don't do this, the resolution width/height value will not update
      // correctly when they have the focus
      GUI.FocusControl("");
    }
    ...
    ResolutionSectionGUI(targetGroup, m_SettingsExtensions[selectedPlatform],
                         sectionIndex++);
    m_SplashScreenEditor.SplashSectionGUI(
        platform, targetGroup, m_SettingsExtensions[selectedPlatform],
        sectionIndex++);
    DebugAndCrashReportingGUI(platform, targetGroup,
                              m_SettingsExtensions[selectedPlatform],
                              sectionIndex++);
    OtherSectionGUI(platform, targetGroup,
                    m_SettingsExtensions[selectedPlatform], sectionIndex++);
  ...
  private void CommonSettings() {
    ...
    EditorGUILayout.PropertyField(m_ApplicationBundleVersion,
                                  EditorGUIUtility.TrTextContent("Version"));
    EditorGUILayout.Space();
    ...
    int[] widths =
        PlayerSettings.GetIconWidthsOfAllKindsForPlatform(platformName);

    // Ensure the default icon list is always populated correctly
    if (icons.Length != widths.Length) {
      icons = new Texture2D[widths.Length];
    }
    icons[0] = (Texture2D) EditorGUILayout.ObjectField(
        SettingsContent.defaultIcon, icons[0], typeof(Texture2D), false);
    // Save changes
    if (GUI.changed) {
    ...
    Rect cursorPropertyRect = EditorGUILayout.GetControlRect(
        true, EditorGUI.kObjectFieldThumbnailHeight);
    EditorGUI.BeginProperty(cursorPropertyRect, SettingsContent.defaultCursor,
                            m_DefaultCursor);
    m_DefaultCursor.objectReferenceValue = EditorGUI.ObjectField(
        cursorPropertyRect, SettingsContent.defaultCursor,
        m_DefaultCursor.objectReferenceValue, typeof(Texture2D), false);
  ...
  public bool BeginSettingsBox(int nr, GUIContent header) {
    ...
    EditorGUI.BeginChangeCheck();
    bool expanded = EditorGUI.FoldoutTitlebar(
        r, header, m_SelectedSection.value == nr, true,
        EditorStyles.inspectorTitlebarFlat, EditorStyles.inspectorTitlebarText);
    if (EditorGUI.EndChangeCheck()) {
  ...
  public void ShowSharedNote() {
    GUILayout.Label(SettingsContent.sharedBetweenPlatformsInfo,
    ...
    if (BeginSettingsBox(sectionIndex, SettingsContent.iconTitle)) {
      ...
      if (platformUsesStandardIcons) {
        ...
        if (targetGroup == BuildTargetGroup.WebGL ||
          ...
          // Get icons and icon sizes for selected platform (or default)
          Texture2D[] icons =
              PlayerSettings.GetAllIconsForPlatform(platformName);
          int[] widths =
              PlayerSettings.GetIconWidthsOfAllKindsForPlatform(platformName);
          int[] heights =
              PlayerSettings.GetIconHeightsOfAllKindsForPlatform(platformName);
          IconKind[] kinds =
              PlayerSettings.GetIconKindsForPlatform(platformName);

          bool overrideIcons = true;

          if (!selectedDefault) {
            // If the list of icons for this platform is not empty (and has the
            // correct size), consider the icon overridden for this platform
            GUI.changed = false;
            overrideIcons = (icons.Length == widths.Length);
            overrideIcons = GUILayout.Toggle(
                overrideIcons, string.Format(L10n.Tr("Override for {0}"),
                                             platform.title.text));
            GUI.enabled = enabled && overrideIcons;
            if (GUI.changed || (!overrideIcons && icons.Length > 0)) {
              // Set the list of icons to correct length if overridden,
              // otherwise to an empty list
              if (overrideIcons)
                icons = new Texture2D[widths.Length];
              else
          ...
          for (int i = 0; i < widths.Length; i++) {
            ...
            int previewHeight =
                (int)((float) heights[i] * previewWidth /
                      widths[i]); // take into account the aspect ratio
            ...
            if (targetGroup == BuildTargetGroup.iOS) {
              ...
              if (kinds[i] == IconKind.Spotlight &&
                  kinds[i - 1] != IconKind.Spotlight) {
                Rect labelRect =
                    GUILayoutUtility.GetRect(EditorGUIUtility.labelWidth, 20);
                GUI.Label(new Rect(labelRect.x, labelRect.y,
                                   EditorGUIUtility.labelWidth, 20),
                          "Spotlight icons", EditorStyles.boldLabel);
              }

              if (kinds[i] == IconKind.Settings &&
                  kinds[i - 1] != IconKind.Settings) {
                Rect labelRect =
                    GUILayoutUtility.GetRect(EditorGUIUtility.labelWidth, 20);
                GUI.Label(new Rect(labelRect.x, labelRect.y,
                                   EditorGUIUtility.labelWidth, 20),
                          "Settings icons", EditorStyles.boldLabel);
              }

              if (kinds[i] == IconKind.Notification &&
                  kinds[i - 1] != IconKind.Notification) {
                Rect labelRect =
                    GUILayoutUtility.GetRect(EditorGUIUtility.labelWidth, 20);
                GUI.Label(new Rect(labelRect.x, labelRect.y,
                                   EditorGUIUtility.labelWidth, 20),
                          "Notification icons", EditorStyles.boldLabel);
              }

              if (kinds[i] == IconKind.Store &&
                  kinds[i - 1] != IconKind.Store) {
                Rect labelRect =
                    GUILayoutUtility.GetRect(EditorGUIUtility.labelWidth, 20);
                GUI.Label(new Rect(labelRect.x, labelRect.y,
                                   EditorGUIUtility.labelWidth, 20),
                          "App Store icons", EditorStyles.boldLabel);
              }
            }

            Rect rect = GUILayoutUtility.GetRect(
                kSlotSize, Mathf.Max(kSlotSize, previewHeight) + kIconSpacing);
            float width = Mathf.Min(
                rect.width, EditorGUIUtility.labelWidth + 4 + kSlotSize +
                                kIconSpacing + kMaxPreviewSize);

            // Label
            string label = widths[i] + "x" + heights[i];
            GUI.Label(
                new Rect(rect.x, rect.y,
                         width - kMaxPreviewSize - kSlotSize - 2 * kIconSpacing,
                         20),
                label);
            ...
            if (overrideIcons) {
              ...
              int slotHeight =
                  (int)((float) heights[i] / widths[i] *
                        kSlotSize); // take into account the aspect ratio
              icons[i] = (Texture2D) EditorGUI.ObjectField(
                  new Rect(rect.x + width - kMaxPreviewSize - kSlotSize -
                               kIconSpacing,
                           rect.y, slotWidth, slotHeight),
                  icons[i], typeof(Texture2D), false);
            }

            // Preview
            Rect previewRect = new Rect(rect.x + width - kMaxPreviewSize,
                                        rect.y, previewWidth, previewHeight);
            Texture2D closestIcon = PlayerSettings.GetIconForPlatformAtSize(
                platformName, widths[i], heights[i], kinds[i]);
            if (closestIcon != null)
          ...
          if (GUI.changed) {
            Undo.RecordObject(this.target,
                              SettingsContent.undoChangedIconString);
            PlayerSettings.SetIconsForPlatform(platformName, icons);
          }
          GUI.enabled = enabled;
          ...
          if (targetGroup == BuildTargetGroup.iOS ||
            ...
            EditorGUILayout.PropertyField(m_UIPrerenderedIcon,
                                          SettingsContent.UIPrerenderedIcon);
            EditorGUILayout.Space();
          }
        }
      }
  ...
  private static bool TargetSupportsOptionalBuiltinSplashScreen(
      BuildTargetGroup targetGroup, ISettingEditorExtension settingsExtension) {
    if (settingsExtension != null)
  ...
  public void ResolutionSectionGUI(BuildTargetGroup targetGroup,
                                   ISettingEditorExtension settingsExtension,
                                   int sectionIndex = 0) {
    if (BeginSettingsBox(sectionIndex,
                         SettingsContent.resolutionPresentationTitle)) {
      // PLEASE DO NOT COPY SETTINGS TO APPEAR MULTIPLE PLACES IN THE CODE! See
...

      {
        ...
        if (settingsExtension != null) {
          ...
          float kLabelFloatMinW = EditorGUI.kLabelW +
                                  EditorGUIUtility.fieldWidth +
                                  EditorGUI.kSpacing;
          float kLabelFloatMaxW = EditorGUI.kLabelW +
                                  EditorGUIUtility.fieldWidth +
                                  EditorGUI.kSpacing;
          settingsExtension.ResolutionSectionGUI(h, kLabelFloatMinW,
                                                 kLabelFloatMaxW);
        }

        if (targetGroup == BuildTargetGroup.Standalone) {
          GUILayout.Label(SettingsContent.resolutionTitle,
          ...
          var fullscreenModeNames =
              new[]{SettingsContent.fullscreenWindow,
                    SettingsContent.exclusiveFullscreen,
                    SettingsContent.maximizedWindow, SettingsContent.windowed};
          var fullscreenModeNew =
              BuildEnumPopup(m_FullscreenMode, SettingsContent.fullscreenMode,
                             fullscreenModes, fullscreenModeNames);

          bool defaultIsFullScreen =
              fullscreenModeNew != FullScreenMode.Windowed;
          m_ShowDefaultIsNativeResolution.target = defaultIsFullScreen;
          if (EditorGUILayout.BeginFadeGroup(
                  m_ShowDefaultIsNativeResolution.faded))
            EditorGUILayout.PropertyField(m_DefaultIsNativeResolution);
          EditorGUILayout.EndFadeGroup();

          m_ShowResolution.target =
              !(defaultIsFullScreen && m_DefaultIsNativeResolution.boolValue);
          if (EditorGUILayout.BeginFadeGroup(m_ShowResolution.faded)) {
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(m_DefaultScreenWidth,
                                          SettingsContent.defaultScreenWidth);
            if (EditorGUI.EndChangeCheck() && m_DefaultScreenWidth.intValue < 1)
              m_DefaultScreenWidth.intValue = 1;

            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(m_DefaultScreenHeight,
                                          SettingsContent.defaultScreenHeight);
            if (EditorGUI.EndChangeCheck() &&
        ...
        if (targetGroup == BuildTargetGroup.Standalone) {
          EditorGUILayout.PropertyField(m_MacRetinaSupport,
                                        SettingsContent.macRetinaSupport);
          EditorGUILayout.PropertyField(m_RunInBackground,
                                        SettingsContent.runInBackground);
        }

        if (settingsExtension != null &&
            settingsExtension.SupportsOrientation()) {
          GUILayout.Label(SettingsContent.orientationTitle,
                          EditorStyles.boldLabel);

          EditorGUILayout.PropertyField(
              m_DefaultScreenOrientation,
              SettingsContent.defaultScreenOrientation);

          if (PlayerSettings.virtualRealitySupported) {
            EditorGUILayout.HelpBox(SettingsContent.vrOrientationInfo.text,
                                    MessageType.Warning);
          }

          if (m_DefaultScreenOrientation.enumValueIndex ==
              (int) UIOrientation.AutoRotation) {
            if (targetGroup == BuildTargetGroup.iOS)
              EditorGUILayout.PropertyField(m_UseOSAutoRotation,
                                            SettingsContent.useOSAutoRotation);

            EditorGUI.indentLevel++;

            GUILayout.Label(SettingsContent.allowedOrientationTitle,
                            EditorStyles.boldLabel);

            bool somethingAllowed =
                m_AllowedAutoRotateToPortrait.boolValue ||
            ...
            if (!somethingAllowed) {
              ...
              Debug.LogError(
                  "All orientations are disabled. Allowing portrait");
            }

            EditorGUILayout.PropertyField(
                m_AllowedAutoRotateToPortrait,
                SettingsContent.allowedAutoRotateToPortrait);
            EditorGUILayout.PropertyField(
                m_AllowedAutoRotateToPortraitUpsideDown,
                SettingsContent.allowedAutoRotateToPortraitUpsideDown);
            EditorGUILayout.PropertyField(
                m_AllowedAutoRotateToLandscapeRight,
                SettingsContent.allowedAutoRotateToLandscapeRight);
            EditorGUILayout.PropertyField(
                m_AllowedAutoRotateToLandscapeLeft,
                SettingsContent.allowedAutoRotateToLandscapeLeft);
        ...
        if (targetGroup == BuildTargetGroup.iOS) {
          GUILayout.Label(SettingsContent.multitaskingSupportTitle,
                          EditorStyles.boldLabel);
          EditorGUILayout.PropertyField(m_UIRequiresFullScreen,
                                        SettingsContent.UIRequiresFullScreen);
          EditorGUILayout.Space();

          GUILayout.Label(SettingsContent.statusBarTitle,
                          EditorStyles.boldLabel);
          EditorGUILayout.PropertyField(m_UIStatusBarHidden,
                                        SettingsContent.UIStatusBarHidden);
          EditorGUILayout.PropertyField(m_UIStatusBarStyle,
                                        SettingsContent.UIStatusBarStyle);
          EditorGUILayout.Space();
        }
        ...
        // Standalone Player
        if (targetGroup == BuildTargetGroup.Standalone) {
          GUILayout.Label(SettingsContent.standalonePlayerOptionsTitle,
                          EditorStyles.boldLabel);
          ...
          EditorGUILayout.PropertyField(m_VisibleInBackground,
                                        SettingsContent.visibleInBackground);

          EditorGUILayout.PropertyField(m_AllowFullscreenSwitch,
                                        SettingsContent.allowFullscreenSwitch);

          EditorGUILayout.PropertyField(m_ForceSingleInstance);
          EditorGUILayout.PropertyField(m_UseFlipModelSwapchain,
                                        SettingsContent.useFlipModelSwapChain);
        ...
        if (BuildTargetDiscovery.PlatformGroupHasFlag(
                targetGroup, TargetAttributes.HasIntegratedGPU)) {
          // iOS, while supports 16bit FB through GL interface, use 32bit in
          // hardware, so there is no need in 16bit
          if (targetGroup != BuildTargetGroup.iOS &&
              targetGroup != BuildTargetGroup.tvOS) {
            EditorGUILayout.PropertyField(
                m_Use32BitDisplayBuffer, SettingsContent.use32BitDisplayBuffer);
          }

          EditorGUILayout.PropertyField(
              m_DisableDepthAndStencilBuffers,
              SettingsContent.disableDepthAndStencilBuffers);
          EditorGUILayout.PropertyField(
              m_PreserveFramebufferAlpha,
              SettingsContent.preserveFramebufferAlpha);
        }
        // activity indicator on loading
        if (targetGroup == BuildTargetGroup.iOS) {
          EditorGUILayout.PropertyField(
              m_iosShowActivityIndicatorOnLoading,
              SettingsContent.iosShowActivityIndicatorOnLoading);
        }
        if (targetGroup == BuildTargetGroup.Android) {
          EditorGUILayout.PropertyField(
              m_androidShowActivityIndicatorOnLoading,
              SettingsContent.androidShowActivityIndicatorOnLoading);
        }
        if (targetGroup == BuildTargetGroup.iOS ||
  ...
  private void AddGraphicsDeviceMenuSelected(object userData, string[] options,
                                             int selected) {
    var target = (BuildTarget) userData;
    var apis = PlayerSettings.GetGraphicsAPIs(target);
    if (apis == null)
      return;
    var apiToAdd = (GraphicsDeviceType) Enum.Parse(typeof(GraphicsDeviceType),
  ...
  private void AddGraphicsDeviceElement(BuildTarget target, Rect rect,
                                        ReorderableList list) {
    GraphicsDeviceType[] availableDevices =
        PlayerSettings.GetSupportedGraphicsAPIs(target);
    ...
    for (int i = 0; i < availableDevices.Length; ++i) {
      names[i] = L10n.Tr(availableDevices [i]
                             .ToString());
      enabled[i] = !list.list.Contains(availableDevices[i]);
    }

    EditorUtility.DisplayCustomMenu(rect, names, enabled, null,
                                    AddGraphicsDeviceMenuSelected, target);
  }
  ...
  private void RemoveGraphicsDeviceElement(BuildTarget target,
                                           ReorderableList list) {
    var apis = PlayerSettings.GetGraphicsAPIs(target);
    if (apis == null)
      return;
  ...
  private void ReorderGraphicsDeviceElement(BuildTarget target,
                                            ReorderableList list) {
  ...
  // these two methods are needed for cases when you want to take some action
  // depending on user choice as changing graphics api will call
  // GUIUtility.ExitGUI
  ...
  private ChangeGraphicsApiAction
  CheckApplyGraphicsAPIList(BuildTarget target, bool firstEntryChanged) {
    bool doRestart = false;
    // If we're changing the first API for relevant editor, this will cause
    // editor to switch: ask for scene save & confirmation
    if (firstEntryChanged && WillEditorUseFirstGraphicsAPI(target)) {
      // If we have dirty scenes we need to save or discard changes before we
      // restart editor. Otherwise user will get a dialog later on where they
      // can click cancel and put editor in a bad device state.
      ...
      if (dirtyScenes.Count != 0) {
        var result = EditorUtility.DisplayDialogComplex(
            ...
            "Save and Restart", "Cancel Changing API",
        ...
        doRestart = EditorUtility.DisplayDialog(
            "Changing editor graphics API",
  ...
  private void ApplyChangeGraphicsApiAction(BuildTarget target,
                                            GraphicsDeviceType[] apis,
                                            ChangeGraphicsApiAction action) {
    if (action.changeList)
      PlayerSettings.SetGraphicsAPIs(target, apis);
    else
      s_GraphicsDeviceLists.Remove(
          target); // we cancelled the list change, so remove the cached one
  ...
  private void ApplyChangedGraphicsAPIList(BuildTarget target,
                                           GraphicsDeviceType[] apis,
                                           bool firstEntryChanged) {
    ChangeGraphicsApiAction action =
        CheckApplyGraphicsAPIList(target, firstEntryChanged);
    ApplyChangeGraphicsApiAction(target, apis, action);
  }

  private void DrawGraphicsDeviceElement(BuildTarget target, Rect rect,
    ...
    // For WebGL, display the actual WebGL version names instead of
    // corresponding GLES APIs for clarification.
  ...
  private static bool
  WillEditorUseFirstGraphicsAPI(BuildTarget targetPlatform) {
  ...
  void OpenGLES31OptionsGUI(BuildTargetGroup targetGroup,
    ...
    var hasMinES3 = apis.Contains(GraphicsDeviceType.OpenGLES3) &&
                    !apis.Contains(GraphicsDeviceType.OpenGLES2);
    if (!hasMinES3)
      return;
  ...
  void GraphicsAPIsGUIOnePlatform(BuildTargetGroup targetGroup,
                                  BuildTarget targetPlatform,
                                  string platformTitle) {
    GraphicsDeviceType[] availableDevices =
        PlayerSettings.GetSupportedGraphicsAPIs(targetPlatform);
    // if no devices (e.g. no platform module), or we only have one possible
    // choice, then no point in having any UI
    ...
    automatic =
        EditorGUILayout.Toggle(string.Format(L10n.Tr("Auto Graphics API {0}"),
                                             (platformTitle ?? string.Empty)),
                               automatic);
    if (EditorGUI.EndChangeCheck()) {
    ...
    if (!automatic) {
      ...
      if (WillEditorUseFirstGraphicsAPI(targetPlatform)) {
        EditorGUILayout.HelpBox(SettingsContent.recordingInfo.text,
      ...
      if (!s_GraphicsDeviceLists.ContainsKey(targetPlatform)) {
        GraphicsDeviceType[] devices =
            PlayerSettings.GetGraphicsAPIs(targetPlatform);
        var devicesList = (devices != null) ? devices.ToList()
                                            : new List<GraphicsDeviceType>();
        var rlist = new ReorderableList(devicesList, typeof(GraphicsDeviceType),
                                        true, true, true, true);
        rlist.onAddDropdownCallback = (rect, list) =>
            AddGraphicsDeviceElement(targetPlatform, rect, list);
        rlist.onCanRemoveCallback = CanRemoveGraphicsDeviceElement;
        rlist.onRemoveCallback = (list) =>
            RemoveGraphicsDeviceElement(targetPlatform, list);
        rlist.onReorderCallback = (list) =>
            ReorderGraphicsDeviceElement(targetPlatform, list);
        rlist.drawElementCallback = (rect, index, isActive, isFocused) =>
            DrawGraphicsDeviceElement(targetPlatform, rect, index, isActive,
                                      isFocused);
      ...
      s_GraphicsDeviceLists [targetPlatform]
          .DoLayoutList();
  ...
  void GraphicsAPIsGUI(BuildTargetGroup targetGroup, BuildTarget target) {
    ...
    if (targetGroup == BuildTargetGroup.Standalone) {
      GraphicsAPIsGUIOnePlatform(targetGroup, BuildTarget.StandaloneWindows,
                                 " for Windows");
      GraphicsAPIsGUIOnePlatform(targetGroup, BuildTarget.StandaloneOSX,
                                 " for Mac");
      GraphicsAPIsGUIOnePlatform(targetGroup, BuildTarget.StandaloneLinux64,
                                 " for Linux");
    } else {
  ...
  // If platform group is not in the dictionary, then it's assumed it supports
  // only sRGB. Color gamut player setting is not displayed for such platforms.
  //
  // This information might be useful for users that use the color gamut APIs,
  // we could expose it somehow
  private static Dictionary<BuildTargetGroup, List<ColorGamut>>
      s_SupportedColorGamuts =
          new Dictionary<BuildTargetGroup, List<ColorGamut>>{
              {BuildTargetGroup.Standalone,
               new List<ColorGamut>{ColorGamut.sRGB, ColorGamut.DisplayP3}},
  ...
  private static bool
  IsColorGamutSupportedOnTargetGroup(BuildTargetGroup targetGroup,
                                     ColorGamut gamut) {
    if (gamut == ColorGamut.sRGB)
      return true;
    if (s_SupportedColorGamuts.ContainsKey(targetGroup) &&
        s_SupportedColorGamuts [targetGroup]
            .Contains(gamut))
      return true;
    return false;
  }

  private static string GetColorGamutDisplayString(BuildTargetGroup targetGroup,
                                                   ColorGamut gamut) {
  ...
  private void AddColorGamutElement(BuildTargetGroup targetGroup, Rect rect,
                                    ReorderableList list) {
    ...
    for (int i = 0; i < availableColorGamuts.Length; ++i) {
      names [i]
      = GetColorGamutDisplayString(targetGroup, availableColorGamuts[i]);
      enabled[i] = !list.list.Contains(availableColorGamuts[i]);
    }

    EditorUtility.DisplayCustomMenu(rect, names, enabled, null,
                                    AddColorGamutMenuSelected,
                                    availableColorGamuts);
  }

  private void AddColorGamutMenuSelected(object userData, string[] options,
                                         int selected) {
  ...
  private void DrawColorGamutElement(BuildTargetGroup targetGroup, Rect rect,
                                     int index, bool selected, bool focused) {
    var colorGamut = s_ColorGamutList.list[index];
    GUI.Label(rect,
              GetColorGamutDisplayString(targetGroup, (ColorGamut) colorGamut),
              EditorStyles.label);
  }
  ...
  void ColorGamutGUI(BuildTargetGroup targetGroup) {
    ...
    if (s_ColorGamutList == null) {
      ...
      var colorGamutsList =
          (colorGamuts != null) ? colorGamuts.ToList() : new List<ColorGamut>();
      var rlist = new ReorderableList(colorGamutsList, typeof(ColorGamut), true,
                                      true, true, true);
    ...
    GUIContent header =
        targetGroup == BuildTargetGroup.Standalone ? SettingsContent
                           .colorGamutForMac : SettingsContent.colorGamut;
    s_ColorGamutList.drawHeaderCallback = (rect) =>
        GUI.Label(rect, header, EditorStyles.label);

    // we want to change the displayed text per platform, to indicate
    // unsupported gamuts
  ...
  public void DebugAndCrashReportingGUI(
      BuildPlatform platform, BuildTargetGroup targetGroup,
    ...
    if (BeginSettingsBox(sectionIndex,
                         SettingsContent.debuggingCrashReportingTitle)) {
      // PLEASE DO NOT COPY SETTINGS TO APPEAR MULTIPLE PLACES IN THE CODE! See
      // top of file for more info.
      {
        // Debugging
        GUILayout.Label(SettingsContent.debuggingTitle, EditorStyles.boldLabel);
        EditorGUILayout.PropertyField(m_EnableInternalProfiler,
                                      SettingsContent.enableInternalProfiler);
        EditorGUILayout.Space();
      }

      {
        // Crash reporting
        GUILayout.Label(SettingsContent.crashReportingTitle,
                        EditorStyles.boldLabel);
        EditorGUILayout.PropertyField(
            m_ActionOnDotNetUnhandledException,
            SettingsContent.actionOnDotNetUnhandledException);
        EditorGUILayout.PropertyField(
            m_LogObjCUncaughtExceptions,
            SettingsContent.logObjCUncaughtExceptions);
        ...
        if (UnityEditor.CrashReporting.CrashReportingSettings.enabled) {
          // CrashReport API must be enabled if cloud crash reporting is
          // enabled, so don't let them change the value of the checkbox
          crashReportApiContent = new GUIContent(
              crashReportApiContent); // Create a copy so we don't alter the
                                      // style definition
          apiFieldDisabled = true;
          crashReportApiContent.tooltip =
              "CrashReport API must be enabled for Performance Reporting service.";
          m_EnableCrashReportAPI.boolValue = true;
        }

        EditorGUI.BeginDisabledGroup(apiFieldDisabled);
        EditorGUILayout.PropertyField(m_EnableCrashReportAPI,
                                      crashReportApiContent);
  ...
  public static void BuildDisabledEnumPopup(GUIContent selected,
                                            GUIContent uiString) {
    using(new EditorGUI.DisabledScope(true)) {
      EditorGUI.Popup(EditorGUILayout.GetControlRect(true), uiString, 0,
                      new GUIContent[]{selected});
    }
  }

  public static T BuildEnumPopup<T>(SerializedProperty prop,
                                    GUIContent uiString, T[] options,
  ...
  public static T BuildEnumPopup<T>(GUIContent uiString, T selected,
                                    T[] options, GUIContent[] optionNames) {
    // Display dropdown
  ...
  public void OtherSectionGUI(BuildPlatform platform,
  ...
  private void
  OtherSectionRenderingGUI(BuildPlatform platform, BuildTargetGroup targetGroup,
                           ISettingEditorExtension settingsExtension) {
    ...
    using(new EditorGUI.DisabledScope(
        EditorApplication
            .isPlaying)) // switching color spaces in play mode is not supported
    {
      EditorGUI.BeginChangeCheck();
      EditorGUILayout.PropertyField(m_ActiveColorSpace,
                                    SettingsContent.activeColorSpace);
      if (EditorGUI.EndChangeCheck()) {
        serializedObject.ApplyModifiedProperties();
    ...
    // Display a warning for platforms that some devices don't support linear
    // rendering if the settings are not fine for linear colorspace
    if (PlayerSettings.colorSpace == ColorSpace.Linear) {
      ...
      if (targetGroup == BuildTargetGroup.Android) {
        ...
        bool hasBlitDisabled =
            (PlayerSettings.Android.blitType == AndroidBlitType.Never) &&
            (GraphicsSettings.currentRenderPipeline == null);
        showWarning =
            hasBlitDisabled || apis.Contains(GraphicsDeviceType.OpenGLES2);
        warningMessage = SettingsContent.colorSpaceAndroidWarning;
      } else if (targetGroup == BuildTargetGroup.iOS ||
                 platform.targetGroup == BuildTargetGroup.tvOS) {
        showWarning = apis.Contains(GraphicsDeviceType.OpenGLES3) ||
                      apis.Contains(GraphicsDeviceType.OpenGLES2);
    ...
    if (Application.platform == RuntimePlatform.OSXEditor &&
        BuildTargetDiscovery.BuildTargetSupportsRenderer(
            platform, GraphicsDeviceType.Metal)) {
      bool curMetalSupport =
          m_MetalEditorSupport.boolValue ||
          SystemInfo.graphicsDeviceType == GraphicsDeviceType.Metal;
      bool newMetalSupport = EditorGUILayout.Toggle(
          SettingsContent.metalEditorSupport, curMetalSupport);
      ...
      if (newMetalSupport != curMetalSupport) {
        ...
        ChangeGraphicsApiAction action = CheckApplyGraphicsAPIList(
            BuildTarget.StandaloneOSX, updateCurrentAPI);
        if (action.changeList) {
          m_MetalEditorSupport.boolValue = newMetalSupport;
          serializedObject.ApplyModifiedProperties();
          // HACK: we pretended to change first api in list to trigger possible
          // gfx device recreation HACK: but we dont really change api list (as
          // we will simply set bool checked from native code)
      ...
      if (m_MetalEditorSupport.boolValue) {
        using(new EditorGUI.IndentLevelScope()) m_MetalAPIValidation.boolValue =
            EditorGUILayout.Toggle(SettingsContent.metalAPIValidation,
                                   m_MetalAPIValidation.boolValue);
      }

      EditorGUILayout.PropertyField(m_MetalFramebufferOnly,
                                    SettingsContent.metalFramebufferOnly);
      if (targetGroup == BuildTargetGroup.iOS ||
          targetGroup == BuildTargetGroup.tvOS)
        EditorGUILayout.PropertyField(m_MetalForceHardShadows,
                                      SettingsContent.metalForceHardShadows);

      int[] memorylessModeValues = {0, 1, 2};
      BuildEnumPopup(m_FramebufferDepthMemorylessMode,
                     SettingsContent.framebufferDepthMemorylessMode,
                     memorylessModeValues, SettingsContent.memorylessModeNames);
    }

    // Multithreaded rendering
    if (settingsExtension != null &&
        settingsExtension.SupportsMultithreadedRendering())
    ...
    // Batching section
    {
      ...
      PlayerSettings.GetBatchingForPlatform(
          platform.defaultTarget, out staticBatching, out dynamicBatching);
      ...
      if (reset) {
        PlayerSettings.SetBatchingForPlatform(platform.defaultTarget,
                                              staticBatching, dynamicBatching);
      }
      ...
      using(new EditorGUI.DisabledScope(!staticBatchingSupported)) {
        if (GUI.enabled)
          staticBatching =
              EditorGUILayout.Toggle(SettingsContent.staticBatching,
                                     staticBatching != 0)
                  ? 1
                  : 0;
        else
      ...
      if (GraphicsSettings.currentRenderPipeline == null) {
        using(new EditorGUI.DisabledScope(!dynamicBatchingSupported)) {
          dynamicBatching =
              EditorGUILayout.Toggle(SettingsContent.dynamicBatching,
                                     dynamicBatching != 0)
                  ? 1
                  : 0;
        }
    ...
    bool customLightmapEncodingSupported =
        (targetGroup == BuildTargetGroup.Standalone ||
         targetGroup == BuildTargetGroup.WebGL);
    if (settingsExtension != null) {
      hdrDisplaySupported =
          settingsExtension.SupportsHighDynamicRangeDisplays();
      gfxJobModesSupported = settingsExtension.SupportsGfxJobModes();
      customLightmapEncodingSupported =
          customLightmapEncodingSupported ||
          settingsExtension.SupportsCustomLightmapEncoding();
    } else {
      if (targetGroup == BuildTargetGroup.Standalone) {
        GraphicsDeviceType[] gfxAPIs =
            PlayerSettings.GetGraphicsAPIs(platform.defaultTarget);

        hdrDisplaySupported = gfxAPIs[0] == GraphicsDeviceType.Direct3D11 ||
                              gfxAPIs[0] == GraphicsDeviceType.Direct3D12 ||
                              gfxAPIs[0] == GraphicsDeviceType.Vulkan ||
                              gfxAPIs[0] == GraphicsDeviceType.Metal;
      }
    }

    // GPU Skinning toggle (only show on relevant platforms)
    if (!BuildTargetDiscovery.PlatformHasFlag(
            platform.defaultTarget, TargetAttributes.GPUSkinningNotSupported)) {
      GraphicsDeviceType[] gfxAPIs =
          PlayerSettings.GetGraphicsAPIs(platform.defaultTarget);
      ...
      EditorGUI.BeginChangeCheck();
      EditorGUILayout.PropertyField(
          m_SkinOnGPU, computeSkinningOnly ? SettingsContent.skinOnGPUCompute
          : SettingsContent.skinOnGPU);
      if (EditorGUI.EndChangeCheck()) {
    ...
    bool graphicsJobs =
        PlayerSettings.GetGraphicsJobsForPlatform(platform.defaultTarget);
    bool newGraphicsJobs = graphicsJobs;
    bool graphicsJobsModeOptionEnabled = graphicsJobs;

    if (targetGroup == BuildTargetGroup.XboxOne) {
      // on XBoxOne, we only have kGfxJobModeNative active for DX12 API and
      // kGfxJobModeLegacy for the DX11 API no need for a drop down popup for
      // XBoxOne also if XboxOneD3D12 is selected as GraphicsAPI, then we want
      // to set graphics jobs and disable the user option
      GraphicsDeviceType[] gfxAPIs =
          PlayerSettings.GetGraphicsAPIs(platform.defaultTarget);
      ...
      if (gfxAPIs[0] == GraphicsDeviceType.XboxOneD3D12) {
        ...
        if (graphicsJobs == false) {
          PlayerSettings.SetGraphicsJobsForPlatform(platform.defaultTarget,
                                                    true);
          graphicsJobs = true;
          newGraphicsJobs = true;
        }
      }
      PlayerSettings.SetGraphicsJobModeForPlatform(platform.defaultTarget,
                                                   newGfxJobMode);
    ...
    if (gfxJobModesSupported) {
      ...
      using(new EditorGUI.DisabledScope(!graphicsJobsModeOptionEnabled)) {
        GraphicsJobMode currGfxJobMode =
            PlayerSettings.GetGraphicsJobModeForPlatform(
                platform.defaultTarget);
        GraphicsJobMode newGfxJobMode =
            BuildEnumPopup(SettingsContent.graphicsJobsMode, currGfxJobMode,
                           m_GfxJobModeValues, m_GfxJobModeNames);
        if (EditorGUI.EndChangeCheck() && (newGfxJobMode != currGfxJobMode)) {
          Undo.RecordObject(target,
                            SettingsContent.undoChangedGraphicsJobModeString);
          PlayerSettings.SetGraphicsJobModeForPlatform(platform.defaultTarget,
                                                       newGfxJobMode);
        }
      }
    ...
    if (customLightmapEncodingSupported) {
      using(new EditorGUI.DisabledScope(EditorApplication.isPlaying ||
        ...
        EditorGUI.BeginChangeCheck();
        LightmapEncodingQuality encodingQuality =
            PlayerSettings.GetLightmapEncodingQualityForPlatformGroup(
                targetGroup);
        LightmapEncodingQuality[] lightmapEncodingValues = {
            LightmapEncodingQuality.Low, LightmapEncodingQuality.Normal,
            LightmapEncodingQuality.High};
        LightmapEncodingQuality newEncodingQuality = BuildEnumPopup(
            SettingsContent.lightmapEncodingLabel, encodingQuality,
            lightmapEncodingValues, SettingsContent.lightmapEncodingNames);
        if (EditorGUI.EndChangeCheck() &&
            encodingQuality != newEncodingQuality) {
          PlayerSettings.SetLightmapEncodingQualityForPlatformGroup(
              targetGroup, newEncodingQuality);
        ...
        if (encodingQuality != LightmapEncodingQuality.Low) {
          if (targetGroup == BuildTargetGroup.iOS) {
            ...
            var hasMinAPI = apis.Contains(GraphicsDeviceType.Metal) &&
                            !apis.Contains(GraphicsDeviceType.OpenGLES3) &&
                            !apis.Contains(GraphicsDeviceType.OpenGLES2);
            if (!hasMinAPI)
              EditorGUILayout.HelpBox(
                  SettingsContent.lightmapQualityIOSWarning.text,
                  MessageType.Warning);
            ...
            var hasMinAPI = (apis.Contains(GraphicsDeviceType.Vulkan) ||
                             apis.Contains(GraphicsDeviceType.OpenGLES3)) &&
                            !apis.Contains(GraphicsDeviceType.OpenGLES2);
            if (!hasMinAPI)
              EditorGUILayout.HelpBox(
                  SettingsContent.lightmapQualityAndroidWarning.text,
                  MessageType.Warning);
          }
        }
      }
    ...
    using(new EditorGUI.DisabledScope(EditorApplication.isPlaying ||
      ...
      bool streamingEnabled =
          PlayerSettings.GetLightmapStreamingEnabledForPlatformGroup(
              targetGroup);
      int streamingPriority =
          PlayerSettings.GetLightmapStreamingPriorityForPlatformGroup(
              targetGroup);

      EditorGUI.BeginChangeCheck();
      streamingEnabled = EditorGUILayout.Toggle(
          SettingsContent.lightmapStreamingEnabled, streamingEnabled);
      if (streamingEnabled) {
        EditorGUI.indentLevel++;
        streamingPriority = EditorGUILayout.DelayedIntField(
            SettingsContent.lightmapStreamingPriority, streamingPriority);
        EditorGUI.indentLevel--;
      }
      if (EditorGUI.EndChangeCheck()) {
        PlayerSettings.SetLightmapStreamingEnabledForPlatformGroup(
            targetGroup, streamingEnabled);
        PlayerSettings.SetLightmapStreamingPriorityForPlatformGroup(
            targetGroup, streamingPriority);
    ...
    if (targetGroup == BuildTargetGroup.Standalone ||
        ...
        (settingsExtension != null &&
         settingsExtension.SupportsFrameTimingStatistics())) {
      PlayerSettings.enableFrameTimingStats =
          EditorGUILayout.Toggle(SettingsContent.enableFrameTimingStats,
                                 PlayerSettings.enableFrameTimingStats);
    }
    ...
    if (hdrDisplaySupported) {
      ...
      string tooltip =
          "Switch the display to HDR output (on supported displays)" +
          ((targetGroup == BuildTargetGroup.XboxOne)
               ? " at start of application."
               : ".");
      bool oldUseHDRDisplay = PlayerSettings.useHDRDisplay;
      PlayerSettings.useHDRDisplay = EditorGUILayout.Toggle(
          EditorGUIUtility.TrTextContent(label, tooltip), oldUseHDRDisplay);
      ...
      if (targetGroup == BuildTargetGroup.Standalone ||
        ...
        using(new EditorGUI.DisabledScope(!PlayerSettings.useHDRDisplay)) {
          using(new EditorGUI.IndentLevelScope()) {
            ...
            D3DHDRDisplayBitDepth[] bitDepthValues = {
                D3DHDRDisplayBitDepth.D3DHDRDisplayBitDepth10,
                D3DHDRDisplayBitDepth.D3DHDRDisplayBitDepth16};
            GUIContent HDRBitDepthLabel = EditorGUIUtility.TrTextContent(
                "Swap Chain Bit Depth",
                "Affects the bit depth of the final swap chain format and color space.");
            GUIContent[] HDRBitDepthNames = {
                EditorGUIUtility.TrTextContent("Bit Depth 10"),
                EditorGUIUtility.TrTextContent("Bit Depth 16")};

            D3DHDRDisplayBitDepth bitDepth =
                BuildEnumPopup(HDRBitDepthLabel, oldBitDepth, bitDepthValues,
                               HDRBitDepthNames);
            if (EditorGUI.EndChangeCheck()) {
    ...
    using(new EditorGUI.DisabledScope(EditorApplication.isPlaying ||
      ...
      vtPropRect = EditorGUI.PrefixLabel(
          vtPropRect, 0, SettingsContent.virtualTexturingSupportEnabled);

      EditorGUI.BeginChangeCheck();
      bool selectedValue = m_VirtualTexturingSupportEnabled.boolValue;
      EditorGUI.PropertyField(vtPropRect, m_VirtualTexturingSupportEnabled,
                              GUIContent.none);
      if (EditorGUI.EndChangeCheck()) {
        bool doApply = false;
        ...
        if (dirtyScenes.Count != 0) {
          var result = EditorUtility.DisplayDialogComplex(
              "Changing Virtual Texturing support",
          ...
          doApply = EditorUtility.DisplayDialog(
              "Changing Virtual Texturing support",
              "Enabling or disabling Virtual Texturing requires a restart of the Editor.",
        ...
        if (doApply) {
          PlayerSettings.SetVirtualTexturingSupportEnabled(
              m_VirtualTexturingSupportEnabled.boolValue);
          EditorApplication.RequestCloseAndRelaunchWithCurrentArguments();
          GUIUtility.ExitGUI();
        } else {
    ...
    if (PlayerSettings.GetVirtualTexturingSupportEnabled()) {
      ...
      bool platformSupportsVT =
          UnityEngine.Rendering.VirtualTexturingEditor.Building
              .IsPlatformSupportedForPlayer(platform.defaultTarget);
      if (!platformSupportsVT) {
        EditorGUILayout.HelpBox(
            SettingsContent.virtualTexturingUnsupportedPlatformWarning.text,
            MessageType.Warning);
      }

      // Test for all three 'Automatic Graphics API for X' checkboxes and report
      // API/Platform-specific error
      if (targetGroup == BuildTargetGroup.Standalone) {
        if (VirtualTexturingInvalidGfxAPI(BuildTarget.StandaloneWindows,
                                          true) ||
            VirtualTexturingInvalidGfxAPI(BuildTarget.StandaloneWindows64,
                                          true)) {
          EditorGUILayout.HelpBox(
              SettingsContent.virtualTexturingUnsupportedAPIWin.text,
              MessageType.Warning);
        }

        if (VirtualTexturingInvalidGfxAPI(BuildTarget.StandaloneLinux64,
                                          true)) {
          EditorGUILayout.HelpBox(
              SettingsContent.virtualTexturingUnsupportedAPILinux.text,
              MessageType.Warning);
        }

        if (VirtualTexturingInvalidGfxAPI(BuildTarget.StandaloneOSX, true)) {
          EditorGUILayout.HelpBox(
              SettingsContent.virtualTexturingUnsupportedAPIMac.text,
              MessageType.Warning);
        }
      } else {
        if (platformSupportsVT &&
            VirtualTexturingInvalidGfxAPI(platform.defaultTarget, false)) {
          EditorGUILayout.HelpBox(
              SettingsContent.virtualTexturingUnsupportedAPI.text,
              MessageType.Warning);
        }
      }
    }
  ...
  private bool VirtualTexturingInvalidGfxAPI(BuildTarget target,
                                             bool checkEditor) {
    ...
    foreach (GraphicsDeviceType api in gfxTypes) {
      supportedAPI &= UnityEngine.Rendering.VirtualTexturingEditor.Building
                          .IsRenderAPISupported(api, target, checkEditor);
    }
  ...
  private void
  OtherSectionIdentificationGUI(BuildTargetGroup targetGroup,
                                ISettingEditorExtension settingsExtension) {
    // Identification

    if (settingsExtension != null && settingsExtension.HasIdentificationGUI()) {
      GUILayout.Label(SettingsContent.identificationTitle,
                      EditorStyles.boldLabel);
      settingsExtension.IdentificationSectionGUI();

      EditorGUILayout.Space();
    } else if (targetGroup == BuildTargetGroup.Standalone) {
      // TODO this should be move to an extension if we have one for MacOS or
      // Standalone target at some point.
      GUILayout.Label(SettingsContent.macAppStoreTitle, EditorStyles.boldLabel);

      PlayerSettingsEditor.ShowApplicationIdentifierUI(
          serializedObject, BuildTargetGroup.Standalone, "Bundle Identifier",
          "'CFBundleIdentifier'",
          SettingsContent.undoChangedBundleIdentifierString);
      PlayerSettingsEditor.ShowBuildNumberUI(
          serializedObject, BuildTargetGroup.Standalone, "Build",
          "'CFBundleVersion'", SettingsContent.undoChangedBuildNumberString);

      EditorGUILayout.PropertyField(m_MacAppStoreCategory,
                                    SettingsContent.macAppStoreCategory);
      EditorGUILayout.PropertyField(m_UseMacAppStoreValidation,
                                    SettingsContent.useMacAppStoreValidation);
  ...
  private void
  OtherSectionVulkanSettingsGUI(BuildTargetGroup targetGroup,
                                ISettingEditorExtension settingsExtension) {
    // Standalone targets don't have a settingsExtension but support vulkan
    if (settingsExtension != null &&
        !settingsExtension.ShouldShowVulkanSettings())
      return;

    GUILayout.Label(SettingsContent.vulkanSettingsTitle,
                    EditorStyles.boldLabel);

    PlayerSettings.vulkanEnableSetSRGBWrite =
        EditorGUILayout.Toggle(SettingsContent.vulkanEnableSetSRGBWrite,
                               PlayerSettings.vulkanEnableSetSRGBWrite);
    EditorGUILayout.PropertyField(m_VulkanNumSwapchainBuffers,
                                  SettingsContent.vulkanNumSwapchainBuffers);
    PlayerSettings.vulkanNumSwapchainBuffers =
        (UInt32) m_VulkanNumSwapchainBuffers.intValue;
    PlayerSettings.vulkanEnablePreTransform =
        EditorGUILayout.Toggle(SettingsContent.vulkanEnablePreTransform,
                               PlayerSettings.vulkanEnablePreTransform);
  ...
  ShowPlatformIconsByKind(PlatformIconFieldGroup iconFieldGroup,
                          bool foldByKind = true, bool foldBySubkind = true) {
    int labelHeight = 20;

    if (iconFieldGroup.m_IconsFields.Count == 0) {
      foreach (var kind in PlayerSettings.GetSupportedIconKindsForPlatform(
                   iconFieldGroup.targetGroup)) {
        iconFieldGroup.AddPlatformIcons(
            PlayerSettings.GetPlatformIcons(iconFieldGroup.targetGroup, kind),
            kind);
      }
    }
    foreach (var kindGroup in iconFieldGroup.m_IconsFields) {
      ...
      if (foldByKind) {
        GUIContent kindName =
            new GUIContent(string.Format("{0} icons ({1}/{2})", key.m_Label,
                                         kindGroup.Key.m_SetIconSlots,
                                         kindGroup.Key.m_IconSlotCount),
                           key.m_KindDescription);

        Rect rectKindLabel = GUILayoutUtility.GetRect(kSlotSize, labelHeight);
        rectKindLabel.x += 2;
        key.m_State = EditorGUI.Foldout(rectKindLabel, key.m_State, kindName,
      ...
      if (key.m_State) {
        ...
        foreach (var subKindGroup in kindGroup.Value) {
          subKindGroup.Key.m_SetIconSlots =
              PlayerSettings.GetNonEmptyPlatformIconCount(
                  subKindGroup.Value.Select(x => x.platformIcon).ToArray());
          kindGroup.Key.m_SetIconSlots += subKindGroup.Key.m_SetIconSlots;

          if (foldBySubkind) {
            string subKindName = string.Format(
                "{0} icons ({1}/{2})", subKindGroup.Key.m_Label,
                subKindGroup.Key.m_SetIconSlots, subKindGroup.Value.Length);
            Rect rectSubKindLabel =
                GUILayoutUtility.GetRect(kSlotSize, labelHeight);
            rectSubKindLabel.x += 8;

            subKindGroup.Key.m_State =
                EditorGUI.Foldout(rectSubKindLabel, subKindGroup.Key.m_State,
                                  subKindName, EditorStyles.foldout);
          } else
      ...
      if (EditorGUI.EndChangeCheck())
        PlayerSettings.SetPlatformIcons(
            iconFieldGroup.targetGroup, key.m_Kind,
            iconFieldGroup.m_PlatformIconsByKind[key.m_Kind]);
    }
  }

  internal static void
  ShowApplicationIdentifierUI(SerializedObject serializedObject,
                              BuildTargetGroup targetGroup, string label,
                              string tooltip, string undoText) {
    EditorGUI.BeginChangeCheck();
    string identifier = EditorGUILayout.TextField(
        EditorGUIUtility.TrTextContent(label, tooltip),
        PlayerSettings.GetApplicationIdentifier(targetGroup));
    if (EditorGUI.EndChangeCheck()) {
  ...
  internal static void ShowBuildNumberUI(SerializedObject serializedObject,
                                         BuildTargetGroup targetGroup,
                                         string label, string tooltip,
                                         string undoText) {
    EditorGUI.BeginChangeCheck();
    string buildNumber = EditorGUILayout.TextField(
        EditorGUIUtility.TrTextContent(label, tooltip),
        PlayerSettings.GetBuildNumber(targetGroup));
    if (EditorGUI.EndChangeCheck()) {
      Undo.RecordObject(serializedObject.targetObject, undoText);
  ...
  private void
  OtherSectionConfigurationGUI(BuildPlatform platform,
                               BuildTargetGroup targetGroup,
                               ISettingEditorExtension settingsExtension) {
    // Configuration
    ...
    using(new EditorGUI.DisabledScope(EditorApplication.isPlaying)) {
      // Scripting back-end
      IScriptingImplementations scripting =
          ModuleManager.GetScriptingImplementations(targetGroup);
      bool allowCompilerConfigurationSelection;

      if (scripting == null) {
        allowCompilerConfigurationSelection =
            true; // All platforms that support only one scripting backend are
                  // IL2CPP platforms
        BuildDisabledEnumPopup(SettingsContent.scriptingDefault,
                               SettingsContent.scriptingBackend);
      } else {
        var backends = scripting.Enabled();

        ScriptingImplementation currBackend =
            PlayerSettings.GetScriptingBackend(targetGroup);
        allowCompilerConfigurationSelection =
            currBackend == ScriptingImplementation.IL2CPP &&
            scripting.AllowIL2CPPCompilerConfigurationSelection();
        ScriptingImplementation newBackend;

        if (backends.Length == 1) {
          newBackend = backends[0];
          BuildDisabledEnumPopup(GetNiceScriptingBackendName(backends[0]),
                                 SettingsContent.scriptingBackend);
        } else {
          newBackend =
              BuildEnumPopup(SettingsContent.scriptingBackend, currBackend,
                             backends, GetNiceScriptingBackendNames(backends));
        }
      ...
      var currentCompatibilityLevel =
          PlayerSettings.GetApiCompatibilityLevel(targetGroup);
      var availableCompatibilityLevels =
          new ApiCompatibilityLevel[]{ApiCompatibilityLevel.NET_4_6,
                                      ApiCompatibilityLevel.NET_Standard_2_0};

      var newCompatibilityLevel = BuildEnumPopup(
          SettingsContent.apiCompatibilityLevel, currentCompatibilityLevel,
      ...
      if (currentCompatibilityLevel != newCompatibilityLevel)
        PlayerSettings.SetApiCompatibilityLevel(targetGroup,
                                                newCompatibilityLevel);

      using(new EditorGUI.DisabledScope(!allowCompilerConfigurationSelection)) {
        var currentConfiguration =
            PlayerSettings.GetIl2CppCompilerConfiguration(targetGroup);
        var configurations = GetIl2CppCompilerConfigurations();
        var configurationNames = GetIl2CppCompilerConfigurationNames();

        var newConfiguration = BuildEnumPopup(
            SettingsContent.il2cppCompilerConfiguration, currentConfiguration,
            configurations, configurationNames);

        if (currentConfiguration != newConfiguration)
          PlayerSettings.SetIl2CppCompilerConfiguration(targetGroup,
                                                        newConfiguration);
      }

      bool gcIncrementalEnabled = BuildPipeline.IsFeatureSupported(
          "ENABLE_SCRIPTING_GC_WBARRIERS", platform.defaultTarget);
      if (targetGroup == BuildTargetGroup.iOS)
      ...
      using(new EditorGUI.DisabledScope(!gcIncrementalEnabled)) {
        ...
        EditorGUILayout.PropertyField(m_GCIncremental,
                                      SettingsContent.gcIncremental);
    ...
    if (showPrivacyPermissions) {
      EditorGUILayout.PropertyField(m_CameraUsageDescription,
                                    SettingsContent.cameraUsageDescription);
      EditorGUILayout.PropertyField(m_MicrophoneUsageDescription,
                                    SettingsContent.microphoneUsageDescription);

      if (targetGroup == BuildTargetGroup.iOS ||
          targetGroup == BuildTargetGroup.tvOS)
        EditorGUILayout.PropertyField(m_LocationUsageDescription,
                                      SettingsContent.locationUsageDescription);
    }

    bool showMobileSection = targetGroup == BuildTargetGroup.iOS ||
                             targetGroup == BuildTargetGroup.tvOS ||
                             targetGroup == BuildTargetGroup.Android ||
                             targetGroup == BuildTargetGroup.WSA;
    ...
    if (showMobileSection) {
      if (targetGroup == BuildTargetGroup.iOS ||
          targetGroup == BuildTargetGroup.tvOS)
        EditorGUILayout.PropertyField(m_useOnDemandResources,
                                      SettingsContent.useOnDemandResources);
      ...
      if (supportsAccelerometerFrequency)
        EditorGUILayout.PropertyField(m_AccelerometerFrequency,
                                      SettingsContent.accelerometerFrequency);

      if (targetGroup == BuildTargetGroup.iOS ||
          targetGroup == BuildTargetGroup.tvOS ||
          targetGroup == BuildTargetGroup.Android) {
        EditorGUILayout.PropertyField(m_MuteOtherAudioSources,
                                      SettingsContent.muteOtherAudioSources);

        if (m_MuteOtherAudioSources.boolValue == false &&
            targetGroup == BuildTargetGroup.iOS)
          EditorGUILayout.HelpBox(
              SettingsContent.iOSExternalAudioInputNotSupported.text,
              MessageType.Warning);
      }
      ...
      if (targetGroup == BuildTargetGroup.iOS ||
        ...
        if (targetGroup == BuildTargetGroup.iOS) {
          EditorGUILayout.PropertyField(m_PrepareIOSForRecording,
                                        SettingsContent.prepareIOSForRecording);
          EditorGUILayout.PropertyField(
              m_ForceIOSSpeakersWhenRecording,
              SettingsContent.forceIOSSpeakersWhenRecording);
        }
        EditorGUILayout.PropertyField(m_UIRequiresPersistentWiFi,
                                      SettingsContent.UIRequiresPersistentWiFi);
        EditorGUILayout.PropertyField(m_IOSAllowHTTPDownload,
                                      SettingsContent.iOSAllowHTTPDownload);
        EditorGUILayout.PropertyField(m_IOSURLSchemes,
                                      SettingsContent.iOSURLSchemes, true);
      }
    }
    ...
    int inputOption = (!m_EnableInputSystem.boolValue)
                          ? 0
                          : m_DisableInputManager.boolValue ? 1 : 2;
    int oldInputOption = inputOption;
    EditorGUI.BeginChangeCheck();
    inputOption =
        EditorGUILayout.Popup(SettingsContent.activeInputHandling, inputOption,
                              SettingsContent.activeInputHandlingOptions);
    if (EditorGUI.EndChangeCheck()) {
      if (inputOption != oldInputOption) {
        // Give the user a chance to change mind and revert changes.
        if (ShouldRestartEditorToApplySetting()) {
          m_EnableInputSystem.boolValue =
              (inputOption == 1 || inputOption == 2);
          m_DisableInputManager.boolValue =
              !(inputOption == 0 || inputOption == 2);
          m_EnableInputSystem.serializedObject.ApplyModifiedProperties();
  ...
  private void OtherSectionScriptCompilationGUI(BuildTargetGroup targetGroup) {
    // Configuration
    GUILayout.Label(SettingsContent.scriptCompilationTitle,
                    EditorStyles.boldLabel);
    ...
    // User script defines
    {
      ...
      if (appliedScriptingDefines == null ||
          s_ScriptingDefineSymbolsList == null) {
      ...
      if (GUILayout.Button(SettingsContent.scriptingDefineSymbolsApplyRevert,
                           EditorStyles.miniButton)) {
        UpdateScriptingDefineSymbolsLists();
      }

      if (GUILayout.Button(SettingsContent.scriptingDefineSymbolsApply,
                           EditorStyles.miniButton)) {
        PlayerSettings.SetScriptingDefineSymbolsForGroup(
            targetGroup, scriptDefinesList.ToArray());

        // Get Scripting Define Symbols without duplicates
        PlayerSettings.GetScriptingDefineSymbolsForGroup(
            targetGroup, out appliedScriptingDefines);
        UpdateScriptingDefineSymbolsLists();
      }
      ...
      if (EditorGUI.EndChangeCheck()) {
        Undo.RecordObject(this.target,
                          SettingsContent.undoChangedScriptingDefineString);
      }
    }

    {
      EditorGUI.BeginChangeCheck();
      EditorGUILayout.PropertyField(m_AllowUnsafeCode,
                                    SettingsContent.allowUnsafeCode);
      if (EditorGUI.EndChangeCheck()) {
...

    {
      ...
      EditorGUILayout.PropertyField(
          m_UseDeterministicCompilation,
          SettingsContent.useDeterministicCompilation);
      if (EditorGUI.EndChangeCheck()) {
        PlayerSettings.UseDeterministicCompilation =
            m_UseDeterministicCompilation.boolValue;
      }
    }

    {
      EditorGUI.BeginChangeCheck();
      EditorGUILayout.PropertyField(m_UseReferenceAssemblies,
                                    SettingsContent.useReferenceAssembclies);
      if (EditorGUI.EndChangeCheck()) {
        PlayerSettings.useReferenceAssemblies =
            m_UseReferenceAssemblies.boolValue;
      }
    }
  }
  ...
  void DrawTextField(Rect rect, int index) {
    ...
    if (evt.type == EventType.MouseDown && rect.Contains(evt.mousePosition)) {
      if (s_ScriptingDefineSymbolsList.index != index) {
        ...
        s_ScriptingDefineSymbolsList.onSelectCallback?.Invoke(
            s_ScriptingDefineSymbolsList);
      }
    }

    string define = scriptDefinesList[index];
    scriptDefinesList[index] = GUI.TextField(rect, scriptDefinesList[index]);
    if (!scriptDefinesList [index]
             .Equals(define))
  ...
  private void OtherSectionOptimizationGUI(BuildPlatform platform,
    ...
    EditorGUILayout.PropertyField(m_BakeCollisionMeshes,
                                  SettingsContent.bakeCollisionMeshes);
    EditorGUILayout.PropertyField(m_KeepLoadedShadersAlive,
                                  SettingsContent.keepLoadedShadersAlive);
    EditorGUILayout.PropertyField(m_PreloadedAssets,
                                  SettingsContent.preloadedAssets, true);

    bool platformUsesAOT = targetGroup == BuildTargetGroup.iOS ||
                           targetGroup == BuildTargetGroup.tvOS ||
                           targetGroup == BuildTargetGroup.XboxOne ||
    ...
    bool platformSupportsStripping = !BuildTargetDiscovery.PlatformGroupHasFlag(
        targetGroup, TargetAttributes.StrippingNotSupported);

    if (platformSupportsStripping) {
      ScriptingImplementation backend =
          PlayerSettings.GetScriptingBackend(targetGroup);
      var availableStrippingLevels =
          GetAvailableManagedStrippingLevels(backend);
      ManagedStrippingLevel currentManagedStrippingLevel =
          PlayerSettings.GetManagedStrippingLevel(targetGroup);
      ManagedStrippingLevel newManagedStrippingLevel;

      if (BuildPipeline.IsFeatureSupported("ENABLE_ENGINE_CODE_STRIPPING",
                                           platform.defaultTarget) &&
          backend == ScriptingImplementation.IL2CPP) {
        EditorGUILayout.PropertyField(m_StripEngineCode,
                                      SettingsContent.stripEngineCode);
      }

      newManagedStrippingLevel = BuildEnumPopup(
          SettingsContent.managedStrippingLevel, currentManagedStrippingLevel,
          availableStrippingLevels,
          GetNiceManagedStrippingLevelNames(availableStrippingLevels));
      if (newManagedStrippingLevel != currentManagedStrippingLevel)
        PlayerSettings.SetManagedStrippingLevel(targetGroup,
                                                newManagedStrippingLevel);
    }
    ...
    if (targetGroup == BuildTargetGroup.iOS ||
      ...
      EditorGUILayout.PropertyField(
          m_IPhoneScriptCallOptimization,
          SettingsContent.iPhoneScriptCallOptimization);
    }
    if (targetGroup == BuildTargetGroup.Android) {
      EditorGUILayout.PropertyField(m_AndroidProfiler,
                                    SettingsContent.enableInternalProfiler);
    }
    ...
    VertexChannelCompressionFlags vertexFlags =
        (VertexChannelCompressionFlags) m_VertexChannelCompressionMask.intValue;
    vertexFlags =
        (VertexChannelCompressionFlags) EditorGUILayout.EnumFlagsField(
            SettingsContent.vertexChannelCompressionMask, vertexFlags);
    m_VertexChannelCompressionMask.intValue = (int) vertexFlags;

    EditorGUILayout.PropertyField(m_StripUnusedMeshComponents,
                                  SettingsContent.stripUnusedMeshComponents);
  ...
  static ManagedStrippingLevel[] mono_levels = new ManagedStrippingLevel[]{
      ManagedStrippingLevel.Disabled, ManagedStrippingLevel.Low,
      ManagedStrippingLevel.Medium, ManagedStrippingLevel.High};
  static ManagedStrippingLevel[] il2cpp_levels = new ManagedStrippingLevel[]{
      ManagedStrippingLevel.Low, ManagedStrippingLevel.Medium,
      ManagedStrippingLevel.High};
  // stripping levels vary based on scripting backend
  private ManagedStrippingLevel[] GetAvailableManagedStrippingLevels(
      ScriptingImplementation backend) {
  ...
  private GUIContent[] GetIl2CppCompilerConfigurationNames() {
    if (m_Il2cppCompilerConfigurationNames == null) {
      var configurations = GetIl2CppCompilerConfigurations();
      m_Il2cppCompilerConfigurationNames =
          new GUIContent[configurations.Length];

      for (int i = 0; i < configurations.Length; i++)
        m_Il2cppCompilerConfigurationNames[i] =
            EditorGUIUtility.TextContent(configurations [i]
                                             .ToString());
    }
  ...
  public static bool IsLatestApiCompatibility(ApiCompatibilityLevel level) {
    return (level == ApiCompatibilityLevel.NET_4_6 ||
            level == ApiCompatibilityLevel.NET_Standard_2_0);
  }
  ...
  private void OtherSectionLoggingGUI() {
    ...
    foreach (StackTraceLogType stackTraceLogType in Enum.GetValues(
                 typeof(StackTraceLogType))) {
    ...
    foreach (LogType logType in Enum.GetValues(typeof(LogType))) {
      ...
      foreach (StackTraceLogType stackTraceLogType in Enum.GetValues(
                   typeof(StackTraceLogType))) {
        StackTraceLogType inStackTraceLogType =
            PlayerSettings.GetStackTraceLogType(logType);
        EditorGUI.BeginChangeCheck();
        bool val = EditorGUILayout.ToggleLeft(
            " ", inStackTraceLogType == stackTraceLogType, GUILayout.Width(70));
  ...
  private void OtherSectionLegacyGUI(BuildTargetGroup targetGroup) {
    ...
    EditorGUILayout.PropertyField(m_LegacyClampBlendShapeWeights,
                                  SettingsContent.legacyClampBlendShapeWeights);

    // ARCore - legacy way to enable
    if (BuildTargetDiscovery.PlatformGroupHasVRFlag(
            targetGroup, BuildTargetDiscovery.VRAttributes.SupportTango)) {
      EditorGUILayout.Space();
      GUILayout.Label(SettingsContent.legacyXRTitle, EditorStyles.boldLabel);
      EditorGUILayout.PropertyField(
          m_AndroidEnableTango,
          EditorGUIUtility.TrTextContent("ARCore Supported"));
    }

    EditorGUILayout.Space();
  }

  private static Dictionary<ApiCompatibilityLevel, GUIContent>
      m_NiceApiCompatibilityLevelNames;
  private static Dictionary<ManagedStrippingLevel, GUIContent>
      m_NiceManagedStrippingLevelNames;

  private static GUIContent[] GetGUIContentsForValues<T>(
      Dictionary<T, GUIContent> contents, T[] values) {
    ...
    for (int i = 0; i < values.Length; i++) {
      if (contents.ContainsKey(values[i]))
        ...
        throw new NotImplementedException(
            string.Format("Missing name for {0}", values[i]));
    }
    return names;
  }

  static GUIContent[] GetNiceScriptingBackendNames(
      ScriptingImplementation[] scriptingBackends) {
    return scriptingBackends.Select(s => GetNiceScriptingBackendName(s))
        .ToArray();
  }

  static GUIContent
  GetNiceScriptingBackendName(ScriptingImplementation scriptingBackend) {
  ...
  private static GUIContent[] GetNiceApiCompatibilityLevelNames(
    ...
    if (m_NiceApiCompatibilityLevelNames == null) {
      m_NiceApiCompatibilityLevelNames =
          new Dictionary<ApiCompatibilityLevel, GUIContent>{
    ...
    return GetGUIContentsForValues(m_NiceApiCompatibilityLevelNames,
                                   apiCompatibilityLevels);
  }

  private static GUIContent[] GetNiceManagedStrippingLevelNames(
      ManagedStrippingLevel[] managedStrippingLevels) {
    if (m_NiceManagedStrippingLevelNames == null) {
      m_NiceManagedStrippingLevelNames =
          new Dictionary<ManagedStrippingLevel, GUIContent>{
              {ManagedStrippingLevel.Disabled,
               SettingsContent.strippingDisabled},
    ...
    return GetGUIContentsForValues(m_NiceManagedStrippingLevelNames,
                                   managedStrippingLevels);
  }

  public void BrowseablePathProperty(string propertyLabel,
                                     SerializedProperty property,
                                     string browsePanelTitle, string extension,
                                     string dir) {
    EditorGUILayout.BeginHorizontal();
    ...
    if (GUILayout.Button(browseBtnLabel, EditorStyles.miniButton,
                         GUILayout.MaxWidth(sizeOfLabel.x))) {
      GUI.FocusControl("");
      ...
      if (string.IsNullOrEmpty(extension))
        newStringValue =
            EditorUtility.OpenFolderPanel(title, currDirectory, "");
      else
        newStringValue =
            EditorUtility.OpenFilePanel(title, currDirectory, extension);
    ...
    using(new EditorGUI.DisabledScope(emptyString)) {
      ...
      EditorGUI.BeginChangeCheck();
      GUILayoutOption[] options = {GUILayout.Width(32),
  ...
  internal static bool BuildPathBoxButton(SerializedProperty prop,
                                          string uiString, string directory) {
  ...
  internal static bool BuildPathBoxButton(SerializedProperty prop,
                                          ...
                                          Action onSelect) {
    float h = EditorGUI.kSingleLineHeight;
    float kLabelFloatMinW =
        EditorGUI.kLabelW + EditorGUIUtility.fieldWidth + EditorGUI.kSpacing;
    float kLabelFloatMaxW =
        EditorGUI.kLabelW + EditorGUIUtility.fieldWidth + EditorGUI.kSpacing;
    Rect r = GUILayoutUtility.GetRect(kLabelFloatMinW, kLabelFloatMaxW, h, h,
                                      EditorStyles.layerMaskField, null);

    float labelWidth = EditorGUIUtility.labelWidth;
    Rect buttonRect = new Rect(r.x + EditorGUI.indent, r.y,
                               labelWidth - EditorGUI.indent, r.height);
    Rect fieldRect =
        new Rect(r.x + labelWidth, r.y, r.width - labelWidth, r.height);

    string display =
        (prop.stringValue.Length == 0) ? "Not selected." : prop.stringValue;
    ...
    if (GUI.Button(buttonRect, EditorGUIUtility.TextContent(uiString))) {
      ...
      string path = EditorUtility.OpenFolderPanel(
          EditorGUIUtility.TextContent(uiString).text, directory, "");
  ...
  internal static bool BuildFileBoxButton(SerializedProperty prop,
                                          string uiString, string directory,
                                          string ext) {
  ...
  internal static bool BuildFileBoxButton(SerializedProperty prop,
    ...
    if (GUI.Button(buttonRect, EditorGUIUtility.TextContent(uiString))) {
      ...
      string path = EditorUtility.OpenFilePanel(
          EditorGUIUtility.TextContent(uiString).text, directory, ext);
  ...
  public void PublishSectionGUI(BuildTargetGroup targetGroup,
                                ISettingEditorExtension settingsExtension,
                                int sectionIndex = 5) {
    ...
    if (BeginSettingsBox(sectionIndex,
                         SettingsContent.publishingSettingsTitle)) {
      float h = EditorGUI.kSingleLineHeight;
      float kLabelFloatMinW =
          EditorGUI.kLabelW + EditorGUIUtility.fieldWidth + EditorGUI.kSpacing;
      float kLabelFloatMaxW =
      ...
      if (settingsExtension != null) {
        settingsExtension.PublishSectionGUI(h, kLabelFloatMinW,
                                            kLabelFloatMaxW);
      }
    }
    EndSettingsBox();
  ...
  internal static SettingsProvider CreateProjectSettingsProvider() {
    var provider = AssetSettingsProvider.CreateProviderFromAssetPath(
        ...
        SettingsProvider
            .GetSearchKeywordsFromGUIContentProperties<SettingsContent>());
    provider.activateHandler = (searchContext, rootElement) => {
      var playerSettingsProvider =
          provider.settingsEditor as PlayerSettingsEditor;
      if (playerSettingsProvider != null) {
        playerSettingsProvider.SetValueChangeListeners(provider.Repaint);
        playerSettingsProvider.splashScreenEditor.SetValueChangeListeners(
            provider.Repaint);
      }
    };
    return provider;
  ...
  void InitReorderableScriptingDefineSymbolsList(BuildTargetGroup targetGroup) {
    ...
    s_ScriptingDefineSymbolsList = new ReorderableList(
        scriptDefinesList, typeof(string), true, true, true, true);
    s_ScriptingDefineSymbolsList.drawElementCallback =
        (rect, index, isActive, isFocused) => DrawTextField(rect, index);
    s_ScriptingDefineSymbolsList.drawHeaderCallback = (rect) => GUI.Label(
        rect, SettingsContent.scriptingDefineSymbols, EditorStyles.label);
    s_ScriptingDefineSymbolsList.onAddCallback = AddScriptingDefineCallback;
    s_ScriptingDefineSymbolsList.onRemoveCallback =
        RemoveScriptingDefineCallback;
    s_ScriptingDefineSymbolsList.onChangedCallback +=
        SetScriptingDefinesListDirty;
  }
