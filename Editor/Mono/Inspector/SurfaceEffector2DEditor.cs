...
internal class SurfaceEffector2DEditor : Effector2DEditor {
  ...
  public override void OnInspectorGUI() {
    ...
    // Force.
    m_ShowForceRollout.target =
        EditorGUILayout.Foldout(m_ShowForceRollout.target, "Force", true);
    ...
    // Options.
    m_ShowOptionsRollout.target =
        EditorGUILayout.Foldout(m_ShowOptionsRollout.target, "Options", true);
