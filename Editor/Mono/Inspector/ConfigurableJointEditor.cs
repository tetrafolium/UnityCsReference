...
protected override void GetActors(ConfigurableJoint joint,
...
protected override void DoAngularLimitHandles(ConfigurableJoint joint) {
	...
	if (EditorGUI.EndChangeCheck()) {
		...
		limit = joint.angularYLimit;
		limit.limit =
			angularLimitHandle.yMax ==
			limit.limit ? -angularLimitHandle.yMin : angularLimitHandle.yMax;
		joint.angularYLimit = limit;

		limit = joint.angularZLimit;
		limit.limit =
			angularLimitHandle.zMax ==
			limit.limit ? -angularLimitHandle.zMin : angularLimitHandle.zMax;
