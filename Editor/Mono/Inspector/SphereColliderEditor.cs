...
CopyColliderPropertiesToHandle(SphereCollider collider) {
...
protected override void
CopyHandlePropertiesToCollider(SphereCollider collider) {
	...
	collider.radius = Mathf.Approximately(scaleFactor, 0f)
	                  ? 0f
	                  : m_BoundsHandle.radius / scaleFactor;
}
