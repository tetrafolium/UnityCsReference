...
internal class RigidbodyEditor : Editor {
  ...
  static GUIContent m_FreezePositionLabel =
      EditorGUIUtility.TrTextContent("Freeze Position");
  static GUIContent m_FreezeRotationLabel =
  ...
  void ConstraintToggle(Rect r, string label, RigidbodyConstraints value,
                        int bit) {
  ...
  void ToggleBlock(RigidbodyConstraints constraints, GUIContent label, int x,
                   int y, int z) {
  ...
  public override void OnInspectorGUI() {
    ...
    m_Constraints.isExpanded = EditorGUI.Foldout(
        position, m_Constraints.isExpanded, m_Constraints.displayName, true);
    EditorGUI.EndProperty();

    serializedObject.Update();
    RigidbodyConstraints constraints =
        (RigidbodyConstraints) m_Constraints.intValue;
  ...
  private void ShowBodyInfoProperties() {
    ...
    m_ShowInfoFoldout.value = m_ShowInfo.target =
        EditorGUI.Foldout(position, m_ShowInfo.target, "Info", true);
