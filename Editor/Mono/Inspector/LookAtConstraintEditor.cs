...
GUIContent m_Roll = EditorGUIUtility.TrTextContent(
	"Roll", "Specifies the roll angle in degrees.");
GUIContent m_UseUpObject = EditorGUIUtility.TrTextContent(
	"Use Up Object",
	"Specifies how the world up vector should be computed. Either use the World Up Object or the Roll value");
...
public GUIContent Roll {
	get { return m_Roll; }
}
public GUIContent UseUpObject {
	get { return m_UseUpObject; }
}
}
