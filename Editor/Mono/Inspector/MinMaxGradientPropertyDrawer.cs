...
public readonly GUIContent[] modes =
	new[] {EditorGUIUtility.TrTextContent("Color"),
...
public override float GetPropertyHeight(SerializedProperty property,
                                        GUIContent label) {
	Init(property);
	return m_Property.mode.intValue ==
	       (int) MinMaxGradientState.k_RandomBetweenTwoGradients ? EditorGUI
	       .kSingleLineHeight *
	       2.0f : EditorGUI.kSingleLineHeight;
}

static void DrawTwoPropertyFields(Rect rect, GUIContent label,
                                  SerializedProperty prop1,
                                  SerializedProperty prop2, bool singleLine) {
...
public override void OnGUI(Rect position, SerializedProperty property,
	...
	int newSelection =
		EditorGUI.Popup(modeRect, GUIContent.none, m_Property.mode.intValue,
	...
	case MinMaxGradientState.k_RandomBetweenTwoColors:
		DrawTwoPropertyFields(fieldRect, label, m_Property.colorMin,
		                      m_Property.colorMax, true);
		break;
	case MinMaxGradientState.k_RandomBetweenTwoGradients:
		DrawTwoPropertyFields(fieldRect, label, m_Property.gradientMin,
		                      m_Property.gradientMax, false);
		break;
	}
}
}
