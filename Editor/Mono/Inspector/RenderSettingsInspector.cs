...
internal class RenderSettingsInspector : Editor {
  ...
  Editor lightingEditor {
    get {
      return m_LightingEditor ??(m_LightingEditor = Editor.CreateEditor(
                                    target, typeof(LightingEditor)));
    }
  }
  ...
  Editor fogEditor {
    get {
      return m_FogEditor ??(m_FogEditor =
                               Editor.CreateEditor(target, typeof(FogEditor)));
    }
  }
  ...
  Editor otherRenderingEditor {
    get {
      return m_OtherRenderingEditor ??(
          m_OtherRenderingEditor =
              Editor.CreateEditor(target, typeof(OtherRenderingEditor)));
    }
  }
