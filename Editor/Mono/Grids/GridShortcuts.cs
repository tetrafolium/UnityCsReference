...
namespace UnityEditor.Snap {
  static class Shortcuts {
    ...
    [Shortcut("Grid/Increase Grid Size", typeof(SceneView),
    ...
    [Shortcut("Grid/Decrease Grid Size", typeof(SceneView), KeyCode.LeftBracket,
    ...
    [Shortcut("Grid/Nudge Grid Backward", typeof(SceneView),
              KeyCode.LeftBracket, ShortcutModifiers.Shift)]
    ...
    [Shortcut("Grid/Nudge Grid Forward", typeof(SceneView),
              KeyCode.RightBracket, ShortcutModifiers.Shift)]
    ...
    [Shortcut("Grid/Push To Grid", typeof(SceneView), KeyCode.Backslash,
              ShortcutModifiers.Action)]
