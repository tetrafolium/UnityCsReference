...
class EditorSnapSettingsData : ScriptableSingleton<EditorSnapSettingsData>
{
    ...
    {
        get {
            return m_SnapSettings;
        }
        set {
            m_SnapSettings = value;
        }
    }
...
public static class EditorSnapSettings
{
    ...
    {
        get {
            return EditorSnapSettingsData.instance;
        }
    }
    ...
    {
        get {
            return !incrementalSnapActive && activeToolSupportsGridSnap && instance.snapEnabled;
        }
    }
    ...
    {
        get {
            return instance.snapSettings.snapValue;
        }
        set {
    ...
    {
        get {
            return instance.snapSettings.rotation;
        }
        set {
    ...
    {
        get {
            return instance.snapSettings.scale;
        }
        set {
    ...
    {
        get {
            return instance.snapSettings.snapMultiplier;
        }
        set {
            instance.snapSettings.snapMultiplier = value;
        }
    }
