...
internal class SceneHierarchyWindow : SearchableEditorWindow, IHasCustomMenu, IPropertySourceOpener
{
    ...
    public SceneHierarchy sceneHierarchy {
        get {
            return m_SceneHierarchy;
        }
    }

    bool showingStageHeader {
        get {
            return !(StageNavigationManager.instance.currentStage is MainStage);
        }
    }
    ...
    {
        get {
            return new Rect(0, EditorGUI.kWindowToolbarHeight, position.width, Styles.kStageHeaderHeight);
        }
    }
