...
/// <summary>
/// Helper so we can call some tuple methods recursively without knowing the
/// underlying types.
/// </summary>
...
public static Tuple<T1, T2, T3> Create<T1, T2, T3>(T1 item1, T2 item2,
                                                   T3 item3) {
...
Create<T1, T2, T3, T4, T5, T6>(T1 item1, T2 item2, T3 item3, T4 item4,
                               T5 item5, T6 item6) {
	return new Tuple<T1, T2, T3, T4, T5, T6>(item1, item2, item3, item4, item5,
	                                         item6);
}

public static Tuple<T1, T2, T3, T4, T5, T6, T7>
Create<T1, T2, T3, T4, T5, T6, T7>(T1 item1, T2 item2, T3 item3, T4 item4,
                                   T5 item5, T6 item6, T7 item7) {
	return new Tuple<T1, T2, T3, T4, T5, T6, T7>(item1, item2, item3, item4,
	                                             item5, item6, item7);
}

public static Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8> >
Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1 item1, T2 item2, T3 item3, T4 item4,
                                       T5 item5, T6 item6, T7 item7,
                                       T8 item8) {
...
public override Boolean Equals(Object obj) {
	return ((IStructuralEquatable) this)
	       .Equals(obj, EqualityComparer<Object>.Default);
}
...
Int32 IComparable.CompareTo(Object obj) {
	return ((IStructuralComparable) this)
	       .CompareTo(obj, Comparer<Object>.Default);
}
...
public override int GetHashCode() {
	return ((IStructuralEquatable) this)
	       .GetHashCode(EqualityComparer<Object>.Default);
}
...
Int32 IStructuralEquatable.GetHashCode(IEqualityComparer comparer) {
	return Tuple.CombineHashCodes(
		comparer.GetHashCode(m_Item1), comparer.GetHashCode(m_Item2),
		comparer.GetHashCode(m_Item3), comparer.GetHashCode(m_Item4));
}
...
[Serializable]
internal class Tuple<T1, T2, T3, T4, T5, T6>
	: IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal {
private readonly T1 m_Item1;
private readonly T2 m_Item2;
private readonly T3 m_Item3;
...
Boolean IStructuralEquatable.Equals(Object other,
	...
	Tuple<T1, T2, T3, T4, T5, T6> objTuple =
		other as Tuple<T1, T2, T3, T4, T5, T6>;
...
Int32 IStructuralEquatable.GetHashCode(IEqualityComparer comparer) {
	return Tuple.CombineHashCodes(
		comparer.GetHashCode(m_Item1), comparer.GetHashCode(m_Item2),
		comparer.GetHashCode(m_Item3), comparer.GetHashCode(m_Item4),
		comparer.GetHashCode(m_Item5), comparer.GetHashCode(m_Item6));
}
...
[Serializable]
internal class Tuple<T1, T2, T3, T4, T5, T6, T7>
	: IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal {
private readonly T1 m_Item1;
private readonly T2 m_Item2;
private readonly T3 m_Item3;
...
Boolean IStructuralEquatable.Equals(Object other,
	...
	Tuple<T1, T2, T3, T4, T5, T6, T7> objTuple =
		other as Tuple<T1, T2, T3, T4, T5, T6, T7>;
...
[Serializable]
internal class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest>
	: IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal {
private readonly T1 m_Item1;
private readonly T2 m_Item2;
private readonly T3 m_Item3;
...
Boolean IStructuralEquatable.Equals(Object other,
	...
	Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> objTuple =
	...
	return comparer.Equals(m_Item1, objTuple.m_Item1) &&
	       ...
	       comparer.Equals(m_Item6, objTuple.m_Item6) &&
	       comparer.Equals(m_Item7, objTuple.m_Item7) &&
	       comparer.Equals(m_Rest, objTuple.m_Rest);
}
...
Int32 IStructuralEquatable.GetHashCode(IEqualityComparer comparer) {
	// We want to have a limited hash in this case.  We'll use the last 8
	...
	// In this case, the rest member has less than 8 elements so we need to
	// combine some our elements with the elements in rest
	int k = 8 - t.Length;
	switch (k) {
	case 1:
		return Tuple.CombineHashCodes(comparer.GetHashCode(m_Item7),
		                              t.GetHashCode(comparer));
	case 2:
		return Tuple.CombineHashCodes(comparer.GetHashCode(m_Item6),
		                              comparer.GetHashCode(m_Item7),
		                              t.GetHashCode(comparer));
	case 3:
		return Tuple.CombineHashCodes(
	...
	case 4:
		return Tuple.CombineHashCodes(
			...
			comparer.GetHashCode(m_Item6), comparer.GetHashCode(m_Item7),
			t.GetHashCode(comparer));
	case 5:
		return Tuple.CombineHashCodes(
			comparer.GetHashCode(m_Item3), comparer.GetHashCode(m_Item4),
