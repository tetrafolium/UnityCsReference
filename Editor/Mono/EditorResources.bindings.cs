...
[NativeHeader("Editor/Src/EditorResources.h"),
 StaticAccessor(
	 "EditorResources",
	 StaticAccessorType.DoubleColon)] partial class EditorResources {
[NativeProperty("k_NormalSkinIndex", true, TargetType.Field)]
public static extern int normalSkinIndex {
	get;
}
[NativeProperty("k_DarkSkinIndex", true, TargetType.Field)]
public static extern int darkSkinIndex {
	get;
}
...
[NativeProperty("k_OpenedFolderIconName", true, TargetType.Field)]
internal static extern string openedFolderIconName {
	get;
}
[NativeProperty("k_EditorDefaultResourcesPath", true, TargetType.Field)]
public static extern string editorDefaultResourcesPath {
	get;
}
[NativeProperty("k_LibraryBundlePath", true, TargetType.Field)]
public static extern string libraryBundlePath {
	get;
}
...
[Obsolete(
	 "EditorResourcesUtility is obsolete, please use EditorResources instead.",
	 false)]
