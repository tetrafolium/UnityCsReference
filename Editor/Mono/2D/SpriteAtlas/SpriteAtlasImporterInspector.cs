...
internal class SpriteAtlasImporterInspector : Editor
{
    ...
    private SpriteAtlasAsset spriteAtlasAsset {
        get {
            return m_TargetAsset as SpriteAtlasAsset;
        }
    }
    private SpriteAtlasImporter spriteAtlasImporter {
        get {
            return target as SpriteAtlasImporter;
        }
    }
    ...
    private bool secondaryTextureSelected {
        get {
            return m_SelectedPlatformSettings >= 2 && m_SelectedPlatformSettings <= m_PlatformSettingsOptions.Count - 3;
        }
    }
