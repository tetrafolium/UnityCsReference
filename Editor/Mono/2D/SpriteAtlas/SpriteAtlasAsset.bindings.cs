...
extern public TextureImporterPlatformSettings
GetPlatformSettings(string buildTarget);
...
extern internal TextureImporterPlatformSettings
GetSecondaryPlatformSettings(string buildTarget, string secondaryTextureName);
extern internal void
SetSecondaryPlatformSettings(TextureImporterPlatformSettings src,
                             string secondaryTextureName);
extern internal bool GetSecondaryColorSpace(string secondaryTextureName);
extern internal void SetSecondaryColorSpace(string secondaryTextureName,
                                            bool srGB);
extern internal void
DeleteSecondaryPlatformSettings(string secondaryTextureName);
}
}
;
