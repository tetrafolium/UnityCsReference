...
public AnimatorLayerBlendingMode blendingMode {
	...
	set { m_BlendingMode = value; }
}
public int syncedLayerIndex {
	get { return m_SyncedLayerIndex; }
	set { m_SyncedLayerIndex = value; }
}
public bool iKPass {
	get { return m_IKPass; }
	set { m_IKPass = value; }
...
public float defaultWeight {
	get { return m_DefaultWeight; }
	set { m_DefaultWeight = value; }
}
public bool syncedLayerAffectsTiming {
	get { return m_SyncedLayerAffectsTiming; }
	set { m_SyncedLayerAffectsTiming = value; }
}
...
public void SetOverrideBehaviours(AnimatorState state,
