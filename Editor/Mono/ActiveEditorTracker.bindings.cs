...
// This is a strain for the garbage collector (Small memory for GC, big overhead
// for engine) Might want to add a manual dispose
...
#pragma warning restore
  ...
  public ActiveEditorTracker() { Internal_Create(this); }
  ...
  public Editor[] activeEditors {
    get { return (Editor[]) Internal_GetActiveEditors(this); }
  }

  [FreeFunction]
  internal static extern void
  Internal_GetActiveEditorsNonAlloc(ActiveEditorTracker self, Editor[] editors);
  ...
  [FreeFunction]
  static extern void Internal_GetObjectsLockedByThisTrackerInternal(
      ActiveEditorTracker self, [ NotNull ] object lockedObjects);
  ...
  [FreeFunction]
  static extern void
  Internal_SetObjectsLockedByThisTrackerInternal(ActiveEditorTracker self,
                                                 object toBeLocked);
  ...
  [FreeFunction]
  static extern void Internal_SetVisible(ActiveEditorTracker self, int index,
                                         int visible);
  ...
  public bool isDirty {
    get { return Internal_GetIsDirty(this); }
  }
  ...
  // Enable or disable the ActiveEditorTracker rebuilding from
  // ISceneInspector.DidFlushDirty calls.
  ...
  [FreeFunction]
  static extern InspectorMode
  Internal_GetInspectorMode(ActiveEditorTracker self);
  [FreeFunction]
  static extern void Internal_SetInspectorMode(ActiveEditorTracker self,
                                               InspectorMode value);
  ...
  [FreeFunction]
  static extern bool
  Internal_GetHasComponentsWhichCannotBeMultiEdited(ActiveEditorTracker self);
  ...
  internal static void RebuildAllIfNecessary() {
    Internal_RebuildAllIfNecessary();
  }
  ...
  [FreeFunction]
  static extern void
  Internal_VerifyModifiedMonoBehaviours(ActiveEditorTracker self);
