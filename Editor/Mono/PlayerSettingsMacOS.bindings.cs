...
[NativeProperty("MacAppStoreCategory")] extern internal static string
applicationCategoryType {
	get;
	set;
}

// these two are internal because we are not yet sure if we want to have
// them back in general PlayerSettings as we have several platforms that
