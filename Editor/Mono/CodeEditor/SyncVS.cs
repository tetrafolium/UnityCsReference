...
partial class SyncVS {
  public static void SyncSolution() {
    ...
    // TODO: Rider and possibly other code editors, use reflection to call this
    // method. To avoid conflicts and null reference exception, this is left as
    // a dummy method.
...
public static class SolutionGuidGenerator {
  ...
  private static string HashAsGuid(string hash) {
    var guid = hash.Substring(0, 8) + "-" + hash.Substring(8, 4) + "-" +
               hash.Substring(12, 4) + "-" + hash.Substring(16, 4) + "-" +
