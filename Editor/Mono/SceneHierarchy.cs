...
internal class SceneHierarchy
{
    ...
    {
        get {
            return customScenes != null && customScenes.Length > 0;
        }
    }
    ...
    {
        get {
            return SessionState.GetBool("PrefabStageDebug", false);
        }
        set {
            SessionState.SetBool("PrefabStageDebug", value);
        }
    }
    ...
    {
        get {
            return SessionState.GetBool("ExpandedStateDebug", false);
        }
        set {
            SessionState.SetBool("ExpandedStateDebug", value);
        }
    }
    ...
    public bool hasSortMethods {
        get {
            return m_SortingObjects != null && m_SortingObjects.Count > 1;
        }
    }

    public int treeViewKeyboardControlID {
        get {
            return m_TreeViewKeyboardControlID;
        }
    }
    ...
    GameObjectTreeViewDataSource dataSource {
        get {
            return (GameObjectTreeViewDataSource)treeView.data;
        }
    }
