...
[Shortcut("Edit/CopyInsert", KeyCode.Insert, ShortcutModifiers.Action,
          displayName = "Copy Insert Selection")]
internal static void CopyInsertSelection() {
	InternalEditorUtility.ExecuteCommandOnKeyWindow(EventCommandNames.Copy);
}

[Shortcut("Edit/PasteInsert", KeyCode.Insert, ShortcutModifiers.Shift,
          displayName = "Paste Insert Selection")]
