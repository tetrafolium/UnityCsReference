...
// Intentionally internal. Extra argument only used to make doc authoring
// easier.
[FreeFunction]
internal static extern bool HasHelpForObject(Object obj,
                                             bool defaultToMonoBehaviour);
...
GetNiceHelpNameForObject(Object obj, bool defaultToMonoBehaviour);
...
[FreeFunction]
private static extern string GetHelpURLForObject(Object obj,
                                                 bool defaultToMonoBehaviour);
...
internal static string GetDispatchedHelpURL(Object obj, string fieldName) {
	System.Reflection.FieldInfo field = obj.GetType().GetField(
		fieldName, System.Reflection.BindingFlags.Public |
	...
	object[] attrs =
		value.GetType().GetCustomAttributes(typeof(HelpURLAttribute), true);
