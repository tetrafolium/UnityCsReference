...
public struct AssetMoveInfo : IEquatable<AssetMoveInfo> {
	...
	public bool Equals(AssetMoveInfo other) {
		return string.Equals(sourceAssetPath, other.sourceAssetPath) &&
		       string.Equals(destinationAssetPath, other.destinationAssetPath);
	}
	...
	public override int GetHashCode() {
		unchecked {
			return ((sourceAssetPath != null ? sourceAssetPath.GetHashCode() : 0) *
			        397) ^
			       (destinationAssetPath !=
			        null ? destinationAssetPath.GetHashCode() : 0);
		}
	}
