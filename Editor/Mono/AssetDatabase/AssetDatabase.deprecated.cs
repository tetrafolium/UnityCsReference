...
partial class AssetDatabase {
  ...
  [Obsolete(
      "GetTextMetaDataPathFromAssetPath has been renamed to GetTextMetaFilePathFromAssetPath (UnityUpgradable) -> GetTextMetaFilePathFromAssetPath(*)")]
...
[Obsolete(
    "AssetStatus enum is not used anymore (Asset Server has been removed)")]
...
// Used to be part of Asset Server, and public API for some reason.
[Obsolete(
    "AssetsItem class is not used anymore (Asset Server has been removed)")]
