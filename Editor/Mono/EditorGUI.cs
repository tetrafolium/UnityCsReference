...
#pragma warning restore 612
    ...
    {
        get {
            return GetPreviewMaterial(ref s_ColorMaterial, "Previews/PreviewColor2D.shader");
        }
    }
    internal static Material colorVTMaterial
    {
        get {
            return GetPreviewMaterial(ref s_ColorVTMaterial, "Previews/PreviewColor2DVT.shader");
        }
    }
    internal static Material alphaMaterial
    {
        get {
            return GetPreviewMaterial(ref s_AlphaMaterial, "Previews/PreviewAlpha.shader");
        }
    }
    internal static Material alphaVTMaterial
    {
        get {
            return GetPreviewMaterial(ref s_AlphaVTMaterial, "Previews/PreviewAlphaVT.shader");
        }
    }
    internal static Material transparentMaterial
    {
        get {
            return GetPreviewMaterial(ref s_TransparentMaterial, "Previews/PreviewTransparent.shader");
        }
    }
    internal static Material transparentVTMaterial
    {
        get {
            return GetPreviewMaterial(ref s_TransparentVTMaterial, "Previews/PreviewTransparentVT.shader");
        }
    }
    internal static Material normalmapMaterial
    {
        get {
            return GetPreviewMaterial(ref s_NormalmapMaterial, "Previews/PreviewEncodedNormals.shader");
        }
    }
    internal static Material normalmapVTMaterial
    {
        get {
            return GetPreviewMaterial(ref s_NormalmapVTMaterial, "Previews/PreviewEncodedNormalsVT.shader");
        }
    }
    internal static Material lightmapRGBMMaterial
    {
        get {
            return GetPreviewMaterial(ref s_LightmapRGBMMaterial, "Previews/PreviewEncodedLightmapRGBM.shader");
        }
    }
    internal static Material lightmapDoubleLDRMaterial
    {
        get {
            return GetPreviewMaterial(ref s_LightmapDoubleLDRMaterial, "Previews/PreviewEncodedLightmapDoubleLDR.shader");
        }
    }
    internal static Material lightmapFullHDRMaterial
    {
        get {
            return GetPreviewMaterial(ref s_LightmapFullHDRMaterial, "Previews/PreviewEncodedLightmapFullHDR.shader");
        }
    }
    internal static Material guiTextureClipVerticallyMaterial
    {
        get {
            return GetPreviewMaterial(ref s_GUITextureClipVertically, "Inspectors/Internal-GUITextureClipVertically.shader");
        }
    }
