...
internal static class AssetPreviewUpdater {
  ...
  public static Texture2D CreatePreviewForAsset(Object obj, Object[] subAssets,
                                                string assetPath) {
    if (obj == null)
      return null;
    ...
    //  string previewFilePath = string.Format ("{0}/../SavedPreview{1}.png",
    //  Application.dataPath, (int)(EditorApplication.timeSinceStartup*1000));
