...
using NativeArrayUnsafeUtility =
...
internal struct LightmapConvergence {
	public bool IsConverged() {
		return convergedDirectTexelCount == occupiedTexelCount &&
		       convergedGITexelCount == occupiedTexelCount;
	}
	public bool IsValid() {
		return -1 != visibleConvergedDirectTexelCount;
	}

	[NativeName("m_CullingHash")]
	public Hash128 cullingHash;
	[NativeName("m_VisibleConvergedDirectTexelCount")]
	public int visibleConvergedDirectTexelCount;
	[NativeName("m_VisibleConvergedGITexelCount")]
	public int visibleConvergedGITexelCount;
	[NativeName("m_VisibleConvergedEnvTexelCount")]
	public int visibleConvergedEnvTexelCount;
	[NativeName("m_VisibleTexelCount")]
	public int visibleTexelCount;

	[NativeName("m_ConvergedDirectTexelCount")]
	public int convergedDirectTexelCount;
	[NativeName("m_ConvergedGITexelCount")]
	public int convergedGITexelCount;
	[NativeName("m_ConvergedEnvTexelCount")]
	public int convergedEnvTexelCount;
	[NativeName("m_OccupiedTexelCount")]
	public int occupiedTexelCount;

	[NativeName("m_MinDirectSamples")]
	public int minDirectSamples;
	[NativeName("m_MinGISamples")]
	public int minGISamples;
	[NativeName("m_MinEnvSamples")]
	public int minEnvSamples;
	[NativeName("m_MaxDirectSamples")]
	public int maxDirectSamples;
	[NativeName("m_MaxGISamples")]
	public int maxGISamples;
	[NativeName("m_MaxEnvSamples")]
	public int maxEnvSamples;
	[NativeName("m_AvgDirectSamples")]
	public int avgDirectSamples;
	[NativeName("m_AvgGISamples")]
	public int avgGISamples;
	[NativeName("m_AvgEnvSamples")]
	public int avgEnvSamples;

	[NativeName("m_ForceStop")]
	public bool avgGIForceStop;

	[NativeName("m_Progress")]
...
internal struct LightProbesConvergence {
	public bool IsConverged() {
		return probeSetCount == convergedProbeSetCount;
	}
	public bool IsValid() {
		return -1 != probeSetCount;
	}

	[NativeName("m_ProbeSetCount")]
	public int probeSetCount;
	[NativeName("m_ConvergedProbeSetCount")]
	public int convergedProbeSetCount;
}
...
internal struct LightmapMemory {
	...
	public float lightmapDataSizeCPU;
	[NativeName("m_LightmapTexturesSize")]
	public float lightmapTexturesSize;
	[NativeName("m_LightmapDataSizeGPU")]
...
public enum GIWorkflowMode {
	...
	// Data is only precomputed for dynamic and static GI when the bake button
	// is pressed.
	OnDemand = 1,
...
//        [Obsolete("Lightmapping.giWorkflowMode is obsolete, use
//        Lightmapping.lightingSettings.autoGenerate instead. ", false)]
public static GIWorkflowMode giWorkflowMode {
	get {
		return GetLightingSettingsOrDefaultsFallback()
		       .autoGenerate ? GIWorkflowMode.Iterative : GIWorkflowMode.OnDemand;
	}
	set {
		GetOrCreateLightingsSettings().autoGenerate =
			(value == GIWorkflowMode.Iterative);
	}
}

//        [Obsolete("Lightmapping.realtimeGI is obsolete, use
//        Lightmapping.lightingSettings.realtimeGI instead. ", false)]
...
//        [Obsolete("Lightmapping.bakedGI is obsolete, use
//        Lightmapping.lightingSettings.bakedGI instead. ", false)]
...
[Obsolete(
	 "Lightmapping.indirectOutputScale is obsolete, use Lightmapping.lightingSettings.indirectScale instead. ",
	 false)]
...
[Obsolete(
	 "Lightmapping.bounceBoost is obsolete, use Lightmapping.lightingSettings.albedoBoost instead. ",
	 false)]
...
// Set concurrent jobs type. Warning, high priority can impact Editor
// performance
[StaticAccessor("EnlightenPrecompManager::Get()", StaticAccessorType.Arrow)]
internal static extern ConcurrentJobsType concurrentJobsType {
	get;
	set;
}
...
[Obsolete(
	 "Lightmapping.enlightenForceWhiteAlbedo is obsolete, use Lightmapping.lightingSettings.realtimeForceWhiteAlbedo instead. ",
	 false)]
internal static bool enlightenForceWhiteAlbedo {
	get {
		return GetLightingSettingsOrDefaultsFallback().realtimeForceWhiteAlbedo;
	}
	set { GetOrCreateLightingsSettings().realtimeForceWhiteAlbedo = value; }
}

[Obsolete(
	 "Lightmapping.enlightenForceUpdates is obsolete, use Lightmapping.lightingSettings.realtimeForceUpdates instead. ",
	 false)]
...
[Obsolete(
	 "Lightmapping.filterMode is obsolete, use Lightmapping.lightingSettings.lightmapFilterMode instead. ",
	 false)]
...
[StaticAccessor("ProgressiveRuntimeManager::Get()", StaticAccessorType.Arrow)]
internal static extern int atlasCount {
	[NativeName("GetAtlasCount")] get;
}

[StaticAccessor("ProgressiveRuntimeManager::Get()", StaticAccessorType.Arrow)]
internal static extern LightmapConvergence
GetLightmapConvergence(int lightmapIndex);
...
[StaticAccessor("ProgressiveRuntimeManager::Get()", StaticAccessorType.Arrow)]
internal static extern bool GetGBufferHash(int lightmapIndex,
                                           out Hash128 gbufferHash);
...
[StaticAccessor(
	 "ProgressiveRuntimeManager::Get()",
	 StaticAccessorType.Arrow)] extern internal static DeviceAndPlatform
[] GetLightmappingGpuDevices();
...
public static extern bool isRunning {
	[FreeFunction("IsRunningLightmapping")] get;
}

[System.Obsolete(
	 "OnStartedFunction.started is obsolete, please use bakeStarted instead. ",
	 false)]
...
[System.Obsolete(
	 "OnCompletedFunction.completed is obsolete, please use event bakeCompleted instead. ",
	 false)]
...
// Returns the progress of a build when the bake job is running, returns 0
// when no bake job is running.
...
// Calculates a Delaunay Tetrahedralization of the 'positions' point set - the
// same way the lightmapper
...
[FreeFunction]
private static extern TetrahedralizationData
TetrahedralizeInternal(Vector3[] positions);

internal static void GetEnvironmentSamples(out Vector4[] outDirections,
                                           out Vector4[] outIntensities) {
...
[FreeFunction]
public static extern bool BakeReflectionProbe(ReflectionProbe probe,
                                              string path);

// Used to quickly update baked reflection probes without GI computations.
[FreeFunction]
internal static extern bool
BakeReflectionProbeSnapshot(ReflectionProbe probe);
...
OnUpdateLightmapStreaming(BuildTargetGroup target);

[FreeFunction]
public static extern void GetTerrainGIChunks([ NotNull ] Terrain terrain,
                                             ref int numChunksX,
                                             ref int numChunksY);
...
public static LightingSettings lightingSettings {
	...
	set { lightingSettingsInternal = value; }
}

[StaticAccessor("GetLightmapSettings()")]
[NativeName("LightingSettings")]
internal static extern LightingSettings lightingSettingsInternal {
	get;
	set;
}
...
public static extern LightingSettings lightingSettingsDefaults {
	get;
}
...
// used to make sure that the old APIs work. The user should not be required
// to manually create an asset, so we do it for them.
...
public static void BakeMultipleScenes(string[] paths) {
	...
	BakeOnAllOpen = (UnityEngine.SceneManagement.Scene scene,
	                 SceneManagement.OpenSceneMode loadSceneMode) => {
...
[StaticAccessor("GetLightingSettings()")] extern internal static void Reset();

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
IsLightmappedOrDynamicLightmappedForRendering([ NotNull ] Renderer renderer);
...
[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
IsRadeonDenoiserSupported();

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
IsOpenImageDenoiserSupported();

// Packing for realtime GI may fail of the mesh has zero UV or surface area.
// This is the outcome for the given renderer.
[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
HasZeroAreaMesh(Renderer renderer);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
HasUVOverlaps(Renderer renderer);

// Packing for realtime GI may clamp the output resolution. This is the
// outcome for the given renderer.
[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
HasClampedResolution(Renderer renderer);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetSystemResolution(Renderer renderer, out int width, out int height);

[FreeFunction("GetSystemResolution")]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetTerrainSystemResolution(Terrain terrain, out int width, out int height,
                           out int numChunksInX, out int numChunksInY);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetInstanceResolution(Renderer renderer, out int width, out int height);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetInputSystemHash(int instanceID, out Hash128 inputSystemHash);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetLightmapIndex(int instanceID, out int lightmapIndex);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal
Hash128[] GetMainSystemHashes();

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetInstanceHash(Renderer renderer, out Hash128 instanceHash);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetPVRInstanceHash(int instanceID, out Hash128 instanceHash);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetPVRAtlasHash(int instanceID, out Hash128 atlasHash);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetPVRAtlasInstanceOffset(int instanceID, out int atlasInstanceOffset);

[FreeFunction]
[NativeHeader("Editor/Src/GI/EditorHelpers.h")] extern static internal bool
GetGeometryHash(Renderer renderer, out Hash128 geometryHash);
}
}

namespace UnityEditor.Experimental {
public sealed partial class Lightmapping {
[StaticAccessor("ProgressiveRuntimeManager::Get()",
...
[StaticAccessor("ProgressiveRuntimeManager::Get()",
                StaticAccessorType.Arrow)]
public static extern void SetCustomBakeInputs(Vector4[] inputData,
                                              int sampleCount);
...
[Obsolete(
	 "UnityEditor.Experimental.Lightmapping.extractAmbientOcclusion is obsolete, use Lightmapping.lightingSettings.extractAO instead. ",
	 false)]
public static bool extractAmbientOcclusion {
	get {
		return UnityEditor.Lightmapping.GetLightingSettingsOrDefaultsFallback()
		       .extractAO;
	}
	set {
		UnityEditor.Lightmapping.GetOrCreateLightingsSettings().extractAO =
			value;
	}
}
...
[FreeFunction]
internal unsafe static extern bool GetAdditionalBakedProbes(
	int id, void *outBakedProbeSH, void *outBakedProbeValidity,
	void *outBakedProbeOctahedralDepth, int outBakedProbeCount);

[Obsolete(
	 "Please use the new GetAdditionalBakedProbes with added octahedral depth map data.",
	 false)]
public unsafe static bool
GetAdditionalBakedProbes(int id,
                         NativeArray<SphericalHarmonicsL2> outBakedProbeSH,
                         NativeArray<float> outBakedProbeValidity) {
	const int octahedralDepthMapTexelCount = 64; // 8*8
	var outBakedProbeOctahedralDepth = new NativeArray<float>(
		outBakedProbeSH.Length * octahedralDepthMapTexelCount, Allocator.Temp,
		NativeArrayOptions.UninitializedMemory);
	bool success =
		GetAdditionalBakedProbes(id, outBakedProbeSH, outBakedProbeValidity,
		                         outBakedProbeOctahedralDepth);
...
GetAdditionalBakedProbes(int id,
                         NativeArray<SphericalHarmonicsL2> outBakedProbeSH,
                         NativeArray<float> outBakedProbeValidity,
                         NativeArray<float> outBakedProbeOctahedralDepth) {
	if (outBakedProbeSH == null || !outBakedProbeSH.IsCreated ||
	    outBakedProbeValidity == null || !outBakedProbeValidity.IsCreated ||
	    outBakedProbeOctahedralDepth == null ||
	    !outBakedProbeOctahedralDepth.IsCreated) {
	...
	if (outBakedProbeOctahedralDepth.Length !=
	    numEntries * octahedralDepthMapTexelCount) {
		Debug.LogError("Octahedral array must provide " +
		               numEntries * octahedralDepthMapTexelCount + " floats.");
		return false;
	}
	...
	void *validityPtr =
		NativeArrayUnsafeUtility.GetUnsafePtr(outBakedProbeValidity);
	void *octahedralDepthPtr =
		NativeArrayUnsafeUtility.GetUnsafePtr(outBakedProbeOctahedralDepth);

	return GetAdditionalBakedProbes(
		id, shPtr, validityPtr, octahedralDepthPtr, outBakedProbeSH.Length);
}

[FreeFunction]
public static extern void SetAdditionalBakedProbes(int id,
                                                   Vector3[] positions);
}
}
