...
internal struct LightmapConvergence
{
    public bool       IsConverged() {
        return convergedDirectTexelCount == occupiedTexelCount && convergedGITexelCount == occupiedTexelCount;
    }
    public bool       IsValid() {
...
//        [Obsolete("Lightmapping.giWorkflowMode is obsolete, use Lightmapping.lightingSettings.autoGenerate instead. ", false)]
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().autoGenerate ? GIWorkflowMode.Iterative : GIWorkflowMode.OnDemand;
        }
        set {
            GetOrCreateLightingsSettings().autoGenerate = (value == GIWorkflowMode.Iterative);
        }
    }
...
//        [Obsolete("Lightmapping.realtimeGI is obsolete, use Lightmapping.lightingSettings.realtimeGI instead. ", false)]
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().realtimeGI;
        }
        set {
            GetOrCreateLightingsSettings().realtimeGI = value;
        }
    }
...
//        [Obsolete("Lightmapping.bakedGI is obsolete, use Lightmapping.lightingSettings.bakedGI instead. ", false)]
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().bakedGI;
        }
        set {
            GetOrCreateLightingsSettings().bakedGI = value;
        }
    }
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().indirectScale;
        }
        set {
            GetOrCreateLightingsSettings().indirectScale = value;
        }
    }
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().albedoBoost;
        }
        set {
            GetOrCreateLightingsSettings().albedoBoost = value;
        }
    }
    ...
    internal static bool enlightenForceWhiteAlbedo
    {
        ...
        set {
            GetOrCreateLightingsSettings().realtimeForceWhiteAlbedo = value;
        }
    }
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().realtimeForceUpdates;
        }
        set {
            GetOrCreateLightingsSettings().realtimeForceUpdates = value;
        }
    }
    ...
    {
        get {
            return GetLightingSettingsOrDefaultsFallback().lightmapFilterMode;
        }
        set {
            GetOrCreateLightingsSettings().lightmapFilterMode = value;
        }
    }
...
public sealed partial class Lightmapping
{
    ...
    {
        get {
            return UnityEditor.Lightmapping.GetLightingSettingsOrDefaultsFallback().extractAO;
        }
        set {
            UnityEditor.Lightmapping.GetOrCreateLightingsSettings().extractAO = value;
        }
    }
