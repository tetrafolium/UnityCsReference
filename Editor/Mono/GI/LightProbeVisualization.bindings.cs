...
internal static partial class LightProbeVisualization {
  ...
  DrawPointCloud([ NotNull ] Vector3[] unselectedPositions,
                 [ NotNull ] Vector3[] selectedPositions, Color baseColor,
                 Color selectedColor, float scale, Transform cloudTransform);

  [StaticAccessor("GetLightProbeVisualizationSettings()")]
  internal static extern void DrawTetrahedra(bool shouldRecalculateTetrahedra,
