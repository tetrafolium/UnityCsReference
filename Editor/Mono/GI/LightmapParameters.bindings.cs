...
public sealed partial class LightmapParameters : UnityEngine.Object {
  public LightmapParameters() { Internal_Create(this); }

  [FreeFunction("LightmapParametersBindings::Internal_Create")]
  private extern static void
  Internal_Create([ UnityEngine.Writable ] LightmapParameters self);

  public extern static LightmapParameters
  GetLightmapParametersForLightingSettings(
      UnityEngine.LightingSettings lightingSettings);
  public extern static void SetLightmapParametersForLightingSettings(
      LightmapParameters parameters,
      UnityEngine.LightingSettings lightingSettings);

  public void
  AssignToLightingSettings(UnityEngine.LightingSettings lightingSettings) {
  ...
  public extern bool stitchEdges {
    get;
    set;
  }
  ...
  public extern bool limitLightmapCount {
    get;
    set;
  }
  public extern int maxLightmapCount {
    get;
    set;
  }
