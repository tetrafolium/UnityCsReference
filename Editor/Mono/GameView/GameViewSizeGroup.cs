...
internal class GameViewSizeGroup {
  ...
  public GameViewSize GetGameViewSize(int index) {
    ...
    Debug.LogError("Invalid index " + (index + m_Builtin.Count) + " " +
                   m_Builtin.Count + " " + m_Custom.Count);
  ...
  public int GetTotalCount() { return m_Builtin.Count + m_Custom.Count; }

  public int GetBuiltinCount() { return m_Builtin.Count; }

  public int GetCustomCount() { return m_Custom.Count; }
