...
internal static string ValidatePackageVersion(string value) {
	Regex metroPackageVersionRegex =
		new Regex(@"^(\d+)\.(\d+)\.(\d+)\.(\d+)$",
...
public static string GetVisualAssetsImage(WSAImageType type,
                                          WSAImageScale scale) {
...
public static void SetVisualAssetsImage(string image, WSAImageType type,
                                        WSAImageScale scale) {
	ValidateWSAImageType(type);
	ValidateWSAImageScale(scale);
...
public static System.Version packageVersion {
	get {
		try {
			...
			throw new Exception(string.Format("{0}, the raw string was {1}",
			                                  ex.Message, packageVersionRaw));
		}
	}
...
public static bool GetCapability(WSACapability capability) {
	...
	try {
		return (bool)
		       System.ComponentModel.TypeDescriptor.GetConverter(typeof(bool))
		       .ConvertFromString(stringValue);
	} catch {
		Debug.LogError("Failed to parse value  ('" + capability + "," +
		               stringValue + "') to bool type.");
		return false;
	}
}

public static void SetTargetDeviceFamily(WSATargetFamily family,
                                         bool value) {
...
public static bool GetTargetDeviceFamily(WSATargetFamily family) {
	...
	try {
		...
		Debug.LogError("Failed to parse value  ('" + family + "," +
		               stringValue + "') to bool type.");
		return false;
	}
}
...
public static string storeTileLogo180 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileLogo180 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeTileWideLogo {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileWideLogo is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileWideLogo is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeTileWideLogo140 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileWideLogo140 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileWideLogo140 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeTileWideLogo180 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileWideLogo180 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
...
public static string storeTileSmallLogo80 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo80 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo80 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeTileSmallLogo {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeTileSmallLogo140 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo140 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
...
public static string storeTileSmallLogo180 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo180 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeTileSmallLogo180 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeSmallTile80 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.storeSmallTile80 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeSmallTile80 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeSmallTile {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeSmallTile is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string storeSmallTile140 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.storeSmallTile140 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneAppIcon240 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneAppIcon240 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneSmallTile {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSmallTile is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSmallTile is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneSmallTile140 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSmallTile140 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneSmallTile240 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSmallTile240 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSmallTile240 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneMediumTile {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneMediumTile140 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile140 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile140 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneMediumTile240 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile240 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneMediumTile240 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneWideTile {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneWideTile is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneWideTile is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneWideTile140 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneWideTile140 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneWideTile240 {
	...
	set {
		throw new NotSupportedException(
			      "PlayerSettings.phoneWideTile240 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
public static string phoneSplashScreenImage {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.phoneSplashScreenImage is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
...
public static string packageLogo180 {
	get {
		throw new NotSupportedException(
			      "PlayerSettings.packageLogo180 is deprecated. Use GetVisualAssetsImage() instead.");
	}
	set {
		throw new NotSupportedException(
			      "PlayerSettings.packageLogo180 is deprecated. Use SetVisualAssetsImage() instead.");
	}
}
...
[System.ComponentModel.EditorBrowsable(
	 System.ComponentModel.EditorBrowsableState.Never)]
[Obsolete(
	 "PlayerSettings.enableLowLatencyPresentationAPI is deprecated. It is now always enabled.",
	 true)]
