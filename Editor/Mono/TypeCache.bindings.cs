...
public static partial class TypeCache {
  ...
  public struct TypeCollection : IList<Type>,
                                 IList {
    [NonSerialized] readonly IntPtr ptr;
    readonly int count;

    internal TypeCollection(IntPtr p, int s) {
      ptr = p;
      count = s;
    }
    ...
    public Type this[int index] {
      get {
        ...
        throw new IndexOutOfRangeException(
            $"Index {index} is out of range of '{count}' Count.");
      }
    ...
    public int IndexOf(Type item) {
      ...
      for (int i = 0; i < count; ++i) {
        // We can use == here as type object is unique and stored in a hashtable
        // for the domain lifetime (Mono).
    ...
    public int IndexOf(object item) {
      ...
      if (typedItem == null)
        throw new ArgumentException(nameof(item) + " is not of type " +
                                    nameof(Type));
    ...
    [ThreadSafe] extern void Internal_CopyTo(Type[] array, int arrayIndex);

    IEnumerator<Type> IEnumerable<Type>.GetEnumerator() => GetEnumerator();

    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

    void ICollection<Type>.Add(Type item) { ThrowNotSupported(); }

    void ICollection<Type>.Clear() { ThrowNotSupported(); }
    ...
    void IList<Type>.Insert(int index, Type item) { ThrowNotSupported(); }

    void IList<Type>.RemoveAt(int index) { ThrowNotSupported(); }
    ...
    static void ThrowNotSupported() {
      throw new NotSupportedException(
          nameof(TypeCollection) +
          " is read-only. Modification is not supported.");
    }
  ...
  public struct MethodCollection : IList<MethodInfo>,
    ...
    internal MethodCollection(IntPtr p, int s) {
      ptr = p;
      count = s;
    }
    ...
    [ThreadSafe] extern void Internal_CopyTo(MethodInfo[] array,
                                             int arrayIndex);

    IEnumerator<MethodInfo>
        IEnumerable<MethodInfo>.GetEnumerator() => GetEnumerator();

    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

    void ICollection<MethodInfo>.Add(MethodInfo item) { ThrowNotSupported(); }

    void ICollection<MethodInfo>.Clear() { ThrowNotSupported(); }
    ...
    void IList<MethodInfo>.RemoveAt(int index) { ThrowNotSupported(); }
  ...
  [DebuggerDisplay("Count = {" + nameof(count) + "}")]
  [DebuggerTypeProxy(typeof(DebugView))]
  public struct FieldInfoCollection : IList<FieldInfo>,
                                      IList {
    [NonSerialized] readonly IntPtr ptr;
    readonly int count;

    internal FieldInfoCollection(IntPtr p, int s) {
      ptr = p;
      count = s;
    }
    ...
    [ThreadSafe] extern void Internal_CopyTo(FieldInfo[] array, int arrayIndex);

    IEnumerator<FieldInfo>
        IEnumerable<FieldInfo>.GetEnumerator() => GetEnumerator();

    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

    void ICollection<FieldInfo>.Add(FieldInfo item) { ThrowNotSupported(); }

    void ICollection<FieldInfo>.Clear() { ThrowNotSupported(); }
    ...
    void IList<FieldInfo>.RemoveAt(int index) { ThrowNotSupported(); }
  ...
  [ThreadSafe]
  public static extern FieldInfoCollection
