...
namespace UnityEditor.SearchService {
  ...
  public struct ObjectSelectorTargetInfo {
    ...
    public ObjectSelectorTargetInfo(GlobalObjectId globalObjectId,
    ...
    public Object LoadObject() {
      return targetObject ?? GlobalObjectId.GlobalObjectIdentifierToObjectSlow(
          globalObjectId);
    }
  }
  ...
  public class ObjectSelectorSearchContext : ISearchContext {
    ...
    public VisibleObjects visibleObjects {
      get;
      set;
    }
    ...
    public Func<ObjectSelectorTargetInfo, Object[], ObjectSelectorSearchContext,
                bool> selectorConstraint {
      get;
      set;
    }
  }
  ...
  public static class ObjectSelector {
    static readonly SearchApiBaseImp<ObjectSelectorEngineAttribute,
                                     IObjectSelectorEngine> k_EngineImp;

    public const SearchEngineScope EngineScope =
        SearchEngineScope.ObjectSelector;

    static ObjectSelector() {
      k_EngineImp = new SearchApiBaseImp<ObjectSelectorEngineAttribute,
                                         IObjectSelectorEngine>(
          EngineScope, "Object Selector");
    }

    internal static bool
    SelectObject(ObjectSelectorSearchContext context,
      ...
      try {
        return activeEngine.SelectObject(context, onObjectSelectorClosed,
    ...
    internal static void SetSearchFilter(string searchFilter,
                                         ObjectSelectorSearchContext context) {
      var activeEngine = k_EngineImp.activeSearchEngine;
    ...
    internal static void BeginSearch(string query,
                                     ObjectSelectorSearchContext context) {
