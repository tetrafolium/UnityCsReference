...
public HierarchyProperty rootProperty {
	get;
	set;
}
}
...
static readonly SearchApiBaseImp<SceneSearchEngineAttribute,
                                 ISceneSearchEngine> k_EngineImp;

public const SearchEngineScope EngineScope = SearchEngineScope.Scene;

static Scene() {
	k_EngineImp =
		new SearchApiBaseImp<SceneSearchEngineAttribute, ISceneSearchEngine>(
			EngineScope, "Scene");
}

internal static bool Filter(string query, HierarchyProperty objectToFilter,
