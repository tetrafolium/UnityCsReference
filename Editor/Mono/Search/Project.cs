...
static readonly SearchApiBaseImp<ProjectSearchEngineAttribute,
                                 IProjectSearchEngine> k_EngineImp;

public const SearchEngineScope EngineScope = SearchEngineScope.Project;

static Project() {
	k_EngineImp =
		new SearchApiBaseImp<ProjectSearchEngineAttribute,
		                     IProjectSearchEngine>(EngineScope, "Project");
}

internal static IEnumerable<string>
Search(string query, ProjectSearchContext context,
