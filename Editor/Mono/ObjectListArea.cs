...
internal partial class ObjectListArea
{
    ...
    public System.Action repaintCallback                {
        get {
            return m_RepaintWantedCallback;
        }
        set {
            m_RepaintWantedCallback = value;
        }
    }
    public System.Action<bool> itemSelectedCallback     {
        get {
            return m_ItemSelectedCallback;
        }
        set {
            m_ItemSelectedCallback = value;
        }
    }
    public System.Action keyboardCallback               {
        get {
            return m_KeyboardInputCallback;
        }
        set {
            m_KeyboardInputCallback = value;
        }
    }
    public System.Action gotKeyboardFocus               {
        get {
            return m_GotKeyboardFocus;
        }
        set {
            m_GotKeyboardFocus = value;
        }
    }
    public System.Action assetStoreSearchEnded          {
        get {
            return m_AssetStoreSearchEnded;
        }
        set {
            m_AssetStoreSearchEnded = value;
        }
    }
    public System.Func<Rect, float> drawLocalAssetHeader {
        get {
            return m_DrawLocalAssetHeader;
        }
        set {
            m_DrawLocalAssetHeader = value;
        }
    }
    ...
    {
        get {
            return m_LocalAssets.ItemCount;
        }
    }
