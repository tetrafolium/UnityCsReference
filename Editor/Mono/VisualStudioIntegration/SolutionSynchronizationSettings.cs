...
namespace UnityEditor.VisualStudioIntegration {
  ...
  internal class DefaultSolutionSynchronizationSettings
      : ISolutionSynchronizationSettings {
    ...
    public virtual string GetProjectHeaderTemplate(ScriptingLanguage language) {
      ...
      var footer = new string[]{@"  <ItemGroup>", @""};
    ...
    protected virtual string FrameworksPath() { return string.Empty; }
  }
}
