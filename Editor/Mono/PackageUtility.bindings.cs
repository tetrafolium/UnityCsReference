...
[NativeType(CodegenOptions.Custom, "MonoImportPackageItem",
            Header = "Editor/Mono/PackageUtility.bindings.h")]
[NativeAsStruct]
...
[NativeType(CodegenOptions.Custom, "MonoPackageInfo",
            Header = "Editor/Src/PackageUtility.h")]
...
internal class PackageUtility {
  [NativeThrows]
  public static extern ExportPackageItem[] BuildExportPackageItemsList(
      string[] guids, bool dependencies);
  [NativeThrows]
  public static extern ExportPackageItem
      [] BuildExportPackageItemsListWithPackageManagerWarning(
          string[] guids, bool dependencies,
          bool warnPackageManagerDependencies);
  [NativeThrows]
  public static extern void ExportPackage(string[] guids, string fileName);
  [NativeThrows]
  public static extern void
  ExportPackageAndPackageManagerManifest(string[] guids, string fileName);
  public static extern ImportPackageItem[] ExtractAndPrepareAssetList(
      string packagePath, out string packageIconPath,
      out string packageManagerDependenciesPath);

  [FreeFunction("DelayedImportPackageAssets")]
  public static extern void ImportPackageAssets(string packageName,
                                                ImportPackageItem[] items);
  [FreeFunction("ImportPackageAssets")]
  public static extern void
  ImportPackageAssetsImmediately(string packageName, ImportPackageItem[] items);

  [FreeFunction("ImportPackageCancelledGUI")]
  public static extern void
  ImportPackageAssetsCancelledFromGUI(string packageName,
                                      ImportPackageItem[] items);
