...
internal sealed class FrameDebuggerUtility
{
    ...
    [NativeName("FinalDrawCallCount")] public extern static int count {
        get;
    }
    [NativeName("DrawCallLimit")] public extern static int limit {
        get;
        set;
    }
    [NativeName("FrameEventsHash")] public extern static int eventsHash {
        get;
    }
    [NativeName("FrameEventDataHash")] public extern static uint eventDataHash {
        get;
    }
