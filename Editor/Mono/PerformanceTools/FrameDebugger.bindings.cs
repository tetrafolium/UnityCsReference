...
public extern static bool receivingRemoteFrameEventData {
	[NativeName("IsReceivingRemoteFrameEventData")] get;
}
public extern static bool locallySupported {
	[NativeName("IsSupported")] get;
}
[NativeName("FinalDrawCallCount")]
public extern static int count {
	get;
}
[NativeName("DrawCallLimit")]
public extern static int limit {
	get;
	set;
}
[NativeName("FrameEventsHash")]
public extern static int eventsHash {
	get;
}
[NativeName("FrameEventDataHash")]
public extern static uint eventDataHash {
	get;
}
public extern static void SetRenderTargetDisplayOptions(int rtIndex,
                                                        Vector4 channels,
                                                        float blackLevel,
                                                        float whiteLevel);
[NativeName("GetProfilerEventName")]
public extern static string GetFrameEventInfoName(int index);
public extern static GameObject GetFrameEventGameObject(int index);
[FreeFunction("FrameDebuggerBindings::GetBatchBreakCauseStrings")]
public extern static string[] GetBatchBreakCauseStrings();

public static FrameDebuggerEvent[] GetFrameEvents() {
	return (FrameDebuggerEvent[]) GetFrameEventsImpl();
}
[NativeName("GetFrameEvents")] extern private static System.Array
GetFrameEventsImpl();

// Returns false, if frameEventData holds data from previous selected frame
public static bool
GetFrameEventData(int index, FrameDebuggerEventData frameDebuggerEventData) {
...
[FreeFunction(
	 "FrameDebuggerBindings::GetFrameEventDataImpl")] extern private static void
GetFrameEventDataImpl(System.IntPtr frameDebuggerEventData);
}
}
