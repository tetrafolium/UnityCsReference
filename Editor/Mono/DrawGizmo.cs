...
public enum GizmoType {
  ...
  [
    Obsolete(
        "Use NotInSelectionHierarchy instead (UnityUpgradable) -> NotInSelectionHierarchy")
  ] NotSelected = -127,

  [
    Obsolete(
        "Use InSelectionHierarchy instead (UnityUpgradable) -> InSelectionHierarchy")
  ] SelectedOrChild = -127,
}
...
public sealed class DrawGizmo : Attribute {
  ...
  public DrawGizmo(GizmoType gizmo) { drawOptions = gizmo; }
