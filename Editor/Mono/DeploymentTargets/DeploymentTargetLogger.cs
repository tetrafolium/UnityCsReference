...
// First string parameter is used as log ID, e.g. it could be stdout, stderr
// or any other For every unique ID passed to this event - a separate log
// file will be created Second string parameter is log message
