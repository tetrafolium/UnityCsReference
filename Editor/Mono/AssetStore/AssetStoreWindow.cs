...
internal class AssetStoreWindow : EditorWindow
{
    ...
    private Button visitWebsiteButton {
        get {
            return rootVisualElement.Q<Button>("visitWebsiteButton");
        }
    }
    private Button launchPackageManagerButton {
        get {
            return rootVisualElement.Q<Button>("launchPackageManagerButton");
        }
    }
    private Toggle alwaysOpenInBrowserToggle {
        get {
            return rootVisualElement.Q<Toggle>("alwaysOpenInBrowserToggle");
        }
    }
}
}
