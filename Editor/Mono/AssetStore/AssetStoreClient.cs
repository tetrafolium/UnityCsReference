...
class AssetStoreClient
{
    ...
    static public bool RememberSession
    {
        ...
        set {
            EditorPrefs.SetString("kharma.remember_session", value ? "1" : "0");
        }
    }
    ...
    */
            ...
            AssetStoreSearchResults.Callback callback)
    {
        ...
        return CreateJSONRequest(url, delegate(AssetStoreResponse ar) {
            r.Parse(ar);
        });
    }
    ...
    internal static AsyncHTTPClient DirectPurchase(int packageID, string password, PurchaseResult.Callback callback)
    {
        ...
        d["password"] = password;
        return CreateJSONRequestPost(url, d, delegate(AssetStoreResponse ar) {
            r.Parse(ar);
        });
    }
