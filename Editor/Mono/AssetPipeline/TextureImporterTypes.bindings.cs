...
#pragma warning disable 169
    ...
    {
        get {
            return m_MipMapsPreserveCoverage != 0;
        }
        set {
            m_MipMapsPreserveCoverage = value ? 1 : 0;
        }
    }
    public float alphaTestReferenceValue
    {
        ...
        set {
            m_AlphaTestReferenceValue = value;
        }
    }
    ...
    public TextureImporterSingleChannelComponent singleChannelComponent
    {
        ...
        set {
            m_SingleChannelComponent = (int)value;
        }
    }
    ...
    {
        get {
            return m_StreamingMipmaps != 0;
        }
        set {
            m_StreamingMipmaps = value ? 1 : 0;
        }
    }
    public int streamingMipmapsPriority
    {
        ...
        set {
            m_StreamingMipmapsPriority = value;
        }
    }
    ...
    {
        get {
            return (TextureWrapMode)m_WrapU;
        }
        set {
            m_WrapU = (int)value;
            m_WrapV = (int)value;
    ...
    {
        get {
            return (TextureWrapMode)m_WrapV;
        }
        set {
            m_WrapV = (int)value;
        }
    ...
    {
        get {
            return (TextureWrapMode)m_WrapW;
        }
        set {
            m_WrapW = (int)value;
        }
    ...
    {
        get {
            return m_IgnorePngGamma != 0;
        }
        set {
            m_IgnorePngGamma = value ? 1 : 0;
        }
    }
    ...
    {
        get {
            return m_SpriteGenerateFallbackPhysicsShape != 0;
        }
        set {
            m_SpriteGenerateFallbackPhysicsShape = value ? 1 : 0;
        }
    }
    ...
    public bool normalMap
    {
        ...
        set {
            if (value) textureType = TextureImporterType.NormalMap;
            else textureType = TextureImporterType.Default;
        }
    }
    ...
    public bool lightmap
    {
        ...
        set {
            if (value) textureType = TextureImporterType.Lightmap;
            else textureType = TextureImporterType.Default;
        }
    }
    ...
    public bool grayscaleToAlpha
    {
        ...
        set {
            if (value) alphaSource = TextureImporterAlphaSource.FromGrayScale;
            else alphaSource = TextureImporterAlphaSource.FromInput;
        }
    }
...
public sealed partial class TextureImporterPlatformSettings
{
    ...
    {
        get {
            return m_Overridden != 0;
        }
        set {
            m_Overridden = value ? 1 : 0;
        }
    }
    ...
    {
        get {
            return (TextureResizeAlgorithm)m_ResizeAlgorithm;
        }
        set {
            m_ResizeAlgorithm = (int)value;
        }
    }
    ...
    public TextureImporterFormat format
    {
        ...
        set {
            m_TextureFormat = (int)value;
        }
    }
    public TextureImporterCompression textureCompression
    {
        get {
            return (TextureImporterCompression)m_TextureCompression;
        }
        set {
            m_TextureCompression = (int)value;
        }
    }
    ...
    {
        get {
            return m_ForceMaximumCompressionQuality_BC6H_BC7;
        }
        set {
            m_ForceMaximumCompressionQuality_BC6H_BC7 = value;
        }
    }
    ...
    {
        get {
            return m_CrunchedCompression != 0;
        }
        set {
            m_CrunchedCompression = value ? 1 : 0;
        }
    }
    ...
    {
        get {
            return m_AllowsAlphaSplitting != 0;
        }
        set {
            m_AllowsAlphaSplitting = value ? 1 : 0;
        }
    }
    ...
    {
        get {
            return (AndroidETC2FallbackOverride)m_AndroidETC2FallbackOverride;
        }
        set {
            m_AndroidETC2FallbackOverride = (int)value;
        }
    }
