...
// Note: MUST match memory layout of TextureImporterSettings in
// TextureImporter.h! This means you need to be careful about field sizes (e.g.
// don't use "bool" since they are different size in C# and C++).
[System.Serializable]
[StructLayout(LayoutKind.Sequential)]
[NativeAsStruct]
[NativeType(CodegenOptions.Custom, "TextureImporterSettings")]
[NativeHeader(
	 "Editor/Src/AssetPipeline/TextureImporting/TextureImporter.bindings.h")]
[NativeHeader(
	 "Editor/Src/AssetPipeline/TextureImporting/TextureImporterTypes.h")]
public sealed partial class TextureImporterSettings {
[SerializeField] int m_AlphaSource;
[SerializeField] int m_MipMapMode;
[SerializeField] int m_EnableMipMap;
[SerializeField] int m_FadeOut;
[SerializeField] int m_BorderMipMap;
[SerializeField] int m_MipMapsPreserveCoverage;
[SerializeField] float m_AlphaTestReferenceValue;
[SerializeField] int m_MipMapFadeDistanceStart;
[SerializeField] int m_MipMapFadeDistanceEnd;

#pragma warning disable 169

[SerializeField] int m_ConvertToNormalMap;
[SerializeField] float m_HeightScale;
[SerializeField] int m_NormalMapFilter;
[SerializeField] int m_IsReadable;

[SerializeField] int m_StreamingMipmaps;
[SerializeField] int m_StreamingMipmapsPriority;

[SerializeField] int m_NPOTScale;
[SerializeField] int m_sRGBTexture;

[SerializeField] int m_SpriteMode;
[SerializeField] uint m_SpriteExtrude;
[SerializeField] int m_SpriteMeshType;
[SerializeField] int m_Alignment;
[SerializeField] Vector2 m_SpritePivot;
[SerializeField] float m_SpritePixelsToUnits;
[SerializeField] Vector4 m_SpriteBorder;
[SerializeField] int m_SpriteGenerateFallbackPhysicsShape;

[SerializeField] int m_GenerateCubemap;
[SerializeField] int m_CubemapConvolution;
[SerializeField] int m_SeamlessCubemap;

[SerializeField] int m_AlphaIsTransparency;

[SerializeField] float m_SpriteTessellationDetail;

[SerializeField] int m_TextureType;
[SerializeField] int m_TextureShape;

[SerializeField] int m_SingleChannelComponent;

[SerializeField] int m_FlipbookRows;

[SerializeField] int m_FlipbookColumns;

[SerializeField] int m_IgnorePngGamma;

// memory layout of these is in TextureSettings.h
[SerializeField]
[NativeName("m_TextureSettings.m_FilterMode")] int m_FilterMode;
[SerializeField]
[NativeName("m_TextureSettings.m_Aniso")] int m_Aniso;
[SerializeField]
[NativeName("m_TextureSettings.m_MipBias")] float m_MipBias;
[SerializeField]
[NativeName("m_TextureSettings.m_WrapU")] int m_WrapU;
[SerializeField]
[NativeName("m_TextureSettings.m_WrapV")] int m_WrapV;
[SerializeField]
[NativeName("m_TextureSettings.m_WrapW")] int m_WrapW;

// Deprecated since texture importer overhaul. Kept for backward compatibility
// purpose.
[SerializeField]
[NativeName("m_NormalMap_Deprecated")] int m_NormalMap;
[SerializeField]
[NativeName("m_TextureFormat_Deprecated")] int m_TextureFormat;
[SerializeField]
[NativeName("m_MaxTextureSize_Deprecated")] int m_MaxTextureSize;
[SerializeField]
[NativeName("m_Lightmap_Deprecated")] int m_Lightmap;
[SerializeField]
[NativeName("m_CompressionQuality_Deprecated")] int m_CompressionQuality;
[SerializeField]
[NativeName("m_LinearTexture_Deprecated")] int m_LinearTexture;
[SerializeField]
[NativeName("m_GrayScaleToAlpha_Deprecated")] int m_GrayScaleToAlpha;
[SerializeField]
[NativeName("m_RGBM_Deprecated")] int m_RGBM;
[SerializeField]
[NativeName("m_CubemapConvolutionSteps_Deprecated")] int
        m_CubemapConvolutionSteps;
[SerializeField]
[NativeName("m_CubemapConvolutionExponent_Deprecated")] float
        m_CubemapConvolutionExponent;

// These are just part of a hack to support backward compatibility for
// maxTextureSize, textureFormat and compressionQualityProperties
[SerializeField]
...
// For backward compatibility for an incorrectly applied gamma decoding step
// (bug)
[SerializeField] int m_ApplyGammaDecoding;
...
public TextureImporterSingleChannelComponent singleChannelComponent {
	get {
		return (TextureImporterSingleChannelComponent) m_SingleChannelComponent;
	}
...
// The number of pixels in one unit. Note: Internally, the name
// m_SpritePixelsToUnits has not been changed yet to minimize merge conflicts.
...
public static extern bool Equal(TextureImporterSettings a,
                                TextureImporterSettings b);
...
private static extern void Copy([ NotNull ] TextureImporterSettings self,
                                [Out]
                                [NotNull] TextureImporterSettings target);

// Configure parameters to import a texture for a purpose of ''type'', as
// described [[TextureImporterType|here]].
[Obsolete(
...
Internal_ApplyTextureType([Out]
                          [NotNull] TextureImporterSettings self,
...
[Obsolete(
	 "Check importer.textureType against TextureImporterType.NormalMap instead. Getter will work as expected. Setter will set textureType to NormalMap if true, nothing otherwise")]
...
[Obsolete(
	 "Texture format can only be overridden on a per platform basis. See [[TextureImporterPlatformSettings]]")]
...
[Obsolete(
	 "Texture max size can only be overridden on a per platform basis. See [[TextureImporter.maxTextureSize]] for Default platform or [[TextureImporterPlatformSettings]]")]
...
[Obsolete(
	 "Check importer.textureType against TextureImporterType.Lightmap instead. Getter will work as expected. Setter will set textureType to Lightmap if true, nothing otherwise.")]
...
[Obsolete(
	 "RGBM is no longer a user's choice but has become an implementation detail hidden to the user.")]
...
[Obsolete(
	 "Not used anymore. The right values are automatically picked by the importer.")]
...
[Obsolete(
	 "Texture compression can only be overridden on a per platform basis. See [[TextureImporter.compressionQuality]] for Default platform or [[TextureImporterPlatformSettings]]")]
...
// Note: MUST match memory layout of TextureImporterPlatformSettings in
// TextureImporterTypes.h! This means you need to be careful about field sizes
// (e.g. don't use "bool" since they are different size in C# and C++).
[System.Serializable]
[StructLayout(LayoutKind.Sequential)]
[NativeAsStruct]
[NativeType(CodegenOptions.Custom,
            "TextureImporterPlatformSettings_Marshalling")]
[NativeHeader(
	 "Editor/Src/AssetPipeline/TextureImporting/TextureImporter.bindings.h")]
public sealed partial class TextureImporterPlatformSettings {
[SerializeField]
[NativeName("m_BuildTarget")] string m_Name =
	TextureImporterInspector.s_DefaultPlatformName;
[SerializeField] int m_Overridden = 0;
[SerializeField] int m_MaxTextureSize = 2048;
[SerializeField] int m_ResizeAlgorithm =
	(int) TextureResizeAlgorithm.Mitchell;
[SerializeField] int m_TextureFormat = (int) TextureImporterFormat.Automatic;
[SerializeField] int m_TextureCompression =
	(int) TextureImporterCompression.Compressed;
[SerializeField] int m_CompressionQuality =
	(int) TextureCompressionQuality.Normal;

[SerializeField]
internal int m_ForceMaximumCompressionQuality_BC6H_BC7 = 0;

[SerializeField] int m_CrunchedCompression = 0;
[SerializeField] int m_AllowsAlphaSplitting = 0;
[SerializeField] int m_AndroidETC2FallbackOverride =
...
[FreeFunction("TextureImporterBindings::CopyTo")]
private static extern void
Copy([ NotNull ] TextureImporterPlatformSettings self,
     [Out]
     [NotNull] TextureImporterPlatformSettings target);
}
}
