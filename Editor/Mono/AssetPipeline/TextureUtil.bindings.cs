...
internal static class TextureUtil {
  [Obsolete(
      "GetStorageMemorySize has been deprecated since it is limited to 2GB. Please use GetStorageMemorySizeLong() instead.")]
  ...
  [FreeFunction]
  public static extern int GetRowBytesFromWidthAndFormat(int width,
  ...
  IsCompressedCrunchTextureFormat(TextureFormat format);
  ...
  [FreeFunction]
  public static extern TextureFormat
  ConvertToAlphaTextureFormat(TextureFormat format);

  public static bool IsDepthRTFormat(RenderTextureFormat format) {
    return format == RenderTextureFormat.Depth ||
  ...
  [FreeFunction]
  public static extern Texture2D GetSourceTexture(Cubemap cubemapRef,
                                                  CubemapFace face);

  [FreeFunction]
  public static extern void SetSourceTexture(Cubemap cubemapRef,
                                             CubemapFace face, Texture2D tex);

  [FreeFunction]
  public static extern void CopyTextureIntoCubemapFace(Texture2D textureRef,
                                                       Cubemap cubemapRef,
                                                       CubemapFace face);

  [FreeFunction]
  public static extern void CopyCubemapFaceIntoTexture(Cubemap cubemapRef,
                                                       CubemapFace face,
                                                       Texture2D textureRef);

  [FreeFunction]
  public static extern bool
  ReformatCubemap(Cubemap cubemap, int width, int height,
                  TextureFormat textureFormat, bool useMipmap, bool linear);

  [FreeFunction]
  public static extern bool
  ReformatTexture(ref Texture2D texture, int width, int height,
                  TextureFormat textureFormat, bool useMipmap, bool linear);
  ...
  [FreeFunction]
  public static extern void SetWrapModeNoDirty(Texture tex, TextureWrapMode u,
                                               TextureWrapMode v,
                                               TextureWrapMode w);
  ...
  [FreeFunction]
  public static extern bool
  DoesTextureStillNeedToBeCompressed(string assetPath);

  [FreeFunction]
  public static extern bool IsCubemapReadable(Cubemap cubemapRef);

  [FreeFunction]
  public static extern void MarkCubemapReadable(Cubemap cubemapRef,
                                                bool readable);
  ...
  GetTexture2DStreamingMipmapsPriority(Texture2D texture);
  ...
  [FreeFunction]
  public static extern void SetTexture2DStreamingMipmaps(Texture2D textureRef,
                                                         bool streaming);

  [FreeFunction]
  public static extern void
  SetTexture2DStreamingMipmapsPriority(Texture2D textureRef, int priority);

  [FreeFunction]
  public static extern void SetCubemapStreamingMipmaps(Cubemap cubemapRef,
                                                       bool streaming);

  [FreeFunction]
  public static extern void
  SetCubemapStreamingMipmapsPriority(Cubemap cubemapRef, int priority);
}
}
