...
internal enum TextureUsageMode {
	...
	// Range [0;kLightmapRGBMMax] packed to [0;1] with multiplier stored in the
	// alpha channel.
	BakedLightmapRGBM = 2,
...
public enum TextureImporterFormat {
	...
	[ System.Obsolete(
		  "Use textureCompression property instead") ] AutomaticCompressed = -1,
	// Choose a 16 bit format automatically.
	[ System.Obsolete(
		  "Use textureCompression property instead") ] Automatic16bit = -2,
	// Choose a Truecolor format automatically.
	[ System.Obsolete(
		  "Use textureCompression property instead") ] AutomaticTruecolor = -3,
	...
	[ System.Obsolete("Use ETC_RGB4 (UnityUpgradable) -> ETC_RGB4") ] ATC_RGB4 =
		35,
	[ System.Obsolete(
		  "Use ETC2_RGBA8 (UnityUpgradable) -> ETC2_RGBA8") ] ATC_RGBA8 = 36,
	...
	// ASTC uses 128bit block of varying sizes (we use only square blocks). It
	// does not distinguish RGB/RGBA
	ASTC_4x4 = 48,
	ASTC_5x5 = 49,
	ASTC_6x6 = 50,
	ASTC_8x8 = 51,
	...
	[System.Obsolete("Use ASTC_4x4 (UnityUpgradable) -> ASTC_4x4")] ASTC_RGB_4x4 =
		48,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete("Use ASTC_5x5 (UnityUpgradable) -> ASTC_5x5")] ASTC_RGB_5x5 =
		49,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete("Use ASTC_6x6 (UnityUpgradable) -> ASTC_6x6")] ASTC_RGB_6x6 =
		50,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete("Use ASTC_8x8 (UnityUpgradable) -> ASTC_8x8")] ASTC_RGB_8x8 =
		51,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_10x10 (UnityUpgradable) -> ASTC_10x10")] ASTC_RGB_10x10 = 52,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_12x12 (UnityUpgradable) -> ASTC_12x12")] ASTC_RGB_12x12 = 53,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_4x4 (UnityUpgradable) -> ASTC_4x4")] ASTC_RGBA_4x4 = 54,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_5x5 (UnityUpgradable) -> ASTC_5x5")] ASTC_RGBA_5x5 = 55,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_6x6 (UnityUpgradable) -> ASTC_6x6")] ASTC_RGBA_6x6 = 56,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_8x8 (UnityUpgradable) -> ASTC_8x8")] ASTC_RGBA_8x8 = 57,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_10x10 (UnityUpgradable) -> ASTC_10x10")] ASTC_RGBA_10x10 = 58,
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[System.Obsolete(
		 "Use ASTC_12x12 (UnityUpgradable) -> ASTC_12x12")] ASTC_RGBA_12x12 = 59,
...
public enum TextureImporterGenerateCubemap {
	...
	[System.Obsolete(
		 "This value is deprecated (use TextureImporter.textureShape instead).")] None =
		0,
	...
	[
		System.Obsolete(
			"Obscure shperemap modes are not supported any longer (use TextureImporterGenerateCubemap.Spheremap instead).")
	] SimpleSpheremap = 3,
	[
		System.Obsolete(
			"Obscure shperemap modes are not supported any longer (use TextureImporterGenerateCubemap.Spheremap instead).")
	...
	// Automatically determine type of cubemap generation from the source
	// image.
	AutoCubemap = 6
}
...
public enum TextureImporterType {
	Default = 0,
	[ System.Obsolete("Use Default (UnityUpgradable) -> Default") ] Image = 0,
	NormalMap = 1,
	[ System.Obsolete("Use NormalMap (UnityUpgradable) -> NormalMap") ] Bump = 1,
	GUI = 2,
	Sprite = 8,
	Cursor = 7,
	[
		System.Obsolete(
			"Use importer.textureShape = TextureImporterShape.TextureCube")
	] Cubemap = 3,
	[
		System.Obsolete(
			"Use a texture setup as a cubemap with glossy reflection instead")
	] Reflection = 3,
	Cookie = 4,
	Lightmap = 6,
	[ System.Obsolete("HDRI is not supported anymore") ] HDRI = 9,
	[
		System.Obsolete(
			"Use Default instead. All texture types now have an Advanced foldout (UnityUpgradable) -> Default")
	] Advanced = 5,
	SingleChannel = 10
}
...
public enum TextureImporterCompression {
	...
	CompressedHQ = 2,
	// Low quality compression formats but high Performance - low bandwidth - max
	// compression
	CompressedLQ = 3
}
...
public enum TextureResizeAlgorithm {
	...
	Mitchell = 0,
	// Might provide better result for some noise textures, when sharp details
	// wanted
	Bilinear = 1
}
