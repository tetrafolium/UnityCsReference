...
public struct TextureGenerationOutput {
	...
	public string importInspectorWarnings {
		get { return m_ImportInspectorWarnings; }
	}
	public string[] importWarnings {
		get { return m_ImportWarnings; }
	}
...
public bool containsAlpha {
	get { return m_SourceContainsAlpha; }
	set { m_SourceContainsAlpha = value; }
}
public bool hdr {
	get { return m_SourceWasHDR; }
	set { m_SourceWasHDR = value; }
}
}
...
public struct TextureGenerationSettings {
	...
	public TextureGenerationSettings(TextureImporterType type) {
		...
		m_PlatformSettings.compressionQuality =
		...
		m_Settings.wrapMode = m_Settings.wrapModeU = m_Settings.wrapModeV =
			m_Settings.wrapModeW = TextureWrapMode.Repeat;
		...
		case TextureImporterType.GUI:
			...
			m_Settings.aniso = 1;
			m_Settings.wrapMode = m_Settings.wrapModeU = m_Settings.wrapModeV =
				m_Settings.wrapModeW = TextureWrapMode.Clamp;
			break;
	...
	public bool qualifyForSpritePacking {
		get { return m_QualifyForSpritePacking; }
		set { m_QualifyForSpritePacking = value; }
	}
	...
	public SourceTextureInformation sourceTextureInformation {
		get { return m_SourceTextureInformation; }
		set { m_SourceTextureInformation = value; }
	}
	public SpriteImportData[] spriteImportData {
		get { return m_SpriteImportData; }
		set { m_SpriteImportData = value; }
	}
	public string spritePackingTag {
		get { return m_SpritePackingTag; }
		set { m_SpritePackingTag = value; }
	}
...
GenerateTexture(TextureGenerationSettings settings,
                NativeArray<Color32> colorBuffer) {
	return GenerateTextureImpl(settings, colorBuffer.GetUnsafeReadOnlyPtr(),
	                           colorBuffer.Length *
	                           UnsafeUtility.SizeOf<Color32>());
}

[NativeThrows]
[NativeMethod("GenerateTextureScripting")] extern static unsafe
TextureGenerationOutput
GenerateTextureImpl(TextureGenerationSettings settings,
                    void *colorBuffer, int colorBufferLength);
}
}
