...
public struct TextureGenerationOutput
{
    ...
    public string importInspectorWarnings {
        get {
            return m_ImportInspectorWarnings;
        }
    }
    public string[] importWarnings {
        get {
            return m_ImportWarnings;
        }
    }
...
public class SourceTextureInformation
{
    ...
    public bool containsAlpha {
        get {
            return m_SourceContainsAlpha;
        }
        set {
            m_SourceContainsAlpha = value;
        }
    }
    public bool hdr {
        get {
            return m_SourceWasHDR;
        }
        set {
            m_SourceWasHDR = value;
        }
    }
}
...
public struct TextureGenerationSettings
{
    ...
    public bool qualifyForSpritePacking {
        get {
            return m_QualifyForSpritePacking;
        }
        set {
            m_QualifyForSpritePacking = value;
        }
    }
    public bool enablePostProcessor {
        get {
            return m_EnablePostProcessor;
        }
        set {
            m_EnablePostProcessor = value;
        }
    }
    ...
    public SourceTextureInformation sourceTextureInformation {
        get {
            return m_SourceTextureInformation;
        }
        set {
            m_SourceTextureInformation = value;
        }
    }
    public SpriteImportData[] spriteImportData {
        ...
        set {
            m_SpriteImportData = value;
        }
    }
    public string spritePackingTag {
        get {
            return m_SpritePackingTag;
        }
        set {
            m_SpritePackingTag = value;
        }
    }
    public SecondarySpriteTexture[] secondarySpriteTextures {
        get {
            return m_SecondarySpriteTextures;
        }
        set {
            m_SecondarySpriteTextures = value;
        }
    }
}
