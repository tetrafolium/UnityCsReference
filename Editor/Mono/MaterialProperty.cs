...
public sealed partial class MaterialProperty
{
    ...
    public Vector2 rangeLimits {
        get {
            return m_RangeLimits;
        }
    }
    public bool hasMixedValue {
        get {
            return (m_MixedValueMask & 1) != 0;
        }
    }
    public ApplyPropertyCallback applyPropertyCallback {
        get {
            return m_ApplyPropertyCallback;
        }
        set {
            m_ApplyPropertyCallback = value;
        }
    }
