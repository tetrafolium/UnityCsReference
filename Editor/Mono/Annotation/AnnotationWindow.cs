...
internal class AnnotationWindow : EditorWindow
{
    ...
    {
        if (scriptClass != "")
            return m_ScriptAnnotations.Find(delegate(AInfo o) {
            return o.m_ScriptClass == scriptClass;
        });

        return m_BuiltinAnnotations.Find(delegate(AInfo o) {
            return o.m_ClassID == classID;
        });
    }
