...
public enum AndroidSdkVersions {
  ...
  [ Obsolete(
      "Minimum supported Android API level is 19 (Android 4.4 KitKat). Please use AndroidApiLevel19 or higher",
      true) ] AndroidApiLevel16 = 16,

  // Android 4.2, "Jelly Bean", API level 17
  [ Obsolete(
      "Minimum supported Android API level is 19 (Android 4.4 KitKat). Please use AndroidApiLevel19 or higher",
      true) ] AndroidApiLevel17 = 17,

  // Android 4.3, "Jelly Bean", API level 18
  [ Obsolete(
      "Minimum supported Android API level is 19 (Android 4.4 KitKat). Please use AndroidApiLevel19 or higher",
      true) ] AndroidApiLevel18 = 18,
...
public enum AndroidPreferredInstallLocation {
  ...
  // Force installation into internal memory. Needed for things like Live
  // Wallpapers
  ForceInternal = 2,
}
...
public partial class PlayerSettings : UnityEngine.Object {
  ...
  public partial class Android {
    ...
    [Obsolete(
        "use24BitDepthBuffer is deprecated, use disableDepthAndStencilBuffers instead.")]
    ...
    public static extern int bundleVersionCode {
      [NativeMethod("GetAndroidBundleVersionCode")] get;
      [NativeMethod("SetAndroidBundleVersionCode")] set;
    }

    // Minimal Android SDK version
    public static extern AndroidSdkVersions minSdkVersion {
      [NativeMethod("GetAndroidMinSdkVersion")] get;
      [NativeMethod("SetAndroidMinSdkVersion")] set;
    }

    // Target Android SDK version
    public static extern AndroidSdkVersions targetSdkVersion {
      [NativeMethod("GetAndroidTargetSdkVersion")] get;
      [NativeMethod("SetAndroidTargetSdkVersion")] set;
    }

    // Preferred application install location
    public static extern AndroidPreferredInstallLocation
        preferredInstallLocation {
      [NativeMethod("GetAndroidPreferredInstallLocation")] get;
      [NativeMethod("SetAndroidPreferredInstallLocation")] set;
    }

    // Force internet permission flag
    public static extern bool forceInternetPermission {
      [NativeMethod("GetForceAndroidInternetPermission")] get;
      [NativeMethod("SetForceAndroidInternetPermission")] set;
    }

    // Force SD card permission
    public static extern bool forceSDCardPermission {
      [NativeMethod("GetForceAndroidSDCardPermission")] get;
      [NativeMethod("SetForceAndroidSDCardPermission")] set;
    }
    ...
    public static extern bool ARCoreEnabled {
      get;
      set;
    }
    ...
    // Gamepad support level for Android TV
    internal static extern AndroidGamepadSupportLevel
    ...
    internal static extern bool createWallpaper {
      [NativeMethod("GetCreateAndroidWallpaper")] get;
      [NativeMethod("SetCreateAndroidWallpaper")] set;
    }

    // Targeted CPU architectures.
    public static extern AndroidArchitecture targetArchitectures {
      [NativeMethod("GetAndroidTargetArchitectures")] get;
      [NativeMethod("SetAndroidTargetArchitectures")] set;
    }

    // Support different CPU architectures with each APK (a.k.a. Multiple APK
    // support).
    public static extern bool buildApkPerCpuArchitecture {
      [NativeMethod("GetBuildApkPerCpuArchitecture")] get;
      [NativeMethod("SetBuildApkPerCpuArchitecture")] set;
    }

    // Android splash screen scale mode
    public static extern AndroidSplashScreenScale splashScreenScale {
      [NativeMethod("GetAndroidSplashScreenScale")] get;
      [NativeMethod("SetAndroidSplashScreenScale")] set;
    }
    ...
    ConvertAndroidKeystorePath(string keystoreName);

    [StaticAccessor("GetPlayerSettings().GetEditorOnly()",
                    StaticAccessorType.Dot)]
    internal static extern string
    ConvertAndroidKeystoreNameToFullPath(string keystoreName);

    [StaticAccessor("GetPlayerSettings().GetEditorOnly()",
                    StaticAccessorType.Dot)]
    internal static extern string
    ConvertAndroidKeystoreNameToPath(string keystoreName);

    // Android keystore name
    public static extern string keystoreName {
      [NativeMethod("GetAndroidKeystorePath")] get;
      [NativeMethod("SetAndroidKeystorePath")] set;
    }
    ...
    public static extern string keystorePass {
      [NativeMethod("GetAndroidKeystorePass")] get;
      [NativeMethod("SetAndroidKeystorePass")] set;
    }

    // Android key alias name
    public static extern string keyaliasName {
      [NativeMethod("GetAndroidKeyaliasName")] get;
      [NativeMethod("SetAndroidKeyaliasName")] set;
    }

    // Android key alias password
    public static extern string keyaliasPass {
      [NativeMethod("GetAndroidKeyaliasPass")] get;
      [NativeMethod("SetAndroidKeyaliasPass")] set;
    }

    // License verification flag
    public static extern bool licenseVerification {
      [NativeMethod("GetAndroidLicenseVerification")] get;
    }
    ...
    public static extern AndroidShowActivityIndicatorOnLoading
        showActivityIndicatorOnLoading {
      [NativeMethod("GetAndroidShowActivityIndicatorOnLoading")] get;
      [NativeMethod("SetAndroidShowActivityIndicatorOnLoading")] set;
    }

    // Android screen blit type
    public static extern AndroidBlitType blitType {
      [NativeMethod("GetAndroidBlitType")] get;
      [NativeMethod("SetAndroidBlitType")] set;
    }

    // enum { Legacy Wide Screen (1.86) = 0, Super Wide Screen (2.1) = 1, Custom
    // = 2 }
    internal static extern int supportedAspectRatioMode {
      [NativeMethod("GetAndroidSupportedAspectRatio")] get;
      [NativeMethod("SetAndroidSupportedAspectRatio")] set;
    }

    // Maximum aspect ratio that is supported by the app. Black bars are added
    // by Android OS if supportedAspectRatio is smaller than the screen aspect
    // ratio.
    ...
    private static void SetAndroidMaxAspectRatioInternal(float value) {
      if ((Mathf.Abs(value - 1.86f) <= 0.001f) || (value >= 1.86f)) {
        SetAndroidSupportedAspectRatio(
            2); // set supported aspect ratio mode to "Custom"
    ...
    internal static extern bool useLowAccuracyLocation {
      [NativeMethod("GetAndroidUseLowAccuracyLocation")] get;
    }
    ...
    public static extern bool startInFullscreen {
      [NativeMethod("GetAndroidStartInFullscreen")] get;
      [NativeMethod("SetAndroidStartInFullscreen")] set;
    }
    // Start application in fullscreen mode
    public static extern bool renderOutsideSafeArea {
      [NativeMethod("GetAndroidRenderOutsideSafeArea")] get;
      [NativeMethod("SetAndroidRenderOutsideSafeArea")] set;
    }

    // Validate release App Bundle size after build
    internal static extern bool validateAppBundleSize {
      get;
      set;
    }

    // App Bundle size which should cause warning message appear
    internal static extern int appBundleSizeToValidate {
      get;
      set;
    }
  }
