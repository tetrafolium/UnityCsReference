...
public sealed class EditorUserSettings : UnityObject
{
    ...
    public static extern bool overwriteFailedCheckoutAssets {
        get;
        set;
    }

    [NativeProperty("VCProjectOverlayIcons")]
    public static extern bool overlayIcons {
        get;
        set;
    }

    [NativeProperty("VCHierarchyOverlayIcons")]
    internal static extern bool hierarchyOverlayIcons {
        get;
        set;
    }

    [NativeProperty("VCOtherOverlayIcons")]
    internal static extern bool otherOverlayIcons {
        get;
        set;
    }
