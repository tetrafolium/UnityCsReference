...
GetMenuItemDefaultShortcuts(List<string> outItemNames,
...
internal static extern void
AddExistingMenuItem(string name, string existingMenuItemId, int priority);

[FreeFunction("MenuController::AddMenuItem")]
internal static extern void
AddMenuItem(string name, string shortcut, bool @checked, int priority,
            System.Action execute, System.Func<bool> validate);
