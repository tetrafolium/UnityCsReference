...
[Obsolete(
    "Use AndroidArchitecture instead. (UnityUpgradable) -> AndroidArchitecture",
    false)]
public enum AndroidTargetDevice {
      [Obsolete(
          "Use AndroidArchitecture.All instead. (UnityUpgradable) -> AndroidArchitecture.All",
          false)] FAT = 0,
      // ARMv6    = 1,
      // Emulator = 2,
      [ Obsolete(
          "Use AndroidArchitecture.ARMv7 instead. (UnityUpgradable) -> AndroidArchitecture.ARMv7",
          false) ] ARMv7 = 3,
  // x86      = 4,
}
// deprecated in 5.1.
[Obsolete(
    "TargetGlesGraphics is ignored, use SetGraphicsAPIs/GetGraphicsAPIs APIs",
    false)]
...
[Obsolete(
    "TargetIOSGraphics is ignored, use SetGraphicsAPIs/GetGraphicsAPIs APIs",
    false)]
...
[Flags]
[Obsolete(
    "Use UnityEngine.iOS.SystemGestureDeferMode instead. (UnityUpgradable) -> [UnityEngine] UnityEngine.iOS.SystemGestureDeferMode",
    true)]
...
partial class PlayerSettings {
  ...
  [System.ComponentModel.EditorBrowsable(
      System.ComponentModel.EditorBrowsableState.Never)]
  [Obsolete(
      "The option alwaysDisplayWatermark is deprecated and is always false",
      true)]
  ...
  public static TargetGlesGraphics targetGlesGraphics {
    get { return TargetGlesGraphics.Automatic; }
    set {}
  }
  [Obsolete(
      "targetIOSGraphics is ignored, use SetGraphicsAPIs/GetGraphicsAPIs APIs",
  ...
  public static TargetIOSGraphics targetIOSGraphics {
    get { return TargetIOSGraphics.Automatic; }
    set {}
  }

  // deprecated in 5.5
  [Obsolete(
      "Use PlayerSettings.iOS.locationUsageDescription instead (UnityUpgradable) -> UnityEditor.PlayerSettings/iOS.locationUsageDescription",
      false)]
  public static string locationUsageDescription {
    get { return iOS.locationUsageDescription; }
    set { iOS.locationUsageDescription = value; }
  }

  // deprecated in 5.5
  [Obsolete(
      "renderingPath is ignored, use UnityEditor.Rendering.TierSettings with UnityEditor.Rendering.SetTierSettings/GetTierSettings instead",
      false)]
  ...
  [Obsolete(
      "mobileRenderingPath is ignored, use UnityEditor.Rendering.TierSettings with UnityEditor.Rendering.SetTierSettings/GetTierSettings instead",
      false)]
...
partial class PlayerSettings {
  partial class Android {
    // deprecated in 2018.1
    [Obsolete(
        "Use targetArchitectures instead. (UnityUpgradable) -> targetArchitectures",
        false)]
    public static AndroidTargetDevice targetDevice {
      ...
      set { targetArchitectures = AndroidArchitecture.ARMv7; }
    }
  }

  partial class iOS {
    // deprecated in 5.0
    [Obsolete("exitOnSuspend is deprecated, use appInBackgroundBehavior",
              false)]
    ...
    // deprecated in 5.5
    [Obsolete(
        "Use PlayerSettings.muteOtherAudioSources instead (UnityUpgradable) -> UnityEditor.PlayerSettings.muteOtherAudioSources",
        false)]
    public static bool overrideIPodMusic {
      get { return PlayerSettings.muteOtherAudioSources; }
