...
// Use this method when checking if user hit Space or Return in order to
// activate the main action for a control, such as opening a popup menu or
// color picker.
internal static bool MainActionKeyForControl(this UnityEngine.Event evt,
                                             int controlId) {
