...
// Measured blocks may be nested, although the profiler does not do anything
// intelligent with it. Ie. you can measure a big code block as well as smaller
// code blocks within it. All measured times are printed when calling
// PrintTimes, at which point the timer is also reset.

// Note, out built-in profiler in Unity did not catch the code I needed to
// profile, hence I had to make this one.
...
private static Dictionary<string, float> m_Timers =
	new Dictionary<string, float>();
private static Dictionary<string, int> m_Calls =
