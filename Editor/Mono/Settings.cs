...
internal class PrefColor : IPrefType {
  ...
  public PrefColor() { m_Loaded = true; }

  public PrefColor(string name, float defaultRed, float defaultGreen,
                   float defaultBlue, float defaultAlpha) {
    this.m_Name = name;
    this.m_Color = this.m_DefaultColor =
        new Color(defaultRed, defaultGreen, defaultBlue, defaultAlpha);
  ...
  public PrefColor(string name, float defaultRed, float defaultGreen,
                   float defaultBlue, float defaultAlpha, float defaultRed2,
                   float defaultGreen2, float defaultBlue2,
                   float defaultAlpha2) {
    this.m_Name = name;
    this.m_Color = this.m_DefaultColor =
        new Color(defaultRed, defaultGreen, defaultBlue, defaultAlpha);
  ...
  public string ToUniqueString() {
    ...
    if (m_SeparateColors)
      return UnityString.Format("{0};{1};{2};{3};{4};{5};{6};{7};{8}", m_Name,
                                m_Color.r, m_Color.g, m_Color.b, m_Color.a,
                                m_OptionalDarkColor.r, m_OptionalDarkColor.g,
                                m_OptionalDarkColor.b, m_OptionalDarkColor.a);

    return UnityString.Format("{0};{1};{2};{3};{4}", m_Name, m_Color.r,
  ...
  public void FromUniqueString(string s) {
    ...
    bool success = float.TryParse(
        split[1], NumberStyles.Float,
        System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out r);
    success &= float.TryParse(
        split[2], NumberStyles.Float,
        System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out g);
    success &= float.TryParse(
        split[3], NumberStyles.Float,
        System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out b);
    success &= float.TryParse(
        split[4], NumberStyles.Float,
        System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out a);
    ...
    if (split.Length == 9) {
      ...
      split[8] = split [8]
                     .Replace(',', '.');
      success = float.TryParse(
          split[5], NumberStyles.Float,
          System.Globalization.CultureInfo.InvariantCulture.NumberFormat,
          out r);
      success &= float.TryParse(
          split[6], NumberStyles.Float,
          System.Globalization.CultureInfo.InvariantCulture.NumberFormat,
          out g);
      success &= float.TryParse(
          split[7], NumberStyles.Float,
          System.Globalization.CultureInfo.InvariantCulture.NumberFormat,
          out b);
      success &= float.TryParse(
          split[8], NumberStyles.Float,
          System.Globalization.CultureInfo.InvariantCulture.NumberFormat,
          out a);
...
internal class PrefSettings {
  ...
  static internal void Add(IPrefType value) { m_AddedPrefs.Add(value); }

  static internal T Get<T>(string name, T defaultValue) where T : IPrefType,
                                                                  new () {
    Load();

    if (defaultValue == null)
      throw new System.ArgumentException("default can not be null",
                                         "defaultValue");
  ...
  static internal void Set<T>(string name, T value) where T : IPrefType {
    Load();
  ...
  static internal IEnumerable<KeyValuePair<string, T>> Prefs<T>() where T
      : IPrefType {
    Load();
...
internal class SavedInt {
  ...
  public static implicit operator int(SavedInt s) { return s.value; }
}
...
internal class SavedFloat {
  ...
  public static implicit operator float(SavedFloat s) { return s.value; }
}
...
internal class SavedBool {
  ...
  public static implicit operator bool(SavedBool s) { return s.value; }
}
}
