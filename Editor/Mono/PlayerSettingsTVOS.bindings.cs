...
public enum tvOSSdkVersion { Device = 0, Simulator = 1 }

[System.Obsolete(
	 "targetOSVersion is obsolete. Use targetOSVersionString instead.", false)]
...
private static extern int sdkVersionInt {
	[NativeMethod("GettvOSSdkVersion")] get;
	[NativeMethod("SettvOSSdkVersion")] set;
}
...
[System.Obsolete(
	 "targetOSVersion is obsolete. Use targetOSVersionString instead.",
	 false)]
...
public static extern string targetOSVersionString {
	[NativeMethod("GettvOSTargetOSVersion")] get;
	[NativeMethod("SettvOSTargetOSVersion")] set;
}
...
internal static Texture2D[] GetTopShelfImageWideLayers2x() {
	return topShelfImageWideLayers2x;
}
internal static void SetTopShelfImageWideLayers2x(Texture2D[] layers) {
	topShelfImageWideLayers2x = layers;
}

// AppleTV Enable extended game controller
public static extern bool requireExtendedGameController {
	[NativeMethod("GettvOSRequireExtendedGameController")] get;
	[NativeMethod("SettvOSRequireExtendedGameController")] set;
}
}
}
}
