...
public class AnimationModeDriver : ScriptableObject {
  ...
  [UsedByNativeCode]
  internal bool InvokeIsKeyCallback_Internal(Object target,
                                             string propertyPath) {
...
public class AnimationMode {
  ...
  static private PrefColor s_AnimatedPropertyColor =
      new PrefColor("Animation/Property Animated", 0.82f, 0.97f, 1.00f, 1.00f,
                    0.54f, 0.85f, 1.00f, 1.00f);
  static private PrefColor s_RecordedPropertyColor =
      new PrefColor("Animation/Property Recorded", 1.00f, 0.60f, 0.60f, 1.00f,
                    1.00f, 0.50f, 0.50f, 1.00f);
  static private PrefColor s_CandidatePropertyColor =
      new PrefColor("Animation/Property Candidate", 1.00f, 0.70f, 0.60f, 1.00f,
                    1.00f, 0.67f, 0.43f, 1.00f);

  static public Color animatedPropertyColor {
    get { return s_AnimatedPropertyColor; }
  }
  static public Color recordedPropertyColor {
    get { return s_RecordedPropertyColor; }
  }
  static public Color candidatePropertyColor {
    get { return s_CandidatePropertyColor; }
  }
  ...
  extern public static bool IsPropertyAnimated(Object target,
                                               string propertyPath);
  extern internal static bool IsPropertyCandidate(Object target,
                                                  string propertyPath);
  ...
  AddCandidate(EditorCurveBinding binding, PropertyModification modification,
               bool keepPrefabOverride);

  [NativeThrows] extern internal static void
  AddCandidates([ NotNull ] GameObject gameObject,
  ...
  [NativeThrows] extern public static void BeginSampling();

  [NativeThrows] extern public static void EndSampling();

  [NativeThrows] extern public static void
  SampleAnimationClip([ NotNull ] GameObject gameObject,
                      [ NotNull ] AnimationClip clip, float time);

  [NativeThrows] extern internal static void
  SampleCandidateClip([ NotNull ] GameObject gameObject,
                      [ NotNull ] AnimationClip clip, float time);

  [NativeThrows] extern public static void
  SamplePlayableGraph(PlayableGraph graph, int index, float time);
  ...
  [NativeThrows] extern public static void
  AddEditorCurveBinding([ NotNull ] GameObject gameObject,
                        EditorCurveBinding binding);

  [NativeThrows] extern internal static void
  AddTransformTR([ NotNull ] GameObject root, string path);

  [NativeThrows] extern internal static void
  AddTransformTRS([ NotNull ] GameObject root, string path);

  [NativeThrows] extern internal static void
  InitializePropertyModificationForGameObject([ NotNull ] GameObject gameObject,
                                              [ NotNull ] AnimationClip clip);

  [NativeThrows] extern internal static void
  InitializePropertyModificationForObject([ NotNull ] Object target,
                                          [ NotNull ] AnimationClip clip);

  [NativeThrows] extern internal static void
  RevertPropertyModificationsForGameObject([ NotNull ] GameObject gameObject);

  [NativeThrows] extern internal static void
  RevertPropertyModificationsForObject([ NotNull ] Object target);

  // Returns editor curve bindings for animation clip and animator hierarchy
  // that need to be snapshot for animation mode.
  extern internal static EditorCurveBinding[] GetAllBindings(
      [ NotNull ] GameObject root, [ NotNull ] AnimationClip clip);

  // Returns editor curve bindings for animation clip that need to be snapshot
  // for animation mode.
  extern internal static EditorCurveBinding[] GetCurveBindings(
      [ NotNull ] AnimationClip clip);

  // Return editor curve bindings for animator hierarhcy that need to be
  // snapshot for animation mode.
  extern internal static EditorCurveBinding[] GetAnimatorBindings(
  ...
  Internal_StartCandidateRecording(Object driver);
}
}
