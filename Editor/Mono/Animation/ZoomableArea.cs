...
internal class ZoomableArea
{
    ...
    {
        get {
            return (hAllowExceedBaseRangeMax ? Mathf.Infinity : hBaseRangeMax);
        }
        set {
    ...
    {
        get {
            return (vAllowExceedBaseRangeMax ? Mathf.Infinity : vBaseRangeMax);
        }
        set {
    ...
    protected bool allowSliderZoomHorizontal {
        get {
            return m_EnableSliderZoomHorizontal && m_HScaleMin < m_HScaleMax;
        }
    }
    protected bool allowSliderZoomVertical {
        get {
            return m_EnableSliderZoomVertical && m_VScaleMin < m_VScaleMax;
        }
    }
    ...
    public float vSliderWidth {
        get {
            return vSlider ? styles.sliderWidth : 0f;
        }
    }
    public float hSliderHeight {
        get {
            return hSlider ? styles.sliderWidth : 0f;
        }
    }
    ...
    {
        get {
            return new Rect(drawRect.x, drawRect.y, drawRect.width + (m_VSlider ? styles.visualSliderWidth : 0), drawRect.height + (m_HSlider ? styles.visualSliderWidth : 0));
        }
        set
        {
