...
internal class AnimationWindowEvent : ScriptableObject {
  ...
  static public AnimationWindowEvent
  CreateAndEdit(GameObject root, AnimationClip clip, float time) {
    ...
    AnimationWindowEvent animationWindowEvent =
        CreateInstance<AnimationWindowEvent>();
  ...
  static public AnimationWindowEvent Edit(GameObject root, AnimationClip clip,
                                          int eventIndex) {
    AnimationWindowEvent animationWindowEvent =
        CreateInstance<AnimationWindowEvent>();
    animationWindowEvent.hideFlags = HideFlags.HideInHierarchy;
  ...
  static public AnimationWindowEvent Edit(AnimationClipInfoProperties clipInfo,
                                          int eventIndex) {
    AnimationWindowEvent animationWindowEvent =
        CreateInstance<AnimationWindowEvent>();
    animationWindowEvent.hideFlags = HideFlags.HideInHierarchy;
  ...
  static private int InsertAnimationEvent(ref AnimationEvent[] events,
                                          AnimationClip clip,
                                          AnimationEvent evt) {
    ...
    if (events[insertIndex].time != evt.time ||
        events[insertIndex].functionName != evt.functionName)
