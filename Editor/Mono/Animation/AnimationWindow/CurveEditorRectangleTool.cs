...
internal class CurveEditorRectangleTool : RectangleTool
{
    ...
    private bool hasSelection {
        get {
            return m_CurveEditor.hasSelection && !m_CurveEditor.IsDraggingCurveOrRegion();
        }
    }
    private Bounds selectionBounds {
        get {
            return m_CurveEditor.selectionBounds;
        }
    }

    private float frameRate {
        get {
            return m_CurveEditor.invSnap;
        }
    }
    private bool rippleTime {
        get {
            return m_CurveEditor.rippleTime;
        }
    }
