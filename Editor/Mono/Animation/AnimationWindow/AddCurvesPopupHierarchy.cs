...
internal class AddCurvesPopupHierarchy {
  ...
  public float GetContentWidth() { return m_ContentWidth; }
  ...
  public void InitIfNeeded(EditorWindow owner, Rect rect) {
    ...
    AddCurvesPopupHierarchyGUI gui =
        new AddCurvesPopupHierarchyGUI(m_TreeView, owner);

    m_TreeView.Init(rect, m_TreeViewDataSource, gui, null);
