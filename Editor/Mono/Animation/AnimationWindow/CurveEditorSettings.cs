...
internal TickStyle hTickStyle {
	get { return m_HTickStyle; }
	set { m_HTickStyle = value; }
}
internal TickStyle vTickStyle {
	get { return m_VTickStyle; }
	set { m_VTickStyle = value; }
}
...
public float hRangeMin {
	get { return m_HRangeMin; }
	set { m_HRangeMin = value; }
}
public float hRangeMax {
	get { return m_HRangeMax; }
	set { m_HRangeMax = value; }
}
public float vRangeMin {
	get { return m_VRangeMin; }
	set { m_VRangeMin = value; }
}
public float vRangeMax {
	get { return m_VRangeMax; }
	set { m_VRangeMax = value; }
}
public bool hasUnboundedRanges {
	get {
		return m_HRangeMin == Mathf.NegativeInfinity ||
...
// Offset to move the labels along the horizontal axis to make room for the
// overlaid scrollbar in the curve editor popup.
public float hTickLabelOffset = 0;
public EditorGUIUtility.SkinnedColor wrapColor =
	new EditorGUIUtility.SkinnedColor(new Color(1.0f, 1.0f, 1.0f, 0.5f),
	                                  new Color(.65f, .65f, .65f, 0.5f));
...
public Vector2 curveRegionDomain =
	new Vector2(0, 1); // X axis range in which to draw the shaded curve
                           // region between 2 curves.
...
internal RectangleToolFlags rectangleToolFlags =
	RectangleToolFlags.NoRectangleTool;
