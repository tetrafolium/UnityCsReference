...
internal class DopeSheetEditorRectangleTool : RectangleTool
{
    ...
    private bool hasSelection {
        get {
            return (m_State.selectedKeys.Count > 0);
        }
    }
    private Bounds selectionBounds {
        get {
            return m_State.selectionBounds;
        }
    }
    private float frameRate {
        get {
            return m_State.frameRate;
        }
    }
    private bool rippleTime {
        get {
            return m_State.rippleTime;
        }
    }

    private bool isDragging {
        get {
            return m_IsDragging || m_DopeSheetEditor.isDragging;
        }
    }
