...
internal class AnimEditor : ScriptableObject
{
    ...
    private float hierarchyWidth {
        get {
            return m_HorizontalSplitter.realSizes[0];
        }
    }
    private float contentWidth {
        get {
            return m_HorizontalSplitter.realSizes[1];
        }
    }
    ...
    {
        get {
            return (int)EditorGUI.kWindowToolbarHeight;
        }
    }
    ...
    static void ShowCurves(ShortcutArguments args)
    {
        ExecuteShortcut(args, animEditor => {
            animEditor.SwitchBetweenCurvesAndDopesheet();
        });
    }
    ...
    {
        ExecuteShortcut(args, animEditor => {
            animEditor.triggerFraming = true;
        });
    }
