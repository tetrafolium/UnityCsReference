...
internal static class AnimationWindowOptions {
  ...
  static AnimationWindowOptions() {
    m_TimeFormat = (TimeArea.TimeFormat) EditorPrefs.GetInt(
        kTimeFormat, (int) TimeArea.TimeFormat.TimeFrame);
  ...
  public static bool filterBySelection {
    get { return m_FilterBySelection; }
    set {
