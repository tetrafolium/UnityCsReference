...
internal class EulerCurveRenderer : CurveRenderer {
  ...
  public EulerCurveRenderer(int component,
                            EulerCurveCombinedRenderer renderer) {
  ...
  public float ClampedValue(float value) { return value; }

  public float RangeStart() { return renderer.RangeStart(); }
  public float RangeEnd() { return renderer.RangeEnd(); }
  public void SetWrap(WrapMode wrap) { renderer.SetWrap(wrap); }
  ...
  public void DrawCurve(float minTime, float maxTime, Color color,
    ...
    renderer.DrawCurve(minTime, maxTime, color, transform, component,
                       wrapColor);
  }
