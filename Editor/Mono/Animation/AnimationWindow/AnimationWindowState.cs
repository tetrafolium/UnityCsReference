...
internal class AnimationWindowState : ScriptableObject, ICurveEditorState
{
    ...
    public bool rippleTimeClutch {
        get {
            return m_RippleTimeClutch;
        }
        set {
            m_RippleTimeClutch = value;
        }
    }

    public bool showFrameRate {
        get {
            return AnimationWindowOptions.showFrameRate;
        }
        set {
            AnimationWindowOptions.showFrameRate = value;
        }
    }
    ...
    public bool previewing {
        get {
            return controlInterface.previewing;
        }
    }
    ...
    public bool recording {
        get {
            return controlInterface.recording;
        }
    }

    public bool canRecord {
        get {
            return controlInterface.canRecord;
        }
    }
    ...
    public bool playing {
        get {
            return controlInterface.playing;
        }
    }
    ...
    public int currentFrame {
        ...
        set {
            controlInterface.GoToFrame(value);
        }
    }
    public float currentTime {
        ...
        set {
            controlInterface.GoToTime(value);
        }
    }

    public TimeArea.TimeFormat timeFormat {
        get {
            return AnimationWindowOptions.timeFormat;
        }
        set {
            AnimationWindowOptions.timeFormat = value;
        }
    }
    ...
    {
        get {
            return timeArea.shownArea.xMin * timeArea.m_Scale.x * -1f;
        }
    }
    ...
    public float minVisibleTime {
        get {
            return m_TimeArea.shownArea.xMin;
        }
    }
    public float maxVisibleTime {
        get {
            return m_TimeArea.shownArea.xMax;
        }
    }
    public float visibleTimeSpan {
        get {
            return maxVisibleTime - minVisibleTime;
        }
    }
    public float minVisibleFrame {
        get {
            return minVisibleTime * frameRate;
        }
    }
    public float maxVisibleFrame {
        get {
            return maxVisibleTime * frameRate;
        }
    }
    public float visibleFrameSpan {
        get {
            return visibleTimeSpan * frameRate;
        }
    }
