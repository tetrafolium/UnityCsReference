...
[System.Serializable] struct AnimationKeyTime {
  [SerializeField]
  ...
  public float frameFloor {
    get { return ((float) frame - 0.5f) / frameRate; }
  }
  ...
  public float timeRound {
    get { return (float) frame / frameRate; }
  }
  ...
  public bool Equals(AnimationKeyTime key) {
    return m_Frame == key.m_Frame && m_FrameRate == key.m_FrameRate &&
