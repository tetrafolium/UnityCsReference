...
public EditorGUIUtility.SkinnedColor tickColor =
	new EditorGUIUtility.SkinnedColor(
		new Color(0.0f, 0.0f, 0.0f, 0.2f),
		new Color(.45f, .45f, .45f, 0.2f)); // color and opacity of ticks
public EditorGUIUtility.SkinnedColor labelColor =
	new EditorGUIUtility.SkinnedColor(
		new Color(0.0f, 0.0f, 0.0f, 0.32f),
		new Color(0.8f, 0.8f, 0.8f,
		          0.32f)); // color and opacity of tick labels
public int distMin =
	10; // min distance between ticks before they disappear completely
public int distFull =
	80; // distance between ticks where they gain full strength
