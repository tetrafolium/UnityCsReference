...
// NOTE: This is a quick solution for accessing editor prefs from background
// threads,
...
public static extern int GetInt(string key,
                                [ DefaultValue("0") ] int defaultValue);
...
GetFloat(string key, [ DefaultValue("0.0F") ] float defaultValue);
...
GetString(string key, [ DefaultValue("\"\"") ] string defaultValue);
...
GetBool(string key, [ DefaultValue("false") ] bool defaultValue);
