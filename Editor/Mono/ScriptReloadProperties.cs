...
internal sealed class ScriptReloadProperties : ScriptableObject {
  ...
  private void ManagedStore() {
    ...
    EditorGUI_TextEditor_hasHorizontalCursorPos =
        EditorGUI.s_RecycledEditor.hasHorizontalCursorPos;
    ...
    EditorGUI_TextEditor_graphicalCursorPos =
        EditorGUI.s_RecycledEditor.graphicalCursorPos;
    ...
    EditorGUI_DelayedTextEditor_cursorIndex =
        EditorGUI.s_DelayedTextEditor.cursorIndex;
    EditorGUI_DelayedTextEditor_selectIndex =
        EditorGUI.s_DelayedTextEditor.selectIndex;
    EditorGUI_DelayedTextEditor_controlID =
        EditorGUI.s_DelayedTextEditor.controlID;
    EditorGUI_DelayedTextEditor_hasHorizontalCursorPos =
        EditorGUI.s_DelayedTextEditor.hasHorizontalCursorPos;
    EditorGUI_DelayedTextEditor_scrollOffset =
        EditorGUI.s_DelayedTextEditor.scrollOffset;
    EditorGUI_DelayedTextEditor_hasFocus =
        EditorGUI.s_DelayedTextEditor.m_HasFocus;
    EditorGUI_DelayedTextEditor_graphicalCursorPos =
        EditorGUI.s_DelayedTextEditor.graphicalCursorPos;
    EditorGUI_DelayedTextEditor_content = EditorGUI.s_DelayedTextEditor.text;
    EditorGUI_DelayedControlThatHadFocusValue =
        EditorGUI.s_DelayedTextEditor.controlThatHadFocusValue;
  }
