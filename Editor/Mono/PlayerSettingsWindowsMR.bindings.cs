...
public sealed partial class PlayerSettings : UnityEngine.Object {
  ...
  public static partial class VRWindowsMixedReality {
    ...
    public static extern DepthBufferFormat depthBufferFormat {
      get;
      set;
    }

    [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
    [NativeProperty("vrSettings.hololens.depthBufferSharingEnabled",
                    TargetType.Field)]
    public static extern bool depthBufferSharingEnabled {
      get;
      set;
    }
  }
