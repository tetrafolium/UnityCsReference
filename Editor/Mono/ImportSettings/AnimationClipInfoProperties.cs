...
#pragma warning disable 0649
  [CacheProperty("name")] SerializedProperty m_Name;
  [CacheProperty("takeName")] SerializedProperty m_TakeName;
  [CacheProperty("internalID")] SerializedProperty m_InternalId;
  [CacheProperty("firstFrame")] SerializedProperty m_FirstFrame;
  [CacheProperty("lastFrame")] SerializedProperty m_LastFrame;
  [CacheProperty("wrapMode")] SerializedProperty m_WrapMode;
  [CacheProperty("loop")] SerializedProperty m_Loop;
  [CacheProperty("orientationOffsetY")] SerializedProperty m_OrientationOffsetY;
  [CacheProperty("level")] SerializedProperty m_Level;
  [CacheProperty("cycleOffset")] SerializedProperty m_CycleOffset;
  [CacheProperty("additiveReferencePoseFrame")] SerializedProperty
      m_AdditiveReferencePoseFrame;
  [CacheProperty("hasAdditiveReferencePose")] SerializedProperty
      m_HasAdditiveReferencePose;
  [CacheProperty("loopTime")] SerializedProperty m_LoopTime;
  [CacheProperty("loopBlend")] SerializedProperty m_LoopBlend;
  [CacheProperty("loopBlendOrientation")] SerializedProperty
      m_LoopBlendOrientation;
  [CacheProperty("loopBlendPositionY")] SerializedProperty m_LoopBlendPositionY;
  [CacheProperty("loopBlendPositionXZ")] SerializedProperty
      m_LoopBlendPositionXZ;
  [CacheProperty("keepOriginalOrientation")] SerializedProperty
      m_KeepOriginalOrientation;
  [CacheProperty("keepOriginalPositionY")] SerializedProperty
      m_KeepOriginalPositionY;
  [CacheProperty("keepOriginalPositionXZ")] SerializedProperty
      m_KeepOriginalPositionXZ;
  [CacheProperty("heightFromFeet")] SerializedProperty m_HeightFromFeet;
  [CacheProperty("mirror")] SerializedProperty m_Mirror;
  [CacheProperty("maskType")] SerializedProperty m_MaskType;
  [CacheProperty("maskSource")] SerializedProperty m_MaskSource;
  [CacheProperty("bodyMask")] SerializedProperty m_BodyMask;
  [CacheProperty("transformMask")] SerializedProperty m_TransformMask;
  [CacheProperty("curves")] SerializedProperty m_Curves;
  [CacheProperty("events")] SerializedProperty m_Events;
#pragma warning restore 0649
  ...
  public string takeName {
    get { return m_TakeName.stringValue; }
    set { m_TakeName.stringValue = value; }
  }
  public long internalID {
    get { return m_InternalId.longValue; }
    set { m_InternalId.longValue = value; }
  }
  public float firstFrame {
    get { return m_FirstFrame.floatValue; }
    set { m_FirstFrame.floatValue = value; }
  }
  public float lastFrame {
    get { return m_LastFrame.floatValue; }
    set { m_LastFrame.floatValue = value; }
  }
  public int wrapMode {
    get { return m_WrapMode.intValue; }
    set { m_WrapMode.intValue = value; }
  }
  public bool loop {
    get { return m_Loop.boolValue; }
    set { m_Loop.boolValue = value; }
  }

  // Mecanim animation properties
  public float orientationOffsetY {
    get { return m_OrientationOffsetY.floatValue; }
    set { m_OrientationOffsetY.floatValue = value; }
  }
  public float level {
    get { return m_Level.floatValue; }
    set { m_Level.floatValue = value; }
  }
  public float cycleOffset {
    get { return m_CycleOffset.floatValue; }
    set { m_CycleOffset.floatValue = value; }
  }
  public float additiveReferencePoseFrame {
    get { return m_AdditiveReferencePoseFrame.floatValue; }
    set { m_AdditiveReferencePoseFrame.floatValue = value; }
  }
  public bool hasAdditiveReferencePose {
    get { return m_HasAdditiveReferencePose.boolValue; }
    set { m_HasAdditiveReferencePose.boolValue = value; }
  }
  public bool loopTime {
    get { return m_LoopTime.boolValue; }
    set { m_LoopTime.boolValue = value; }
  }
  public bool loopBlend {
    get { return m_LoopBlend.boolValue; }
    set { m_LoopBlend.boolValue = value; }
  }
  public bool loopBlendOrientation {
    get { return m_LoopBlendOrientation.boolValue; }
    set { m_LoopBlendOrientation.boolValue = value; }
  }
  public bool loopBlendPositionY {
    get { return m_LoopBlendPositionY.boolValue; }
    set { m_LoopBlendPositionY.boolValue = value; }
  }
  public bool loopBlendPositionXZ {
    get { return m_LoopBlendPositionXZ.boolValue; }
    set { m_LoopBlendPositionXZ.boolValue = value; }
  }
  public bool keepOriginalOrientation {
    get { return m_KeepOriginalOrientation.boolValue; }
    set { m_KeepOriginalOrientation.boolValue = value; }
  }
  public bool keepOriginalPositionY {
    get { return m_KeepOriginalPositionY.boolValue; }
    set { m_KeepOriginalPositionY.boolValue = value; }
  }
  public bool keepOriginalPositionXZ {
    get { return m_KeepOriginalPositionXZ.boolValue; }
    set { m_KeepOriginalPositionXZ.boolValue = value; }
  }
  public bool heightFromFeet {
    get { return m_HeightFromFeet.boolValue; }
    set { m_HeightFromFeet.boolValue = value; }
  }
  public bool mirror {
    get { return m_Mirror.boolValue; }
    set { m_Mirror.boolValue = value; }
  }
  public ClipAnimationMaskType maskType {
    get { return (ClipAnimationMaskType) m_MaskType.intValue; }
    set { m_MaskType.intValue = (int) value; }
  }
  public AvatarMask maskSource {
    get { return (AvatarMask) m_MaskSource.objectReferenceValue; }
    set { m_MaskSource.objectReferenceValue = value; }
  }
  ...
  public bool MaskNeedsUpdating() {
    ...
    using(SerializedObject source = new SerializedObject(mask)) {
      if (!SerializedProperty.DataEquals(bodyMaskProperty,
                                         source.FindProperty("m_Mask")))
        return true;

      if (!SerializedProperty.DataEquals(transformMaskProperty,
                                         source.FindProperty("m_Elements")))
        return true;
    }
    ...
    if (bodyMask != null && bodyMask.isArray) {
      for (AvatarMaskBodyPart i = 0; i < AvatarMaskBodyPart.LastBodyPart; i++) {
        mask.SetHumanoidBodyPartActive(
            i, bodyMask.GetArrayElementAtIndex((int) i).intValue != 0);
      }
    }
  ...
  public void MaskToClip(AvatarMask mask) {
    ...
    if (bodyMask != null && bodyMask.isArray) {
      for (AvatarMaskBodyPart i = 0; i < AvatarMaskBodyPart.LastBodyPart; i++) {
        ...
        bodyMask.GetArrayElementAtIndex((int) i).intValue =
            mask.GetHumanoidBodyPartActive(i) ? 1 : 0;
      }
    }
  ...
  public string GetCurveName(int index) {
    ...
    if (curves != null && curves.isArray) {
      ret = curves.GetArrayElementAtIndex(index)
  ...
  public void SetCurveName(int index, string name) {
    ...
    if (curves != null && curves.isArray) {
      curves.GetArrayElementAtIndex(index)
          .FindPropertyRelative("name")
          .stringValue = name;
    }
  }
  ...
  public void AddCurve() {
    ...
    if (curves != null && curves.isArray) {
      ...
      curves.GetArrayElementAtIndex(curves.arraySize - 1)
          .FindPropertyRelative("name")
          .stringValue = "Curve";
      ...
      curves.GetArrayElementAtIndex(curves.arraySize - 1)
          .FindPropertyRelative("curve")
          .animationCurveValue = newCurve;
    }
  }
  ...
  public AnimationEvent GetEvent(int index) {
    ...
    if (events != null && events.isArray) {
      if (index < events.arraySize) {
        evt.floatParameter = events.GetArrayElementAtIndex(index)
                                 .FindPropertyRelative("floatParameter")
                                 .floatValue;
        evt.functionName = events.GetArrayElementAtIndex(index)
                               .FindPropertyRelative("functionName")
                               .stringValue;
        evt.intParameter = events.GetArrayElementAtIndex(index)
                               .FindPropertyRelative("intParameter")
                               .intValue;
        evt.objectReferenceParameter =
            events.GetArrayElementAtIndex(index)
                .FindPropertyRelative("objectReferenceParameter")
                .objectReferenceValue;
        evt.stringParameter = events.GetArrayElementAtIndex(index)
                                  .FindPropertyRelative("data")
                                  .stringValue;
        evt.time = events.GetArrayElementAtIndex(index)
  ...
  public void SetEvent(int index, AnimationEvent animationEvent) {
    ...
    if (events != null && events.isArray) {
      if (index < events.arraySize) {
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("floatParameter")
            .floatValue = animationEvent.floatParameter;
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("functionName")
            .stringValue = animationEvent.functionName;
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("intParameter")
            .intValue = animationEvent.intParameter;
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("objectReferenceParameter")
            .objectReferenceValue = animationEvent.objectReferenceParameter;
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("data")
            .stringValue = animationEvent.stringParameter;
        events.GetArrayElementAtIndex(index)
            .FindPropertyRelative("time")
            .floatValue = animationEvent.time;
      } else {
        Debug.LogWarning("Invalid Event Index");
      }
    }
  ...
  public void AddEvent(float time) {
    ...
    if (events != null && events.isArray) {
      ...
      events.GetArrayElementAtIndex(events.arraySize - 1)
          .FindPropertyRelative("functionName")
          .stringValue = "NewEvent";
      events.GetArrayElementAtIndex(events.arraySize - 1)
          .FindPropertyRelative("time")
          .floatValue = time;
    }
  ...
  public void AssignToPreviewClip(AnimationClip clip) {
    ...
    info.additiveReferencePoseTime =
        additiveReferencePoseFrame / clip.frameRate;
  ...
  public void ExtractFromPreviewClip(AnimationClip clip) {
    ...
    // Ensure that we don't accidentally dirty settings due to floating point
    // precision in the multiply / divide
    ...
    if (additiveReferencePoseFrame / clip.frameRate !=
        info.additiveReferencePoseTime)
      additiveReferencePoseFrame =
          FixPrecisionErrors(info.additiveReferencePoseTime * clip.frameRate);
  }
}
}
