...
internal class TextureImportPlatformSettingsData
{
    ...
    {
        get {
            return m_OverriddenIsDifferent;
        }
        set {
            m_OverriddenIsDifferent = value;
        }
    }
    ...
    {
        get {
            return isDefault || (platformTextureSettings.overridden && !overriddenIsDifferent);
        }
    }
    public bool isDefault
    {
        get {
            return platformTextureSettings.name == TextureImporterInspector.s_DefaultPlatformName;
        }
    }
    ...
    {
        get {
            return m_MaxTextureSizeIsDifferent;
        }
        set {
            m_MaxTextureSizeIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_ResizeAlgorithmIsDifferent;
        }
        set {
            m_ResizeAlgorithmIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_TextureCompressionIsDifferent;
        }
        set {
            m_TextureCompressionIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_CompressionQualityIsDifferent;
        }
        set {
            m_CompressionQualityIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_CrunchedCompressionIsDifferent;
        }
        set {
            m_CrunchedCompressionIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_TextureFormatIsDifferent;
        }
        set {
            m_TextureFormatIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_AlphaSplitIsDifferent;
        }
        set {
            m_AlphaSplitIsDifferent = value;
        }
    }
    ...
    {
        get {
            return m_AndroidETC2FallbackOverrideIsDifferent;
        }
        set {
            m_AndroidETC2FallbackOverrideIsDifferent = value;
        }
    }
    ...
    {
        get {
            return platformTextureSettings.forceMaximumCompressionQuality_BC6H_BC7 != 0;
        }
        set {
            platformTextureSettings.forceMaximumCompressionQuality_BC6H_BC7 = value ? 1 : 0;
        }
    }
