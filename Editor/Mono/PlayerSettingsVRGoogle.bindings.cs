...
namespace UnityEditor.XR.Daydream {
  public enum SupportedHeadTracking { ThreeDoF = 0, SixDoF = 1 }
}
...
public sealed partial class PlayerSettings : UnityEngine.Object {
  ...
  public static class VRCardboard {
    ...
    public extern static int depthFormat {
      [StaticAccessor("GetGoogleCardboardSettings()",
                      StaticAccessorType.Dot)] get;
      [StaticAccessor("GetGoogleCardboardSettingsForUpdate()",
  ...
  public static class VRDaydream {
    ...
    public extern static Texture2D daydreamIcon {
      [StaticAccessor("GetGoogleVREditorOnlySettings()",
                      StaticAccessorType.Dot)] get;
      [StaticAccessor("GetGoogleVREditorOnlySettingsForUpdate()",
                      StaticAccessorType.Dot)] set;
    }
    ...
    public extern static int depthFormat {
      ...
      [StaticAccessor("GetGoogleVRSettingsForUpdate()",
                      StaticAccessorType.Dot)] set;
    }
    [NativeProperty("minimumSupportedHeadTracking", TargetType.Field)]
    public extern static XR.Daydream
        .SupportedHeadTracking minimumSupportedHeadTracking {
      [StaticAccessor("GetGoogleVRSettings()", StaticAccessorType.Dot)] get;
      [StaticAccessor("GetGoogleVRSettingsForUpdate()",
                      StaticAccessorType.Dot)] set;
    }
    ...
    public extern static XR.Daydream
        .SupportedHeadTracking maximumSupportedHeadTracking {
      [StaticAccessor("GetGoogleVRSettings()", StaticAccessorType.Dot)] get;
      [StaticAccessor("GetGoogleVRSettingsForUpdate()",
                      StaticAccessorType.Dot)] set;
    }
