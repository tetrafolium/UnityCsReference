...
internal bool isUnityClass {
	get { return m_IsUnityClass; }
	set { m_IsUnityClass = value; }
}
}
...
internal RuntimeInitializeLoadType[] loadTypes {
	get { return m_LoadTypes; }
	set { m_LoadTypes = value; }
}
}
...
extern internal static string[] dontStripClassNames {
	get;
}

[NativeProperty(
	 "RuntimeInitializeClassMethodInfos")] extern internal static RuntimeInitializeMethodInfo
[] methodInfos {
	get;
}

[NativeMethod("UpdateExecutionOrderNumber")] extern internal static void
UpdateMethodExecutionOrders(int[] changedIndices, int[] changedOrder);
}
}
