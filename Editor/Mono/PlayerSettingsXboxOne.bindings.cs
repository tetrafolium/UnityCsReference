...
public sealed partial class PlayerSettings
{
    ...
    public sealed partial class XboxOne
    {
        ...
        extern public static XboxOneLoggingLevel defaultLoggingLevel {
            get;
            set;
        }
        ...
        extern public static string ProductId {
            get;
            set;
        }
        ...
        extern public static string UpdateKey {
            get;
            set;
        }
        ...
        extern public static string SandboxId {
            get;
            set;
        }
        ...
        extern public static string ContentId {
            get;
            set;
        }
        ...
        extern public static string TitleId {
            get;
            set;
        }
        ...
        extern public static string SCID {
            get;
            set;
        }
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static UInt32 PresentImmediateThreshold {
            get;
            set;
        }
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static bool Enable7thCore {
            get;
            set;
        }
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static bool DisableKinectGpuReservation {
            get;
            set;
        }
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static bool EnablePIXSampling {
            get;
            set;
        }
        ...
        extern public static string GameOsOverridePath {
            get;
            set;
        }
        ...
        extern public static string PackagingOverridePath {
            get;
            set;
        }
        ...
        extern public static string OverrideIdentityName {
            get;
            set;
        }
        ...
        extern public static string OverrideIdentityPublisher {
            get;
            set;
        }
        ...
        extern public static string AppManifestOverridePath {
            get;
            set;
        }
        ...
        extern public static string Description {
            get;
            set;
        }
        ...
        {
            get {
                return persistentLocalStorageSizeInternal;
            }
            set
            {
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static bool EnableTypeOptimization {
            get;
            set;
        }
        ...
        [StaticAccessor("GetPlayerSettings()", StaticAccessorType.Dot)]
        extern public static int monoLoggingLevel {
            get;
            set;
        }
