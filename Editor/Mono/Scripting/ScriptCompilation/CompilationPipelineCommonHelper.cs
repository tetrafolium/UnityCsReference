...
namespace UnityEditor.Scripting.ScriptCompilation {
  internal static class CompilationPipelineCommonHelper {
    ...
    public static bool ShouldAdd(string assemblyName) {
      ...
      if (name.StartsWith(k_UnityAssemblyPrefix,
                          StringComparison.OrdinalIgnoreCase) &&
          name.EndsWith(k_CompilerClientSuffix,
                        StringComparison.OrdinalIgnoreCase))
        return true;
    ...
    public static void
    UpdateScriptAssemblyReference(ref ScriptAssembly scriptAssembly) {
      ...
      newReferences[referencesLength] =
          AssetPath.Combine(EditorApplication.applicationContentsPath,
                            "Managed", "Unity.CompilationPipeline.Common.dll");
