...
namespace UnityEditor.Scripting.ScriptCompilation {
  internal struct ExpressionTypeKey {
    public bool Equals(ExpressionTypeKey other) {
      return m_LeftSymbol == other.m_LeftSymbol &&
             m_RightSymbol == other.m_RightSymbol &&
             m_HasSeparator == other.m_HasSeparator &&
             m_HasLeftSemVer == other.m_HasLeftSemVer &&
             m_HasRightSemVer == other.m_HasRightSemVer;
    }
    ...
    public ExpressionTypeKey(char leftSymbol = default(char),
                             char rightSymbol = default(char),
                             bool hasSeparator = false,
                             bool hasLeftSemVer = false,
                             bool hasRightSemVer = false) {
