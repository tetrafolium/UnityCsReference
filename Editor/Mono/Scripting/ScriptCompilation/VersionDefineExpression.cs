...
internal struct VersionDefineExpression {
	...
	public SemVersion Left {
		get;
	}
	public SemVersion Right {
		get;
	}
	...
	public VersionDefineExpression(
		Func<SemVersion, SemVersion, SemVersion, bool> isValid,
		SemVersion leftSemVersion, SemVersion rightSemVersion) {
		m_IsValid = isValid;
		m_AppliedRule = null;
		Left = leftSemVersion;
