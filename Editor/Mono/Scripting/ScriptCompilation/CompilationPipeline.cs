...
public class Assembly
{
    ...
    public string[] allReferences {
        get {
            return assemblyReferences.Select(a => a.outputPath).Concat(compiledAssemblyReferences).ToArray();
        }
    }
...
public static partial class CompilationPipeline
{
    ...
    {
        get {
            return IsScriptDebugInfoEnabled() ? CodeOptimization.Debug : CodeOptimization.Release;
        }
        set
        {
