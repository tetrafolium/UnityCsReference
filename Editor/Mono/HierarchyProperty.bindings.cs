...
public enum InspectorMode { Normal = 0, Debug = 1, DebugInternal = 2 }
...
public HierarchyProperty(HierarchyType hierarchyType, string rootPath,
                         bool forceImport) {
	m_Ptr = Internal_Create(hierarchyType, rootPath, forceImport);
}

[FreeFunction("HierarchyPropertyBindings::Internal_Create")]
static extern IntPtr Internal_Create(HierarchyType hierarchyType,
                                     string rootPath, bool forceImport);
...
[FreeFunction("HierarchyPropertyBindings::SetCustomScenes",
              HasExplicitThis = true)]
public extern void SetCustomScenes([ NotNull ] int[] sceneHandles);
[FreeFunction("HierarchyPropertyBindings::SetSubScenes",
              HasExplicitThis = true)]
public extern void
SetSubScenes([ NotNull ] SceneHierarchyHooks.SubSceneInfo[] subScenes);
public extern void Reset();

[FreeFunction("HierarchyPropertyBindings::Internal_Destroy",
              IsThreadSafe = true)]
...
public extern Object pptrValue {
	[FreeFunction("HierarchyPropertyBindings::PPtrValue",
...
[FreeFunction("HierarchyPropertyBindings::IsExpanded",
              HasExplicitThis = true)]
public extern bool IsExpanded(int[] expanded);

public extern string guid {
	[FreeFunction("HierarchyPropertyBindings::GetGuid",
	              HasExplicitThis = true)] get;
}
public extern bool alphaSorted {
	[NativeName("IsAlphaSorted")] get;
	set;
}
public extern bool showSceneHeaders {
	[NativeName("IsShowingSceneHeaders")] get;
	[NativeName("SetShowingSceneHeaders")] set;
}
public extern bool isValid {
	[NativeName("IsValid")] get;
}
public extern bool isMainRepresentation {
	[NativeName("IsMainAssetRepresentation")] get;
}
public extern bool hasFullPreviewImage {
	[NativeName("HasFullPreviewImage")] get;
}
public extern IconDrawStyle iconDrawStyle {
	get;
}
public extern bool isFolder {
	[NativeName("IsFolder")] get;
}
public extern GUID[] dynamicDependencies {
	get;
}

[FreeFunction("HierarchyPropertyBindings::Next", HasExplicitThis = true)]
public extern bool Next(int[] expanded);
[FreeFunction("HierarchyPropertyBindings::NextWithDepthCheck",
              HasExplicitThis = true)]
...
[FreeFunction("HierarchyPropertyBindings::CountRemaining",
              HasExplicitThis = true)]
...
internal void SetSearchFilter(SearchFilter filter) {
	SetSearchFilterImpl(SearchFilter.Split(filter.nameFilter),
	                    filter.classNames, filter.assetLabels,
	                    filter.assetBundleNames, filter.versionControlStates,
	                    filter.softLockControlStates,
	                    filter.referencingInstanceIDs, filter.sceneHandles,
	                    filter.GlobToRegex().ToArray(), filter.showAllHits);
}

[FreeFunction("HierarchyPropertyBindings::SetSearchFilterImpl",
              HasExplicitThis = true)] extern void
SetSearchFilterImpl(string[] nameFilters, string[] classNames,
                    string[] assetLabels, string[] assetBundleNames,
                    string[] versionControlStates,
                    string[] softLockControlStates,
                    int[] referencingInstanceIDs, int[] sceneHandles,
                    string[] regex, bool showAllHits);
[FreeFunction("HierarchyPropertyBindings::FindAllAncestors",
              HasExplicitThis = true)]
...
public static extern void FilterSingleSceneObject(int instanceID,
                                                  bool otherVisibilityState);
[FreeFunction("HierarchyPropertyBindings::SetFilteredVisibility",
              HasExplicitThis = true)]
