...
public static BuildTarget CalculateSelectedBuildTarget() {
	...
	case BuildTargetGroup.Standalone:
		return DesktopStandaloneBuildWindowExtension.GetBestStandaloneTarget(
	...
	default:
		...
		BuildPlatform platform =
			BuildPlatforms.instance.BuildPlatformFromTargetGroup(targetGroup);
		if (platform == null)
			throw new System.Exception(
				      "Could not find build platform for target group " + targetGroup);
