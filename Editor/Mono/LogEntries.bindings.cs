...
// All functions marked internal may not be called unless you call
// StartGettingEntries and EndGettingEntries
...
OpenFileOnSpecificLineAndColumn(string filePath, int line, int column);
...
public static extern void
GetLinesAndModeFromEntryInternal(int row, int numberOfLines, ref int mask,
                                 [ In, Out ] ref string outString);

[FreeFunction]
public static extern bool GetEntryInternal(int row,
                                           [ Out ] LogEntry outputEntry);
...
public static extern void
AddMessageWithDoubleClickCallback(LogEntry outputEntry);
}
}
