...
internal class Change
{
    ...
    public bool isRevertable {
        get {
            return HasRevertableState(RevertableStates.Revertable);
        }
    }
    public RevertableStates revertableState {
        get {
            return m_RevertableState;
        }
    }
    ...
    public bool isMeta {
        get {
            return HasState(Collab.CollabStates.kCollabMetaFile);
        }
    }
    public bool isConflict {
        get {
            return HasState(Collab.CollabStates.kCollabConflicted) || HasState(Collab.CollabStates.kCollabPendingMerge);
        }
    }
    public bool isFolderMeta {
        get {
            return HasState(Collab.CollabStates.kCollabFolderMetaFile);
        }
    }
    public bool isResolved {
        get {
            return HasState(Collab.CollabStates.kCollabUseMine) || HasState(Collab.CollabStates.kCollabUseTheir) || HasState(Collab.CollabStates.kCollabMerged);
        }
    }
