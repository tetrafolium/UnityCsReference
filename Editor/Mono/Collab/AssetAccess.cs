...
namespace UnityEditor.Collaboration {
  internal static class AssetAccess {
    ...
    public static bool
    TryGetAssetGUIDFromObject(UnityEngine.Object objectWithGUID,
    ...
    public static bool TryGetAssetFromGUID(string assetGUID,
    ...
    // Success: assigns the retrieval of the GUID to 'assetGUID' and returns
    // true.
    private static bool TryGetPrefabGUID(UnityEngine.Object gameObject,
                                         out string assetGUID) {
    ...
    // Success: assigns the GUID result from 'AssetDatabase' to 'assetGUID' and
    // returns true.
    private static bool
    TryGetAssetGUIDFromDatabase(UnityEngine.Object objectWithGUID,
                                out string assetGUID) {
      if (objectWithGUID == null) {
        throw new ArgumentNullException("objectWithGuid");
      }
