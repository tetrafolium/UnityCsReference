...
namespace UnityEditor.Collaboration {
  ...
  internal class CollabPublishDialog : EditorWindow {
    public static CollabPublishDialog ShowCollabWindow(string changelist) {
      CollabPublishDialog dialog =
          ScriptableObject.CreateInstance<CollabPublishDialog>();
    ...
    static GUIContent DescribeChangesText =
        EditorGUIUtility.TrTextContent("Describe your changes here");
    static GUIContent ChangeAssetsText =
        EditorGUIUtility.TrTextContent("Changed assets:");
    ...
    public CollabPublishDialog() { Options.Comments = ""; }

    public void OnGUI() {
      GUILayout.BeginVertical();
      GUILayout.Label(DescribeChangesText);
      Options.Comments =
          GUILayout.TextArea(Options.Comments, 1000, GUILayout.MinHeight(80));
      ...
      EditorGUILayout.SelectableLabel(Changelist, EditorStyles.textField,
  ...
  internal class CollabCannotPublishDialog : EditorWindow {
    public static CollabCannotPublishDialog
    ShowCollabWindow(string infoMessage) {
      CollabCannotPublishDialog dialog =
          ScriptableObject.CreateInstance<CollabCannotPublishDialog>();
