...
namespace UnityEditor.Collaboration {
  ...
  [NativeType(CodegenOptions = CodegenOptions.Custom,
              Header = "Editor/Src/Collab/CollabProgressInfo.h",
  ...
  internal class ProgressInfo {
    ...
    public int percentComplete {
      get {
        if (m_ProgressType == ProgressType.Percent ||
            m_ProgressType == ProgressType.Both) {
          return m_Percentage;
        }
    ...
    public bool isProgressTypeCount {
      get {
        return (m_ProgressType == ProgressType.Count ||
                m_ProgressType == ProgressType.Both);
      }
    }
    public bool isProgressTypePercent {
      get {
        return (m_ProgressType == ProgressType.Percent ||
                m_ProgressType == ProgressType.Both);
      }
    }
    public bool errorOccured {
      get { return (m_LastError != 0); }
    }
  }
}
