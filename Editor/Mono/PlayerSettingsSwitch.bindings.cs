...
public sealed partial class PlayerSettings
{
    ...
    public sealed partial class Switch
    {
        ...
        extern public static int socketMemoryPoolSize {
            get;
            set;
        }
        ...
        extern public static int socketAllocatorPoolSize {
            get;
            set;
        }
        ...
        extern public static int socketConcurrencyLimit {
            get;
            set;
        }
        ...
        extern public static bool useSwitchCPUProfiler {
            get;
            set;
        }
        ...
        extern public static bool useSwitchGOLDLinker {
            get;
            set;
        }
        ...
        extern public static int systemResourceMemory {
            get;
            set;
        }
        ...
        extern public static int defaultSwitchQueueCommandMemory {
            get;
        }

        [StaticAccessor("PlayerSettings", StaticAccessorType.DoubleColon)]
        extern public static int minimumSwitchQueueCommandMemory {
            get;
        }
        ...
        [StaticAccessor("PlayerSettings", StaticAccessorType.DoubleColon)]
        extern public static int defaultSwitchQueueControlMemory {
            get;
        }

        [StaticAccessor("PlayerSettings", StaticAccessorType.DoubleColon)]
        extern public static int minimumSwitchQueueControlMemory {
            get;
        }
        ...
        [StaticAccessor("PlayerSettings", StaticAccessorType.DoubleColon)]
        extern public static int defaultSwitchQueueComputeMemory {
            get;
        }
        ...
        extern public static ScreenResolutionBehavior screenResolutionBehavior {
            get;
            set;
        }

        [NativeProperty("switchNMETAOverride", TargetType.Function)]
        extern static private string NMETAOverrideInternal {
            get;
            set;
        }
        ...
        extern public static string applicationID {
            get;
            set;
        }
        ...
        extern public static string nsoDependencies {
            get;
            set;
        }
        ...
        extern static private string manualHTMLPathInternal {
            get;
            set;
        }

        [NativeProperty("switchAccessibleURLs", TargetType.Function)]
        extern static private string accessibleURLPathInternal {
            get;
            set;
        }

        [NativeProperty("switchLegalInformation", TargetType.Function)]
        extern static private string legalInformationPathInternal {
            get;
            set;
        }

        [NativeProperty("switchMainThreadStackSize", TargetType.Field)]
        extern public static int mainThreadStackSize {
            get;
            set;
        }

        [NativeProperty("switchPresenceGroupId", TargetType.Function)]
        extern public static string presenceGroupId {
            get;
            set;
        }

        [NativeProperty("switchLogoHandling", TargetType.Field)]
        extern public static LogoHandling logoHandling {
            get;
            set;
        }
        ...
        extern private static int cardSpecSizeInternal {
            get;
            set;
        }
        ...
        extern private static int cardSpecClockInternal {
            get;
            set;
        }

        [NativeProperty("switchRatingsMask", TargetType.Field)]
        extern public static int ratingsMask {
            get;
            set;
        }
        ...
        extern public static bool isUnderParentalControl {
            get;
            set;
        }

        [NativeProperty("switchAllowsScreenshot", TargetType.Field)]
        extern public static bool isScreenshotEnabled {
            get;
            set;
        }
        ...
        [NativeProperty("switchAllowsScreenshot", TargetType.Field)]
        extern public static bool isAllowsScreenshot {
            get;
            set;
        }

        [NativeProperty("switchAllowsVideoCapturing", TargetType.Field)]
        extern public static bool isVideoCapturingEnabled {
            get;
            set;
        }

        [NativeProperty("switchAllowsRuntimeAddOnContentInstall", TargetType.Field)]
        extern public static bool isRuntimeAddOnContentInstallEnabled {
            get;
            set;
        }

        [NativeProperty("switchDataLossConfirmation", TargetType.Field)]
        extern public static bool isDataLossConfirmationEnabled {
            get;
            set;
        }

        [NativeProperty("switchUserAccountLockEnabled", TargetType.Field)]
        extern public static bool isUserAccountLockEnabled {
            get;
            set;
        }
        ...
        [NativeProperty("switchDataLossConfirmation", TargetType.Field)]
        extern public static bool isDataLossConfirmation {
            get;
            set;
        }
        ...
        extern public static SupportedNpadStyle supportedNpadStyles {
            get;
            set;
        }
        ...
        extern public static int nativeFsCacheSize {
            get;
            set;
        }

        [NativeProperty("switchIsHoldTypeHorizontal", TargetType.Field)]
        extern public static bool isHoldTypeHorizontal {
            get;
            set;
        }

        [NativeProperty("switchSupportedNpadCount", TargetType.Field)]
        extern public static int supportedNpadCount {
            get;
            set;
        }
        ...
        extern public static bool socketConfigEnabled {
            get;
            set;
        }
        ...
        extern public static int tcpInitialSendBufferSize {
            get;
            set;
        }
        ...
        extern public static int tcpInitialReceiveBufferSize {
            get;
            set;
        }
        ...
        extern public static int tcpAutoSendBufferSizeMax {
            get;
            set;
        }
        ...
        extern public static int tcpAutoReceiveBufferSizeMax {
            get;
            set;
        }
        ...
        extern public static int udpSendBufferSize {
            get;
            set;
        }
        ...
        extern public static int udpReceiveBufferSize {
            get;
            set;
        }
        ...
        extern public static int socketBufferEfficiency {
            get;
            set;
        }
        ...
        extern public static bool socketInitializeEnabled {
            get;
            set;
        }
        ...
        extern public static bool networkInterfaceManagerInitializeEnabled {
            get;
            set;
        }
        ...
        extern public static bool playerConnectionEnabled {
            get;
            set;
        }
    }
