...
internal class SerializedPropertyFilters
{
    ...
    internal class String : SerializableFilter
    {
        ...
        public override bool Filter(SerializedProperty prop) {
            return prop.stringValue.IndexOf(m_Text, 0, System.StringComparison.OrdinalIgnoreCase) >= 0;
        }
    ...
    internal sealed class Name : String
    {
        public bool Filter(string str) {
            return str.IndexOf(m_Text, 0, System.StringComparison.OrdinalIgnoreCase) >= 0;
        }
    }
