...
internal static bool HandleDelayedDrag(Rect position, int id,
                                       Object objectToDrag) {
...
public static extern Object[] objectReferences {
	[NativeMethod("GetPPtrs")] get;
	[NativeMethod("SetPPtrs")] set;
}
