...
namespace UnityEditor.Experimental.Rendering {
  ...
  class ScriptableBakedReflectionSystemWrapper
      : IDisposable,
    ...
    internal IScriptableBakedReflectionSystem implementation {
      get;
      set;
    }

    internal ScriptableBakedReflectionSystemWrapper(IntPtr ptr) { m_Ptr = ptr; }

    ~ScriptableBakedReflectionSystemWrapper() { Dispose(false); }

    Hash128[] Internal_ScriptableBakedReflectionSystemWrapper_stateHashes {
      [RequiredByNativeCode] get {
        return implementation != null ? implementation.stateHashes : null;
      }
    }

    int Internal_ScriptableBakedReflectionSystemWrapper_stageCount {
      [RequiredByNativeCode] get {
        return implementation != null ? implementation.stageCount : 0;
      }
    }
    ...
    void IScriptableBakedReflectionSystemStageNotifier.EnterStage(
    ...
    [RequiredByNativeCode]
    void
    Internal_ScriptableBakedReflectionSystemWrapper_Tick(SceneStateHash deps) {
      if (Disposed)
        throw new ObjectDisposedException(
            "ScriptableBakedReflectionSystemWrapper");
    ...
    [RequiredByNativeCode]
    void
    Internal_ScriptableBakedReflectionSystemWrapper_SynchronizeReflectionProbes() {
      if (Disposed)
        throw new ObjectDisposedException(
            "ScriptableBakedReflectionSystemWrapper");
    ...
    [RequiredByNativeCode]
    bool
    Internal_ScriptableBakedReflectionSystemWrapper_BakeAllReflectionProbes() {
      if (Disposed)
        throw new ObjectDisposedException(
            "ScriptableBakedReflectionSystemWrapper");
    ...
    [StaticAccessor("ScriptableBakedReflectionSystem",
                    StaticAccessorType.DoubleColon)]
    static extern void ScriptingEnterStage(IntPtr objPtr, int stage,
