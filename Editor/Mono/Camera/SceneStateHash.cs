...
public struct SceneStateHash : IEquatable<SceneStateHash> {
	...
	public SceneStateHash(Hash128 sceneObjectsHash, Hash128 skySettingsHash,
	...
	public override bool Equals(object obj) {
		if (ReferenceEquals(null, obj))
			return false;
		return obj is SceneStateHash && Equals((SceneStateHash) obj);
	}

	public override int GetHashCode() {
		var h = new Hash128();
		unsafe {
			fixed(Hash128 *ptr = &m_SceneObjectsHash)
			h.Append(ptr, (ulong) sizeof(Hash128));
			fixed(Hash128 *ptr = &m_SkySettingsHash)
			h.Append(ptr, (ulong) sizeof(Hash128));
			fixed(Hash128 *ptr = &m_AmbientProbeHash)
			h.Append(ptr, (ulong) sizeof(Hash128));
		}
