...
sealed partial class UnityType
{
    ...
    public bool isAbstract {
        get {
            return (flags & UnityTypeFlags.Abstract) != 0;
        }
    }
    public bool isSealed {
        get {
            return (flags & UnityTypeFlags.Sealed) != 0;
        }
    }
    public bool isEditorOnly {
        get {
            return (flags & UnityTypeFlags.EditorOnly) != 0;
        }
    }
    ...
    {
        get {
            return hasNativeNamespace ? nativeNamespace + "::" + name : name;
        }
    }
    ...
    {
        get {
            return nativeNamespace.Length > 0;
        }
    }
