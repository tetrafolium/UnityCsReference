...
internal class TilemapCollider2DEditor : Collider2DEditorBase {
  ...
  private new static class Styles {
    public static readonly GUIContent maximumTileChangeCountLabel =
    ...
    public static readonly GUIContent extrusionFactorLabel =
        EditorGUIUtility.TrTextContent(
            "Extrusion Factor",
  ...
  public override void OnEnable() {
    base.OnEnable();
    m_MaximumTileChangeCount =
        serializedObject.FindProperty("m_MaximumTileChangeCount");
    m_ExtrusionFactor = serializedObject.FindProperty("m_ExtrusionFactor");
  }

  public override void OnInspectorGUI() {
    serializedObject.Update();
    EditorGUILayout.PropertyField(m_MaximumTileChangeCount,
                                  Styles.maximumTileChangeCountLabel);
    using(new EditorGUI.DisabledScope(
        !(target as TilemapCollider2D).usedByComposite))
        EditorGUILayout.PropertyField(m_ExtrusionFactor,
                                      Styles.extrusionFactorLabel);
    base.OnInspectorGUI();
