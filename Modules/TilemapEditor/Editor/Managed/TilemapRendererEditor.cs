...
public static readonly GUIContent materialLabel =
	EditorGUIUtility.TrTextContent(
		"Material", "Material to be used by TilemapRenderer");
public static readonly GUIContent maskInteractionLabel =
	EditorGUIUtility.TrTextContent(
		"Mask Interaction",
		"TilemapRenderer's interaction with a Sprite Mask");
}
...
public override void OnEnable() {
	...
	m_ChunkCullingBounds =
		serializedObject.FindProperty("m_ChunkCullingBounds");
	m_DetectChunkCullingBounds =
		serializedObject.FindProperty("m_DetectChunkCullingBounds");
}
...
public override void OnInspectorGUI() {
	...
	GUI.enabled = (!m_DetectChunkCullingBounds.hasMultipleDifferentValues &&
