...
namespace UnityEditorInternal.Profiling {
  internal abstract class ProfilerDetailedView {
    protected static readonly string kNoneText =
        LocalizationDatabase.GetLocalizedString("None");

    protected static class Styles {
      public static GUIContent emptyText = new GUIContent("");
      public static GUIContent selectLineText = EditorGUIUtility.TrTextContent(
          "Select Line for the detailed information");
