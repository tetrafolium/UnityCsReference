...
public class PackedMemorySnapshot
{
    ...
    public VirtualMachineInformation virtualMachineInformation {
        get {
            return m_VirtualMachineInformation;
        }
    }
}
...
public struct PackedNativeType
{
    ...
    public int baseClassId {
        get {
            return m_NativeBaseTypeArrayIndex;
        }
    }
...
public struct PackedNativeUnityEngineObject
{
    ...
    public bool isPersistent {
        get {
            return (m_Flags & ObjectFlags.IsPersistent) != 0;
        }
    }
    public bool isDontDestroyOnLoad {
        get {
            return (m_Flags & ObjectFlags.IsDontDestroyOnLoad) != 0;
        }
    }
    public bool isManager {
        get {
            return (m_Flags & ObjectFlags.IsManager) != 0;
        }
    }
    public string name {
        get {
...
public struct TypeDescription
{
    ...
    {
        get {
            return (m_Flags & TypeFlags.kValueType) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & TypeFlags.kArray) != 0;
        }
    }
    ...
    {
        get {
            return (int)(m_Flags & TypeFlags.kArrayRankMask) >> 16;
        }
    }
    ...
    public byte[] staticFieldBytes {
        get {
            return m_StaticFieldBytes;
        }
    }
    public int baseOrElementTypeIndex {
        get {
            return m_BaseOrElementTypeIndex;
        }
    }
    public int size {
        get {
...
public struct VirtualMachineInformation
{
    ...
    public int objectHeaderSize {
        get {
            return m_ObjectHeaderSize;
        }
    }
    public int arrayHeaderSize {
        get {
            return m_ArrayHeaderSize;
        }
    }
    public int arrayBoundsOffsetInHeader {
        get {
            return m_ArrayBoundsOffsetInHeader;
        }
    }
    public int arraySizeOffsetInHeader {
        get {
            return m_ArraySizeOffsetInHeader;
        }
    }
