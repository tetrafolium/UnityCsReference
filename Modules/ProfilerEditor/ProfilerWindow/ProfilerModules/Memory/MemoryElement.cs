...
internal class MemoryElement {
  ...
  public MemoryElement() { children = new List<MemoryElement>(); }
  ...
  public int AccumulatedChildCount() { return totalChildCount; }
  ...
  public int ReferenceCount() {
    return memoryInfo != null &&
           memoryInfo.referencedBy != null ? memoryInfo.referencedBy.Count : 0;
  }
  ...
  public MemoryElement FirstChild() { return children[0]; }
...
class MemoryElementSelection {
  ...
  public void ClearSelection() { m_Selected = null; }

  public bool isSelected(MemoryElement node) { return (m_Selected == node); }
