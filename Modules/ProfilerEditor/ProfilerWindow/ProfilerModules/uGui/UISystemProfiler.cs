...
internal class UISystemProfiler
{
    ...
    private static Styles.RenderMode PreviewRenderMode
    {
        ...
        set {
            EditorPrefs.SetInt(Styles.PrefOverdraw, (int)value);
        }
    }
    ...
    {
        get {
            return (Styles.PreviewBackgroundType)EditorPrefs.GetInt(Styles.PrefCheckerBoard, 0);
        }
        set {
            EditorPrefs.SetInt(Styles.PrefCheckerBoard, (int)value);
        }
    }
