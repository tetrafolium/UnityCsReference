...
/// <summary>
/// Calculates the time offset, in milliseconds, between the two specified
/// frames.
/// </summary>
/// <param name="fromFrameIndex"></param>
/// <param name="toFrameIndex"></param>
/// <returns>The time offset in milliseconds.</returns>
public static float TimeOffsetBetweenFrames(int fromFrameIndex,
                                            int toFrameIndex) {
...
private static float TimeOffsetForEarlierFrame(int fromFrameIndex,
                                               int toFrameIndex) {
	var timeOffset = 0f;
...
private static float TimeOffsetForLaterFrame(int fromFrameIndex,
                                             int toFrameIndex) {
	var timeOffset = 0f;
