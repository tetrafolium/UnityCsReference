...
internal abstract class CPUorGPUProfilerModule : ProfilerModuleBase, IProfilerSampleNameProvider
{
    ...
    {
        get {
            return !(m_ProfilerWindow == null || (m_ProfilerWindow.IsRecording() && (ProfilerDriver.IsConnectionEditor()))) || updateViewLive;
        }
    }
    ...
    string ViewTypeSettingsKey {
        get {
            return SettingsKeyPrefix + k_ViewTypeSettingsKey;
        }
    }
    string HierarchyViewSettingsKeyPrefix {
        get {
            return SettingsKeyPrefix + k_HierarchyViewSettingsKeyPrefix;
        }
    }
