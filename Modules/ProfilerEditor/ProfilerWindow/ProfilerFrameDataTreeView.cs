...
internal class ProfilerFrameDataTreeView : TreeView
{
    ...
    {
        get {
            return m_MultiColumnHeader.sortedProfilerColumn;
        }
    }
    ...
    {
        get {
            return m_MultiColumnHeader.sortedProfilerColumnAscending;
        }
    }
...
public class ProfilerFrameDataMultiColumnHeader : MultiColumnHeader
{
    ...
    {
        get {
            return GetProfilerColumn(sortedColumnIndex);
        }
    }
    public bool sortedProfilerColumnAscending
    {
        get {
            return IsSortedAscending(sortedColumnIndex);
        }
    }
