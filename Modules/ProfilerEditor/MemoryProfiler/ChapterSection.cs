...
namespace UnityEditorInternal.Profiling.Memory.Experimental {
  ...
  abstract class Chapter {
    ...
    internal Chapter(BinaryReader reader) { BuildChapter(reader); }

    internal uint GetBlockIndex() { return m_BlockIndex; }
  ...
  class SingleValueChapter : Chapter {
    ...
    internal SingleValueChapter(BinaryReader reader) : base(reader) {}
    ...
    internal override uint GetNumEntries() { return 1; }
  ...
  class ConstantSizeArrayChapter : Chapter {
    ...
    internal ConstantSizeArrayChapter(BinaryReader reader) : base(reader) {}
    ...
    internal override uint GetNumEntries() { return m_NumEntries; }
  ...
  class DynamicSizeArrayChapter : Chapter {
    ...
    internal DynamicSizeArrayChapter(BinaryReader reader) : base(reader) {}
    ...
    internal override uint GetSizeForEntryIndex(uint entryIndex) {
      Debug.Assert(entryIndex < m_NumEntries);
      return (uint)(m_BlockOffsets[entryIndex + 1] -
                    m_BlockOffsets[entryIndex]);
    }
