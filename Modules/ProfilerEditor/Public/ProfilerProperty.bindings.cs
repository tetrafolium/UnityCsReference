...
public partial class ProfilerProperty : IDisposable {
  ...
  public ProfilerProperty() { m_Ptr = Internal_Create(); }
  ...
  public extern bool HasChildren { [NativeMethod("HasChildren")] get; }
  ...
  public extern string propertyPath { [NativeMethod("GetFunctionPath")] get; }
  ...
  public static Texture2D UISystemProfilerRender(int frameIndex,
                                                 int renderDataIndex,
                                                 int renderDataCount,
                                                 bool renderOverdraw) {
    return UISystemProfilerRender_Internal(IntPtr.Zero, frameIndex,
                                           renderDataIndex, renderDataCount,
                                           renderOverdraw);
  }
  ...
  UISystemProfilerRender_Internal(IntPtr ptr, int frameIndex,
                                  int renderDataIndex, int renderDataCount,
                                  bool renderOverdraw);
  ...
  ~ProfilerProperty() { FreeNativeResources(); }
}
}
