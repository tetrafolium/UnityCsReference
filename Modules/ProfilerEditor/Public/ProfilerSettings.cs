...
internal class ProfilerUserSettings
{
    ...
    public static bool rememberLastRecordState
    {
        ...
        set {
            EditorPrefs.SetBool(k_RememberLastRecordStateSettingKey, value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool(k_DefaultRecordStateSettingKey, true);
        }
        set {
            EditorPrefs.SetBool(k_DefaultRecordStateSettingKey, value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool(k_ShowStatsLabelsOnCurrentFrameSettingKey, false);
        }
        set {
    ...
    {
        get {
            return (ProfilerEditorTargetMode)EditorPrefs.GetInt(k_DefaultTargetModeSettingKey, (int)ProfilerEditorTargetMode.Playmode);
        }
        set {
            EditorPrefs.SetInt(k_DefaultTargetModeSettingKey, (int)value);
        }
    }
