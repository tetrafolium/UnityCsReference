...
public partial class ProfilerFrameDataIterator : IDisposable {
  ...
  public ProfilerFrameDataIterator() { m_Ptr = Internal_Create(); }
  ...
  ~ProfilerFrameDataIterator() { FreeNativeResources(); }
  ...
  public extern int group { get; }

  public extern int depth { get; }

  /// <summary>
  /// The maximal depth of the stacked samples. This count includes the thread
  /// root as well as counters.
  /// </summary>
  public extern int maxDepth { get; }

  public extern string path { [NativeMethod("GetFunctionPath")] get; }

  public extern string name { [NativeMethod("GetFunctionName")] get; }

  public extern int sampleId { get; }
  ...
  public extern float startTimeMS { get; }

  public extern float durationMS { get; }

  public extern string extraTooltipInfo {
    [NativeMethod("GetExtraTooltipInfo")] get;
  }
