...
public class AudioSampleProvider : IDisposable
{
    ...
    {
        get {
            return InternalGetMaxSampleFrameCount(id);
        }
    }
    ...
    {
        get {
            return InternalGetAvailableSampleFrameCount(id);
        }
    }
    ...
    {
        get {
            return InternalGetFreeSampleFrameCount(id);
        }
    }
