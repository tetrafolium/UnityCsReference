...
// Keep this enum in sync with the one defined in "NavMeshBindingTypes.h"
public enum NavMeshCollectGeometry { RenderMeshes = 0, PhysicsColliders = 1 }

// Struct containing source geometry data and annotation for runtime navmesh
// building
[UsedByNativeCode]
...
public struct NavMeshBuildSource {
	...
	public Object sourceObject {
		get { return InternalGetObject(m_InstanceID); }
		set { m_InstanceID = value != null? value.GetInstanceID() : 0; }
	}
	public Component component {
		get { return InternalGetComponent(m_ComponentID); }
		set { m_ComponentID = value != null? value.GetInstanceID() : 0; }
	}
...
public struct NavMeshBuildMarkup {
	public bool overrideArea {
		get { return m_OverrideArea != 0; }
		set { m_OverrideArea = value ? 1 : 0; }
	}
	public int area {
		get { return m_Area; }
		set { m_Area = value; }
	...
	public bool ignoreFromBuild {
		get { return m_IgnoreFromBuild != 0; }
		set { m_IgnoreFromBuild = value ? 1 : 0; }
	}
	public Transform root {
		get { return InternalGetRootGO(m_InstanceID); }
		set { m_InstanceID = value != null? value.GetInstanceID() : 0; }
	}
