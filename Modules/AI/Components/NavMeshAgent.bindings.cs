...
// current path. (RO)
public extern Vector3 steeringTarget {
	get;
}

// The desired velocity of the agent including any potential contribution
// from avoidance. (RO)
public extern Vector3 desiredVelocity {
	get;
}
...
public extern bool isOnOffMeshLink {
	[NativeName("IsOnOffMeshLink")] get;
}
