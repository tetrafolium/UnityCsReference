...
namespace UnityEngine.Experimental.Video {
  ...
  [StaticAccessor("VideoPlayerExtensionsBindings",
                  StaticAccessorType.DoubleColon)]
  public static class VideoPlayerExtensions {
    public static AudioSampleProvider
    GetAudioSampleProvider(this VideoPlayer vp, ushort trackIndex) {
    ...
    extern internal static uint
    InternalGetAudioSampleProviderId(this VideoPlayer vp, ushort trackIndex);
  }
}
