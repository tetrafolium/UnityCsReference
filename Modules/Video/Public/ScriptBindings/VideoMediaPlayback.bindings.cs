...
[assembly:InternalsVisibleTo("Unity.Audio.DSPGraph.Tests")]
  ...
  internal class VideoPlaybackMgr : IDisposable {
    ...
    public VideoPlaybackMgr() { m_Ptr = Internal_Create(); }
    ...
    extern public VideoPlayback
    CreateVideoPlayback(string fileName, MessageCallback errorCallback,
                        Callback readyCallback, Callback reachedEndCallback,
