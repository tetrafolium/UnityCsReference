...
namespace UnityEngine.Video {
  ...
  public sealed class VideoPlayer : Behaviour {
    ...
    public extern bool isPrepared { [NativeName("IsPrepared")] get; }
    ...
    public extern bool isPaused { [NativeName("IsPaused")] get; }

    public extern bool canSetTime { [NativeName("CanSetTime")] get; }
    ...
    public extern bool canStep { [NativeName("CanStep")] get; }

    public extern void StepForward();

    public extern bool canSetPlaybackSpeed {
      [NativeName("CanSetPlaybackSpeed")] get;
    }
    ...
    public extern bool canSetTimeSource {
      [NativeName("CanSetTimeSource")] get;
    }
    ...
    public extern bool canSetSkipOnDrop {
      [NativeName("CanSetSkipOnDrop")] get;
    }
    ...
    public ushort controlledAudioTrackCount {
      get { return GetControlledAudioTrackCount(); }

      set {
        int maxNumTracks = controlledAudioTrackMaxCount;
        if (value > maxNumTracks)
          throw new ArgumentException(
              string.Format("Cannot control more than {0} tracks.",
                            maxNumTracks),
              "value");
    ...
    public extern bool canSetDirectAudioVolume {
      [NativeName("CanSetDirectAudioVolume")] get;
    }
    ...
    public extern void SetTargetAudioSource(ushort trackIndex,
                                            AudioSource source);
    ...
    public delegate void FrameReadyEventHandler(VideoPlayer source,
                                                long frameIdx);
    ...
    public extern bool sendFrameReadyEvents {
      [NativeName("AreFrameReadyEventsEnabled")] get;
      [NativeName("EnableFrameReadyEvents")] set;
    }
    ...
    [RequiredByNativeCode]
    private static void
    InvokePrepareCompletedCallback_Internal(VideoPlayer source) {
      if (source.prepareCompleted != null)
        source.prepareCompleted(source);
    }

    [RequiredByNativeCode]
    private static void InvokeFrameReadyCallback_Internal(VideoPlayer source,
                                                          long frameIdx) {
    ...
    [RequiredByNativeCode]
    private static void
    InvokeLoopPointReachedCallback_Internal(VideoPlayer source) {
    ...
    [RequiredByNativeCode]
    private static void
    InvokeFrameDroppedCallback_Internal(VideoPlayer source) {
      if (source.frameDropped != null)
        source.frameDropped(source);
    }

    [RequiredByNativeCode]
    private static void InvokeErrorReceivedCallback_Internal(VideoPlayer source,
                                                             string errorStr) {
    ...
    [RequiredByNativeCode]
    private static void
    InvokeSeekCompletedCallback_Internal(VideoPlayer source) {
    ...
    [RequiredByNativeCode]
    private static void
    InvokeClockResyncOccurredCallback_Internal(VideoPlayer source,
                                               double seconds) {
