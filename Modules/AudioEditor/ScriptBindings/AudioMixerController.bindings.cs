...
internal partial class AudioMixerController : AudioMixer
{
    ...
    public extern int numExposedParameters {
        [NativeMethod("AudioMixerControllerBindings::GetNumExposedParameters", HasExplicitThis = true, IsFreeFunction = true)] get;
    }
    ...
    public AudioMixerSnapshotController TargetSnapshot {
        get {
            return (AudioMixerSnapshotController)currentSnapshot;
        }
        set {
