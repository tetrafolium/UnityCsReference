...
namespace UnityEditor.Audio {
  ...
  [NativeHeader(
      "Modules/AudioEditor/ScriptBindings/AudioMixerController.bindings.h")]
  internal partial class AudioMixerController : AudioMixer {
    public AudioMixerController() { Internal_CreateAudioMixerController(this); }

    [FreeFunction(
        "AudioMixerControllerBindings::Internal_CreateAudioMixerController")]
    private static extern void
    Internal_CreateAudioMixerController([ Writable ] AudioMixerController mono);

    private static void
    GetGroupsRecurse(AudioMixerGroupController group,
    ...
    public extern int numExposedParameters {
      [NativeMethod("AudioMixerControllerBindings::GetNumExposedParameters",
                    HasExplicitThis = true, IsFreeFunction = true)] get;
    }
    ...
    public extern AudioMixerGroupController masterGroup {
      [NativeName("GetMasterGroupController")] get;
      [NativeName("SetMasterGroupController")] set;
    }
    ...
    public AudioMixerSnapshotController TargetSnapshot {
      get { return (AudioMixerSnapshotController) currentSnapshot; }
      set { currentSnapshot = value; }
    }

    private extern AudioMixerSnapshot currentSnapshot {
      get;
      set;
    }
    ...
    public AudioMixerSnapshotController[] snapshots {
      get {
        return System.Array.ConvertAll(
            snapshots_Internal, ams =>(AudioMixerSnapshotController) ams);
      }
      set {
        snapshots_Internal =
            System.Array.ConvertAll(value, amsc =>(AudioMixerSnapshot) amsc);
        ValidateSnapshots();
      }
    }

    [NativeName("Snapshots")]
    private extern AudioMixerSnapshot[] snapshots_Internal {
      get;
      set;
    }
    ...
    [NativeMethod("AudioMixerControllerBindings::GetGroupVUInfo",
                  HasExplicitThis = true, IsFreeFunction = true)]
    public extern int GetGroupVUInfo(GUID group, bool fader, float[] vuLevel,
                                     float[] vuPeak);
    ...
    static internal extern bool CheckForCyclicReferences(AudioMixer mixer,
