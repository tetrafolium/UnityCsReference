...
namespace UnityEditor.Audio {
  ...
  [NativeHeader(
      "Modules/AudioEditor/ScriptBindings/AudioMixerSnapshotController.bindings.h")]
  internal class AudioMixerSnapshotController : AudioMixerSnapshot {
    ...
    [FreeFunction(
        "AudioMixerSnapshotControllerBindings::Internal_CreateAudioMixerSnapshotController")]
    private static extern void Internal_CreateAudioMixerSnapshotController(
        [ Writable ] AudioMixerSnapshotController mono, AudioMixer owner);
    ...
    public extern void SetTransitionTypeOverride(GUID guid,
                                                 ParameterTransitionType type);
    public extern bool
    GetTransitionTypeOverride(GUID guid, out ParameterTransitionType type);
