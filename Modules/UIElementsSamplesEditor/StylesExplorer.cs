...
namespace UnityEditor.UIElements.Samples {
  internal class StylesExplorer {
    ...
    private static readonly string s_StylesExplorerClassName =
        "unity-samples-window__styles-explorer";
    private static readonly string s_ScrollViewContainerClassName =
        "unity-styles-explorer__scroll_view_container";

    private static readonly string s_StylePanelDarkClassName =
        "unity-samples-window__style-panel--dark";
    private static readonly string s_StylePanelLightClassName =
        "unity-samples-window__style-panel--light";

    private static readonly string s_StylePanelClassName =
        "unity-samples-window__style-panel";
    private static readonly string s_StyleSectionClassName =
        "unity-samples-window__style-section";
    private static readonly string s_StyleSectionLabelClassName =
        "unity-samples-window__style-section-label";
    private static readonly string s_StyleSectionInnerContainerClassName =
        "unity-samples-window__style-section-inner-container";
    private static readonly string s_StyleSectionMainContainerClassName =
        "unity-samples-window__style-section-main-container";
    private static readonly string s_StyleSectionSecondaryContainerClassName =
        "unity-samples-window__style-section-secondary-container";
    private static readonly string s_StyleFoldoutClassName =
        "unity-samples-window__style-foldout";

    private static readonly int s_MinWidthForDualColumn = 690;

    internal static VisualElement
    Create(UIElementsSamples.SampleTreeItem item) {
      ...
      innerContainer.RegisterCallback<GeometryChangedEvent>(
          ContainerGeometryChange);
      ...
      leftPanel.styleSheets.Add(
          UIElementsEditorUtility.s_DefaultCommonDarkStyleSheet);
      rightPanel.styleSheets.Add(
          UIElementsEditorUtility.s_DefaultCommonLightStyleSheet);
    ...
    private static VisualElement CreateStandardSection<T>() where T
        : VisualElement,
          new () {
      ...
      if (tname == "Toggle" || tname == "Button") {
        ...
        Add<T>(secondary,
               PseudoStates.Hover | PseudoStates.Active | PseudoStates.Checked);
        Add<T>(secondary,
               PseudoStates.Focus | PseudoStates.Active | PseudoStates.Checked);
      }
    ...
    private static T Add<T>(VisualElement parent,
                            PseudoStates pseudo = 0) where T : VisualElement,
                                                               new () {
      var element = new T();
      ...
      ApplyModificationsToInputs(element, BaseField<int>.inputUssClassName,
                                 pseudo);
    ...
    private static void ApplyModificationsToInputs(VisualElement element,
                                                   string className,
                                                   PseudoStates pseudo) {
      element.Query(classes
                    : new string[]{className})
          .ForEach(e => { e.pseudoStates |= pseudo; });
    }
  }
}
