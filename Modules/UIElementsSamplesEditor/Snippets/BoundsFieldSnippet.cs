...
internal override void Apply(VisualElement container) {
	...
	uxmlField.value = new Bounds(new Vector3(1.1f, 2.2f, 3.3f),
	                             new Vector3(2.2f, 4.4f, 6.6f));
	...
	uxmlField.RegisterCallback<ChangeEvent<Bounds> >(
		(evt) => { csharpField.value = evt.newValue; });
	/// </sample>
}
}
}
