...
namespace UnityEditor.UIElements.Samples {
  internal class ElementSnippet<T> where T : new () {
    private static readonly string s_CodeContainerClassName =
        "unity-snippet-code__container";
    private static readonly string s_CodeTitleClassName =
        "unity-snippet-code__title";
    private static readonly string s_CodeClassName = "unity-snippet-code__code";
    private static readonly string s_CodeLineNumbersClassName =
        "unity-snippet-code__code-line-numbers";
    private static readonly string s_CodeTextClassName =
        "unity-snippet-code__code-text";
    private static readonly string s_CodeInputClassName =
        "unity-snippet-code__input";
    private static readonly string s_CodeCodeOuterContainerClassName =
        "unity-snippet-code__code_outer_container";
    private static readonly string s_CodeCodeContainerClassName =
        "unity-snippet-code__code_container";

    private static readonly string s_DemoContainerClassName =
        "unity-samples-explorer__demo-container";
    private static readonly string s_SnippetsContainer =
        "unity-samples-explorer__snippets-container";

    private static readonly string s_SampleBeginTag = "/// <sample>";
    private static readonly string s_SampleEndTag = "/// </sample>";

    private static readonly string s_TextAssetsPath =
        "UIPackageResources/Snippets/Generated/";
    private static readonly string s_AssetsPath =
        "UIPackageResources/Snippets/";
    ...
    private static string ProcessCSharp(string text) {
      ...
      for (int i = actualStartIndex; i < endIndex; ++i) {
        ...
        leadingWhiteSpace =
            text.Substring(actualStartIndex, i - actualStartIndex);
        actualStartIndex = i;
        break;
      }
    ...
    private static VisualElement CreateSnippetCode(string title, string path) {
      ...
      var code = new TextField(TextField.kMaxLengthNone, true, false,
                               char.MinValue){value = text};
    ...
    Create(UIElementsSamples.SampleTreeItem item) {
      ...
      var ussTextAssetPath =
          s_TextAssetsPath + "StyleSheets/" + tname + "_uss.asset";
      var uxmlTextAssetPath =
          s_TextAssetsPath + "UXML/" + tname + "_uxml.asset";
