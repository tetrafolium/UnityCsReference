...
void UpdateShortcutTableSearchFilter() {
	...
	foreach (var filter in filters) {
		var filterElement = new TextElement(){
			text = filter
		};
...
public Keyboard(
	...
	var mainContainer = new VisualElement(){
		name = "fullKeyboardContainer"
	};

	var compactContainer =
		new VisualElement(){
		name = "compactKeyboardContainer"
	};
	var cursorControlContainer =
		new VisualElement(){
		name = "cursorControlKeyboardContainer"
	};
