...
namespace UnityEditor.Experimental.GraphView {
  ...
  public class GraphViewMinimapWindow : GraphViewToolWindow {
    ...
    protected override void OnGraphViewChanged() {
      ...
      if (m_MiniMap == null) // Probably called from base.OnEnable(). We're not
                             // ready just yet.
        return;
    ...
    void GraphViewRedrawn() { m_MiniMap.MarkDirtyRepaint(); }

    protected override bool IsGraphViewSupported(GraphView gv) { return true; }
  }
}
