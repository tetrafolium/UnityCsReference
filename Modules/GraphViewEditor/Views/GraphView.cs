...
HashSet<string> selectedElements {
	get;
}
}
...
VisualElement graphViewContainer {
	get;
}
...
private UQueryState<GraphElement> allGraphElements {
	get;
}
...
public static void CalculateFrameTransform(Rect rectToFit, Rect clientRect,
	...
	var screenRect =
		new Rect {
		xMin = border, xMax = clientRect.width - border,
