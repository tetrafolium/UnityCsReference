...
public abstract class GraphView : VisualElement, ISelection
{
    ...
    {
        get {
            return contentViewContainer.transform;
        }
    }
    ...
    {
        get {
            return m_ZoomerMaxElementCountWithPixelCacheRegen;
        }
        set
        {
    ...
    public virtual void BuildContextualMenu(ContextualMenuPopulateEvent evt)
    {
        ...
        {
            evt.menu.AppendAction("Cut", (a) => {
                CutSelectionCallback();
            },
            (a) => {
                return canCutSelection ? DropdownMenuAction.Status.Normal : DropdownMenuAction.Status.Disabled;
            });
        }
        if (evt.target is GraphView || evt.target is Node || evt.target is Group)
        {
            ...
            (a) => {
                return canCopySelection ? DropdownMenuAction.Status.Normal : DropdownMenuAction.Status.Disabled;
            });
        }
        ...
        if (evt.target is GraphView || evt.target is Node || evt.target is Group || evt.target is Edge)
        {
            ...
            (a) => {
                return canDeleteSelection ? DropdownMenuAction.Status.Normal : DropdownMenuAction.Status.Disabled;
            });
        }
        if (evt.target is GraphView || evt.target is Node || evt.target is Group)
        {
            ...
            (a) => {
                return canDuplicateSelection ? DropdownMenuAction.Status.Normal : DropdownMenuAction.Status.Disabled;
            });
            evt.menu.AppendSeparator();
        }
    }
    ...
    {
        get {
            return CanPasteSerializedData(clipboard);
        }
    }
