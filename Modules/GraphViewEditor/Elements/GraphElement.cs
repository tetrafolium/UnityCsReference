...
namespace UnityEditor.Experimental.GraphView {
  public abstract class GraphElement : VisualElement, ISelectable {
    ...
    static CustomStyleProperty<int> s_LayerProperty =
        new CustomStyleProperty<int>("--layer");
    ...
    internal ResizeRestriction resizeRestriction {
      get;
      set;
    }
    ...
    static GraphElement() { RegisterAll(); }

    ClickSelector m_ClickSelector;

    public virtual bool IsSelectable() {
      return (capabilities & Capabilities.Selectable) ==
                 Capabilities.Selectable &&
             visible && resolvedStyle.display != DisplayStyle.None;
    }
    ...
    public virtual bool IsAscendable() {
      return (capabilities & Capabilities.Ascendable) ==
    ...
    public virtual void UpdatePresenterPosition() {
      // This can be overridden by derived class to get notified when a
      // manipulator has *finished* changing the layout (size or position) of
      // this element.
    }

    public virtual Rect GetPosition() { return layout; }

    public virtual void SetPosition(Rect newPos) { layout = newPos; }
    ...
    public virtual void Select(VisualElement selectionContainer,
                               bool additive) {
    ...
    static void RegisterAll() {
      ...
      VisualElementFactoryRegistry.RegisterFactory(
          new ResizableElement.UxmlFactory());
      VisualElementFactoryRegistry.RegisterFactory(
          new StickyNote.UxmlFactory());
    }
  }
}
