...
// color for lines
internal static PrefColor s_SnappingLineColor =
	new PrefColor("General/Graph Snapping Line Color", 68 / 255f,
	              192 / 255f, 255 / 255f, 0.2f);
...
void OnGenerateVisualContent(MeshGenerationContext mgc) {
	...
	foreach (Line2 line in lines) {
		...
		mgc.Rectangle(MeshGenerationContextUtils.RectangleParams.MakeSolid(
				      rect, s_SnappingLineColor, ContextType.Editor));
	}
}
}
}
