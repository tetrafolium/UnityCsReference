...
namespace UnityEditor.Experimental.GraphView {
  public class RectUtils {
    ...
    public static Rect Inflate(Rect a, float left, float top, float right,
                               float bottom) {
      return new Rect{xMin = a.xMin - left, yMin = a.yMin - top,
                      xMax = a.xMax + right, yMax = a.yMax + bottom};
    }
  }
}
