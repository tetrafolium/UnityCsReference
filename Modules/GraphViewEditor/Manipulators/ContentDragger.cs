...
namespace UnityEditor.Experimental.GraphView {
  ...
  public class ContentDragger : MouseManipulator {
    ...
    public ContentDragger() {
      ...
      activators.Add(
          new ManipulatorActivationFilter{button = MouseButton.MiddleMouse});
      panSpeed = new Vector2(1, 1);
      clampToParentEdges = false;
    }

    protected Rect CalculatePosition(float x, float y, float width,
                                     float height) {
    ...
    protected void OnMouseDown(MouseDownEvent e) {
      ...
      m_Start = graphView.ChangeCoordinatesTo(graphView.contentViewContainer,
    ...
    protected void OnMouseMove(MouseMoveEvent e) {
      ...
      Vector2 diff = graphView.ChangeCoordinatesTo(
                         graphView.contentViewContainer, e.localMousePosition) -
                     m_Start;
