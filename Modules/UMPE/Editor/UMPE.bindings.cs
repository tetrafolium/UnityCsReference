...
namespace UnityEditor.MPE {
  ...
  {[Obsolete("... (UnityUpgradable) -> Undefined")] UMP_EVENT_UNDEFINED = 0,
   Undefined = 0,

   [ Obsolete("... (UnityUpgradable) -> Create") ] UMP_EVENT_CREATE = 1,
   Create = 1,

   [ Obsolete("... (UnityUpgradable) -> Initialize") ] UMP_EVENT_INITIALIZE = 2,
   Initialize = 2,
   ...
   [ Obsolete("... (UnityUpgradable) -> Shutdown") ] UMP_EVENT_SHUTDOWN = 4,
   Shutdown = 4 }

  [MovedFrom("Unity.MPE")]
  public enum ProcessLevel // Keep in sync with ProcessService.h
  {[Obsolete("... (UnityUpgradable) -> Undefined")] UMP_UNDEFINED = 0,
   Undefined = 0,

   [ Obsolete("... (UnityUpgradable) -> Master") ] UMP_MASTER = 1,
   Master = 1,

   [ Obsolete("... (UnityUpgradable) -> Slave") ] UMP_SLAVE = 2,
   Slave = 2 }

  [MovedFrom("Unity.MPE")]
  public enum ProcessState // Keep in sync with ProcessService.h
  {[Obsolete("... (UnityUpgradable) -> UnknownProcess")] UMP_UNKNOWN_PROCESS =
       0,
   UnknownProcess = 0,
   [
   ...
   FinishedWithError = 2,
   [ Obsolete("... (UnityUpgradable) -> Running") ] UMP_RUNNING = 3,
   Running = 3 }
  ...
  public struct ChannelInfo : IEquatable<ChannelInfo> {
    public static ChannelInfo invalidChannel =
        new ChannelInfo(){m_ChannelId = -1};

    [NativeName("channelName")] string m_ChannelName;

    [NativeName("channelId")] int m_ChannelId;

    public string name => m_ChannelName;

    public int id => m_ChannelId;

    public bool Equals(ChannelInfo obj) { return this == obj; }
  ...
  public struct ChannelClientInfo : IEquatable<ChannelClientInfo> {
    public static ChannelClientInfo invalidClient =
        new ChannelClientInfo(){m_ChannelClientId = -1, m_ConnectionId = -1};

    [NativeName("channelName")] string m_ChannelName;

    [NativeName("channelClientId")] int m_ChannelClientId;

    [NativeName("connectionId")] int m_ConnectionId;
    ...
    public bool Equals(ChannelClientInfo obj) { return this == obj; }
  ...
  public class ProcessService {
    ...
    public static extern int LaunchSlave(string roleName,
    ...
    public static extern void
        ApplyPropertyModifications(PropertyModification[] modifications);
