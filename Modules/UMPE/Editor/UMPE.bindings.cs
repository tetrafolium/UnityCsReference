...
public struct ChannelClientInfo : IEquatable<ChannelClientInfo> {
	public static ChannelClientInfo invalidClient =
		new ChannelClientInfo(){
		m_ChannelClientId = -1, m_ConnectionId = -1
	};
...
public static extern ProcessLevel level {
	get;
}
public static extern string roleName {
	get;
}
...
public static extern int ConnectionId {
	get;
}
