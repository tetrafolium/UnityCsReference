...
namespace UnityEditor.MPE {
  ...
  public partial class ChannelClient {
    internal static Dictionary<int, ChannelClient> s_Clients =
        new Dictionary<int, ChannelClient>();
    ...
    public bool IsConnected() { return IsConnected(clientId); }
    ...
    public void Stop() { Stop(clientId); }
    ...
    public void Tick() { Tick(clientId); }

    public void Send(string data) { Send(clientId, data); }

    public void Send(byte[] data) { Send(clientId, data); }
    ...
    public int NewRequestId() { return NewRequestId(clientId); }
  ...
  public struct ChannelClientScope : IDisposable {
    ...
    public ChannelClient client {
      get;
      private set;
    }
    public ChannelClientScope(bool autoTick, string channelName,
                              Action<string> handler,
                              bool closeClientOnExit = true) {
