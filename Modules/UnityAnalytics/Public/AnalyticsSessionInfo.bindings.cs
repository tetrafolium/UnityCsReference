...
namespace UnityEngine.Analytics {
  ...
  public static class AnalyticsSessionInfo {
    public delegate void SessionStateChanged(AnalyticsSessionState sessionState,
                                             long sessionId,
    ...
    CallSessionStateChanged(AnalyticsSessionState sessionState, long sessionId,
    ...
    public extern static AnalyticsSessionState sessionState {
      [NativeMethod("GetPlayerSessionState")] get;
    }

    public extern static long sessionId {
      [NativeMethod("GetPlayerSessionId")] get;
    }

    public extern static long sessionCount {
      [NativeMethod("GetPlayerSessionCount")] get;
    }

    public extern static long sessionElapsedTime {
      [NativeMethod("GetPlayerSessionElapsedTime")] get;
    }

    public extern static bool sessionFirstRun {
      [NativeMethod("GetPlayerSessionFirstRun", false, true)] get;
    }

    public extern static string userId { [NativeMethod("GetUserId")] get; }
    ...
    private extern static string identityTokenInternal {
      [NativeMethod("GetIdentityToken")] get;
    }

    [StaticAccessor("GetUnityAnalytics()", StaticAccessorType.Dot)]
    private extern static string customUserIdInternal {
      [NativeMethod("GetCustomUserId")] get;
      [NativeMethod("SetCustomUserId")] set;
    }

    [StaticAccessor("GetUnityAnalytics()", StaticAccessorType.Dot)]
    private extern static string customDeviceIdInternal {
      [NativeMethod("GetCustomDeviceId")] get;
      [NativeMethod("SetCustomDeviceId")] set;
    }
  }
}
