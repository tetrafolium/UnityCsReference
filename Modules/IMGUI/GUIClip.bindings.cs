...
internal static extern bool enabled {
	[FreeFunction(
		 "GetGUIState().m_CanvasGUIState.m_GUIClipState.GetEnabled")] get;
}

// The visible rectangle.
internal static extern Rect visibleRect {
	[FreeFunction(
		 "GetGUIState().m_CanvasGUIState.m_GUIClipState.GetVisibleRect")] get;
}
...
internal static extern Rect topmostRect {
	[FreeFunction(
		 "GetGUIState().m_CanvasGUIState.m_GUIClipState.GetTopMostPhysicalRect")] get;
}

// Push a clip rect to the stack with pixel offsets.
internal static extern void Internal_Push(Rect screenRect,
...
[FreeFunction(
	 "GetGUIState().m_CanvasGUIState.m_GUIClipState.GetAbsoluteMousePosition")]
...
// Set the GUIMatrix. This is here as this class handles all coordinate
// transforms anyways.
...
[FreeFunction(
	 "GetGUIState().m_CanvasGUIState.m_GUIClipState.GetParentTransform")]
internal static extern Matrix4x4 GetParentMatrix();

internal static extern void Internal_PushParentClip(Matrix4x4 objectTransform,
                                                    Rect clipRect);
