...
internal delegate bool DrawHandler(GUIStyle style, Rect rect,
...
internal readonly struct DrawStates {
  public DrawStates(bool isHover, bool isActive, bool on, bool hasKeyboardFocus)
      : this(-1, isHover, isActive, on, hasKeyboardFocus) {}

  public DrawStates(int controlId, bool isHover, bool isActive, bool on,
  ...
  public DrawStates(int controlId, bool isHover, bool isActive, bool on,
                    bool hasKeyboardFocus, bool drawSelectionAsComposition,
                    int cursorFirst, int cursorLast, Color cursorColor,
