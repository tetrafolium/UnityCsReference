...
public sealed partial class GUISettings {
  ...
  public bool doubleClickSelectsWord {
    get { return m_DoubleClickSelectsWord; }
    set { m_DoubleClickSelectsWord = value; }
  }
  [SerializeField] bool m_DoubleClickSelectsWord = true;

  // Should triple-clicking select whole text in text fields.
  public bool tripleClickSelectsLine {
    get { return m_TripleClickSelectsLine; }
    set { m_TripleClickSelectsLine = value; }
  }
  [SerializeField] bool m_TripleClickSelectsLine = true;
  ...
  [SerializeField] Color m_CursorColor = Color.white;
  ...
  [SerializeField] float m_CursorFlashSpeed = -1;
  ...
  [SerializeField] Color m_SelectionColor = new Color(.5f, .5f, 1f);
}
...
public sealed class GUISkin : ScriptableObject {
  ...
  // *undocumented*
  public GUISkin() { m_CustomStyles = new GUIStyle[1]; }

  internal void OnEnable() { Apply(); }
  ...
  [SerializeField] // yes the attribute applies to all fields on the line below.
      GUIStyle m_box,
      m_button, m_toggle, m_label, m_textField, m_textArea, m_window;
  ...
  [SerializeField] GUIStyle m_horizontalSlider;
  [SerializeField] GUIStyle m_horizontalSliderThumb;
  [NonSerialized] GUIStyle m_horizontalSliderThumbExtent;
  [SerializeField] GUIStyle m_verticalSlider;
  [SerializeField] GUIStyle m_verticalSliderThumb;
  [NonSerialized] GUIStyle m_verticalSliderThumbExtent;

  // Style used by default for the background part of GUI::ref::HorizontalSlider
  // controls.
  ...
  // Style used by default for the thumb extent in GUI::ref::HorizontalSlider
  // controls.
  ...
  // Style used by default for the extended region around the thumb in
  // GUI::ref::HorizontalSlider controls.
  internal GUIStyle horizontalSliderThumbExtent {
    get { return m_horizontalSliderThumbExtent; }
    set {
  ...
  // Style used by default for the background part of GUI::ref::VerticalSlider
  // controls.
  ...
  // GUI::ref::VerticalSlider controls.
  ...
  internal GUIStyle verticalSliderThumbExtent {
    get { return m_verticalSliderThumbExtent; }
    set {
  ...
  [SerializeField] GUIStyle m_horizontalScrollbar;
  [SerializeField] GUIStyle m_horizontalScrollbarThumb;
  [SerializeField] GUIStyle m_horizontalScrollbarLeftButton;
  [SerializeField] GUIStyle m_horizontalScrollbarRightButton;

  // Style used by default for the background part of
  // GUI::ref::HorizontalScrollbar controls.
  ...
  // Style used by default for the left button on GUI::ref::HorizontalScrollbar
  // controls.
  public GUIStyle horizontalScrollbarLeftButton {
    get { return m_horizontalScrollbarLeftButton; }
    set {
      m_horizontalScrollbarLeftButton = value;
      Apply();
    }
  }
  // Style used by default for the right button on GUI::ref::HorizontalScrollbar
  // controls.
  public GUIStyle horizontalScrollbarRightButton {
    get { return m_horizontalScrollbarRightButton; }
    set {
  ...
  [SerializeField] GUIStyle m_verticalScrollbar;
  [SerializeField] GUIStyle m_verticalScrollbarThumb;
  [SerializeField] GUIStyle m_verticalScrollbarUpButton;
  [SerializeField] GUIStyle m_verticalScrollbarDownButton;

  // Style used by default for the background part of
  // GUI::ref::VerticalScrollbar controls.
  ...
  // Style used by default for the up button on GUI::ref::VerticalScrollbar
  // controls.
  public GUIStyle verticalScrollbarUpButton {
    get { return m_verticalScrollbarUpButton; }
    set {
      m_verticalScrollbarUpButton = value;
      Apply();
    }
  }
  // Style used by default for the down button on GUI::ref::VerticalScrollbar
  // controls.
  public GUIStyle verticalScrollbarDownButton {
    get { return m_verticalScrollbarDownButton; }
    set {
  ...
  private void BuildStyleCache() {
    ...
    m_Styles =
        new Dictionary<string, GUIStyle>(StringComparer.OrdinalIgnoreCase);
    ...
    m_Styles["horizontalscrollbarrightbutton"] =
    ...
    if (!m_Styles.TryGetValue("HorizontalSliderThumbExtent",
                              out m_horizontalSliderThumbExtent)) {
    ...
    if (!m_Styles.TryGetValue("VerticalSliderThumbExtent",
                              out m_verticalSliderThumbExtent)) {
  ...
  public GUIStyle GetStyle(string styleName) {
    ...
    if (s != null)
      return s;
    Debug.LogWarning("Unable to find style '" + styleName + "' in skin '" +
                     name + "' " +
                     (Event.current != null ? Event.current.type.ToString()
                      : "<called outside OnGUI>"));
    return error;
  }

  // Try to search for a [[GUIStyle]]. This functions returns NULL and does not
  // give an error.
