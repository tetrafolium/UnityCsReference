...
public class GUIContent {
  ...
  [SerializeField] string m_Tooltip = string.Empty;
  ...
  // Build a GUIContent containing some /text/. When the user hovers the mouse
  // over it, the global GUI::ref::tooltip is set to the /tooltip/.
  ...
  // it, the global GUI::ref::tooltip is set to the /tooltip/.
  public GUIContent(Texture image, string tooltip)
      : this(string.Empty, image, tooltip) {}

  // Build a GUIContent that contains both /text/, an /image/ and has a
  // /tooltip/ defined. When the user hovers the mouse over it, the global
  // GUI::ref::tooltip is set to the /tooltip/.
