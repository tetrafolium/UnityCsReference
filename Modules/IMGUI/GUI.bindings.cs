...
[NativeHeader("Modules/IMGUI/GUI.bindings.h"),
 NativeHeader("Modules/IMGUI/GUISkin.bindings.h")] partial class GUI {
...
public static extern Color contentColor {
	get;
	set;
}
...
internal static extern Material blendMaterial {
	[FreeFunction("GetGUIBlendMaterial")] get;
}
internal static extern Material blitMaterial {
	[FreeFunction("GetGUIBlitMaterial")] get;
}
internal static extern Material roundedRectMaterial {
	[FreeFunction("GetGUIRoundedRectMaterial")] get;
}
internal static extern Material roundedRectWithColorPerBorderMaterial {
	[FreeFunction("GetGUIRoundedRectWithColorPerBorderMaterial")] get;
}
...
private static extern Rect
Internal_DoModalWindow(int id, int instanceID, Rect clientRect,
                       WindowFunction func, GUIContent content,
                       GUIStyle style, System.Object skin);
private static extern Rect
Internal_DoWindow(int id, int instanceID, Rect clientRect,
                  WindowFunction func, GUIContent title, GUIStyle style,
...
internal static extern string Internal_Concatenate(GUIContent first,
                                                   GUIContent second);
}
}
