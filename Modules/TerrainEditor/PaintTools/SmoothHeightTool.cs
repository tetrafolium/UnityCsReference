  ...
  internal class SmoothHeightTool : TerrainPaintTool<SmoothHeightTool> {
    ...
    class Styles {
      public readonly GUIContent description =
          EditorGUIUtility.TrTextContent("Click to smooth the terrain height.");
      public readonly GUIContent direction = EditorGUIUtility.TrTextContent(
          "Blur Direction",
          "Blur only up (1.0), only down (-1.0) or both (0.0)");
    }
    ...
    public override void OnInspectorGUI(Terrain terrain,
      ...
      m_direction =
          EditorGUILayout.Slider(styles.direction, m_direction, -1.0f, 1.0f);
    ...
    private void ApplyBrushInternal(PaintContext paintContext,
      ...
      Vector4 smoothWeights =
          new Vector4(Mathf.Clamp01(1.0f - Mathf.Abs(m_direction)), // centered
      ...
      Graphics.Blit(
          ...
          (int) TerrainPaintUtility.BuiltinPaintMaterialPasses.SmoothHeights);
    }
