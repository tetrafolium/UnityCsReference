...
internal class TerrainLayersContextMenus
{
    ...
    internal static void AddLayer(MenuCommand item)
    {
        ...
        selection => {
            TerrainLayerUtility.AddTerrainLayer(terrain, (TerrainLayer)selection);
        }, null);
    }
    ...
    internal static void ReplaceLayer(MenuCommand item)
    {
        ...
        selection => {
            TerrainLayerUtility.ReplaceTerrainLayer(terrain, (int)item.userData, (TerrainLayer)selection);
        });
    }
