...
extern static internal float GetFloat(Mesh mesh, uint vertexIndex,
                                      uint channelOffset,
                                      uint vertexStride);
extern static internal Vector2 GetFloat2(Mesh mesh, uint vertexIndex,
                                         uint channelOffset,
                                         uint vertexStride);
extern static internal Vector3 GetFloat3(Mesh mesh, uint vertexIndex,
                                         uint channelOffset,
                                         uint vertexStride);
extern static internal Vector4 GetFloat4(Mesh mesh, uint vertexIndex,
                                         uint channelOffset,
                                         uint vertexStride);
extern static internal Vector4 GetColor(Mesh mesh, uint vertexIndex,
                                        uint channelOffset,
                                        uint vertexStride);
}
}
