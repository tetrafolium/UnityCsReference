...
public sealed class Font : Object
{
    ...
    [NativeProperty("LineSpacing", false, TargetType.Function)] public extern int lineHeight {
        get;
    }
    ...
    [ExcludeFromDocs] public bool GetCharacterInfo(char ch, out CharacterInfo info, int size) {
    ...
    [ExcludeFromDocs] public void RequestCharactersInTexture(string characters, int size) {
        RequestCharactersInTexture(characters, size, FontStyle.Normal);
    }
    [ExcludeFromDocs] public void RequestCharactersInTexture(string characters) {
...
public sealed partial class TextGenerator
{
    ...
    [NativeProperty("FontSizeFoundForBestFit", false, TargetType.Function)] public extern int fontSizeUsedForBestFit {
        get;
    }
