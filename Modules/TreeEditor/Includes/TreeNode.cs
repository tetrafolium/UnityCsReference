...
public class TreeNode {
  ...
  //
  // Computes the surface angle deviation, from the splines orientation.. Funky
  // stuff! ! In degrees !
  ...
  public void GetPropertiesAtTime(float time, out Vector3 pos,
                                  out Quaternion rot, out float rad) {
    if (spline == null) {
      pos = Vector3.zero;
