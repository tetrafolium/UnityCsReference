...
public TreeAttribute(string uiLabel, string uiGadget, float uiMin,
                     float uiMax) {
...
public TreeAttribute(string uiLabel, string uiGadget, float uiMin,
                     float uiMax, string uiRequirement) {
	this.uiLabel = uiLabel;
	this.uiGadget = uiGadget;
	this.uiMin = uiMin;
	this.uiMax = uiMax;
...
public TreeAttribute(string uiLabel, string uiGadget, float uiMin,
                     float uiMax, string uiCurve, float uiCurveMin,
                     float uiCurveMax) {
	this.uiLabel = uiLabel;
	this.uiGadget = uiGadget;
	this.uiMin = uiMin;
...
public TreeAttribute(string uiLabel, string uiGadget, float uiMin,
                     float uiMax, string uiCurve, float uiCurveMin,
                     float uiCurveMax, string uiRequirement) {
	this.uiLabel = uiLabel;
	this.uiGadget = uiGadget;
	this.uiMin = uiMin;
	this.uiMax = uiMax;
...
public TreeAttribute(string uiLabel, string uiGadget, string uiOptions,
                     string uiCurve, float uiCurveMin, float uiCurveMax,
...
public override string ToString() {
	string value = "uiLabel: " + uiLabel + ", uiGadget: " + uiGadget +
	               ", uiMin: " + uiMin + ", uiMax: " + uiMax;
	if (uiCurve != "") {
