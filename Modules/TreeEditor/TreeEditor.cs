...
internal class TreeEditor : Editor {
  ...
  private static string[] geometryModeOptions = {
      L10n.Tr("Plane|"), L10n.Tr("Cross|"), L10n.Tr("TriCross|"),
      L10n.Tr("Billboard|"), L10n.Tr("Mesh|")};
  ...
  private static string[] toolbarContentStringsBranch = {
      ...
      L10n.Tr(
          "Rotate Branch|Select a branch spline point and drag to rotate it."),
      L10n.Tr(
  ...
  private static string[] inspectorDistributionPopupOptions = {
      L10n.Tr("Random|"), L10n.Tr("Alternate|"), L10n.Tr("Opposite|"),
      L10n.Tr("Whorled|")};

  private static string treeSeedString = L10n.Tr(
  ...
  private static string areaSpreadString = L10n.Tr(
      "Area Spread|Adjusts the spread of trunk nodes. Has an effect only if you have more than one trunk.");

  private static string groundOffsetString =
      L10n.Tr("Ground Offset|Adjusts the offset of trunk nodes on Y axis.");

  private static string lodQualityString = L10n.Tr(
      "LOD Quality|Defines the level-of-detail for the entire tree. A low value will make the tree less complex, a high value will make the tree more complex. Check the statistics in the hierarchy view to see the current complexity of the mesh.");

  private static string ambientOcclusionString =
      L10n.Tr("Ambient Occlusion|Toggles ambient occlusion on or off.");

  private static string aoDensityString =
      L10n.Tr("AO Density|Adjusts the density of ambient occlusion.");

  private static string translucencyColorString = L10n.Tr(
      "Translucency Color|The color that will be multiplied in when the leaves are backlit.");

  private static string transViewDepString = L10n.Tr(
      "Trans. View Dep.|Translucency view dependency. Fully view dependent translucency is relative to the angle between the view direction and the light direction. View independent is relative to the angle between the leaf's normal vector and the light direction.");

  private static string alphaCutoffString = L10n.Tr(
      "Alpha Cutoff|Alpha values from the base texture smaller than the alpha cutoff are clipped creating a cutout.");

  private static string shadowStrengthString = L10n.Tr(
      "Shadow Strength|Makes the shadows on the leaves less harsh. Since it scales all the shadowing that the leaves receive, it should be used with care for trees that are e.g. in a shadow of a mountain.");

  private static string shadowOffsetString = L10n.Tr(
  ...
  private static string[] leafMaterialOptions = {
      L10n.Tr("Full Res|"), L10n.Tr("Half Res|"), L10n.Tr("Quarter Res|"),
      L10n.Tr("One-8th Res|"), L10n.Tr("One-16th Res|")};

  private static string shadowCasterResString = L10n.Tr(
      "Shadow Caster Res.|Defines the resolution of the texture atlas containing alpha values from source diffuse textures. The atlas is used when the leaves are rendered as shadow casters. Using lower resolution might increase performance.");

  private static string lodMultiplierString = L10n.Tr(
  ...
  private static string[] categoryNamesOptions = {L10n.Tr("Branch Only|"),
                                                  L10n.Tr("Branch + Fronds|"),
                                                  L10n.Tr("Fronds Only|")};

  private static string geometryModeString =
      L10n.Tr("Geometry Mode|Type of geometry for this branch group.");
  private static string branchMaterialString =
      L10n.Tr("Branch Material|The primary material for the branches.");

  private static string breakMaterialString =
      L10n.Tr("Break Material|Material for capping broken branches.");

  private static string frondMaterialString =
      L10n.Tr("Frond Material|Material for the fronds.");

  private static string lengthString =
      L10n.Tr("Length|Adjusts the length of the branches.");

  private static string relativeLengthString = L10n.Tr(
      "Relative Length|Determines whether the radius of a branch is affected by its length.");

  private static string radiusString = L10n.Tr(
      "Radius|Adjusts the radius of the branches, use the curve to fine-tune the radius along the length of the branches.");

  private static string capSmoothingString = L10n.Tr(
      "Cap Smoothing|Defines the roundness of the cap/tip of the branches. Useful for cacti.");

  private static string crinklynessString = L10n.Tr(
      "Crinkliness|Adjusts how crinkly/crooked the branches are, use the curve to fine-tune.");

  private static string seekSunString = L10n.Tr(
      "Seek Sun|Use the curve to adjust how the branches are bent upwards/downwards and the slider to change the scale.");

  private static string noiseString =
      L10n.Tr("Noise|Overall noise factor, use the curve to fine-tune.");

  private static string noiseScaleUString = L10n.Tr(
  ...
  private static string noiseScaleVString = L10n.Tr(
  ...
  private static string flareRadiusString = L10n.Tr(
      "Flare Radius|The radius of the flares, this is added to the main radius, so a zero value means no flares.");

  private static string flareHeightString =
      L10n.Tr("Flare Height|Defines how far up the trunk the flares start.");

  private static string flareNoiseString = L10n.Tr(
  ...
  private static string weldLengthString = L10n.Tr(
      "Weld Length|Defines how far up the branch the weld spread starts.");

  private static string spreadTopString = L10n.Tr(
      "Spread Top|Weld's spread factor on the top-side of the branch, relative to its parent branch. Zero means no spread.");

  private static string spreadBottomString = L10n.Tr(
      "Spread Bottom|Weld's spread factor on the bottom-side of the branch, relative to its parent branch. Zero means no spread.");

  private static string breakChanceString = L10n.Tr(
  ...
  private static string breakLocationString = L10n.Tr(
      "Break Location|This range defines where the branches will be broken. Relative to the length of the branch.");

  private static string frondCountString = L10n.Tr(
      "Frond Count|Defines the number of fronds per branch. Fronds are always evenly spaced around the branch.");

  private static string frondWidthString = L10n.Tr(
      "Frond Width|The width of the fronds, use the curve to adjust the specific shape along the length of the branch.");

  private static string frondRangeString = L10n.Tr(
      "Frond Range|Defines the starting and ending point of the fronds.");

  private static string frondRotationString =
      L10n.Tr("Frond Rotation|Defines rotation around the parent branch.");

  private static string frondCreaseString =
      L10n.Tr("Frond Crease|Adjust to crease / fold the fronds.");

  private static string geometryModeLeafString = L10n.Tr(
  ...
  static void CreateNewTree(MenuCommand menuCommand) {
    ...
    meshAsset.name = "Mesh";
    Material materialSolidAsset =
        new Material(TreeEditorHelper.DefaultOptimizedBarkShader);
    materialSolidAsset.name = "Optimized Bark Material";
    materialSolidAsset.hideFlags =
        HideFlags.NotEditable | HideFlags.HideInInspector;

    Material materialCutoutAsset =
        new Material(TreeEditorHelper.DefaultOptimizedLeafShader);
    materialCutoutAsset.name = "Optimized Leaf Material";
    materialCutoutAsset.hideFlags =
        HideFlags.NotEditable | HideFlags.HideInInspector;

    // Create optimized tree mesh prefab the user can instantiate in the scene
    GameObject prefabInstance =
        new GameObject("OptimizedTree", typeof(Tree), typeof(MeshFilter),
                       typeof(MeshRenderer));
    ...
    GameObject prefabAsset = PrefabUtility.SaveAsPrefabAssetAndConnect(
        prefabInstance, path,
        InteractionMode.AutomatedAction); // saving the unfinished prefab here
                                          // allows assets to be added
    ...
    GameObjectUtility.SetParentAndAlign(prefabInstance,
  ...
  static void PreviewMesh(Tree tree) { PreviewMesh(tree, true); }
  ...
  static void UpdateMesh(Tree tree) { UpdateMesh(tree, true); }
  ...
  static void UpdateMesh(Tree tree, bool callExitGUI) {
    ...
    // If a Tree is opened in Prefab Mode the Tree should be saved by the Prefab
    // Mode logic (manual- or auto-save) Note: When opened in Prefab Mode the
    // Tree will be unpacked (have no connection to its Prefab). so we have to
    // dirty its scene instead.
  ...
  static void CreateWindZone(MenuCommand menuCommand) {
    ...
    GameObjectUtility.SetParentAndAlign(wind,
                                        menuCommand.context as GameObject);
  ...
  static GameObject CreateDefaultWindZone() {
    // Create a wind zone
    GameObject wind =
        ObjectFactory.CreateGameObject("WindZone", typeof(WindZone));
    Undo.SetCurrentGroupName(createWindZoneString);
    return wind;
  }

  private float FindClosestOffset(TreeData data, Matrix4x4 objMatrix,
                                  TreeNode node, Ray mouseRay,
                                  ref float rotation) {
    ...
    for (float t = step; t <= 1.0f; t += step) {
      ...
      float dist = 0.0f;
      float s = 0.0f;
      closestSegment = MathUtils.ClosestPtSegmentRay(
          pointA, pointB, mouseRay, out dist, out s, out closestRay);
      if (dist < closestDist) {
        ...
        //
        // 1: Closest point on ray compared to sphere positioned at spline
        // position.. 2: Transform to local space of the spline (oriented to the
        // spline) 3: Compute angle in Degrees..
        //
        float radius = node.GetRadiusAtTime(closestOffset);
        float tt = 0.0f;
        if (MathUtils.ClosestPtRaySphere(mouseRay, closestSegment, radius,
                                         ref tt, ref closestRay)) {
          Matrix4x4 invMatrix =
              (matrix * node.GetLocalMatrixAtTime(closestOffset)).inverse;
          Vector3 raySegmentVector = closestRay - closestSegment;
          raySegmentVector = invMatrix.MultiplyVector(raySegmentVector);
          rotation = Mathf.Atan2(raySegmentVector.x, raySegmentVector.z) *
                     Mathf.Rad2Deg;
        }
      }
      pointA = pointB;
  ...
  void SelectGroup(TreeGroup group) {
    ...
    if (m_TreeEditorHelper.NodeHasWrongMaterial(group)) {
      // automatically show the Geometry tab if the selected node has a wrong
      // shader
      s_ShowCategory = 1;
    }
    ...
    if (s_SelectedNode != null) {
      if (s_SelectedPoint >= 1) {
        ...
        if ((s_SelectedGroup != null) &&
            (s_SelectedGroup.nodeIDs.Length == 1)) {
          s_SelectedNode = null;
  ...
  void VerifySelection(TreeData treeData) {
    ...
    // on first start, we need to verify the selected part actually belongs to
    // the current tree);
    ...
    if ((nodeToSelect != null) &&
        (treeData.GetGroup(nodeToSelect.groupID) != groupToSelect)) {
      nodeToSelect = null;
    }
    ...
    if (s_SelectedGroup != null && groupToSelect == s_SelectedGroup)
      return;
  ...
  bool OnCheckHotkeys(TreeData treeData, bool checkFrameSelected) {
    ...
    case EventType.ExecuteCommand:
      ...
      if (Event.current.commandName == "UndoRedoPerformed") {
        float materialHash =
            GenerateMaterialHash(treeData.optimizedCutoutMaterial);
        if (s_CutoutMaterialHashBeforeUndo != materialHash) {
          // Cutout material's hash has changed, so we're undoing property
          // changes on the generated material only, no need to update the whole
          // tree.
          s_CutoutMaterialHashBeforeUndo = materialHash;
        } else {
          // After undo: restore the material hash of the materials that were
          // used to create texture atlases currently stored on disk. That will
          // make sure that performing undo will regenerate atlases when
          // necessary.
  ...
  Bounds CalcBounds(TreeData treeData, Matrix4x4 objMatrix, TreeNode node) {
    ...
    if (treeData.GetGroup(node.groupID).GetType() ==
            typeof(TreeGroupBranch) &&node.spline != null &&
        node.spline.nodes.Length > 0) {
      // Has a spline
      bounds = new Bounds(nodeMatrix.MultiplyPoint(node.spline.nodes[0].point),
                          Vector3.zero);
      for (int i = 1; i < node.spline.nodes.Length; i++) {
        bounds.Encapsulate(
            nodeMatrix.MultiplyPoint(node.spline.nodes[i].point));
      }
    } else {
      // no spline
  ...
  void FrameSelected(Tree tree) {
    ...
    Bounds bounds =
        new Bounds(objMatrix.MultiplyPoint(Vector3.zero), Vector3.zero);
    ...
    if (s_SelectedGroup != null) {
      if (s_SelectedGroup.GetType() == typeof(TreeGroupRoot)) {
        ...
        if ((meshFilter == null) ||
            (s_SelectedGroup.childGroupIDs.Length == 0)) {
          float rad = s_SelectedGroup.GetRootSpread();
          bounds =
              new Bounds(objMatrix.MultiplyPoint(Vector3.zero),
                         objMatrix.MultiplyVector(new Vector3(rad, rad, rad)));
        } else {
          bounds = new Bounds(
              objMatrix.MultiplyPoint(meshFilter.sharedMesh.bounds.center),
              objMatrix.MultiplyVector(meshFilter.sharedMesh.bounds.size));
        }
      } else if (s_SelectedNode != null) {
        if (s_SelectedGroup.GetType() ==
            typeof(TreeGroupLeaf) &&s_SelectedPoint >= 0) {
          // Focus on selected point
          Matrix4x4 nodeMatrix = objMatrix * s_SelectedNode.matrix;
          bounds = new Bounds(
              nodeMatrix.MultiplyPoint(
        ...
        for (int i = 0; i < s_SelectedGroup.nodeIDs.Length; i++) {
          Bounds temp =
              CalcBounds(treeData, objMatrix,
                         treeData.GetNode(s_SelectedGroup.nodeIDs[i]));
          if (i == 0) {
            bounds = temp;
          } else {
  ...
  void RepaintGUIView() { GUIView.current.Repaint(); }
  ...
  void OnDisable() {
    ...
    Renderer treeRenderer = tree.GetComponent<Renderer>();
    EditorUtility.SetSelectedRenderState(
        treeRenderer, EditorSelectedRenderState.Wireframe |
                          EditorSelectedRenderState.Highlight);
  }
...
#region Do Root Handles
    if (s_SelectedGroup.GetType() == typeof(TreeGroupRoot)) {
      ...
      Handles.DrawWireDisc(treeTransform.position, treeTransform.up,
                           treeData.root.rootSpread);
    } else {
      Tools.s_Hidden = true;
...
#region Do Branch Handles
    if (s_SelectedGroup != null &&
        s_SelectedGroup.GetType() == typeof(TreeGroupBranch)) {
      ...
      GL.Begin(GL.LINES);
      for (int nodeIndex = 0; nodeIndex < s_SelectedGroup.nodeIDs.Length;
           nodeIndex++) {
        ...
        Handles.color =
            (branch == s_SelectedNode) ? s_NormalColor : s_GroupColor;

        Matrix4x4 branchMatrix = treeMatrix * branch.matrix;

        // Draw Spline
        Vector3 prevPos =
            branchMatrix.MultiplyPoint(spline.GetPositionAtTime(0.0f));

        GL.Color(Handles.color);
        for (float t = 0.01f; t <= 1.0f; t += 0.01f) {
          Vector3 currPos =
              branchMatrix.MultiplyPoint(spline.GetPositionAtTime(t));
      ...
      for (int nodeIndex = 0; nodeIndex < s_SelectedGroup.nodeIDs.Length;
        ...
        // Draw Points
        for (int pointIndex = 0; pointIndex < spline.nodes.Length;
             pointIndex++) {
          ...
          case EditMode.MoveNode:
            if (pointIndex == 0)
              worldPos = Handles.FreeMoveHandle(worldPos, Quaternion.identity,
                                                handleSize, Vector3.zero,
            ...
            if (oldEventType == EventType.MouseDown &&
                evt.type == EventType.Used &&
                oldKeyboardControl != GUIUtility.keyboardControl) {
              SelectNode(branch, treeData);
              s_SelectedPoint = pointIndex;
              m_StartPointRotation =
                  MathUtils.QuaternionFromMatrix(branchMatrix) * point.rot;
            }

            if ((oldEventType == EventType.MouseDown ||
                 oldEventType == EventType.MouseUp) &&
                evt.type == EventType.Used) {
              m_StartPointRotation =
                  MathUtils.QuaternionFromMatrix(branchMatrix) * point.rot;
            }
            ...
            if (oldEventType == EventType.MouseUp &&
                evt.type == EventType.Used) {
            ...
            if (GUI.changed) {
              ...
              // Snap root branch to parent (overrides position received from
              // handles, uses mouse raycasts instead)
              ...
              if (pointIndex == 0) {
                ...
                if (parentNode != null) {
                  TreeGroup parentGroup =
                      treeData.GetGroup(s_SelectedGroup.parentGroupID);
                  if (parentGroup.GetType() == typeof(TreeGroupBranch)) {
                    // Snap to parent branch
                    s_SelectedNode.offset = FindClosestOffset(
                        treeData, treeMatrix, parentNode, mouseRay, ref angle);
                    ...
                    Plane p =
                        new Plane(treeMatrix.MultiplyVector(Vector3.up), mid);
                    if (p.Raycast(mouseRay, out hitDist)) {
                      ...
                      s_SelectedNode.offset = Mathf.Clamp01(
                          delta.magnitude / treeData.root.rootSpread);
            ...
            break;
          case EditMode.RotateNode:
            Handles.FreeMoveHandle(worldPos, Quaternion.identity, handleSize,
          ...
          case EditMode.Freehand:
            ...
            if (s_SelectedPoint == pointIndex && s_SelectedNode == branch &&
                oldEventType == EventType.MouseDrag) {
              Ray mouseRay =
                  HandleUtility.GUIPointToWorldRay(evt.mousePosition);

              // In draw mode.. move current spline node to mouse position
              // trace ray on a plane placed at the original position of the
              // selected node and aligned to the camera..
              ...
              if (p.Raycast(mouseRay, out hitDist)) {
                ...
                s_SelectedNode.spline.nodes[s_SelectedPoint].point =
                    (branchMatrix.inverse).MultiplyPoint(hitPos);
                ...
                if (delta.magnitude > 1.0f) {
                  ...
                  if (s_SelectedPoint >= s_SelectedNode.spline.nodes.Length) {
                    s_SelectedNode.spline.AddPoint(
                        branchMatrix.inverse.MultiplyPoint(hitPos), 1.1f);
                  }
                }
      ...
      if (s_SelectedPoint > 0 && editMode == EditMode.MoveNode &&
          s_SelectedNode != null) {
        ...
        if (Tools.pivotRotation == PivotRotation.Local) {
          if (oldEventType == EventType.MouseUp ||
              oldEventType == EventType.MouseDown)
            m_StartPointRotation =
                MathUtils.QuaternionFromMatrix(branchMatrix) * point.rot;
      ...
      if (s_SelectedPoint >= 0 && editMode == EditMode.RotateNode &&
          s_SelectedNode != null) {
        TreeNode branch = s_SelectedNode;
        SplineNode point = branch.spline.nodes[s_SelectedPoint];
        Matrix4x4 branchMatrix = treeMatrix * branch.matrix;
        ...
        m_GlobalToolRotation =
            Handles.RotationHandle(m_GlobalToolRotation, worldPos);
        ...
        if (GUI.changed) {
          ...
          for (int i = s_SelectedPoint + 1; i < m_TempSpline.nodes.Length;
               i++) {
...
#region Do Leaf Handles
    if (s_SelectedGroup != null &&
        s_SelectedGroup.GetType() == typeof(TreeGroupLeaf)) {
      for (int nodeIndex = 0; nodeIndex < s_SelectedGroup.nodeIDs.Length;
           nodeIndex++) {
        ...
        case EditMode.MoveNode:
          ...
          if (oldEventType == EventType.MouseDown &&
            ...
            m_LockedWorldPos = new Vector3(m_StartMatrix.m03, m_StartMatrix.m13,
                                           m_StartMatrix.m23);
          }
          ...
          if (GUI.changed) {
            ...
            if (parentGroup.GetType() == typeof(TreeGroupBranch)) {
              // Snap to branch
              leaf.offset = FindClosestOffset(treeData, treeMatrix, parentNode,
                                              mouseRay, ref angle);
        ...
        case EditMode.RotateNode: {
          ...
          if (oldEventType == EventType.MouseDown &&
            ...
            m_StartPointRotation = leaf.rotation;
            m_LockedWorldPos =
                new Vector3(leafMatrix.m03, leafMatrix.m13, leafMatrix.m23);
          }
          ...
          if (s_SelectedNode == leaf) {
            ...
            m_GlobalToolRotation =
                Handles.RotationHandle(m_GlobalToolRotation, m_LockedWorldPos);
            ...
            if (GUI.changed) {
              s_SelectedGroup.Lock();
              Quaternion invStart = Quaternion.Inverse(
                  MathUtils.QuaternionFromMatrix(m_StartMatrix));
              leaf.rotation =
                  m_StartPointRotation * (invStart * m_GlobalToolRotation);
  ...
  private void GUIPropEnd() { GUIPropEnd(true); }
  ...
  // GUI Helpers..
  private float GUISlider(PropertyType prop, string contentID, float value,
                          float minimum, float maximum, bool hasCurve) {
    GUIPropBegin();
    float newValue = EditorGUILayout.Slider(
        TreeEditorHelper.GetGUIContent(contentID), value, minimum, maximum);
    if (newValue != value) {
  ...
  private int GUIIntSlider(PropertyType prop, string contentID, int value,
                           int minimum, int maximum, bool hasCurve) {
    GUIPropBegin();
  ...
  private bool GUIToggle(PropertyType prop, string contentID, bool value,
                         bool hasCurve) {
    GUIPropBegin();
    bool newValue = EditorGUILayout.Toggle(
        TreeEditorHelper.GetGUIContent(contentID), value);
    if (newValue != value) {
      GUIHandlePropertyChange(prop);
      m_WantCompleteUpdate = true;
    }
  ...
  private int GUIPopup(PropertyType prop, string contentID, string[] optionIDs,
                       int value, bool hasCurve) {
    GUIPropBegin();
    ...
    int newValue = EditorGUILayout.Popup(
        TreeEditorHelper.GetGUIContent(contentID), value, options);
    if (newValue != value) {
      GUIHandlePropertyChange(prop);
      m_WantCompleteUpdate = true;
    }
  ...
  private Material GUIMaterialField(PropertyType prop, int uniqueNodeID,
                                    string contentID, Material value,
                                    TreeEditorHelper.NodeType nodeType) {
    string uniqueID = uniqueNodeID + "_" + contentID;

    GUIPropBegin();
    Material newValue =
        EditorGUILayout.ObjectField(TreeEditorHelper.GetGUIContent(contentID),
                                    value, typeof(Material), false) as Material;
    GUIPropEnd();

    bool shaderFixed =
        m_TreeEditorHelper.GUIWrongShader(uniqueID, newValue, nodeType);
  ...
  private Object GUIObjectField(PropertyType prop, string contentID,
                                Object value, System.Type type, bool hasCurve) {
    GUIPropBegin();
    Object newValue = EditorGUILayout.ObjectField(
        TreeEditorHelper.GetGUIContent(contentID), value, type, false);
    if (newValue != value) {
      GUIHandlePropertyChange(prop);
      m_WantCompleteUpdate = true;
    }
  ...
  private bool GUICurve(PropertyType prop, AnimationCurve curve, Rect ranges) {
    ...
    EditorGUILayout.CurveField(curve, Color.green, ranges,
                               GUILayout.Width(kCurveSpace));
    GUIPropEnd(false);
  ...
  private Vector2 GUIMinMaxSlider(PropertyType prop, string contentID,
                                  Vector2 value, float minimum, float maximum,
                                  bool hasCurve) {
    GUIPropBegin();
    Vector2 newValue =
        new Vector2(Mathf.Min(value.x, value.y), Mathf.Max(value.x, value.y));
    GUIContent content = TreeEditorHelper.GetGUIContent(contentID);
    bool preChange = GUI.changed;
    Rect tempRect = GUILayoutUtility.GetRect(content, "Button");
    EditorGUI.MinMaxSlider(tempRect, content, ref newValue.x, ref newValue.y,
                           minimum, maximum);
    if (preChange != GUI.changed) {
      GUIHandlePropertyChange(prop);
    }
  ...
  public void InspectorHierachy(TreeData treeData, Renderer renderer) {
    ...
    if (GUILayout.Button(styles.iconAddLeaves, styles.toolbarButton))
      sel = 0;
    if (GUILayout.Button(styles.iconAddBranches, styles.toolbarButton))
      sel = 1;
    GUI.enabled = true;
    ...
    if (GUILayout.Button(styles.iconDuplicate, styles.toolbarButton))
      sel = 3;
    if (GUILayout.Button(styles.iconTrash, styles.toolbarButton))
      sel = 2;
    GUI.enabled = true;
  ...
  public void InspectorEditTools(Tree obj) {
    ...
    editMode = (EditMode)
        GUItoolbar((int) editMode,
                   BuildToolbarContent(toolbarIconStrings,
                                       toolbarContentStrings, (int) editMode));
    ...
    if (editMode == EditMode.None) {
      ...
      GUILayout.Label(TreeEditorHelper.ExtractTooltip(uiString),
                      EditorStyles.wordWrappedMiniLabel);
    }
  ...
  private static GUIContent[] BuildToolbarContent(string[] iconStrings,
    ...
    for (int i = 0; i < contentStrings.Length; i++) {
      ...
      contents[i] =
          EditorGUIUtility.IconContent(iconStrings[i] + iconSuffix, tooltip);
    }
  ...
  public void InspectorDistribution(TreeData treeData, TreeGroup group) {
    ...
    int pre = group.seed;
    group.seed = GUIIntSlider(PropertyType.Normal, group.GroupSeedString,
                              group.seed, 0, 999999, false);
    if (group.seed != pre) {
    ...
    group.distributionFrequency =
        GUIIntSlider(PropertyType.FullUndo, group.FrequencyString,
                     group.distributionFrequency, 1, 100, false);
    ...
    group.distributionMode = (TreeGroup.DistributionMode) GUIPopup(
        PropertyType.Normal, group.DistributionModeString,
        inspectorDistributionPopupOptions, (int) group.distributionMode, true);
    ...
    if (group.distributionMode != TreeGroup.DistributionMode.Random) {
      ...
      group.distributionTwirl =
          GUISlider(PropertyType.Normal, group.TwirlString,
                    group.distributionTwirl, -1.0f, 1.0f, false);
    ...
    if (group.distributionMode == TreeGroup.DistributionMode.Whorled) {
      ...
      group.distributionNodes =
          GUIIntSlider(PropertyType.Normal, group.WhorledStepString,
                       group.distributionNodes, 1, 21, false);
    ...
    // growth scale
    group.distributionScale =
        GUISlider(PropertyType.Normal, group.GrowthScaleString,
                  group.distributionScale, 0.0f, 1.0f, true);
    ...
    // growth scale
    group.distributionPitch =
        GUISlider(PropertyType.Normal, group.GrowthAngleString,
                  group.distributionPitch, 0.0f, 1.0f, true);
  ...
  public void InspectorAnimation(TreeData treeData, TreeGroup group) {
    ...
    group.animationPrimary =
        GUISlider(PropertyType.Normal, group.MainWindString,
                  group.animationPrimary, 0.0f, 1.0f, false);

    // not for trunks
    if (treeData.GetGroup(group.parentGroupID) != treeData.root)
      group.animationSecondary =
          GUISlider(PropertyType.Normal, group.MainTurbulenceString,
                    group.animationSecondary, 0.0f, 1.0f, false);

    // branches must have fronds
    GUI.enabled = true;
    if (!(group is TreeGroupBranch &&
          ((group as TreeGroupBranch).geometryMode ==
           (int) TreeGroupBranch.GeometryMode.Branch))) {
      group.animationEdge =
          GUISlider(PropertyType.Normal, group.EdgeTurbulenceString,
                    group.animationEdge, 0.0f, 1.0f, false);
    }

    // Create default wind button
    GUIPropBegin();
    if (GUILayout.Button(TreeEditorHelper.GetGUIContent(
            "Create Wind Zone|Creates a default wind zone, which is required for animating trees while playing the game."))) {
  ...
  private int GUItoolbar(int selection, GUIContent[] names) {
    ...
    for (int i = 0; i < names.Length; i++) {
      ...
      if (names[i] != null) {
        if (GUILayout.Toggle(selection == i, names[i], buttonStyle))
          selection = i;
      }
    }
    GUILayout.FlexibleSpace();
  ...
  private void GUIunlockbox(TreeData treeData) {
    ...
    GUIContent labelContent = TreeEditorHelper.GetGUIContent(
        "This group has been edited by hand. Some parameters may not be available.|");
    ...
    GUIContent buttonContent = TreeEditorHelper.GetGUIContent(
        "Convert to procedural group. All hand editing will be lost!|");
  ...
  private bool GUIMaterialColor(Material material, string propertyID,
                                string contentID) {
    bool changed = false;
    GUIPropBegin();
    Color value = material.GetColor(propertyID);
    Color newValue = EditorGUILayout.ColorField(
        TreeEditorHelper.GetGUIContent(contentID), value);
    if (newValue != value) {
  ...
  private bool GUIMaterialSlider(Material material, string propertyID,
                                 string contentID) {
    bool changed = false;
    GUIPropBegin();
    float value = material.GetFloat(propertyID);
    float newValue = EditorGUILayout.Slider(
        TreeEditorHelper.GetGUIContent(contentID), value, 0, 1);
    if (newValue != value) {
      Undo.RegisterCompleteObjectUndo(material, "Material");
  ...
  private bool GUIMaterialFloatField(Material material, string propertyID,
                                     string contentID) {
    bool success;
  ...
  public void InspectorRoot(TreeData treeData, TreeGroupRoot group) {
    GUIContent[] categoryNames = {
        TreeEditorHelper.GetGUIContent(L10n.Tr("Distribution|")),
        TreeEditorHelper.GetGUIContent(L10n.Tr("Geometry|")),
        TreeEditorHelper.GetGUIContent(L10n.Tr(
            "Material|Controls global material properties of the tree.")),
        null,
        null,
        null};
    ...
    PrepareSpacing(false);
    int pre = group.seed;
    group.seed = GUIIntSlider(PropertyType.Normal, treeSeedString, group.seed,
                              0, 9999999, false);
    if (group.seed != pre) {
      treeData.UpdateSeed(group.uniqueID);
    }

    group.rootSpread = GUISlider(PropertyType.Normal, areaSpreadString,
                                 group.rootSpread, 0.0f, 10.0f, false);
    group.groundOffset = GUISlider(PropertyType.Normal, groundOffsetString,
                                   group.groundOffset, 0.0f, 10.0f, false);
    EndSettingsSection();
    ...
    PrepareSpacing(false);
    group.adaptiveLODQuality =
        GUISlider(PropertyType.FullUndo, lodQualityString,
                  group.adaptiveLODQuality, 0.0f, 1.0f, false);

    group.enableAmbientOcclusion =
        GUIToggle(PropertyType.FullUndo, ambientOcclusionString,
                  group.enableAmbientOcclusion, false);

    GUI.enabled = group.enableAmbientOcclusion;
    group.aoDensity = GUISlider(PropertyType.Normal, aoDensityString,
                                group.aoDensity, 0.0f, 1.0f, false);
    GUI.enabled = true;
    EndSettingsSection();
    ...
    if (leafMaterial != null) {
      ...
      bool changed = GUIMaterialColor(leafMaterial, "_TranslucencyColor",
                                      translucencyColorString);

      changed |= GUIMaterialSlider(leafMaterial, "_TranslucencyViewDependency",
                                   transViewDepString);
      changed |= GUIMaterialSlider(leafMaterial, "_Cutoff", alphaCutoffString);
      changed |= GUIMaterialSlider(leafMaterial, "_ShadowStrength",
                                   shadowStrengthString);

      changed |= GUIMaterialFloatField(leafMaterial, "_ShadowOffsetScale",
                                       shadowOffsetString);

      if (changed)
        s_CutoutMaterialHashBeforeUndo =
            GenerateMaterialHash(treeData.optimizedCutoutMaterial);

      group.shadowTextureQuality =
          GUIPopup(PropertyType.FullUpdate, shadowCasterResString,
                   leafMaterialOptions, group.shadowTextureQuality, false);
  ...
  public void InspectorBranch(TreeData treeData, TreeGroupBranch group) {
    ...
    GUIContent[] categoryNames = {
        TreeEditorHelper.GetGUIContent(L10n.Tr(
            "Distribution|Adjusts the count and placement of branches in the group. Use the curves to fine tune position, rotation and scale. The curves are relative to the parent branch or to the area spread in case of a trunk.")),
        TreeEditorHelper.GetGUIContent(L10n.Tr(
            "Geometry|Select what type of geometry is generated for this branch group and which materials are applied. LOD Multiplier allows you to adjust the quality of this group relative to tree's LOD Quality.")),
        TreeEditorHelper.GetGUIContent(L10n.Tr(
            "Shape|Adjusts the shape and growth of the branches. Use the curves to fine tune the shape, all curves are relative to the branch itself.")),
        TreeEditorHelper.GetGUIContent(L10n.Tr("Fronds|")),
        TreeEditorHelper.GetGUIContent(L10n.Tr(
            "Wind|Adjusts the parameters used for animating this group of branches. The wind zones are only active in Play Mode."))};
    ...
    BeginSettingsSection(1, categoryNames);
    PrepareSpacing(false);
    group.lodQualityMultiplier =
        GUISlider(PropertyType.Normal, lodMultiplierString,
                  group.lodQualityMultiplier, 0.0f, 2.0f, false);

    group.geometryMode = (TreeGroupBranch.GeometryMode)
        GUIPopup(PropertyType.FullUpdate, geometryModeString,
                 categoryNamesOptions, (int) group.geometryMode, false);

    if (group.geometryMode != TreeGroupBranch.GeometryMode.Frond)
      group.materialBranch = GUIMaterialField(
          PropertyType.FullUpdate, group.uniqueID, branchMaterialString,
          group.materialBranch, TreeEditorHelper.NodeType.BarkNode);

    group.materialBreak = GUIMaterialField(
        PropertyType.FullUpdate, group.uniqueID, breakMaterialString,
        group.materialBreak, TreeEditorHelper.NodeType.BarkNode);

    if (group.geometryMode != TreeGroupBranch.GeometryMode.Branch)
      group.materialFrond = GUIMaterialField(
          PropertyType.FullUpdate, group.uniqueID, frondMaterialString,
          group.materialFrond, TreeEditorHelper.NodeType.BarkNode);
    EndSettingsSection();
    ...
    group.height = GUIMinMaxSlider(PropertyType.Normal, lengthString,
                                   group.height, 0.1f, 50.0f, false);

    GUI.enabled = (group.geometryMode != TreeGroupBranch.GeometryMode.Frond);
    group.radiusMode = GUIToggle(PropertyType.Normal, relativeLengthString,
                                 group.radiusMode, false);

    GUI.enabled = (group.geometryMode != TreeGroupBranch.GeometryMode.Frond);
    group.radius = GUISlider(PropertyType.Normal, radiusString, group.radius,
                             0.1f, 5.0f, true);
    ...
    GUI.enabled = (group.geometryMode != TreeGroupBranch.GeometryMode.Frond);
    group.capSmoothing = GUISlider(PropertyType.Normal, capSmoothingString,
                                   group.capSmoothing, 0.0f, 1.0f, false);
    ...
    GUI.enabled = (group.lockFlags == 0);
    group.crinklyness = GUISlider(PropertyType.Normal, crinklynessString,
                                  group.crinklyness, 0.0f, 1.0f, true);
    ...
    GUI.enabled = (group.lockFlags == 0);
    group.seekBlend = GUISlider(PropertyType.Normal, seekSunString,
                                group.seekBlend, 0.0f, 1.0f, true);
    ...
    group.noise = GUISlider(PropertyType.Normal, noiseString, group.noise, 0.0f,
                            1.0f, true);
    ...
    group.noiseScaleU = GUISlider(PropertyType.Normal, noiseScaleUString,
                                  group.noiseScaleU, 0.0f, 1.0f, false);
    group.noiseScaleV = GUISlider(PropertyType.Normal, noiseScaleVString,
                                  group.noiseScaleV, 0.0f, 1.0f, false);
    ...
    if (treeData.GetGroup(group.parentGroupID) == treeData.root) {
      ...
      // Flares
      //
      group.flareSize = GUISlider(PropertyType.Normal, flareRadiusString,
                                  group.flareSize, 0.0f, 5.0f, false);
      group.flareHeight = GUISlider(PropertyType.Normal, flareHeightString,
                                    group.flareHeight, 0.0f, 1.0f, false);
      group.flareNoise = GUISlider(PropertyType.Normal, flareNoiseString,
                                   group.flareNoise, 0.0f, 1.0f, false);
    } else {
      //
      // Welding
      //
      group.weldHeight = GUISlider(PropertyType.Normal, weldLengthString,
                                   group.weldHeight, 0.01f, 1.0f, false);
      group.weldSpreadTop = GUISlider(PropertyType.Normal, spreadTopString,
                                      group.weldSpreadTop, 0.0f, 1.0f, false);
      group.weldSpreadBottom =
          GUISlider(PropertyType.Normal, spreadBottomString,
                    group.weldSpreadBottom, 0.0f, 1.0f, false);
    }

    EditorGUILayout.Space();

    // Breaking
    group.breakingChance = GUISlider(PropertyType.Normal, breakChanceString,
                                     group.breakingChance, 0.0f, 1.0f, false);
    group.breakingSpot =
        GUIMinMaxSlider(PropertyType.Normal, breakLocationString,
                        group.breakingSpot, 0.0f, 1.0f, false);
    EndSettingsSection();
    ...
    if (group.geometryMode != (int)(TreeGroupBranch.GeometryMode.Branch)) {
      ...
      group.frondCount = GUIIntSlider(PropertyType.Normal, frondCountString,
                                      group.frondCount, 1, 16, false);
      group.frondWidth = GUISlider(PropertyType.Normal, frondWidthString,
                                   group.frondWidth, 0.1f, 10.0f, true);
      tempCurve = group.frondCurve;
      if (GUICurve(PropertyType.Normal, tempCurve, m_CurveRangesA)) {
        group.frondCurve = tempCurve;
      }
      group.frondRange = GUIMinMaxSlider(PropertyType.Normal, frondRangeString,
                                         group.frondRange, 0.0f, 1.0f, false);
      group.frondRotation = GUISlider(PropertyType.Normal, frondRotationString,
                                      group.frondRotation, 0.0f, 1.0f, false);
      group.frondCrease = GUISlider(PropertyType.Normal, frondCreaseString,
                                    group.frondCrease, -1.0f, 1.0f, false);
  ...
  public void InspectorLeaf(TreeData treeData, TreeGroupLeaf group) {
    ...
    GUIContent[] categoryNames = {
        TreeEditorHelper.GetGUIContent(
            "Distribution|Adjusts the count and placement of leaves in the group. Use the curves to fine tune position, rotation and scale. The curves are relative to the parent branch."),
        TreeEditorHelper.GetGUIContent(
            "Geometry|Select what type of geometry is generated for this leaf group and which materials are applied. If you use a custom mesh, its materials will be used."),
        TreeEditorHelper.GetGUIContent(
            "Shape|Adjusts the shape and growth of the leaves."),
        null,
        null,
        TreeEditorHelper.GetGUIContent(
            "Wind|Adjusts the parameters used for animating this group of leaves. Wind zones are only active in Play Mode. If you select too high values for Main Wind and Main Turbulence the leaves may float away from the branches.")};
    ...
    // Geometry
    group.geometryMode =
        GUIPopup(PropertyType.FullUpdate, geometryModeLeafString,
                 geometryModeOptions, group.geometryMode, false);

    if (group.geometryMode != (int) TreeGroupLeaf.GeometryMode.MESH)
      group.materialLeaf = GUIMaterialField(
          PropertyType.FullUpdate, group.uniqueID, materialLeafString,
          group.materialLeaf, TreeEditorHelper.NodeType.LeafNode);

    if (group.geometryMode == (int) TreeGroupLeaf.GeometryMode.MESH)
      group.instanceMesh =
          GUIObjectField(PropertyType.FullUpdate, meshString,
                         group.instanceMesh, typeof(GameObject), false)
              as GameObject;
    EndSettingsSection();
    ...
    // Shape
    group.size = GUIMinMaxSlider(PropertyType.Normal, sizeString, group.size,
                                 0.1f, 2.0f, false);

    group.perpendicularAlign =
        GUISlider(PropertyType.Normal, perpendicularAlignString,
                  group.perpendicularAlign, 0.0f, 1.0f, false);
    group.horizontalAlign =
        GUISlider(PropertyType.Normal, horizontalAlignString,
                  group.horizontalAlign, 0.0f, 1.0f, false);
    EndSettingsSection();
  ...
  public override void OnInspectorGUI() {
    ...
    // We just want events in this window - checking on Event.current.type won't
    // work
    EventType hotControlType =
        Event.current.GetTypeForControl(GUIUtility.hotControl);
    // MouseUp works for most controls, need to check Return and OnLostFocus for
    // controls with text fields
    if (hotControlType == EventType.MouseUp ||
        (hotControlType == EventType.KeyUp &&
         Event.current.keyCode == KeyCode.Return) ||
        (hotControlType == EventType.ExecuteCommand &&
         Event.current.commandName == "OnLostFocus")) {
      if (treeData.isInPreviewMode) {
        // We need a complete rebuild..
        m_WantCompleteUpdate = true;
      }
    ...
    // and in case a node is not using a tree shader - recommend one already
    // used.
  ...
  public class Styles {
    public GUIContent iconAddLeaves = EditorGUIUtility.TrIconContent(
        "TreeEditor.AddLeaves", "Add Leaf Group");
    public GUIContent iconAddBranches = EditorGUIUtility.TrIconContent(
        "TreeEditor.AddBranches", "Add Branch Group");
    public GUIContent iconTrash = EditorGUIUtility.TrIconContent(
        "TreeEditor.Trash", "Delete Selected Group");
    public GUIContent iconDuplicate = EditorGUIUtility.TrIconContent(
        "TreeEditor.Duplicate", "Duplicate Selected Group");
    public GUIContent iconRefresh =
        EditorGUIUtility.TrIconContent("TreeEditor.Refresh", "Recompute Tree");
    ...
    public GUIStyle[] nodeBoxes = {"TE NodeBox", "TE NodeBoxSelected"};
  ...
  void DrawHierachy(TreeData treeData, Renderer renderer, Rect sizeRect) {
    ...
    hierachyDisplayRect = GUILayoutUtility.GetRect(
        sizeRect.width, hierachyRect.height + oversize);
    hierachyDisplayRect.width = sizeRect.width;

    // background
    GUI.Box(hierachyDisplayRect, GUIContent.none, styles.nodeBackground);

    hierachyScroll = GUI.BeginScrollView(hierachyDisplayRect, hierachyScroll,
                                         hierachyRect, false, false);
    GUI.changed = clear;
    ...
    if (dragNode != null && isDragging) {
      ...
      DrawHierachyNodes(treeData, nodes, dragNode.group,
                        dragOffset + offset / 2, 0.5f, 0.5f);
    }
    ...
    if (renderer) {
      ...
      if (m && m.sharedMesh && renderer) {
        ...
        Rect labelrect =
            new Rect(hierachyDisplayRect.xMax - 80 - 4,
                     hierachyDisplayRect.yMax + offset.y - 40 - 4, 80, 40);
    ...
    if ((cloneEvent.type == EventType.ScrollWheel) &&
        (Event.current.type == EventType.Used)) {
      Event.current = cloneEvent;
    }
  }

  void BuildHierachyNodes(TreeData treeData, List<HierachyNode> nodes,
                          TreeGroup group, int depth) {
  ...
  void LayoutHierachyNodes(List<HierachyNode> nodes, Rect sizeRect) {
    ...
    // hierachyRect.height = Mathf.Max(hierachyRect.height,
    // hierachyView.height);
    hierachyRect.width = Mathf.Max(hierachyRect.width, hierachyView.width);
    Vector3 cen =
        new Vector3((hierachyRect.xMax + hierachyRect.xMin) * 0.5f,
                    (hierachyRect.yMax + hierachyRect.yMin) * 0.5f, 0.0f);
    cen.y += 8.0f;
    ...
    for (int i = 0; i < nodes.Count; i++) {
      ...
      nodes[i].rect = new Rect(nodes[i].pos.x - hierachyNodeSize.x * 0.5f,
                               nodes[i].pos.y - hierachyNodeSize.y * 0.5f,
                               hierachyNodeSize.x, hierachyNodeSize.y);
    }
  }
  ...
  void HandleDragHierachyNodes(TreeData treeData, List<HierachyNode> nodes) {
    ...
    if (eventType == EventType.MouseDown && Event.current.button == 0) {
      for (int i = 0; i < nodes.Count; i++) {
        ...
        if (GetHierachyNodeVisRect(nodes[i].rect)
    ...
    if (dragNode != null) {
      ...
      for (int i = 0; i < nodes.Count; i++) {
        ...
        if (nodes[i].rect.Contains(Event.current.mousePosition)) {
          ...
          } else if (treeData.GetGroup(sourceGroup.parentGroupID) ==
                     targetGroup) {
  ...
  Rect GetHierachyNodeVisRect(Rect rect) {
    return new Rect(rect.x + rect.width - 13.0f - 1.0f, rect.y + 11, 13.0f,
                    11.0f);
  }

  void DrawHierachyNodes(TreeData treeData, List<HierachyNode> nodes,
                         TreeGroup group, Vector2 offset, float alpha,
                         float fade) {
    // fade
    if ((dragNode != null) && isDragging) {
    ...
    for (int j = 0; j < group.childGroupIDs.Length; j++) {
      ...
      for (int k = 0; k < nodes.Count; k++) {
        if (nodes[k].group == childGroup) {
          Handles.DrawLine(node.pos + offset3 - delta,
                           nodes[k].pos + offset3 + delta);
        }
      }
    }
    ...
    Rect pinRectTop =
        new Rect(rect.x + rect.width / 2f - 4.0f, rect.y - 2.0f, 0f, 0f);
    Rect pinRectBot = new Rect(rect.x + rect.width / 2f - 4.0f,
                               rect.y + rect.height - 2.0f, 0f, 0f);
    Rect iconRect = new Rect(rect.x + 1.0f, rect.yMax - 36f, 32.0f, 32.0f);
    Rect editRect =
        new Rect(rect.xMax - 18.0f, rect.yMax - 18.0f, 16.0f, 16.0f);
    ...
    if (showExtras) {
      ...
      GUIContent visContent =
          TreeEditorHelper.GetGUIContent("|Show / Hide Group");
    ...
    if (GUI.Button(iconRect, buttonContent, GUIStyle.none) ||
        (dragNode == node)) {
    ...
    for (int j = 0; j < group.childGroupIDs.Length; j++) {
      TreeGroup childGroup = treeData.GetGroup(group.childGroupIDs[j]);
      DrawHierachyNodes(treeData, nodes, childGroup, offset, alpha * fade,
                        fade);
    }
