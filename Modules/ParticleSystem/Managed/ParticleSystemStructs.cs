...
[StructLayout(LayoutKind.Sequential),
 NativeType(CodegenOptions.Custom, "MonoBurst",
            Header = "Runtime/Scripting/ScriptingCommonStructDefinitions.h")]
public partial struct Burst {
	...
	public Burst(float _time, short _minCount, short _maxCount, int _cycleCount,
	...
	public Burst(float _time, MinMaxCurve _count, int _cycleCount,
	             float _repeatInterval) {
		m_Time = _time;
		m_Count = _count;
		m_RepeatCount = _cycleCount - 1;
	...
	public float time {
		get {
			return m_Time; // The time the burst happens.
		}
		set { m_Time = value; }
	}
	public MinMaxCurve count {
		get {
			return m_Count; // Number of particles to be emitted.
		}
		set { m_Count = value; }
	}
	public short minCount {
		get {
			return (short)
			       m_Count.constantMin; // Minimum number of particles to be emitted.
		}
		set { m_Count.constantMin = (short) value; }
	}
	public short maxCount {
		get {
			return (short)
			       m_Count.constantMax; // Maximum number of particles to be emitted.
		}
		set { m_Count.constantMax = (short) value; }
	}

	// How many times to play the burst.
	public int cycleCount {
		get { return m_RepeatCount + 1; }
		set {
			if (value < 0)
				throw new ArgumentOutOfRangeException(
					      "cycleCount", "cycleCount must be at least 0: " + value);
	...
	public float repeatInterval {
		...
		set {
			if (value <= 0.0f)
				throw new ArgumentOutOfRangeException(
					      "repeatInterval",
					      "repeatInterval must be greater than 0.0f: " + value);
	...
	public float probability {
		get { return 1.0f - m_InvProbability; }
		set {
			if (value < 0.0f || value > 1.0f)
				throw new ArgumentOutOfRangeException(
					      "probability",
					      "probability must be between 0.0f and 1.0f: " + value);
	...
	private int
	        m_RepeatCount; // externally, we use "cycles", because users preferred
	                       // that, but internally, we must use something that
	                       // defaults to 0, due to C# struct rules
	private float m_RepeatInterval;
	private float m_InvProbability; // internally, we must use something that
	                                // defaults to 0, due to C# struct rules, so
	                                // reverse the storage from 0-1 to 1-0
}
...
public partial struct MinMaxCurve {
	...
	public MinMaxCurve(float multiplier, AnimationCurve min,
	                   AnimationCurve max) {
	...
	public ParticleSystemCurveMode mode {
		get {
			return m_Mode; // The current curve mode.
		}
		set { m_Mode = value; }
	}
	public float curveMultiplier {
		get {
			return m_CurveMultiplier; // The multiplier applied to the 0-1 curves.
		}
		set { m_CurveMultiplier = value; }
	}
	public AnimationCurve curveMax {
		get {
			return m_CurveMax; // The maximum curve.
		}
		set { m_CurveMax = value; }
	}
	public AnimationCurve curveMin {
		get {
			return m_CurveMin; // The minimum curve.
		}
		set { m_CurveMin = value; }
	}
	public float constantMax {
		get {
			return m_ConstantMax; // The maximum constant.
		}
		set { m_ConstantMax = value; }
	}
	public float constantMin {
		get {
			return m_ConstantMin; // The minimum constant.
		}
		set { m_ConstantMin = value; }
	}
	public float constant {
		get {
			return m_ConstantMax; // The single constant.
		}
		set { m_ConstantMax = value; }
	}
	public AnimationCurve curve {
		get {
			return m_CurveMax; // The single curve.
		}
		set { m_CurveMax = value; }
	}
	...
	public float Evaluate(float time, float lerpFactor) {
		...
		case ParticleSystemCurveMode.TwoCurves:
			return Mathf.Lerp(m_CurveMin.Evaluate(time), m_CurveMax.Evaluate(time),
			                  lerpFactor) *
			       m_CurveMultiplier;
...
public partial struct MinMaxGradient {
	...
	public ParticleSystemGradientMode mode {
		get {
			return m_Mode; // The current gradient mode.
		}
		set { m_Mode = value; }
	}
	public Gradient gradientMax {
		get {
			return m_GradientMax; // The maximum gradient.
		}
		set { m_GradientMax = value; }
	}
	public Gradient gradientMin {
		get {
			return m_GradientMin; // The minimum gradient.
		}
		set { m_GradientMin = value; }
	}
	public Color colorMax {
		get {
			return m_ColorMax; // The maximum color.
		}
		set { m_ColorMax = value; }
	}
	public Color colorMin {
		get {
			return m_ColorMin; // The minimum color.
		}
		set { m_ColorMin = value; }
	}
	public Color color {
		get {
			return m_ColorMax; // The single color.
		}
		set { m_ColorMax = value; }
	}
	public Gradient gradient {
		get {
			return m_GradientMax; // The single gradient.
		}
		set { m_GradientMax = value; }
	}
	...
	public Color Evaluate(float time, float lerpFactor) {
		...
		case ParticleSystemGradientMode.TwoGradients:
			return Color.Lerp(m_GradientMin.Evaluate(time),
			                  m_GradientMax.Evaluate(time), lerpFactor);
	...
	// Implicit conversion operator, to allow better syntax when using 1 color
	// or 1 gradient
...
public partial struct Particle {
	...
	public Vector3 animatedVelocity {
		get { return m_AnimatedVelocity; }
	}
	public Vector3 totalVelocity {
		get { return m_Velocity + m_AnimatedVelocity; }
	}
	...
	public float startLifetime {
		get { return m_StartLifetime; }
		set { m_StartLifetime = value; }
	}
	...
	public Vector3 axisOfRotation {
		...
		set { m_AxisOfRotation = value; }
	}

	public float startSize {
		get { return m_StartSize.x; }
		set { m_StartSize = new Vector3(value, value, value); }
	}
	public Vector3 startSize3D {
		get { return m_StartSize; }
		set {
			m_StartSize = value;
			m_Flags |= (UInt32) Flags.Size3D;
		}
	}

	public float rotation {
		get { return m_Rotation.z * Mathf.Rad2Deg; }
		set { m_Rotation = new Vector3(0.0f, 0.0f, value * Mathf.Deg2Rad); }
	}
	public Vector3 rotation3D {
		get { return m_Rotation * Mathf.Rad2Deg; }
		set {
			m_Rotation = value * Mathf.Deg2Rad;
			m_Flags |= (UInt32) Flags.Rotation3D;
		}
	}

	public float angularVelocity {
		get { return m_AngularVelocity.z * Mathf.Rad2Deg; }
		set {
			m_AngularVelocity = new Vector3(0.0f, 0.0f, value * Mathf.Deg2Rad);
		}
	}
	public Vector3 angularVelocity3D {
		get { return m_AngularVelocity * Mathf.Rad2Deg; }
		set {
			m_AngularVelocity = value * Mathf.Deg2Rad;
			m_Flags |= (UInt32) Flags.Rotation3D;
		}
	}

	public float GetCurrentSize(ParticleSystem system) {
		return system.GetParticleCurrentSize(
			ref this); // The current (curve-corrected) size of the particle.
	}
	public Vector3 GetCurrentSize3D(ParticleSystem system) {
		return system.GetParticleCurrentSize3D(
			ref this); // The current (curve-corrected) 3D size of the particle.
	}
	public Color32 GetCurrentColor(ParticleSystem system) {
		return system.GetParticleCurrentColor(
			ref this); // The current (curve-corrected) color of the particle.
	}

	public void SetMeshIndex(int index) {
		m_MeshIndex = index;
		m_Flags |= (UInt32) Flags.MeshIndex;
	}
	public int GetMeshIndex(ParticleSystem system) {
		return system.GetParticleMeshIndex(
			ref this); // Clamped based on the mesh count in the Renderer Module
	}
...
// Script interface for emitting Particles, whilst allowing for overriding of
// some/all properties
[StructLayout(LayoutKind.Sequential)]
public partial struct EmitParams {
	...
	public Vector3 position {
		get { return m_Particle.position; }
		set {
	...
	public bool applyShapeToPosition {
		...
		set { m_ApplyShapeToPosition = value; }
	}
	public Vector3 velocity {
		get { return m_Particle.velocity; }
		set {
	...
	public float startLifetime {
		get { return m_Particle.startLifetime; }
		set {
	...
	public float startSize {
		get { return m_Particle.startSize; }
		set {
	...
	public Vector3 startSize3D {
		get { return m_Particle.startSize3D; }
		set {
	...
	public Vector3 axisOfRotation {
		get { return m_Particle.axisOfRotation; }
		set {
	...
	public float rotation {
		get { return m_Particle.rotation; }
		set {
	...
	public Vector3 rotation3D {
		get { return m_Particle.rotation3D; }
		set {
	...
	public float angularVelocity {
		get { return m_Particle.angularVelocity; }
		set {
	...
	public Vector3 angularVelocity3D {
		get { return m_Particle.angularVelocity3D; }
		set {
	...
	public Color32 startColor {
		get { return m_Particle.startColor; }
		set {
	...
	public UInt32 randomSeed {
		get { return m_Particle.randomSeed; }
		set {
...
public partial struct ParticleCollisionEvent {
	...
	public Component colliderComponent {
		get { return InstanceIDToColliderComponent(m_ColliderInstanceID); }
	}
}
}
