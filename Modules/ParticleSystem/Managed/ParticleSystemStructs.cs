...
public partial class ParticleSystem
{
    ...
    public partial struct Burst
    {
        ...
        public short minCount {
            get {
                return (short)m_Count.constantMin;    // Minimum number of particles to be emitted.
            }
            set {
                m_Count.constantMin = (short)value;
            }
        }
        public short maxCount {
            get {
                return (short)m_Count.constantMax;    // Maximum number of particles to be emitted.
            }
            set {
                m_Count.constantMax = (short)value;
            }
        }
    ...
    public partial struct Particle
    {
        ...
        public Vector3 animatedVelocity {
            get {
                return m_AnimatedVelocity;
            }
        }
        public Vector3 totalVelocity {
            get {
                return m_Velocity + m_AnimatedVelocity;
            }
        }
        ...
        public float rotation {
            get {
                return m_Rotation.z * Mathf.Rad2Deg;
            }
            set {
                m_Rotation = new Vector3(0.0f, 0.0f, value * Mathf.Deg2Rad);
            }
        }
        public Vector3 rotation3D {
            get {
                return m_Rotation * Mathf.Rad2Deg;
            }
            set {
        ...
        public float angularVelocity {
            get {
                return m_AngularVelocity.z * Mathf.Rad2Deg;
            }
            set {
        ...
        public Vector3 angularVelocity3D {
            get {
                return m_AngularVelocity * Mathf.Rad2Deg;
            }
            set {
        ...
        public float GetCurrentSize(ParticleSystem system) {
            return system.GetParticleCurrentSize(ref this);    // The current (curve-corrected) size of the particle.
        }
        public Vector3 GetCurrentSize3D(ParticleSystem system) {
            return system.GetParticleCurrentSize3D(ref this);    // The current (curve-corrected) 3D size of the particle.
        }
        public Color32 GetCurrentColor(ParticleSystem system) {
            return system.GetParticleCurrentColor(ref this);    // The current (curve-corrected) color of the particle.
        }
        ...
        public int GetMeshIndex(ParticleSystem system) {
            return system.GetParticleMeshIndex(ref this);    // Clamped based on the mesh count in the Renderer Module
        }
