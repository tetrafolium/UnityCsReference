...
internal class LocalizationDatabase
{
    ...
    extern public static SystemLanguage currentEditorLanguage {
        get;
        set;
    }
    ...
    extern public static bool enableEditorLocalization {
        get;
        set;
    }

    [NativeProperty(Name = "NoLocalizationGroupName", IsThreadSafe = true)]
    extern public static string noLocalizationGroupName {
        get;
    }
