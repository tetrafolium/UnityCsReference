...
namespace UnityEditor.TextCore {
  [CustomPropertyDrawer(typeof(FontWeights))]
  class FontWeightDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property,
                               GUIContent label) {
      SerializedProperty prop_regular =
          property.FindPropertyRelative("regularTypeface");
      SerializedProperty prop_italic =
          property.FindPropertyRelative("italicTypeface");
  ...
  class FontAssetEditor : Editor {
    ...
    /// <summary>
    /// Material used to display Bitmap glyphs in the Character and Glyph
    /// tables.
    /// </summary>
      ...
      get {
        if (s_InternalBitmapMaterial == null)
          s_InternalBitmapMaterial =
              new Material(ShaderUtilities.ShaderRef_MobileBitmap);
    ...
    private static string[] s_UiStateLabel = new string[]{
        "<i>(Click to collapse)</i> ", "<i>(Click to expand)</i> "};
    ...
    private int[] m_AtlasResolutions = {8,   16,   32,   64,   128, 256,
    ...
    public void OnEnable() {
      ...
      font_atlas_prop = serializedObject.FindProperty("m_AtlasTextures")
                            .GetArrayElementAtIndex(0);
      font_material_prop = serializedObject.FindProperty("m_Material");

      m_AtlasPopulationMode_prop =
          serializedObject.FindProperty("m_AtlasPopulationMode");
      m_AtlasRenderMode_prop =
          serializedObject.FindProperty("m_AtlasRenderMode");
      m_SamplingPointSize_prop =
          m_FaceInfo_prop.FindPropertyRelative("m_PointSize");
      ...
      m_list = new ReorderableList(
          serializedObject,
          serializedObject.FindProperty("m_FallbackFontAssetTable"), true, true,
          true, true);

      m_list.drawElementCallback = (Rect rect, int index, bool isActive,
                                    bool isFocused) => {
      ...
      m_list.drawHeaderCallback =
          rect => { EditorGUI.LabelField(rect, "Fallback List"); };

      font_normalStyle_prop =
          serializedObject.FindProperty("m_RegularStyleWeight");
      font_normalSpacing_prop =
          serializedObject.FindProperty("m_RegularStyleSpacing");

      font_boldStyle_prop = serializedObject.FindProperty("m_BoldStyleWeight");
      font_boldSpacing_prop =
          serializedObject.FindProperty("m_BoldStyleSpacing");

      font_italicStyle_prop =
          serializedObject.FindProperty("m_ItalicStyleSlant");
      ...
      m_KerningPair_prop = serializedObject.FindProperty("m_EmptyKerningPair");
      m_kerningPairs_prop =
          m_KerningTable_prop.FindPropertyRelative("kerningPairs");
      ...
      // m_materialPresets =
      // TMP_EditorUtility.FindMaterialReferences(m_fontAsset);
    ...
    public void OnDisable() {
      // Revert changes if user closes or changes selection without having made
      // a choice.
...
#region Face info
      GUI.Label(rect,
                new GUIContent("<b>Face Info</b> - v" + m_fontAsset.version),
                TextCoreEditorStyles.sectionHeader);
      ...
      if (GUI.Button(rect, new GUIContent("Update Atlas Texture"))) {
        // TMPro_FontAssetCreatorWindow.ShowFontAtlasCreatorWindow(target as
        // FontAsset);
      }
      ...
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_FamilyName"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_StyleName"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_PointSize"));
      ...
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_Scale"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_LineHeight"));

      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_AscentLine"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_CapLine"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_MeanLine"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_Baseline"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_DescentLine"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_UnderlineOffset"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_UnderlineThickness"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_StrikethroughOffset"));
      // EditorGUILayout.PropertyField(m_FaceInfo_prop.FindPropertyRelative("strikethroughThickness"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_SuperscriptOffset"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_SuperscriptSize"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_SubscriptOffset"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_SubscriptSize"));
      EditorGUILayout.PropertyField(
          m_FaceInfo_prop.FindPropertyRelative("m_TabWidth"));
      // TODO : Add clamping for some of these values.
      // subSize_prop.floatValue = Mathf.Clamp(subSize_prop.floatValue, 0.25f,
      // 1f);
...
#region Generation Settings
      ...
      if (GUI.Button(rect, new GUIContent("<b>Generation Settings</b>"),
                     TextCoreEditorStyles.sectionHeader))
        UI_PanelState.generationSettingsPanel =
            !UI_PanelState.generationSettingsPanel;

      GUI.Label(rect,
                (UI_PanelState.generationSettingsPanel ? ""
                 : s_UiStateLabel[1]),
                TextCoreEditorStyles.rightLabel);

      if (UI_PanelState.generationSettingsPanel) {
        EditorGUI.indentLevel = 1;

        EditorGUI.BeginChangeCheck();
        Font sourceFont = (Font) EditorGUILayout.ObjectField(
            "Source Font File", m_fontAsset.m_SourceFontFile_EditorRef,
            typeof(Font), false);
        ...
        EditorGUI.BeginChangeCheck();
        EditorGUILayout.PropertyField(m_AtlasPopulationMode_prop,
        ...
        EditorGUILayout.PropertyField(m_SamplingPointSize_prop,
                                      new GUIContent("Sampling Point Size"));
        EditorGUILayout.PropertyField(m_AtlasPadding_prop,
                                      new GUIContent("Padding"));
        EditorGUILayout.IntPopup(m_AtlasWidth_prop, m_AtlasResolutionLabels,
                                 m_AtlasResolutions,
                                 new GUIContent("Atlas Width"));
        EditorGUILayout.IntPopup(m_AtlasHeight_prop, m_AtlasResolutionLabels,
                                 m_AtlasResolutions,
        ...
        if (m_DisplayDestructiveChangeWarning) {
          ...
          if (GUI.Button(new Rect(rect.width - 140, rect.y + 36, 80, 18),
                         new GUIContent("Apply"))) {
            m_DisplayDestructiveChangeWarning = false;

            // Update face info is sampling point size was changed.
            if (m_AtlasSettings.pointSize !=
                m_SamplingPointSize_prop.intValue) {
              FontEngine.LoadFontFace(m_fontAsset.m_SourceFontFile,
                                      m_SamplingPointSize_prop.intValue);
              m_fontAsset.faceInfo = FontEngine.GetFaceInfo();
            }

            // Update material
            m_fontAsset.material.SetFloat(ShaderUtilities.ID_TextureWidth,
                                          m_AtlasWidth_prop.intValue);
            m_fontAsset.material.SetFloat(ShaderUtilities.ID_TextureHeight,
                                          m_AtlasHeight_prop.intValue);
            m_fontAsset.material.SetFloat(ShaderUtilities.ID_GradientScale,
          ...
          if (GUI.Button(new Rect(rect.width - 56, rect.y + 36, 80, 18),
...
#region Atlas &Material
      ...
      if (GUI.Button(rect, new GUIContent("<b>Atlas & Material</b>"),
                     TextCoreEditorStyles.sectionHeader))
        UI_PanelState.fontAtlasInfoPanel = !UI_PanelState.fontAtlasInfoPanel;

      GUI.Label(rect,
                (UI_PanelState.fontAtlasInfoPanel ? ""
                 : s_UiStateLabel[1]),
                TextCoreEditorStyles.rightLabel);
      ...
      if (UI_PanelState.fontAtlasInfoPanel) {
        ...
        GUI.enabled = false;
        EditorGUILayout.PropertyField(font_atlas_prop,
                                      new GUIContent("Font Atlas"));
        EditorGUILayout.PropertyField(font_material_prop,
                                      new GUIContent("Font Material"));
        GUI.enabled = true;
        EditorGUILayout.Space();
      }
#endregion
      ...
      string evt_cmd =
          Event.current.commandName; // Get Current Event CommandName to check
                                     // for Undo Events
...
#region Font Weights
      ...
      if (UI_PanelState.fontWeightPanel) {
        ...
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(1),
            new GUIContent("100 - Thin"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(2),
            new GUIContent("200 - Extra-Light"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(3),
            new GUIContent("300 - Light"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(4),
            new GUIContent("400 - Regular"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(5),
            new GUIContent("500 - Medium"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(6),
            new GUIContent("600 - Semi-Bold"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(7),
            new GUIContent("700 - Bold"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(8),
            new GUIContent("800 - Heavy"));
        EditorGUILayout.PropertyField(
            fontWeights_prop.GetArrayElementAtIndex(9),
        ...
        EditorGUILayout.PropertyField(font_normalStyle_prop,
                                      new GUIContent("Regular Weight"));
        font_normalStyle_prop.floatValue =
            Mathf.Clamp(font_normalStyle_prop.floatValue, -3.0f, 3.0f);
        if (GUI.changed || evt_cmd == k_UndoRedo) {
          ...
          //    m_materialPresets[i].SetFloat("_WeightNormal",
          //    font_normalStyle_prop.floatValue);
        }

        EditorGUILayout.PropertyField(font_boldStyle_prop,
                                      new GUIContent("Bold Weight"));
        font_boldStyle_prop.floatValue =
            Mathf.Clamp(font_boldStyle_prop.floatValue, -3.0f, 3.0f);
        if (GUI.changed || evt_cmd == k_UndoRedo) {
          GUI.changed = false;

          // Modify the material property on matching material presets.
          // for (int i = 0; i < m_materialPresets.Length; i++)
          //    m_materialPresets[i].SetFloat("_WeightBold",
          //    font_boldStyle_prop.floatValue);
        }
        ...
        EditorGUILayout.PropertyField(font_normalSpacing_prop,
                                      new GUIContent("Regular Spacing"));
        font_normalSpacing_prop.floatValue =
            Mathf.Clamp(font_normalSpacing_prop.floatValue, -100, 100);
        if (GUI.changed || evt_cmd == k_UndoRedo) {
          GUI.changed = false;
        }

        EditorGUILayout.PropertyField(font_boldSpacing_prop,
                                      new GUIContent("Bold Spacing"));
        font_boldSpacing_prop.floatValue =
            Mathf.Clamp(font_boldSpacing_prop.floatValue, 0, 100);
        if (GUI.changed || evt_cmd == k_UndoRedo) {
          GUI.changed = false;
        }
        EditorGUILayout.EndHorizontal();
        ...
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PropertyField(font_italicStyle_prop,
                                      new GUIContent("Italic Style"));
        font_italicStyle_prop.intValue =
            Mathf.Clamp(font_italicStyle_prop.intValue, 15, 60);

        EditorGUILayout.PropertyField(font_tabSize_prop,
                                      new GUIContent("Tab Multiple"));
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.EndVertical();
        EditorGUILayout.Space();
      }
...
#region Character Table
      ...
      if (GUI.Button(rect,
                     new GUIContent(
                         "<b>Character Table</b>",
                         "List of characters contained in this font asset."),
                     TextCoreEditorStyles.sectionHeader))
        UI_PanelState.characterTablePanel = !UI_PanelState.characterTablePanel;

      GUI.Label(rect,
                (UI_PanelState.characterTablePanel ? ""
                 : s_UiStateLabel[1]),
                TextCoreEditorStyles.rightLabel);
...
#region DISPLAY SEARCH BAR
          EditorGUILayout.BeginHorizontal();
          {
            ...
            string searchPattern = EditorGUILayout.TextField(
                "Character Search", m_CharacterSearchPattern,
                "SearchTextField");
            if (EditorGUI.EndChangeCheck() || m_isSearchDirty) {
              if (string.IsNullOrEmpty(searchPattern) == false) {
                ...
                SearchCharacterTable(m_CharacterSearchPattern,
                                     ref m_CharacterSearchList);
              } else
          ...
          DisplayPageNavigation(ref m_CurrentCharacterPage, arraySize,
                                itemsPerPage);
        }
        EditorGUILayout.EndVertical();
        ...
        if (arraySize > 0) {
          ...
          for (int i = itemsPerPage * m_CurrentCharacterPage;
            ...
            Rect elementStartRegion =
                GUILayoutUtility.GetRect(0f, 0f, GUILayout.ExpandWidth(true));
            ...
            Rect elementEndRegion =
                GUILayoutUtility.GetRect(0f, 0f, GUILayout.ExpandWidth(true));

            // Check for Item selection
            Rect selectionArea =
                new Rect(elementStartRegion.x, elementStartRegion.y,
            ...
            if (m_SelectedCharacterRecord == i) {
              DrawBox(selectionArea, 2f, new Color32(40, 192, 255, 255));

              // Draw Glyph management options
              Rect controlRect = EditorGUILayout.GetControlRect(
                  true, EditorGUIUtility.singleLineHeight * 1f);
              float optionAreaWidth = controlRect.width * 0.6f;
              float btnWidth = optionAreaWidth / 3;

              Rect position =
                  new Rect(controlRect.x + controlRect.width * .4f,
                           controlRect.y, btnWidth, controlRect.height);
              ...
              if (GUI.Button(position, new GUIContent("Copy to"))) {
                ...
                int dstGlyphID = TextUtilities.StringHexToInt(m_dstUnicode);
                ...
                // TODO : Find way to force repaint
                // TMPro_EventManager.ON_FONT_PROPERTY_CHANGED(true,
                // m_fontAsset);
              }
              ...
              EditorGUI.LabelField(
                  ...
                  new GUIContent(
                      m_unicodeHexLabel,
                      "The Unicode (Hex) ID of the duplicated Character"),
                  TextCoreEditorStyles.label);

              // Only filter the input when the destination glyph ID text field
              // has focus.
              ...
              if (m_AddCharacterWarning.isEnabled &&
                  EditorApplication.timeSinceStartup <
                      m_AddCharacterWarning.expirationTime) {
                EditorGUILayout.HelpBox(
                    "The Destination Character ID already exists",
                    MessageType.Warning);
              }
            }
          }
...
#region Glyph Table
      ...
      if (GUI.Button(
              rect,
              new GUIContent("<b>Glyph Table</b>",
                             "List of glyphs contained in this font asset."),
              TextCoreEditorStyles.sectionHeader))
        UI_PanelState.glyphTablePanel = !UI_PanelState.glyphTablePanel;

      GUI.Label(rect,
                (UI_PanelState.glyphTablePanel ? ""
                 : s_UiStateLabel[1]),
                TextCoreEditorStyles.rightLabel);
...
#region DISPLAY SEARCH BAR
          EditorGUILayout.BeginHorizontal();
          {
            ...
            EditorGUI.BeginChangeCheck();
            string searchPattern = EditorGUILayout.TextField(
                "Glyph Search", m_GlyphSearchPattern, "SearchTextField");
            if (EditorGUI.EndChangeCheck() || m_isSearchDirty) {
              if (string.IsNullOrEmpty(searchPattern) == false) {
          ...
          DisplayPageNavigation(ref m_CurrentGlyphPage, arraySize,
                                itemsPerPage);
        }
        EditorGUILayout.EndVertical();
        ...
        if (arraySize > 0) {
          ...
          for (int i = itemsPerPage * m_CurrentGlyphPage;
            ...
            SerializedProperty glyphProperty =
                m_GlyphTable_prop.GetArrayElementAtIndex(elementIndex);
            ...
            if (m_SelectedGlyphRecord == i) {
              ...
              if (GUI.Button(position, new GUIContent("Copy to"))) {
                ...
                if (!AddNewGlyph(elementIndex, dstGlyphID)) {
                  ...
                  m_AddGlyphWarning.expirationTime =
                      EditorApplication.timeSinceStartup + 1;
                }
              ...
              EditorGUI.LabelField(
                  position,
                  new GUIContent(m_GlyphIDLabel,
                                 "The Glyph ID of the duplicated Glyph"),
                  TextCoreEditorStyles.label);
              ...
              if (m_AddGlyphWarning.isEnabled &&
                  EditorApplication.timeSinceStartup <
                      m_AddGlyphWarning.expirationTime) {
                EditorGUILayout.HelpBox(
                    "The Destination Glyph ID already exists",
                    MessageType.Warning);
              }
            }
          }
...
#region Kerning Table
      ...
      if (GUI.Button(rect,
                     new GUIContent(
                         "<b>Glyph Adjustment Table</b>",
                         "List of glyph adjustment / advanced kerning pairs."),
                     TextCoreEditorStyles.sectionHeader))
        UI_PanelState.kerningInfoPanel = !UI_PanelState.kerningInfoPanel;

      GUI.Label(rect,
                (UI_PanelState.kerningInfoPanel ? ""
                 : s_UiStateLabel[1]),
                TextCoreEditorStyles.rightLabel);
...
#region DISPLAY SEARCH BAR
          EditorGUILayout.BeginHorizontal();
          {
            ...
            EditorGUI.BeginChangeCheck();
            string searchPattern = EditorGUILayout.TextField(
                "Adjustment Pair Search", m_KerningTableSearchPattern,
                "SearchTextField");
            if (EditorGUI.EndChangeCheck() || m_isSearchDirty) {
              if (string.IsNullOrEmpty(searchPattern) == false) {
                ...
                // Search Glyph Table for potential matches
                SearchKerningTable(m_KerningTableSearchPattern,
                                   ref m_KerningTableSearchList);
              } else
          ...
          DisplayPageNavigation(ref m_CurrentKerningPage, arraySize,
                                itemsPerPage);
        }
        EditorGUILayout.EndVertical();
        ...
        // pos.x += 5;
        // EditorGUI.LabelField(pos, "First Glyph",
        // TMP_UIStyleManager.TMP_GUISkin.label); pos.x += 100;
        // EditorGUI.LabelField(pos, "Adjustment Values",
        // TMP_UIStyleManager.TMP_GUISkin.label);

        // pos.x = pos.width / 2 + 5;
        // EditorGUI.LabelField(pos, "Second Glyph",
        // TMP_UIStyleManager.TMP_GUISkin.label); pos.x += 100;
        // EditorGUI.LabelField(pos, "Adjustment Values",
        // TMP_UIStyleManager.TMP_GUISkin.label);
        ...
        if (arraySize > 0) {
          // Display each GlyphInfo entry using the GlyphInfo property drawer.
          for (int i = itemsPerPage * m_CurrentKerningPage;
               i < arraySize && i < itemsPerPage * (m_CurrentKerningPage + 1);
               i++) {
            // Define the start of the selection region of the element.
            Rect elementStartRegion =
                GUILayoutUtility.GetRect(0f, 0f, GUILayout.ExpandWidth(true));
            ...
            SerializedProperty kerningInfo =
                m_kerningPairs_prop.GetArrayElementAtIndex(elementIndex);

            EditorGUILayout.BeginVertical(EditorStyles.helpBox);

            EditorGUI.BeginDisabledGroup(i != m_SelectedAdjustmentRecord);
            {
              EditorGUILayout.PropertyField(kerningInfo,
                                            new GUIContent("Selectable"));
            }
            EditorGUI.EndDisabledGroup();
            ...
            if (m_SelectedAdjustmentRecord == i) {
              ...
              Rect position =
                  new Rect(controlRect.x + controlRect.width - btnWidth,
                           controlRect.y, btnWidth, controlRect.height);
        ...
        if (GUILayout.Button("Add New Kerning Pair")) {
          int firstGlyph =
              m_KerningPair_prop.FindPropertyRelative("m_FirstGlyph").intValue;
          int secondGlyph =
              m_KerningPair_prop.FindPropertyRelative("m_SecondGlyph").intValue;

          GlyphValueRecord firstGlyphAdjustments =
              GetGlyphAdjustments(m_KerningPair_prop.FindPropertyRelative(
                  "m_FirstGlyphAdjustments"));
          GlyphValueRecord secondGlyphAdjustments =
              GetGlyphAdjustments(m_KerningPair_prop.FindPropertyRelative(
                  "m_SecondGlyphAdjustments"));

          errorCode = m_kerningTable.AddGlyphPairAdjustmentRecord(
              (uint) firstGlyph, firstGlyphAdjustments, (uint) secondGlyph,
              secondGlyphAdjustments);

          // Sort Kerning Pairs & Reload Font Asset if new kerning pair was
          // added.
          if (errorCode != -1) {
        ...
        if (errorCode == -1) {
          ...
          GUILayout.Label("Kerning Pair already <color=#ffff00>exists!</color>",
                          TextCoreEditorStyles.label);
          GUILayout.FlexibleSpace();
    ...
    void SavedAtlasGenerationSettings() {
      m_AtlasSettings.glyphRenderMode =
          (GlyphRenderMode) m_AtlasRenderMode_prop.intValue;
    ...
    void UpdateFontAssetCreationSettings() {
      m_fontAsset.m_FontAssetCreationSettings.pointSize =
          m_SamplingPointSize_prop.intValue;
      m_fontAsset.m_FontAssetCreationSettings.renderMode =
          m_AtlasRenderMode_prop.intValue;
      m_fontAsset.m_FontAssetCreationSettings.padding =
          m_AtlasPadding_prop.intValue;
      m_fontAsset.m_FontAssetCreationSettings.atlasWidth =
          m_AtlasWidth_prop.intValue;
      m_fontAsset.m_FontAssetCreationSettings.atlasHeight =
          m_AtlasHeight_prop.intValue;
    }
    ...
    void UpdateCharacterData(SerializedProperty property, int index) {
      ...
      character.unicode =
          (uint) property.FindPropertyRelative("m_Unicode").intValue;
      character.scale = property.FindPropertyRelative("m_Scale").floatValue;

      SerializedProperty glyphProperty =
          property.FindPropertyRelative("m_Glyph");
      character.glyph.index =
          (uint) glyphProperty.FindPropertyRelative("m_Index").intValue;

      SerializedProperty glyphRectProperty =
          glyphProperty.FindPropertyRelative("m_GlyphRect");
      character.glyph.glyphRect = new GlyphRect(
          glyphRectProperty.FindPropertyRelative("m_X").intValue,
      ...
      SerializedProperty glyphMetricsProperty =
          glyphProperty.FindPropertyRelative("m_Metrics");
      character.glyph.metrics = new GlyphMetrics(
          glyphMetricsProperty.FindPropertyRelative("m_Width").floatValue,
          glyphMetricsProperty.FindPropertyRelative("m_Height").floatValue,
          glyphMetricsProperty.FindPropertyRelative("m_HorizontalBearingX")
              .floatValue,
          glyphMetricsProperty.FindPropertyRelative("m_HorizontalBearingY")
              .floatValue,
          glyphMetricsProperty.FindPropertyRelative("m_HorizontalAdvance")
              .floatValue);

      character.glyph.scale =
          glyphProperty.FindPropertyRelative("m_Scale").floatValue;

      character.glyph.atlasIndex =
          glyphProperty.FindPropertyRelative("m_AtlasIndex").intValue;
    }
    ...
    void UpdateGlyphData(SerializedProperty property, int index) {
      ...
      SerializedProperty glyphRect =
          property.FindPropertyRelative("m_GlyphRect");
      glyph.glyphRect =
          new GlyphRect(glyphRect.FindPropertyRelative("m_X").intValue,
                        glyphRect.FindPropertyRelative("m_Y").intValue,
                        glyphRect.FindPropertyRelative("m_Width").intValue,
                        glyphRect.FindPropertyRelative("m_Height").intValue);

      SerializedProperty glyphMetrics =
          property.FindPropertyRelative("m_Metrics");
      glyph.metrics = new GlyphMetrics(
          glyphMetrics.FindPropertyRelative("m_Width").floatValue,
    ...
    void DisplayPageNavigation(ref int currentPage, int arraySize,
                               int itemsPerPage) {
      Rect pagePos = EditorGUILayout.GetControlRect(false, 20);
      pagePos.width /= 3;

      int shiftMultiplier =
          Event.current.shift ? 10 : 1; // Page + Shift goes 10 page forward
      ...
      GUI.Label(pagePos, "Page " + (currentPage + 1) + " / " + totalPages,
                TextCoreEditorStyles.centeredLabel);
    ...
    bool AddNewGlyph(int srcIndex, int dstGlyphID) {
      ...
      SerializedProperty sourceGlyph =
          m_GlyphTable_prop.GetArrayElementAtIndex(srcIndex);

      int dstIndex = m_GlyphTable_prop.arraySize - 1;

      // Get a reference to the target / destination glyph.
      SerializedProperty targetGlyph =
          m_GlyphTable_prop.GetArrayElementAtIndex(dstIndex);
    ...
    void RemoveGlyphFromList(int index) {
      ...
      int targetGlyphIndex = m_GlyphTable_prop.GetArrayElementAtIndex(index)
      ...
      for (int i = 0; i < m_CharacterTable_prop.arraySize; i++) {
        int glyphIndex = m_CharacterTable_prop.GetArrayElementAtIndex(i)
    ...
    bool AddNewCharacter(int srcIndex, int dstGlyphID) {
      ...
      // Get a reference to the source glyph.
      SerializedProperty sourceCharacter =
          m_CharacterTable_prop.GetArrayElementAtIndex(srcIndex);

      int dstIndex = m_CharacterTable_prop.arraySize - 1;

      // Get a reference to the target / destination glyph.
      SerializedProperty targetCharacter =
          m_CharacterTable_prop.GetArrayElementAtIndex(dstIndex);
    ...
    GlyphValueRecord GetGlyphAdjustments(SerializedProperty property) {
      ...
      record.xPlacement =
          property.FindPropertyRelative("xPlacement").floatValue;
      record.yPlacement =
          property.FindPropertyRelative("yPlacement").floatValue;
    ...
    void CopyGlyphSerializedProperty(SerializedProperty srcGlyph,
                                     ref SerializedProperty dstGlyph) {
      // TODO : Should make a generic function which copies each of the
      // properties.
      dstGlyph.FindPropertyRelative("m_Index").intValue =
          srcGlyph.FindPropertyRelative("m_Index").intValue;

      // Glyph -> GlyphMetrics
      SerializedProperty srcGlyphMetrics =
          srcGlyph.FindPropertyRelative("m_Metrics");
      SerializedProperty dstGlyphMetrics =
          dstGlyph.FindPropertyRelative("m_Metrics");
      ...
      dstGlyphMetrics.FindPropertyRelative("m_HorizontalBearingX").floatValue =
          srcGlyphMetrics.FindPropertyRelative("m_HorizontalBearingX")
              .floatValue;
      dstGlyphMetrics.FindPropertyRelative("m_HorizontalBearingY").floatValue =
          srcGlyphMetrics.FindPropertyRelative("m_HorizontalBearingY")
              .floatValue;
      dstGlyphMetrics.FindPropertyRelative("m_HorizontalAdvance").floatValue =
          srcGlyphMetrics.FindPropertyRelative("m_HorizontalAdvance")
              .floatValue;

      // Glyph -> GlyphRect
      SerializedProperty srcGlyphRect =
          srcGlyph.FindPropertyRelative("m_GlyphRect");
      SerializedProperty dstGlyphRect =
          dstGlyph.FindPropertyRelative("m_GlyphRect");

      dstGlyphRect.FindPropertyRelative("m_X").intValue =
          srcGlyphRect.FindPropertyRelative("m_X").intValue;
      dstGlyphRect.FindPropertyRelative("m_Y").intValue =
          srcGlyphRect.FindPropertyRelative("m_Y").intValue;
      ...
      dstGlyph.FindPropertyRelative("m_Scale").floatValue =
          srcGlyph.FindPropertyRelative("m_Scale").floatValue;
      dstGlyph.FindPropertyRelative("m_AtlasIndex").intValue =
          srcGlyph.FindPropertyRelative("m_AtlasIndex").intValue;
    }

    void CopyCharacterSerializedProperty(SerializedProperty source,
                                         ref SerializedProperty target) {
      // TODO : Should make a generic function which copies each of the
      // properties.
      ...
      target.FindPropertyRelative("m_Scale").floatValue =
          source.FindPropertyRelative("m_Scale").floatValue;
    }
    ...
    void SearchGlyphTable(string searchPattern, ref List<int> searchResults) {
      ...
      for (int i = 0; i < arraySize; i++) {
        SerializedProperty sourceGlyph =
            m_GlyphTable_prop.GetArrayElementAtIndex(i);
    ...
    void SearchCharacterTable(string searchPattern,
                              ref List<int> searchResults) {
      if (searchResults == null)
        searchResults = new List<int>();
      ...
      for (int i = 0; i < arraySize; i++) {
        SerializedProperty sourceCharacter =
            m_CharacterTable_prop.GetArrayElementAtIndex(i);
    ...
    void SearchKerningTable(string searchPattern, ref List<int> searchResults) {
      ...
      for (int i = 0; i < arraySize; i++) {
        SerializedProperty sourceGlyph =
            m_kerningPairs_prop.GetArrayElementAtIndex(i);

        int firstGlyph =
            sourceGlyph.FindPropertyRelative("m_FirstGlyph").intValue;
        int secondGlyph =
            sourceGlyph.FindPropertyRelative("m_SecondGlyph").intValue;
    ...
    void DrawBox(Rect rect, float thickness, Color color) {
      EditorGUI.DrawRect(new Rect(rect.x - thickness, rect.y + thickness,
                                  rect.width + thickness * 2, thickness),
                         color);
      EditorGUI.DrawRect(new Rect(rect.x - thickness, rect.y + thickness,
                                  thickness, rect.height - thickness * 2),
                         color);
      EditorGUI.DrawRect(new Rect(rect.x - thickness,
                                  rect.y + rect.height - thickness * 2,
                                  rect.width + thickness * 2, thickness),
                         color);
      EditorGUI.DrawRect(new Rect(rect.x + rect.width, rect.y + thickness,
                                  thickness, rect.height - thickness * 2),
                         color);
    }
  }
