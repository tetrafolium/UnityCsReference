...
internal static class TextCoreEditorStyles
{
    ...
    static TextCoreEditorStyles()
    {
        if (EditorGUIUtility.isProSkin)
        {
            ...
            sectionHeader = new GUIStyle(EditorStyles.textArea) {
                fixedHeight = 22, richText = true, overflow = new RectOffset(9, 0, 0, 0), padding = new RectOffset(0, 0, 4, 0)
            };
        ...
        // Labels
        label = leftLabel = new GUIStyle(EditorStyles.label) {
