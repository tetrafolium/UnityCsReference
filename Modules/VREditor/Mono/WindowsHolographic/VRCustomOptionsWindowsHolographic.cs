...
namespace UnityEditorInternal.VR {
  internal class VRCustomOptionsWindowsMR : VRCustomOptions {
    ...
    static GUIContent s_DepthBufferSharingLabel =
        EditorGUIUtility.TrTextContent("Enable Depth Buffer Sharing");
    ...
    public override void Initialize(SerializedObject settings,
      ...
      m_DepthBufferSharingEnabled =
          FindPropertyAssert("depthBufferSharingEnabled");
    }
    ...
    public override Rect Draw(BuildTargetGroup target, Rect rect) {
      ...
      label = EditorGUI.BeginProperty(rect, s_DepthBufferSharingLabel,
                                      m_DepthBufferSharingEnabled);
      EditorGUI.BeginChangeCheck();
      bool depthBufferSharingEnabled =
          EditorGUI.Toggle(rect, s_DepthBufferSharingLabel,
                           m_DepthBufferSharingEnabled.boolValue);
      if (EditorGUI.EndChangeCheck()) {
