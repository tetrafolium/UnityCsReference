...
partial class PlayerSettings
{
    public class VROculus
    {
        ...
        {
            get {
                return UnityEditorInternal.PlayerSettingsOculus.sharedDepthBuffer;
            }
            set {
        ...
        {
            get {
                return UnityEditorInternal.PlayerSettingsOculus.dashSupport;
            }
            set {
                UnityEditorInternal.PlayerSettingsOculus.dashSupport = value;
            }
        }
        ...
        {
            get {
                return UnityEditorInternal.PlayerSettingsOculus.lowOverheadMode;
            }
            set {
                UnityEditorInternal.PlayerSettingsOculus.lowOverheadMode = value;
            }
        }
        ...
        {
            get {
                return UnityEditorInternal.PlayerSettingsOculus.protectedContext;
            }
            set {
                UnityEditorInternal.PlayerSettingsOculus.protectedContext = value;
            }
        }
        ...
        {
            get {
                return UnityEditorInternal.PlayerSettingsOculus.v2Signing;
            }
            set {
                UnityEditorInternal.PlayerSettingsOculus.v2Signing = value;
            }
        }
    }
}
...
partial class PlayerSettings
{
    ...
    {
        get {
            return UnityEditorInternal.PlayerSettings360StereoCapture.enable360StereoCapture;
        }
        set {
            UnityEditorInternal.PlayerSettings360StereoCapture.enable360StereoCapture = value;
        }
    }
}
}
