...
extern public static VRDeviceInfoEditor[] GetAllVRDeviceInfo(
	BuildTargetGroup targetGroup);

extern public static VRDeviceInfoEditor[] GetAllVRDeviceInfoByTarget(
	BuildTarget target);

extern public static bool
GetVREnabledOnTargetGroup(BuildTargetGroup targetGroup);

extern public static void
SetVREnabledOnTargetGroup(BuildTargetGroup targetGroup, bool value);

extern public static string[] GetVREnabledDevicesOnTargetGroup(
	BuildTargetGroup targetGroup);

extern public static string[] GetVREnabledDevicesOnTarget(
	BuildTarget target);

[NativeMethod("SetVREnabledDevicesOnTargetGroup")] extern public static void
NativeSetVREnabledDevicesOnTargetGroup(BuildTargetGroup targetGroup,
                                       string[] devices);
public static void
SetVREnabledDevicesOnTargetGroup(BuildTargetGroup targetGroup,
                                 string[] devices) {
...
public static extern bool sharedDepthBuffer {
	[NativeMethod("GetOculusSharedDepthBufferEnabled")] get;
	[NativeMethod("SetOculusSharedDepthBufferEnabled")] set;
}

public static extern bool dashSupport {
	[NativeMethod("GetOculusDashSupportEnabled")] get;
	[NativeMethod("SetOculusDashSupportEnabled")] set;
}

public static extern bool lowOverheadMode {
	[NativeMethod("GetOculusLowOverheadModeEnabled")] get;
	[NativeMethod("SetOculusLowOverheadModeEnabled")] set;
}

public static extern bool protectedContext {
	[NativeMethod("GetOculusProtectedContextEnabled")] get;
	[NativeMethod("SetOculusProtectedContextEnabled")] set;
}

public static extern bool v2Signing {
	[NativeMethod("GetOculusV2SigningEnabled")] get;
	[NativeMethod("SetOculusV2SigningEnabled")] set;
}
}
...
// When Nested classes is supported for bindings, the above Internal only class
// should be removed and the below class should be updated with the proper
// PlayerSettings calls.
...
public static bool sharedDepthBuffer {
	...
	set {
		UnityEditorInternal.PlayerSettingsOculus.sharedDepthBuffer = value;
	}
}
...
public static bool enable360StereoCapture {
	get {
		return UnityEditorInternal.PlayerSettings360StereoCapture
		       .enable360StereoCapture;
	}
	set {
		UnityEditorInternal.PlayerSettings360StereoCapture
		.enable360StereoCapture = value;
	}
}
}
}
