...
[RequireComponent(typeof(RectTransform)), NativeClass("UI::Canvas"),
 NativeHeader("Modules/UI/Canvas.h"), NativeHeader("Modules/UI/UIStructs.h")]
public sealed class Canvas : Behaviour {
  ...
  [Obsolete(
      "Setting normalizedSize via a int is not supported. Please use normalizedSortingGridSize",
      false)]
  [NativeProperty("SortingBucketNormalizedSize", false, TargetType.Function)]
  ...
  [Obsolete(
      "Shared default material now used for text and general UI elements, call Canvas.GetDefaultCanvasMaterial()",
      false)]
...
public static class UISystemProfilerApi {
  public enum SampleType { Layout, Render }
