...
namespace UnityEditor.PackageManager {
  public class PackageRegistrationEventArgs {
    ...
    private static extern PackageInfo[] Internal_GetAddedPackages(
        IntPtr nativeHandle);
    private static extern PackageInfo[] Internal_GetRemovedPackages(
        IntPtr nativeHandle);
    private static extern PackageInfo[] Internal_GetChangedFromPackages(
        IntPtr nativeHandle);
    private static extern PackageInfo[] Internal_GetChangedToPackages(
        IntPtr nativeHandle);

    [RequiredByNativeCode]
    private static PackageRegistrationEventArgs
    InstantiateFromNative(IntPtr nativeHandle) {
    ...
    private void PopulateFromNative(IntPtr nativeHandle) {
      ...
      changedFrom =
          Array.AsReadOnly(Internal_GetChangedFromPackages(nativeHandle));
    }
  }
}
