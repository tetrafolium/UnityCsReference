...
public static extern LogLevel LogLevel {
	get;
	set;
}

[FreeFunction("PackageManager::Add::StartOperation")]
private static extern NativeStatusCode Add([ Out ] out long operationId,
                                           string packageId);

[FreeFunction("PackageManager::Embed::StartOperation")]
private static extern NativeStatusCode Embed([ Out ] out long operationId,
                                             string packageId);

[FreeFunction("PackageManager::GetCachedPackages::StartOperation")]
private static extern NativeStatusCode
GetCachedPackages([ Out ] out long operationId, string registryId);

[FreeFunction("PackageManager::GetPackageInfo::StartOperation")]
private static extern NativeStatusCode
GetPackageInfo([ Out ] out long operationId, string packageId,
               bool offlineMode);

[FreeFunction("PackageManager::GetRegistries::StartOperation")]
private static extern NativeStatusCode
GetRegistries([ Out ] out long operationId);

[FreeFunction("PackageManager::List::StartOperation")]
private static extern NativeStatusCode
List([ Out ] out long operationId, bool offlineMode,
     bool includeIndirectDependencies);

[FreeFunction("PackageManager::Pack::StartOperation")]
private static extern NativeStatusCode Pack([ Out ] out long operationId,
                                            string packageFolder,
                                            string targetFolder);

[FreeFunction("PackageManager::Remove::StartOperation")]
private static extern NativeStatusCode Remove([ Out ] out long operationId,
                                              string packageId);

[FreeFunction("PackageManager::ResetToEditorDefaults::StartOperation")]
private static extern NativeStatusCode
ResetToEditorDefaults([ Out ] out long operationId);

[FreeFunction("PackageManager::Resolve")]
internal static extern void Resolve();

[FreeFunction("PackageManager::Search::StartOperation")]
private static extern NativeStatusCode Search([ Out ] out long operationId,
...
[NativeHeader(
	 "Modules/PackageManager/Editor/PackageManagerImmutableAssets.h")]
[StaticAccessor("PackageManager::ImmutableAssets",
                StaticAccessorType.DoubleColon)]
internal class ImmutableAssets {
public static extern void
SetAssetsAllowedToBeModified(string[] assetsAllowedToBeModified);
}
}
