...
[NativeHeader("Modules/PackageManager/Editor/Public/PackageManager.h")]
[StaticAccessor("PackageManager::GetCachedPackages",
                StaticAccessorType.DoubleColon)]
private static extern CachedPackageInfo[] GetOperationData(
	long operationId);
}

internal partial class GetRegistriesRequest {
[NativeHeader("Modules/PackageManager/Editor/Public/PackageManager.h")]
[StaticAccessor("PackageManager::GetRegistries",
                StaticAccessorType.DoubleColon)]
...
private static extern PackOperationResult
GetOperationData(long operationId);
}
...
[NativeHeader("Modules/PackageManager/Editor/Public/PackageManager.h")]
[StaticAccessor("PackageManager::GetPackageInfo",
                StaticAccessorType.DoubleColon)]
private static extern PackageInfo[] GetOperationData(long operationId);
}
}
