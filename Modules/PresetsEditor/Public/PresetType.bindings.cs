...
namespace UnityEditor.Presets {
  ...
  public struct PresetType : IEquatable<PresetType> {
    ...
    internal PresetType(SerializedProperty property) {
      ...
      m_ManagedTypePPtr = property.FindPropertyRelative("m_ManagedTypePPtr")
                              .objectReferenceValue as MonoScript;
      m_ManagedTypeFallback =
          property.FindPropertyRelative("m_ManagedTypeFallback").stringValue;
    }
    ...
    public override int GetHashCode() { return GetHash(); }
