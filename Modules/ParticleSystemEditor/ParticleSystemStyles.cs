...
class ParticleSystemStyles
{
    ...
    public GUIStyle editableLabel {
        get {
            return EditorGUIUtility.GetBoldDefaultFont() ? m_EditableLabelBold : m_EditableLabel;
        }
    }
    public GUIStyle objectField {
        get {
            return EditorGUIUtility.GetBoldDefaultFont() ? m_ObjectFieldBold : m_ObjectField;
        }
    }
    public GUIStyle numberField {
        get {
            return EditorGUIUtility.GetBoldDefaultFont() ? m_NumberFieldBold : m_NumberField;
        }
    }
    public GUIStyle moduleHeaderStyle {
        get {
            return EditorGUIUtility.GetBoldDefaultFont() ? m_ModuleHeaderStyleBold : m_ModuleHeaderStyle;
        }
    }
    public GUIStyle popup {
        get {
            return EditorGUIUtility.GetBoldDefaultFont() ? m_PopupStyleBold : m_PopupStyle;
        }
    }
    public GUIStyle emitterHeaderStyle {
        get {
            return m_EmitterHeaderStyle;
        }
    }
    public GUIStyle effectBgStyle {
        get {
            return m_EffectBgStyle;
        }
    }
    public GUIStyle moduleBgStyle {
        get {
            return m_ModuleBgStyle;
        }
    }
    ...
    public GUIStyle checkmarkMixed {
        get {
            return m_CheckmarkMixed;
        }
    }
    public GUIStyle minMaxCurveStateDropDown {
        get {
            return m_MinMaxCurveStateDropDown;
        }
    }
    ...
    public GUIStyle toolbarButtonLeftAlignText {
        get {
            return m_ToolbarButtonLeftAlignText;
        }
    }
    public GUIStyle modulePadding {
        get {
            return m_ModulePadding;
        }
    }
    public GUIStyle customDataWindow {
        get {
            return m_CustomDataWindow;
        }
    }
