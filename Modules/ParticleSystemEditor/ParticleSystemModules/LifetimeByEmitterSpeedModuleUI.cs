...
class LifetimeByEmitterSpeedModuleUI : ModuleUI {
  ...
  class Texts {
    public GUIContent speed = EditorGUIUtility.TrTextContent(
        "Multiplier",
        "Controls the initial lifetime of particles based on the speed of the emitter.");
  ...
  public LifetimeByEmitterSpeedModuleUI(ParticleSystemUI owner,
                                        SerializedObject o, string displayName)
      : base(owner, o, "LifetimeByEmitterSpeedModule", displayName) {
    m_ToolTip =
        "Controls the initial lifetime of each particle based on the speed of the emitter when the particle was spawned.";
  }
