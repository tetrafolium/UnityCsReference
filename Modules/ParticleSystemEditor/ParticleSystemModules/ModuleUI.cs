...
abstract partial class ModuleUI : SerializedModule
{
    ...
    {
        get {
            return m_VisibilityState != VisibilityState.NotVisible;
        }
        set {
            SetVisibilityState(value ? VisibilityState.VisibleAndFolded : VisibilityState.NotVisible);
        }
    }
    public bool foldout
    {
        get {
            return m_VisibilityState == VisibilityState.VisibleAndFoldedOut;
        }
        set {
            SetVisibilityState(value ? VisibilityState.VisibleAndFoldedOut : VisibilityState.VisibleAndFolded);
        }
    }
    ...
    {
        get {
            return m_Enabled.hasMultipleDifferentValues;
        }
    }
    ...
    {
        get {
            return m_ParticleSystemUI.m_ParticleEffectUI.m_Owner is ParticleSystemWindow;
        }
    }
