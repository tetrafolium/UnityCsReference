...
namespace UnityEngine.Playables {
  ...
  public partial class PlayableDirector : Behaviour,
    ...
    public void DeferredEvaluate() { EvaluateNextFrame(); }
    ...
    // Bindings properties.
    extern public DirectorUpdateMode timeUpdateMode {
      set;
      get;
    }
    extern public double time {
      set;
      get;
    }
    extern public double initialTime {
      set;
      get;
    }
    ...
    // Bindings methods.
    [NativeThrows] extern public void Evaluate();
    [NativeThrows] extern public void Play();
    extern public void Stop();
    extern public void Pause();
    extern public void Resume();
    [NativeThrows] extern public void RebuildGraph();
    extern public void ClearReferenceValue(PropertyName id);
    extern public void SetReferenceValue(PropertyName id,
                                         UnityEngine.Object value);
    extern public UnityEngine.Object GetReferenceValue(PropertyName id,
                                                       out bool idValid);
    [NativeMethod("GetBindingFor")] extern public Object
    GetGenericBinding(Object key);
    [NativeMethod("ClearBindingFor")] extern public void
    ClearGenericBinding(Object key);
    [NativeThrows] extern public void RebindPlayableGraphOutputs();

    extern internal void ProcessPendingGraphChanges();
    [NativeMethod("HasBinding")] extern internal bool
    HasGenericBinding(Object key);
    ...
    [NativeThrows] extern private void EvaluateNextFrame();
    extern private PlayableGraph GetGraphHandle();
    extern private void SetPlayOnAwake(bool on);
    extern private bool GetPlayOnAwake();
    [NativeThrows] extern private void Internal_SetGenericBinding(Object key,
                                                                  Object value);
