...
public static extern void SetGameId(RuntimePlatform platform,
                                    string gameId);
...
public static void SetPlatformEnabled(RuntimePlatform platform,
                                      bool value) {
}
...
public static extern void SetPlatformGameId(string platformName,
                                            string gameId);
