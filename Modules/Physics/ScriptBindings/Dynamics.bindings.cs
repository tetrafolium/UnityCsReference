...
public struct RaycastHit
{
    ...
    public Collider collider {
        get {
            return Object.FindObjectFromInstanceID(m_Collider) as Collider;
        }
    }
    ...
    public Vector3 barycentricCoordinate {
        get {
            return new Vector3(1.0F - (m_UV.y + m_UV.x), m_UV.x, m_UV.y);
        }
        set {
            m_UV = value;
        }
    ...
    public Rigidbody rigidbody {
        get {
            return collider != null ? collider.attachedRigidbody : null;
        }
    }
...
public partial class Collider : Component
{
    ...
    extern public PhysicMaterial sharedMaterial {
        get;
        set;
    }
...
public struct ContactPoint
{
    ...
    public Collider thisCollider {
        get {
            return GetColliderByInstanceID(m_ThisColliderInstanceID);
        }
    }
    public Collider otherCollider {
        get {
            return GetColliderByInstanceID(m_OtherColliderInstanceID);
        }
    }
...
public class Physics
{
    ...
    extern public static PhysicsScene defaultPhysicsScene {
        get;
    }
