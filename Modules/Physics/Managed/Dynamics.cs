...
public class Collision
{
    ...
    public GameObject gameObject {
        get {
            return m_Rigidbody != null ? m_Rigidbody.gameObject : m_Collider.gameObject;
        }
    }
    ...
    public Component other {
        get {
            return m_Rigidbody != null ? (Component)m_Rigidbody : (Component)m_Collider;
        }
    }
}
