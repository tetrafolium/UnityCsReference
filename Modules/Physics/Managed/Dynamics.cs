...
// The [[ConfigurableJoint]] attempts to attain position / velocity targets
// based on this flag
[Flags()]
...
// Determines how to snap physics joints back to its constrained position when
// it drifts off too much. Note: PositionOnly is not supported anymore!
public enum JointProjectionMode {
	...
	[Obsolete("JointProjectionMode.PositionOnly is no longer supported",
	          true)] PositionOnly = 2
}
...
public enum MeshColliderCookingOptions {
	None,
	[ Obsolete(
		  "No longer used because the problem this was trying to solve is gone since Unity 2018.3",
		  true) ] InflateConvexMesh = 1 << 0,
...
// WheelFrictionCurve is used by the [[WheelCollider]] to describe friction
// properties of the wheel tire.
public struct WheelFrictionCurve {
	...
	public float extremumSlip {
		get { return m_ExtremumSlip; }
		set { m_ExtremumSlip = value; }
	}

	// Force at the extremum slip (default 20000).
	public float extremumValue {
		get { return m_ExtremumValue; }
		set { m_ExtremumValue = value; }
	}

	// Asymptote point slip (default 2).
	public float asymptoteSlip {
		get { return m_AsymptoteSlip; }
		set { m_AsymptoteSlip = value; }
	}

	// Force at the asymptote slip (default 10000).
	public float asymptoteValue {
		get { return m_AsymptoteValue; }
		set { m_AsymptoteValue = value; }
	}

	// Multiplier for the ::ref::extremumValue and ::ref::asymptoteValue values
	// (default 1).
...
public struct SoftJointLimit {
	...
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[Obsolete("Spring has been moved to SoftJointLimitSpring class in Unity 5",
	          true)]
	public float spring {
		get { return 0; }
		set {}
	...
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[Obsolete("Damper has been moved to SoftJointLimitSpring class in Unity 5",
	          true)]
	public float damper {
		get { return 0; }
		set {}
	...
	/// Within the contact distance from the limit contacts will persist in order
	/// to avoid jitter.
	public float contactDistance {
		get { return m_ContactDistance; }
		set { m_ContactDistance = value; }
	}
...
public struct SoftJointLimitSpring {
	...
	// If greater than zero, the limit is soft. The spring will pull the joint
	// back.
	public float spring {
		get { return m_Spring; }
		set { m_Spring = value; }
...
public struct JointDrive {
	...
	// Whether the drive should attempt to reach position, velocity, both or
	// nothing
	public JointDriveMode mode {
		get { return (JointDriveMode) 0; }
		set {}
	}
	...
	public float positionSpring {
		...
		set { m_PositionSpring = value; }
	}

	// Resistance strength against the Position Spring. Only used if /mode/
	// includes Position.
	public float positionDamper {
		get { return m_PositionDamper; }
		set { m_PositionDamper = value; }
	}

	// Amount of force applied to push the object toward the defined direction.
	public float maximumForce {
		get { return m_MaximumForce; }
		set { m_MaximumForce = value; }
	}
}
...
public struct JointMotor {
	...
	// If /freeSpin/ is enabled the motor will only accelerate but never slow
	// down.
	public bool freeSpin {
		get { return m_FreeSpin == 1; }
		set { m_FreeSpin = value ? 1 : 0; }
	}
}

// JointSpring is used add a spring force to [[HingeJoint]] and
// [[PhysicMaterial]].
public struct JointSpring {
	...
	// We have to keep those as public variables because of a bug in the C#
	// raycast sample.
}
...
public struct JointLimits {
	...
	public float bounceMinVelocity {
		get { return m_BounceMinVelocity; }
		set { m_BounceMinVelocity = value; }
	}
	...
	[System.ComponentModel.EditorBrowsable(
		 System.ComponentModel.EditorBrowsableState.Never)]
	[Obsolete(
		 "minBounce and maxBounce are replaced by a single JointLimits.bounciness for both limit ends.",
		 true)]
...
public Rigidbody rigidbody {
	get { return m_Collider.attachedRigidbody; }
}

// The game object that was hit by the controller.
public GameObject gameObject {
	get { return m_Collider.gameObject; }
}

// The transform that was hit by the controller.
public Transform transform {
	get { return m_Collider.transform; }
}
...
// Approximately the direction from the center of the capsule to the point we
// touch.
...
// The [[Rigidbody]] we hit (RO). This is /null/ if the object we hit is a
...
public GameObject gameObject {
	get {
		return m_Rigidbody != null ? m_Rigidbody.gameObject
...
//*undocumented*
[Obsolete(
	 "Do not use Collision.GetEnumerator(), enumerate using non-allocating array returned by Collision.GetContacts() or enumerate using Collision.GetContact(index) instead.",
	 false)]
...
[Obsolete(
	 "Please use Collision.rigidbody, Collision.transform or Collision.collider instead",
	 false)]
public Component other {
	get {
		return m_Rigidbody != null ? (Component) m_Rigidbody : (Component)
		       m_Collider;
	}
}
}
