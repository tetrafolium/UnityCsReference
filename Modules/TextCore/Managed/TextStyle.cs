...
[SerializeField] string m_OpeningDefinition = string.Empty;

[SerializeField] string m_ClosingDefinition = string.Empty;

[SerializeField] int[] m_OpeningTagArray;

[SerializeField] int[] m_ClosingTagArray;

/// <summary>
/// Function to update the content of the int[] resulting from changes to
/// OpeningDefinition & ClosingDefinition.
/// </summary>
