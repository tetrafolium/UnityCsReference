...
namespace UnityEngine.TextCore {
  ...
  /// <summary>
  /// Structure containing information about the individual words contained in
  /// the text object.
  /// </summary>
  struct WordInfo {
    public int firstCharacterIndex;
  ...
  /// <summary>
  /// Class which contains information about every element contained within the
  /// text object.
  /// </summary>
  class TextInfo {
    ...
    /// <summary>
    /// Function to clear the content of the MeshInfo array while preserving the
    /// Triangles, Normals and Tangents.
    /// </summary>
