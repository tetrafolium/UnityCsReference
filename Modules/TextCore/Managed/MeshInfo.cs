...
namespace UnityEngine.TextCore {
  ...
  /// <summary>
  /// Structure which contains the vertex attributes (geometry) of the text
  /// object.
  /// </summary>
  struct MeshInfo {
    static readonly Color32 k_DefaultColor =
    ...
    public MeshInfo(int size) {
      ...
      // Limit the mesh to less than 65535 vertices which is the limit for
      // Unity's Mesh.
    ...
    /// <summary>
    /// Function to resized the content of MeshData and re-assign normals,
    ...
    /// <summary>
    /// Function to clear the vertices while preserving the Triangles, Normals
    /// and Tangents.
    /// </summary>
    ...
    /// </summary>
    /// <param name="src">Index of the first vertex attribute of the source
    /// character / quad.</param> <param name="dst">Index of the first vertex
    /// attribute of the destination character / quad.</param>
