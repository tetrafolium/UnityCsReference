...
namespace UnityEngine.TextCore {
  ...
  class TextStyleSheet : ScriptableObject {
    ...
    [SerializeField] List<TextStyle> m_StyleList = new List<TextStyle>(1);
    Dictionary<int, TextStyle> m_StyleDictionary =
    ...
    void LoadStyleDictionaryInternal() {
      ...
      // Read Styles from style list and store them into dictionary for faster
      // access.
