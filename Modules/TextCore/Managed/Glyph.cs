...
namespace UnityEngine.TextCore {
  ...
  public struct GlyphRect : IEquatable<GlyphRect> {
    ...
    /// <summary>
    /// A GlyphRect with all values set to zero. Shorthand for writing
    /// GlyphRect(0, 0, 0, 0).
    /// </summary>
    public static GlyphRect zero {
      get { return s_ZeroGlyphRect; }
    }

    /// <summary>
    /// Constructor for new GlyphRect.
    /// </summary>
    /// <param name="x">The x position of the glyph in the atlas
    /// texture.</param> <param name="y">The y position of the glyph in the
    /// atlas texture.</param> <param name="width">The width of the
    /// glyph.</param> <param name="height">The height of the glyph.</param>
    ...
    public bool Equals(GlyphRect other) { return base.Equals(other); }
  ...
  public struct GlyphMetrics : IEquatable<GlyphMetrics> {
    ...
    /// relative to the element's left bounding box edge (bbox).
    /// </summary>
    public float horizontalBearingX {
      get { return m_HorizontalBearingX; }
      set { m_HorizontalBearingX = value; }
    }

    /// <summary>
    /// The vertical distance from the current baseline relative to the
    /// element's top bounding box edge (bbox).
    /// </summary>
    public float horizontalBearingY {
      get { return m_HorizontalBearingY; }
      set { m_HorizontalBearingY = value; }
    }
    ...
    /// element. This determines the origin position of the next text element.
    /// </summary>
    public float horizontalAdvance {
      get { return m_HorizontalAdvance; }
      set { m_HorizontalAdvance = value; }
    }
    ...
    public GlyphMetrics(float width, float height, float bearingX,
                        float bearingY, float advance) {
      m_Width = width;
      m_Height = height;
    ...
    public bool Equals(GlyphMetrics other) { return base.Equals(other); }
  ...
  public class Glyph {
    ...
    /// <summary>
    /// The metrics that define the size, position and spacing of a glyph when
    /// performing text layout.
    /// </summary>
    ...
    /// <summary>
    /// A rectangle that defines the position of a glyph within an atlas
    /// texture.
    /// </summary>
    public GlyphRect glyphRect {
      get { return m_GlyphRect; }
      set { m_GlyphRect = value; }
    }
    ...
    public int atlasIndex {
      get { return m_AtlasIndex; }
      set { m_AtlasIndex = value; }
    }
    ...
    /// Constructor for a new glyph
    /// </summary>
    /// <param name="glyph">Glyph whose values are copied to the new
    /// glyph.</param>
    ...
    /// Constructor for a new glyph
    /// </summary>
    /// <param name="glyphStruct">Glyph whose values are copied to the new
    /// glyph.</param>
    ...
    /// <param name="glyphRect">The GlyphRect defining the position of the glyph
    /// in the atlas texture.</param>
    ...
    /// <param name="metrics">The metrics of the glyph.</param>
    /// <param name="glyphRect">The GlyphRect defining the position of the glyph
    /// in the atlas texture.</param> <param name="scale">The relative scale of
    /// the glyph.</param> <param name="atlasIndex">The index of the atlas
    /// texture that contains the glyph.</param>
    public Glyph(uint index, GlyphMetrics metrics, GlyphRect glyphRect,
                 float scale, int atlasIndex) {
      m_Index = index;
      m_Metrics = metrics;
      m_GlyphRect = glyphRect;
      m_Scale = scale;
    ...
    /// <returns>Returns true if the glyphs have the same values. False if
    /// not.</returns>
    public bool Compare(Glyph other) {
      return index == other.index && metrics == other.metrics &&
             glyphRect == other.glyphRect && scale == other.scale &&
