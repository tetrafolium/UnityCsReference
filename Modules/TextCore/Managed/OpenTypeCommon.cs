...
namespace UnityEngine.TextCore.LowLevel {
  ...
  internal struct GlyphValueRecord {
    /// <summary>
    /// The positional adjustment affecting the horizontal bearing X of the
    /// glyph.
    /// </summary>
    ...
    /// <summary>
    /// The positional adjustment affecting the horizontal bearing Y of the
    /// glyph.
    /// </summary>
    ...
    /// Constructor
    /// </summary>
    /// <param name="xPlacement">The positional adjustment affecting the
    /// horizontal bearing X of the glyph.</param> <param name="yPlacement">The
    /// positional adjustment affecting the horizontal bearing Y of the
    /// glyph.</param> <param name="xAdvance">The positional adjustment
    /// affecting the horizontal advance of the glyph.</param> <param
    /// name="yAdvance">The positional adjustment affecting the vertical advance
    /// of the glyph.</param>
    public GlyphValueRecord(float xPlacement, float yPlacement, float xAdvance,
                            float yAdvance) {
    ...
    public static GlyphValueRecord operator +(GlyphValueRecord a,
                                              GlyphValueRecord b) {
      GlyphValueRecord c;
  ...
  internal struct GlyphAdjustmentRecord {
    ...
    /// Constructor
    /// </summary>
    /// <param name="glyphIndex">The index of the glyph in the source font
    /// file.</param> <param name="glyphValueRecord">The GlyphValueRecord
    /// contains the positional adjustments of the glyph.</param>
    public GlyphAdjustmentRecord(uint glyphIndex,
  ...
  internal struct GlyphPairAdjustmentRecord {
    ...
    /// Constructor
    /// </summary>
    /// <param name="firstAdjustmentRecord">First glyph adjustment
    /// record.</param> <param name="secondAdjustmentRecord">Second glyph
    /// adjustment record.</param>
    public GlyphPairAdjustmentRecord(
        GlyphAdjustmentRecord firstAdjustmentRecord,
        GlyphAdjustmentRecord secondAdjustmentRecord) {
