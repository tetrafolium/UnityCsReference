...
namespace UnityEngine.TextCore {
  /// <summary>
  /// Structure containing information about individual links contained in the
  /// text object.
  /// </summary>
  struct LinkInfo {
    public int hashCode;
    ...
    public string GetLinkText(TextInfo textInfo) {
      ...
      for (int i = linkTextfirstCharacterIndex;
           i < linkTextfirstCharacterIndex + linkTextLength; i++)
    ...
    /// </summary>
    /// <returns></returns>
    public string GetLinkId() { return new string(linkId, 0, linkIdLength); }
  }
}
