...
namespace UnityEngine.TextCore {
  ...
  internal class TextGenerationSettings {
    ...
    protected bool Equals(TextGenerationSettings other) {
      return string.Equals(text, other.text) &&
             ...
             Equals(spriteAsset, other.spriteAsset) &&
             fontStyle == other.fontStyle &&
             textAlignment == other.textAlignment &&
             overflowMode == other.overflowMode && wordWrap == other.wordWrap &&
             wordWrappingRatio.Equals(other.wordWrappingRatio) &&
             color.Equals(other.color) &&
             Equals(fontColorGradient, other.fontColorGradient) &&
             tintSprites == other.tintSprites &&
             overrideRichTextColors == other.overrideRichTextColors &&
             fontSize.Equals(other.fontSize) && autoSize == other.autoSize &&
    ...
    public override int GetHashCode() {
      unchecked {
        ...
        hashCode =
            (hashCode * 397) ^ (fontAsset != null ? fontAsset.GetHashCode() : 0);
        hashCode =
            (hashCode * 397) ^ (material != null ? material.GetHashCode() : 0);
        hashCode = (hashCode * 397) ^
                   (spriteAsset != null ? spriteAsset.GetHashCode() : 0);
        ...
        hashCode =
            (hashCode * 397) ^
            (fontColorGradient != null ? fontColorGradient.GetHashCode() : 0);
    ...
    public static bool operator ==(TextGenerationSettings left,
                                   TextGenerationSettings right) {
  ...
  internal class TextGenerator {
    // Character codes
    const int k_Tab = 9, k_LineFeed = 10, k_CarriageReturn = 13, k_Space = 32,
              k_DoubleQuotes = 34, k_NumberSign = 35, k_PercentSign = 37,
              k_SingleQuote = 39, k_Plus = 43, k_Minus = 45, k_Period = 46,
              k_LesserThan = 60, k_Equal = 61, k_GreaterThan = 62,
              k_Underline = 95, k_NoBreakSpace = 0x00A0, k_SoftHyphen = 0x00AD,
              k_HyphenMinus = 0x002D, k_FigureSpace = 0x2007, k_Hyphen = 0x2010,
              k_NonBreakingHyphen = 0x2011, k_ZeroWidthSpace = 0x200B,
              k_NarrowNoBreakSpace = 0x202F, k_WordJoiner = 0x2060,
              k_HorizontalEllipsis = 8230, k_RightSingleQuote = 8217,
              k_Square = 9633, k_HangulJamoStart = 0x1100,
              k_HangulJamoEnd = 0x11ff, k_CjkStart = 0x2E80, k_CjkEnd = 0x9FFF,
              k_HangulJameExtendedStart = 0xA960,
              k_HangulJameExtendedEnd = 0xA97F, k_HangulSyllablesStart = 0xAC00,
              k_HangulSyllablesEnd = 0xD7FF, k_CjkIdeographsStart = 0xF900,
              k_CjkIdeographsEnd = 0xFAFF, k_CjkFormsStart = 0xFE30,
              k_CjkFormsEnd = 0xFE4F, k_CjkHalfwidthStart = 0xFF00,
    ...
    const int k_MaxCharacters = 8; // Determines the initial allocation and size
                                   // of the character array / buffer.
    ...
    public static void GenerateText(TextGenerationSettings settings,
                                    TextInfo textInfo) {
      if (settings.fontAsset == null ||
          settings.fontAsset.characterLookupTable == null) {
        Debug.LogWarning(
      ...
      if (textInfo == null) {
        Debug.LogError(
            "Null TextInfo provided to TextGenerator. Cannot update its content.");
        return;
      }
    ...
    public static Vector2 GetCursorPosition(TextGenerationSettings settings,
                                            int index) {
      if (settings.fontAsset == null ||
          settings.fontAsset.characterLookupTable == null) {
        Debug.LogWarning(
    ...
    public static Vector2 GetCursorPosition(TextInfo textInfo, Rect screenRect,
                                            int index) {
      ...
      if (index >= textInfo.characterCount) {
        return new Vector2(
            textInfo.textElementInfo[textInfo.characterCount - 1].xAdvance +
                screenRect.position.x,
            screenRect.position.y);
      }

      return new Vector2(textInfo.textElementInfo[index].origin +
                             screenRect.position.x,
                         screenRect.position.y);
    }

    public static float GetPreferredWidth(TextGenerationSettings settings,
                                          TextInfo textInfo) {
      if (settings.fontAsset == null ||
          settings.fontAsset.characterLookupTable == null) {
        Debug.LogWarning(
    ...
    public static float GetPreferredHeight(TextGenerationSettings settings,
                                           TextInfo textInfo) {
      if (settings.fontAsset == null ||
          settings.fontAsset.characterLookupTable == null) {
        Debug.LogWarning(
    ...
    public static Vector2 GetPreferredValues(TextGenerationSettings settings,
                                             TextInfo textInfo) {
      if (settings.fontAsset == null ||
          settings.fontAsset.characterLookupTable == null) {
        Debug.LogWarning(
    ...
    RichTextTagStack<MaterialReference> m_MaterialReferenceStack =
        new RichTextTagStack<MaterialReference>(new MaterialReference[16]);
    float m_Padding;
    ...
    RichTextTagStack<FontWeight> m_FontWeightStack =
        new RichTextTagStack<FontWeight>(8);

    TextAlignment m_LineJustification;
    RichTextTagStack<TextAlignment> m_LineJustificationStack =
        new RichTextTagStack<TextAlignment>(16);
    float m_BaselineOffset;
    RichTextTagStack<float> m_BaselineOffsetStack =
        new RichTextTagStack<float>(new float[16]);
    Color32 m_FontColor32;
    Color32 m_HtmlColor;
    Color32 m_UnderlineColor;
    Color32 m_StrikethroughColor;
    RichTextTagStack<Color32> m_ColorStack =
        new RichTextTagStack<Color32>(new Color32[16]);
    RichTextTagStack<Color32> m_UnderlineColorStack =
        new RichTextTagStack<Color32>(new Color32[16]);
    RichTextTagStack<Color32> m_StrikethroughColorStack =
        new RichTextTagStack<Color32>(new Color32[16]);
    RichTextTagStack<Color32> m_HighlightColorStack =
        new RichTextTagStack<Color32>(new Color32[16]);
    TextGradientPreset m_ColorGradientPreset;
    RichTextTagStack<TextGradientPreset> m_ColorGradientStack =
        new RichTextTagStack<TextGradientPreset>(new TextGradientPreset[16]);
    RichTextTagStack<int> m_ActionStack =
        new RichTextTagStack<int>(new int[16]);
    ...
    float m_TagIndent;
    RichTextTagStack<float> m_IndentStack =
        new RichTextTagStack<float>(new float[16]);
    bool m_TagNoParsing;
    ...
    Dictionary<int, int> m_MaterialReferenceIndexLookup =
    ...
    void Prepare(TextGenerationSettings generationSettings, TextInfo textInfo) {
      ...
      // TODO: Hard coded padding value is temporary change to avoid clipping of
      // text geometry with small point size.
      ...
      ComputeMarginSize(generationSettings.screenRect,
                        generationSettings.margins);

      // ParseInputText
      TextGeneratorUtilities.StringToCharArray(
          generationSettings.text, ref m_CharBuffer, ref m_StyleStack,
          generationSettings);
      ...
      if (generationSettings.autoSize)
        m_FontSize = Mathf.Clamp(generationSettings.fontSize,
                                 generationSettings.fontSizeMin,
                                 generationSettings.fontSizeMax);
      else
    ...
    /// <summary>
    /// This is the main function that is responsible for creating / displaying
    /// the text.
    /// </summary>
    void GenerateTextMesh(TextGenerationSettings generationSettings,
                          TextInfo textInfo) {
      // Clear TextInfo
      if (textInfo == null)
        return;
      ...
      if (m_CharBuffer == null || m_CharBuffer.Length == 0 ||
          m_CharBuffer[0] == (char) 0) {
      ...
      m_MaterialReferenceStack.SetDefault(
      ...
      // Calculate the scale of the font based on selected font size and
      // sampling point size. baseScale is calculated using the font asset
      // assigned to the text object.
      float baseScale = m_FontScale =
          (m_FontSize / generationSettings.fontAsset.faceInfo.pointSize *
           generationSettings.fontAsset.faceInfo.scale);
      ...
      m_FontStyleInternal =
          generationSettings.fontStyle; // Set the default style.
      m_FontWeightInternal =
          (m_FontStyleInternal & FontStyles.Bold) ==
          FontStyles.Bold ? FontWeight.Bold : generationSettings.fontWeight;
      m_FontWeightStack.SetDefault(m_FontWeightInternal);
      m_FontStyleStack.Clear();

      m_LineJustification =
          generationSettings.textAlignment; // Sets the line justification mode
                                            // to match editor alignment.
      m_LineJustificationStack.SetDefault(m_LineJustification);

      float padding = 0;
      float boldXAdvanceMultiplier =
          1; // Used to increase spacing between character when style is bold.
      ...
      Vector3 underlineStart =
          Vector3.zero; // Used to track where underline starts & ends.
      ...
      m_LineOffset = 0; // Amount of space between lines (font line spacing +
                        // m_linespacing).
      m_LineHeight = k_FloatUnset;
      float lineGap = m_CurrentFontAsset.faceInfo.lineHeight -
                      (m_CurrentFontAsset.faceInfo.ascentLine -
                       m_CurrentFontAsset.faceInfo.descentLine);

      m_CSpacing = 0; // Amount of space added between characters as a result of
                      // the use of the <cspace> tag.
      m_MonoSpacing = 0;
      ...
      m_PageNumber = 0;
      int pageToDisplay = Mathf.Clamp(generationSettings.pageToDisplay - 1, 0,
                                      textInfo.pageInfo.Length - 1);
      ...
      // Parse through Character buffer to read HTML tags and begin creating
      // mesh.
      for (int i = 0; i < m_CharBuffer.Length && m_CharBuffer[i] != 0; i++) {
        var charCode = m_CharBuffer[i]; // Holds the character code of the
                                        // currently being processed character.
        ...
        if (generationSettings.richText && charCode == k_LesserThan) {
          ...
          // Check if Tag is valid. If valid, skip to the end of the validated
          // tag.
          if (ValidateHtmlTag(m_CharBuffer, i + 1, out endTagIndex,
                              generationSettings, textInfo)) {
            i = endTagIndex;
          ...
          m_TextElementType =
              textInfo.textElementInfo[m_CharacterCount].elementType;
          m_CurrentMaterialIndex =
              textInfo.textElementInfo[m_CharacterCount].materialReferenceIndex;
          m_CurrentFontAsset =
              textInfo.textElementInfo[m_CharacterCount].fontAsset;
        }

        int prevMaterialIndex = m_CurrentMaterialIndex;

        bool isUsingAltTypeface =
            textInfo.textElementInfo[m_CharacterCount].isUsingAlternateTypeface;

        m_IsParsingText = false;

        // When using Linked text, mark character as ignored and skip to next
        // character.
        ...
        if (m_TextElementType == TextElementType.Character) {
          if ((m_FontStyleInternal & FontStyles.UpperCase) ==
              FontStyles.UpperCase) {
            // If this character is lowercase, switch to uppercase.
            if (char.IsLower((char) charCode))
              charCode = char.ToUpper((char) charCode);
          } else if ((m_FontStyleInternal & FontStyles.LowerCase) ==
                     FontStyles.LowerCase) {
            // If this character is uppercase, switch to lowercase.
            if (char.IsUpper((char) charCode))
              charCode = char.ToLower((char) charCode);
          } else if ((m_FontStyleInternal & FontStyles.SmallCaps) ==
        ...
        if (m_TextElementType == TextElementType.Sprite) {
          // If a sprite is used as a fallback then get a reference to it and
          // set the color to white.
          m_CurrentSpriteAsset =
              textInfo.textElementInfo[m_CharacterCount].spriteAsset;
          m_SpriteIndex =
              textInfo.textElementInfo[m_CharacterCount].spriteIndex;

          SpriteCharacter sprite =
              m_CurrentSpriteAsset.spriteCharacterTable[m_SpriteIndex];
          if (sprite == null)
            continue;
          ...
          // The sprite scale calculations are based on the font asset assigned
          // to the text object.
          float spriteScale =
              (m_CurrentFontSize / m_CurrentFontAsset.faceInfo.pointSize *
               m_CurrentFontAsset.faceInfo.scale);
          currentElementScale = m_CurrentFontAsset.faceInfo.ascentLine /
                                sprite.glyph.metrics.height * sprite.scale *
                                spriteScale;
          ...
          m_CachedTextElement =
              textInfo.textElementInfo[m_CharacterCount].textElement;
          ...
          m_CurrentFontAsset =
              textInfo.textElementInfo[m_CharacterCount].fontAsset;
          m_CurrentMaterial =
              textInfo.textElementInfo[m_CharacterCount].material;
          m_CurrentMaterialIndex =
              textInfo.textElementInfo[m_CharacterCount].materialReferenceIndex;

          // Re-calculate font scale as the font asset may have changed.
          m_FontScale = m_CurrentFontSize * smallCapsMultiplier /
                        m_CurrentFontAsset.faceInfo.pointSize *
                        m_CurrentFontAsset.faceInfo.scale;

          currentElementScale =
              m_FontScale * m_FontScaleMultiplier * m_CachedTextElement.scale;

          textInfo.textElementInfo[m_CharacterCount].elementType =
              TextElementType.Character;
          textInfo.textElementInfo[m_CharacterCount].scale =
              currentElementScale;

          padding =
              m_CurrentMaterialIndex == 0
                  ? m_Padding
                  : GetPaddingForMaterial(m_CurrentMaterial,
                                          generationSettings.extraPadding);
        }
        ...
        textInfo.textElementInfo[m_CharacterCount].pointSize =
            m_CurrentFontSize;
        textInfo.textElementInfo[m_CharacterCount].color = m_HtmlColor;
        textInfo.textElementInfo[m_CharacterCount].underlineColor =
            m_UnderlineColor;
        textInfo.textElementInfo[m_CharacterCount].strikethroughColor =
            m_StrikethroughColor;
        textInfo.textElementInfo[m_CharacterCount].highlightColor =
            m_HighlightColor;
        ...
        if (generationSettings.enableKerning) {
          ...
          if (m_CharacterCount < totalCharacterCount - 1) {
            uint nextGlyph =
                textInfo.textElementInfo[m_CharacterCount + 1].character;
            KerningPairKey keyValue =
                new KerningPairKey((uint) charCode, nextGlyph);

            m_CurrentFontAsset.kerningLookupDictionary.TryGetValue(
          ...
          if (m_CharacterCount >= 1) {
            uint previousGlyph =
                textInfo.textElementInfo[m_CharacterCount - 1].character;
            KerningPairKey keyValue =
                new KerningPairKey(previousGlyph, (uint) charCode);
        ...
        if (generationSettings.isRightToLeft) {
          m_XAdvance -= ((m_CachedTextElement.glyph.metrics.horizontalAdvance *
                              boldXAdvanceMultiplier +
                          generationSettings.characterSpacing +
                          generationSettings.wordSpacing +
                          m_CurrentFontAsset.regularStyleSpacing) *
                             currentElementScale +
                         m_CSpacing) *
                        (1 - m_CharWidthAdjDelta);

          if (char.IsWhiteSpace((char) charCode) ||
              charCode == k_ZeroWidthSpace)
        ...
        if (m_MonoSpacing != 0) {
          monoAdvance =
              (m_MonoSpacing / 2 -
               (m_CachedTextElement.glyph.metrics.width / 2 +
                m_CachedTextElement.glyph.metrics.horizontalBearingX) *
                   currentElementScale) *
              (1 - m_CharWidthAdjDelta);
             ...
             FontStyles.Bold)) // Checks for any combination of Bold Style.
        {
          if (m_CurrentMaterial.HasProperty(ShaderUtilities.ID_GradientScale)) {
            float gradientScale =
                m_CurrentMaterial.GetFloat(ShaderUtilities.ID_GradientScale);
            stylePadding =
                m_CurrentFontAsset.boldStyleWeight / 4.0f * gradientScale *
                m_CurrentMaterial.GetFloat(ShaderUtilities.ID_ScaleRatio_A);
          ...
          boldXAdvanceMultiplier =
              1 + m_CurrentFontAsset.boldStyleSpacing * 0.01f;
        } else {
          if (m_CurrentMaterial.HasProperty(ShaderUtilities.ID_GradientScale)) {
            float gradientScale =
                m_CurrentMaterial.GetFloat(ShaderUtilities.ID_GradientScale);
            stylePadding =
                m_CurrentFontAsset.regularStyleWeight / 4.0f * gradientScale *
                m_CurrentMaterial.GetFloat(ShaderUtilities.ID_ScaleRatio_A);
        ...
        float fontBaseLineOffset = m_CurrentFontAsset.faceInfo.baseline *
                                   m_FontScale * m_FontScaleMultiplier *
                                   m_CurrentFontAsset.faceInfo.scale;
        Vector3 topLeft;
        topLeft.x = m_XAdvance +
                    ((m_CachedTextElement.glyph.metrics.horizontalBearingX -
                      padding - stylePadding + glyphAdjustments.xPlacement) *
                     currentElementScale * (1 - m_CharWidthAdjDelta));
        topLeft.y = fontBaseLineOffset +
                    (m_CachedTextElement.glyph.metrics.horizontalBearingY +
                     padding + glyphAdjustments.yPlacement) *
                        currentElementScale -
        ...
        bottomLeft.y =
            topLeft.y -
            ((m_CachedTextElement.glyph.metrics.height + padding * 2) *
             currentElementScale);
        bottomLeft.z = 0;

        Vector3 topRight;
        topRight.x =
            bottomLeft.x + ((m_CachedTextElement.glyph.metrics.width +
                             padding * 2 + stylePadding * 2) *
                            currentElementScale * (1 - m_CharWidthAdjDelta));
        ...
        if (m_TextElementType == TextElementType.Character &&
            !isUsingAltTypeface &&
            ((m_FontStyleInternal & FontStyles.Italic) == FontStyles.Italic)) {
          // Shift Top vertices forward by half (Shear Value * height of
          // character) and Bottom vertices back by same amount.
          ...
          Vector3 bottomShear = new Vector3(
              shearValue *
                  (((m_CachedTextElement.glyph.metrics.horizontalBearingY -
                     m_CachedTextElement.glyph.metrics.height - padding -
                     stylePadding)) *
                   currentElementScale),
              0, 0);
        ...
        if (m_IsFxMatrixSet) {
          ...
          topLeft = m_FxMatrix.MultiplyPoint3x4(topLeft - positionOffset) +
                    positionOffset;
          bottomLeft =
              m_FxMatrix.MultiplyPoint3x4(bottomLeft - positionOffset) +
              positionOffset;
          topRight = m_FxMatrix.MultiplyPoint3x4(topRight - positionOffset) +
                     positionOffset;
          bottomRight =
              m_FxMatrix.MultiplyPoint3x4(bottomRight - positionOffset) +
              positionOffset;
        }
        ...
        textInfo.textElementInfo[m_CharacterCount].baseLine =
            fontBaseLineOffset - m_LineOffset + m_BaselineOffset;
        textInfo.textElementInfo[m_CharacterCount].aspectRatio =
            (topRight.x - bottomLeft.x) / (topLeft.y - bottomLeft.y);

        // Compute and save text element Ascender and maximum line Ascender.
        float elementAscender =
            m_CurrentFontAsset.faceInfo.ascentLine *
                (m_TextElementType ==
                     TextElementType.Character ? currentElementScale /
                         smallCapsMultiplier
                 : textInfo.textElementInfo[m_CharacterCount].scale) +
            m_BaselineOffset;
        textInfo.textElementInfo[m_CharacterCount].ascender =
            elementAscender - m_LineOffset;
        m_MaxLineAscender = elementAscender > m_MaxLineAscender ? elementAscender
            : m_MaxLineAscender;
        ...
        float elementDescender =
            m_CurrentFontAsset.faceInfo.descentLine *
                (m_TextElementType ==
                 ...
                 : textInfo.textElementInfo[m_CharacterCount].scale) +
            m_BaselineOffset;
        float elementDescenderIi =
            textInfo.textElementInfo[m_CharacterCount].descender =
                elementDescender - m_LineOffset;
        m_MaxLineDescender = elementDescender <
                             m_MaxLineDescender ? elementDescender
            : m_MaxLineDescender;

        // Adjust maxLineAscender and maxLineDescender if style is superscript
        // or subscript
        if ((m_FontStyleInternal & FontStyles.Subscript) ==
                FontStyles.Subscript ||
            (m_FontStyleInternal & FontStyles.Superscript) ==
                FontStyles.Superscript) {
          float baseAscender = (elementAscender - m_BaselineOffset) /
                               m_CurrentFontAsset.faceInfo.subscriptSize;
          elementAscender = m_MaxLineAscender;
          m_MaxLineAscender = baseAscender > m_MaxLineAscender ? baseAscender
              : m_MaxLineAscender;

          float baseDescender = (elementDescender - m_BaselineOffset) /
                                m_CurrentFontAsset.faceInfo.subscriptSize;
          elementDescender = m_MaxLineDescender;
          m_MaxLineDescender = baseDescender < m_MaxLineDescender ? baseDescender
              : m_MaxLineDescender;
        }

        if (m_LineNumber == 0 || m_IsNewPage) {
          m_MaxAscender =
              m_MaxAscender > elementAscender ? m_MaxAscender : elementAscender;
          m_MaxCapHeight = Mathf.Max(
              m_MaxCapHeight, m_CurrentFontAsset.faceInfo.capLine *
                                  currentElementScale / smallCapsMultiplier);
        }
        if (m_LineOffset == 0)
          pageAscender =
              pageAscender > elementAscender ? pageAscender : elementAscender;

        // Set Characters to not visible by default.
        textInfo.textElementInfo[m_CharacterCount].isVisible = false;

        // Setup Mesh for visible text elements. ie. not a SPACE / LINEFEED /
        // CARRIAGE RETURN.
        float lineOffsetDelta;
        if (charCode == k_Tab || charCode == k_NoBreakSpace ||
            charCode == k_FigureSpace ||
            (!char.IsWhiteSpace((char) charCode) &&
             charCode != k_ZeroWidthSpace) ||
            m_TextElementType == TextElementType.Sprite) {
          textInfo.textElementInfo[m_CharacterCount].isVisible = true;

          width = m_Width != -1
                      ? Mathf.Min(marginWidth + 0.0001f - m_MarginLeft -
                                      m_MarginRight,
                                  m_Width)
          ...
          bool isJustifiedOrFlush =
              ((HorizontalAlignment) m_LineJustification &
               HorizontalAlignment.Flush) == HorizontalAlignment.Flush ||
              ((HorizontalAlignment) m_LineJustification &
               HorizontalAlignment.Justified) == HorizontalAlignment.Justified;

          // Calculate the line breaking width of the text.
          var linebreakingWidth =
              Mathf.Abs(m_XAdvance) +
              (!generationSettings.isRightToLeft ? m_CachedTextElement.glyph
                    .metrics.horizontalAdvance : 0) *
                  (1 - m_CharWidthAdjDelta) *
                  (charCode != 0xAD ? currentElementScale : oldScale);

          // Check if Character exceeds the width of the Text Container
          if (linebreakingWidth > width * (isJustifiedOrFlush ? 1.05f : 1.0f)) {
            ellipsisIndex =
                m_CharacterCount - 1; // Last safely rendered character

            // Word Wrapping
            if (generationSettings.wordWrap &&
                m_CharacterCount != m_FirstCharacterOfLine) {
              // Check if word wrapping is still possible
              if (wrappingIndex == m_SavedWordWrapState.previousWordBreak ||
                  isFirstWord) {
                // Word wrapping is no longer possible. Shrink size of text if
                // auto-sizing is enabled.
                if (generationSettings.autoSize &&
                    m_FontSize > generationSettings.fontSizeMin) {
                  // Handle Character Width Adjustments
                  if (m_CharWidthAdjDelta <
                      generationSettings.charWidthMaxAdj / 100) {
                    m_LoopCountA = 0;
                  ...
                  m_FontSize -=
                      Mathf.Max((m_FontSize - m_MinFontSize) / 2, 0.05f);
                  m_FontSize = (int)(Mathf.Max(m_FontSize,
                                               generationSettings.fontSizeMin) *
                                         20 +
                                     0.5f) /
                               20f;
                ...
                // Word wrapping is no longer possible, now breaking up
                // individual words.
              ...
              // Restore to previously stored state of last valid (space
              // character or linefeed)
              i = RestoreWordWrappingState(ref m_SavedWordWrapState, textInfo);
              wrappingIndex = i; // Used to detect when line length can no
                                 // longer be reduced.
              ...
              if (m_LineNumber > 0 &&
                  !TextGeneratorUtilities.Approximately(
                      m_MaxLineAscender, m_StartOfLineAscender) &&
                  m_LineHeight == k_FloatUnset && !m_IsNewPage) {
                float offsetDelta = m_MaxLineAscender - m_StartOfLineAscender;
                TextGeneratorUtilities.AdjustLineOffset(m_FirstCharacterOfLine,
                                                        m_CharacterCount,
                                                        offsetDelta, textInfo);
              ...
              // Calculate lineAscender & make sure if last character is
              // superscript or subscript that we check that as well.
              ...
              if (generationSettings.useMaxVisibleDescender &&
                  (m_CharacterCount >=
                       generationSettings.maxVisibleCharacters ||
                   m_LineNumber >= generationSettings.maxVisibleLines))
                isMaxVisibleDescenderSet = true;

              // Track & Store lineInfo for the new line
              textInfo.lineInfo[m_LineNumber].firstCharacterIndex =
                  m_FirstCharacterOfLine;
              textInfo.lineInfo[m_LineNumber].firstVisibleCharacterIndex =
                  m_FirstVisibleCharacterOfLine =
                      m_FirstCharacterOfLine >
                      m_FirstVisibleCharacterOfLine ? m_FirstCharacterOfLine
                  : m_FirstVisibleCharacterOfLine;
              textInfo.lineInfo[m_LineNumber].lastCharacterIndex =
                  m_LastCharacterOfLine =
                      m_CharacterCount - 1 > 0 ? m_CharacterCount - 1 : 0;
              textInfo.lineInfo[m_LineNumber]
                  .lastVisibleCharacterIndex = m_LastVisibleCharacterOfLine =
                  m_LastVisibleCharacterOfLine <
                  m_FirstVisibleCharacterOfLine ? m_FirstVisibleCharacterOfLine
                  : m_LastVisibleCharacterOfLine;

              textInfo.lineInfo[m_LineNumber].characterCount =
                  textInfo.lineInfo[m_LineNumber].lastCharacterIndex -
                  textInfo.lineInfo[m_LineNumber].firstCharacterIndex + 1;
              textInfo.lineInfo[m_LineNumber].visibleCharacterCount =
                  m_LineVisibleCharacterCount;
              textInfo.lineInfo[m_LineNumber].lineExtents.min = new Vector2(
                  textInfo.textElementInfo[m_FirstVisibleCharacterOfLine]
                      .bottomLeft.x,
                  lineDescender);
              textInfo.lineInfo[m_LineNumber].lineExtents.max = new Vector2(
                  textInfo.textElementInfo[m_LastVisibleCharacterOfLine]
                      .topRight.x,
                  lineAscender);
              textInfo.lineInfo[m_LineNumber].length =
                  textInfo.lineInfo[m_LineNumber].lineExtents.max.x;
              textInfo.lineInfo[m_LineNumber].width = width;

              textInfo.lineInfo[m_LineNumber].maxAdvance =
                  textInfo.textElementInfo[m_LastVisibleCharacterOfLine]
                      .xAdvance -
                  (generationSettings.characterSpacing +
                   m_CurrentFontAsset.regularStyleSpacing) *
              ...
              textInfo.lineInfo[m_LineNumber].lineHeight =
                  lineAscender - lineDescender + lineGap * baseScale;

              m_FirstCharacterOfLine =
                  m_CharacterCount; // Store first character of the next line.
              m_LineVisibleCharacterCount = 0;

              // Store the state of the line before starting on the new line.
              SaveWordWrappingState(ref m_SavedLineState, i,
                                    m_CharacterCount - 1, textInfo);
              ...
              if (m_LineNumber >= textInfo.lineInfo.Length)
                TextGeneratorUtilities.ResizeLineExtents(m_LineNumber,
                                                         textInfo);

              // Apply Line Spacing based on scale of the last character of the
              // line.
              if (m_LineHeight == k_FloatUnset) {
                float ascender =
                    textInfo.textElementInfo[m_CharacterCount].ascender -
                    textInfo.textElementInfo[m_CharacterCount].baseLine;
                lineOffsetDelta = 0 - m_MaxLineDescender + ascender +
                                  (lineGap + generationSettings.lineSpacing +
                                   m_LineSpacingDelta) *
                                      baseScale;
                ...
                m_LineOffset +=
                    m_LineHeight + generationSettings.lineSpacing * baseScale;
            ...
            if (generationSettings.autoSize &&
              ...
              m_FontSize =
                  (int)(Mathf.Max(m_FontSize, generationSettings.fontSizeMin) *
                            20 +
                        0.5f) /
                  20f;
            ...
            case TextOverflowMode.Ellipsis:
              ...
              if (m_CachedEllipsisGlyphInfo != null) {
                textInfo.textElementInfo[ellipsisIndex].character =
                    (char) k_HorizontalEllipsis;
                textInfo.textElementInfo[ellipsisIndex].textElement =
                    m_CachedEllipsisGlyphInfo;
                textInfo.textElementInfo[ellipsisIndex].fontAsset =
                    m_MaterialReferences[0].fontAsset;
                textInfo.textElementInfo[ellipsisIndex].material =
                    m_MaterialReferences[0].material;
                textInfo.textElementInfo[ellipsisIndex].materialReferenceIndex =
                    0;
              } else {
                Debug.LogWarning(
                    "Unable to use Ellipsis character since it wasn't found in the current Font Asset [" +
                    generationSettings.fontAsset.name +
          ...
          // Special handling of characters that are not ignored at the end of a
          // line.
          if (charCode == k_Tab || charCode == k_NoBreakSpace ||
              charCode == k_FigureSpace) {
            textInfo.textElementInfo[m_CharacterCount].isVisible = false;
          ...
          if ((charCode == k_LineFeed || char.IsSeparator((char) charCode)) &&
              charCode != k_SoftHyphen && charCode != k_ZeroWidthSpace &&
        ...
        // Check if Line Spacing of previous line needs to be adjusted.
        if (m_LineNumber > 0 &&
            !TextGeneratorUtilities.Approximately(m_MaxLineAscender,
                                                  m_StartOfLineAscender) &&
            m_LineHeight == k_FloatUnset && !m_IsNewPage) {
          float offsetDelta = m_MaxLineAscender - m_StartOfLineAscender;
          TextGeneratorUtilities.AdjustLineOffset(
              m_FirstCharacterOfLine, m_CharacterCount, offsetDelta, textInfo);
        ...
        if (charCode != k_LineFeed && charCode != k_CarriageReturn &&
                charCode != k_HorizontalEllipsis ||
            textInfo.lineInfo[m_LineNumber].characterCount == 1)
        ...
        if (m_MaxAscender - elementDescenderIi > marginHeight + 0.0001f) {
          ...
          if (generationSettings.autoSize &&
              m_LineSpacingDelta > generationSettings.lineSpacingMax &&
              m_LineNumber > 0) {
            m_LoopCountA = 0;
          ...
          // Handle Text Auto-sizing resulting from text exceeding vertical
          // bounds.
          if (generationSettings.autoSize &&
              m_FontSize > generationSettings.fontSizeMin) {
            m_MaxFontSize = m_FontSize;
          ...
          case TextOverflowMode.Ellipsis:
            ...
            if (m_LineNumber > 0) {
              m_CharBuffer[textInfo.textElementInfo[ellipsisIndex].index] =
                  k_HorizontalEllipsis;
              m_CharBuffer[textInfo.textElementInfo[ellipsisIndex].index + 1] =
                  (char) 0;
        ...
        // Handle xAdvance & Tabulation Stops. Tab stops at every 25% of Font
        // Size.
        if (charCode == 9) {
          float tabSize = m_CurrentFontAsset.faceInfo.tabWidth *
                          m_CurrentFontAsset.tabMultiple * currentElementScale;
          float tabs = Mathf.Ceil(m_XAdvance / tabSize) * tabSize;
          m_XAdvance = tabs > m_XAdvance ? tabs : m_XAdvance + tabSize;
        } else if (m_MonoSpacing != 0) {
          m_XAdvance += (m_MonoSpacing - monoAdvance +
                         ((generationSettings.characterSpacing +
                           m_CurrentFontAsset.regularStyleSpacing) *
                          currentElementScale) +
                         m_CSpacing) *
          ...
          m_XAdvance += ((m_CachedTextElement.glyph.metrics.horizontalAdvance *
                              scaleFxMultiplier * boldXAdvanceMultiplier +
                          generationSettings.characterSpacing +
                          m_CurrentFontAsset.regularStyleSpacing +
                          glyphAdjustments.xAdvance) *
                             currentElementScale +
                         m_CSpacing) *
                        (1 - m_CharWidthAdjDelta);
        ...
        // Handle Line Spacing Adjustments + Word Wrapping & special case for
        // last line.
        if (charCode == k_LineFeed ||
          ...
          if (m_LineNumber > 0 &&
              !TextGeneratorUtilities.Approximately(m_MaxLineAscender,
                                                    m_StartOfLineAscender) &&
              m_LineHeight == k_FloatUnset && !m_IsNewPage) {
            // Debug.Log("Line Feed - Adjusting Line Spacing on line #" +
            // m_lineNumber);
            float offsetDelta = m_MaxLineAscender - m_StartOfLineAscender;
            TextGeneratorUtilities.AdjustLineOffset(m_FirstCharacterOfLine,
                                                    m_CharacterCount,
          ...
          // or subscript that we check that as well.
          float lineAscender = m_MaxLineAscender - m_LineOffset;
          float lineDescender = m_MaxLineDescender - m_LineOffset;

          // Update maxDescender and maxVisibleDescender
          m_MaxDescender =
              m_MaxDescender < lineDescender ? m_MaxDescender : lineDescender;
          if (!isMaxVisibleDescenderSet)
            maxVisibleDescender = m_MaxDescender;

          if (generationSettings.useMaxVisibleDescender &&
              (m_CharacterCount >= generationSettings.maxVisibleCharacters ||
               m_LineNumber >= generationSettings.maxVisibleLines))
            isMaxVisibleDescenderSet = true;
          ...
          textInfo.lineInfo[m_LineNumber].firstVisibleCharacterIndex =
              ...
              : m_FirstVisibleCharacterOfLine;
          textInfo.lineInfo[m_LineNumber].lastCharacterIndex =
              m_LastCharacterOfLine = m_CharacterCount;
          textInfo.lineInfo[m_LineNumber].lastVisibleCharacterIndex =
              m_LastVisibleCharacterOfLine =
                  m_LastVisibleCharacterOfLine <
                  m_FirstVisibleCharacterOfLine ? m_FirstVisibleCharacterOfLine
              : m_LastVisibleCharacterOfLine;
          ...
          textInfo.lineInfo[m_LineNumber].lineExtents.min = new Vector2(
              ...
              lineDescender);
          textInfo.lineInfo[m_LineNumber].lineExtents.max = new Vector2(
              textInfo.textElementInfo[m_LastVisibleCharacterOfLine].topRight.x,
              lineAscender);
          textInfo.lineInfo[m_LineNumber].length =
              textInfo.lineInfo[m_LineNumber].lineExtents.max.x -
              (padding * currentElementScale);
          textInfo.lineInfo[m_LineNumber].width = width;
          ...
          if (textInfo.textElementInfo[m_LastVisibleCharacterOfLine].isVisible)
            ...
            textInfo.lineInfo[m_LineNumber].maxAdvance =
                textInfo.textElementInfo[m_LastCharacterOfLine].xAdvance -
                (generationSettings.characterSpacing +
                 m_CurrentFontAsset.regularStyleSpacing) *
                    currentElementScale -
                m_CSpacing;
          ...
          if (charCode == k_LineFeed) {
            ...
            if (m_LineHeight == k_FloatUnset) {
              lineOffsetDelta =
                  0 - m_MaxLineDescender + elementAscender +
                  (lineGap + generationSettings.lineSpacing +
                   generationSettings.paragraphSpacing + m_LineSpacingDelta) *
                      baseScale;
              m_LineOffset += lineOffsetDelta;
            } else
              m_LineOffset +=
                  m_LineHeight + (generationSettings.lineSpacing +
                                  generationSettings.paragraphSpacing) *
                                     baseScale;
        ...
        if (textInfo.textElementInfo[m_CharacterCount].isVisible) {
          m_MeshExtents.min.x = Mathf.Min(
              m_MeshExtents.min.x,
              textInfo.textElementInfo[m_CharacterCount].bottomLeft.x);
          m_MeshExtents.min.y = Mathf.Min(
              m_MeshExtents.min.y,
              textInfo.textElementInfo[m_CharacterCount].bottomLeft.y);

          m_MeshExtents.max.x =
              Mathf.Max(m_MeshExtents.max.x,
                        textInfo.textElementInfo[m_CharacterCount].topRight.x);
          m_MeshExtents.max.y =
              Mathf.Max(m_MeshExtents.max.y,
                        textInfo.textElementInfo[m_CharacterCount].topRight.y);
        }

        // Save pageInfo Data
        if (generationSettings.overflowMode == TextOverflowMode.Page &&
            charCode != k_CarriageReturn &&
            charCode != k_LineFeed) // && m_pageNumber < 16)
        {
          ...
          textInfo.pageInfo[m_PageNumber].descender =
              elementDescender < textInfo.pageInfo[m_PageNumber]
                                     .descender ? elementDescender
              : textInfo.pageInfo[m_PageNumber]
                                     .descender;

          if (m_PageNumber == 0 && m_CharacterCount == 0)
            textInfo.pageInfo[m_PageNumber].firstCharacterIndex =
                m_CharacterCount;
          else if (m_CharacterCount > 0 &&
                   m_PageNumber !=
                       textInfo.textElementInfo[m_CharacterCount - 1]
                           .pageNumber) {
            textInfo.pageInfo[m_PageNumber - 1].lastCharacterIndex =
                m_CharacterCount - 1;
            textInfo.pageInfo[m_PageNumber].firstCharacterIndex =
                m_CharacterCount;
          } else if (m_CharacterCount == totalCharacterCount - 1)
            textInfo.pageInfo[m_PageNumber].lastCharacterIndex =
                m_CharacterCount;
        }
        ...
        if (generationSettings.wordWrap ||
            ...
            generationSettings.overflowMode == TextOverflowMode.Ellipsis) {
          if ((char.IsWhiteSpace((char) charCode) ||
               charCode == k_ZeroWidthSpace || charCode == k_HyphenMinus ||
               charCode == k_SoftHyphen) &&
              (!m_IsNonBreakingSpace || ignoreNonBreakingSpace) &&
              charCode != k_NoBreakSpace && charCode != k_FigureSpace &&
              charCode != k_NonBreakingHyphen &&
              charCode != k_NarrowNoBreakSpace && charCode != k_WordJoiner) {
            // We store the state of numerous variables for the most recent
            // Space, LineFeed or Carriage Return to enable them to be restored
            // for Word Wrapping.
            SaveWordWrappingState(ref m_SavedWordWrapState, i, m_CharacterCount,
                                  textInfo);
            m_IsCharacterWrappingEnabled = false;
          ...
          else if ((charCode > k_HangulJamoStart &&
                        charCode < k_HangulJamoEnd || /* Hangul Jamo */
                    charCode > k_CjkStart && charCode < k_CjkEnd || /* CJK */
                    charCode > k_HangulJameExtendedStart &&
                        charCode < k_HangulJameExtendedEnd || /* Hangul Jame
                                                                 Extended-A */
                    charCode > k_HangulSyllablesStart &&
                        charCode <
                            k_HangulSyllablesEnd || /* Hangul Syllables */
                    charCode > k_CjkIdeographsStart &&
                        charCode < k_CjkIdeographsEnd || /* CJK Compatibility
                                                            Ideographs */
                    charCode > k_CjkFormsStart &&
                        charCode <
                            k_CjkFormsEnd || /* CJK Compatibility Forms */
                    charCode > k_CjkHalfwidthStart &&
                        charCode < k_CjkHalfwidthEnd) /* CJK Half-Width */
                   && !m_IsNonBreakingSpace) {
            if (isFirstWord || isLastBreakingChar ||
                TextSettings.linebreakingRules.leadingCharacters.ContainsKey(
                    charCode) == false &&
                    (m_CharacterCount < totalCharacterCount - 1 &&
                     TextSettings.linebreakingRules.followingCharacters
                             .ContainsKey(
                                 textInfo.textElementInfo[m_CharacterCount + 1]
                                     .character) == false)) {
              SaveWordWrappingState(ref m_SavedWordWrapState, i,
                                    m_CharacterCount, textInfo);
              m_IsCharacterWrappingEnabled = false;
              isFirstWord = false;
            }
          } else if (isFirstWord || m_IsCharacterWrappingEnabled ||
                     isLastBreakingChar)
            SaveWordWrappingState(ref m_SavedWordWrapState, i, m_CharacterCount,
                                  textInfo);
        }
      ...
      if (!m_IsCharacterWrappingEnabled && generationSettings.autoSize &&
          fontSizeDelta > 0.051f &&
          m_FontSize < generationSettings.fontSizeMax) {
        m_MinFontSize = m_FontSize;
        m_FontSize += Mathf.Max((m_MaxFontSize - m_FontSize) / 2, 0.05f);
        m_FontSize =
            (int)(Mathf.Min(m_FontSize, generationSettings.fontSizeMax) * 20 +
                  0.5f) /
            20f;
      ...
      // Partial clear of the vertices array to mark unused vertices as
      // degenerate.
      textInfo
          .meshInfo [0]
          .Clear(false);
      ...
      case TextAlignment.TopGeoAligned:
        if (generationSettings.overflowMode != TextOverflowMode.Page)
          ...
          anchorOffset =
              ...
              new Vector3(
                  0 + margins.x,
                  0 - textInfo.pageInfo[pageToDisplay].ascender - margins.y, 0);
        break;
      ...
      case TextAlignment.MiddleGeoAligned:
        if (generationSettings.overflowMode != TextOverflowMode.Page)
          anchorOffset = (corners[0] + corners[1]) / 2 +
                         new Vector3(0 + margins.x,
                                     0 - (m_MaxAscender + margins.y +
                                          maxVisibleDescender - margins.w) /
                                             2,
                                     0);
        else
          anchorOffset =
              ...
              new Vector3(
                  0 + margins.x,
                  0 - (textInfo.pageInfo[pageToDisplay].ascender + margins.y +
                       textInfo.pageInfo[pageToDisplay].descender - margins.w) /
                          2,
                  0);
        break;
      ...
      case TextAlignment.BottomGeoAligned:
        if (generationSettings.overflowMode != TextOverflowMode.Page)
          anchorOffset =
              corners[0] + new Vector3(0 + margins.x,
                                       0 - maxVisibleDescender + margins.w, 0);
        else
          anchorOffset =
              corners[0] +
              new Vector3(0 + margins.x,
                          0 - textInfo.pageInfo[pageToDisplay].descender +
                              margins.w,
                          0);
        break;
      ...
      case TextAlignment.BaselineGeoAligned:
        anchorOffset =
            (corners[0] + corners[1]) / 2 + new Vector3(0 + margins.x, 0, 0);
        break;
      ...
      case TextAlignment.MidlineGeoAligned:
        anchorOffset = (corners[0] + corners[1]) / 2 +
                       new Vector3(0 + margins.x,
                                   0 - (m_MeshExtents.max.y + margins.y +
                                        m_MeshExtents.min.y - margins.w) /
                                           2,
                                   0);
        break;
      ...
      case TextAlignment.CaplineGeoAligned:
        anchorOffset =
            (corners[0] + corners[1]) / 2 +
            new Vector3(0 + margins.x,
                        0 - (m_MaxCapHeight - margins.y - margins.w) / 2, 0);
        break;
      }
      ...
      // Second Pass : Line Justification, UV Mapping, Character & Line
      // Visibility & more.
      ...
      for (int i = 0; i < m_CharacterCount; i++) {
        ...
        case TextAlignment.CaplineCenter:
          justificationOffset =
              new Vector3(lineInfo.marginLeft + lineInfo.width / 2 -
                              lineInfo.maxAdvance / 2,
                          0, 0);
          break;
        ...
        case TextAlignment.MidlineGeoAligned:
        case TextAlignment.CaplineGeoAligned:
          justificationOffset = new Vector3(
              lineInfo.marginLeft + lineInfo.width / 2 -
                  (lineInfo.lineExtents.min.x + lineInfo.lineExtents.max.x) / 2,
              0, 0);
          break;
        ...
        case TextAlignment.CaplineRight:
          if (!generationSettings.isRightToLeft)
            justificationOffset = new Vector3(
                lineInfo.marginLeft + lineInfo.width - lineInfo.maxAdvance, 0,
                0);
          else
            justificationOffset =
        ...
        case TextAlignment.CaplineFlush:
          ...
          if (currentCharacter == k_SoftHyphen ||
              currentCharacter == k_ZeroWidthSpace ||
              currentCharacter == k_WordJoiner)
            break;

          char lastCharOfCurrentLine =
              textElementInfos[lineInfo.lastCharacterIndex].character;
          bool isFlush =
          ...
          if (char.IsControl(lastCharOfCurrentLine) == false &&
                  currentLine < m_LineNumber ||
              isFlush || lineInfo.maxAdvance > lineInfo.width) {
            // First character of each line.
            if (currentLine != lastLine || i == 0 ||
                i == generationSettings.firstVisibleCharacter) {
              if (!generationSettings.isRightToLeft)
              ...
              float gap = !generationSettings.isRightToLeft ? lineInfo.width -
                          lineInfo.maxAdvance : lineInfo.width +
                          lineInfo.maxAdvance;

              int visibleCount = lineInfo.visibleCharacterCount - 1 +
                                 lineInfo.controlCharacterCount;

              // Get the number of spaces for each line ignoring the last
              // character if it is not visible (ie. a space or linefeed).
              int spaces = (textElementInfos[lineInfo.lastCharacterIndex]
                                .isVisible ? lineInfo.spaceCount
              ...
              float ratio =
                  spaces > 0 ? generationSettings.wordWrappingRatio : 1;

              if (spaces < 1)
                spaces = 1;

              if (currentCharacter != 0xA0 &&
                  (currentCharacter == 9 ||
            ...
            if (!generationSettings.isRightToLeft)
              justificationOffset = new Vector3(
                  lineInfo.marginLeft, 0, 0); // Keep last line left justified.
            else
              justificationOffset =
                  new Vector3(lineInfo.marginLeft + lineInfo.width, 0,
                              0); // Keep last line right justified.
          }
          break;
        }
        ...
        if (isCharacterVisible) {
          ...
          case TextElementType.Character:
            ...
            float uvOffset =
                (generationSettings.uvLineOffset * currentLine) % 1;
            ...
            case TextureMapping.Line:
              if (generationSettings.textAlignment !=
                  TextAlignment.MiddleJustified) {
                textElementInfos[i].vertexBottomLeft.uv2.x =
                    (textElementInfos[i].vertexBottomLeft.position.x -
                     lineExtents.min.x) /
                        (lineExtents.max.x - lineExtents.min.x) +
                    uvOffset;
                textElementInfos[i].vertexTopLeft.uv2.x =
                    (textElementInfos[i].vertexTopLeft.position.x -
                     lineExtents.min.x) /
                        (lineExtents.max.x - lineExtents.min.x) +
                    uvOffset;
                textElementInfos[i].vertexTopRight.uv2.x =
                    (textElementInfos[i].vertexTopRight.position.x -
                     lineExtents.min.x) /
                        (lineExtents.max.x - lineExtents.min.x) +
                    uvOffset;
                textElementInfos[i].vertexBottomRight.uv2.x =
                    (textElementInfos[i].vertexBottomRight.position.x -
                     lineExtents.min.x) /
                        (lineExtents.max.x - lineExtents.min.x) +
                    uvOffset;
                break;
              } else // Special Case if Justified is used in Line Mode.
              {
                textElementInfos[i].vertexBottomLeft.uv2.x =
                    (textElementInfos[i].vertexBottomLeft.position.x +
                     justificationOffset.x - m_MeshExtents.min.x) /
                        (m_MeshExtents.max.x - m_MeshExtents.min.x) +
                    uvOffset;
                textElementInfos[i].vertexTopLeft.uv2.x =
                    (textElementInfos[i].vertexTopLeft.position.x +
                     justificationOffset.x - m_MeshExtents.min.x) /
            ...
            case TextureMapping.MatchAspect:
              ...
              case TextureMapping.Line:
                textElementInfos[i].vertexBottomLeft.uv2.y =
                    (textElementInfos[i].vertexBottomLeft.position.y -
                     lineExtents.min.y) /
                        (lineExtents.max.y - lineExtents.min.y) +
                    uvOffset;
                textElementInfos[i].vertexTopLeft.uv2.y =
                    (textElementInfos[i].vertexTopLeft.position.y -
                     lineExtents.min.y) /
                        (lineExtents.max.y - lineExtents.min.y) +
                    uvOffset;
                textElementInfos[i].vertexTopRight.uv2.y =
                    textElementInfos[i].vertexBottomLeft.uv2.y;
                textElementInfos[i].vertexBottomRight.uv2.y =
                    textElementInfos[i].vertexTopLeft.uv2.y;
                break;
              ...
              float xDelta = (1 - ((textElementInfos[i].vertexBottomLeft.uv2.y +
                                    textElementInfos[i].vertexTopLeft.uv2.y) *
                                   textElementInfos[i].aspectRatio)) /
                             2; // Center of Rectangle
            ...
            case TextureMapping.Line:
              textElementInfos[i].vertexBottomLeft.uv2.y =
                  (textElementInfos[i].vertexBottomLeft.position.y -
                   lineInfo.descender) /
                  (lineInfo.ascender - lineInfo.descender);
              textElementInfos[i].vertexTopLeft.uv2.y =
                  (textElementInfos[i].vertexTopLeft.position.y -
                   lineInfo.descender) /
                  (lineInfo.ascender - lineInfo.descender); // + m_uvOffset.y;
              textElementInfos[i].vertexTopRight.uv2.y =
                  textElementInfos[i].vertexTopLeft.uv2.y;
              textElementInfos[i].vertexBottomRight.uv2.y =
                  textElementInfos[i].vertexBottomLeft.uv2.y;
            ...
            case TextureMapping.MatchAspect:
              float yDelta = (1 - ((textElementInfos[i].vertexBottomLeft.uv2.x +
                                    textElementInfos[i].vertexTopRight.uv2.x) /
                                   textElementInfos[i].aspectRatio)) /
                             2; // Center of Rectangle

              textElementInfos[i].vertexBottomLeft.uv2.y =
                  yDelta + (textElementInfos[i].vertexBottomLeft.uv2.x /
                            textElementInfos[i].aspectRatio);
              textElementInfos[i].vertexTopLeft.uv2.y =
                  yDelta + (textElementInfos[i].vertexTopRight.uv2.x /
                            textElementInfos[i].aspectRatio);
              textElementInfos[i].vertexBottomRight.uv2.y =
                  textElementInfos[i].vertexBottomLeft.uv2.y;
              textElementInfos[i].vertexTopRight.uv2.y =
            ...
            // Pack UV's so that we can pass Xscale needed for Shader to
            // maintain 1:1 ratio.

            xScale = textElementInfos[i].scale * (1 - m_CharWidthAdjDelta) *
                     1; // generationSettings.scale;
            if (!textElementInfos[i].isUsingAlternateTypeface &&
                (textElementInfos[i].style & FontStyles.Bold) ==
                    FontStyles.Bold)
              xScale *= -1;

            // Optimization to avoid having a vector2 returned from the Pack UV
            // function.
          ...
          // Handle maxVisibleCharacters, maxVisibleLines and Overflow Page
          // Mode.

          if (i < generationSettings.maxVisibleCharacters &&
              wordCount < generationSettings.maxVisibleWords &&
              currentLine < generationSettings.maxVisibleLines &&
              generationSettings.overflowMode != TextOverflowMode.Page) {
          ...
          } else if (i < generationSettings.maxVisibleCharacters &&
                     wordCount < generationSettings.maxVisibleWords &&
                     currentLine < generationSettings.maxVisibleLines &&
                     generationSettings.overflowMode == TextOverflowMode.Page &&
                     textElementInfos[i].pageNumber == pageToDisplay) {
            textElementInfos[i].vertexBottomLeft.position += offset;
            textElementInfos[i].vertexTopLeft.position += offset;
            textElementInfos[i].vertexTopRight.position += offset;
            textElementInfos[i].vertexBottomRight.position += offset;
          ...
          if (elementType == TextElementType.Character) {
            TextGeneratorUtilities.FillCharacterVertexBuffers(
                i, generationSettings, textInfo);
          } else if (elementType == TextElementType.Sprite) {
            TextGeneratorUtilities.FillSpriteVertexBuffers(
                i, generationSettings, textInfo);
          }
        }
        ...
        // Need to recompute lineExtent to account for the offset from
        // justification.
        ...
        if (currentLine != lastLine || i == m_CharacterCount - 1) {
          ...
          if (currentLine != lastLine) {
            ...
            textInfo.lineInfo[lastLine].lineExtents.min =
                new Vector2(textInfo
                                .textElementInfo[textInfo.lineInfo[lastLine]
                                                     .firstCharacterIndex]
                                .bottomLeft.x,
                            textInfo.lineInfo[lastLine].descender);
            textInfo.lineInfo[lastLine].lineExtents.max =
                new Vector2(textInfo
                                .textElementInfo[textInfo.lineInfo[lastLine]
                                                     .lastVisibleCharacterIndex]
                                .topRight.x,
                            textInfo.lineInfo[lastLine].ascender);
          }
          ...
          if (i == m_CharacterCount - 1) {
            ...
            textInfo.lineInfo[currentLine].lineExtents.min =
                new Vector2(textInfo
                                .textElementInfo[textInfo.lineInfo[currentLine]
                                                     .firstCharacterIndex]
                                .bottomLeft.x,
                            textInfo.lineInfo[currentLine].descender);
            textInfo.lineInfo[currentLine].lineExtents.max =
                new Vector2(textInfo
                                .textElementInfo[textInfo.lineInfo[currentLine]
                                                     .lastVisibleCharacterIndex]
                                .topRight.x,
                            textInfo.lineInfo[currentLine].ascender);
          }
        }
        ...
        if (char.IsLetterOrDigit(currentCharacter) ||
            currentCharacter == k_HyphenMinus ||
            currentCharacter == k_SoftHyphen || currentCharacter == k_Hyphen ||
            currentCharacter == k_NonBreakingHyphen) {
          ...
          if (isStartOfWord && i == m_CharacterCount - 1) {
            ...
            textInfo.wordInfo[index].characterCount =
                wordLastChar - wordFirstChar + 1;
            ...
            textInfo.lineInfo[currentLine].wordCount += 1;
                   ...
                   i == 0 && (!char.IsPunctuation(currentCharacter) ||
                              char.IsWhiteSpace(currentCharacter) ||
                              currentCharacter == k_ZeroWidthSpace ||
                              i == m_CharacterCount - 1)) {
          if (!(i > 0 && i < textElementInfos.Length - 1 &&
                i < m_CharacterCount &&
                (currentCharacter == k_SingleQuote ||
                 currentCharacter == k_RightSingleQuote) &&
                char.IsLetterOrDigit(textElementInfos[i - 1].character) &&
                char.IsLetterOrDigit(textElementInfos[i + 1].character))) {
            wordLastChar = i == m_CharacterCount - 1 &&
                                   char.IsLetterOrDigit(currentCharacter)
                               ? i
                               : i - 1;
            isStartOfWord = false;
        ...
        // NOTE: Need to figure out how underline will be handled with multiple
        // fonts and which font will be used for the underline.
        bool isUnderline = (textInfo.textElementInfo[i].style &
        ...
        if (isUnderline) {
          ...
          if (i > generationSettings.maxVisibleCharacters ||
              currentLine > generationSettings.maxVisibleLines ||
              (generationSettings.overflowMode == TextOverflowMode.Page &&
               currentPage + 1 != generationSettings.pageToDisplay))
          ...
          if (!char.IsWhiteSpace(currentCharacter) &&
              currentCharacter != k_ZeroWidthSpace) {
            underlineMaxScale =
                Mathf.Max(underlineMaxScale, textInfo.textElementInfo[i].scale);
            underlineBaseLine = Mathf.Min(
                currentPage == lastPage ? underlineBaseLine
                : TextGeneratorUtilities.largePositiveFloat,
                  textInfo.textElementInfo[i].baseLine +
                      generationSettings.fontAsset.faceInfo.underlineOffset *
                          underlineMaxScale);
            lastPage = currentPage; // Need to track pages to ensure we reset
                                    // baseline for the new pages.
          }

          if (!beginUnderline && isUnderlineVisible &&
              i <= lineInfo.lastVisibleCharacterIndex &&
              currentCharacter != k_LineFeed &&
              currentCharacter != k_CarriageReturn) {
            if (!(i == lineInfo.lastVisibleCharacterIndex &&
                  char.IsSeparator(currentCharacter))) {
              beginUnderline = true;
              ...
              underlineStart =
                  new Vector3(textInfo.textElementInfo[i].bottomLeft.x,
                              underlineBaseLine, 0);
          ...
          if (beginUnderline && m_CharacterCount == 1) {
            ...
            underlineEnd = new Vector3(textInfo.textElementInfo[i].topRight.x,
                                       underlineBaseLine, 0);
            underlineEndScale = textInfo.textElementInfo[i].scale;

            DrawUnderlineMesh(underlineStart, underlineEnd, ref lastVertIndex,
                              underlineStartScale, underlineEndScale,
                              underlineMaxScale, xScale, underlineColor,
                              generationSettings, textInfo);
            underlineMaxScale = 0;
            underlineBaseLine = TextGeneratorUtilities.largePositiveFloat;
          } else if (beginUnderline &&
                     (i == lineInfo.lastCharacterIndex ||
                      i >= lineInfo.lastVisibleCharacterIndex)) {
            // Terminate underline at previous visible character if space or
            // carriage return.
            if (char.IsWhiteSpace(currentCharacter) ||
                currentCharacter == 0x200B) {
              int lastVisibleCharacterIndex =
                  lineInfo.lastVisibleCharacterIndex;
              underlineEnd = new Vector3(
                  textInfo.textElementInfo[lastVisibleCharacterIndex]
                      .topRight.x,
                  underlineBaseLine, 0);
              underlineEndScale =
                  textInfo.textElementInfo[lastVisibleCharacterIndex].scale;
            } else {
            ...
            beginUnderline = false;
            underlineEnd =
                new Vector3(textInfo.textElementInfo[i - 1].topRight.x,
                            underlineBaseLine, 0);
            ...
            underlineMaxScale = 0;
            underlineBaseLine = TextGeneratorUtilities.largePositiveFloat;
          } else if (beginUnderline && i < m_CharacterCount - 1 &&
                     !ColorUtilities.CompareColors(
                         underlineColor,
                         textInfo.textElementInfo[i + 1].underlineColor)) {
        ...
        bool isStrikethrough =
            (textInfo.textElementInfo[i].style & FontStyles.Strikethrough) ==
            FontStyles.Strikethrough;
        float strikethroughOffset =
            currentFontAsset.faceInfo.strikethroughOffset;

        if (isStrikethrough) {
          bool isStrikeThroughVisible =
              !(i > generationSettings.maxVisibleCharacters ||
                currentLine > generationSettings.maxVisibleLines ||
                (generationSettings.overflowMode == TextOverflowMode.Page &&
                 textInfo.textElementInfo[i].pageNumber + 1 !=
                     generationSettings.pageToDisplay));

          if (beginStrikethrough == false && isStrikeThroughVisible &&
              i <= lineInfo.lastVisibleCharacterIndex &&
              currentCharacter != k_LineFeed &&
              currentCharacter != k_CarriageReturn) {
            if (!(i == lineInfo.lastVisibleCharacterIndex &&
              ...
              strikethroughStart =
                  new Vector3(textInfo.textElementInfo[i].bottomLeft.x,
                              textInfo.textElementInfo[i].baseLine +
                                  strikethroughOffset * strikethroughScale,
                              0);
              strikethroughColor =
                  textInfo.textElementInfo[i].strikethroughColor;
          ...
          if (beginStrikethrough && m_CharacterCount == 1) {
            ...
            strikethroughEnd =
                new Vector3(textInfo.textElementInfo[i].topRight.x,
                            textInfo.textElementInfo[i].baseLine +
                                strikethroughOffset * strikethroughScale,
                            0);

            DrawUnderlineMesh(strikethroughStart, strikethroughEnd,
                              ref lastVertIndex, strikethroughScale,
                              strikethroughScale, strikethroughScale, xScale,
                              strikethroughColor, generationSettings, textInfo);
          } else if (beginStrikethrough && i == lineInfo.lastCharacterIndex) {
            // Terminate Strikethrough at previous visible character if space or
            // carriage return.
            if (char.IsWhiteSpace(currentCharacter) ||
                currentCharacter == k_ZeroWidthSpace) {
              int lastVisibleCharacterIndex =
                  lineInfo.lastVisibleCharacterIndex;
              strikethroughEnd = new Vector3(
                  textInfo.textElementInfo[lastVisibleCharacterIndex]
                      .topRight.x,
                  textInfo.textElementInfo[lastVisibleCharacterIndex].baseLine +
                      strikethroughOffset * strikethroughScale,
                  0);
            } else {
            ...
            DrawUnderlineMesh(strikethroughStart, strikethroughEnd,
                              ...
                              strikethroughScale, strikethroughScale, xScale,
                              strikethroughColor, generationSettings, textInfo);
          } else if (beginStrikethrough && i < m_CharacterCount &&
                     (textInfo.textElementInfo[i + 1].pointSize !=
                          strikethroughPointSize ||
                      !TextGeneratorUtilities.Approximately(
                          textInfo.textElementInfo[i + 1].baseLine + offset.y,
            ...
            DrawUnderlineMesh(strikethroughStart, strikethroughEnd,
                     ...
                     currentFontAsset.GetInstanceID() !=
                         textElementInfos[i + 1].fontAsset.GetInstanceID()) {
            ...
            strikethroughEnd =
                new Vector3(textInfo.textElementInfo[i - 1].topRight.x,
                            textInfo.textElementInfo[i - 1].baseLine +
                                strikethroughOffset * strikethroughScale,
                            0);
        ...
        bool isHighlight = (textInfo.textElementInfo[i].style &
                            FontStyles.Highlight) == FontStyles.Highlight;
        if (isHighlight) {
          ...
          if (!beginHighlight && isHighlightVisible &&
              i <= lineInfo.lastVisibleCharacterIndex &&
              currentCharacter != k_LineFeed &&
              currentCharacter != k_CarriageReturn) {
            if (!(i == lineInfo.lastVisibleCharacterIndex &&
          ...
          if (beginHighlight) {
            Color32 currentHighlightColor =
                textInfo.textElementInfo[i].highlightColor;
            bool isColorTransition = false;

            // Handle Highlight color changes
            if (!ColorUtilities.CompareColors(highlightColor,
                                              currentHighlightColor)) {
              // End drawing at the start of new highlight color to prevent a
              // gap between highlight sections.
              highlightEnd.x =
                  (highlightEnd.x + textInfo.textElementInfo[i].bottomLeft.x) /
                  2;

              highlightStart.y = Mathf.Min(
                  highlightStart.y, textInfo.textElementInfo[i].descender);
              highlightEnd.y = Mathf.Max(highlightEnd.y,
                                         textInfo.textElementInfo[i].ascender);

              DrawTextHighlight(highlightStart, highlightEnd, ref lastVertIndex,
                                highlightColor, generationSettings, textInfo);
              ...
              highlightEnd =
                  new Vector3(textInfo.textElementInfo[i].topRight.x,
                              textInfo.textElementInfo[i].descender, 0);
              highlightColor = textInfo.textElementInfo[i].highlightColor;
            ...
            if (!isColorTransition) {
              // Use the Min / Max Extents of the Highlight area to handle
              // different character sizes and fonts.
              highlightStart.x = Mathf.Min(
                  highlightStart.x, textInfo.textElementInfo[i].bottomLeft.x);
              highlightStart.y = Mathf.Min(
                  highlightStart.y, textInfo.textElementInfo[i].descender);

              highlightEnd.x = Mathf.Max(
                  highlightEnd.x, textInfo.textElementInfo[i].topRight.x);
              highlightEnd.y = Mathf.Max(highlightEnd.y,
                                         textInfo.textElementInfo[i].ascender);
            }
          }
      ...
      textInfo.wordCount =
          wordCount != 0 && m_CharacterCount > 0 ? wordCount : 1;
      ...
      if (generationSettings.geometrySortingOrder != VertexSortingOrder.Normal)
        textInfo
            .meshInfo [0]
            .SortGeometry(VertexSortingOrder.Reverse);
      ...
      for (int i = 1; i < textInfo.materialCount; i++) {
        ...
        if (generationSettings.geometrySortingOrder !=
    ...
    /// <returns></returns>
    bool ValidateRichTextTag(string sourceText, ref int readIndex,
                             ref int writeIndex,
      ...
      for (; readIndex < srcLength &&
             sourceText[readIndex] !=
                 0 /* && tagCharCount < s_RichTextTag.Length */;
           readIndex++) {
        ...
        if (readingFlag == 0) {
          ...
          if ((c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z') || c == '/' ||
              c == '-') {
            m_Attributes[attributeIndex].nameHashCode =
                ((m_Attributes[attributeIndex].nameHashCode << 5) +
                 m_Attributes[attributeIndex].nameHashCode) ^
                (int) TextUtilities.ToUpperASCIIFast(c);
            continue;
          }
        ...
        // Determine value type for tag and attribute with special handling for
        // values contained in quotes
        if (readingFlag == 1) {
        ...
        if (readingFlag == 2) {
          ...
          // Also done reading the value if we run into a space when quotes are
          // not being used.
          ...
          m_Attributes[attributeIndex].valueHashCode =
              ((m_Attributes[attributeIndex].valueHashCode << 5) +
               m_Attributes[attributeIndex].valueHashCode) ^
              (int) TextUtilities.ToUpperASCIIFast(c);
      ...
      if (isTagPotentiallyValid == false) {
        // Reset read and write positions to what they were when function was
        // first called.
      ...
      // Debug.Log("Hashcode: " + m_Attributes[0].nameHashCode + "  Start Index:
      // " + srcReadIndex + "  End Index: " + readIndex + "  Length: " +
      // (writeIndex - srcWriteIndex));
    ...
    /// <summary>
    /// Function to identify and validate the rich tag. Returns the position of
    /// the > if the tag was valid.
    /// </summary>
    ...
    /// <param name="textInfo"></param>
    /// <returns></returns>
    protected bool ValidateHtmlTag(int[] chars, int startIndex,
                                   out int endIndex,
                                   TextGenerationSettings generationSettings,
                                   TextInfo textInfo) {
      int tagCharCount = 0;
      ...
      for (int i = startIndex;
           ...
           tagCharCount < m_RichTextTag.Length && chars[i] != '<';
           i++) {
        ...
        if (attributeFlag == 1) {
          if (tagType == TagValueType.None) {
            ...
            if (unicode == '+' || unicode == '-' || unicode == '.' ||
              ...
              m_XmlAttribute[attributeIndex].valueType =
              ...
              m_XmlAttribute[attributeIndex].valueType =
                  TagValueType.StringValue;
              m_XmlAttribute[attributeIndex].valueStartIndex = tagCharCount - 1;
              m_XmlAttribute[attributeIndex].valueHashCode =
                  (m_XmlAttribute[attributeIndex].valueHashCode << 5) +
                      m_XmlAttribute[attributeIndex].valueHashCode ^
                  (int) TextUtilities.ToUpperASCIIFast(unicode);
              m_XmlAttribute[attributeIndex].valueLength += 1;
            }
          } else {
            if (tagType == TagValueType.NumericalValue) {
              // Check for termination of numerical value.
              if (unicode == 'p' || unicode == 'e' || unicode == '%' ||
                  unicode == ' ') {
                attributeFlag = 2;
        ...
        if (attributeFlag == 0)
          m_XmlAttribute[attributeIndex].nameHashCode =
              (m_XmlAttribute[attributeIndex].nameHashCode << 5) +
                  m_XmlAttribute[attributeIndex].nameHashCode ^
              (int) TextUtilities.ToUpperASCIIFast(unicode);
      ...
      // Debug.Log("Tag is [" + m_htmlTag.ArrayToString() + "].  Tag HashCode: "
      // + m_xmlAttribute[0].nameHashCode + "  Tag Value HashCode: " +
      // m_xmlAttribute[0].valueHashCode + "  Attribute 1 HashCode: " +
      // m_xmlAttribute[1].nameHashCode + " Value HashCode: " +
      // m_xmlAttribute[1].valueHashCode); for (int i = 0; i < attributeIndex;
      // i++)
      //    Debug.Log("Tag [" + i + "] with HashCode: " +
      //    m_XmlAttribute[i].nameHashCode + " has value of [" + new
      //    string(m_RichTextTag, m_XmlAttribute[i].valueStartIndex,
      //    m_XmlAttribute[i].valueLength) + "] Numerical Value: " +
      //    TextGeneratorUtilities.ConvertToFloat(m_RichTextTag,
      //    m_XmlAttribute[i].valueStartIndex, m_XmlAttribute[i].valueLength));

      // Special handling of the no parsing tag </noparse> </NOPARSE> tag
      if (m_TagNoParsing && ((TagHashCode) m_XmlAttribute[0].nameHashCode !=
                             TagHashCode.SLASH_NO_PARSE)) {
        return false;
      }
      if ((TagHashCode) m_XmlAttribute[0].nameHashCode ==
          TagHashCode.SLASH_NO_PARSE) {
        m_TagNoParsing = false;
        return true;
      }
      ...
      if (m_RichTextTag[0] == '#' && tagCharCount == 4) {
        m_HtmlColor =
            TextGeneratorUtilities.HexCharsToColor(m_RichTextTag, tagCharCount);
      ...
      // Color <#FF00FF>
      if (m_RichTextTag[0] == '#' &&
          tagCharCount == 7) // if Tag begins with # and contains 7 characters.
      {
        m_HtmlColor =
            TextGeneratorUtilities.HexCharsToColor(m_RichTextTag, tagCharCount);
        m_ColorStack.Add(m_HtmlColor);
      ...
      if (m_RichTextTag[0] == '#' &&
          tagCharCount == 9) // if Tag begins with # and contains 9 characters.
      {
        m_HtmlColor =
            TextGeneratorUtilities.HexCharsToColor(m_RichTextTag, tagCharCount);
        m_ColorStack.Add(m_HtmlColor);
        ...
        case TagHashCode.SLASH_BOLD: // </b>
          if ((generationSettings.fontStyle & FontStyles.Bold) !=
              FontStyles.Bold) {
        ...
        case TagHashCode.SLASH_ITALIC: // </i>
          if ((generationSettings.fontStyle & FontStyles.Italic) !=
              FontStyles.Italic) {
        ...
        case TagHashCode.STRIKETHROUGH: // <s>
          ...
          if (m_XmlAttribute[1].nameHashCode == (uint) TagHashCode.COLOR) {
            m_StrikethroughColor = TextGeneratorUtilities.HexCharsToColor(
                m_RichTextTag, m_XmlAttribute[1].valueStartIndex,
                m_XmlAttribute[1].valueLength);
            m_StrikethroughColor.a =
                m_HtmlColor.a <
                m_StrikethroughColor.a ? m_HtmlColor.a : m_StrikethroughColor.a;
          } else
            m_StrikethroughColor = m_HtmlColor;
        ...
        case TagHashCode.SLASH_STRIKETHROUGH: // </s>
          if ((generationSettings.fontStyle & FontStyles.Strikethrough) !=
              FontStyles.Strikethrough) {
        ...
        case TagHashCode.UNDERLINE: // <u>
          ...
          if (m_XmlAttribute[1].nameHashCode == (uint) TagHashCode.COLOR) {
            m_UnderlineColor = TextGeneratorUtilities.HexCharsToColor(
                m_RichTextTag, m_XmlAttribute[1].valueStartIndex,
                m_XmlAttribute[1].valueLength);
            m_UnderlineColor.a =
                m_HtmlColor.a <
                m_UnderlineColor.a ? m_HtmlColor.a : m_UnderlineColor.a;
          } else
            m_UnderlineColor = m_HtmlColor;
        ...
        case TagHashCode.SLASH_UNDERLINE: // </u>
          if ((generationSettings.fontStyle & FontStyles.Underline) !=
        ...
        case TagHashCode.MARK: // <mark=#FF00FF80>
          ...
          m_HighlightColor = TextGeneratorUtilities.HexCharsToColor(
              m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
              m_XmlAttribute[0].valueLength);
          m_HighlightColor.a =
              m_HtmlColor.a <
              m_HighlightColor.a ? m_HtmlColor.a : m_HighlightColor.a;
          m_HighlightColorStack.Add(m_HighlightColor);
          return true;

        case TagHashCode.SLASH_MARK: // </mark>
          if ((generationSettings.fontStyle & FontStyles.Highlight) !=
        ...
        case TagHashCode.SUBSCRIPT: // <sub>
          m_FontScaleMultiplier *=
              m_CurrentFontAsset.faceInfo.subscriptSize > 0
                  ? m_CurrentFontAsset.faceInfo.subscriptSize
                  : 1;
          m_BaselineOffsetStack.Push(m_BaselineOffset);
          m_BaselineOffset += m_CurrentFontAsset.faceInfo.subscriptOffset *
                              m_FontScale * m_FontScaleMultiplier;
        ...
        case TagHashCode.SUPERSCRIPT: // <sup>
          m_FontScaleMultiplier *=
              m_CurrentFontAsset.faceInfo.superscriptSize > 0
                  ? m_CurrentFontAsset.faceInfo.superscriptSize
                  : 1;
          m_BaselineOffsetStack.Push(m_BaselineOffset);
          m_BaselineOffset += m_CurrentFontAsset.faceInfo.superscriptOffset *
                              m_FontScale * m_FontScaleMultiplier;
        ...
        case TagHashCode.SLASH_SUPERSCRIPT: // </sup>
          if ((m_FontStyleInternal & FontStyles.Superscript) ==
              FontStyles.Superscript) {
            if (m_FontScaleMultiplier < 1) {
              m_BaselineOffset = m_BaselineOffsetStack.Pop();
              m_FontScaleMultiplier /=
        ...
        case TagHashCode.FONT_WEIGHT: // <font-weight>
          value = TextGeneratorUtilities.ConvertToFloat(
              m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
              m_XmlAttribute[0].valueLength);
        ...
        case TagHashCode.POSITION: // <pos=000.00px> <pos=0em> <pos=50%>
          ...
          case TagUnitType.FontUnits:
            m_XAdvance = value * m_FontScale *
                         generationSettings.fontAsset.faceInfo.tabWidth /
                         generationSettings.fontAsset.tabMultiple;
            return true;
        ...
        case TagHashCode.VERTICAL_OFFSET: // <voffset>
          ...
          case TagUnitType.Pixels:
            ...
            return true;
          case TagUnitType.FontUnits:
            m_BaselineOffset = value * m_FontScale *
                               generationSettings.fontAsset.faceInfo.ascentLine;
            return true;
          case TagUnitType.Percentage:
            return false;
          }
        ...
        case TagHashCode.PAGE: // <page>
          ...
          // <BR> tag is now handled inline where it is replaced by a linefeed
          // or \n.
        ...
        case TagHashCode.FONT: // <font=xx>
          ...
          if (!MaterialReferenceManager.TryGetFontAsset(fontHashCode,
                                                        out tempFont)) {
            // Load Font Asset
            tempFont = Resources.Load<FontAsset>(
                TextSettings.defaultFontAssetPath +
                new string(m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
                           m_XmlAttribute[0].valueLength));

            if (tempFont == null)
              return false;

            // Add new reference to the font asset as well as default material
            // to the MaterialReferenceManager
          ...
          if (materialAttributeHashCode == 0 && materialHashCode == 0) {
            ...
            m_CurrentMaterialIndex = MaterialReference.AddMaterialReference(
                m_CurrentMaterial, tempFont, m_MaterialReferences,
                m_MaterialReferenceIndexLookup);

            m_MaterialReferenceStack.Add(
                m_MaterialReferences[m_CurrentMaterialIndex]);
          } else if (materialAttributeHashCode ==
                     (uint) TagHashCode.MATERIAL) // using material attribute
          {
            if (MaterialReferenceManager.TryGetMaterial(materialHashCode,
                                                        out tempMaterial)) {
              ...
              // Load new material
              tempMaterial = Resources.Load<Material>(
                  TextSettings.defaultFontAssetPath +
                  new string(m_RichTextTag, m_XmlAttribute[1].valueStartIndex,
                             m_XmlAttribute[1].valueLength));

              if (tempMaterial == null)
                return false;

              // Add new reference to this material in the
              // MaterialReferenceManager
              MaterialReferenceManager.AddFontMaterial(materialHashCode,
                                                       tempMaterial);
        ...
        case TagHashCode.SLASH_FONT: // </font>
        {
          MaterialReference materialReference =
              m_MaterialReferenceStack.Remove();
        ...
        case TagHashCode.MATERIAL: // <material="material name">
          ...
          if (MaterialReferenceManager.TryGetMaterial(materialHashCode,
            ...
            m_CurrentMaterialIndex = MaterialReference.AddMaterialReference(
                m_CurrentMaterial, m_CurrentFontAsset, m_MaterialReferences,
                m_MaterialReferenceIndexLookup);
        ...
        case TagHashCode.ALPHA: // <alpha=#FF>
          ...
          m_HtmlColor.a =
              (byte)(TextGeneratorUtilities.HexToInt(m_RichTextTag[7]) * 16 +
                     TextGeneratorUtilities.HexToInt(m_RichTextTag[8]));
          return true;
        ...
        case TagHashCode.LINK: // <link="name">
          if (m_IsParsingText && !m_IsCalculatingPreferredValues) {
            ...
            textInfo.linkInfo[index].linkTextfirstCharacterIndex =
                m_CharacterCount;

            textInfo.linkInfo[index].linkIdFirstCharacterIndex =
                startIndex + m_XmlAttribute[0].valueStartIndex;
            textInfo.linkInfo[index].linkIdLength =
                m_XmlAttribute[0].valueLength;
            textInfo
                .linkInfo [index]
                .SetLinkId(m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
                           m_XmlAttribute[0].valueLength);
          }
          return true;
        ...
        case TagHashCode.SLASH_LINK: // </link>
          if (m_IsParsingText && !m_IsCalculatingPreferredValues) {
            if (textInfo.linkCount < textInfo.linkInfo.Length) {
              textInfo.linkInfo[textInfo.linkCount].linkTextLength =
                  m_CharacterCount - textInfo.linkInfo[textInfo.linkCount]
        ...
        case TagHashCode.COLOR: // <color> <color=#FF00FF> or <color=#FF00FF00>
          ...
          if (m_RichTextTag[6] == '#' && tagCharCount == 10) {
            m_HtmlColor = TextGeneratorUtilities.HexCharsToColor(m_RichTextTag,
                                                                 tagCharCount);
            m_ColorStack.Add(m_HtmlColor);
            return true;
          }
        ...
        case TagHashCode.GRADIENT: //<gradient>
          ...
          if (MaterialReferenceManager.TryGetColorGradientPreset(
                  gradientPresetHashCode, out tempColorGradientPreset)) {
            m_ColorGradientPreset = tempColorGradientPreset;
          } else {
            // Load Color Gradient Preset
            if (tempColorGradientPreset == null) {
              tempColorGradientPreset = Resources.Load<TextGradientPreset>(
                  TextSettings.defaultColorGradientPresetsPath +
                  new string(m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
                             m_XmlAttribute[0].valueLength));
            }
            ...
            MaterialReferenceManager.AddColorGradientPreset(
                gradientPresetHashCode, tempColorGradientPreset);
            m_ColorGradientPreset = tempColorGradientPreset;
          }
        ...
        case TagHashCode.SLASH_CHARACTER_SPACE: // </cspace>
          ...
          if (m_CharacterCount > 0) {
            ...
            textInfo.textElementInfo[m_CharacterCount - 1].xAdvance =
                m_XAdvance;
          }
          m_CSpacing = 0;
          return true;
        ...
        case TagHashCode.SPRITE: // <sprite=x>
          ...
          // CHECK TAG FORMAT
          if (m_XmlAttribute[0].valueType == TagValueType.None ||
              m_XmlAttribute[0].valueType == TagValueType.NumericalValue) {
            ...
            if (generationSettings.spriteAsset != null) {
              ...
              if (TextSettings.defaultSpriteAsset != null)
                ...
                m_DefaultSpriteAsset = Resources.Load<TextSpriteAsset>(
            ...
            if (MaterialReferenceManager.TryGetSpriteAsset(
                    spriteAssetHashCode, out tempSpriteAsset)) {
              m_CurrentSpriteAsset = tempSpriteAsset;
            } else {
              // Load Sprite Asset
              if (tempSpriteAsset == null) {
                tempSpriteAsset = Resources.Load<TextSpriteAsset>(
              ...
              MaterialReferenceManager.AddSpriteAsset(spriteAssetHashCode,
                                                      tempSpriteAsset);
              m_CurrentSpriteAsset = tempSpriteAsset;
            }
          }
          ...
          if (m_XmlAttribute[0].valueType ==
              TagValueType.NumericalValue) // <sprite=index>
          {
            int index = (int) TextGeneratorUtilities.ConvertToFloat(
                m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
                m_XmlAttribute[0].valueLength);
          ...
          for (int i = 0;
               i < m_XmlAttribute.Length && m_XmlAttribute[i].nameHashCode != 0;
               i++) {
            ...
            case TagHashCode.NAME: // <sprite name="">
              m_CurrentSpriteAsset = TextSpriteAsset.SearchForSpriteByHashCode(
                  m_CurrentSpriteAsset, m_XmlAttribute[i].valueHashCode, true,
                  out index);
              if (index == -1)
                return false;
            ...
            case TagHashCode.INDEX: // <sprite index=>
              index = (int) TextGeneratorUtilities.ConvertToFloat(
                  m_RichTextTag, m_XmlAttribute[1].valueStartIndex,
                  m_XmlAttribute[1].valueLength);
              if (index == k_FloatUnset)
                return false;
            ...
            case TagHashCode.TINT: // tint
              m_TintSprite =
                  TextGeneratorUtilities.ConvertToFloat(
                      m_RichTextTag, m_XmlAttribute[i].valueStartIndex,
                      m_XmlAttribute[i].valueLength) != 0;
              break;
            case TagHashCode.COLOR: // color=#FF00FF80
              m_SpriteColor = TextGeneratorUtilities.HexCharsToColor(
                  m_RichTextTag, m_XmlAttribute[i].valueStartIndex,
                  m_XmlAttribute[i].valueLength);
              break;
            case TagHashCode.ANIM: // anim="0,16,12"  start, end, fps
              Debug.LogWarning(
                  "Sprite animations are not currently supported in TextCore");
              break;
          ...
          // Material HashCode for the Sprite Asset is the Sprite Asset Hash
          // Code
          m_CurrentMaterialIndex = MaterialReference.AddMaterialReference(
              m_CurrentSpriteAsset.material, m_CurrentSpriteAsset,
              m_MaterialReferences, m_MaterialReferenceIndexLookup);
        ...
        case TagHashCode.SLASH_LOWERCASE: // </lowercase>
          if ((generationSettings.fontStyle & FontStyles.LowerCase) !=
              FontStyles.LowerCase) {
        ...
        case TagHashCode.SLASH_UPPERCASE: // </uppercase>
          if ((generationSettings.fontStyle & FontStyles.UpperCase) !=
              FontStyles.UpperCase) {
        ...
        case TagHashCode.SLASH_SMALLCAPS: // </smallcaps>
          if ((generationSettings.fontStyle & FontStyles.SmallCaps) !=
              FontStyles.SmallCaps) {
        ...
        case TagHashCode.MARGIN: // <margin=00.0> <margin=00em> <margin=50%>
          // TODO: Revise margin tag to make left and right variants be
          // attribute based.
          value = TextGeneratorUtilities.ConvertToFloat(
              m_RichTextTag, m_XmlAttribute[0].valueStartIndex,
              m_XmlAttribute[0].valueLength); // px
          if (value == k_FloatUnset)
            return false;
          ...
          case TagUnitType.Pixels:
            ...
            break;
          case TagUnitType.FontUnits:
            m_MarginLeft *= m_FontScale *
                            generationSettings.fontAsset.faceInfo.tabWidth /
                            generationSettings.fontAsset.tabMultiple;
            break;
          case TagUnitType.Percentage:
            m_MarginLeft = (m_MarginWidth - (m_Width != -1 ? m_Width : 0)) *
                           m_MarginLeft / 100;
            break;
          }
        ...
        case TagHashCode.MARGIN_RIGHT: // <margin-right=xx.x>
          ...
          case TagUnitType.Pixels:
            ...
            break;
          case TagUnitType.FontUnits:
            m_MarginRight *= m_FontScale *
                             generationSettings.fontAsset.faceInfo.tabWidth /
                             generationSettings.fontAsset.tabMultiple;
            break;
          case TagUnitType.Percentage:
            m_MarginRight = (m_MarginWidth - (m_Width != -1 ? m_Width : 0)) *
                            m_MarginRight / 100;
            break;
          }
        ...
        case TagHashCode.LINE_HEIGHT: // <line-height=xx.x>
          ...
          case TagUnitType.FontUnits:
            m_LineHeight *=
                generationSettings.fontAsset.faceInfo.lineHeight * m_FontScale;
            break;
          case TagUnitType.Percentage:
            m_LineHeight = generationSettings.fontAsset.faceInfo.lineHeight *
                           m_LineHeight / 100 * m_FontScale;
            break;
          }
          return true;
        ...
        case TagHashCode.SCALE: // <scale=xx.x>
          ...
          m_FxMatrix = Matrix4x4.TRS(Vector3.zero, Quaternion.identity,
        ...
        case TagHashCode.ROTATE: // <rotate=xx.x>
          ...
          m_FxMatrix = Matrix4x4.TRS(
              Vector3.zero, Quaternion.Euler(0, 0, value), Vector3.one);
          m_IsFxMatrixSet = true;
    ...
    /// <param name="generationSettings"></param>
    /// <param name="textInfo"></param>
    void SaveGlyphVertexInfo(float padding, float stylePadding,
                             Color32 vertexColor,
                             TextGenerationSettings generationSettings,
                             TextInfo textInfo) {
      // Save the Vertex Position for the Character
      textInfo.textElementInfo[m_CharacterCount].vertexBottomLeft.position =
          textInfo.textElementInfo[m_CharacterCount].bottomLeft;
      textInfo.textElementInfo[m_CharacterCount].vertexTopLeft.position =
          textInfo.textElementInfo[m_CharacterCount].topLeft;
      textInfo.textElementInfo[m_CharacterCount].vertexTopRight.position =
          textInfo.textElementInfo[m_CharacterCount].topRight;
      textInfo.textElementInfo[m_CharacterCount].vertexBottomRight.position =
          textInfo.textElementInfo[m_CharacterCount].bottomRight;

      // Alpha is the lower of the vertex color or tag color alpha used.
      vertexColor.a =
          m_FontColor32.a < vertexColor.a ? m_FontColor32.a : vertexColor.a;

      // Handle Vertex Colors & Vertex Color Gradient
      if (generationSettings.fontColorGradient == null) {
        textInfo.textElementInfo[m_CharacterCount].vertexBottomLeft.color =
            vertexColor;
        textInfo.textElementInfo[m_CharacterCount].vertexTopLeft.color =
            vertexColor;
        textInfo.textElementInfo[m_CharacterCount].vertexTopRight.color =
            vertexColor;
        textInfo.textElementInfo[m_CharacterCount].vertexBottomRight.color =
            vertexColor;
      } else {
        if (!generationSettings.overrideRichTextColors &&
            m_ColorStack.m_Index > 1) {
          textInfo.textElementInfo[m_CharacterCount].vertexBottomLeft.color =
              vertexColor;
          textInfo.textElementInfo[m_CharacterCount].vertexTopLeft.color =
              vertexColor;
        ...
        {
          textInfo.textElementInfo[m_CharacterCount].vertexBottomLeft.color =
              generationSettings.fontColorGradient.bottomLeft * vertexColor;
          textInfo.textElementInfo[m_CharacterCount].vertexTopLeft.color =
              generationSettings.fontColorGradient.topLeft * vertexColor;
          textInfo.textElementInfo[m_CharacterCount].vertexTopRight.color =
              generationSettings.fontColorGradient.topRight * vertexColor;
          textInfo.textElementInfo[m_CharacterCount].vertexBottomRight.color =
              generationSettings.fontColorGradient.bottomRight * vertexColor;
        }
      }

      if (m_ColorGradientPreset != null) {
        textInfo.textElementInfo[m_CharacterCount].vertexBottomLeft.color *=
            m_ColorGradientPreset.bottomLeft;
        textInfo.textElementInfo[m_CharacterCount].vertexTopLeft.color *=
            m_ColorGradientPreset.topLeft;
        textInfo.textElementInfo[m_CharacterCount].vertexTopRight.color *=
            m_ColorGradientPreset.topRight;
        textInfo.textElementInfo[m_CharacterCount].vertexBottomRight.color *=
            m_ColorGradientPreset.bottomRight;
      }
      ...
      Vector2 uv0;
      uv0.x = (m_CachedTextElement.glyph.glyphRect.x - padding - stylePadding) /
              m_CurrentFontAsset.atlasWidth;
      uv0.y = (m_CachedTextElement.glyph.glyphRect.y - padding - stylePadding) /
              m_CurrentFontAsset.atlasHeight;

      Vector2 uv1;
      uv1.x = uv0.x;
      uv1.y = (m_CachedTextElement.glyph.glyphRect.y + padding + stylePadding +
               m_CachedTextElement.glyph.glyphRect.height) /
              m_CurrentFontAsset.atlasHeight;

      Vector2 uv2;
      uv2.x = (m_CachedTextElement.glyph.glyphRect.x + padding + stylePadding +
               m_CachedTextElement.glyph.glyphRect.width) /
              m_CurrentFontAsset.atlasWidth;
      uv2.y = uv1.y;
    ...
    void SaveSpriteVertexInfo(Color32 vertexColor,
      ...
      Color32 spriteColor = m_TintSprite ? ColorUtilities.MultiplyColors(
          m_SpriteColor, vertexColor)
          : m_SpriteColor;
      spriteColor.a =
          spriteColor.a < m_FontColor32.a ? spriteColor.a =
              spriteColor.a < vertexColor.a ? spriteColor.a
          : vertexColor.a : m_FontColor32.a;
      ...
      if (generationSettings.fontColorGradient != null) {
        c0 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c0, generationSettings.fontColorGradient.bottomLeft)
            : c0;
        c1 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c1, generationSettings.fontColorGradient.topLeft)
            : c1;
        c2 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c2, generationSettings.fontColorGradient.topRight)
            : c2;
        c3 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c3, generationSettings.fontColorGradient.bottomRight)
            : c3;
      }

      if (m_ColorGradientPreset != null) {
        c0 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c0, m_ColorGradientPreset.bottomLeft)
            : c0;
        c1 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c1, m_ColorGradientPreset.topLeft)
            : c1;
        c2 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c2, m_ColorGradientPreset.topRight)
            : c2;
        c3 = m_TintSprite ? ColorUtilities.MultiplyColors(
            c3, m_ColorGradientPreset.bottomRight)
            : c3;
      }
      ...
      Vector2 uv0 = new Vector2(
          (float) m_CachedTextElement.glyph.glyphRect.x /
              m_CurrentSpriteAsset.spriteSheet.width,
          (float) m_CachedTextElement.glyph.glyphRect.y /
              m_CurrentSpriteAsset.spriteSheet.height); // bottom left
      Vector2 uv1 = new Vector2(
          uv0.x, (float)(m_CachedTextElement.glyph.glyphRect.y +
                         m_CachedTextElement.glyph.glyphRect.height) /
                     m_CurrentSpriteAsset.spriteSheet.height); // top left
      Vector2 uv2 =
          new Vector2((float)(m_CachedTextElement.glyph.glyphRect.x +
                              m_CachedTextElement.glyph.glyphRect.width) /
                          m_CurrentSpriteAsset.spriteSheet.width,
                      uv1.y);                  // top right
    ...
    void DrawUnderlineMesh(Vector3 start, Vector3 end, ref int index,
                           float startScale, float endScale, float maxScale,
      ...
      // Check to make sure our current mesh buffer allocations can hold these
      // new Quads.
      if (verticesCount > textInfo.meshInfo[0].vertices.Length) {
        // Resize Mesh Buffers
        textInfo
            .meshInfo [0]
            .ResizeMeshInfo(verticesCount / 4);
      }

      // Adjust the position of the underline based on the lowest character.
      // This matters for subscript character.
      start.y = Mathf.Min(start.y, end.y);
      end.y = Mathf.Min(start.y, end.y);

      float segmentWidth =
          m_CachedUnderlineGlyphInfo.glyph.metrics.width / 2 * maxScale;

      if (end.x - start.x <
          m_CachedUnderlineGlyphInfo.glyph.metrics.width * maxScale) {
      ...
      float underlineThickness =
          m_CachedUnderlineGlyphInfo.glyph.metrics.height;
      ...
      vertices[index + 0] =
          start + new Vector3(0,
                              0 - (underlineThickness + m_Padding) * maxScale,
                              0); // BL
      vertices[index + 1] =
          start + new Vector3(0, m_Padding * maxScale, 0); // TL
      vertices[index + 2] =
          vertices[index + 1] + new Vector3(segmentWidth, 0, 0); // TR
      vertices[index + 3] =
          vertices[index + 0] + new Vector3(segmentWidth, 0, 0); // BR

      // Middle Part of the Underline
      vertices[index + 4] = vertices[index + 3]; // BL
      vertices[index + 5] = vertices[index + 2]; // TL
      vertices[index + 6] =
          end + new Vector3(-segmentWidth, m_Padding * maxScale, 0); // TR
      vertices[index + 7] =
          end + new Vector3(-segmentWidth,
                            -(underlineThickness + m_Padding) * maxScale,
                            0); // BR
      ...
      vertices[index + 10] =
          end + new Vector3(0, m_Padding * maxScale, 0); // TR
      vertices[index + 11] =
          end +
          new Vector3(0, -(underlineThickness + m_Padding) * maxScale, 0); // BR

      // Handle potential axis inversion.
      if (generationSettings.inverseYAxis) {
        Vector3 axisOffset;
        axisOffset.x = 0;
        axisOffset.y = generationSettings.screenRect.y +
      ...
      Vector2 uv0 = new Vector2(
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.x - startPadding) /
              generationSettings.fontAsset.atlasWidth,
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.y - m_Padding) /
              generationSettings.fontAsset.atlasHeight); // bottom left
      Vector2 uv1 = new Vector2(
          uv0.x,
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.y +
           m_CachedUnderlineGlyphInfo.glyph.glyphRect.height + m_Padding) /
              generationSettings.fontAsset.atlasHeight); // top left
      Vector2 uv2 = new Vector2(
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.x - startPadding +
           (float) m_CachedUnderlineGlyphInfo.glyph.glyphRect.width / 2) /
              generationSettings.fontAsset.atlasWidth,
          uv1.y);                              // Mid Top Left
      Vector2 uv3 = new Vector2(uv2.x, uv0.y); // Mid Bottom Left
      Vector2 uv4 = new Vector2(
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.x + endPadding +
           (float) m_CachedUnderlineGlyphInfo.glyph.glyphRect.width / 2) /
              generationSettings.fontAsset.atlasWidth,
          uv1.y);                              // Mid Top Right
      Vector2 uv5 = new Vector2(uv4.x, uv0.y); // Mid Bottom right
      Vector2 uv6 = new Vector2(
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.x + endPadding +
           m_CachedUnderlineGlyphInfo.glyph.glyphRect.width) /
              generationSettings.fontAsset.atlasWidth,
          uv1.y);                              // End Part - Bottom Right
      ...
      // Calculate the xScale or how much the UV's are getting stretched on the
      // X axis for the middle section of the underline.
      ...
      // Alpha is the lower of the vertex color or tag color alpha used.
      underlineColor.a = m_FontColor32.a <
                         underlineColor.a ? m_FontColor32.a : underlineColor.a;
    ...
    void DrawTextHighlight(Vector3 start, Vector3 end, ref int index,
      ...
      // Calculate UV required to setup the 3 Quads for the Underline.
      Vector2 uv0 = new Vector2(
          ((float) m_CachedUnderlineGlyphInfo.glyph.glyphRect.x +
           m_CachedUnderlineGlyphInfo.glyph.glyphRect.width / 2) /
              generationSettings.fontAsset.atlasWidth,
          (m_CachedUnderlineGlyphInfo.glyph.glyphRect.y +
           (float) m_CachedUnderlineGlyphInfo.glyph.glyphRect.height / 2) /
              generationSettings.fontAsset.atlasHeight); // bottom left
      ...
      // Alpha is the lower of the vertex color or tag color alpha used.
      highlightColor.a = m_FontColor32.a <
                         highlightColor.a ? m_FontColor32.a : highlightColor.a;
    ...
    void EnableMasking() { m_IsMaskingEnabled = true; }

    // Enable Masking in the Shader
    void DisableMasking() { m_IsMaskingEnabled = false; }

    // This function parses through the Char[] to determine how many characters
    // will be visible. It then makes sure the arrays are large enough for all
    // those characters.
    // TODO: Generation settings should be a Struct.
    void SetArraySizes(int[] chars, TextGenerationSettings generationSettings,
                       TextInfo textInfo) {
      int spriteCount = 0;
      ...
      MaterialReference.AddMaterialReference(
          m_CurrentMaterial, m_CurrentFontAsset, m_MaterialReferences,
          m_MaterialReferenceIndexLookup);
      ...
      for (int i = 0; i < chars.Length && chars[i] != 0; i++) {
        ...
        if (textInfo.textElementInfo == null ||
            m_TotalCharacterCount >= textInfo.textElementInfo.Length)
          TextInfo.Resize(ref textInfo.textElementInfo,
                          m_TotalCharacterCount + 1, true);

        int unicode = chars[i];

        // PARSE XML TAGS
        if (generationSettings.richText &&
            unicode == k_LesserThan) // if Char '<'
        {
          int prevMatIndex = m_CurrentMaterialIndex;

          // Check if Tag is Valid
          int tagEnd;
          if (ValidateHtmlTag(chars, i + 1, out tagEnd, generationSettings,
                              textInfo)) {
            i = tagEnd;
            ...
            if (m_TextElementType == TextElementType.Sprite) {
              ...
              textInfo.textElementInfo[m_TotalCharacterCount].character =
                  (char)(k_SpritesStart + m_SpriteIndex);
              textInfo.textElementInfo[m_TotalCharacterCount].spriteIndex =
                  m_SpriteIndex;
              textInfo.textElementInfo[m_TotalCharacterCount].fontAsset =
                  m_CurrentFontAsset;
              textInfo.textElementInfo[m_TotalCharacterCount].spriteAsset =
                  m_CurrentSpriteAsset;
              textInfo.textElementInfo[m_TotalCharacterCount]
                  .materialReferenceIndex = m_CurrentMaterialIndex;
              textInfo.textElementInfo[m_TotalCharacterCount].elementType =
                  m_TextElementType;
        ...
        character = FontUtilities.GetCharacterFromFontAsset(
            (uint) unicode, m_CurrentFontAsset, false, m_FontStyleInternal,
            m_FontWeightInternal, out isUsingAlternativeTypeface,
            out tempFontAsset);

        // Search for the glyph in the list of fallback assigned to the primary
        // font asset.
        if (character == null) {
          if (m_CurrentFontAsset.fallbackFontAssetTable != null &&
              m_CurrentFontAsset.fallbackFontAssetTable.Count > 0)
            character = FontUtilities.GetCharacterFromFontAssets(
                (uint) unicode, m_CurrentFontAsset.fallbackFontAssetTable, true,
                m_FontStyleInternal, m_FontWeightInternal,
                out isUsingAlternativeTypeface, out tempFontAsset);
        }
        ...
        if (character == null) {
          ...
          if (spriteAsset != null) {
            ...
            spriteAsset = TextSpriteAsset.SearchForSpriteByUnicode(
                spriteAsset, (uint) unicode, true, out spriteIndex);
            ...
            if (spriteIndex != -1) {
              ...
              m_CurrentMaterialIndex = MaterialReference.AddMaterialReference(
                  spriteAsset.material, spriteAsset, m_MaterialReferences,
                  m_MaterialReferenceIndexLookup);
              m_MaterialReferences[m_CurrentMaterialIndex].referenceCount += 1;
        ...
        // Search for the glyph in the list of fallback assigned in the TMP
        // Settings (General Fallbacks).
        if (character == null) {
          if (TextSettings.fallbackFontAssets != null &&
              TextSettings.fallbackFontAssets.Count > 0)
            character = FontUtilities.GetCharacterFromFontAssets(
                (uint) unicode, TextSettings.fallbackFontAssets, true,
                m_FontStyleInternal, m_FontWeightInternal,
                out isUsingAlternativeTypeface, out tempFontAsset);
        }

        // Search for the glyph in the Default Font Asset assigned in the TMP
        // Settings file.
        if (character == null) {
          if (TextSettings.defaultFontAsset != null)
            character = FontUtilities.GetCharacterFromFontAsset(
                (uint) unicode, TextSettings.defaultFontAsset, true,
                m_FontStyleInternal, m_FontWeightInternal,
                out isUsingAlternativeTypeface, out tempFontAsset);
        }
        ...
        if (character == null) {
          ...
          // Try replacing the missing glyph character by TMP Settings Missing
          // Glyph or Square (9633) character.
          unicode = chars[i] = TextSettings.missingGlyphCharacter == 0
                                   ? 9633
                                   : TextSettings.missingGlyphCharacter;

          // Check for the missing glyph character in the currently assigned
          // font asset and its fallbacks
          character = FontUtilities.GetCharacterFromFontAsset(
              (uint) unicode, m_CurrentFontAsset, true, m_FontStyleInternal,
              m_FontWeightInternal, out isUsingAlternativeTypeface,
              out tempFontAsset);

          if (character == null) {
            // Search for the missing glyph character in the TMP Settings
            // Fallback list.
            if (TextSettings.fallbackFontAssets != null &&
                TextSettings.fallbackFontAssets.Count > 0)
              character = FontUtilities.GetCharacterFromFontAssets(
          ...
          if (character == null) {
            // Search for the missing glyph in the TMP Settings Default Font
            // Asset.
            if (TextSettings.defaultFontAsset != null)
              character = FontUtilities.GetCharacterFromFontAsset(
                  (uint) unicode, TextSettings.defaultFontAsset, true,
        ...
        // Determine if the font asset is still the current font asset or a
        // fallback.
        if (tempFontAsset != null) {
          if (tempFontAsset.GetInstanceID() !=
              m_CurrentFontAsset.GetInstanceID()) {
        ...
        textInfo.textElementInfo[m_TotalCharacterCount]
            .isUsingAlternateTypeface = isUsingAlternativeTypeface;
        textInfo.textElementInfo[m_TotalCharacterCount].character =
            (char) unicode;
        textInfo.textElementInfo[m_TotalCharacterCount].fontAsset =
            m_CurrentFontAsset;
        ...
        if (isUsingFallbackOrAlternativeTypeface) {
          // Create Fallback material instance matching current material preset
          // if necessary
          if (TextSettings.matchMaterialPreset)
            m_CurrentMaterial = MaterialManager.GetFallbackMaterial(
        ...
        if (!char.IsWhiteSpace((char) unicode) && unicode != k_ZeroWidthSpace) {
          // Limit the mesh of the main text object to 65535 vertices and use
          // sub objects for the overflow.
          if (m_MaterialReferences[m_CurrentMaterialIndex].referenceCount <
              k_VerticesMax)
            m_MaterialReferences[m_CurrentMaterialIndex].referenceCount += 1;
          else {
            m_CurrentMaterialIndex = MaterialReference.AddMaterialReference(
                new Material(m_CurrentMaterial), m_CurrentFontAsset,
                m_MaterialReferences, m_MaterialReferenceIndexLookup);
            m_MaterialReferences[m_CurrentMaterialIndex].referenceCount += 1;
          }
        }

        textInfo.textElementInfo[m_TotalCharacterCount].material =
            m_CurrentMaterial;
        textInfo.textElementInfo[m_TotalCharacterCount].materialReferenceIndex =
            m_CurrentMaterialIndex;
        m_MaterialReferences[m_CurrentMaterialIndex].isFallbackMaterial =
            isUsingFallbackOrAlternativeTypeface;

        // Restore previous font asset and material if fallback font was used.
        if (isUsingFallbackOrAlternativeTypeface) {
          m_MaterialReferences[m_CurrentMaterialIndex].fallbackMaterial =
              prevMaterial;
      ...
      int materialCount = textInfo.materialCount =
          m_MaterialReferenceIndexLookup.Count;

      // Check if we need to resize the MeshInfo array for handling different
      // materials.
      ...
      if (textInfo.textElementInfo.Length - m_TotalCharacterCount > 256)
        TextInfo.Resize(ref textInfo.textElementInfo,
                        Mathf.Max(m_TotalCharacterCount + 1, 256), true);

      // Iterate through the material references to set the mesh buffer
      // allocations
      for (int i = 0; i < materialCount; i++) {
        int referenceCount = m_MaterialReferences[i].referenceCount;

        // Check to make sure buffer allocations can accommodate the required
        // text elements.
        if (textInfo.meshInfo[i].vertices == null ||
            textInfo.meshInfo[i].vertices.Length < referenceCount * 4) {
          if (textInfo.meshInfo[i].vertices == null) {
            textInfo.meshInfo[i] = new MeshInfo(referenceCount + 1);
          } else
            textInfo
                .meshInfo [i]
                .ResizeMeshInfo(referenceCount > 1024
                                    ? referenceCount + 256
                                    : Mathf.NextPowerOfTwo(referenceCount));
        } else if (textInfo.meshInfo[i].vertices.Length - referenceCount * 4 >
                   1024) {
          ...
          textInfo
              ...
              .ResizeMeshInfo(
                  referenceCount > 1024
                      ? referenceCount + 256
                      : Mathf.Max(Mathf.NextPowerOfTwo(referenceCount), 256));
        }
    ...
    void GetSpecialCharacters(FontAsset fontAsset) {
      ...
      fontAsset.characterLookupTable.TryGetValue(
          k_Underline, out m_CachedUnderlineGlyphInfo);

      // Check & Assign Underline Character for use with the Underline tag.
      fontAsset.characterLookupTable.TryGetValue(k_HorizontalEllipsis,
                                                 out m_CachedEllipsisGlyphInfo);
    }
    ...
    float GetPaddingForMaterial(Material material, bool extraPadding) {
      ...
      m_Padding =
          ShaderUtilities.GetPadding(material, extraPadding, m_IsUsingBold);
    ...
    /// </summary>
    /// <returns></returns>
    float GetPreferredWidthInternal(TextGenerationSettings generationSettings,
                                    TextInfo textInfo) {
      if (TextSettings.instance == null)
        return 0;

      float fontSize =
          generationSettings.autoSize ? generationSettings.fontSizeMax
          : m_FontSize;
      ...
      float preferredWidth =
          CalculatePreferredValues(fontSize, margin, true, generationSettings,
                                   textInfo)
              .x;
    ...
    /// </summary>
    /// <returns></returns>
    float GetPreferredHeightInternal(TextGenerationSettings generationSettings,
                                     TextInfo textInfo) {
      if (TextSettings.instance == null)
        return 0;
      ...
      Vector2 margin = new Vector2(
          m_MarginWidth != 0 ? m_MarginWidth
                             : TextGeneratorUtilities.largePositiveFloat,
          TextGeneratorUtilities.largePositiveFloat);

      m_RecursiveCount = 0;
      float preferredHeight =
          CalculatePreferredValues(fontSize, margin,
                                   !generationSettings.autoSize,
                                   generationSettings, textInfo)
              .y;
    ...
    Vector2
    GetPreferredValuesInternal(TextGenerationSettings generationSettings,
                               TextInfo textInfo) {
      if (TextSettings.instance == null)
        return Vector2.zero;
      ...
      m_RecursiveCount = 0;
      return CalculatePreferredValues(fontSize, margin,
                                      !generationSettings.autoSize,
                                      generationSettings, textInfo);
    }
    ...
    /// </summary>
    /// <returns></returns>
    protected virtual Vector2 CalculatePreferredValues(
        float defaultFontSize, Vector2 marginSize, bool ignoreTextAutoSizing,
        TextGenerationSettings generationSettings, TextInfo textInfo) {
      Profiler.BeginSample("TextGenerator.CalculatePreferredValues");
      // Early exit if no font asset was assigned. This should not be needed
      // since LiberationSans SDF will be assigned by default.
      if (generationSettings.fontAsset == null ||
          generationSettings.fontAsset.characterLookupTable == null) {
        return Vector2.zero;
      }
      ...
      m_CurrentMaterial = generationSettings.material;
      m_CurrentMaterialIndex = 0;
      m_MaterialReferenceStack.SetDefault(new MaterialReference(
          0, m_CurrentFontAsset, null, m_CurrentMaterial, m_Padding));

      // Total character count is computed when the text is parsed.
      int totalCharacterCount = m_TotalCharacterCount;

      if (m_InternalTextElementInfo == null ||
          totalCharacterCount > m_InternalTextElementInfo.Length) {
        m_InternalTextElementInfo =
            new TextElementInfo[totalCharacterCount > 1024
      ...
      // assigned to the text object.
      float baseScale = m_FontScale =
          (defaultFontSize / generationSettings.fontAsset.faceInfo.pointSize *
           generationSettings.fontAsset.faceInfo.scale);
      float currentElementScale = baseScale;
      m_FontScaleMultiplier = 1;
      ...
      int charCode; // Holds the character code of the currently being processed
                    // character.
      ...
      float boldXAdvanceMultiplier; // Used to increase spacing between
                                    // character when style is bold.
      ...
      for (int i = 0; m_CharBuffer[i] != 0; i++) {
        ...
        m_CurrentMaterialIndex =
            textInfo.textElementInfo[m_CharacterCount].materialReferenceIndex;
        m_CurrentFontAsset =
            m_MaterialReferences[m_CurrentMaterialIndex].fontAsset;
        ...
        if (m_TextElementType == TextElementType.Sprite) {
          ...
          // The sprite scale calculations are based on the font asset assigned
          // to the text object. Sprite scale is used to determine line height
          // Current element scale represents a modified scale to normalize the
          // sprite based on the font baseline to ascender.
          float spriteScale = (m_CurrentFontSize /
                               generationSettings.fontAsset.faceInfo.pointSize *
                               generationSettings.fontAsset.faceInfo.scale);
          currentElementScale =
              generationSettings.fontAsset.faceInfo.ascentLine /
              sprite.glyph.metrics.height * sprite.scale * spriteScale;

          m_CachedTextElement = sprite;

          m_InternalTextElementInfo[m_CharacterCount].elementType =
              TextElementType.Sprite;
        ...
        m_InternalTextElementInfo[m_CharacterCount].baseLine =
            0 - m_LineOffset + m_BaselineOffset;
        ...
        float elementAscender =
            m_CurrentFontAsset.faceInfo.ascentLine *
                (m_TextElementType ==
                     TextElementType.Character ? currentElementScale /
                         smallCapsMultiplier
                 : m_InternalTextElementInfo[m_CharacterCount].scale) +
            m_BaselineOffset;
        m_InternalTextElementInfo[m_CharacterCount].ascender =
            elementAscender - m_LineOffset;
        m_MaxLineAscender = elementAscender > m_MaxLineAscender ? elementAscender
            : m_MaxLineAscender;
        ...
        // CARRIAGE RETURN.
        if (charCode == 9 ||
            (!char.IsWhiteSpace((char) charCode) && charCode != 0x200B) ||
            m_TextElementType == TextElementType.Sprite) {
          // Check if Character exceeds the width of the Text Container
          float width =
              m_Width != -1
          ...
          linebreakingWidth =
              m_XAdvance + m_CachedTextElement.glyph.metrics.horizontalAdvance *
                               (1 - m_CharWidthAdjDelta) *
                               (charCode != k_SoftHyphen ? currentElementScale
                                : oldScale);
          ...
          if (linebreakingWidth > width * (isJustifiedOrFlush ? 1.05f : 1.0f)) {
            ...
            if (generationSettings.wordWrap &&
                m_CharacterCount != m_FirstCharacterOfLine) {
              // Check if word wrapping is still possible
              if (wrappingIndex == savedWordWrapState.previousWordBreak ||
                  isFirstWord) {
                // Word wrapping is no longer possible. Shrink size of text if
                // auto-sizing is enabled.
                if (ignoreTextAutoSizing == false &&
                    m_CurrentFontSize > generationSettings.fontSizeMin) {
                  // Handle Character Width Adjustments
                  if (m_CharWidthAdjDelta <
                      generationSettings.charWidthMaxAdj / 100) {
                    m_RecursiveCount = 0;
                    m_CharWidthAdjDelta += 0.01f;
                    return CalculatePreferredValues(defaultFontSize, marginSize,
                                                    false, generationSettings,
                                                    textInfo);
                  }
                  ...
                  defaultFontSize -=
                      Mathf.Max((defaultFontSize - m_MinFontSize) / 2, 0.05f);
                  defaultFontSize =
                      (int)(Mathf.Max(defaultFontSize,
                                      generationSettings.fontSizeMin) *
                                20 +
                            0.5f) /
                      20f;
              ...
              if (generationSettings.wordWrap)
                ...
                renderedHeight =
                    Mathf.Max(renderedHeight, lineAscender - lineDescender);
            ...
            // Text Auto-Sizing (text exceeding Width of container.
            if (ignoreTextAutoSizing == false &&
                defaultFontSize > generationSettings.fontSizeMin) {
              // Handle Character Width Adjustments
              if (m_CharWidthAdjDelta <
                  generationSettings.charWidthMaxAdj / 100) {
                m_RecursiveCount = 0;
        ...
        if (charCode == k_LineFeed ||
          ...
          if (charCode == k_LineFeed &&
              m_CharacterCount != totalCharacterCount - 1) {
            maxXAdvance =
                Mathf.Max(maxXAdvance, renderedWidth + linebreakingWidth);
            renderedWidth = 0;
          } else
            renderedWidth =
                Mathf.Max(maxXAdvance, renderedWidth + linebreakingWidth);
        ...
        if (generationSettings.wordWrap ||
          ...
          if ((char.IsWhiteSpace((char) charCode) ||
               charCode == k_ZeroWidthSpace || charCode == k_HyphenMinus ||
               charCode == k_SoftHyphen) &&
              !m_IsNonBreakingSpace && charCode != k_NoBreakSpace &&
              charCode != k_NonBreakingHyphen &&
              charCode != k_NarrowNoBreakSpace && charCode != k_WordJoiner) {
            // We store the state of numerous variables for the most recent
            // Space, LineFeed or Carriage Return to enable them to be restored
          ...
          // Handling for East Asian languages
                    ...
                    charCode > k_CjkFormsStart &&
                        charCode <
                            k_CjkFormsEnd || /* CJK Compatibility Forms */
                    charCode > k_CjkHalfwidthStart &&
                        charCode < k_CjkHalfwidthEnd) /* CJK Halfwidth */
                   && !m_IsNonBreakingSpace) {
            if (isFirstWord || isLastBreakingChar ||
                TextSettings.linebreakingRules.leadingCharacters.ContainsKey(
                    charCode) == false &&
                    (m_CharacterCount < totalCharacterCount - 1 &&
                     TextSettings.linebreakingRules.followingCharacters
                             .ContainsKey(
                                 m_InternalTextElementInfo[m_CharacterCount + 1]
                                     .character) == false)) {
              SaveWordWrappingState(ref savedWordWrapState, i, m_CharacterCount,
                                    textInfo);
              m_IsCharacterWrappingEnabled = false;
      ...
      // Check Auto Sizing and increase font size to fill text container.
      var fontSizeDelta = m_MaxFontSize - m_MinFontSize;
      if (!m_IsCharacterWrappingEnabled && !ignoreTextAutoSizing &&
          fontSizeDelta > 0.051f &&
          defaultFontSize < generationSettings.fontSizeMax) {
        m_MinFontSize = defaultFontSize;
        defaultFontSize +=
            Mathf.Max((m_MaxFontSize - defaultFontSize) / 2, 0.05f);
        defaultFontSize =
            (int)(Mathf.Min(defaultFontSize, generationSettings.fontSizeMax) *
                      20 +
                  0.5f) /
            20f;
      ...
      renderedWidth +=
          generationSettings.margins.x > 0 ? generationSettings.margins.x : 0;
      renderedWidth +=
          generationSettings.margins.z > 0 ? generationSettings.margins.z : 0;

      renderedHeight +=
          generationSettings.margins.y > 0 ? generationSettings.margins.y : 0;
      renderedHeight +=
          generationSettings.margins.w > 0 ? generationSettings.margins.w : 0;
