...
namespace UnityEngine.TextCore {
  ...
  internal class TextSpriteAsset : ScriptableObject {
    ...
    /// Version 1.1.0 updates the asset data structure to be compatible with new
    ...
    /// <summary>
    /// Hash code derived from the name of the material used by this
    /// TextSpriteAsset.
    /// </summary>
    public int materialHashCode {
      get { return m_MaterialHashCode; }
    }
    [SerializeField] int m_MaterialHashCode;
    ...
    /// This function should be called when a sprite's name or unicode value
    /// changes or when a new sprite is added.
    /// </summary>
    ...
    /// <summary>
    /// Search through the given sprite asset and its fallbacks for the
    /// specified sprite matching the given unicode character.
    /// </summary>
    /// <param name="spriteAsset">The font asset to search for the given
    /// character.</param> <param name="unicode">The character to find.</param>
    /// <param name="includeFallbacks"></param>
    /// <param name="spriteIndex"></param>
    /// <returns></returns>
    public static TextSpriteAsset
    SearchForSpriteByUnicode(TextSpriteAsset spriteAsset, uint unicode,
                             bool includeFallbacks, out int spriteIndex) {
      ...
      // Initialize list to track instance of Sprite Assets that have already
      // been searched.
      ...
      if (includeFallbacks && spriteAsset.fallbackSpriteAssets != null &&
          spriteAsset.fallbackSpriteAssets.Count > 0)
        return SearchForSpriteByUnicodeInternal(
            spriteAsset.fallbackSpriteAssets, unicode, includeFallbacks,
            out spriteIndex);
      ...
      if (includeFallbacks && TextSettings.defaultSpriteAsset != null)
        return SearchForSpriteByUnicodeInternal(TextSettings.defaultSpriteAsset,
                                                unicode, includeFallbacks,
                                                out spriteIndex);
    ...
    /// <summary>
    /// Search through the given list of sprite assets and fallbacks for a
    /// sprite whose unicode value matches the target unicode.
    /// </summary>
    ...
    /// <param name="spriteIndex"></param>
    /// <returns></returns>
    static TextSpriteAsset
    SearchForSpriteByUnicodeInternal(List<TextSpriteAsset> spriteAssets,
                                     uint unicode, bool includeFallbacks,
                                     out int spriteIndex) {
      for (int i = 0; i < spriteAssets.Count; i++) {
        ...
        temp = SearchForSpriteByUnicodeInternal(temp, unicode, includeFallbacks,
                                                out spriteIndex);
    ...
    /// <summary>
    /// Search the given sprite asset and fallbacks for a sprite whose unicode
    /// value matches the target unicode.
    /// </summary>
    ...
    /// <returns></returns>
    static TextSpriteAsset
    SearchForSpriteByUnicodeInternal(TextSpriteAsset spriteAsset, uint unicode,
    ...
    /// <summary>
    /// Search the given sprite asset and fallbacks for a sprite whose hash code
    /// value of its name matches the target hash code.
    /// </summary>
    /// <param name="spriteAsset">The Sprite Asset to search for the given
    /// sprite whose name matches the hashcode value</param> <param
    /// name="hashCode">The hash code value matching the name of the
    /// sprite</param> <param name="includeFallbacks">Include fallback sprite
    /// assets in the search</param> <param name="spriteIndex">The index of the
    /// sprite matching the provided hash code</param> <returns>The Sprite Asset
    /// that contains the sprite</returns>
    public static TextSpriteAsset
    SearchForSpriteByHashCode(TextSpriteAsset spriteAsset, int hashCode,
                              bool includeFallbacks, out int spriteIndex) {
      ...
      if (includeFallbacks && spriteAsset.fallbackSpriteAssets != null &&
          spriteAsset.fallbackSpriteAssets.Count > 0)
        return SearchForSpriteByHashCodeInternal(
            spriteAsset.fallbackSpriteAssets, hashCode, includeFallbacks,
            out spriteIndex);

      // Search default sprite asset potentially assigned in the Text Settings.
      if (includeFallbacks && TextSettings.defaultSpriteAsset != null)
        return SearchForSpriteByHashCodeInternal(
            TextSettings.defaultSpriteAsset, hashCode, includeFallbacks,
            out spriteIndex);
    ...
    /// <summary>
    ///  Search through the given list of sprite assets and fallbacks for a
    ///  sprite whose hash code value of its name matches the target hash code.
    /// </summary>
    /// <param name="spriteAssets"></param>
    /// <param name="hashCode"></param>
    ...
    /// <returns></returns>
    static TextSpriteAsset
    SearchForSpriteByHashCodeInternal(List<TextSpriteAsset> spriteAssets,
                                      int hashCode, bool searchFallbacks,
                                      out int spriteIndex) {
      ...
      for (int i = 0; i < spriteAssets.Count; i++) {
        ...
        temp = SearchForSpriteByHashCodeInternal(
            temp, hashCode, searchFallbacks, out spriteIndex);
    ...
    /// <summary>
    /// Search through the given sprite asset and fallbacks for a sprite whose
    /// hash code value of its name matches the target hash code.
    /// </summary>
    /// <param name="spriteAsset"></param>
    /// <param name="hashCode"></param>
    /// <param name="searchFallbacks"></param>
    ...
    /// <returns></returns>
    static TextSpriteAsset
    SearchForSpriteByHashCodeInternal(TextSpriteAsset spriteAsset, int hashCode,
      ...
      if (searchFallbacks && spriteAsset.fallbackSpriteAssets != null &&
          spriteAsset.fallbackSpriteAssets.Count > 0)
        return SearchForSpriteByHashCodeInternal(
            spriteAsset.fallbackSpriteAssets, hashCode, searchFallbacks,
            out spriteIndex);
    ...
    public void SortGlyphTable() {
      ...
      m_SpriteGlyphTable =
          m_SpriteGlyphTable.OrderBy(item => item.index).ToList();
    }
    ...
    internal void SortCharacterTable() {
      if (m_SpriteCharacterTable != null && m_SpriteCharacterTable.Count > 0)
        m_SpriteCharacterTable =
            m_SpriteCharacterTable.OrderBy(c => c.unicode).ToList();
    }
