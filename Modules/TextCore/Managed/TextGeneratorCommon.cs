...
/// </summary>
[Flags] enum HorizontalAlignment {
	Left = 0x1,
	Center = 0x2,
	Right = 0x4,
	Justified = 0x8,
...
internal enum TextAlignment {
	...
	BaselineJustified =
		HorizontalAlignment.Justified | VerticalAlignment.Baseline,
	BaselineFlush = HorizontalAlignment.Flush | VerticalAlignment.Baseline,
	BaselineGeoAligned =
		HorizontalAlignment.Geometry | VerticalAlignment.Baseline,
	...
	MidlineJustified =
		HorizontalAlignment.Justified | VerticalAlignment.Midline,
	MidlineFlush = HorizontalAlignment.Flush | VerticalAlignment.Midline,
	MidlineGeoAligned =
		HorizontalAlignment.Geometry | VerticalAlignment.Midline,
	...
	CaplineJustified =
		HorizontalAlignment.Justified | VerticalAlignment.Capline,
	CaplineFlush = HorizontalAlignment.Flush | VerticalAlignment.Capline,
	CaplineGeoAligned =
		HorizontalAlignment.Geometry | VerticalAlignment.Capline,
}

[Flags] enum FontStyles {
	Normal = 0x0,
	Bold = 0x1,
	Italic = 0x2,
	Underline = 0x4,
