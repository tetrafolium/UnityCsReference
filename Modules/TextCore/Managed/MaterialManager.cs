...
namespace UnityEngine.TextCore {
  static class MaterialManager {
    static Dictionary<long, Material> s_FallbackMaterials =
        new Dictionary<long, Material>();

    /// <summary>
    /// This function returns a material instance using the material properties
    /// of a previous material but using the font atlas texture of the new font
    /// asset.
    /// </summary>
    /// <param name="sourceMaterial">The material containing the source material
    /// properties to be copied to the new material.</param> <param
    /// name="targetMaterial">The font atlas texture that should be assigned to
    /// the new material.</param> <returns></returns>
    public static Material GetFallbackMaterial(Material sourceMaterial,
      ...
      // Create new material from the source material and copy properties if
      // using distance field shaders.
