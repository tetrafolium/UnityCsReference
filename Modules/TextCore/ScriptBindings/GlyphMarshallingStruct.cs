...
namespace UnityEngine.TextCore.LowLevel {
  ...
  internal struct GlyphMarshallingStruct {
    ...
    /// <summary>
    /// Metrics defining the size, positioning and spacing of a glyph when doing
    /// text layout.
    /// </summary>
    ...
    /// <param name="glyphRect">A rectangle defining the position of the glyph
    ...
    public GlyphMarshallingStruct(uint index, GlyphMetrics metrics,
                                  GlyphRect glyphRect, float scale,
                                  int atlasIndex) {
      this.index = index;
