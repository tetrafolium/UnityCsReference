...
namespace UnityEditor.UIElements {
  public class RectField : BaseCompositeField<Rect, FloatField, float> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Rect r, float v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Rect r, float v) => r.y = v),
          new FieldDescription("W", "unity-width-input", r => r.width,
                               (ref Rect r, float v) => r.width = v),
          new FieldDescription("H", "unity-height-input", r => r.height,
                               (ref Rect r, float v) => r.height = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Rect, FloatField, float>.UxmlTraits {
      UxmlFloatAttributeDescription m_XValue =
          new UxmlFloatAttributeDescription{name = "x"};
      UxmlFloatAttributeDescription m_YValue =
          new UxmlFloatAttributeDescription{name = "y"};
      UxmlFloatAttributeDescription m_WValue =
          new UxmlFloatAttributeDescription{name = "w"};
      UxmlFloatAttributeDescription m_HValue =
          new UxmlFloatAttributeDescription{name = "h"};
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        var r = (RectField) ve;
        r.SetValueWithoutNotify(new Rect(m_XValue.GetValueFromBag(bag, cc),
                                         m_YValue.GetValueFromBag(bag, cc),
                                         m_WValue.GetValueFromBag(bag, cc),
                                         m_HValue.GetValueFromBag(bag, cc)));
      }
    }
  ...
  public class RectIntField : BaseCompositeField<RectInt, IntegerField, int> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref RectInt r, int v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref RectInt r, int v) => r.y = v),
          new FieldDescription("W", "unity-width-input", r => r.width,
                               (ref RectInt r, int v) => r.width = v),
          new FieldDescription("H", "unity-height-input", r => r.height,
                               (ref RectInt r, int v) => r.height = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<RectInt, IntegerField, int>.UxmlTraits {
      UxmlIntAttributeDescription m_XValue =
          new UxmlIntAttributeDescription{name = "x"};
      UxmlIntAttributeDescription m_YValue =
          new UxmlIntAttributeDescription{name = "y"};
      UxmlIntAttributeDescription m_WValue =
          new UxmlIntAttributeDescription{name = "w"};
      UxmlIntAttributeDescription m_HValue =
          new UxmlIntAttributeDescription{name = "h"};
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        r.SetValueWithoutNotify(new RectInt(m_XValue.GetValueFromBag(bag, cc),
                                            m_YValue.GetValueFromBag(bag, cc),
                                            m_WValue.GetValueFromBag(bag, cc),
                                            m_HValue.GetValueFromBag(bag, cc)));
      }
  ...
  public class Vector2Field : BaseCompositeField<Vector2, FloatField, float> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Vector2 r, float v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Vector2 r, float v) => r.y = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Vector2, FloatField, float>.UxmlTraits {
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        f.SetValueWithoutNotify(new Vector2(m_XValue.GetValueFromBag(bag, cc),
                                            m_YValue.GetValueFromBag(bag, cc)));
      }
    }
  ...
  public class Vector3Field : BaseCompositeField<Vector3, FloatField, float> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Vector3 r, float v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Vector3 r, float v) => r.y = v),
          new FieldDescription("Z", "unity-z-input", r => r.z,
                               (ref Vector3 r, float v) => r.z = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Vector3, FloatField, float>.UxmlTraits {
      ...
      UxmlFloatAttributeDescription m_ZValue =
          new UxmlFloatAttributeDescription{name = "z"};
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        f.SetValueWithoutNotify(new Vector3(m_XValue.GetValueFromBag(bag, cc),
                                            m_YValue.GetValueFromBag(bag, cc),
                                            m_ZValue.GetValueFromBag(bag, cc)));
      }
    }
  ...
  public class Vector4Field : BaseCompositeField<Vector4, FloatField, float> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Vector4 r, float v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Vector4 r, float v) => r.y = v),
          new FieldDescription("Z", "unity-z-input", r => r.z,
                               (ref Vector4 r, float v) => r.z = v),
          new FieldDescription("W", "unity-w-input", r => r.w,
                               (ref Vector4 r, float v) => r.w = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Vector4, FloatField, float>.UxmlTraits {
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        f.SetValueWithoutNotify(new Vector4(m_XValue.GetValueFromBag(bag, cc),
                                            m_YValue.GetValueFromBag(bag, cc),
                                            m_ZValue.GetValueFromBag(bag, cc),
                                            m_WValue.GetValueFromBag(bag, cc)));
      }
  ...
  public class Vector2IntField
      : BaseCompositeField<Vector2Int, IntegerField, int> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Vector2Int r, int v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Vector2Int r, int v) => r.y = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Vector2Int, IntegerField, int>.UxmlTraits
    {
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        f.SetValueWithoutNotify(
            new Vector2Int(m_XValue.GetValueFromBag(bag, cc),
                           m_YValue.GetValueFromBag(bag, cc)));
      }
    }
  ...
  public class Vector3IntField
      : BaseCompositeField<Vector3Int, IntegerField, int> {
    internal override FieldDescription[] DescribeFields() {
      return new[]{
          new FieldDescription("X", "unity-x-input", r => r.x,
                               (ref Vector3Int r, int v) => r.x = v),
          new FieldDescription("Y", "unity-y-input", r => r.y,
                               (ref Vector3Int r, int v) => r.y = v),
          new FieldDescription("Z", "unity-z-input", r => r.z,
                               (ref Vector3Int r, int v) => r.z = v),
      };
    }
    ...
    public new class UxmlTraits : BaseCompositeField<Vector3Int, IntegerField, int>.UxmlTraits
    {
      ...
      UxmlIntAttributeDescription m_YValue =
          new UxmlIntAttributeDescription{name = "y"};
      UxmlIntAttributeDescription m_ZValue =
          new UxmlIntAttributeDescription{name = "z"};
      ...
      public override void Init(VisualElement ve, IUxmlAttributes bag,
        ...
        f.SetValueWithoutNotify(
            new Vector3Int(m_XValue.GetValueFromBag(bag, cc),
                           m_YValue.GetValueFromBag(bag, cc),
                           m_ZValue.GetValueFromBag(bag, cc)));
      }
    }
