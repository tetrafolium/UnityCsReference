...
namespace UnityEditor.UIElements {
  ...
  public abstract class BasePopupField<TValueType, TValueChoice>
    ...
    public override void SetValueWithoutNotify(TValueType newValue) {
      ...
      ((INotifyValueChanged<string>) m_TextElement)
    ...
    internal BasePopupField(string label) : base(label, null) {
      ...
      m_TextElement = new PopupTextElement{pickingMode = PickingMode.Ignore};
    ...
    private class PopupTextElement : TextElement {
      protected internal override Vector2 DoMeasure(float desiredWidth,
        ...
        return MeasureTextSize(textToMeasure, desiredWidth, widthMode,
                               desiredHeight, heightMode);
      }
    }
  }
}
