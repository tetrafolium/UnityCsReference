...
namespace UnityEditor.UIElements {
  public class FloatField : TextValueField<float> {
    ...
    public new class UxmlTraits
        : TextValueFieldTraits<float, UxmlFloatAttributeDescription> {}
    ...
    CanTryParse(string textString) => float.TryParse(textString, out _);
    ...
    class FloatInput : TextValueInput {
      ...
      protected override string allowedCharacters =>
          EditorGUI.s_AllowedCharactersForFloat;

      public override void
      ApplyInputDeviceDelta(Vector3 delta, DeltaSpeed speed, float startValue) {
        double sensitivity =
        ...
        v += NumericFieldDraggerUtility.NiceDelta(delta, acceleration) *
             sensitivity;
