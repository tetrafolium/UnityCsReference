...
public new class UxmlTraits
	: TextValueFieldTraits<int, UxmlIntAttributeDescription> {}
...
public IntegerField() : this((string) null) {
}
...
CanTryParse(string textString) => int.TryParse(textString, out _);
...
EditorGUI.s_AllowedCharactersForInt;

public override void
ApplyInputDeviceDelta(Vector3 delta, DeltaSpeed speed, int startValue) {
	double sensitivity =
