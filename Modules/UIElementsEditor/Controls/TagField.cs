...
namespace UnityEditor.UIElements {
  public class TagField : PopupField<string> {
    ...
    internal override string GetValueToDisplay() { return rawValue; }

    public override string value {
      get { return base.value; }
      set {
        // Allow the setting of value outside of Tags, but do nothing with
        // them...
      ...
      set {
        if (value != null) {
          Debug.LogWarning(L10n.Tr(
              "TagField doesn't support the formatting of the selected value."));
        }
    ...
    public override Func<string, string> formatListItemCallback {
      ...
      set {
        if (value != null) {
          Debug.LogWarning(L10n.Tr(
              "TagField doesn't support the formatting of the list items."));
        }
    ...
    public TagField() : this(null) {}

    public TagField(string label, string defaultValue = null) : base(label) {
    ...
    internal override void AddMenuItems(GenericMenu menu) {
      ...
      foreach (var menuItem in choices) {
        ...
        menu.AddItem(new GUIContent(menuItem), isSelected,
                     () => ChangeValueFromMenu(menuItem));
      }
      menu.AddItem(new GUIContent(""), false, null); // This is a separator...
      menu.AddItem(new GUIContent(L10n.Tr("Add Tag...")), false,
                   OpenTagInspector);
    }

    void ChangeValueFromMenu(string menuItem) { value = menuItem; }
