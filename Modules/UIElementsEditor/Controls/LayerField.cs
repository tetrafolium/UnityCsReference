  ...
  public class LayerField : PopupField<int> {
      ...
      set {
        if (value != null) {
          Debug.LogWarning(L10n.Tr(
              "LayerField doesn't support the formatting of the selected value."));
        }
    ...
    public override Func<int, string> formatListItemCallback {
      ...
      set {
        if (value != null) {
          Debug.LogWarning(L10n.Tr(
              "LayerField doesn't support the formatting of the list items."));
        }
    ...
    public LayerField(string label) : base(label, InitializeLayers(), 0) {
    ...
    public LayerField() : this(null) {}

    public LayerField(int defaultValue) : this(null, defaultValue) {
    ...
    internal override void AddMenuItems(GenericMenu menu) {
      ...
      menu.AddItem(new GUIContent(L10n.Tr("Add Layer...")), false,
                   OpenLayerInspector);
    }

    void ChangeValueFromMenu(int menuItemIndex) { value = menuItemIndex; }
