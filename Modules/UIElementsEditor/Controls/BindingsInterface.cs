...
namespace UnityEditor.UIElements {
  internal interface ISerializedObjectBindingImplementation {
    ...
    void Bind(VisualElement element, object bindingContext,
  ...
  public static class BindingExtensions {
    ...
    internal static readonly string prefabOverrideBarName =
        "unity-binding-prefab-override-bar";
    internal static readonly string prefabOverrideBarContainerName =
        "unity-prefab-override-bars-container";
    internal static readonly string prefabOverrideBarUssClassName =
        "unity-binding__prefab-override-bar";
    internal static readonly string animationAnimatedUssClassName =
        "unity-binding--animation-animated";
    internal static readonly string animationRecordedUssClassName =
        "unity-binding--animation-recorded";
    internal static readonly string animationCandidateUssClassName =
    ...
    public static SerializedProperty BindProperty(this IBindable field,
                                                  SerializedObject obj) {
      return bindingImpl.BindProperty(field, obj);
    }

    public static void BindProperty(this IBindable field,
