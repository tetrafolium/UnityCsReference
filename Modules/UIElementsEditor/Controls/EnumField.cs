...
#pragma warning restore 414
    ...
    public EnumField() : this((string) null) {}
    ...
    public void Init(Enum defaultValue) { Init(defaultValue, false); }
    ...
    private void ShowMenu() {
      ...
      var menuPosition =
          new Vector2(visualInput.layout.xMin, visualInput.layout.height);
