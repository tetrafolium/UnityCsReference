...
namespace UnityEditor.UIElements {
  ...
  internal class PanelDebug : IPanelDebug {
    ...
    public IPanel debuggerOverlayPanel {
      get;
      private set;
    }
    ...
    private void InitializeDebuggerOverlayPanel() {
      if (debuggerOverlayPanel == null) {
        ...
        var debuggerOverlayTmpPanel =
            new Panel(ownerObject, panel.contextType, new EventDispatcher());
        ...
        debugContainer = new VisualElement(){
            style = {position = Position.Absolute, top = 0, left = 0, right = 0,
                     bottom = 0, backgroundColor = Color.clear}};
    ...
    public PanelDebug(IPanel panel) { this.panel = panel; }
    ...
    public void MarkDirtyRepaint() { panel.visualTree.MarkDirtyRepaint(); }
