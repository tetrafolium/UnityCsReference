...
namespace UnityEditor.UIElements {
  public class ToolbarSearchField : SearchFieldBase<TextField, string> {
    ...
    public new static readonly string textUssClassName =
        SearchFieldBase<TextField, string>.textUssClassName;
    public new static readonly string searchButtonUssClassName =
        SearchFieldBase<TextField, string>.searchButtonUssClassName;
    public new static readonly string cancelButtonUssClassName =
        SearchFieldBase<TextField, string>.cancelButtonUssClassName;
    public new static readonly string cancelButtonOffVariantUssClassName =
        SearchFieldBase<TextField, string>.cancelButtonOffVariantUssClassName;
    public new static readonly string popupVariantUssClassName =
        SearchFieldBase<TextField, string>.popupVariantUssClassName;
