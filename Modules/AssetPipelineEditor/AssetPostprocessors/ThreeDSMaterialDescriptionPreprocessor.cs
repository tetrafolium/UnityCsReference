...
namespace UnityEditor.Experimental.AssetImporters {
  public class ThreeDSMaterialDescriptionPreprocessor : AssetPostprocessor {
    ...
    void CreateFrom3DSMaterial(MaterialDescription description,
                               Material material, AnimationClip[] clips) {
      var shader = Shader.Find("Standard");
      if (shader == null) {
        context.LogImportError(
            "ThreeDSMaterialDescriptionPreprocessor cannot find a shader named 'Standard'.");
        return;
      }
