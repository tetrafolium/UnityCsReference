...
internal abstract class BaseAssetImporterTabUI
{
    ...
    {
        get {
            return m_PanelContainer.serializedObject;
        }
    }
    ...
    {
        get {
            return m_PanelContainer.targets;
        }
    }
    ...
    {
        get {
            return m_PanelContainer.target;
        }
    }
    ...
    {
        get {
            return m_PanelContainer.assetTarget;
        }
    }
    ...
    {
        get {
            return m_PanelContainer.assetTargets;
        }
    }
    ...
    {
        get {
            return m_PanelContainer.referenceTargetIndex;
        }
        set {
            m_PanelContainer.referenceTargetIndex = value;
        }
    }
