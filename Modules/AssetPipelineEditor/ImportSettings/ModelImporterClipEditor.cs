...
internal class ModelImporterClipEditor : BaseAssetImporterTabUI
{
    ...
    ModelImporter singleImporter {
        get {
            return targets[0] as ModelImporter;
        }
    }
    ...
    private class ClipInformation
    {
        ...
        {
            get {
                return prop.FindPropertyRelative("name").stringValue;
            }
        }
        ...
        {
            get {
                return prop.FindPropertyRelative("firstFrame").floatValue.ToString("0.0", CultureInfo.InvariantCulture.NumberFormat);
            }
        }
        ...
        {
            get {
                return prop.FindPropertyRelative("lastFrame").floatValue.ToString("0.0", CultureInfo.InvariantCulture.NumberFormat);
            }
        }
    }
...
#pragma warning restore 0649
    ...
    {
        get {
            return singleImporter.transformPaths;
        }
    }
    ...
    private ModelImporterAnimationType animationType
    {
        ...
        set {
            m_AnimationType.intValue = (int)value;
        }
    }
    ...
    {
        get {
            return (ModelImporterGenerateAnimations)m_LegacyGenerateAnimations.intValue;
        }
        set {
            m_LegacyGenerateAnimations.intValue = (int)value;
        }
    }
    ...
    internal override void OnEnable()
    {
        ...
        motionNodeIndex = ArrayUtility.FindIndex(m_MotionNodeList, delegate(GUIContent content) {
