...
internal class ModelImporterEditor : AssetImporterTabbedEditor {
  ...
  static string s_C4DDeprecationWarning = L10n.Tr(
      "Starting with the Unity 2019.3 release, direct import of Cinema4D files will require an external plugin. Keep an eye on our External Tools forum for updates.\n\nPlease note that FBX files exported from Cinema4D will still be supported.");

  public override void OnInspectorGUI() {
    if (targets.Any(
            t => t != null &&
                 Path.GetExtension(((AssetImporter) t).assetPath)
                     .Equals(".c4d", StringComparison.OrdinalIgnoreCase)))
  ...
  public override void OnEnable() {
    if (tabs == null) {
      tabs = new BaseAssetImporterTabUI[]{
          new ModelImporterModelEditor(this), new ModelImporterRigEditor(this),
  ...
  protected override void Apply() {
    ...
    // project browser, because some settings may have changed the preview
    // completely.
