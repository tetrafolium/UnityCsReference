...
[NativeType(CodegenOptions = CodegenOptions.Custom,
            Header = "Modules/Animation/AvatarMask.h",
            IntermediateScriptingStructName = "MonoTransformMaskElement")]
[NativeHeader(
    "Modules/AssetPipelineEditor/Public/ModelImporting/ModelImporter.bindings.h")]
...
[UsedByNativeCode]
[NativeType(CodegenOptions = CodegenOptions.Custom,
            IntermediateScriptingStructName = "MonoClipAnimationInfoCurve")]
[NativeHeader(
    "Modules/AssetPipelineEditor/Public/ModelImporting/ModelImporter.bindings.h")]
...
[StructLayout(LayoutKind.Sequential)]
[NativeType(CodegenOptions = CodegenOptions.Custom,
            IntermediateScriptingStructName = "MonoClipAnimationInfo")]
[NativeHeader(
    "Modules/AssetPipelineEditor/Public/ModelImporting/ModelImporter.bindings.h")]
public sealed partial class ModelImporterClipAnimation {
  ...
  public string takeName {
    get { return m_TakeName; }
    set { m_TakeName = value; }
  }
  public string name {
    get { return m_Name; }
    set { m_Name = value; }
  ...
  public bool loop {
    get { return m_Loop != 0; }
    set { m_Loop = value ? 1 : 0; }
  }

  public float rotationOffset {
    get { return m_OrientationOffsetY; }
    set { m_OrientationOffsetY = value; }
  }
  ...
  public float cycleOffset {
    get { return m_CycleOffset; }
    set { m_CycleOffset = value; }
  }

  public bool loopTime {
    get { return m_LoopTime != 0; }
    set { m_LoopTime = value ? 1 : 0; }
  }

  public bool loopPose {
    get { return m_LoopBlend != 0; }
    set { m_LoopBlend = value ? 1 : 0; }
  }

  public bool lockRootRotation {
    get { return m_LoopBlendOrientation != 0; }
    set { m_LoopBlendOrientation = value ? 1 : 0; }
  }

  public bool lockRootHeightY {
    get { return m_LoopBlendPositionY != 0; }
    set { m_LoopBlendPositionY = value ? 1 : 0; }
  }

  public bool lockRootPositionXZ {
    get { return m_LoopBlendPositionXZ != 0; }
    set { m_LoopBlendPositionXZ = value ? 1 : 0; }
  }

  public bool keepOriginalOrientation {
    get { return m_KeepOriginalOrientation != 0; }
    set { m_KeepOriginalOrientation = value ? 1 : 0; }
  }

  public bool keepOriginalPositionY {
    get { return m_KeepOriginalPositionY != 0; }
    set { m_KeepOriginalPositionY = value ? 1 : 0; }
  }

  public bool keepOriginalPositionXZ {
    get { return m_KeepOriginalPositionXZ != 0; }
    set { m_KeepOriginalPositionXZ = value ? 1 : 0; }
  }

  public bool heightFromFeet {
    get { return m_HeightFromFeet != 0; }
    set { m_HeightFromFeet = value ? 1 : 0; }
  }

  public bool mirror {
    get { return m_Mirror != 0; }
    set { m_Mirror = value ? 1 : 0; }
  }

  public ClipAnimationMaskType maskType {
    get { return (ClipAnimationMaskType) m_MaskType; }
    set { m_MaskType = (int) value; }
  }

  public AvatarMask maskSource {
    get { return m_MaskSource; }
    set { m_MaskSource = value; }
  }

  public AnimationEvent[] events {
    get { return m_AnimationEvents; }
    set { m_AnimationEvents = value; }
  }
  public ClipAnimationInfoCurve[] curves {
    get { return m_AdditionnalCurves; }
    set { m_AdditionnalCurves = value; }
  }

  public bool maskNeedsUpdating {
    get { return m_MaskNeedsUpdating; }
  }

  public float additiveReferencePoseFrame {
    get { return m_AdditiveReferencePoseFrame; }
    set { m_AdditiveReferencePoseFrame = value; }
  }
  public bool hasAdditiveReferencePose {
    get { return m_HasAdditiveReferencePose != 0; }
    set { m_HasAdditiveReferencePose = value ? 1 : 0; }
  }
  ...
  public void ConfigureClipFromMask(AvatarMask mask) {
    ...
    for (int i = 0; i < (int) AvatarMaskBodyPart.LastBodyPart; i++) {
      m_BodyMask[i] =
          mask.GetHumanoidBodyPartActive((AvatarMaskBodyPart) i) ? 1 : 0;
    }
  }

  public override bool Equals(object o) {
    ModelImporterClipAnimation other = o as ModelImporterClipAnimation;
    return other != null && takeName == other.takeName && name == other.name &&
           firstFrame == other.firstFrame && lastFrame == other.lastFrame &&
           m_WrapMode == other.m_WrapMode && m_Loop == other.m_Loop &&
           ...
           mirror == other.mirror && maskType == other.maskType &&
           maskSource == other.maskSource &&
           additiveReferencePoseFrame == other.additiveReferencePoseFrame &&
           hasAdditiveReferencePose == other.hasAdditiveReferencePose;
  }
...
[System.Obsolete(
    "Use ModelImporterMaterialName, ModelImporter.materialName and ModelImporter.materialImportMode instead",
    true)]
public enum ModelImporterGenerateMaterials {
      [System.Obsolete("Use ModelImporter.materialImportMode=None instead",
                       true)] None = 0,
      [ System.Obsolete(
          "Use ModelImporter.materialImportMode=Import and ModelImporter.materialName=ModelImporterMaterialName.BasedOnTextureName instead",
          true) ] PerTexture = 1,
      [ System.Obsolete(
          "Use ModelImporter.materialImportMode=Import and ModelImporter.materialName=ModelImporterMaterialName.BasedOnModelNameAndMaterialName instead",
          true) ] PerSourceMaterial = 2,
}

[NativeType(
    Header =
        "Modules/AssetPipelineEditor/Public/ModelImporting/ModelImporter.h")]
public enum ModelImporterMaterialName {
  ...
  [
    System.Obsolete(
        "You should use ModelImporterMaterialName.BasedOnTextureName instead, because it it less complicated and behaves in more consistent way.")
...
public enum ModelImporterMaterialLocation {
  ...
  [Tooltip("Use external materials if found in the project.")] External = 0,
  [InspectorName("Use Embedded Materials")]
  [Tooltip("Embed the material inside the imported asset.")] InPrefab = 1
}
...
public enum ModelImporterMaterialImportMode {
      [Tooltip("Do not import materials")] None = 0,
      [InspectorName("Standard (Legacy)")]
      [Tooltip("Use the standard Material import method.")] ImportStandard = 1,
      [InspectorName("Import via MaterialDescription")]
      [Tooltip(
          "Use AssetPostprocessor.OnPreprocessMaterialDescription.")] ImportViaMaterialDescription =
          2,

      [
        System.Obsolete(
            "Use ImportStandard (UnityUpgradable) -> ImportStandard")
      ] LegacyImport = 1,
      [
        System.Obsolete(
            "Use ImportViaMaterialDescription (UnityUpgradable) -> ImportViaMaterialDescription")
      ] Import = 2
}

public enum ModelImporterTangentSpaceMode {
      [System.Obsolete("Use ModelImporterNormals.Import instead")] Import = 0,
      [ System.Obsolete(
          "Use ModelImporterNormals.Calculate instead") ] Calculate = 1,
      [ System.Obsolete("Use ModelImporterNormals.None instead") ] None = 2,
}

[NativeType(
    Header = "Modules/AssetPipelineEditor/Public/ModelImporting/ImportMesh.h")]
...
public enum ModelImporterNormalCalculationMode {
      [InspectorName("Unweighted (Legacy)")] Unweighted_Legacy,
...
public enum ModelImporterTangents {
  ...
  [ InspectorName("Calculate Mikktspace") ] CalculateMikk = 3,
...
public enum ModelImporterIndexFormat {
  ...
  [ InspectorName("32 bits") ] UInt32 = 2,
}
...
public enum ModelImporterAvatarSetup {
  ...
  [Tooltip(
      "Copy an Avatar from another file to import muscle clip. No avatar will be created.")]
  [InspectorName("Copy From Other Avatar")] CopyFromOther = 2,
}
...
public sealed partial class HumanTemplate : Object {
  public HumanTemplate() { Internal_Create(this); }
...
public partial class ModelImporter : AssetImporter {
  const string obsoleteGenerateMaterials =
      "generateMaterials has been  removed. Use materialImportMode, materialName and materialSearch instead.";
  [System.Obsolete(obsoleteGenerateMaterials, true)]
  public ModelImporterGenerateMaterials generateMaterials =>
      throw new NotSupportedException(obsoleteGenerateMaterials);

  const string obsoleteImportMaterials =
      "importMaterials has been  removed. Use materialImportMode instead.";
  [System.Obsolete(obsoleteImportMaterials, true)]
  public bool importMaterials =>
      throw new NotSupportedException(obsoleteImportMaterials);
  ...
  internal extern SourceAssetIdentifier[] sourceMaterials {
    [FreeFunction(Name = "ModelImporterBindings::GetSourceMaterials",
  ...
  public extern bool isUseFileUnitsSupported {
    [NativeMethod("IsUseFileUnitsSupported")] get;
  }
  ...
  public extern float fileScale { get; }
  ...
  public extern bool addCollider {
    [NativeMethod("GetAddColliders")] get;
    [NativeMethod("SetAddColliders")] set;
  }
  ...
  public extern ModelImporterGenerateAnimations generateAnimations {
    [NativeMethod("GetLegacyGenerateAnimations")] get;
    [NativeMethod("SetLegacyGenerateAnimations")] set;
  }

  public extern TakeInfo[] importedTakeInfos { get; }

  public extern string[] transformPaths { get; }
  ...
  private extern static string[] INTERNAL_GetReferencedClips(
      ModelImporter self);
  ...
  [System.Obsolete(
      "optimizeMesh is deprecated. Use optimizeMeshPolygons and/or optimizeMeshVertices instead.  Note that optimizeMesh false equates to optimizeMeshPolygons true and optimizeMeshVertices false while optimizeMesh true equates to both true")]
  public bool optimizeMesh {
    // Legacy property that has been replaced with 'optimizeMeshPolygons' and
    // 'optimizeMeshVertices' to provide more granular mesh optimization control
    get { return meshOptimizationFlags != 0; }
    set {
      if (value) {
        // Original single flag 'optimizeMesh' caused both polygons and vertices
        // to be optimized when true so emulate that behaviour
        meshOptimizationFlags = MeshOptimizationFlags.Everything;
      } else {
        // Original single flag 'optimizeMesh' caused polygons but not vertices
        // to be optimized when false so emulate that behaviour
  ...
  public extern ModelImporterSkinWeights skinWeights {
    [NativeMethod("GetSkinWeightsMode")] get;
    [NativeMethod("SetSkinWeightsMode")] set;
  }
    ...
    set {
      if (value < 1 || value > 255)
        throw new ArgumentOutOfRangeException(
            nameof(maxBonesPerVertex), value,
            "Value must be in the range 1 - 255.");
      if (skinWeights != ModelImporterSkinWeights.Custom)
        Debug.LogWarning(
            "ModelImporter.maxBonesPerVertex is ignored unless ModelImporter.skinWeights is set to ModelImporterSkinWeights.Custom.");
  ...
  public float minBoneWeight {
    ...
    set {
      if (!(value >= 0.0f && value <= 1.0f))
        throw new ArgumentOutOfRangeException(
            nameof(minBoneWeight), value, "Value must be in the range 0 - 1.");
      if (skinWeights != ModelImporterSkinWeights.Custom)
        Debug.LogWarning(
            "ModelImporter.minBoneWeight is ignored unless ModelImporter.skinWeights is set to ModelImporterSkinWeights.Custom.");
  ...
  [System.Obsolete(
      "tangentImportMode is deprecated. Use importTangents instead")]
  ...
  public extern ModelImporterNormals importNormals {
    [NativeMethod("GetNormalImportMode")] get;
    [NativeMethod("SetNormalImportMode")] set;
  }

  internal extern bool
  ...
  public extern ModelImporterNormals importBlendShapeNormals {
    [NativeMethod("GetBlendShapeNormalImportMode")] get;
    [NativeMethod("SetBlendShapeNormalImportMode")] set;
  }
  ...
  public extern ModelImporterTangents importTangents {
    [NativeMethod("GetTangentImportMode")] get;
    [NativeMethod("SetTangentImportMode")] set;
  }
  ...
  public extern bool isBakeIKSupported {
    [NativeMethod("IsBakeIKSupported")] get;
  }

  [System.Obsolete("use resampleCurves instead.")]
  public extern bool resampleRotations {
    [NativeMethod("GetResampleCurves")] get;
    [NativeMethod("SetResampleCurves")] set;
  }
  ...
  public extern bool isTangentImportSupported {
    [NativeMethod("IsTangentImportSupported")] get;
  }
  ...
  private extern int internal_meshCompression {
    [NativeMethod("GetMeshCompression")] get;
    [NativeMethod("SetMeshCompression")] set;
  }
  ...
  INTERNAL_set_extraExposedTransformPaths([ Writable ] ModelImporter self,
                                          string[] value);
  ...
  private extern static void
  INTERNAL_set_extraUserProperties([ Writable ] ModelImporter self,
                                   string[] value);
  ...
  public Avatar sourceAvatar {
    get { return GetSourceAvatar(); }
    set {
      Avatar avatar = value;
      if (value != null) {
        ModelImporter importer = AssetImporter.GetAtPath(
            AssetDatabase.GetAssetPath(value)) as ModelImporter;

        if (importer != null) {
          humanDescription = importer.humanDescription;
        } else {
          Debug.LogError(
              "Avatar must be from a ModelImporter, otherwise use ModelImporter.humanDescription");
          avatar = null;
        }
      }
  ...
  private extern static void SetSourceAvatarInternal(ModelImporter self,
                                                     Avatar value);

  [System.Obsolete(
      "splitAnimations has been deprecated please use clipAnimations instead.",
      true)]
  ...
  private extern static ModelImporterClipAnimation[] GetClipAnimations(
      ModelImporter self);
  [FreeFunction("ModelImporterBindings::SetClipAnimations",
                ThrowsException = true)]
  private extern static void
  SetClipAnimations([ Writable ] ModelImporter self,
                    ModelImporterClipAnimation[] value);
  ...
  private extern static ModelImporterClipAnimation[] GetDefaultClipAnimations(
      ModelImporter self);

  internal extern bool isAssetOlderOr42 {
    [NativeMethod("IsAssetOlderOr42")] get;
  }

  [FreeFunction(
      "ModelImporterBindings::UpdateTransformMask")] extern internal static void
  UpdateTransformMask([ NotNull ] AvatarMask mask,
                      SerializedProperty serializedProperty);

  [FreeFunction(
      "ModelImporterBindings::UpdateSkeletonPose")] extern internal static void
  UpdateSkeletonPose([ NotNull ] SkeletonBone[] skeletonBones,
  ...
  public void CreateDefaultMaskForClip(ModelImporterClipAnimation clip) {
    if (this.defaultClipAnimations.Length > 0) {
      ...
      this.defaultClipAnimations [0]
          .ConfigureMaskFromClip(ref mask);
      clip.ConfigureClipFromMask(mask);
      DestroyImmediate(mask);
    } else
      Debug.LogError(
          "Cannot create default mask because the current importer doesn't have any animation information");
  }
  ...
  public extern bool
  SearchAndRemapMaterials(ModelImporterMaterialName nameOption,
