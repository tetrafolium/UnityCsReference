...
public sealed partial class ModelImporterClipAnimation
{
    ...
    public float rotationOffset {
        get {
            return m_OrientationOffsetY;
        }
        set {
            m_OrientationOffsetY = value;
        }
    }
    ...
    public bool loopTime {
        ...
        set {
            m_LoopTime = value ? 1 : 0;
        }
    }

    public bool loopPose {
        get {
            return m_LoopBlend != 0;
        }
        set {
            m_LoopBlend = value ? 1 : 0;
        }
    }

    public bool lockRootRotation {
        get {
            return m_LoopBlendOrientation != 0;
        }
        set {
            m_LoopBlendOrientation = value ? 1 : 0;
        }
    }

    public bool lockRootHeightY {
        get {
            return m_LoopBlendPositionY != 0;
        }
        set {
            m_LoopBlendPositionY = value ? 1 : 0;
        }
    }

    public bool lockRootPositionXZ {
        get {
            return m_LoopBlendPositionXZ != 0;
        }
        set {
            m_LoopBlendPositionXZ = value ? 1 : 0;
        }
    }

    public bool keepOriginalOrientation {
        get {
            return m_KeepOriginalOrientation != 0;
        }
        set {
            m_KeepOriginalOrientation = value ? 1 : 0;
        }
    }

    public bool keepOriginalPositionY {
        get {
            return m_KeepOriginalPositionY != 0;
        }
        set {
            m_KeepOriginalPositionY = value ? 1 : 0;
        }
    }

    public bool keepOriginalPositionXZ {
        get {
            return m_KeepOriginalPositionXZ != 0;
        }
        set {
            m_KeepOriginalPositionXZ = value ? 1 : 0;
        }
    }

    public bool heightFromFeet {
        get {
            return m_HeightFromFeet != 0;
        }
        set {
            m_HeightFromFeet = value ? 1 : 0;
        }
    }
    ...
    public ClipAnimationMaskType maskType {
        get {
            return (ClipAnimationMaskType)m_MaskType;
        }
        set {
            m_MaskType = (int)value;
        }
    }
    ...
    public AnimationEvent[] events {
        ...
        set {
            m_AnimationEvents = value;
        }
    }
    public ClipAnimationInfoCurve[] curves {
        get {
            return m_AdditionnalCurves;
        }
        set {
            m_AdditionnalCurves = value;
        }
    }

    public bool maskNeedsUpdating {
        get {
            return m_MaskNeedsUpdating;
        }
    }

    public float additiveReferencePoseFrame {
        get {
            return m_AdditiveReferencePoseFrame;
        }
        set {
            m_AdditiveReferencePoseFrame = value;
        }
    }
    public bool hasAdditiveReferencePose {
        get {
            return m_HasAdditiveReferencePose != 0;
        }
        set {
            m_HasAdditiveReferencePose = value ? 1 : 0;
        }
    }
...
public partial class ModelImporter : AssetImporter
{
    ...
    {
        get {
            return INTERNAL_GetReferencedClips(this);
        }
    }
    ...
    public bool optimizeMesh
    {
        ...
        get {
            return meshOptimizationFlags != 0;
        }
        set
        {
            if (value)
    ...
    {
        get {
            return (ModelImporterTangentSpaceMode)importNormals;
        }
        set {
            importNormals = (ModelImporterNormals)value;
        }
    }
    ...
    {
        get {
            return (ModelImporterTangentSpaceMode)importTangents;
        }
        set {
            importTangents = (ModelImporterTangents)value;
        }
    }
    ...
    {
        get {
            return (ModelImporterMeshCompression)internal_meshCompression;
        }
        set {
            internal_meshCompression = (int)value;
        }
    }
    ...
    {
        get {
            return GetExtraExposedTransformPaths();
        }
        set {
            INTERNAL_set_extraExposedTransformPaths(this, value);
        }
    }
    ...
    {
        get {
            return GetExtraUserProperties();
        }
        set {
            INTERNAL_set_extraUserProperties(this, value);
        }
    }
    ...
    {
        get {
            return clipAnimations.Length != 0;
        }
        set {}
    }
    ...
    {
        get {
            return GetClipAnimations(this);
        }
        set {
            SetClipAnimations(this, value);
        }
    }
    ...
    {
        get {
            return GetDefaultClipAnimations(this);
        }
    }
