  ...
  public struct ObjectIdentifier : IEquatable<ObjectIdentifier> {
    ...
    public override string ToString() {
      return UnityString.Format(
          "{{ guid: {0}, fileID: {1}, type: {2}, path: {3}}}", m_GUID,
          m_LocalIdentifierInFile, m_FileType, m_FilePath);
    }
    ...
    public bool Equals(ObjectIdentifier other) { return this == other; }
    ...
    public static bool TryGetObjectIdentifier(UnityEngine.Object targetObject,
                                              out ObjectIdentifier objectId) {
      return GetObjectIdentifierFromObject(targetObject, out objectId);
    }

    public static bool TryGetObjectIdentifier(int instanceID,
                                              out ObjectIdentifier objectId) {
      return GetObjectIdentifierFromInstanceID(instanceID, out objectId);
    }

    internal static extern bool
    GetObjectIdentifierFromObject(UnityEngine.Object targetObject,
                                  out ObjectIdentifier objectId);

    internal static extern bool
    GetObjectIdentifierFromInstanceID(int instanceID,
                                      out ObjectIdentifier objectId);
  }
}
