...
namespace UnityEditor.Build.Content {
  ...
  public class BuildReferenceMap : ISerializable,
                                   IDisposable {
    private IntPtr m_Ptr;

    public BuildReferenceMap() { m_Ptr = Internal_Create(); }

    ~BuildReferenceMap() { Dispose(false); }
    ...
    public void AddMapping(string internalFileName, long serializationIndex,
                           ObjectIdentifier objectID, bool overwrite = false) {
      Internal_AddMapping(internalFileName, serializationIndex, objectID,
                          overwrite);
    }

    [NativeMethod("AddMapping")]
    private extern void
    Internal_AddMapping(string internalFileName, long serializationIndex,
                        ObjectIdentifier objectID, bool overwrite);

    public void AddMappings(string internalFileName,
    ...
    private extern void Internal_AddMappings(string internalFileName,
                                             SerializationInfo[] objectIDs,
                                             bool overwrite);
