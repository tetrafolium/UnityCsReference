...
namespace UnityEditor.StyleSheets {
  // Make sure style sheets importer after allowed dependent assets: textures,
  // fonts and json Has to be higher then AssetImportOrder.kImportOrderLate
  [ScriptedImporter(version : 10, ext
                    : "uss", importQueueOffset : 1100)]
  [ExcludeFromPreset]
...
#pragma warning restore 649
    ...
    private static readonly List<string> s_ValidationPathWhitelist =
        new List<string>(){"Packages/com.unity.shadergraph"};
