...
namespace UnityEditor.StyleSheets {
  internal class StyleSheetBuilder {
    public struct ComplexSelectorScope : System.IDisposable {
      ...
      public void Dispose() { m_Builder.EndComplexSelector(); }
    }

    enum BuilderState { Init, Rule, ComplexSelector, Property }
    ...
    List<StyleComplexSelector> m_ComplexSelectors =
        new List<StyleComplexSelector>();
    ...
    public void
    AddSimpleSelector(StyleSelectorPart[] parts,
    ...
    public StyleProperty BeginProperty(string name, int line = -1) {
      ...
      m_CurrentProperty = new StyleProperty{name = name, line = line};
    ...
    public void AddValue(StyleValueKeyword keyword) {
      ...
      m_CurrentValues.Add(
          new StyleValueHandle((int) keyword, StyleValueType.Keyword));
    }

    public void AddValue(StyleValueFunction function) {
      // for function we use the index to store the enum value
      m_CurrentValues.Add(
          new StyleValueHandle((int) function, StyleValueType.Function));
    }
