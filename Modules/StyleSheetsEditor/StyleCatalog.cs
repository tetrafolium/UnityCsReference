...
namespace UnityEditor.StyleSheets {
  ...
  internal static class StyleCatalogKeyword {
    ...
    public readonly static int backgroundAttachment =
        "background-attachment".GetHashCode();
    public readonly static int backgroundColor =
        "background-color".GetHashCode();
    public readonly static int backgroundImage =
        "background-image".GetHashCode();
    public readonly static int scaledBackgroundImage =
        "-unity-scaled-backgrounds".GetHashCode();
    public readonly static int backgroundPosition =
        "background-position".GetHashCode();
    public readonly static int backgroundPositionX =
        "background-position-x".GetHashCode();
    public readonly static int backgroundPositionY =
        "background-position-y".GetHashCode();

    public readonly static int contentImageOffsetX =
        "-unity-content-image-offset-x".GetHashCode();
    public readonly static int contentImageOffsetY =
        "-unity-content-image-offset-y".GetHashCode();

    public readonly static int backgroundRepeat =
        "background-repeat".GetHashCode();
    ...
    public readonly static int borderBottomColor =
        "border-bottom-color".GetHashCode();
    public readonly static int borderBottomStyle =
        "border-bottom-style".GetHashCode();
    public readonly static int borderBottomWidth =
        "border-bottom-width".GetHashCode();
    ...
    public readonly static int borderLeftColor =
        "border-left-color".GetHashCode();
    public readonly static int borderLeftStyle =
        "border-left-style".GetHashCode();
    public readonly static int borderLeftWidth =
        "border-left-width".GetHashCode();
    ...
    public readonly static int borderRightColor =
        "border-right-color".GetHashCode();
    public readonly static int borderRightStyle =
        "border-right-style".GetHashCode();
    public readonly static int borderRightWidth =
        "border-right-width".GetHashCode();
    ...
    public readonly static int borderTopColor =
        "border-top-color".GetHashCode();
    public readonly static int borderTopStyle =
        "border-top-style".GetHashCode();
    public readonly static int borderTopWidth =
        "border-top-width".GetHashCode();
    public readonly static int borderWidth = "border-width".GetHashCode();
    public readonly static int borderTopLeftRadius =
        "border-top-left-radius".GetHashCode();
    public readonly static int borderTopRightRadius =
        "border-top-right-radius".GetHashCode();
    public readonly static int borderBottomLeftRadius =
        "border-bottom-left-radius".GetHashCode();
    public readonly static int borderBottomRightRadius =
        "border-bottom-right-radius".GetHashCode();
    ...
    public readonly static int listStyleImage =
        "list-style-image".GetHashCode();
    public readonly static int listStylePosition =
        "list-style-position".GetHashCode();
    ...
    public readonly static int pageBreakAfter =
        "page-break-after".GetHashCode();
    public readonly static int pageBreakBefore =
        "page-break-before".GetHashCode();
    public readonly static int position = "position".GetHashCode();
    public readonly static int size = "size".GetHashCode();
    public readonly static int strokeDasharray =
        "stroke-dasharray".GetHashCode();
    public readonly static int strokeDashoffset =
        "stroke-dashoffset".GetHashCode();
    ...
    public readonly static int textDecorationColor =
        "text-decoration-color".GetHashCode();
  ...
  internal class SVC<T> {
    ...
    public SVC(int key, int property, T defaultValue = default(T),
               params StyleState[] states) {
      m_Key = key;
      m_Prop = property;
      m_States = states;
    ...
    public SVC(string name, string property, T defaultValue = default(T),
               params StyleState[] states)
        : this(name.GetHashCode(), property.GetHashCode(), defaultValue,
               states) {}
    public SVC(string name, int property, T defaultValue = default(T),
               params StyleState[] states)
        : this(name.GetHashCode(), property, defaultValue, states) {}
    public SVC(int name, string property, T defaultValue = default(T),
               params StyleState[] states)
        : this(name, property.GetHashCode(), defaultValue, states) {}

    public SVC(string name, int property, Func<T> lateInitHandler,
               params StyleState[] states)
        : this(name.GetHashCode(), property, default(T), states) {
      m_LateInitHandler = lateInitHandler;
    }

    // Root access, i.e. :root {...}
    public SVC(int property, T defaultValue = default(T))
        : this(StyleCatalogKeyword.root, property, defaultValue,
               StyleState.root) {}
    public SVC(string property, T defaultValue = default(T))
        : this(StyleCatalogKeyword.root, property.GetHashCode(), defaultValue,
               StyleState.root) {}
    ...
    private T ReadValue(T defaultValue) {
      ...
      Debug.LogWarning(
          $"Style constant value conversion of type {valueType} not supported.");
      return defaultValue;
    }
  }

  [DebuggerDisplay(
      "topleft = ({top}, {left}), bottomright = ({bottom}, {right}), size = ({width} x {height})")]
  [StructLayout(LayoutKind.Explicit)]
  internal struct StyleRect : IEquatable<StyleRect> {
    public static readonly StyleRect Nil =
        new StyleRect{left = float.NaN, right = float.NaN, top = float.NaN,
                      bottom = float.NaN};
    public static readonly StyleRect Zero =
        new StyleRect{left = 0f, right = 0f, top = 0f, bottom = 0f};

    public static StyleRect Size(float width, float height) {
      return new StyleRect{width = width, height = height, bottom = width,
                           left = height};
    }
    ...
    public bool incomplete =>
        top == float.MaxValue || right == float.MaxValue ||
        bottom == float.MaxValue || left == float.MaxValue;
    ...
    public bool Equals(StyleRect other) {
      return top.Equals(other.top) && right.Equals(other.right) &&
    ...
    public bool Equals(StyleFunction other) {
      ...
      foreach (var argList in args) {
        ...
        foreach (var arg in argList) {
          if (!arg.Equals(other.args [argListIndex]
                          [argIndex]))
            return false;
        }
  ...
  internal struct StyleValueGroup : IEquatable<StyleValueGroup> {
    ...
    public StyleValue GetValueAt(int i) {
      ...
      default:
        throw new ArgumentOutOfRangeException(
            nameof(i), $"Index must be between [0, {k_MaxValueCount - 1}]");
      }
    }
    ...
    public bool Equals(StyleValueGroup other) {
      return count == other.count && v1.Equals(other.v1) &&
  ...
  [DebuggerDisplay(
      "key = {key}, type = {type}, index = {index}, state = {state}")]
  internal struct StyleValue : IEquatable<StyleValue> {
    public static StyleValue Undefined(int key,
                                       StyleState state = StyleState.none) {
      return new StyleValue{key = key, state = state, type = Type.Undefined,
                            index = 0};
    }
    public static StyleValue Undefined(string name,
                                       StyleState state = StyleState.none) {
      return Undefined(name.GetHashCode(), state);
    }
    ...
    public bool IsValid() { return type != Type.Undefined && index != -1; }
  ...
  internal struct StyleFunctionCall {
    ...
    public StyleFunctionCall(StyleBlock block, int valueKey, string name,
                             List<StyleValue[]> args) {
      this.block = block;
    ...
    public Color GetColor(int argIndex, int valueIndex = -1) {
      if (valueIndex == -1 && args[argIndex].Length == 1)
        valueIndex = 0;
      return block.catalog.buffers.colors [args [argIndex]
                                           [valueIndex]
                                               .index]
      ;
    }
    ...
    public float GetNumber(int argIndex, int valueIndex = -1) {
      if (valueIndex == -1 && args[argIndex].Length == 1)
        valueIndex = 0;
      return block.catalog.buffers.numbers [args [argIndex]
                                            [valueIndex]
                                                .index]
      ;
    }
    ...
    public string GetString(int argIndex, int valueIndex = -1) {
      if (valueIndex == -1 && args[argIndex].Length == 1)
        valueIndex = 0;
      return block.catalog.buffers.strings [args [argIndex]
                                            [valueIndex]
                                                .index]
      ;
    }
  ...
  internal readonly struct StyleBlock {
    ...
    public StyleBlock(int name, StyleState[] states, StyleValue[] values,
    ...
    public bool IsValid() { return name != -1; }
    ...
    public StyleValue.Keyword
    GetKeyword(int key,
               StyleValue.Keyword defaultValue = StyleValue.Keyword.Invalid) {
    ...
    public StyleRect GetRect(int key,
                             StyleRect defaultValue = default(StyleRect)) {
    ...
    public StyleRect GetRect(string key,
                             StyleRect defaultValue = default(StyleRect)) {
    ...
    public T GetResource<T>(int key, T defaultValue = null) where T
        : UnityEngine.Object {
      ...
      var resource =
          EditorResources.Load<UnityEngine.Object>(resourceStr, false) as T;
      if (resource == null) {
    ...
    public T GetResource<T>(string key, T defaultValue = null) where T
        : UnityEngine.Object {
      return GetResource<T>(key.GetHashCode(), defaultValue);
    }

    static class TexturesByDPIScale {
      private static Dictionary<int, Dictionary<string, Texture2D>>
          s_TexturesByDPIScale =
              new Dictionary<int, Dictionary<string, Texture2D>>();
      ...
      public static Texture2D GetTextureByDPIScale(string resourcePath,
                                                   bool autoScale,
                                                   float systemScale) {
        Texture2D tex = null;
        ...
        if (autoScale && systemScale > 1f) {
          ...
          string dirName =
              Path.GetDirectoryName(resourcePath).Replace('\\', '/');
          ...
          for (int s = scale; scale > 1; --scale) {
            ...
            var scaledResource = StoreTextureByScale(scale, scaledResourcePath,
                                                     resourcePath, false);
      ...
      private static Texture2D StoreTextureByScale(int scale, string scaledPath,
                                                   string resourcePath,
                                                   bool logError) {
        ...
        if (tex) {
          ...
          s_TexturesByDPIScale [scale]
          [resourcePath] = tex;
        } else if (logError) {
          Debug.LogFormat(LogType.Warning, LogOption.NoStacktrace, null,
                          $"Failed to store {resourcePath} > {scaledPath}");
        }
        return tex;
      }

      private static bool TryGetTexture(int scale, string path,
                                        out Texture2D tex) {
        tex = null;
        if (s_TexturesByDPIScale.ContainsKey(scale) &&
            s_TexturesByDPIScale [scale]
                .TryGetValue(path, out tex) &&
            tex != null)
          return true;
        return false;
      }
    ...
    public Texture2D GetTexture(int key, bool autoScale = false) {
      ...
      return TexturesByDPIScale.GetTextureByDPIScale(resourcePath, autoScale,
    ...
    public Tuple<T1, T2> GetTuple<T1, T2>(int key) {
      return new Tuple<T1, T2>(GetTupleElementValue(key, 0, default(T1)),
                               GetTupleElementValue(key, 1, default(T2)));
    }

    public Tuple<T1, T2, T3> GetTuple<T1, T2, T3>(int key) {
      return new Tuple<T1, T2, T3>(GetTupleElementValue(key, 0, default(T1)),
                                   GetTupleElementValue(key, 1, default(T2)),
    ...
    public Tuple<T1, T2> GetTuple<T1, T2>(string key) {
      return GetTuple<T1, T2>(key.GetHashCode());
    }
    public Tuple<T1, T2, T3> GetTuple<T1, T2, T3>(string key) {
      return GetTuple<T1, T2, T3>(key.GetHashCode());
    }
    public Tuple<T1, T2, T3, T4> GetTuple<T1, T2, T3, T4>(string key) {
      return GetTuple<T1, T2, T3, T4>(key.GetHashCode());
    }
    public Tuple<T1, T2, T3, T4, T5> GetTuple<T1, T2, T3, T4, T5>(string key) {
      return GetTuple<T1, T2, T3, T4, T5>(key.GetHashCode());
    }

    private T GetTupleElementValue<T>(int key, int elementIndex,
                                      T defaultValue) {
      var groupIndex = GetValueIndex(key, StyleValue.Type.Group);
      if (groupIndex == -1)
        return defaultValue;
      return GetItemValue(elementIndex, defaultValue, groupIndex,
                          catalog.buffers.groups, catalog.buffers.strings,
                          catalog.buffers.numbers, catalog.buffers.colors,
                          catalog.buffers.rects);
    }

    public unsafe T GetStruct<T>(int key, T defaultValue = default(T)) where T
        : struct {
      var groupIndex = GetValueIndex(key, StyleValue.Type.Group);
      if (groupIndex == -1)
        return defaultValue;
      ...
      for (int i = 0; i < group.count; ++i) {
        ...
        default:
          throw new NotSupportedException(
              "group struct value type not supported");
        }
    ...
    internal static T GetItemValue<T>(int elementIndex, T defaultValue,
                                      int groupIndex,
                                      IList<StyleValueGroup> groups,
                                      IList<string> strings,
                                      IList<float> numbers, IList<Color> colors,
                                      IList<StyleRect> rects) {
      var sv = groups [groupIndex]
      [elementIndex];
      if (typeof(T) == typeof(string) &&sv.type == StyleValue.Type.Text)
        return (T)(object) strings[sv.index];
      if ((typeof(T) == typeof(float) || typeof(T) == typeof(double)) &&
          sv.type == StyleValue.Type.Number)
    ...
    public T Execute<T, C>(int key, Func<StyleFunctionCall, C, T> callback,
                           C c) {
      var index = GetValueIndex(key, StyleValue.Type.Function);
      if (index == -1)
        return default(T);
    ...
    internal static int GetValueIndex(int hash, IEnumerable<StyleValue> values,
                                      StyleValue.Type type,
                                      StyleState stateFlag) {
  ...
  internal class StyleCatalog {
    ...
    private static readonly StyleState[] k_RegularBlockStates = {
        StyleState.normal};
    private static readonly StyleBlock k_ElementNotFound =
        new StyleBlock(-1, k_NoState, k_NoValue, null);

    private StyleBlock[] m_Blocks;
    private readonly Dictionary<int, string> m_NameCollisionTable =
        new Dictionary<int, string>();

    internal StyleBuffers buffers {
      get;
      private set;
    }

    public StyleCatalog() { buffers = new StyleBuffers(); }
    ...
    private StyleValueGroup[] ReadValueGroupBuffer(BinaryReader reader) {
      ...
      for (int i = 0; i < length; ++i) {
        ...
        buffer[i] = new StyleValueGroup(0, valueCount){
            v1 = ReadValue(reader), v2 = ReadValue(reader),
            v3 = ReadValue(reader), v4 = ReadValue(reader),
            v5 = ReadValue(reader)};
      }
      return buffer;
    }
    ...
    private StyleFunction[] ReadFunctionBuffer(BinaryReader reader) {
      ...
      for (int i = 0; i < length; ++i) {
        ...
        buffer[i] = new StyleFunction{name = funcName, args = funcArgs};
      }
      return buffer;
    }
    ...
    private StyleValue ReadValue(BinaryReader reader) {
      StyleValue v = new StyleValue{
          key = reader.ReadInt32(), type = (StyleValue.Type) reader.ReadInt32(),
          index = reader.ReadInt32(), state = (StyleState) reader.ReadInt64()};
      return v;
    }
    ...
    public bool Load(BinaryReader reader) {
      ...
      // buffers
      buffers = new StyleBuffers{strings = ReadStringBuffer(reader),
    ...
    public int FindStyleIndex(int key) { return FindStyleIndex(key, m_Blocks); }
    ...
    public StyleBlock GetStyle(int selectorKey, params StyleState[] states) {
      ...
      if (location != -1) {
        ...
        return new StyleBlock(
            foundStyle.name, states.Length == 0 ? k_RegularBlockStates : states,
            foundStyle.values, foundStyle.catalog);
      }
    ...
    public StyleBlock GetComposedStyle(int selectorKey,
                                       params StyleState[] states) {
      return GetStyle(selectorKey,
                      states.Concat(new[]{StyleState.normal}).ToArray());
    }
    ...
    public void Load(IEnumerable<string> paths) {
      var sheets = paths
                       .Select(p => {
                         var x = EditorResources.Load<UnityEngine.Object>(
                             p, false) as StyleSheet;
    ...
    public void Load(IEnumerable<StyleSheet> sheets) {
      try {
        ...
        Debug.LogWarning(
            "Cannot load Style Catalog, StyleSheet resolving fails: " + ex);
      }
    }
    ...
    public void Load(StyleSheetResolver resolver) {
      ...
      m_NameCollisionTable.Clear();
      try {
        Compile(resolver, numbers, colors, strings, rects, groups, functions,
                blocks);
      } catch (Exception ex) {
      ...
      buffers = new StyleBuffers{
          strings = strings.ToArray(), numbers = numbers.ToArray(),
          colors = colors.ToArray(),   rects = rects.ToArray(),
          groups = groups.ToArray(),   functions = functions.ToArray()};
    ...
    private static StyleState GetSelectorStateFlags(StyleSelector ss) {
      ...
      for (int p = 0; p < ss.parts.Length; ++p) {
        ...
        if (part.type == StyleSelectorType.PseudoClass) {
          try {
            stateFlags |= (StyleState) Enum.Parse(
                typeof(StyleState), part.value.Replace("-", ""), true);
          } catch {
            // ignored
          }
        }
    ...
    private int GetNameKey(string name) {
      ...
      if (m_NameCollisionTable.ContainsKey(key) &&
          m_NameCollisionTable[key] != name)
        throw new ArgumentException(
            $"Style key name `{name}` collides with `{m_NameCollisionTable[key]}`. You should tweak either name.",
            nameof(name));
      m_NameCollisionTable[key] = name;
      return key;
    }
    ...
    private static StyleValue[] MergeValues(IEnumerable<StyleValue> values,
                                            IEnumerable<StyleValue> newValues) {
      var mergedBlockValues = new List<StyleValue>(values);
      return MergeListValues(mergedBlockValues, newValues).ToArray();
    }

    private static List<StyleValue>
    MergeListValues(List<StyleValue> mergedBlockValues,
                    IEnumerable<StyleValue> newValues) {
      foreach (var newValue in newValues) {
        ...
        for (int j = 0; j < mergedBlockValues.Count; ++j) {
          ...
          if (newValue.key == blockValue.key &&
              newValue.state == blockValue.state &&
    ...
    private void CompileRects(StyleBlock block, StyleValue[] values,
                              IList<StyleRect> rects) {
      ...
      foreach (var v in values) {
        ...
        var normalRectBufferIndex = StyleBlock.GetValueIndex(
            v.key, block.values, StyleValue.Type.Rect, StyleState.normal);
    ...
    private bool CompileElement(string name, IList<StyleBlock> blocks,
                                StyleValue[] values, IList<StyleRect> rects) {
      ...
      blocks[existingStyleIndex] =
          new StyleBlock(key, k_NoState, mergedBlockValues, this);
      return false;
    }
    ...
    private void Compile(StyleSheetResolver resolver, List<float> numbers,
                         List<Color> colors, List<string> strings,
                         List<StyleRect> rects, List<StyleValueGroup> groups,
                         List<StyleFunction> functions,
      ...
      foreach (var rule in resolver.Rules.Values) {
        ...
        if (rule.Selector.selectors.Length != 1 ||
            rule.Selector.selectors[0].parts.Length == 0)
          continue;
        ...
        foreach (var property in rule.Properties.Values) {
          var newValue = CompileValue(property, stateFlags, numbers, colors,
                                      strings, rects, groups, functions);
          if (newValue.IsValid())
            values.Add(newValue);
        }
    ...
    private List<StyleValue>
    ExpandValues(List<StyleValue> values, List<float> numbers,
                 List<Color> colors, List<string> strings,
                 List<StyleRect> rects, List<StyleValueGroup> groups) {
      var states = values.Select(v => v.state).Distinct().ToArray();

      // Rects
      values = ExpandRect(states, values, numbers, rects,
                          StyleCatalogKeyword.position, StyleCatalogKeyword.top,
                          StyleCatalogKeyword.right, StyleCatalogKeyword.bottom,
                          StyleCatalogKeyword.left);
      values = ExpandRect(
          states, values, numbers, rects, StyleCatalogKeyword.margin,
          StyleCatalogKeyword.marginTop, StyleCatalogKeyword.marginRight,
          StyleCatalogKeyword.marginBottom, StyleCatalogKeyword.marginLeft);
      values = ExpandRect(
          states, values, numbers, rects, StyleCatalogKeyword.padding,
          StyleCatalogKeyword.paddingTop, StyleCatalogKeyword.paddingRight,
          StyleCatalogKeyword.paddingBottom, StyleCatalogKeyword.paddingLeft);
      values = ExpandRect(states, values, numbers, rects,
                          "-unity-overflow".GetHashCode(),
                          "-unity-overflow-top".GetHashCode(),
                          "-unity-overflow-right".GetHashCode(),
                          "-unity-overflow-bottom".GetHashCode(),
                          "-unity-overflow-left".GetHashCode());
      values = ExpandRect(
          states, values, numbers, rects, "-unity-slice".GetHashCode(),
          "-unity-slice-top".GetHashCode(), "-unity-slice-right".GetHashCode(),
          "-unity-slice-bottom".GetHashCode(),
          "-unity-slice-left".GetHashCode());

      // Lines
      values = ExpandLine(
          states, values, numbers, colors, strings, rects, groups,
          StyleCatalogKeyword.border, StyleCatalogKeyword.borderWidth,
          StyleCatalogKeyword.borderStyle, StyleCatalogKeyword.borderColor);

      // Extended styles
      values = ExpandRect(states, values, numbers, rects,
                          StyleCatalogKeyword.borderWidth,
                          StyleCatalogKeyword.borderTopWidth,
                          StyleCatalogKeyword.borderRightWidth,
                          StyleCatalogKeyword.borderBottomWidth,
                          StyleCatalogKeyword.borderLeftWidth);
      values = ExpandRect(states, values, numbers, rects,
                          StyleCatalogKeyword.borderRadius,
                          StyleCatalogKeyword.borderTopLeftRadius,
                          StyleCatalogKeyword.borderTopRightRadius,
                          StyleCatalogKeyword.borderBottomRightRadius,
                          StyleCatalogKeyword.borderBottomLeftRadius);

      return values;
    }

    private List<StyleValue>
    ExpandLine(StyleState[] states, List<StyleValue> values,
               List<float> numbers, List<Color> colors, List<string> strings,
               List<StyleRect> rects, List<StyleValueGroup> groups,
               int borderKey, int borderWidthKey, int borderStyleKey,
               int borderColorKey) {
      if (!ExpandHasMembers(values, borderKey, borderWidthKey, borderStyleKey,
                            borderColorKey))
        return values;

      // using (new
      // Profiling.EditorPerformanceTracker("BuildCatalog.ExpandLine"))
      for (int stateIndex = 0; stateIndex < states.Length; ++stateIndex) {
        ...
        for (int i = 0; i < values.Count; ++i) {
          ...
          if (value.key == borderKey && value.type == StyleValue.Type.Group) {
            var width = StyleBlock.GetItemValue(
                0, 0f, value.index, groups, strings, numbers, colors, rects);
            var style =
                StyleBlock.GetItemValue(1, "solid", value.index, groups,
                                        strings, numbers, colors, rects);
            var color =
                StyleBlock.GetItemValue(2, Color.red, value.index, groups,
                                        strings, numbers, colors, rects);
            line = new StyleLine(width, style, color);
          } else if (value.key == borderWidthKey &&
                     value.type == StyleValue.Type.Number)
            line.width = numbers[value.index];
          else if (value.key == borderStyleKey &&
                   value.type == StyleValue.Type.Text)
            line.style = strings[value.index];
          else if (value.key == borderColorKey &&
                   value.type == StyleValue.Type.Color)
            line.color = colors[value.index];
          else {
            // No match
            continue;
          }
        ...
        StyleValueGroup vg = new StyleValueGroup(borderKey, 3){
            v1 = new StyleValue{key = borderWidthKey, state = currentState,
                                type = StyleValue.Type.Number,
                                index = SetIndex(numbers, line.width)},
            v2 = new StyleValue{key = borderStyleKey, state = currentState,
                                type = StyleValue.Type.Text,
                                index = SetIndex(strings, line.style)},
            v3 = new StyleValue{key = borderColorKey, state = currentState,
                                type = StyleValue.Type.Color,
                                index = SetIndex(colors, line.color)}};

        lineValues.Add(new StyleValue{key = borderKey, state = currentState,
    ...
    private List<StyleValue>
    ExpandRect(StyleState[] states, List<StyleValue> values,
               List<float> numbers, List<StyleRect> rects, int rectKey,
               int topKey, int rightKey, int bottomKey, int leftKey) {
      if (!ExpandHasMembers(values, rectKey, topKey, rightKey, bottomKey,
                            leftKey))
        return values;
      ...
      for (int stateIndex = 0; stateIndex < states.Length; ++stateIndex) {
        ...
        var currentState = states[stateIndex];
        var rect =
            new StyleRect{top = float.MaxValue, right = float.MaxValue,
                          bottom = float.MaxValue, left = float.MaxValue};
        for (int i = 0; i < values.Count; ++i) {
          var value = values[i];
          ...
          if (value.key == rectKey && value.type == StyleValue.Type.Rect)
            rect = rects[value.index];
          else if (value.key == rectKey &&
                   value.type == StyleValue.Type.Number) {
            var defaultValue = numbers[value.index];
            if (rect.top == float.MaxValue)
              rect.top = defaultValue;
            if (rect.right == float.MaxValue)
              rect.right = defaultValue;
            if (rect.bottom == float.MaxValue)
              rect.bottom = defaultValue;
            if (rect.left == float.MaxValue)
              rect.left = defaultValue;
          } else if (value.key == topKey &&
                     value.type == StyleValue.Type.Number)
            rect.top = numbers[value.index];
          else if (value.key == rightKey &&
                   value.type == StyleValue.Type.Number)
            rect.right = numbers[value.index];
          else if (value.key == bottomKey &&
                   value.type == StyleValue.Type.Number)
            rect.bottom = numbers[value.index];
          else if (value.key == leftKey && value.type == StyleValue.Type.Number)
            rect.left = numbers[value.index];
          else {
            // No match
            continue;
          }
        ...
        if (rect.left != float.MaxValue || rect.right != float.MaxValue ||
            rect.top != float.MaxValue || rect.bottom != float.MaxValue)
          rectValues.Add(new StyleValue{key = rectKey, state = currentState,
                                        type = StyleValue.Type.Rect,
                                        index = SetIndex(rects, rect)});

        if (rect.top != float.MaxValue)
          rectValues.Add(new StyleValue{key = topKey, state = currentState,
                                        type = StyleValue.Type.Number,
                                        index = SetIndex(numbers, rect.top)});

        if (rect.right != float.MaxValue)
          rectValues.Add(new StyleValue{key = rightKey, state = currentState,
                                        type = StyleValue.Type.Number,
                                        index = SetIndex(numbers, rect.right)});

        if (rect.bottom != float.MaxValue)
          rectValues.Add(
              new StyleValue{key = bottomKey, state = currentState,
                             type = StyleValue.Type.Number,
                             index = SetIndex(numbers, rect.bottom)});

        if (rect.left != float.MaxValue)
          rectValues.Add(new StyleValue{key = leftKey, state = currentState,
                                        type = StyleValue.Type.Number,
                                        index = SetIndex(numbers, rect.left)});
    ...
    private static bool ExpandHasMembers(List<StyleValue> values, int k1,
    ...
    private StyleValue CompileValue(StyleSheetResolver.Property property,
                                    StyleState stateFlags, List<float> numbers,
                                    List<Color> colors, List<string> strings,
                                    List<StyleRect> rects,
      ...
      if (values.Count == 1) {
        if (values[0].ValueType == StyleValueType.Function)
          return CompileFunction(property.Name, values[0], stateFlags, numbers,
                                 colors, strings, functions);

        return CompileBaseValue(property.Name, stateFlags, values[0], numbers,
                                colors, strings);
      }
      ...
      if (values.Count == 2 &&
          ...
          values [1]
              .IsFloat())
        return CompileRect(property.Name, values, stateFlags, rects, 0, 1, 0,
                           1);
      ...
      if (values.Count == 3 &&
          ...
          values [2]
              .IsFloat())
        return CompileRect(property.Name, values, stateFlags, rects, 0, 1, 2,
                           1);
      ...
      if (values.Count >= 2 && values.Count <= 5)
        return CompileValueGroup(property.Name, values, stateFlags, groups,
                                 numbers, colors, strings);

      // Value form not supported, lets report it and keep a undefined value to
      // the property.
      Debug.LogWarning(
          $"Failed to compile style block property {property.Name} " +
          $"with {values.Count} values");
      return StyleValue.Undefined(GetNameKey(property.Name), stateFlags);
    }

    private StyleValue CompileFunction(string propertyName,
                                       StyleSheetResolver.Value value,
                                       StyleState stateFlags,
                                       List<float> numbers, List<Color> colors,
                                       List<string> strings,
                                       List<StyleFunction> functions) {
      ...
      foreach (var argList in func.args) {
        ...
        foreach (var arg in argList) {
          argValues [argIndex]
          = CompileBaseValue(argIndex.ToString(), stateFlags, arg, numbers,
                             colors, strings);
          argIndex++;
        }
      ...
      return new StyleValue{
          key = GetNameKey(propertyName), state = stateFlags,
          type = StyleValue.Type.Function,
          index = SetIndex(
              functions, new StyleFunction{name = funcName, args = funcArgs})};
    }

    private StyleValue
    CompileRect(string propertyName, List<StyleSheetResolver.Value> values,
                StyleState stateFlags, IList<StyleRect> rects, int topIndex,
                int rightIndex, int bottomIndex, int leftIndex) {
      return new StyleValue{
          key = GetNameKey(propertyName), state = stateFlags,
          type = StyleValue.Type.Rect,
          index = SetIndex(rects, new StyleRect{top = values [topIndex]
                                                          .AsFloat(),
                                                right = values [rightIndex]
                                                            .AsFloat(),
                                                bottom = values [bottomIndex]
                                                             .AsFloat(),
                                                left = values [leftIndex]
                                                           .AsFloat()})};
    }

    private StyleValue CompileValueGroup(
        string propertyName, List<StyleSheetResolver.Value> values,
        StyleState stateFlags, List<StyleValueGroup> groups,
        List<float> numbers, List<Color> colors, List<string> strings) {
      int propertyKey = GetNameKey(propertyName);
      StyleValueGroup vg = new StyleValueGroup(propertyKey, values.Count);
      for (int i = 0; i < values.Count; ++i)
        vg [i]
        = CompileBaseValue(propertyName, stateFlags, values[i], numbers, colors,
                           strings);

      return new StyleValue{key = propertyKey, state = stateFlags,
                            type = StyleValue.Type.Group,
                            index = SetIndex(groups, vg)};
    }

    private StyleValue CompileBaseValue(string propertyName,
                                        StyleState stateFlags,
                                        StyleSheetResolver.Value value,
                                        List<float> numbers, List<Color> colors,
                                        List<string> strings) {
      return new StyleValue{key = GetNameKey(propertyName), state = stateFlags,
                            type = ReduceStyleValueType(value),
                            index =
                                MergeValue(value, numbers, colors, strings)};
    }

    private static StyleValue.Type
    ReduceStyleValueType(StyleSheetResolver.Value value) {
    ...
    private static int MergeValue(StyleSheetResolver.Value value,
      ...
      case StyleValueType.AssetReference:
        return SetIndex(strings,
                        AssetDatabase.GetAssetPath(value.AsAssetReference()));
      case StyleValueType.ScalableImage:
        return SetIndex(strings, AssetDatabase.GetAssetPath(
                                     value.AsScalableImage().normalImage));
      case StyleValueType.String:
...
#region ComparisonUtilities
      ...
      foreach (var catBlock in catalog.m_Blocks) {
        ...
        if (!block.states.Equals(catBlock.states)) {
          ...
          for (var i = 0; i < block.values.Length; ++i) {
            ...
            if (value2Index == -1) {
              sb.AppendLine(
                  $"Property {GetKeyName(value1.key)} not found in block {blockName}");
              continue;
            }
            ...
            if (value1.type != value2.type) {
              sb.AppendLine(
                  $"Property: {GetKeyName(value1.key)} has different type in block {blockName}");
            } else if (!CompareValue(block, value1, catBlock, value2)) {
              sb.AppendLine(
                  $"Property: {GetKeyName(value1.key)} has different value in block {blockName}");
            }
          }
        }
      }
    ...
    internal bool CompareBlocks(StyleCatalog catalog, string title,
                                StringBuilder sb) {
      var sameStyles = true;
    ...
    internal static bool CompareValue(StyleBlock b1, StyleValue value1,
                                      StyleBlock b2, StyleValue value2) {
      switch (value1.type) {
      case StyleValue.Type.Color: {
