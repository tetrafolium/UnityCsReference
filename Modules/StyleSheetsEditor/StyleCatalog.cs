...
{
    public static StyleValue Undefined(int key, StyleState state = StyleState.none) {
        return new StyleValue { key = key, state = state, type = Type.Undefined, index = 0 };
    }
    public static StyleValue Undefined(string name, StyleState state = StyleState.none) {
