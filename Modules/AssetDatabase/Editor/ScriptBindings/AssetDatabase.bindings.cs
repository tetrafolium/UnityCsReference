...
public partial class AssetDatabase
{
    ...
    [uei.ExcludeFromDocs] public static void ImportAsset(string path) {
    ...
    [uei.ExcludeFromDocs] public static void Refresh() {
    ...
    [uei.ExcludeFromDocs] public static bool OpenAsset(int instanceID) {
    ...
    [System.Obsolete("Method GetAssetBundleNames has been deprecated. Use GetAllAssetBundleNames instead.")] public string[] GetAssetBundleNames() {
    ...
    [uei.ExcludeFromDocs] public static void ExportPackage(string[] assetPathNames, string fileName) {
