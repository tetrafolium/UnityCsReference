...
namespace UnityEngine.XR {
  ...
  public struct HapticCapabilities : IEquatable<HapticCapabilities> {
    ...
    public uint numChannels {
      ...
      internal set { m_NumChannels = value; }
    }
    public bool supportsImpulse {
      get { return m_SupportsImpulse; }
      internal set { m_SupportsImpulse = value; }
    }
    public bool supportsBuffer {
      get { return m_SupportsBuffer; }
      internal set { m_SupportsBuffer = value; }
    }
    public uint bufferFrequencyHz {
      get { return m_BufferFrequencyHz; }
      internal set { m_BufferFrequencyHz = value; }
    }
    public uint bufferMaxSize {
      get { return m_BufferMaxSize; }
      internal set { m_BufferMaxSize = value; }
    }
    public uint bufferOptimalSize {
      get { return m_BufferOptimalSize; }
      internal set { m_BufferOptimalSize = value; }
    }
    ...
    public override int GetHashCode() {
      return numChannels.GetHashCode() ^ (supportsImpulse.GetHashCode() << 1) ^
  ...
  public enum InputTrackingState : UInt32 {
    ...
    All = (1 << 6) - 1 // Keep this as the last entry, if you add an entry, bump
                       // this shift up by 1 as well
  }
      ...
      get {
        ...
        default:
          throw new InvalidCastException(
              "No valid managed type for unknown native type.");
        }
      }
    }
    ...
    public InputFeatureUsage<T> As<T>() {
      if (type != typeof(T))
        throw new ArgumentException(
            "InputFeatureUsage type does not match out variable type.");
  ...
  public struct InputFeatureUsage<T> : IEquatable<InputFeatureUsage<T>> {
    ...
    public static bool operator ==(InputFeatureUsage<T> a,
                                   InputFeatureUsage<T> b) {
      return a.Equals(b);
    }
    ...
    operator InputFeatureUsage(InputFeatureUsage<T> self) {
      InputFeatureType featureType =
  ...
  public static class CommonUsages {
    ...
    public static InputFeatureUsage<Vector2> primary2DAxis =
        new InputFeatureUsage<Vector2>("Primary2DAxis");
    public static InputFeatureUsage<Vector2> secondary2DAxis =
        new InputFeatureUsage<Vector2>("Secondary2DAxis");

    public static InputFeatureUsage<Vector3> devicePosition =
        new InputFeatureUsage<Vector3>("DevicePosition");
    public static InputFeatureUsage<Vector3> leftEyePosition =
        new InputFeatureUsage<Vector3>("LeftEyePosition");
    public static InputFeatureUsage<Vector3> rightEyePosition =
        new InputFeatureUsage<Vector3>("RightEyePosition");
    ...
    public static InputFeatureUsage<Vector3> colorCameraPosition =
        new InputFeatureUsage<Vector3>("CameraPosition");
    public static InputFeatureUsage<Vector3> deviceVelocity =
        new InputFeatureUsage<Vector3>("DeviceVelocity");
    public static InputFeatureUsage<Vector3> deviceAngularVelocity =
        new InputFeatureUsage<Vector3>("DeviceAngularVelocity");
    public static InputFeatureUsage<Vector3> leftEyeVelocity =
        new InputFeatureUsage<Vector3>("LeftEyeVelocity");
    ...
    public static InputFeatureUsage<Vector3> rightEyeVelocity =
        new InputFeatureUsage<Vector3>("RightEyeVelocity");
    public static InputFeatureUsage<Vector3> rightEyeAngularVelocity =
        new InputFeatureUsage<Vector3>("RightEyeAngularVelocity");
    ...
    public static InputFeatureUsage<Vector3> centerEyeAngularVelocity =
        new InputFeatureUsage<Vector3>("CenterEyeAngularVelocity");
    public static InputFeatureUsage<Vector3> colorCameraVelocity =
        new InputFeatureUsage<Vector3>("CameraVelocity");
    public static InputFeatureUsage<Vector3> colorCameraAngularVelocity =
        new InputFeatureUsage<Vector3>("CameraAngularVelocity");
    public static InputFeatureUsage<Vector3> deviceAcceleration =
        new InputFeatureUsage<Vector3>("DeviceAcceleration");
    ...
    public static InputFeatureUsage<Eyes> eyesData =
        new InputFeatureUsage<Eyes>("EyesData");

    [Obsolete(
        "CommonUsages.dPad is not used by any XR platform and will be removed.")]
    public static InputFeatureUsage<Vector2> dPad =
        new InputFeatureUsage<Vector2>("DPad");
    [Obsolete(
        "CommonUsages.indexFinger is not used by any XR platform and will be removed.")]
    public static InputFeatureUsage<float> indexFinger =
        new InputFeatureUsage<float>("IndexFinger");
    [Obsolete(
        "CommonUsages.MiddleFinger is not used by any XR platform and will be removed.")]
    public static InputFeatureUsage<float> middleFinger =
        new InputFeatureUsage<float>("MiddleFinger");
    [Obsolete(
        "CommonUsages.RingFinger is not used by any XR platform and will be removed.")]
    public static InputFeatureUsage<float> ringFinger =
        new InputFeatureUsage<float>("RingFinger");
    [Obsolete(
        "CommonUsages.PinkyFinger is not used by any XR platform and will be removed.")]
    public static InputFeatureUsage<float> pinkyFinger =
        new InputFeatureUsage<float>("PinkyFinger");

    // These should go to Oculus SDK
    [Obsolete(
        "CommonUsages.thumbrest is Oculus only, and is being moved to their package. Please use OculusUsages.thumbrest. These will still function until removed.")]
    public static InputFeatureUsage<bool> thumbrest =
        new InputFeatureUsage<bool>("Thumbrest");
    [Obsolete(
        "CommonUsages.indexTouch is Oculus only, and is being moved to their package.  Please use OculusUsages.indexTouch. These will still function until removed.")]
    public static InputFeatureUsage<float> indexTouch =
        new InputFeatureUsage<float>("IndexTouch");
    [Obsolete(
        "CommonUsages.thumbTouch is Oculus only, and is being moved to their package.  Please use OculusUsages.thumbTouch. These will still function until removed.")]
  ...
  public struct InputDevice : IEquatable<InputDevice> {
    ...
    // Use this to compare deviceIds.  It will take care of the default
    // uninitialized case.
    private UInt64 deviceId {
      get { return m_Initialized ? m_DeviceId : UInt64.MaxValue; }
    }
    ...
    public XRInputSubsystem subsystem {
      get {
        ...
        if (m_Initialized) {
          /// The DeviceId is cut in two, with the hiword being the subsystem
          /// identifier, and the loword being for the specific device.
          ...
          for (int i = 0; i < s_InputSubsystemCache.Count; i++) {
            if (pluginIndex == s_InputSubsystemCache [i]
                                   .GetIndex())
    ...
    public bool isValid {
      get { return IsValidId() && InputDevices.IsDeviceValid(m_DeviceId); }
    }
    public string name {
      get {
        return IsValidId() ? InputDevices.GetDeviceName(m_DeviceId) : null;
      }
    }
    [Obsolete(
        "This API has been marked as deprecated and will be removed in future versions. Please use InputDevice.characteristics instead.")]
    public InputDeviceRole role {
      get {
        return IsValidId() ? InputDevices.GetDeviceRole(m_DeviceId)
                           : InputDeviceRole.Unknown;
      }
    }
    public string manufacturer {
      get {
        return IsValidId() ? InputDevices.GetDeviceManufacturer(m_DeviceId)
                           : null;
      }
    }
    public string serialNumber {
      get {
        return IsValidId() ? InputDevices.GetDeviceSerialNumber(m_DeviceId)
                           : null;
      }
    }
    public InputDeviceCharacteristics characteristics {
      get {
        return IsValidId() ? InputDevices.GetDeviceCharacteristics(m_DeviceId)
    ...
    // Haptics
    public bool SendHapticImpulse(uint channel, float amplitude,
                                  float duration = 1.0f) {
      if (!IsValidId())
        return false;
      ...
      if (amplitude < 0.0f)
        throw new ArgumentException(
            "Amplitude of SendHapticImpulse cannot be negative.");
      if (duration < 0.0f)
        throw new ArgumentException(
            "Duration of SendHapticImpulse cannot be negative.");
      return InputDevices.SendHapticImpulse(m_DeviceId, channel, amplitude,
                                            duration);
    }
    ...
    public bool TryGetHapticCapabilities(out HapticCapabilities capabilities) {
      if (CheckValidAndSetDefault(out capabilities))
        return InputDevices.TryGetHapticCapabilities(m_DeviceId,
                                                     out capabilities);
      return false;
    }
    ...
    // Features by Usage
    public bool TryGetFeatureValue(InputFeatureUsage<bool> usage,
                                   out bool value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_bool(m_DeviceId, usage.name,
                                                    out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<uint> usage,
                                   out uint value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_UInt32(m_DeviceId, usage.name,
                                                      out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<float> usage,
                                   out float value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_float(m_DeviceId, usage.name,
                                                     out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Vector2> usage,
                                   out Vector2 value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_Vector2f(m_DeviceId, usage.name,
                                                        out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Vector3> usage,
                                   out Vector3 value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_Vector3f(m_DeviceId, usage.name,
                                                        out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Quaternion> usage,
                                   out Quaternion value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_Quaternionf(
            m_DeviceId, usage.name, out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Hand> usage,
                                   out Hand value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_XRHand(m_DeviceId, usage.name,
                                                      out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Bone> usage,
                                   out Bone value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_XRBone(m_DeviceId, usage.name,
                                                      out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<Eyes> usage,
                                   out Eyes value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValue_XREyes(m_DeviceId, usage.name,
                                                      out value);
      return false;
    }

    public bool TryGetFeatureValue(InputFeatureUsage<byte[]> usage,
                                   byte[] value) {
      if (IsValidId())
        return InputDevices.TryGetFeatureValue_Custom(m_DeviceId, usage.name,
                                                      value);
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<InputTrackingState> usage,
      ...
      if (IsValidId()) {
        uint intValue = 0;
        if (InputDevices.TryGetFeatureValue_UInt32(m_DeviceId, usage.name,
                                                   out intValue)) {
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<bool> usage, DateTime time,
                                   out bool value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_bool(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<uint> usage, DateTime time,
                                   out uint value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_UInt32(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<float> usage,
                                   DateTime time, out float value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_float(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<Vector2> usage,
                                   DateTime time, out Vector2 value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_Vector2f(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<Vector3> usage,
                                   DateTime time, out Vector3 value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_Vector3f(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<Quaternion> usage,
                                   DateTime time, out Quaternion value) {
      if (CheckValidAndSetDefault(out value))
        return InputDevices.TryGetFeatureValueAtTime_Quaternionf(
            m_DeviceId, usage.name,
            TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time), out value);
      return false;
    }
    ...
    public bool TryGetFeatureValue(InputFeatureUsage<InputTrackingState> usage,
      ...
      if (IsValidId()) {
        uint intValue = 0;
        if (InputDevices.TryGetFeatureValueAtTime_UInt32(
                m_DeviceId, usage.name,
                TimeConverter.LocalDateTimeToUnixTimeMilliseconds(time),
                out intValue)) {
          value = (InputTrackingState) intValue;
          return true;
        }
    ...
    public bool Equals(InputDevice other) { return deviceId == other.deviceId; }

    public override int GetHashCode() { return deviceId.GetHashCode(); }
  ...
  internal static class TimeConverter {
    static readonly DateTime s_Epoch =
    ...
    public static long LocalDateTimeToUnixTimeMilliseconds(DateTime date) {
      return Convert.ToInt64(
          (date.ToUniversalTime() - s_Epoch).TotalMilliseconds);
    }

    public static DateTime
    UnixTimeMillisecondsToLocalDateTime(long unixTimeInMilliseconds) {
  ...
  public struct Hand : IEquatable<Hand> {
    ...
    Hand_TryGetFingerBonesAsList(Hand hand, HandFinger finger,
                                 [ NotNull ] List<Bone> bonesOut);
    ...
    public static bool operator ==(Hand a, Hand b) { return a.Equals(b); }

    public static bool operator !=(Hand a, Hand b) { return !(a == b); }
  }

  internal enum EyeSide { Left, Right }
  ...
  public struct Eyes : IEquatable<Eyes> {
    ...
    private static extern bool
    Eyes_TryGetEyePosition(Eyes eyes, EyeSide chirality, out Vector3 position);
    private static extern bool Eyes_TryGetEyeRotation(Eyes eyes,
                                                      EyeSide chirality,
    ...
    private static extern bool
    Eyes_TryGetFixationPoint(Eyes eyes, out Vector3 fixationPoint);
    ...
    private static extern bool Eyes_TryGetEyeOpenAmount(Eyes eyes,
                                                        EyeSide chirality,
                                                        out float openAmount);
    ...
    public static bool operator ==(Eyes a, Eyes b) { return a.Equals(b); }

    public static bool operator !=(Eyes a, Eyes b) { return !(a == b); }
  }
  ...
  public struct Bone : IEquatable<Bone> {
    ...
    private static extern bool Bone_TryGetPosition(Bone bone,
                                                   out Vector3 position);

    public bool TryGetRotation(out Quaternion rotation) {
      return Bone_TryGetRotation(this, out rotation);
    }
    private static extern bool Bone_TryGetRotation(Bone bone,
                                                   out Quaternion rotation);

    public bool TryGetParentBone(out Bone parentBone) {
      return Bone_TryGetParentBone(this, out parentBone);
    }
    private static extern bool Bone_TryGetParentBone(Bone bone,
                                                     out Bone parentBone);
    ...
    private static extern bool
    Bone_TryGetChildBones(Bone bone, [ NotNull ] List<Bone> childBones);
    ...
    public static bool operator ==(Bone a, Bone b) { return a.Equals(b); }

    public static bool operator !=(Bone a, Bone b) { return !(a == b); }
  }
  ...
  public partial class InputDevices {
    ...
    public static void GetDevicesAtXRNode(XRNode node,
    ...
    /// Used to avoid creating garbage when getting all devices from native.  Do
    /// not use without first calling GetDevices_Internal in order to keep it up
    /// to date.
    static List<InputDevice> s_InputDeviceList;
    public static void GetDevicesWithCharacteristics(
      ...
      inputDevices.Clear();
      foreach (var device in s_InputDeviceList)
        if ((device.characteristics & desiredCharacteristics) ==
    ...
    [RequiredByNativeCode]
    private static void InvokeConnectionEvent(UInt64 deviceId,
    ...
    GetDevices_Internal([ NotNull ] List<InputDevice> inputDevices);

    internal static extern bool SendHapticImpulse(UInt64 deviceId, uint channel,
                                                  float amplitude,
                                                  float duration);
    internal static extern bool SendHapticBuffer(UInt64 deviceId, uint channel,
                                                 [ NotNull ] byte[] buffer);
    internal static extern bool
    TryGetHapticCapabilities(UInt64 deviceId,
                             out HapticCapabilities capabilities);
    internal static extern void StopHaptics(UInt64 deviceId);

    internal static extern bool
    TryGetFeatureUsages(UInt64 deviceId,
                        [ NotNull ] List<InputFeatureUsage> featureUsages);

    internal static extern bool
    TryGetFeatureValue_bool(UInt64 deviceId, string usage, out bool value);
    internal static extern bool
    TryGetFeatureValue_UInt32(UInt64 deviceId, string usage, out uint value);
    internal static extern bool
    TryGetFeatureValue_float(UInt64 deviceId, string usage, out float value);
    internal static extern bool TryGetFeatureValue_Vector2f(UInt64 deviceId,
                                                            string usage,
                                                            out Vector2 value);
    internal static extern bool TryGetFeatureValue_Vector3f(UInt64 deviceId,
                                                            string usage,
                                                            out Vector3 value);
    internal static extern bool
    TryGetFeatureValue_Quaternionf(UInt64 deviceId, string usage,
                                   out Quaternion value);
    internal static extern bool TryGetFeatureValue_Custom(UInt64 deviceId,
                                                          string usage,
                                                          [ Out ] byte[] value);

    internal static extern bool TryGetFeatureValueAtTime_bool(UInt64 deviceId,
                                                              string usage,
                                                              Int64 time,
                                                              out bool value);
    internal static extern bool TryGetFeatureValueAtTime_UInt32(UInt64 deviceId,
                                                                string usage,
                                                                Int64 time,
                                                                out uint value);
    internal static extern bool TryGetFeatureValueAtTime_float(UInt64 deviceId,
                                                               string usage,
                                                               Int64 time,
                                                               out float value);
    internal static extern bool
    TryGetFeatureValueAtTime_Vector2f(UInt64 deviceId, string usage, Int64 time,
                                      out Vector2 value);
    internal static extern bool
    TryGetFeatureValueAtTime_Vector3f(UInt64 deviceId, string usage, Int64 time,
                                      out Vector3 value);
    internal static extern bool
    TryGetFeatureValueAtTime_Quaternionf(UInt64 deviceId, string usage,
                                         Int64 time, out Quaternion value);

    internal static extern bool
    TryGetFeatureValue_XRHand(UInt64 deviceId, string usage, out Hand value);
    internal static extern bool
    TryGetFeatureValue_XRBone(UInt64 deviceId, string usage, out Bone value);
    internal static extern bool
    TryGetFeatureValue_XREyes(UInt64 deviceId, string usage, out Eyes value);
    ...
    internal static extern InputDeviceCharacteristics
    GetDeviceCharacteristics(UInt64 deviceId);
    ...
    internal static InputDeviceRole GetDeviceRole(UInt64 deviceId) {
      ...
      const InputDeviceCharacteristics genericCharacteristics =
          InputDeviceCharacteristics.HeadMounted |
          InputDeviceCharacteristics.TrackedDevice;
      const InputDeviceCharacteristics leftHandedCharacteristics =
          InputDeviceCharacteristics.Left |
          InputDeviceCharacteristics.HeldInHand |
          InputDeviceCharacteristics.TrackedDevice;
      const InputDeviceCharacteristics rightHandedCharacteristics =
          InputDeviceCharacteristics.Right |
          InputDeviceCharacteristics.HeldInHand |
          InputDeviceCharacteristics.TrackedDevice;
      const InputDeviceCharacteristics trackingReferenceCharacteristics =
      ...
      else if ((flags & rightHandedCharacteristics) ==
               rightHandedCharacteristics)
        return InputDeviceRole.RightHanded;
      else if ((flags & InputDeviceCharacteristics.Controller) ==
               InputDeviceCharacteristics.Controller)
        return InputDeviceRole.GameController;
      else if ((flags & trackingReferenceCharacteristics) ==
               trackingReferenceCharacteristics)
        return InputDeviceRole.TrackingReference;
      else if ((flags & InputDeviceCharacteristics.TrackedDevice) ==
               InputDeviceCharacteristics.TrackedDevice)
  ...
  public partial class InputTracking {
    ...
    [Obsolete(
        "This API has been marked as obsolete in code, and is no longer in use. Please use InputTracking.GetNodeStates and look for the XRNodeState with the corresponding XRNode type instead.")] extern public static Vector3
    GetLocalPosition(XRNode node);

    [NativeConditional("ENABLE_VR", "Quaternionf::identity()")]
    [Obsolete(
        "This API has been marked as obsolete in code, and is no longer in use. Please use InputTracking.GetNodeStates and look for the XRNodeState with the corresponding XRNode type instead.")] extern public static Quaternion
    GetLocalRotation(XRNode node);

    [NativeConditional("ENABLE_VR")] extern public static void Recenter();

    [NativeConditional("ENABLE_VR")] extern public static string
    GetNodeName(ulong uniqueId);
    ...
    [NativeConditional("ENABLE_VR")] extern private static void
    GetNodeStates_Internal([ NotNull ] List<XRNodeState> nodeStates);

    [NativeConditional("ENABLE_VR")] extern public static bool
        disablePositionalTracking {
      [NativeName("GetPositionalTrackingDisabled")] get;
      [NativeName("SetPositionalTrackingDisabled")] set;
    }
    ...
    GetDeviceIdsAtXRNode_Internal(XRNode node,
                                  [ NotNull ] List<UInt64> deviceIds);
  }
}
