...
public struct InputDevice : IEquatable<InputDevice>
{
    ...
    public bool isValid {
        get {
            return IsValidId() && InputDevices.IsDeviceValid(m_DeviceId);
        }
    }
    public string name {
        get {
    ...
    public InputDeviceRole role {
        get {
            return IsValidId() ? InputDevices.GetDeviceRole(m_DeviceId) : InputDeviceRole.Unknown;
        }
    }
    public string manufacturer {
        get {
            return IsValidId() ? InputDevices.GetDeviceManufacturer(m_DeviceId) : null;
        }
    }
    public string serialNumber {
        get {
            return IsValidId() ? InputDevices.GetDeviceSerialNumber(m_DeviceId) : null;
        }
    }
    public InputDeviceCharacteristics characteristics {
        get {
            return IsValidId() ? InputDevices.GetDeviceCharacteristics(m_DeviceId) : InputDeviceCharacteristics.None;
        }
    }
