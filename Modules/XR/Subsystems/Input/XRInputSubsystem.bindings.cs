...
public class XRInputSubsystem
	: IntegratedSubsystem<XRInputSubsystemDescriptor> {
...
private extern bool
TryGetBoundaryPoints_AsList(List<Vector3> boundaryPoints);
...
private static void InvokeTrackingOriginUpdatedEvent(IntPtr internalPtr) {
	IntegratedSubsystem subsystem =
		SubsystemManager.GetIntegratedSubsystemByPtr(internalPtr);
	XRInputSubsystem inputSubsystem = subsystem as XRInputSubsystem;
	if ((inputSubsystem != null) &&
	    (inputSubsystem.trackingOriginUpdated != null))
