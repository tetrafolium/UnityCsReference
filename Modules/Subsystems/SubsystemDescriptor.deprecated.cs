...
public class SubsystemDescriptor<TSubsystem>
    : SubsystemDescriptor where TSubsystem : Subsystem
#pragma warning restore CS0618
{
  internal override ISubsystem CreateImpl() => this.Create();

  public TSubsystem Create() {
    TSubsystem subsystem = SubsystemManager.FindDeprecatedSubsystemByDescriptor(
        this) as TSubsystem;
    if (subsystem != null)
      return subsystem;

    subsystem =
        Activator.CreateInstance(subsystemImplementationType) as TSubsystem;
