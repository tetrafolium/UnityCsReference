...
namespace UnityEngine.Networking {
  public interface IMultipartFormSection {
    ...
    string fileName {
      get; // return null if not a file section
    }
  ...
  public class MultipartFormDataSection : IMultipartFormSection {
    ...
    public MultipartFormDataSection(string name, string data,
                                    string contentType)
        : this(name, data, System.Text.Encoding.UTF8, contentType) {}
  ...
  public class MultipartFormFileSection : IMultipartFormSection {
    ...
    private void Init(string name, byte[] data, string fileName,
                      string contentType) {
      this.name = name;
      this.data = data;
      this.file = fileName;
    ...
    public MultipartFormFileSection(string name, byte[] data, string fileName,
      ...
      if (data == null || data.Length < 1) {
        throw new ArgumentException(
            "Cannot create a multipart form file section without body data");
      }
