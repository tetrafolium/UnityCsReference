...
public static UnityWebRequest Get(string uri) {
	UnityWebRequest request = new UnityWebRequest(
		uri, kHttpVerbGET, new DownloadHandlerBuffer(), null);
	return request;
}
...
[Obsolete(
	 "UnityWebRequest.GetTexture is obsolete. Use UnityWebRequestTexture.GetTexture instead (UnityUpgradable) -> [UnityEngine] UnityWebRequestTexture.GetTexture(*)",
	 true)]
...
[System.ComponentModel.EditorBrowsable(
	 System.ComponentModel.EditorBrowsableState.Never)]
[Obsolete(
	 "UnityWebRequest.GetAudioClip is obsolete. Use UnityWebRequestMultimedia.GetAudioClip instead (UnityUpgradable) -> [UnityEngine] UnityWebRequestMultimedia.GetAudioClip(*)",
	 true)]
...
[System.ComponentModel.EditorBrowsable(
	 System.ComponentModel.EditorBrowsableState.Never)]
[Obsolete(
	 "UnityWebRequest.GetAssetBundle is obsolete. Use UnityWebRequestAssetBundle.GetAssetBundle instead (UnityUpgradable) -> [UnityEngine] UnityWebRequestAssetBundle.GetAssetBundle(*)",
	 true)]
...
public static UnityWebRequest Put(string uri, byte[] bodyData) {
	UnityWebRequest request =
		new UnityWebRequest(uri, kHttpVerbPUT, new DownloadHandlerBuffer(),
...
public static UnityWebRequest Put(string uri, string bodyData) {
	UnityWebRequest request = new UnityWebRequest(
		uri, kHttpVerbPUT, new DownloadHandlerBuffer(),
...
private static void SetupPost(UnityWebRequest request, string postData) {
	...
	if (!string.IsNullOrEmpty(postData)) {
		string urlencoded =
			WWWTranscoder.DataEncode(postData, System.Text.Encoding.UTF8);
...
// Provides a shim for sending a multipart form as declared by the legacy
// WWWForm class.
...
// Provides a way to send a multipart form using the modern
...
private static void
SetupPost(UnityWebRequest request,
...
// Provides a way to send a simple urlencoded form body, for simple forms
// without file sections.
public static UnityWebRequest Post(string uri,
...
public static UnityWebRequest Post(Uri uri,
                                   Dictionary<string, string> formFields) {
	UnityWebRequest request = new UnityWebRequest(uri, kHttpVerbPOST);
	SetupPost(request, formFields);
	return request;
...
private static void SetupPost(UnityWebRequest request,
                              Dictionary<string, string> formFields) {
	byte[] payload = null;
...
public static byte[] SerializeFormSections(
	...
	// end sections with boundary delimiter
...
public static byte[] SerializeSimpleForm(
	Dictionary<string, string> formFields) {
	string queryString = "";
	foreach (KeyValuePair<string, string> pair in formFields) {
		...
		queryString += WWWTranscoder.DataEncode(pair.Key) + "=" +
		               WWWTranscoder.DataEncode(pair.Value);
	}
