...
// A facade for the social API namespace, no state, only helper functions which
// delegate into others
public static class Social {
  ...
  public static ILocalUser localUser {
    get { return Active.localUser; }
  }

  public static void LoadUsers(string[] userIDs,
  ...
  public static void ReportScore(Int64 score, string board,
                                 Action<bool> callback) {
  ...
  public static void ShowAchievementsUI() { Active.ShowAchievementsUI(); }

  public static void ShowLeaderboardUI() { Active.ShowLeaderboardUI(); }
}
}
...
namespace UnityEngine.SocialPlatforms {
  ...
  public enum UserScope { Global = 0, FriendsOnly }

  public enum TimeScope { Today = 0, Week, AllTime }
