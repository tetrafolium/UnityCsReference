...
#pragma warning disable 649
  ...
  public void OnDestroy() { StopPreview(); }
  ...
  public override void OnPreviewGUI(Rect r, GUIStyle background) {
    ...
    if (m_PlayingClip.pixelAspectRatioDenominator > 0) {
      float pixelAspectRatio =
          (float) m_PlayingClip.pixelAspectRatioNumerator /
    ...
    Rect wantedRect = !m_UseAssetPreview ? new Rect(
        r.x, r.y, previewWidth * zoomLevel, m_Texture.height * zoomLevel)
        : r;
  ...
  internal override void OnHeaderIconGUI(Rect iconRect) {
    GUI.DrawTexture(iconRect, GetAssetPreviewTexture(),
                    ScaleMode.StretchToFill);
  }
