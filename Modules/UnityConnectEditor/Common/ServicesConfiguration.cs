...
namespace UnityEditor.Connect {
  ...
  internal sealed class ServicesConfiguration {
    ...
    const string k_CloudHubServiceUrl =
    ...
    const string k_CloudBuildTutorialUrl =
        "https://unity3d.com/learn/tutorials/topics/cloud-build-0";
    const string k_CloudDiagnosticsUrl =
        "https://unitytech.github.io/clouddiagnostics/";
    const string k_CloudDiagUserReportingSdkUrl =
        "https://userreporting.cloud.unity3d.com/api/userreporting/sdk";
    ...
    Dictionary<string, string> m_ServicesUrlsConfig =
    ...
    public bool pathsReady {
      get;
      internal set;
    }
    public bool loadingConfigurations {
      get;
      private set;
    }
    ...
    ServicesConfiguration() {
      m_UnityTeamUrl = L10n.Tr("https://unity3d.com/teams"); // Should be
                                                             // https://unity3d.com/fr/teams
                                                             // in French !
      PrepareAdsEnvironment(ConvertStringToServerEnvironment(
          UnityConnect.instance.GetEnvironment()));
      if (!string.IsNullOrEmpty(
              SessionState.GetString(k_ConfigJsonSessionStateKey, null))) {
    ...
    internal void LoadConfigurations(bool forceLoad = false) {
      if ((!pathsReady && !loadingConfigurations) || forceLoad) {
        ...
        // So we always have some fallback entries if a config only overwrite
        // some of the URLs.
        LoadDefaultConfigurations();

        if (!forceLoad && !string.IsNullOrEmpty(SessionState.GetString(
                              k_ConfigJsonSessionStateKey, null))) {
          LoadConfigurationsFromSessionState();
        } else {
    ...
    void BuildPaths() {
      ...
      m_ProjectDashboardUrl =
          m_ServicesUrlsConfig["core"] + "/orgs/{0}/projects/{1}";
      m_ProjectServiceFlagsApiUrl =
          apiUrl + "/projects/{0}/service_flags"; // no org to specify

      m_CloudBuildProjectUrl =
          m_ServicesUrlsConfig["build"] + "/build/orgs/{0}/projects/{1}";
      ...
      m_CloudDiagCrashesDashboardUrl =
          m_ServicesUrlsConfig["build"] +
          "/diagnostics/orgs/{0}/projects/{1}/crashes";
      m_CollabDashboardUrl = m_ServicesUrlsConfig["build"] +
                             "/collab/orgs/{0}/projects/{1}/assets/";
      m_PurchasingDashboardUrl =
          m_ServicesUrlsConfig["analytics"] + "/projects/{0}/purchasing/";
      m_AnalyticsDashboardUrl =
          m_ServicesUrlsConfig["analytics"] + "/events/{0}/";
    ...
    void StartProgress() {
      ...
      m_ProgressId = Progress.Start(L10n.Tr(k_ProgressTitle), options
    ...
    void LoadDefaultConfigurations() {
      // Snapshot of https://public-cdn.cloud.unity3d.com/config/production
      // taken on 2019-11-13, update periodically. The fallback for CDN configs
      // is the productionUrls.json file in default editor resources. This
      // hardcoded string is the fallback for the file.  So not very likely to
      // ever be used.
      const string hardCodedConfigs =
          ...
          :                          // analytics.cloud.unity3d.com"",
            "" build "" : "" https : // developer.cloud.unity3d.com"",
                                     "" build -
                                     api "" : "" https
          : // build-api.cloud.unity3d.com"",
            "" cdp -
            analytics "" : "" https : // prd-lender.cdp.internal.unity3d.com"",
                                      "" clouddata "" : "" https
          :                           // data.cloud.unity3d.com"",
            "" collab "" : "" https : // collab.cloud.unity3d.com"",
                                      "" collab -
                                      accelerator "" : "" https
          : // collab-accelerator.cloud.unity3d.com"",
            "" collab -
            max - files - per - commit "" : 10000,
                   "" commenting "" : "" https
          :                         // commenting.cloud.unity3d.com"",
            "" core "" : "" https : // core.cloud.unity3d.com"",
                                    "" coreembedded "" : "" https
          :                           // embedded.cloud.unity3d.com"",
            "" coreui "" : "" https : // developer.cloud.unity3d.com"",
                                      "" genesis_api_url "" : "" https
          :                                        // api.unity.com"",
          ...
          :                            // jump.cloud.unity3d.com"",
            "" license "" : "" https : // license.unity3d.com"",
                   ...
                   "" perf "" : "" https : // perf.cloud.unity3d.com"",
                                           "" perf -
                                           events "" : "" https
          : // a:b@perf-events.cloud.unity3d.com"",
            "" perf -
            max - batch - size "" : "" 1 "",
                   "" perf - max - events "" : "" 100 "",
          ...
          : // developer.cloud.unity3d.com"",
            "" waitlist_api "" : "" https
          : // collab-waiting-list.cloud.unity3d.com"",
            "" webauth "" : "" https : // accounts.unity3d.com"",
                                       "" socialdashboard "" : "" https
          : // dashboard.heyplayapp.com"",
            "" seat_required "" : true,
                   "" seatinfourl "" : "" / teams / learn - more "",
                   "" build_upload_api_url "" : "" https
          : // build-artifact-api.cloud.unity3d.com"",
            "" hub_installer_location "" : "" https
          : // public-cdn.cloud.unity3d.com/hub/prod/"",
            "" hub -
            disable - marketing - tips "" : false,
                   "" asset_store_api "" : "" https
          :                                    // packages-v2.unity.com"",
            "" asset_store_url "" : "" https : // assetstore.unity.com"",
                                               "" packman_key ""
          : "" 6357C523886E813D1500408F05B0D7A6 ""
    }
    ";
    ...
    try {
      if (m_GetServicesUrlsRequest != null) {
        try {
          ...
          // ignored, we try to abort (best effort) but no need to panic if it
          // fails
        }
      ...
      m_GetServicesUrlsRequest = new UnityWebRequest(
          string.Format(k_CdnConfigUrl, UnityConnect.instance.GetEnvironment()),
      ...
      operation.completed += asyncOperation => {
        try {
          if (ServicesUtils.IsUnityWebRequestReadyForJsonExtract(
                  m_GetServicesUrlsRequest)) {
            LoadJsonConfiguration(
                m_GetServicesUrlsRequest.downloadHandler.text);
            SessionState.SetString(
                k_ConfigJsonSessionStateKey,
                m_GetServicesUrlsRequest.downloadHandler.text);
            BuildPaths();
          }
        } catch (Exception) {
  ...
  void LoadJsonConfiguration(string json) {
    ...
    foreach (var key in jsonConfigs.Keys) {
      if (!m_ServicesUrlsConfig.ContainsKey(key)) {
        m_ServicesUrlsConfig.Add(key, jsonConfigs [key]
                                          .AsObject()
                                          .ToString());
      } else {
        m_ServicesUrlsConfig[key] = jsonConfigs [key]
                                        .AsObject()
                                        .ToString();
      }
    }
  ...
  public void PrepareAdsEnvironment(ServerEnvironment environmentType) {
    ...
    adsDashboardUrl =
        "https://operate.dashboard.unity3d.com/organizations/{0}/projects/{1}/overview/revenue";

    switch (environmentType) {
    case ServerEnvironment.Production:
      adsOperateApiUrl =
          "https://legacy-editor-integration.dashboard.unity3d.com";
      break;
    ...
    case ServerEnvironment.Staging:
      adsOperateApiUrl =
          "https://legacy-editor-integration.staging.dashboard.unity3d.com";
      break;
  ...
  public ServerEnvironment ConvertStringToServerEnvironment(string value) {
    ...
    if (string.Equals(ServerEnvironment.Custom.ToString(), value,
                      StringComparison.CurrentCultureIgnoreCase)) {
      return ServerEnvironment.Custom;
    }
    if (string.Equals(ServerEnvironment.Staging.ToString(), value,
                      StringComparison.CurrentCultureIgnoreCase)) {
      return ServerEnvironment.Staging;
    }
    if (string.Equals(ServerEnvironment.Development.ToString(), value,
                      StringComparison.CurrentCultureIgnoreCase)) {
  ...
  void RequestAsyncUrl(AsyncUrlId asyncUrlId, Action<string> callback) {
    var asyncUrlCallback =
        new AsyncUrlCallback(){asyncUrlId = asyncUrlId, callback = callback};
    if (pathsReady) {
  ...
  /// <summary>
  /// Request the endpoint to retrieve the projects of the specified
  /// organization, create a new one, etc.
  /// </summary>
  /// <param name="organizationId">Identical to organization name at the time of
  /// this comment</param> <param name="callback"></param> <returns>A url
  /// endpoint to request projects</returns>
  public void RequestOrganizationProjectsApiUrl(string organizationId,
  ...
  public void RequestCurrentProjectApiUrl(Action<string> callback) {
    RequestProjectApiUrl(UnityConnect.instance.projectInfo.organizationId,
                         UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestProjectApiUrl(string organizationId, string projectId,
                                   Action<string> callback) {
  ...
  public void RequestCurrentProjectCoppaApiUrl(Action<string> callback) {
    RequestProjectCoppaApiUrl(UnityConnect.instance.projectInfo.organizationId,
                              UnityConnect.instance.projectInfo.projectId,
                              callback);
  }

  public void RequestProjectCoppaApiUrl(string organizationId, string projectId,
                                        Action<string> callback) {
  ...
  public void RequestCurrentProjectUsersApiUrl(Action<string> callback) {
    RequestProjectUsersApiUrl(UnityConnect.instance.projectInfo.organizationId,
                              UnityConnect.instance.projectInfo.projectId,
                              callback);
  }
  ...
  /// </summary>
  /// <param name="organizationId">Identical to organization name at the time of
  /// this comment</param> <param name="projectId">A project's ID</param> <param
  /// name="callback"></param> <returns>A url to reach the project users
  /// info</returns>
  public void RequestProjectUsersApiUrl(string organizationId, string projectId,
                                        Action<string> callback) {
  ...
  public void RequestCurrentProjectDashboardUrl(Action<string> callback) {
    RequestProjectDashboardUrl(UnityConnect.instance.projectInfo.organizationId,
                               UnityConnect.instance.projectInfo.projectId,
                               callback);
  }
  ...
  /// <param name="organizationId">Identical to organization name at the time of
  /// this comment</param> <param name="projectId">A project's ID</param> <param
  /// name="callback"></param> <returns></returns>
  public void RequestProjectDashboardUrl(
      string organizationId, string projectId, Action<string> callback) {
  ...
  public void RequestCurrentProjectServiceFlagsApiUrl(Action<string> callback) {
    RequestProjectServiceFlagsApiUrl(
        UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestProjectServiceFlagsApiUrl(string projectId,
                                               Action<string> callback) {
    RequestAsyncUrl(
        AsyncUrlId.ProjectServiceFlagsApiUrl, projectServiceFlagsApiUrl => {
  ...
  public string GetUnityTeamInfoUrl() { return m_UnityTeamUrl; }

  // Return the specific cloud build tutorial URL for the cloud build service
  public string GetCloudBuildTutorialUrl() { return k_CloudBuildTutorialUrl; }
  ...
  public void RequestCloudBuildCurrentProjectUrl(Action<string> callback) {
    RequestCloudBuildProjectsUrl(
        UnityConnect.instance.projectInfo.organizationId,
        UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestCloudBuildProjectsUrl(
      string organizationId, string projectId, Action<string> callback) {
  ...
  public void RequestCurrentCloudBuildProjectUploadUrl(
      Action<string> callback) {
    RequestCloudBuildProjectUploadUrl(
        UnityConnect.instance.projectInfo.organizationId,
        UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestCloudBuildProjectUploadUrl(
      string organizationId, string projectId, Action<string> callback) {
  ...
  public void RequestCurrentCloudBuildProjectTargetUrl(
      Action<string> callback) {
    RequestCloudBuildProjectTargetUrl(
        UnityConnect.instance.projectInfo.organizationId,
        UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestCloudBuildProjectTargetUrl(
      string organizationId, string projectId, Action<string> callback) {
  ...
  public void RequestCurrentCloudBuildProjectHistoryUrl(
      Action<string> callback) {
    RequestCloudBuildProjectHistoryUrl(
        UnityConnect.instance.projectInfo.organizationId,
        UnityConnect.instance.projectInfo.projectId, callback);
  }

  public void RequestCloudBuildProjectHistoryUrl(
      string organizationId, string projectId, Action<string> callback) {
    RequestAsyncUrl(AsyncUrlId.CloudBuildProjectUrl, cloudBuildProjectUrl => {
      callback(string.Format(cloudBuildProjectUrl, organizationId, projectId));
    });
  ...
  public void RequestCloudBuildApiCurrentProjectUrl(Action<string> callback) {
    RequestCloudBuildApiProjectUrl(UnityConnect.instance.projectInfo.projectId,
                                   callback);
  }

  public void RequestCloudBuildApiProjectUrl(string projectId,
                                             Action<string> callback) {
    RequestAsyncUrl(
        AsyncUrlId.CloudBuildApiProjectUrl, cloudBuildApiProjectUrl => {
  ...
  public string adsGettingStartedUrl {
    get;
    private set;
  }
  public string adsLearnMoreUrl {
    get;
    private set;
  }
  public string adsDashboardUrl {
    get;
    private set;
  }
  public string adsOperateApiUrl {
    get;
    private set;
  }
}
