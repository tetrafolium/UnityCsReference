...
namespace UnityEditor.Connect {
  ...
  internal class AnalyticsService : SingleService {
    ...
    public override string settingsProviderClassName =>
        nameof(AnalyticsProjectSettings);
    ...
    static AnalyticsService() { k_Instance = new AnalyticsService(); }
    ...
    AnalyticsService() {
      ...
      pathTowardIcon =
          @"Builtin Skins\Shared\Images\ServicesWindow-ServiceIcon-Analytics.png";
    ...
    protected override void InternalEnableService(bool enable,
      ...
      if (AnalyticsSettings.enabled != enable) {
        ...
        EditorAnalytics.SendEventServiceInfo(
            new AnalyticsServiceState(){analytics = enable});
    ...
    public void RequestValidationData(Action<AsyncOperation> onGet,
                                      string authSignature,
                                      out UnityWebRequest request) {
      request = UnityWebRequest.Get(
          String.Format(AnalyticsConfiguration.instance.validatorUrl,
