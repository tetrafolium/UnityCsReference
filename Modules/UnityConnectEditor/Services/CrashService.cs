...
namespace UnityEditor.Connect {
  ...
  internal class CrashService : SingleService {
    ...
    public override string settingsProviderClassName =>
        nameof(CloudDiagProjectSettings);
    ...
    static CrashService() { k_Instance = new CrashService(); }
    ...
    CrashService() {
      ...
      pathTowardIcon =
          @"Builtin Skins\Shared\Images\ServicesWindow-ServiceIcon-Crash.png";
    ...
    protected override void InternalEnableService(bool enable,
      ...
      if (CrashReportingSettings.enabled != enable) {
        ...
        EditorAnalytics.SendEventServiceInfo(
            new CrashServiceState(){crash_reporting = enable});
      }
