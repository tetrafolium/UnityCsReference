...
internal static void TranslateStringsInTree(VisualElement rootElement) {
	rootElement.Query<TextElement>().ForEach((label) => label.text =
							 L10n.Tr(label.text));
}
...
static readonly string k_PlatformSupportUXMLPath =
	"UXML/ServicesWindow/PlatformSupportVisual.uxml";
static readonly string k_PlatformSupportCommonUssPath =
	"StyleSheets/ServicesWindow/PlatformSupportVisualCommon.uss";
static readonly string k_PlatformSupportDarkUssPath =
	"StyleSheets/ServicesWindow/PlatformSupportVisualDark.uss";
static readonly string k_PlatformSupportLightUssPath =
	"StyleSheets/ServicesWindow/PlatformSupportVisualLight.uss";
...
static readonly string k_PlatformWindows8_1Universal =
	"Windows 8.1 Universal";
static readonly string k_PlatformWindows10Universal =
	"Windows 10 Universal";
static readonly string k_PlatformXboxOne = "Xbox One";

static readonly string[] k_MultiplayerSupportedPlatforms = {
	k_PlatformAndroid,   k_PlatformIOS,     k_PlatformLinux,
	k_PlatformMac,       k_PlatformPC,      k_PlatformPS4,
	k_PlatformWebPlayer, k_PlatformXboxOne,
};
...
internal static readonly string initializationError =
	"Unity Connect is unable to initialize.";
}

internal static class StylesheetPath {
internal static readonly string servicesCommon =
	"StyleSheets/ServicesWindow/ServicesProjectSettingsCommon.uss";
internal static readonly string servicesDark =
	"StyleSheets/ServicesWindow/ServicesProjectSettingsDark.uss";
internal static readonly string servicesLight =
	"StyleSheets/ServicesWindow/ServicesProjectSettingsLight.uss";
internal static readonly string servicesWindowCommon =
	"StyleSheets/ServicesWindow/ServicesWindowCommon.uss";
internal static readonly string servicesWindowDark =
	"StyleSheets/ServicesWindow/ServicesWindowDark.uss";
internal static readonly string servicesWindowLight =
	"StyleSheets/ServicesWindow/ServicesWindowLight.uss";
}
...
internal static readonly string createProjectIdBlock =
	"CreateProjectIdBlock";
internal static readonly string supportedPlatformsBlock =
...
public static VisualElement
SetupSupportedPlatformsBlock(List<string> platforms) {
	var supportedPlatformsBlock =
		EditorGUIUtility.Load(k_PlatformSupportUXMLPath) as VisualTreeAsset;
	...
	newVisual.AddStyleSheetPath(
		EditorGUIUtility.isProSkin ? k_PlatformSupportDarkUssPath
	  : k_PlatformSupportLightUssPath);
...
public static bool
IsUnityWebRequestReadyForJsonExtract(UnityWebRequest unityWebRequest) {
...
public static void
OpenServicesProjectSettings(SingleService singleService) {
	OpenServicesProjectSettings(singleService.projectSettingsPath,
	                            singleService.settingsProviderClassName);
}

public static void
OpenServicesProjectSettings(string servicesProjectSettingsPath,
                            string projectSettingsClassName) {
	var currentProvider =
		((ProjectSettingsWindow) SettingsService.OpenProjectSettings())
		.GetCurrentProvider();
	if (currentProvider == null ||
	    !currentProvider.GetType().Name.Equals(projectSettingsClassName)) {
