...
namespace UnityEditor.Connect {
  ...
  internal class CollabService : SingleService {
    ...
    static CollabService() { k_Instance = new CollabService(); }
    ...
    protected override void InternalEnableService(bool enable,
      ...
      if (IsServiceEnabled() != enable) {
        EditorAnalytics.SendEventServiceInfo(
            new CollabServiceState(){collaborate = enable});
      }
      ...
      AssetDatabase.Refresh(); // If auto-refresh was off, make sure we refresh
                               // when setting it back on
    }
    ...
    CollabService() {
      ...
      pathTowardIcon =
          @"Builtin Skins\Shared\Images\ServicesWindow-ServiceIcon-Collab.png";
