...
namespace UnityEditor.Connect {
  ...
  internal class BuildService : SingleService {
    ...
    public override string settingsProviderClassName =>
        nameof(CloudBuildProjectSettings);
    ...
    static BuildService() { k_Instance = new BuildService(); }
    ...
    BuildService() {
      ...
      pathTowardIcon =
          @"Builtin Skins\Shared\Images\ServicesWindow-ServiceIcon-Build.png";
    ...
    protected override void InternalEnableService(bool enable,
      ...
      if (IsServiceEnabled() != enable) {
        EditorAnalytics.SendEventServiceInfo(
            new BuildServiceState(){build = enable});
      }
