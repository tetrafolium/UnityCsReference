    ...
    , IDisposable
{
    ...
    {
        get {
            return (int)_uwr.downloadedBytes;
        }
    }
    ...
    public Texture2D texture {
        get {
            return CreateTextureFromDownloadedData(false);
        }
    }

    public Texture2D textureNonReadable {
        get {
            return CreateTextureFromDownloadedData(true);
        }
    }
    ...
    public override bool keepWaiting {
        get {
            return _uwr == null ? false : !_uwr.isDone;
        }
    }
