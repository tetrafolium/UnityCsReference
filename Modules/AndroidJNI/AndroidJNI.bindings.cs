...
public static class AndroidJNIHelper {
  ...
  // Scans a particular Java class for a constructor method matching a
  // signature.
  ...
  GetConstructorID(IntPtr javaClass,
                   [ UnityEngine.Internal.DefaultValue("") ] string signature) {
  ...
  GetMethodID(IntPtr javaClass, string methodName,
              [ UnityEngine.Internal.DefaultValue("") ] string signature,
              [ UnityEngine.Internal.DefaultValue("false") ] bool isStatic) {
    return _AndroidJNIHelper.GetMethodID(javaClass, methodName, signature,
                                         isStatic);
  }
  ...
  GetFieldID(IntPtr javaClass, string fieldName,
             [ UnityEngine.Internal.DefaultValue("") ] string signature,
             [ UnityEngine.Internal.DefaultValue("false") ] bool isStatic) {
    return _AndroidJNIHelper.GetFieldID(javaClass, fieldName, signature,
                                        isStatic);
  }
  ...
  public static IntPtr CreateJavaProxy(AndroidJavaProxy proxy) {
    ...
    try {
      return _AndroidJNIHelper.CreateJavaProxy(GCHandle.ToIntPtr(handle),
                                               proxy);
    } catch {
      handle.Free();
      throw;
  ...
  // Creates the parameter array to be used as argument list when invoking Java
  // code through CallMethod() in AndroidJNI.
  public static jvalue[] CreateJNIArgArray(object[] args) {
    return _AndroidJNIHelper.CreateJNIArgArray(args);
  }

  // Deletes any local jni references previously allocated by
  // CreateJNIArgArray()
  //
  // @param jniArgs the array returned by CreateJNIArgArray()
  // @param args the array of arguments used as a parameter to
  // CreateJNIArgArray()
  //
  ...
  //
  // @param javaClass Raw JNI Java class object (obtained by calling
  // AndroidJNI.FindClass).
  // @param args Array with parameters to be passed to the constructor when
  // invoked.
  //
  ...
  public static System.IntPtr GetMethodID<ReturnType>(System.IntPtr jclass,
                                                      ...
                                                      object[] args,
                                                      bool isStatic) {
    return _AndroidJNIHelper.GetMethodID<ReturnType>(jclass, methodName, args,
                                                     isStatic);
  }

  // Get a JNI field ID based on type detection. Generic parameter represents
  // the field type.
  public static System.IntPtr
  GetFieldID<FieldType>(System.IntPtr jclass, string fieldName, bool isStatic) {
...
public static class AndroidJNI {
  ...
  // Converts a <tt>java.lang.reflect.Method</tt> or
  // <tt>java.lang.reflect.Constructor</tt> object to a method ID.
  [ThreadSafe]
  ...
  // <tt>java.lang.reflect.Method</tt> or <tt>java.lang.reflect.Constructor</tt>
  // object.
  [ThreadSafe]
  public static extern IntPtr ToReflectedMethod(IntPtr clazz, IntPtr methodID,
                                                bool isStatic);
  // Converts a field ID derived from cls to a <tt>java.lang.reflect.Field</tt>
  // object.
  [ThreadSafe]
  public static extern IntPtr ToReflectedField(IntPtr clazz, IntPtr fieldID,
                                               bool isStatic);

  // If <tt>clazz</tt> represents any class other than the class
  // <tt>Object</tt>, then this function returns the object that represents the
  // superclass of the class specified by <tt>clazz</tt>.
  [ThreadSafe]
  public static extern IntPtr GetSuperclass(IntPtr clazz);
  // Determines whether an object of <tt>clazz1</tt> can be safely cast to
  // <tt>clazz2</tt>.
  [ThreadSafe]
  ...
  // <tt>message</tt> specified by message and causes that exception to be
  // thrown.
  [ThreadSafe]
  ...
  // Raises a fatal error and does not expect the VM to recover. This function
  // does not return.
  [ThreadSafe]
  ...
  // Creates a new global weak reference to the object referred to by the
  // <tt>obj</tt> argument.
  [ThreadSafe]
  ...
  // Ensures that at least a given number of local references can be created in
  // the current thread.
  [ThreadSafe]
  ...
  [ThreadSafe]
  public static extern IntPtr NewObject(IntPtr clazz, IntPtr methodID,
                                        jvalue[] args);
  ...
  // interface.
  [ThreadSafe]
  public static extern IntPtr GetMethodID(IntPtr clazz, string name,
                                          string sig);
  ...
  [ThreadSafe]
  public static extern IntPtr GetStaticMethodID(IntPtr clazz, string name,
                                                string sig);
  // Returns the field ID for a static field of a class.
  [ThreadSafe]
  public static extern IntPtr GetStaticFieldID(IntPtr clazz, string name,
                                               string sig);
  ...
  // Constructs a new <tt>java.lang.String</tt> object from an array of Unicode
  // characters.
  [ThreadSafe]
  public static extern IntPtr NewString(char[] chars);

  // Constructs a new <tt>java.lang.String</tt> object from an array of
  ...
  // Returns a managed string object representing the string in modified UTF-8
  // encoding.
  [ThreadSafe]
  ...
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern string CallStringMethod(IntPtr obj, IntPtr methodID,
                                               jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  ...
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern Int32 CallIntMethod(IntPtr obj, IntPtr methodID,
                                           jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern bool CallBooleanMethod(IntPtr obj, IntPtr methodID,
                                              jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern Int16 CallShortMethod(IntPtr obj, IntPtr methodID,
                                             jvalue[] args);
  [Obsolete(
      "AndroidJNI.CallByteMethod is obsolete. Use AndroidJNI.CallSByteMethod method instead")]
  public static Byte CallByteMethod(IntPtr obj, IntPtr methodID,
                                    jvalue[] args) {
  ...
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern SByte CallSByteMethod(IntPtr obj, IntPtr methodID,
                                             jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern Char CallCharMethod(IntPtr obj, IntPtr methodID,
                                           jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern float CallFloatMethod(IntPtr obj, IntPtr methodID,
                                             jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern double CallDoubleMethod(IntPtr obj, IntPtr methodID,
                                               jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern Int64 CallLongMethod(IntPtr obj, IntPtr methodID,
                                            jvalue[] args);
  // Calls an instance (nonstatic) Java method defined by <tt>methodID</tt>,
  // optionally passing an array of arguments (<tt>args</tt>) to the method.
  [ThreadSafe]
  public static extern void CallVoidMethod(IntPtr obj, IntPtr methodID,
                                           jvalue[] args);

  //---------------------------------------------

  // This function returns the value of an instance (nonstatic) field of an
  // object.
  [ThreadSafe]
  ...
  [Obsolete(
      "AndroidJNI.GetByteField is obsolete. Use AndroidJNI.GetSByteField method instead")]
  ...
  [ThreadSafe]
  public static extern void SetStringField(IntPtr obj, IntPtr fieldID,
                                           string val);
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetObjectField(IntPtr obj, IntPtr fieldID,
                                           IntPtr val);
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetBooleanField(IntPtr obj, IntPtr fieldID,
                                            bool val);
  [Obsolete(
      "AndroidJNI.SetByteField is obsolete. Use AndroidJNI.SetSByteField method instead")]
  ...
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetSByteField(IntPtr obj, IntPtr fieldID,
                                          SByte val);
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  ...
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetShortField(IntPtr obj, IntPtr fieldID,
                                          Int16 val);
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  ...
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetFloatField(IntPtr obj, IntPtr fieldID,
                                          float val);
  // This function sets the value of an instance (nonstatic) field of an object.
  [ThreadSafe]
  public static extern void SetDoubleField(IntPtr obj, IntPtr fieldID,
                                           double val);

  //---------------------------------------------

  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern string
  CallStaticStringMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern IntPtr
  CallStaticObjectMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern Int32 CallStaticIntMethod(IntPtr clazz, IntPtr methodID,
                                                 jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  ...
  CallStaticBooleanMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern Int16
  CallStaticShortMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [Obsolete(
      "AndroidJNI.CallStaticByteMethod is obsolete. Use AndroidJNI.CallStaticSByteMethod method instead")]
  public static Byte CallStaticByteMethod(IntPtr clazz, IntPtr methodID,
                                          jvalue[] args) {
    return (Byte) CallStaticSByteMethod(clazz, methodID, args);
  }

  [ThreadSafe]
  public static extern SByte
  CallStaticSByteMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern Char CallStaticCharMethod(IntPtr clazz, IntPtr methodID,
                                                 jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  ...
  CallStaticFloatMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern double
  CallStaticDoubleMethod(IntPtr clazz, IntPtr methodID, jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern Int64 CallStaticLongMethod(IntPtr clazz, IntPtr methodID,
                                                  jvalue[] args);
  // Invokes a static method on a Java object, according to the specified
  // <tt>methodID</tt>, optionally passing an array of arguments (<tt>args</tt>)
  // to the method.
  [ThreadSafe]
  public static extern void CallStaticVoidMethod(IntPtr clazz, IntPtr methodID,
                                                 jvalue[] args);
  ...
  [ThreadSafe]
  public static extern string GetStaticStringField(IntPtr clazz,
                                                   IntPtr fieldID);
  // This function returns the value of a static field of an object.
  [ThreadSafe]
  public static extern IntPtr GetStaticObjectField(IntPtr clazz,
                                                   IntPtr fieldID);
  // This function returns the value of a static field of an object.
  [ThreadSafe]
  public static extern bool GetStaticBooleanField(IntPtr clazz, IntPtr fieldID);
  [Obsolete(
      "AndroidJNI.GetStaticByteField is obsolete. Use AndroidJNI.GetStaticSByteField method instead")]
  ...
  // This function returns the value of a static field of an object.
  [ThreadSafe]
  public static extern double GetStaticDoubleField(IntPtr clazz,
                                                   IntPtr fieldID);
  ...
  [ThreadSafe]
  public static extern void SetStaticStringField(IntPtr clazz, IntPtr fieldID,
                                                 string val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticObjectField(IntPtr clazz, IntPtr fieldID,
                                                 IntPtr val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticBooleanField(IntPtr clazz, IntPtr fieldID,
                                                  bool val);
  [Obsolete(
      "AndroidJNI.SetStaticByteField is obsolete. Use AndroidJNI.SetStaticSByteField method instead")]
  public static void SetStaticByteField(IntPtr clazz, IntPtr fieldID,
                                        Byte val) {
  ...
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticSByteField(IntPtr clazz, IntPtr fieldID,
                                                SByte val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticCharField(IntPtr clazz, IntPtr fieldID,
                                               Char val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticShortField(IntPtr clazz, IntPtr fieldID,
                                                Int16 val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticIntField(IntPtr clazz, IntPtr fieldID,
                                              Int32 val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticLongField(IntPtr clazz, IntPtr fieldID,
                                               Int64 val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticFloatField(IntPtr clazz, IntPtr fieldID,
                                                float val);
  // This function ets the value of a static field of an object.
  [ThreadSafe]
  public static extern void SetStaticDoubleField(IntPtr clazz, IntPtr fieldID,
                                                 double val);
  ...
  [ThreadSafe]
  [Obsolete(
      "AndroidJNI.ToByteArray is obsolete. Use AndroidJNI.ToSByteArray method instead")]
  ...
  // Convert a managed array of System.IntPtr, representing Java objects, to a
  // Java array of <tt>java.lang.Object</tt>.
  [ThreadSafe]
  ...
  // Convert a Java array of <tt>boolean</tt> to a managed array of
  // System.Boolean.
  [ThreadSafe]
  public static extern Boolean[] FromBooleanArray(IntPtr array);
  [ThreadSafe]
  [Obsolete(
      "AndroidJNI.FromByteArray is obsolete. Use AndroidJNI.FromSByteArray method instead")]
  ...
  // Convert a Java array of <tt>double</tt> to a managed array of
  // System.Double.
  [ThreadSafe]
  public static extern double[] FromDoubleArray(IntPtr array);
  // Convert a Java array of <tt>java.lang.Object</tt> to a managed array of
  // System.IntPtr, representing Java objects.
  [ThreadSafe]
  ...
  [Obsolete(
      "AndroidJNI.NewByteArray is obsolete. Use AndroidJNI.NewSByteArray method instead")]
  ...
  // Constructs a new array holding objects in class <tt>clazz</tt>. All
  // elements are initially set to <tt>obj</tt>.
  [ThreadSafe]
  public static extern IntPtr NewObjectArray(int size, IntPtr clazz,
                                             IntPtr obj);
  ...
  [Obsolete(
      "AndroidJNI.GetByteArrayElement is obsolete. Use AndroidJNI.GetSByteArrayElement method instead")]
  ...
  [Obsolete(
      "AndroidJNI.SetBooleanArrayElement(IntPtr, int, byte) is obsolete. Use AndroidJNI.SetBooleanArrayElement(IntPtr, int, bool) method instead")]
  public static void SetBooleanArrayElement(IntPtr array, int index, byte val) {
    SetBooleanArrayElement(array, index, val != 0);
  }

  [ThreadSafe]
  public static extern void SetBooleanArrayElement(IntPtr array, int index,
                                                   bool val);
  [Obsolete(
      "AndroidJNI.SetByteArrayElement is obsolete. Use AndroidJNI.SetSByteArrayElement method instead")]
  ...
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetSByteArrayElement(IntPtr array, int index,
                                                 sbyte val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetCharArrayElement(IntPtr array, int index,
                                                Char val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetShortArrayElement(IntPtr array, int index,
                                                 Int16 val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetIntArrayElement(IntPtr array, int index,
                                               Int32 val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetLongArrayElement(IntPtr array, int index,
                                                Int64 val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetFloatArrayElement(IntPtr array, int index,
                                                 float val);
  // Sets the value of one element in a primitive array.
  [ThreadSafe]
  public static extern void SetDoubleArrayElement(IntPtr array, int index,
                                                  double val);
  // Sets an element of an <tt>Object</tt> array.
  [ThreadSafe]
  public static extern void SetObjectArrayElement(IntPtr array, int index,
                                                  IntPtr obj);
}
}
