...
public class AndroidInput {
  ...
  // Returns object representing status of a specific touch on a secondary
  // touchpad (Does not allocate temporary variables).
  public static Touch GetSecondaryTouch(int index) { return new Touch(); }
