...
public class Gyroscope {
  internal Gyroscope(int index) { m_GyroIndex = index; }

  private int m_GyroIndex;

  [FreeFunction("GetGyroRotationRate")] extern private static Vector3
  rotationRate_Internal(int idx);
  [FreeFunction("GetGyroRotationRateUnbiased")] extern private static Vector3
  rotationRateUnbiased_Internal(int idx);
  [FreeFunction("GetGravity")] extern private static Vector3
  gravity_Internal(int idx);
  [FreeFunction("GetUserAcceleration")] extern private static Vector3
  userAcceleration_Internal(int idx);
  [FreeFunction("GetAttitude")] extern private static Quaternion
  attitude_Internal(int idx);
  [FreeFunction("IsGyroEnabled")] extern private static bool
  getEnabled_Internal(int idx);
  [FreeFunction("SetGyroEnabled")] extern private static void
  setEnabled_Internal(int idx, bool enabled);
  [FreeFunction("GetGyroUpdateInterval")] extern private static float
  getUpdateInterval_Internal(int idx);
  [FreeFunction("SetGyroUpdateInterval")] extern private static void
  setUpdateInterval_Internal(int idx, float interval);
...
public class LocationService {
  ...
  public void Start() { Start(10f, 10f); }

  public void Stop() { StopUpdatingLocation(); }
}
...
[NativeHeader("Runtime/Camera/Camera.h")]
    // This is needed to internally call Physics/Physics2D using an interface if
    // available, so we don't have a hard dependency on Physics.
    internal class CameraRaycastHelper {
  [FreeFunction(
      "CameraScripting::RaycastTry")] extern internal static GameObject
  RaycastTry(Camera cam, Ray ray, float distance, int layerMask);
  [FreeFunction(
      "CameraScripting::RaycastTry2D")] extern internal static GameObject
  RaycastTry2D(Camera cam, Ray ray, float distance, int layerMask);
}
...
public class Input {
  ...
  public static bool GetKey(KeyCode key) { return GetKeyInt(key); }

  public static bool GetKey(string name) { return GetKeyString(name); }

  public static bool GetKeyUp(KeyCode key) { return GetKeyUpInt(key); }

  public static bool GetKeyUp(string name) { return GetKeyUpString(name); }

  public static bool GetKeyDown(KeyCode key) { return GetKeyDownInt(key); }

  public static bool GetKeyDown(string name) { return GetKeyDownString(name); }

  [Conditional("UNITY_EDITOR")]
  internal static void SimulateTouch(int id, Vector2 position,
                                     TouchPhase action) {
  ...
  private extern static void SimulateTouchInternal(int id, Vector2 position,
                                                   TouchPhase action,
                                                   long timestamp);
  ...
  [NativeThrows]
  public extern static Vector3 mousePosition {
    get;
  }
  [NativeThrows]
  public extern static Vector2 mouseScrollDelta {
    get;
  }
  ...
  public extern static Vector2 compositionCursorPos {
    get;
    set;
  }
  [Obsolete(
      "eatKeyPressOnTextFieldFocus property is deprecated, and only provided to support legacy behavior.")]
  ...
  public extern static bool mousePresent {
    [FreeFunction("GetMousePresent")] get;
  }
  public extern static int touchCount { [FreeFunction("GetTouchCount")] get; }
  public extern static bool touchPressureSupported {
    [FreeFunction("IsTouchPressureSupported")] get;
  }
  public extern static bool stylusTouchSupported {
    [FreeFunction("IsStylusTouchSupported")] get;
  }
  public extern static bool touchSupported {
    [FreeFunction("IsTouchSupported")] get;
  }
  public extern static bool multiTouchEnabled {
    [FreeFunction("IsMultiTouchEnabled")] get;
    [FreeFunction("SetMultiTouchEnabled")] set;
  }
  [Obsolete(
      "isGyroAvailable property is deprecated. Please use SystemInfo.supportsGyroscope instead.")]
  public extern static bool isGyroAvailable {
    [FreeFunction("IsGyroAvailable")] get;
  }
  public extern static DeviceOrientation deviceOrientation {
    [FreeFunction("GetOrientation")] get;
  }
  public extern static Vector3 acceleration {
    [FreeFunction("GetAcceleration")] get;
  }
  public extern static bool compensateSensors {
    [FreeFunction("IsCompensatingSensors")] get;
    [FreeFunction("SetCompensatingSensors")] set;
  }
  public extern static int accelerationEventCount {
    [FreeFunction("GetAccelerationCount")] get;
  }
  public extern static bool backButtonLeavesApp {
    [FreeFunction("GetBackButtonLeavesApp")] get;
    [FreeFunction("SetBackButtonLeavesApp")] set;
  }
