...
namespace UnityEngine.Animations {
  ...
  internal struct ProcessAnimationJobStruct<T> where T : struct, IAnimationJob {
    ...
    public delegate void ExecuteJobFunction(ref T data,
                                            IntPtr animationStreamPtr,
                                            IntPtr unusedPtr,
                                            ref JobRanges ranges, int jobIndex);

    public static unsafe void Execute(ref T data, IntPtr animationStreamPtr,
                                      IntPtr methodIndex, ref JobRanges ranges,
                                      int jobIndex) {
      AnimationStream animationStream;
      UnsafeUtility.CopyPtrToStructure((void *) animationStreamPtr,
                                       out animationStream);
