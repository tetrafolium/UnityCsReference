...
public abstract class StateMachineBehaviour : ScriptableObject {
  ...
  virtual public void OnStateMove(Animator animator,
                                  AnimatorStateInfo stateInfo, int layerIndex) {
  }
  ...
  virtual public void OnStateIK(Animator animator, AnimatorStateInfo stateInfo,
                                int layerIndex) {}

  // OnStateMachineEnter is called when entering a statemachine via its Entry
  // Node
  virtual public void OnStateMachineEnter(Animator animator,
                                          int stateMachinePathHash) {}

  // OnStateMachineExit is called when exiting a statemachine via its Exit Node
  virtual public void OnStateMachineExit(Animator animator,
                                         int stateMachinePathHash) {}
  ...
  // OnStateMachineEnter is called when entering a statemachine via its Entry
  // Node
  virtual public void OnStateMachineEnter(
      Animator animator, int stateMachinePathHash,
      UnityEngine.Animations.AnimatorControllerPlayable controller) {}

  // OnStateMachineExit is called when exiting a statemachine via its Exit Node
  virtual public void OnStateMachineExit(
      Animator animator, int stateMachinePathHash,
      UnityEngine.Animations.AnimatorControllerPlayable controller) {}
}
}
