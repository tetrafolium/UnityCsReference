...
internal enum TransitionType { Normal = 1 << 0, Entry = 1 << 1, Exit = 1 << 2 }
...
public enum AnimatorRecorderMode { Offline, Playback, Record }

public enum DurationUnit { Fixed, Normalized }

// Culling mode for the Animator
public enum AnimatorCullingMode {
  // Always animate the entire character. Object is animated even when
  // offscreen.
  AlwaysAnimate = 0,

  // Retarget, IK and write of Transforms are disabled when renderers are not
  // visible.
  ...
  [Obsolete(
      "Enum member AnimatorCullingMode.BasedOnRenderers has been deprecated. Use AnimatorCullingMode.CullUpdateTransforms instead. (UnityUpgradable) -> CullUpdateTransforms",
      true)] BasedOnRenderers = 1,
}
...
#pragma warning disable 649 // Field is never assigned to and will always have
                            // its default value
...
public struct AnimatorClipInfo {
  ...
  public AnimationClip clip {
    get {
      return m_ClipInstanceID != 0
                 ? InstanceIDToAnimationClipPPtr(m_ClipInstanceID)
                 : null;
    }
  }
  ...
  [FreeFunction(
      "AnimationBindings::InstanceIDToAnimationClipPPtr")] extern private static AnimationClip
  InstanceIDToAnimationClipPPtr(int instanceID);
...
public struct AnimatorStateInfo {
  ...
  [Obsolete(
      "AnimatorStateInfo.nameHash has been deprecated. Use AnimatorStateInfo.fullPathHash instead.")]
  public int nameHash {
    get { return m_Path; }
  }
...
public struct AnimatorTransitionInfo {
  ...
  public bool IsName(string name) {
    return Animator.StringToHash(name) == m_Name ||
           Animator.StringToHash(name) == m_FullPath;
  }
  ...
  // The duration unit: can be either Fixed (in seconds) or Normalized (in
  // percentage)
  public DurationUnit durationUnit {
    get {
      return m_HasFixedDuration ? DurationUnit.Fixed : DurationUnit.Normalized;
    }
  }
  ...
  internal bool entry {
    get { return (m_TransitionType & (int) TransitionType.Entry) != 0; }
  }

  internal bool exit {
    get { return (m_TransitionType & (int) TransitionType.Exit) != 0; }
  }
...
public struct MatchTargetWeightMask {
  ...
  public MatchTargetWeightMask(Vector3 positionXYZWeight,
...
public partial class Animator : Behaviour {
  ...
  extern public bool isOptimizable { [NativeMethod("IsOptimizable")] get; }

  // Returns true if the current rig is ''humanoid'', false if it is ''generic''
  extern public bool isHuman { [NativeMethod("IsHuman")] get; }

  // Returns true if the current generic rig has a root motion
  extern public bool hasRootMotion { [NativeMethod("HasRootMotion")] get; }
  ...
  extern internal bool isRootPositionOrRotationControlledByCurves {
    [NativeMethod("IsRootTranslationOrRotationControllerByCurves")] get;
  }

  // Returns the scale of the current Avatar for a humanoid rig, (1 by default
  // if the rig is generic)
  extern public float humanScale { get; }

  // Return true if the animator is currently initialized and ready to be use
  extern public bool isInitialized { [NativeMethod("IsInitialized")] get; }
  ...
  // Returns true if a parameter is controlled by an additional curve on an
  // animation
  ...
  [Obsolete(
      "Animator.linearVelocityBlending is no longer used and has been deprecated.")] extern public bool
      linearVelocityBlending {
    get;
    set;
  }

  // When turned on, animations will be executed in the physics loop. This is
  // only useful in conjunction with kinematic rigidbodies.
  [Obsolete(
      "Animator.animatePhysics has been deprecated. Use Animator.updateMode instead.")]
  public bool animatePhysics {
    get { return updateMode == AnimatorUpdateMode.AnimatePhysics; }
    set {
      updateMode = (value ? AnimatorUpdateMode.AnimatePhysics
  ...
  extern public bool hasTransformHierarchy { get; }
  ...
  extern public float gravityWeight { get; }
  ...
  extern internal Vector3 bodyPositionInternal {
    ...
    [NativeMethod("SetBodyPosition")] set;
  }
  ...
  extern internal Quaternion bodyRotationInternal {
    ...
    [NativeMethod("SetBodyRotation")] set;
  }
  ...
  extern private void SetGoalRotation(AvatarIKGoal goal,
  ...
  // before IK, 1 = points toward the hint)
  ...
  [NativeMethod("SetLookAtPosition")] extern private void
  ...
  public void SetLookAtWeight(float weight,
    ...
    CheckIfInIKPass();
    SetLookAtWeightInternal(weight, bodyWeight, headWeight, eyesWeight,
                            clampWeight);
  }

  [NativeMethod("SetLookAtWeight")] extern private void
  SetLookAtWeightInternal(float weight, float bodyWeight, float headWeight,
                          float eyesWeight, float clampWeight);

  // Set Local Rotation of humanoid bone during IK pass
  public void SetBoneLocalRotation(HumanBodyBones humanBoneId,
                                   Quaternion rotation) {
    CheckIfInIKPass();
    SetBoneLocalRotationInternal(
        HumanTrait.GetBoneIndexFromMono((int) humanBoneId), rotation);
  }

  [NativeMethod("SetBoneLocalRotation")] extern private void
  SetBoneLocalRotationInternal(int humanBoneId, Quaternion rotation);
  ...
  private static T[] ConvertStateMachineBehaviour<T>(
      ScriptableObject[] rawObjects) where T : StateMachineBehaviour {
    if (rawObjects == null)
      return null;
  ...
  [FreeFunction(Name = "AnimatorBindings::InternalGetBehaviours",
                HasExplicitThis = true)] extern internal
      ScriptableObject[] InternalGetBehaviours([ NotNull ] Type type);

  public StateMachineBehaviour[] GetBehaviours(int fullPathHash,
                                               int layerIndex) {
    return InternalGetBehavioursByKey(fullPathHash, layerIndex,
                                      typeof(StateMachineBehaviour))
        as StateMachineBehaviour[];
  }

  [FreeFunction(Name = "AnimatorBindings::InternalGetBehavioursByKey",
                HasExplicitThis = true)] extern internal
      ScriptableObject[] InternalGetBehavioursByKey(int fullPathHash,
                                                    int layerIndex,
                                                    [ NotNull ] Type type);
  ...
  extern public int layerCount { get; }
  ...
  extern private void GetAnimatorStateInfo(int layerIndex,
  ...
  extern private void
  GetAnimatorTransitionInfo(int layerIndex, out AnimatorTransitionInfo info);
  ...
  [FreeFunction(Name = "AnimatorBindings::GetCurrentAnimatorClipInfo",
                HasExplicitThis = true)] extern public AnimatorClipInfo
      [] GetCurrentAnimatorClipInfo(int layerIndex);

  [FreeFunction(Name = "AnimatorBindings::GetNextAnimatorClipInfo",
                HasExplicitThis = true)] extern public AnimatorClipInfo
      [] GetNextAnimatorClipInfo(int layerIndex);

  // Gets the list of AnimatorClipInfo currently played by the current state
  public void GetCurrentAnimatorClipInfo(int layerIndex,
  ...
  [FreeFunction(Name = "AnimatorBindings::GetAnimatorClipInfoInternal",
                HasExplicitThis = true)] extern private void
  GetAnimatorClipInfoInternal(int layerIndex, bool isCurrent, object clips);
  ...
  extern public AnimatorControllerParameter[] parameters {
    [FreeFunction(Name = "AnimatorBindings::GetParameters",
                  HasExplicitThis = true)] get;
  }

  extern public int parameterCount { get; }
  ...
  // Blends pivot point between body center of mass and feet pivot. At 0%, the
  // blending point is body center of mass. At 100%, the blending point is feet
  // pivot
  ...
  extern public float pivotWeight { get; }

  // Get the current position of the pivot
  extern public Vector3 pivotPosition { get; }

  extern private void MatchTarget(Vector3 matchPosition,
                                  Quaternion matchRotation, int targetBodyPart,
  ...
  // AvatarTarget reaches the matchPosition when the current state is at the
  // specified progress
  public void MatchTarget(Vector3 matchPosition, Quaternion matchRotation,
                          AvatarTarget targetBodyPart,
                          MatchTargetWeightMask weightMask,
                          float startNormalizedTime) {
    MatchTarget(matchPosition, matchRotation, (int) targetBodyPart, weightMask,
                startNormalizedTime, 1);
  }
  ...
  public void InterruptMatchTarget() { InterruptMatchTarget(true); }

  extern public void
  InterruptMatchTarget([ DefaultValue("true") ] bool completeMatch);

  // If automatic matching is active
  extern public bool isMatchingTarget {
    [NativeMethod("IsMatchingTarget")] get;
  }
  ...
  [Obsolete(
      "ForceStateNormalizedTime is deprecated. Please use Play or CrossFade instead.")]
  ...
  public void CrossFadeInFixedTime(string stateName,
    ...
    int layer = -1;
    CrossFadeInFixedTime(StringToHash(stateName), fixedTransitionDuration,
                         layer, fixedTimeOffset, normalizedTransitionTime);
  }

  public void CrossFadeInFixedTime(string stateName,
                                   float fixedTransitionDuration, int layer) {
    float normalizedTransitionTime = 0.0f;
    float fixedTimeOffset = 0.0f;
    CrossFadeInFixedTime(StringToHash(stateName), fixedTransitionDuration,
                         layer, fixedTimeOffset, normalizedTransitionTime);
  ...
  public void CrossFadeInFixedTime(int stateHashName,
                                   float fixedTransitionDuration, int layer,
                                   float fixedTimeOffset) {
    float normalizedTransitionTime = 0.0f;
    CrossFadeInFixedTime(stateHashName, fixedTransitionDuration, layer,
                         fixedTimeOffset, normalizedTransitionTime);
  }
  ...
  [FreeFunction(Name = "AnimatorBindings::CrossFadeInFixedTime",
                HasExplicitThis = true)] extern public void
  CrossFadeInFixedTime(int stateHashName, float fixedTransitionDuration,
                       [ DefaultValue("-1") ] int layer,
                       [ DefaultValue("0.0f") ] float fixedTimeOffset,
                       [ DefaultValue("0.0f") ] float normalizedTransitionTime);

  [FreeFunction(Name = "AnimatorBindings::WriteDefaultValues",
                HasExplicitThis = true)] extern public void
  WriteDefaultValues();

  public void CrossFade(string stateName, float normalizedTransitionDuration,
                        int layer, float normalizedTimeOffset) {
    float normalizedTransitionTime = 0.0f;
  ...
  public void CrossFade(
      ...
      [ DefaultValue("0.0f") ] float normalizedTransitionTime) {
    CrossFade(StringToHash(stateName), normalizedTransitionDuration, layer,
              normalizedTimeOffset, normalizedTransitionTime);
  }

  [FreeFunction(Name = "AnimatorBindings::CrossFade",
                HasExplicitThis = true)] extern public void
  CrossFade(int stateHashName, float normalizedTransitionDuration,
            [ DefaultValue("-1") ] int layer,
  ...
  public void
  PlayInFixedTime(string stateName, [ DefaultValue("-1") ] int layer,
                  [ DefaultValue("float.NegativeInfinity") ] float fixedTime) {
    PlayInFixedTime(StringToHash(stateName), layer, fixedTime);
  }

  [FreeFunction(Name = "AnimatorBindings::PlayInFixedTime",
                HasExplicitThis = true)] extern public void
  PlayInFixedTime(int stateNameHash, [ DefaultValue("-1") ] int layer,
                  [ DefaultValue("float.NegativeInfinity") ] float fixedTime);
  ...
  public void
  Play(string stateName, [ DefaultValue("-1") ] int layer,
       [ DefaultValue("float.NegativeInfinity") ] float normalizedTime) {
    Play(StringToHash(stateName), layer, normalizedTime);
  }

  [FreeFunction(Name = "AnimatorBindings::Play",
                HasExplicitThis = true)] extern public void
  Play(int stateNameHash, [ DefaultValue("-1") ] int layer,
       [ DefaultValue("float.NegativeInfinity") ] float normalizedTime);
  ...
  extern public void SetTarget(AvatarTarget targetIndex,
                               float targetNormalizedTime);

  //  Returns the position of the target specified by SetTarget(AvatarTarget
  //  targetIndex, float targetNormalizedTime))
  extern public Vector3 targetPosition { get; }
  //  Returns the rotation of the target specified by SetTarget(AvatarTarget
  //  targetIndex, float targetNormalizedTime))
  extern public Quaternion targetRotation { get; }
  ...
  extern internal Transform avatarRoot { get; }

  public Transform GetBoneTransform(HumanBodyBones humanBoneId) {
    if (humanBoneId < 0 || humanBoneId >= HumanBodyBones.LastBone)
      throw new IndexOutOfRangeException("humanBoneId must be between 0 and " +
                                         HumanBodyBones.LastBone);

    return GetBoneTransformInternal(
        HumanTrait.GetBoneIndexFromMono((int) humanBoneId));
  }

  [NativeMethod("GetBoneTransform")] extern internal
  ...
  public float recorderStartTime {
    ...
    //[Obsolete("Animator.recorderStartTime cannot be set. You need to use
    //Animator.StartRecording() instead.", true)]
    set {}
  }
  ...
  public float recorderStopTime {
    ...
    // Obsolete is not supported right now on property get/set
    // @jonh to avoid a breaking API change we simply left an empty set for now
    //[Obsolete("Animator.recorderStopTime cannot be set. You need to use
    //Animator.StopRecording() instead.", true)]
    set {}
  }

  extern private float GetRecorderStopTime();

  extern public AnimatorRecorderMode recorderMode { get; }
  ...
  extern public bool hasBoundPlayables {
    [NativeMethod("HasBoundPlayables")] get;
  }
  ...
  [NativeMethod(Name = "ScriptingStringToCRC32",
  ...
  [FreeFunction(Name = "AnimatorBindings::GetCurrentGraph",
                HasExplicitThis = true)] extern private void
  GetCurrentGraph(ref PlayableGraph graph);
  ...
  [FreeFunction(Name = "AnimatorBindings::SetFloatString",
                HasExplicitThis = true)] extern private void
  SetFloatString(string name, float value);

  [FreeFunction(Name = "AnimatorBindings::SetFloatID",
                HasExplicitThis = true)] extern private void
  SetFloatID(int id, float value);

  [FreeFunction(Name = "AnimatorBindings::GetFloatString",
                HasExplicitThis = true)] extern private float
  GetFloatString(string name);
  [FreeFunction(Name = "AnimatorBindings::GetFloatID",
                HasExplicitThis = true)] extern private float
  GetFloatID(int id);

  [FreeFunction(Name = "AnimatorBindings::SetBoolString",
                HasExplicitThis = true)] extern private void
  SetBoolString(string name, bool value);
  [FreeFunction(Name = "AnimatorBindings::SetBoolID",
                HasExplicitThis = true)] extern private void
  SetBoolID(int id, bool value);

  [FreeFunction(Name = "AnimatorBindings::GetBoolString",
                HasExplicitThis = true)] extern private bool
  GetBoolString(string name);
  [FreeFunction(Name = "AnimatorBindings::GetBoolID",
                HasExplicitThis = true)] extern private bool GetBoolID(int id);

  [FreeFunction(Name = "AnimatorBindings::SetIntegerString",
                HasExplicitThis = true)] extern private void
  SetIntegerString(string name, int value);
  [FreeFunction(Name = "AnimatorBindings::SetIntegerID",
                HasExplicitThis = true)] extern private void
  SetIntegerID(int id, int value);

  [FreeFunction(Name = "AnimatorBindings::GetIntegerString",
                HasExplicitThis = true)] extern private int
  GetIntegerString(string name);
  [FreeFunction(Name = "AnimatorBindings::GetIntegerID",
                HasExplicitThis = true)] extern private int
  GetIntegerID(int id);

  [FreeFunction(Name = "AnimatorBindings::SetTriggerString",
                HasExplicitThis = true)] extern private void
  SetTriggerString(string name);
  [FreeFunction(Name = "AnimatorBindings::SetTriggerID",
                HasExplicitThis = true)] extern private void
  SetTriggerID(int id);

  [FreeFunction(Name = "AnimatorBindings::ResetTriggerString",
                HasExplicitThis = true)] extern private void
  ResetTriggerString(string name);
  [FreeFunction(Name = "AnimatorBindings::ResetTriggerID",
                HasExplicitThis = true)] extern private void
  ResetTriggerID(int id);

  [FreeFunction(Name = "AnimatorBindings::IsParameterControlledByCurveString",
                HasExplicitThis = true)] extern private bool
  IsParameterControlledByCurveString(string name);
  [FreeFunction(Name = "AnimatorBindings::IsParameterControlledByCurveID",
                HasExplicitThis = true)] extern private bool
  IsParameterControlledByCurveID(int id);

  [FreeFunction(Name = "AnimatorBindings::SetFloatStringDamp",
                HasExplicitThis = true)] extern private void
  SetFloatStringDamp(string name, float value, float dampTime, float deltaTime);
  [FreeFunction(Name = "AnimatorBindings::SetFloatIDDamp",
                HasExplicitThis = true)] extern private void
  SetFloatIDDamp(int id, float value, float dampTime, float deltaTime);
  ...
  extern public float leftFeetBottomHeight { get; }

  // Get right foot bottom height.
  extern public float rightFeetBottomHeight { get; }

  [NativeConditional("UNITY_EDITOR")] extern internal bool
      supportsOnAnimatorMove {
    [NativeMethod("SupportsOnAnimatorMove")] get;
  }

  [NativeConditional("UNITY_EDITOR")] extern internal void
  OnUpdateModeChanged();

  [NativeConditional("UNITY_EDITOR")] extern internal void
  OnCullingModeChanged();

  [NativeConditional("UNITY_EDITOR")] extern internal void WriteDefaultPose();

  [NativeMethod("UpdateWithDelta")] extern public void Update(float deltaTime);

  public void Rebind() { Rebind(true); }
  extern private void Rebind(bool writeDefaultValues);

  // Applies the default root motion. Use in OnAvatarMove when you don't want to
  // override the default root motion.
  extern public void ApplyBuiltinRootMotion();

  // Evalutes only the StateMachine, does not write into transforms, uses
  // previous deltaTime Mostly used for editor previews ( BlendTrees )
  [NativeConditional("UNITY_EDITOR")]
  internal void EvaluateController() {
    EvaluateController(0);
  }
  extern private void EvaluateController(float deltaTime);

  [NativeConditional("UNITY_EDITOR")]
  internal string GetCurrentStateName(int layerIndex) {
    return GetAnimatorStateName(layerIndex, true);
  }

  [NativeConditional("UNITY_EDITOR")]
  internal string GetNextStateName(int layerIndex) {
    return GetAnimatorStateName(layerIndex, false);
  }

  [NativeConditional("UNITY_EDITOR")] extern private string
  GetAnimatorStateName(int layerIndex, bool current);
