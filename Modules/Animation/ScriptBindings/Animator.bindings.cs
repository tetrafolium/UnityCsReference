...
public struct AnimatorClipInfo
{
    ...
    {
        get {
            return m_ClipInstanceID != 0 ? InstanceIDToAnimationClipPPtr(m_ClipInstanceID) : null;
        }
    }
...
public struct AnimatorTransitionInfo
{
    ...
    internal bool entry                   {
        get {
            return (m_TransitionType & (int)TransitionType.Entry) != 0;
        }
    }

    internal bool exit                    {
        get {
            return (m_TransitionType & (int)TransitionType.Exit) != 0;
        }
    }
