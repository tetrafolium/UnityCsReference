...
[NativeHeader(
	 "Modules/Animation/ScriptBindings/AnimationPosePlayable.bindings.h")]
[NativeHeader("Modules/Animation/Director/AnimationPosePlayable.h")]
[NativeHeader("Runtime/Director/Core/HPlayable.h")]
[StaticAccessor("AnimationPosePlayableBindings",
                StaticAccessorType.DoubleColon)]
[RequiredByNativeCode]
internal struct AnimationPosePlayable : IPlayable,
	IEquatable<AnimationPosePlayable> {
	PlayableHandle m_Handle;

	static readonly AnimationPosePlayable m_NullPlayable =
		new AnimationPosePlayable(PlayableHandle.Null);
		...
		if (handle.IsValid()) {
			if (!handle.IsPlayableOfType<AnimationPosePlayable>())
				throw new InvalidCastException(
					      "Can't set handle: the playable is not an AnimationPosePlayable.");
		}
	...
	[NativeThrows] extern static private bool
	GetMustReadPreviousPoseInternal(ref PlayableHandle handle);
	[NativeThrows] extern static private void
	SetMustReadPreviousPoseInternal(ref PlayableHandle handle, bool value);
	[NativeThrows] extern static private bool
	GetReadDefaultPoseInternal(ref PlayableHandle handle);
	[NativeThrows] extern static private void
	SetReadDefaultPoseInternal(ref PlayableHandle handle, bool value);
	[NativeThrows] extern static private bool
