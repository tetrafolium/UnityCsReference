...
public sealed partial class AvatarMask : Object {
  public AvatarMask() { Internal_Create(this); }

  [FreeFunction(
      "AnimationBindings::CreateAvatarMask")] extern private static void
  Internal_Create([ Writable ] AvatarMask self);

  [Obsolete(
      "AvatarMask.humanoidBodyPartCount is deprecated, use AvatarMaskBodyPart.LastBodyPart instead.")]
  public int humanoidBodyPartCount {
    get { return (int) AvatarMaskBodyPart.LastBodyPart; }
  }

  [NativeMethod("GetBodyPart")] extern public bool
  GetHumanoidBodyPartActive(AvatarMaskBodyPart index);

  [NativeMethod("SetBodyPart")] extern public void
  SetHumanoidBodyPartActive(AvatarMaskBodyPart index, bool value);

  extern public int transformCount {
    get;
    set;
  }
  ...
  extern public void AddTransformPath([ NotNull ] Transform transform,
                                      [ DefaultValue("true") ] bool recursive);

  public void RemoveTransformPath(Transform transform) {
    RemoveTransformPath(transform, true);
  }
  extern public void
  RemoveTransformPath([ NotNull ] Transform transform,
                      [ DefaultValue("true") ] bool recursive);
  ...
  public void SetTransformActive(int index, bool value) {
    SetTransformWeight(index, value ? 1.0F : 0.0F);
  }
