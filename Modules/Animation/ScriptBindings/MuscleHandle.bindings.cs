  ...
  [NativeHeader("Modules/Animation/Animator.h")] // -> dof enum
    ...
    public MuscleHandle(HumanPartDof partDof, LegDof legDof) {
      if (partDof != HumanPartDof.LeftLeg && partDof != HumanPartDof.RightLeg)
        throw new InvalidOperationException(
            "Invalid HumanPartDof for a leg, please use either HumanPartDof.LeftLeg or HumanPartDof.RightLeg.");
    ...
    public MuscleHandle(HumanPartDof partDof, ArmDof armDof) {
      if (partDof != HumanPartDof.LeftArm && partDof != HumanPartDof.RightArm)
        throw new InvalidOperationException(
            "Invalid HumanPartDof for an arm, please use either HumanPartDof.LeftArm or HumanPartDof.RightArm.");
    ...
    public MuscleHandle(HumanPartDof partDof, FingerDof fingerDof) {
      if (partDof < HumanPartDof.LeftThumb ||
          partDof > HumanPartDof.RightLittle)
        throw new InvalidOperationException(
            "Invalid HumanPartDof for a finger.");
    ...
    public extern static void
        GetMuscleHandles([NotNull]
                         [Out] MuscleHandle[] muscleHandles);
