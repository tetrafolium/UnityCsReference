...
public sealed partial class AimConstraint : Behaviour,
	      IConstraint,
	      IConstraintInternal {
...
public extern Vector3 aimVector {
	get;
	set;
}
public extern Vector3 upVector {
	get;
	set;
}
public extern Vector3 worldUpVector {
	get;
	set;
}
...
GetSourceCountInternal([ NotNull ] AimConstraint self);
...
SetSourcesInternal([ NotNull ] AimConstraint self,
...
private void ValidateSourceIndex(int index) {
	if (sourceCount == 0) {
		throw new InvalidOperationException(
			      "The AimConstraint component has no sources.");
	}
