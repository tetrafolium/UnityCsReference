...
public sealed partial class LookAtConstraint : Behaviour,
	      IConstraint,
	      IConstraintInternal {
LookAtConstraint() {
...
Internal_Create([ Writable ] LookAtConstraint self);
...
GetSourceCountInternal([ NotNull ] LookAtConstraint self);
...
private static extern void
SetSourcesInternal([ NotNull ] LookAtConstraint self,
...
private void ValidateSourceIndex(int index) {
	if (sourceCount == 0) {
		throw new InvalidOperationException(
			      "The LookAtConstraint component has no sources.");
	}
