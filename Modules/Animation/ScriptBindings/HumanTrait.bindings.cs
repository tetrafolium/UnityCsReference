...
public class HumanTrait {
  // Number of muscles
  extern public static int MuscleCount { get; }
  ...
  extern public static string[] MuscleName {
    [NativeMethod("GetMuscleNames")] get;
  }

  // Number of bones
  extern public static int BoneCount { get; }

  // Bone's name
  extern public static string[] BoneName {
    [NativeMethod("MonoBoneNames")] get;
  }

  // Return muscle index linked to bone i, dofIndex allow you to choose between
  // X, Y and Z muscle's axis
  public static int MuscleFromBone(int i, int dofIndex) {
    return Internal_MuscleFromBone(GetBoneIndexFromMono(i), dofIndex);
  }

  [NativeMethod("MuscleFromBone")] extern static int
  Internal_MuscleFromBone(int i, int dofIndex);
  ...
  [NativeMethod("BoneFromMuscle")] extern static int
  Internal_BoneFromMuscle(int i);
  ...
  [NativeMethod("RequiredBone")] extern static bool
  Internal_RequiredBone(int i);

  // Number of required bones.
  extern public static int RequiredBoneCount {
    [NativeMethod("RequiredBoneCount")] get;
  }
  ...
  [NativeMethod("GetBoneHierarchyMass")] extern static float
  Internal_GetBoneHierarchyMass(int i);

  [NativeMethod("GetParent")] extern static int Internal_GetParent(int i);
}
}
