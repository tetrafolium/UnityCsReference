...
[Obsolete(
    "This class is not used anymore. See AnimatorOverrideController.GetOverrides() and AnimatorOverrideController.ApplyOverrides()")]
[Serializable]
...
public class AnimatorOverrideController : RuntimeAnimatorController {
  ...
  [FreeFunction(
      "AnimationBindings::CreateAnimatorOverrideController")] extern private static void
  Internal_Create([ Writable ] AnimatorOverrideController self,
                  RuntimeAnimatorController controller);

  // The runtime representation of AnimatorController that controls the Animator
  extern public RuntimeAnimatorController runtimeAnimatorController {
    [NativeMethod("GetAnimatorController")] get;
    [NativeMethod("SetAnimatorController")] set;
  }
  ...
  [NativeMethod("GetClip")] extern private AnimationClip
  Internal_GetClipByName(string name, bool returnEffectiveClip);

  [NativeMethod("SetClip")] extern private void
  Internal_SetClipByName(string name, AnimationClip clip);
  ...
  extern private AnimationClip GetClip(AnimationClip originalClip,
                                       bool returnEffectiveClip);

  extern private void SetClip(AnimationClip originalClip,
                              AnimationClip overrideClip, bool notify);
  ...
  extern public int overridesCount {
    [NativeMethod("GetOriginalClipsCount")] get;
  }

  public void
  GetOverrides(List<KeyValuePair<AnimationClip, AnimationClip>> overrides) {
    if (overrides == null)
    ...
    for (int i = 0; i < count; ++i) {
      ...
      overrides.Add(new KeyValuePair<AnimationClip, AnimationClip>(
          originalClip, GetOverrideClip(originalClip)));
    }
  }

  public void
  ApplyOverrides(IList<KeyValuePair<AnimationClip, AnimationClip>> overrides) {
    if (overrides == null)
      throw new System.ArgumentNullException("overrides");
  ...
  [Obsolete(
      "AnimatorOverrideController.clips property is deprecated. Use AnimatorOverrideController.GetOverrides and AnimatorOverrideController.ApplyOverrides instead.")]
  ...
  OnInvalidateOverrideController(AnimatorOverrideController controller) {
