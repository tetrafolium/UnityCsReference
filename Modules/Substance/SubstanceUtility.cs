...
using
RequiredByNativeCodeAttribute=UnityEngine.Scripting.RequiredByNativeCodeAttribute;
...
public sealed partial class ProceduralMaterial : Material {
  internal ProceduralMaterial() : base((Material) null) { FeatureRemoved(); }
  ...
  public void ClearCache() { FeatureRemoved(); }
  ...
  public void RebuildTextures() { FeatureRemoved(); }

  public void RebuildTexturesImmediately() { FeatureRemoved(); }
  ...
  public static void StopRebuilds() { FeatureRemoved(); }
  ...
  public void FreezeAndReleaseSourceData() { FeatureRemoved(); }
