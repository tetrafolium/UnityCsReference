...
public sealed partial class Terrain : Behaviour
{
    ...
    extern public int lightmapIndex {
        get;
        set;
    }

    [NativeProperty("DynamicLightmapIndexInt")]
    extern public int realtimeLightmapIndex {
        get;
        set;
    }

    [NativeProperty("StaticLightmapST")]
    extern public Vector4 lightmapScaleOffset {
        get;
        set;
    }

    [NativeProperty("DynamicLightmapST")]
    extern public Vector4 realtimeLightmapScaleOffset {
        get;
        set;
    }
    ...
    extern static public GraphicsFormat heightmapFormat {
        get;
    }
    ...
    {
        get {
            return GraphicsFormatUtility.GetTextureFormat(heightmapFormat);
        }
    }
    ...
    [StaticAccessor("Terrain", StaticAccessorType.DoubleColon)]
    extern static public GraphicsFormat normalmapFormat {
        get;
    }
    ...
    {
        get {
            return GraphicsFormatUtility.GetTextureFormat(normalmapFormat);
        }
    }
    ...
    [StaticAccessor("Terrain", StaticAccessorType.DoubleColon)]
    extern static public GraphicsFormat holesFormat {
        get;
    }
    ...
    {
        get {
            return GraphicsFormatUtility.GetRenderTextureFormat(holesFormat);
        }
    }

    [StaticAccessor("Terrain", StaticAccessorType.DoubleColon)]
    extern static public GraphicsFormat compressedHolesFormat {
        get;
    }
    ...
    extern public static Terrain[] activeTerrains {
        get;
    }
...
public sealed partial class Tree : Component
{
    ...
    extern public ScriptableObject data {
        get;
        set;
    }
