...
namespace UnityEngine.Tilemaps {
  ...
  public class ITilemap {
    ...
    internal void SetTilemapInstance(Tilemap tilemap) { m_Tilemap = tilemap; }

    // Tilemap
    public Vector3Int origin {
      get { return m_Tilemap.origin; }
    }
    public Vector3Int size {
      get { return m_Tilemap.size; }
    }
    public Bounds localBounds {
      get { return m_Tilemap.localBounds; }
    }
    public BoundsInt cellBounds {
      get { return m_Tilemap.cellBounds; }
    }
    ...
    public T GetComponent<T>() { return m_Tilemap.GetComponent<T>(); }
