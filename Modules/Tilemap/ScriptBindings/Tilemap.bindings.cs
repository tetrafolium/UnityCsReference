...
public extern Grid layoutGrid {
	[NativeMethod(Name = "GetAttachedGrid")] get;
}
...
public BoundsInt cellBounds {
	get { return new BoundsInt(origin, size); }
}
...
public extern Matrix4x4 orientationMatrix {
	[NativeMethod(Name = "GetTileOrientationMatrix")] get;
	[NativeMethod(Name = "SetOrientationMatrix")] set;
}
...
internal extern Object[] GetTileAssetsBlock(Vector3Int position,
                                            Vector3Int blockDimensions);
...
internal extern void SetTileAssets(Vector3Int[] positionArray,
                                   Object[] tileArray);
...
private extern void INTERNAL_CALL_SetTileAssetsBlock(
	Vector3Int position, Vector3Int blockDimensions, Object[] tileArray);
...
[FreeFunction(Name = "TilemapBindings::GetUsedTilesNonAlloc",
...
public extern void SetTransformMatrix(Vector3Int position,
                                      Matrix4x4 transform);
...
public extern void SetColliderType(Vector3Int position,
...
public void BoxFill(Vector3Int position, TileBase tile, int startX,
                    int startY, int endX, int endY) {
	BoxFillTileAsset(position, tile, startX, startY, endX, endY);
}

[NativeMethod(Name = "BoxFill")]
private extern void BoxFillTileAsset(Vector3Int position, Object tile,
...
public extern void InsertCells(Vector3Int position, int numColumns,
                               int numRows, int numLayers);
...
public extern void DeleteCells(Vector3Int position, int numColumns,
                               int numRows, int numLayers);
...
public extern Vector3Int editorPreviewOrigin {
	[NativeMethod(Name = "GetRenderOrigin")] get;
}

public extern Vector3Int editorPreviewSize {
	[NativeMethod(Name = "GetRenderSize")] get;
}
...
public TileBase GetEditorPreviewTile(Vector3Int position) {
	return GetEditorPreviewTileAsset(position) as TileBase;
}
public T GetEditorPreviewTile<T>(Vector3Int position) where T : TileBase {
	return GetEditorPreviewTile(position) as T;
}

internal extern void SetEditorPreviewTileAsset(Vector3Int position,
                                               Object tile);
...
public extern Matrix4x4
GetEditorPreviewTransformMatrix(Vector3Int position);
public extern void SetEditorPreviewTransformMatrix(Vector3Int position,
                                                   Matrix4x4 transform);
...
private extern void EditorPreviewFloodFillTileAsset(Vector3Int position,
                                                    Object tile);

public void EditorPreviewBoxFill(Vector3Int position, Object tile,
                                 int startX, int startY, int endX,
                                 int endY) {
...
private extern void
EditorPreviewBoxFillTileAsset(Vector3Int position, Object tile, int startX,
                              int startY, int endX, int endY);
...
public extern Vector3 chunkCullingBounds {
	[FreeFunction("TilemapRendererBindings::GetChunkCullingBounds",
	              HasExplicitThis = true)] get;
	[FreeFunction("TilemapRendererBindings::SetChunkCullingBounds",
...
public partial struct TileAnimationData {
	...
	public float animationStartTime {
		...
		set { m_AnimationStartTime = value; }
	}
...
public extern bool hasTilemapChanges {
	[NativeMethod("HasTilemapChanges")] get;
}
