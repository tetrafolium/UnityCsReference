...
internal class PackageDatabase : ISerializationCallbackReceiver
{
    ...
    public virtual bool isInstallOrUninstallInProgress
    {
        ...
        get {
            return m_UpmClient.isAddRemoveOrEmbedInProgress;
        }
    }
    ...
    public virtual IEnumerable<IPackage> assetStorePackages {
        get {
            return m_Packages.Values.Where(p => p is AssetStorePackage);
        }
    }
    public virtual IEnumerable<IPackage> upmPackages {
        get {
            return m_Packages.Values.Where(p => p is UpmPackage);
        }
    }
