...
namespace UnityEditor.PackageManager.UI {
  ...
  internal class PackageSizeInfo : ISerializationCallbackReceiver {
    ...
    public SemVersion supportedUnityVersion {
      get { return m_SupportedUnityVersion; }
      set {
    ...
    public void OnAfterDeserialize() {
      // m_SupportedUnityVersionString will always be valid because it is set
      // from an existing SemVersion
      m_SupportedUnityVersion =
          SemVersionParser.Parse(m_SupportedUnityVersionString);
    }
  }
}
