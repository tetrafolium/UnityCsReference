...
namespace UnityEditor.PackageManager.UI {
  ...
  internal class ApplicationProxy {
    ...
    public virtual event Action<PlayModeStateChange>
        onPlayModeStateChanged = delegate{};

    public virtual string userAppDataPath => InternalEditorUtility
                                                 .userAppDataFolder;
    ...
    public void OnEnable() {
      m_IsInternetReachable = Application.internetReachability ==
