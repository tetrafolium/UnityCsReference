...
namespace UnityEditor.PackageManager.UI {
  internal class PackageManagerProjectSettingsProxy {
    ...
    public virtual bool enablePreviewPackages {
      ...
      set => PackageManagerProjectSettings.instance.enablePreviewPackages =
          value;
    }
    ...
    public void OnEnable() {
      PackageManagerProjectSettings.instance.onEnablePreviewPackagesChanged +=
          OnEnablePreviewPackagesChanged;
    }
