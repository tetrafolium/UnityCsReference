...
namespace UnityEditor.PackageManager.UI {
  ...
  internal class UnityConnectProxy {
    ...
    public void OnEnable() {
      ...
      m_HasAccessToken =
          !string.IsNullOrEmpty(UnityConnect.instance.userInfo.accessToken);
    ...
    public virtual void ShowLogin() { UnityConnect.instance.ShowLogin(); }
    ...
    private void OnUserStateChanged(UserInfo newInfo) {
      ...
      if (isUerInfoReadyOld != isUserInfoReady ||
          isUserLoggedIn != isUserLoggedInOld)
