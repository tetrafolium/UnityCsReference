...
namespace UnityEditor.PackageManager.UI {
  internal static class SemVersionExtension {
    ...
    public static bool IsPatchOf(this SemVersion version,
                                 SemVersion? olderVersion) {
      return version.Major == olderVersion?.Major &&
             version.Minor == olderVersion?.Minor && version > olderVersion;
    }
