...
namespace UnityEditor.PackageManager.UI {
  internal class PackageSampleList : VisualElement {
    ...
    public PackageSampleList() {
      ...
      samplesExpander.RegisterValueChangedCallback(
    ...
    public void SetPackageVersion(IPackageVersion version) {
      ...
      foreach (var sample in samples) {
        ...
        var sampleVisualItemLowWidth =
            new PackageDependencySampleItemLowWidth(version, sample);
    ...
    private Toggle samplesExpander {
      get { return cache.Get<Toggle>("samplesExpander"); }
    }
    internal VisualElement samplesListLowWidth {
      get { return cache.Get<VisualElement>("samplesListLowWidth"); }
    }
    private VisualElement samplesOuterContainer {
      get { return cache.Get<VisualElement>("samplesOuterContainer"); }
    }
    internal VisualElement samplesContainer {
      get { return cache.Get<VisualElement>("samplesContainer"); }
    }
    internal VisualElement importStatusContainer {
      get { return cache.Get<VisualElement>("importStatusContainer"); }
    }
    internal VisualElement nameAndSizeLabelContainer {
      get { return cache.Get<VisualElement>("nameAndSizeLabelContainer"); }
    }
    internal VisualElement importButtonContainer {
      get { return cache.Get<VisualElement>("importButtonContainer"); }
    }
  }
}
