...
internal class PackageDependencySampleItemLowWidth : VisualElement
{
    ...
    private VisualElement itemStatusNameContainer {
        get {
            return cache.Get<VisualElement>("itemStatusNameContainer");
        }
    }
    private Label itemName {
        get {
            return cache.Get<Label>("itemName");
        }
    }
    private TextField itemSizeOrVersion {
        get {
            return cache.Get<TextField>("itemSizeOrVersion");
        }
    }
    private VisualElement item {
        get {
            return cache.Get<VisualElement>("dependencySampleItemLowWidth");
        }
    }
}
}
