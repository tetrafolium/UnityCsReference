...
internal class PackageManagerPrefs
{
    ...
    private static string lastUsedFilterForProjectPerfs {
        get {
            return k_LastUsedFilterPrefsPrefix + projectIdentifier;
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool(k_SkipRemoveConfirmationPrefs, false);
        }
        set {
            EditorPrefs.SetBool(k_SkipRemoveConfirmationPrefs, value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool(k_SkipDisableConfirmationPrefs, false);
        }
        set {
            EditorPrefs.SetBool(k_SkipDisableConfirmationPrefs, value);
        }
    }
    ...
    {
        get {
            return EditorPrefs.GetBool(k_ShowPackageDependenciesPrefs, false);
        }
        set
        {
    ...
    {
        get {
            return m_NumItemsPerPage <= 0 ? (int?)null : m_NumItemsPerPage;
        }
        set {
            m_NumItemsPerPage = value ?? 0;
        }
    }
