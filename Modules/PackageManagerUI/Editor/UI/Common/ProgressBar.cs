...
public void UpdateProgress(IOperation operation) {
	var showProgressBar = operation != null &&
	                      operation.isProgressTrackable &&
	                      operation.isProgressVisible;
...
private Label currentProgressBar {
	get { return cache.Get<Label>("currentProgressBar"); }
}
private Label currentProgressText {
	get { return cache.Get<Label>("currentProgressText"); }
}
}
}
