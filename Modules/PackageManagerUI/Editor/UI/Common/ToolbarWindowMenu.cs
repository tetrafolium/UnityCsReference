...
namespace UnityEditor.PackageManager.UI {
  internal class ToolbarWindowMenu : Button {
    ...
    private static readonly string textUssClassName =
        newUssClassName + "__text";
    private static readonly string arrowUssClassName =
        newUssClassName + "__arrow";

    internal new class UxmlFactory
        : UxmlFactory<ToolbarWindowMenu, UxmlTraits> {}
