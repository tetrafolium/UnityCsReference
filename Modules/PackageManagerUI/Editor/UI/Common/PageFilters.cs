...
internal class PageFilters : IEquatable<PageFilters>
{
    ...
    public string searchText
    {
        ...
        set {
            if (value == null) m_SearchText = "";
            else m_SearchText = value;
        }
    }
    ...
    public List<string> statuses
    {
        ...
        set {
            if (value == null) m_statuses = new List<string>();
            else m_statuses = value;
        }
    }
    ...
    public List<string> categories
    {
        ...
        set {
            if (value == null) m_categories = new List<string>();
            else m_categories = value;
        }
    }
    ...
    public List<string> labels
    {
        ...
        set {
            if (value == null) m_labels = new List<string>();
            else m_labels = value;
        }
    }
    ...
    public string orderBy
    {
        ...
        set {
            if (value == null) m_orderBy = "";
            else m_orderBy = value;
        }
    }
