...
namespace UnityEditor.PackageManager.UI {
  internal class PackageTagLabel : Label {
    ...
    public PackageTagLabel() : base() {}

    public static PackageTagLabel CreateTagLabel(IPackageVersion version,
                                                 bool isVersionItem = false) {
      if (version != null) {
        if (version.HasTag(PackageTag.InDevelopment))
          return new PackageTagLabel(L10n.Tr("In Development"),
