...
internal class PackageStatusBar : VisualElement
{
    ...
    private LoadingSpinner loadingSpinner {
        get {
            return cache.Get<LoadingSpinner>("loadingSpinner");
        }
    }
    private Label errorIcon {
        get {
            return cache.Get<Label>("errorIcon");
        }
    }
    private Label statusLabel {
        get {
            return cache.Get<Label>("statusLabel");
        }
    }
    private DropdownButton refreshButton {
        get {
            return cache.Get<DropdownButton>("refreshButton");
        }
    }
}
}
