...
internal class PackageSampleItem
{
    ...
    internal Label importStatus {
        get {
            return m_ImportStatus ?? (m_ImportStatus = new Label() {
    ...
    internal Label nameLabel {
        get {
            return m_NameLabel ?? (m_NameLabel = new Label() {
                classList = { "nameLabel" }
            });
        }
    }
    ...
    internal Label sizeLabel {
        get {
            return m_SizeLabel ?? (m_SizeLabel = new Label() {
                classList = { "sizeLabel" }
            });
        }
    }
    ...
    internal Button importButton {
        get {
            return m_ImportButton ?? (m_ImportButton = new Button() {
