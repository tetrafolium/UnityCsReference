...
internal class PackageLoadBar : VisualElement
{
    ...
    private Label loadedLabel {
        get {
            return cache.Get<Label>("loadedLabel");
        }
    }
    private Label loadMoreLabel {
        get {
            return cache.Get<Label>("loadMoreLabel");
        }
    }
    private Label loadMinLabel {
        get {
            return cache.Get<Label>("loadMinLabel");
        }
    }
    private Label loadMaxLabel {
        get {
            return cache.Get<Label>("loadMaxLabel");
        }
    }
    private VisualElement loadBarContainer {
        get {
            return cache.Get<VisualElement>("loadBarContainer");
        }
    }
}
}
