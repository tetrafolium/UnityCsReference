...
public static class PackageManagerExtensions
{
    ...
    internal static List<IPackageManagerToolbarExtension> ToolbarExtensions {
        get {
            return toolbarExtensions ?? (toolbarExtensions = new List<IPackageManagerToolbarExtension>());
        }
    }
    ...
    internal static List<IPackageManagerMenuExtensions> MenuExtensions {
        get {
            return menuExtensions ?? (menuExtensions = new List<IPackageManagerMenuExtensions>());
        }
    }
