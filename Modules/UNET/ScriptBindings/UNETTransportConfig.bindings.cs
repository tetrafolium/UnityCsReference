...
#pragma warning disable 618
  ...
  internal class ConnectionConfigInternal : IDisposable {
    ...
    public ConnectionConfigInternal(ConnectionConfig config) {
      ...
      this.MaxCombinedReliableMessageSize =
          config.MaxCombinedReliableMessageSize;
      this.MaxCombinedReliableMessageCount =
          config.MaxCombinedReliableMessageCount;
      ...
      for (byte i = 0; i < config.SharedOrderChannelCount; ++i) {
        ...
        byte[] sharedOrderChannelsArray =
            new byte[sharedOrderChannelsList.Count];
    ...
    ~ConnectionConfigInternal() { Dispose(false); }
    ...
    [NativeProperty("m_ProtocolRequired.m_ReducedPingTimeout",
                    TargetType.Field)]
    ...
    [NativeProperty("m_ProtocolOptional.m_NetworkDropThreshold",
                    TargetType.Field)]
    private extern byte NetworkDropThreshold {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_OverflowDropThreshold",
                    TargetType.Field)]
    private extern byte OverflowDropThreshold {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_MaxConnectionAttempt",
                    TargetType.Field)]
    ...
    [NativeProperty("m_ProtocolOptional.m_MaxCombinedReliableMessageSize",
                    TargetType.Field)]
    private extern ushort MaxCombinedReliableMessageSize {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_MaxCombinedReliableMessageAmount",
                    TargetType.Field)]
    private extern ushort MaxCombinedReliableMessageCount {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_MaxSentMessageQueueSize",
                    TargetType.Field)]
    ...
    [NativeProperty("m_ProtocolRequired.m_UsePlatformSpecificProtocols",
                    TargetType.Field)]
    ...
    [NativeProperty("m_ProtocolOptional.m_BandwidthPeakFactor",
                    TargetType.Field)]
    private extern float BandwidthPeakFactor {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_WebSocketReceiveBufferMaxSize",
                    TargetType.Field)]
    private extern ushort WebSocketReceiveBufferMaxSize {
      set;
    }
    [NativeProperty("m_ProtocolOptional.m_UdpSocketReceiveBufferMaxSize",
                    TargetType.Field)]
  ...
  internal class HostTopologyInternal : IDisposable {
    ...
    public HostTopologyInternal(HostTopology topology) {
      ConnectionConfigInternal config =
          new ConnectionConfigInternal(topology.DefaultConfig);
    ...
    ~HostTopologyInternal() { Dispose(false); }
    ...
    private static extern IntPtr InternalCreate(ConnectionConfigInternal config,
                                                int maxDefaultConnections);
    [NativeMethod(IsThreadSafe = true)]
    private static extern void InternalDestroy(IntPtr ptr);
    public extern ushort
    AddSpecialConnectionConfig(ConnectionConfigInternal config);
  ...
  internal class ConnectionSimulatorConfigInternal : IDisposable {
    ...
    public ConnectionSimulatorConfigInternal(ConnectionSimulatorConfig config) {
      m_Ptr = InternalCreate(config.m_OutMinDelay, config.m_OutAvgDelay,
                             config.m_InMinDelay, config.m_InAvgDelay,
                             config.m_PacketLossPercentage);
    }
    ...
    ~ConnectionSimulatorConfigInternal() { Dispose(false); }
    ...
    private static extern IntPtr InternalCreate(int outMinDelay,
                                                int outAvgDelay, int inMinDelay,
                                                int inAvgDelay,
  ...
  internal class GlobalConfigInternal : IDisposable {
    ...
    public GlobalConfigInternal(GlobalConfig config) {
      ...
      this.ReactorMaximumReceivedMessages =
          config.ReactorMaximumReceivedMessages;
      ...
      if (config.ThreadPoolSize == 0 || config.ThreadPoolSize > 254)
        throw new ArgumentOutOfRangeException(
            "Worker thread pool size should be >= 1 && < 254 (for server only)");
    ...
    ~GlobalConfigInternal() { Dispose(false); }
