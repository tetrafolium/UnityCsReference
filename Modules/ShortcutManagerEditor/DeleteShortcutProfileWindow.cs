...
namespace UnityEditor.ShortcutManagement {
  class DeleteShortcutProfileWindow : EditorWindow {
    ...
    public static void Show(string profileName, Action action) {
      var deleteProfilePromptWindow =
          GetWindow<DeleteShortcutProfileWindow>(true, "Delete Profile", true);

      deleteProfilePromptWindow.minSize = new Vector2(320, 120);

      deleteProfilePromptWindow.m_HeaderTextElement.text =
          "Delete a shortcut profile";
      deleteProfilePromptWindow.m_MessageTextElement.text = string.Format(
          "Are you sure you want to delete the shortcut profile '{0}'?",
          profileName);
    ...
    void OnEnable() {
      ...
      var visualTreeAsset =
          (VisualTreeAsset) EditorResources.Load<UnityEngine.Object>(
              "UXML/ShortcutManager/DeleteShortcutProfileWindow.uxml");
