...
public static class ShortcutManager
{
    ...
    public static IShortcutManager instance {
        get;
    } = new ShortcutManagerImplementation(ShortcutIntegration.instance.profileManager);
}
...
class ShortcutManagerImplementation : IShortcutManager
{
    ...
    {
        get {
            return m_ShortcutProfileManager.activeProfile?.id ?? ShortcutManager.defaultProfileId;
        }
        set
        {
            if (value == null)
