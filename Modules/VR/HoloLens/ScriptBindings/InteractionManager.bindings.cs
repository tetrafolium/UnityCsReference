...
public struct InteractionSource : IEquatable<InteractionSource>
{
    ...
    {
        get {
            return (m_Flags & InteractionSourceFlags.SupportsGrasp) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceFlags.SupportsMenu) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceFlags.SupportsPointing) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceFlags.SupportsThumbstick) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceFlags.SupportsTouchpad) != 0;
        }
    }
...
public partial struct InteractionSourceProperties
{
    public double sourceLossRisk {
        get {
            return m_SourceLossRisk;
        }
    }
    public Vector3 sourceLossMitigationDirection {
        get {
            return m_SourceLossMitigationDirection;
        }
    }
...
public partial struct InteractionSourceState
{
    ...
    {
        get {
            return (m_Flags & InteractionSourceStateFlags.AnyPressed) != 0;
        }
    }
    ...
    {
        get {
            return m_Properties.m_SourcePose;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceStateFlags.SelectPressed) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceStateFlags.MenuPressed) != 0;
        }
    }
    ...
    {
        get {
            return (m_Flags & InteractionSourceStateFlags.Grasped) != 0;
        }
    }
