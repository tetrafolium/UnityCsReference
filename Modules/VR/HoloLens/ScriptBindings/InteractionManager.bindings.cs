...
namespace UnityEngine.XR.WSA.Input {
  ...
  public struct InteractionSource : IEquatable<InteractionSource> {
    ...
    public bool Equals(InteractionSource other) { return other.m_Id == m_Id; }

    public override int GetHashCode() { return (int) m_Id; }

    public uint id {
      get { return m_Id; }
    }
    public InteractionSourceKind kind {
      get { return m_SourceKind; }
    }
  ...
  public enum InteractionSourceHandedness { Unknown, Left, Right }
  ...
  public enum InteractionSourceNode { Grip, Pointer }

  public enum InteractionSourcePositionAccuracy { None, Approximate, High }
  ...
  public partial struct InteractionSourcePose {
    ...
    TryGetRotation(out Quaternion rotation,
                   InteractionSourceNode node = InteractionSourceNode.Grip) {
      if (node == InteractionSourceNode.Grip) {
    ...
    public bool
    TryGetForward(out Vector3 forward,
                  InteractionSourceNode node = InteractionSourceNode.Grip) {
      Quaternion rotation;
  ...
  public partial struct InteractionSourceProperties {
    public double sourceLossRisk {
      get { return m_SourceLossRisk; }
    }
    public Vector3 sourceLossMitigationDirection {
      get { return m_SourceLossMitigationDirection; }
    }
  ...
  [RequiredByNativeCode]
  [NativeHeader("Modules/VR/HoloLens/Gestures/GestureSource.h")]
  ...
  public partial struct InteractionSourceState {
    ...
    public bool touchpadTouched {
      get {
        return (m_Flags & InteractionSourceStateFlags.TouchpadTouched) != 0;
      }
    }

    public bool touchpadPressed {
      get {
        return (m_Flags & InteractionSourceStateFlags.TouchpadPressed) != 0;
      }
    }
    ...
    public bool thumbstickPressed {
      get {
        return (m_Flags & InteractionSourceStateFlags.ThumbstickPressed) != 0;
      }
    }
  ...
  public struct InteractionSourcePressedEventArgs {
    ...
    public InteractionSourcePressedEventArgs(
        InteractionSourceState state, InteractionSourcePressType pressType)
        : this() {
      this.state = state;
  ...
  public struct InteractionSourceReleasedEventArgs {
    ...
    public InteractionSourceReleasedEventArgs(
        InteractionSourceState state, InteractionSourcePressType pressType)
        : this() {
      this.state = state;
      this.pressType = pressType;
  ...
  public partial class InteractionManager {
    ...
    public static event Action<InteractionSourceDetectedEventArgs>
        InteractionSourceDetected;
    public static event Action<InteractionSourceLostEventArgs>
        InteractionSourceLost;
    public static event Action<InteractionSourcePressedEventArgs>
        InteractionSourcePressed;
    public static event Action<InteractionSourceReleasedEventArgs>
        InteractionSourceReleased;
    public static event Action<InteractionSourceUpdatedEventArgs>
    ...
    public static InteractionSourceState[] GetCurrentReading() {
      InteractionSourceState[] sourceStates =
          new InteractionSourceState[numSourceStates];
    ...
    private extern static int GetCurrentReading_Internal(
        [ NotNull ] InteractionSourceState[] sourceStates);
    ...
    public extern static int numSourceStates {
      [NativeConditional("ENABLE_HOLOLENS_MODULE")]
      [NativeName("GetNumSourceStates")] get;
    }
...
#pragma warning disable 0618
    [RequiredByNativeCode]
        ...
        OnSourceEvent(EventType eventType, IntPtr statePtr,
      ...
      case EventType.SourceReleased: {
        ...
        if (eventHandler != null)
          eventHandler(
              new InteractionSourceReleasedEventArgs(state, pressType));
      } break;
