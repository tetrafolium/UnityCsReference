...
namespace UnityEngine.XR.WSA {
  internal class SimulatedSpatialController {
    ...
    public Quaternion orientation {
      ...
      set {
        HolographicAutomation.TrySetHandOrientation(m_ControllerHandednss,
                                                    value);
      }
    }
    ...
    public Vector3 position {
      get {
        return HolographicAutomation.GetControllerPosition(
            m_ControllerHandednss);
      }
      set {
        HolographicAutomation.TrySetControllerPosition(m_ControllerHandednss,
                                                       value);
      }
    }
    ...
    public bool activated {
      get {
        return HolographicAutomation.GetControllerActivated(
            m_ControllerHandednss);
      }
      set {
        HolographicAutomation.TrySetControllerActivated(m_ControllerHandednss,
                                                        value);
      }
    }
    ...
    public bool visible {
      get {
        return HolographicAutomation.GetControllerVisible(
            m_ControllerHandednss);
      }
    }
  ...
  internal class SimulatedHand {
    ...
    // Require use of HolographicEmulation.simulatedLeftHand or
    // HolographicEmulation.simulatedRightHand to get instance
    internal SimulatedHand(Handedness hand) { m_Hand = hand; }
  ...
  internal partial class HolographicAutomation {
    ...
    static SimulatedSpatialController s_LeftController =
        new SimulatedSpatialController(Handedness.Left);
    static SimulatedSpatialController s_RightController =
        new SimulatedSpatialController(Handedness.Right);
  ...
  internal static class HolographicEmulationHelpers {
    ...
    // defined above)
    public static Vector3 CalcExpectedCameraPosition(SimulatedHead head,
                                                     SimulatedBody body) {
