...
namespace UnityEngine.XR.WSA {
  ...
  internal partial class HolographicAutomation {
    ...
    SetPlaymodeInputType(PlaymodeInputType inputType);

    [NativeName("ResetEmulationState")]
    internal static extern void Reset();

    internal static extern void PerformGesture(Handedness hand,
                                               SimulatedGesture gesture);

    internal static extern void
    PerformButtonPress(Handedness hand, SimulatedControllerPress buttonPress);

    [NativeConditional("ENABLE_HOLOLENS_MODULE",
                       StubReturnStatement = "Vector3f::zero")]
    ...
    internal static extern void SetHandPosition(Handedness hand,
                                                Vector3 position);

    [NativeConditional("ENABLE_HOLOLENS_MODULE",
                       StubReturnStatement = "Quaternionf::identity()")]
    internal static extern Quaternion GetHandOrientation(Handedness hand);

    internal static extern bool TrySetHandOrientation(Handedness hand,
                                                      Quaternion orientation);

    internal static extern bool GetHandActivated(Handedness hand);

    internal static extern void SetHandActivated(Handedness hand,
                                                 bool activated);
    ...
    internal static extern bool TrySetControllerPosition(Handedness hand,
                                                         Vector3 position);

    internal static extern bool GetControllerActivated(Handedness hand);

    internal static extern bool TrySetControllerActivated(Handedness hand,
                                                          bool activated);
