...
namespace UnityEngine.XR.WSA.Input {
  ...
  [MovedFrom("UnityEngine.VR.WSA.Input")]
  [UsedByNativeCode]
  [NativeHeader("Modules/VR/HoloLens/Gestures/GestureRecognizer.h")]
  ...
  [StructLayout(LayoutKind.Sequential)] // needed for IntPtr binding classes
    ...
    //
    public GestureRecognizer() { m_Recognizer = Internal_Create(this); }

    [NativeConditional("ENABLE_HOLOLENS_MODULE")]
    [NativeName("Create")]
    private extern static IntPtr
    Internal_Create(GestureRecognizer gestureRecognizer);
    ...
    SetRecognizableGestures(GestureSettings newMaskValue) {
      return (GestureSettings)
          SetRecognizableGestures_Internal((int) newMaskValue);
    }
...
#pragma warning disable 0618
    ...
    [RequiredByNativeCode]
    private void InvokeHoldCanceled(InteractionSource source,
      ...
      if (holdCanceledEvent != null)
        holdCanceledEvent(
            source.m_SourceKind,
            new Ray(headPose.position, headPose.rotation * Vector3.forward));
    ...
    [RequiredByNativeCode]
    private void InvokeHoldCompleted(InteractionSource source,
                                     InteractionSourcePose sourcePose,
                                     Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeHoldStarted(InteractionSource source,
                                   InteractionSourcePose sourcePose,
                                   Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeTapped(InteractionSource source,
                              InteractionSourcePose sourcePose, Pose headPose,
                              int tapCount) {
      var tappedEvent = TappedEvent;
      if (tappedEvent != null)
        tappedEvent(
            source.m_SourceKind, tapCount,
            new Ray(headPose.position, headPose.rotation * Vector3.forward));
    ...
    [RequiredByNativeCode]
    private void InvokeManipulationCompleted(InteractionSource source,
                                             InteractionSourcePose sourcePose,
                                             Pose headPose,
      ...
      if (manipulationCompletedEvent != null)
        manipulationCompletedEvent(
            source.m_SourceKind, cumulativeDelta,
            new Ray(headPose.position, headPose.rotation * Vector3.forward));
    ...
    [RequiredByNativeCode]
    private void InvokeManipulationStarted(InteractionSource source,
                                           InteractionSourcePose sourcePose,
                                           Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeManipulationUpdated(InteractionSource source,
                                           InteractionSourcePose sourcePose,
                                           Pose headPose,
                                           Vector3 cumulativeDelta) {
    ...
    [RequiredByNativeCode]
    private void InvokeNavigationCanceled(InteractionSource source,
                                          InteractionSourcePose sourcePose,
                                          Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeNavigationCompleted(InteractionSource source,
                                           InteractionSourcePose sourcePose,
                                           Pose headPose,
      ...
      if (navigationCompletedEvent != null)
        navigationCompletedEvent(
            source.m_SourceKind, normalizedOffset,
            new Ray(headPose.position, headPose.rotation * Vector3.forward));
    ...
    [RequiredByNativeCode]
    private void InvokeNavigationStarted(InteractionSource source,
                                         InteractionSourcePose sourcePose,
                                         Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeNavigationUpdated(InteractionSource source,
                                         InteractionSourcePose sourcePose,
                                         Pose headPose,
                                         Vector3 normalizedOffset) {
    ...
    [RequiredByNativeCode]
    private void InvokeRecognitionEnded(InteractionSource source,
                                        InteractionSourcePose sourcePose,
                                        Pose headPose) {
    ...
    [RequiredByNativeCode]
    private void InvokeRecognitionStarted(InteractionSource source,
                                          InteractionSourcePose sourcePose,
                                          Pose headPose) {
...
#pragma warning restore 0618
    ...
    //
    // These deprecated APIs must be declared in this file (instead of a
    // separate .deprecated.cs file) because they add data members, and partial
    // class field ordering is non-deterministic
    //
    public delegate void HoldCanceledEventDelegate(InteractionSourceKind source,
                                                   Ray headRay);
    public delegate void
    HoldCompletedEventDelegate(InteractionSourceKind source, Ray headRay);
    public delegate void HoldStartedEventDelegate(InteractionSourceKind source,
                                                  Ray headRay);
    public delegate void TappedEventDelegate(InteractionSourceKind source,
                                             int tapCount, Ray headRay);
    public delegate void
    ManipulationCanceledEventDelegate(InteractionSourceKind source,
                                      Vector3 cumulativeDelta, Ray headRay);
    public delegate void
    ManipulationCompletedEventDelegate(InteractionSourceKind source,
                                       Vector3 cumulativeDelta, Ray headRay);
    public delegate void
    ManipulationStartedEventDelegate(InteractionSourceKind source,
                                     Vector3 cumulativeDelta, Ray headRay);
    public delegate void
    ManipulationUpdatedEventDelegate(InteractionSourceKind source,
                                     Vector3 cumulativeDelta, Ray headRay);
    public delegate void
    NavigationCanceledEventDelegate(InteractionSourceKind source,
                                    Vector3 normalizedOffset, Ray headRay);
    public delegate void
    NavigationCompletedEventDelegate(InteractionSourceKind source,
                                     Vector3 normalizedOffset, Ray headRay);
    public delegate void
    NavigationStartedEventDelegate(InteractionSourceKind source,
                                   Vector3 normalizedOffset, Ray headRay);
    public delegate void
    NavigationUpdatedEventDelegate(InteractionSourceKind source,
                                   Vector3 normalizedOffset, Ray headRay);
    public delegate void
    RecognitionEndedEventDelegate(InteractionSourceKind source, Ray headRay);
    public delegate void
    RecognitionStartedEventDelegate(InteractionSourceKind source, Ray headRay);
    public delegate void
    GestureErrorDelegate([ MarshalAs(UnmanagedType.LPStr) ] string error,
                         int hresult);

    [Obsolete(
        "HoldCanceledEvent is deprecated, and will be removed in a future release. Use OnHoldCanceledEvent instead.",
        false)]
    public event HoldCanceledEventDelegate HoldCanceledEvent;

    [Obsolete(
        "HoldCompletedEvent is deprecated, and will be removed in a future release. Use OnHoldCompletedEvent instead.",
        false)]
    public event HoldCompletedEventDelegate HoldCompletedEvent;

    [Obsolete(
        "HoldStartedEvent is deprecated, and will be removed in a future release. Use OnHoldStartedEvent instead.",
        false)]
    public event HoldStartedEventDelegate HoldStartedEvent;

    [Obsolete(
        "TappedEvent is deprecated, and will be removed in a future release. Use Tapped instead.",
        false)]
    public event TappedEventDelegate TappedEvent;

    [Obsolete(
        "ManipulationCanceledEvent is deprecated, and will be removed in a future release. Use OnManipulationCanceledEvent instead.",
        false)]
    public event ManipulationCanceledEventDelegate ManipulationCanceledEvent;

    [Obsolete(
        "ManipulationCompletedEvent is deprecated, and will be removed in a future release. Use OnManipulationCompletedEvent instead.",
        false)]
    public event ManipulationCompletedEventDelegate ManipulationCompletedEvent;

    [Obsolete(
        "ManipulationStartedEvent is deprecated, and will be removed in a future release. Use OnManipulationStartedEvent instead.",
        false)]
    public event ManipulationStartedEventDelegate ManipulationStartedEvent;

    [Obsolete(
        "ManipulationUpdatedEvent is deprecated, and will be removed in a future release. Use OnManipulationUpdatedEvent instead.",
        false)]
    public event ManipulationUpdatedEventDelegate ManipulationUpdatedEvent;

    [Obsolete(
        "NavigationCanceledEvent is deprecated, and will be removed in a future release. Use OnNavigationCanceledEvent instead.",
        false)]
    public event NavigationCanceledEventDelegate NavigationCanceledEvent;

    [Obsolete(
        "NavigationCompletedEvent is deprecated, and will be removed in a future release. Use OnNavigationCompletedEvent instead.",
        false)]
    public event NavigationCompletedEventDelegate NavigationCompletedEvent;

    [Obsolete(
        "NavigationStartedEvent is deprecated, and will be removed in a future release. Use OnNavigationStartedEvent instead.",
        false)]
    public event NavigationStartedEventDelegate NavigationStartedEvent;

    [Obsolete(
        "NavigationUpdatedEvent is deprecated, and will be removed in a future release. Use OnNavigationUpdatedEvent instead.",
        false)]
    public event NavigationUpdatedEventDelegate NavigationUpdatedEvent;

    [Obsolete(
        "RecognitionEndedEvent is deprecated, and will be removed in a future release. Use OnRecognitionEndedEvent instead.",
        false)]
    public event RecognitionEndedEventDelegate RecognitionEndedEvent;

    [Obsolete(
        "RecognitionStartedEvent is deprecated, and will be removed in a future release. Use OnRecognitionStartedEvent instead.",
        false)]
    public event RecognitionStartedEventDelegate RecognitionStartedEvent;

    [Obsolete(
        "GestureErrorEvent is deprecated, and will be removed in a future release. Use OnGestureErrorEvent instead.",
        false)]
