...
public static class XRSettings
{
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static GameViewRenderMode gameViewRenderMode {
        get;
        set;
    }
    ...
    [NativeName("Active")]
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static bool isDeviceActive {
        get;
    }

    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static bool showDeviceView {
        get;
        set;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static float renderScale {
        get;
        set;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static float eyeTextureResolutionScale {
        get;
        set;
    }

    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static int eyeTextureWidth {
        get;
    }

    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static int eyeTextureHeight {
        get;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static UnityEngine.RenderTextureDescriptor eyeTextureDesc {
        get;
    }

    [NativeName("DeviceEyeTextureDimension")]
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static TextureDimension deviceEyeTextureDimension {
        get;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern internal static float renderViewportScaleInternal {
        get;
        set;
    }

    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static float occlusionMaskScale {
        get;
        set;
    }

    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static bool useOcclusionMesh {
        get;
        set;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static string loadedDeviceName {
        get;
    }
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static StereoRenderingMode stereoRenderingMode {
        get;
    }
}
...
public static class XRDevice
{
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static string family {
        get;
    }

    [NativeName("DeviceModel")]
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static string model {
        get;
    }

    [NativeName("DeviceRefreshRate")]
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static float refreshRate {
        get;
    }
...
public static class Boundary
{
    ...
    [StaticAccessor("GetIVRDevice()", StaticAccessorType.ArrowWithDefaultReturnIfNull)]
    extern public static bool configured {
        get;
    }
