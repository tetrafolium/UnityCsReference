...
internal class SpriteMaskEditor : RendererEditorBase {
  ...
  class Styles {
    public static readonly GUIContent spriteLabel =
        EditorGUIUtility.TrTextContent("Sprite",
                                       "The Sprite defining the mask");
    public static readonly GUIContent alphaCutoffLabel =
        EditorGUIUtility.TrTextContent(
            "Alpha Cutoff",
            "The minimum alpha value used by the mask to select the area of influence defined over the mask's sprite.");
    public static readonly GUIContent isCustomRangeActive =
        EditorGUIUtility.TrTextContent(
            "Custom Range",
            "Mask sprites from front to back sorting values only.");
    public static readonly GUIContent createSpriteMaskUndoString =
        EditorGUIUtility.TrTextContent("Create Sprite Mask");
    public static readonly GUIContent newSpriteMaskName =
        EditorGUIUtility.TrTextContent("New Sprite Mask");
    public static readonly GUIContent frontLabel =
        EditorGUIUtility.TrTextContent("Front");
    public static readonly GUIContent backLabel =
        EditorGUIUtility.TrTextContent("Back");
  ...
  static void CreateSpriteMaskGameObject() {
    ...
    go.name = GameObjectUtility.GetUniqueNameForSibling(
        go.transform.parent, Styles.newSpriteMaskName.text);
  ...
  public override void OnEnable() {
    ...
    m_IsCustomRangeActive =
        serializedObject.FindProperty("m_IsCustomRangeActive");
    m_FrontSortingOrder = serializedObject.FindProperty("m_FrontSortingOrder");
    m_FrontSortingLayerID =
        serializedObject.FindProperty("m_FrontSortingLayerID");
    m_BackSortingOrder = serializedObject.FindProperty("m_BackSortingOrder");
    m_BackSortingLayerID =
        serializedObject.FindProperty("m_BackSortingLayerID");
  ...
  public override void OnInspectorGUI() {
    ...
    EditorGUILayout.PropertyField(m_IsCustomRangeActive,
                                  Styles.isCustomRangeActive);
    ...
    if (EditorGUILayout.BeginFadeGroup(m_ShowCustomRangeValues.faded)) {
      ...
      SortingLayerEditorUtility.RenderSortingLayerFields(m_FrontSortingOrder,
                                                         m_FrontSortingLayerID);

      EditorGUILayout.Space();
      EditorGUILayout.LabelField(Styles.backLabel);
      SortingLayerEditorUtility.RenderSortingLayerFields(m_BackSortingOrder,
                                                         m_BackSortingLayerID);
      EditorGUI.indentLevel--;
    }
  ...
  bool ShouldShowCustomRangeValues() {
    return m_IsCustomRangeActive.boolValue &&
           !m_IsCustomRangeActive.hasMultipleDifferentValues;
  }
}
}
