...
public enum DrivenTransformProperties {
  ...
  AnchoredPosition3D =
      AnchoredPositionX | AnchoredPositionY | AnchoredPositionZ,
...
public struct DrivenRectTransformTracker {
  ...
  public void Add(Object driver, RectTransform rectTransform,
    ...
    rectTransform.drivenProperties =
...
public sealed class RectTransform : Transform {
  ...
  public extern Vector2 anchorMin {
    get;
    set;
  }
  public extern Vector2 anchorMax {
    get;
    set;
  }
  public extern Vector2 anchoredPosition {
    get;
    set;
  }
  public extern Vector2 sizeDelta {
    get;
    set;
  }
  ...
  public Vector2 offsetMin {
    ...
    set {
      Vector2 offset =
          value - (anchoredPosition - Vector2.Scale(sizeDelta, pivot));
      sizeDelta -= offset;
  ...
  public Vector2 offsetMax {
    ...
    set {
      Vector2 offset = value - (anchoredPosition +
                                Vector2.Scale(sizeDelta, Vector2.one - pivot));
      sizeDelta += offset;
      anchoredPosition += Vector2.Scale(offset, pivot);
    }
  }

  extern internal Object drivenByObject {
    get;
    set;
  }
  extern internal DrivenTransformProperties drivenProperties {
    get;
    set;
  }
  ...
  public void SetInsetAndSizeFromParentEdge(Edge edge, float inset,
                                            float size) {
    ...
    // Set size. Since anchors are together, size and sizeDelta means the same
    // in this case.
    ...
    positionCopy[axis] =
        end ? - inset - size * (1 - pivot[axis]) : inset + size * pivot[axis];
