...
namespace UnityEngine.Sprites {
  public sealed partial class DataUtility {
    // UV coordinates for the inner part of a sliced Sprite or the whole Sprite
    // if borders=0
    ...
    // Pixel padding from the edges of the sprite to the drawn rectangle (left,
    // bottom, right, top). Valid when the RenderData rect does not match the
    // definition rect (i.e. alpha trimming).
