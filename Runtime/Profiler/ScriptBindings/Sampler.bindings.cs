...
namespace UnityEngine.Profiling {
  ...
  public class Sampler {
    ...
    [NativeMethod(Name = "ProfilerBindings::GetSamplerInternal",
                  IsFreeFunction = true)]
    private extern static IntPtr GetSamplerInternal([ NotNull ] string name);

    [NativeMethod(Name = "ProfilerBindings::GetSamplerNamesInternal",
                  IsFreeFunction = true)]
    private extern static int
    GetSamplerNamesInternal(List<string> namesScriptingPtr);
  }
  ...
  public sealed class CustomSampler : Sampler {
    ...
    [NativeMethod(Name = "ProfilerBindings::CreateCustomSamplerInternal",
                  IsFreeFunction = true, ThrowsException = true,
                  IsThreadSafe = true)]
    static extern IntPtr CreateInternal([ NotNull ] string name,
                                        bool collectGpuData);
    ...
    [NativeMethod(Name = "ProfilerBindings::CustomSampler_Begin",
                  IsFreeFunction = true, IsThreadSafe = true)]
    static extern void Begin_Internal(IntPtr ptr);

    [NativeMethod(Name = "ProfilerBindings::CustomSampler_BeginWithObject",
                  IsFreeFunction = true, IsThreadSafe = true)]
    static extern void
    BeginWithObject_Internal(IntPtr ptr, UnityEngine.Object targetObject);

    [NativeMethod(Name = "ProfilerBindings::CustomSampler_End",
                  IsFreeFunction = true, IsThreadSafe = true)]
