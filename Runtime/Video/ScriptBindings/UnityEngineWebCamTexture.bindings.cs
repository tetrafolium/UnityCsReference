...
public struct WebCamDevice
{
    ...
    public bool isFrontFacing {
        get {
            return (m_Flags & ((int)WebCamFlags.FrontFacing)) != 0;
        }
    }
    ...
    public string depthCameraName {
        get {
            return m_DepthCameraName == "" ? null : m_DepthCameraName;
        }
    }
    ...
    public bool isAutoFocusPointSupported {
        get {
            return (m_Flags & ((int)WebCamFlags.AutoFocusPointSupported)) != 0;
        }
    }
...
public sealed class WebCamTexture : Texture
{
    ...
    {
        get {
            return internalAutoFocusPoint.x < 0 ? null : new Vector2 ? (internalAutoFocusPoint);
        }
        set {
            internalAutoFocusPoint = (value == null) ? new Vector2(-1, -1) : value.Value;
        }
    }
