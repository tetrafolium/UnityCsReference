...
public struct WebCamDevice {
  ...
  public bool isFrontFacing {
    get { return (m_Flags & ((int) WebCamFlags.FrontFacing)) != 0; }
  }
  ...
  // A human-readable name of the paired device which provides depth data.
  // Returns null if device doesn't support depth data.
  public string depthCameraName {
    get { return m_DepthCameraName == "" ? null : m_DepthCameraName; }
  }

  // True if camera device supports arbitrary focus point
  public bool isAutoFocusPointSupported {
    get { return (m_Flags & ((int) WebCamFlags.AutoFocusPointSupported)) != 0; }
  }
...
public sealed class WebCamTexture : Texture {
  public extern static WebCamDevice[] devices {
    ...
    [NativeName("Internal_GetDevices")] get;
  }

  public WebCamTexture(string deviceName, int requestedWidth,
                       int requestedHeight, int requestedFPS) {
    Internal_CreateWebCamTexture(this, deviceName, requestedWidth,
  ...
  public WebCamTexture(int requestedWidth, int requestedHeight,
                       int requestedFPS) {
    Internal_CreateWebCamTexture(this, "", requestedWidth, requestedHeight,
                                 requestedFPS);
  }
  ...
  public WebCamTexture() { Internal_CreateWebCamTexture(this, "", 0, 0, 0); }
  ...
  public extern bool videoVerticallyMirrored {
    [NativeName("IsVideoVerticallyMirrored")] get;
  }
  public extern bool didUpdateThisFrame {
    [NativeName("DidUpdateThisFrame")] get;
  }

  public extern Color GetPixel(int x, int y);
  public Color[] GetPixels() { return GetPixels(0, 0, width, height); }

  [FreeFunction("WebCamTextureBindings::Internal_GetPixels",
                HasExplicitThis = true)]
  public extern Color[] GetPixels(int x, int y, int blockWidth,
                                  int blockHeight);
  ...
  [FreeFunction("WebCamTextureBindings::Internal_GetPixels32",
                HasExplicitThis = true)]
  ...
  public Vector2? autoFocusPoint {
    get {
      return internalAutoFocusPoint.x < 0
                 ? null
                 : new Vector2 ?(internalAutoFocusPoint);
    }
    set {
      internalAutoFocusPoint =
          (value == null) ? new Vector2(-1, -1) : value.Value;
    }
  }
  internal extern Vector2 internalAutoFocusPoint {
    get;
    set;
  }
  ...
  Internal_CreateWebCamTexture([ Writable ] WebCamTexture self,
                               string scriptingDevice, int requestedWidth,
                               int requestedHeight, int maxFramerate);
}
