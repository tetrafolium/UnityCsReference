...
public static void
DrawMesh(Mesh mesh, [ DefaultValue("Vector3.zero") ] Vector3 position,
...
public static void
DrawWireMesh(Mesh mesh, [ DefaultValue("Vector3.zero") ] Vector3 position,
             [ DefaultValue("Quaternion.identity") ] Quaternion rotation,
             [ DefaultValue("Vector3.one") ] Vector3 scale) {
...
public static void DrawGUITexture(Rect screenRect, Texture texture,
	...
	Material mat = null;
	DrawGUITexture(screenRect, texture, leftBorder, rightBorder, topBorder,
	               bottomBorder, mat);
}
}
}
