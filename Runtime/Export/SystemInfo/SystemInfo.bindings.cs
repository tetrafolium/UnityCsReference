...
// The operating system family application is running. Returned by
// SystemInfo.operatingSystemFamily. NOTE: also match with enum in SystemInfo.h
...
// Enumeration for [[SystemInfo.deviceType]], denotes a coarse grouping of kinds
// of devices.
...
// Returns the kind of device the application is running on. See
// [[DeviceType]] enumeration for possible values.
...
public static bool supportsRenderToCubemap {
	get {
		return true; // all platforms support these days
	}
}
...
internal static bool IsEnumValueObsolete(Enum value) {
	foreach (var enumMember in value.GetType().GetFields(BindingFlags.Static |
	                                                     BindingFlags.Public)) {
		if (!object.Equals(enumMember.GetValue(null), value))
			continue;

		var isObsolete =
			enumMember.GetCustomAttributes(typeof(ObsoleteAttribute), false)
			.Length != 0;
		if (!isObsolete) {
			return false;
		}
...
public static bool SupportsRenderTextureFormat(RenderTextureFormat format) {
	if (!IsValidEnumValue(format))
		throw new ArgumentException(
			      "Failed SupportsRenderTextureFormat; format is not a valid RenderTextureFormat");
...
public static bool
SupportsBlendingOnRenderTextureFormat(RenderTextureFormat format) {
	if (!IsValidEnumValue(format))
		throw new ArgumentException(
			      "Failed SupportsBlendingOnRenderTextureFormat; format is not a valid RenderTextureFormat");
...
public static bool SupportsTextureFormat(TextureFormat format) {
	if (!IsValidEnumValue(format))
		throw new ArgumentException(
			      "Failed SupportsTextureFormat; format is not a valid TextureFormat");

	return SupportsTextureFormatNative(format);
}

public static bool SupportsVertexAttributeFormat(VertexAttributeFormat format,
                                                 int dimension) {
	if (!IsValidEnumValue(format))
		throw new ArgumentException(
			      "Failed SupportsVertexAttributeFormat; format is not a valid VertexAttributeFormat");
	if (dimension < 1 || dimension > 4)
		throw new ArgumentException(
			      "Failed SupportsVertexAttributeFormat; dimension must be in 1..4 range");
...
public static int graphicsPixelFillrate {
	get {
		return -1; // was already indicating "unknown GPU/platform" back when we
...
[FreeFunction(
	 "ScriptingGraphicsCaps::HasDynamicUniformArrayIndexingInFragmentShaders")]
...
static extern bool
SupportsBlendingOnRenderTextureFormatNative(RenderTextureFormat format);
...
static extern bool
SupportsVertexAttributeFormatNative(VertexAttributeFormat format,
                                    int dimension);
...
[FreeFunction(
	 "ScriptingGraphicsCaps::IsFormatSupported")] extern public static bool
IsFormatSupported(GraphicsFormat format, FormatUsage usage);

[FreeFunction(
	 "ScriptingGraphicsCaps::GetCompatibleFormat")] extern public static GraphicsFormat
GetCompatibleFormat(GraphicsFormat format, FormatUsage usage);

[FreeFunction(
	 "ScriptingGraphicsCaps::GetGraphicsFormat")] extern public static GraphicsFormat
GetGraphicsFormat(DefaultFormat format);
...
public const string unsupportedIdentifier =
	EditorSystemInfo.unsupportedIdentifier;

public static float batteryLevel => ShimManager.systemInfoShim.batteryLevel;

public static BatteryStatus batteryStatus =>
ShimManager.systemInfoShim.batteryStatus;

public static string operatingSystem =>
ShimManager.systemInfoShim.operatingSystem;

public static OperatingSystemFamily operatingSystemFamily =>
ShimManager.systemInfoShim.operatingSystemFamily;

public static string processorType =>
ShimManager.systemInfoShim.processorType;

public static int processorFrequency =>
ShimManager.systemInfoShim.processorFrequency;

public static int processorCount => ShimManager.systemInfoShim.processorCount;

public static int systemMemorySize =>
ShimManager.systemInfoShim.systemMemorySize;

public static string deviceUniqueIdentifier =>
ShimManager.systemInfoShim.deviceUniqueIdentifier;
...
public static bool supportsAccelerometer =>
ShimManager.systemInfoShim.supportsAccelerometer;

public static bool supportsGyroscope =>
ShimManager.systemInfoShim.supportsGyroscope;

public static bool supportsLocationService =>
ShimManager.systemInfoShim.supportsLocationService;

public static bool supportsVibration =>
ShimManager.systemInfoShim.supportsVibration;
...
public static int graphicsMemorySize =>
ShimManager.systemInfoShim.graphicsMemorySize;

public static string graphicsDeviceName =>
ShimManager.systemInfoShim.graphicsDeviceName;

public static string graphicsDeviceVendor =>
ShimManager.systemInfoShim.graphicsDeviceVendor;

public static int graphicsDeviceID =>
ShimManager.systemInfoShim.graphicsDeviceID;

public static int graphicsDeviceVendorID =>
ShimManager.systemInfoShim.graphicsDeviceVendorID;

public static Rendering.GraphicsDeviceType graphicsDeviceType =>
ShimManager.systemInfoShim.graphicsDeviceType;

public static bool graphicsUVStartsAtTop =>
ShimManager.systemInfoShim.graphicsUVStartsAtTop;

public static string graphicsDeviceVersion =>
ShimManager.systemInfoShim.graphicsDeviceVersion;

public static int graphicsShaderLevel =>
ShimManager.systemInfoShim.graphicsShaderLevel;

public static bool graphicsMultiThreaded =>
ShimManager.systemInfoShim.graphicsMultiThreaded;

public static Rendering.RenderingThreadingMode renderingThreadingMode =>
ShimManager.systemInfoShim.renderingThreadingMode;

public static bool hasHiddenSurfaceRemovalOnGPU =>
ShimManager.systemInfoShim.hasHiddenSurfaceRemovalOnGPU;

public static bool hasDynamicUniformArrayIndexingInFragmentShaders =>
ShimManager.systemInfoShim
.hasDynamicUniformArrayIndexingInFragmentShaders;

public static bool supportsShadows =>
ShimManager.systemInfoShim.supportsShadows;

public static bool supportsRawShadowDepthSampling =>
ShimManager.systemInfoShim.supportsRawShadowDepthSampling;

public static bool supportsMotionVectors =>
ShimManager.systemInfoShim.supportsMotionVectors;

public static bool supports3DTextures =>
ShimManager.systemInfoShim.supports3DTextures;

public static bool supportsCompressed3DTextures =>
ShimManager.systemInfoShim.supportsCompressed3DTextures;

public static bool supports2DArrayTextures =>
ShimManager.systemInfoShim.supports2DArrayTextures;

public static bool supports3DRenderTextures =>
ShimManager.systemInfoShim.supports3DRenderTextures;

public static bool supportsCubemapArrayTextures =>
ShimManager.systemInfoShim.supportsCubemapArrayTextures;

public static Rendering.CopyTextureSupport copyTextureSupport =>
ShimManager.systemInfoShim.copyTextureSupport;

public static bool supportsComputeShaders =>
ShimManager.systemInfoShim.supportsComputeShaders;

public static bool supportsConservativeRaster =>
ShimManager.systemInfoShim.supportsConservativeRaster;

public static bool supportsGeometryShaders =>
ShimManager.systemInfoShim.supportsGeometryShaders;

public static bool supportsTessellationShaders =>
ShimManager.systemInfoShim.supportsTessellationShaders;

public static bool supportsInstancing =>
ShimManager.systemInfoShim.supportsInstancing;

public static bool supportsHardwareQuadTopology =>
ShimManager.systemInfoShim.supportsHardwareQuadTopology;

public static bool supports32bitsIndexBuffer =>
ShimManager.systemInfoShim.supports32bitsIndexBuffer;

public static bool supportsSparseTextures =>
ShimManager.systemInfoShim.supportsSparseTextures;

public static int supportedRenderTargetCount =>
ShimManager.systemInfoShim.supportedRenderTargetCount;

public static bool supportsSeparatedRenderTargetsBlend =>
ShimManager.systemInfoShim.supportsSeparatedRenderTargetsBlend;

public static int supportedRandomWriteTargetCount =>
ShimManager.systemInfoShim.supportedRandomWriteTargetCount;

public static int supportsMultisampledTextures =>
ShimManager.systemInfoShim.supportsMultisampledTextures;

public static bool supportsMultisampleAutoResolve =>
ShimManager.systemInfoShim.supportsMultisampleAutoResolve;

public static int supportsTextureWrapMirrorOnce =>
ShimManager.systemInfoShim.supportsTextureWrapMirrorOnce;

public static bool usesReversedZBuffer =>
ShimManager.systemInfoShim.usesReversedZBuffer;
...
public static bool
SupportsBlendingOnRenderTextureFormat(RenderTextureFormat format) {
	return ShimManager.systemInfoShim.SupportsBlendingOnRenderTextureFormat(
		format);
}
...
public static bool SupportsVertexAttributeFormat(VertexAttributeFormat format,
                                                 int dimension) {
	return ShimManager.systemInfoShim.SupportsVertexAttributeFormat(format,
	                                                                dimension);
}

public static NPOTSupport npotSupport =>
ShimManager.systemInfoShim.npotSupport;
...
internal static int maxRenderTextureSize =>
EditorSystemInfo.maxRenderTextureSize;

public static int maxComputeBufferInputsVertex =>
ShimManager.systemInfoShim.maxComputeBufferInputsVertex;

public static int maxComputeBufferInputsFragment =>
ShimManager.systemInfoShim.maxComputeBufferInputsFragment;

public static int maxComputeBufferInputsGeometry =>
ShimManager.systemInfoShim.maxComputeBufferInputsGeometry;

public static int maxComputeBufferInputsDomain =>
ShimManager.systemInfoShim.maxComputeBufferInputsDomain;

public static int maxComputeBufferInputsHull =>
ShimManager.systemInfoShim.maxComputeBufferInputsHull;

public static int maxComputeBufferInputsCompute =>
ShimManager.systemInfoShim.maxComputeBufferInputsCompute;

public static int maxComputeWorkGroupSize =>
ShimManager.systemInfoShim.maxComputeWorkGroupSize;

public static int maxComputeWorkGroupSizeX =>
ShimManager.systemInfoShim.maxComputeWorkGroupSizeX;

public static int maxComputeWorkGroupSizeY =>
ShimManager.systemInfoShim.maxComputeWorkGroupSizeY;

public static int maxComputeWorkGroupSizeZ =>
ShimManager.systemInfoShim.maxComputeWorkGroupSizeZ;

public static bool supportsAsyncCompute =>
ShimManager.systemInfoShim.supportsAsyncCompute;

public static bool supportsGpuRecorder =>
ShimManager.systemInfoShim.supportsGpuRecorder;
public static bool supportsGraphicsFence =>
ShimManager.systemInfoShim.supportsGraphicsFence;

public static bool supportsAsyncGPUReadback =>
ShimManager.systemInfoShim.supportsAsyncGPUReadback;
public static bool supportsRayTracing =>
ShimManager.systemInfoShim.supportsRayTracing;

public static bool supportsSetConstantBuffer =>
ShimManager.systemInfoShim.supportsSetConstantBuffer;

public static bool minConstantBufferOffsetAlignment =>
ShimManager.systemInfoShim.minConstantBufferOffsetAlignment;

public static bool hasMipMaxLevel =>
ShimManager.systemInfoShim.hasMipMaxLevel;

public static bool supportsMipStreaming =>
ShimManager.systemInfoShim.supportsMipStreaming;

public static bool usesLoadStoreActions =>
ShimManager.systemInfoShim.usesLoadStoreActions;

public static HDRDisplaySupportFlags hdrDisplaySupportFlags =>
ShimManager.systemInfoShim.hdrDisplaySupportFlags;
...
public static GraphicsFormat GetCompatibleFormat(GraphicsFormat format,
                                                 FormatUsage usage) {
...
[Obsolete("supportsRenderTextures always returns true, no need to call it")]
public static bool supportsRenderTextures =>
EditorSystemInfo.supportsRenderTextures;

[Obsolete("supportsRenderToCubemap always returns true, no need to call it")]
public static bool supportsRenderToCubemap =>
EditorSystemInfo.supportsRenderToCubemap;

[Obsolete("supportsImageEffects always returns true, no need to call it")]
public static bool supportsImageEffects =>
EditorSystemInfo.supportsImageEffects;
...
[Obsolete("graphicsPixelFillrate is no longer supported in Unity 5.0+.")]
public static int graphicsPixelFillrate =>
EditorSystemInfo.graphicsPixelFillrate;

[Obsolete("Vertex program support is required in Unity 5.0+")]
public static bool supportsVertexPrograms =>
EditorSystemInfo.supportsVertexPrograms;
}
