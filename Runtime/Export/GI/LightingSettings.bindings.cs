...
public sealed partial class LightingSettings : Object {
  ...
  public LightingSettings() { Internal_Create(this); }

  private extern static void
  Internal_Create([ Writable ] LightingSettings self);
...
#region Editor Only
  ...
  public extern Lightmapper lightmapper {
    get;
    set;
  }
  ...
  // Realtime lightmap resolution in texels per world unit. Also used for
  // indirect resolution when using baked GI.
  ...
  public extern Sampling sampling {
    get;
    set;
  }
  ...
  public extern FilterMode filteringMode {
    get;
    set;
  }
  ...
  public extern DenoiserType denoiserTypeDirect {
    get;
    set;
  }
  ...
  public extern DenoiserType denoiserTypeIndirect {
    get;
    set;
  }
  ...
  public extern DenoiserType denoiserTypeAO {
    get;
    set;
  }
  ...
  public extern FilterType filterTypeDirect {
    get;
    set;
  }
  ...
  public extern FilterType filterTypeIndirect {
    get;
    set;
  }
  ...
  public extern FilterType filterTypeAO {
    get;
    set;
  }

  // Which radius is used for the direct light path tracer filter if gauss is
  // chosen.
  ...
  // Which radius is used for the indirect light path tracer filter if gauss is
  // chosen.
  ...
  // Which position sigma is used for the direct light path tracer filter if
  // Atrous is chosen.
  ...
  // Which position sigma is used for the indirect light path tracer filter if
  // Atrous is chosen.
