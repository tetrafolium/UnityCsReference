...
namespace UnityEngine.Windows.WebCam {
  ...
  public class WebCam {
    public extern static WebCamMode Mode {
      [NativeConditional(
          "(PLATFORM_WIN || PLATFORM_WINRT) && !PLATFORM_XBOXONE")]
      [NativeName("GetWebCamMode")] get;
    }
  }
  ...
  public struct CameraParameters {
    ...
    public float hologramOpacity {
      get { return m_HologramOpacity; }
      set { m_HologramOpacity = value; }
    }
    ...
    public int cameraResolutionWidth {
      get { return m_CameraResolutionWidth; }
      set { m_CameraResolutionWidth = value; }
    }
    public int cameraResolutionHeight {
      get { return m_CameraResolutionHeight; }
      set { m_CameraResolutionHeight = value; }
    }
    ...
    public CameraParameters(WebCamMode webCamMode) {
      ...
      if (webCamMode == WebCamMode.PhotoMode) {
        Resolution photoCaptureCameraResolution =
        ...
        Resolution videoCaptureCameraResolution =
            VideoCapture.SupportedResolutions
                .OrderByDescending((res) => res.width * res.height)
                .First();
        float cameraFramerate = VideoCapture
                                    .GetSupportedFrameRatesForResolution(
                                        videoCaptureCameraResolution)
