...
public partial struct Bounds : IEquatable<Bounds>,
	...
	// Creates new Bounds with a given /center/ and total /size/. Bound
	// ::ref::extents will be half the given size.
	...
	public string ToString(string format, IFormatProvider formatProvider) {
		if (string.IsNullOrEmpty(format))
			format = "F1";
		return UnityString.Format("Center: {0}, Extents: {1}",
