...
public struct BoundsInt : IEquatable<BoundsInt>,
  ...
  public Vector3 center {
    get {
      return new Vector3(x + m_Size.x / 2f, y + m_Size.y / 2f,
                         z + m_Size.z / 2f);
    }
  }
  public Vector3Int min {
    get { return new Vector3Int(xMin, yMin, zMin); }
    set {
      xMin = value.x;
      yMin = value.y;
      zMin = value.z;
  ...
  public Vector3Int max {
    get { return new Vector3Int(xMax, yMax, zMax); }
    set {
      xMax = value.x;
      yMax = value.y;
      zMax = value.z;
  ...
  public int xMin {
    get { return Math.Min(m_Position.x, m_Position.x + m_Size.x); }
    set {
      int oldxmax = xMax;
      m_Position.x = value;
  ...
  public int yMin {
    get { return Math.Min(m_Position.y, m_Position.y + m_Size.y); }
    set {
      int oldymax = yMax;
      m_Position.y = value;
  ...
  public int zMin {
    get { return Math.Min(m_Position.z, m_Position.z + m_Size.z); }
    set {
      int oldzmax = zMax;
      m_Position.z = value;
  ...
  public int xMax {
    get { return Math.Max(m_Position.x, m_Position.x + m_Size.x); }
    set { m_Size.x = value - m_Position.x; }
  }
  public int yMax {
    get { return Math.Max(m_Position.y, m_Position.y + m_Size.y); }
    set { m_Size.y = value - m_Position.y; }
  }
  public int zMax {
    get { return Math.Max(m_Position.z, m_Position.z + m_Size.z); }
  ...
  public BoundsInt(int xMin, int yMin, int zMin, int sizeX, int sizeY,
                   int sizeZ) {
  ...
  public void ClampToBounds(BoundsInt bounds) {
    ...
    size = new Vector3Int(Math.Min(bounds.xMax - position.x, size.x),
  ...
  public struct PositionEnumerator : IEnumerator<Vector3Int> {
    ...
    public PositionEnumerator GetEnumerator() { return this; }
