...
namespace UnityEngine.Rendering {
  ...
  public struct RenderTargetBlendState : IEquatable<RenderTargetBlendState> {
    ...
    public bool Equals(RenderTargetBlendState other) {
      return m_WriteMask == other.m_WriteMask &&
             m_SourceColorBlendMode == other.m_SourceColorBlendMode &&
             m_DestinationColorBlendMode == other.m_DestinationColorBlendMode &&
             m_SourceAlphaBlendMode == other.m_SourceAlphaBlendMode &&
             m_DestinationAlphaBlendMode == other.m_DestinationAlphaBlendMode &&
             m_ColorBlendOperation == other.m_ColorBlendOperation &&
             m_AlphaBlendOperation == other.m_AlphaBlendOperation;
    }

    public override bool Equals(object obj) {
      if (ReferenceEquals(null, obj))
        return false;
      return obj is RenderTargetBlendState &&
             Equals((RenderTargetBlendState) obj);
    }
    ...
    public static bool operator ==(RenderTargetBlendState left,
                                   RenderTargetBlendState right) {
