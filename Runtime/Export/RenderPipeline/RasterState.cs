...
namespace UnityEngine.Rendering {
  ...
  public struct RasterState : IEquatable<RasterState> {
    ...
    public static readonly RasterState defaultValue =
        new RasterState(CullMode.Back);

    public RasterState(CullMode cullingMode = CullMode.Back,
                       int offsetUnits = 0, float offsetFactor = 0f,
                       bool depthClip = true) {
    ...
    public bool Equals(RasterState other) {
      return m_CullingMode == other.m_CullingMode &&
             m_OffsetUnits == other.m_OffsetUnits &&
             m_OffsetFactor.Equals(other.m_OffsetFactor) &&
             m_DepthClip == other.m_DepthClip &&
             m_Conservative == other.m_Conservative;
    }
