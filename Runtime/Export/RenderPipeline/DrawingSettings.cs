...
#pragma warning restore 414
    ...
    public DrawingSettings(ShaderTagId shaderPassName,
    ...
    public Material overrideMaterial {
      get {
        return m_OverrideMaterialInstanceId != 0
                   ? Object.FindObjectFromInstanceID(
                         m_OverrideMaterialInstanceId) as Material
                   : null;
      }
    ...
    public ShaderTagId GetShaderPassName(int index) {
      if (index >= maxShaderPasses || index < 0)
        throw new ArgumentOutOfRangeException(
            nameof(index),
            $"Index should range from 0 to DrawSettings.maxShaderPasses ({maxShaderPasses}), was {index}");

      fixed(int *p = shaderPassNames) { return new ShaderTagId{id = p[index]}; }
    }
    ...
    public void SetShaderPassName(int index, ShaderTagId shaderPassName) {
      ...
      fixed(int *p = shaderPassNames) { p[index] = shaderPassName.id; }
    }
    ...
    public bool Equals(DrawingSettings other) {
      ...
      return m_SortingSettings.Equals(other.m_SortingSettings) &&
             ...
             m_OverrideMaterialInstanceId ==
                 other.m_OverrideMaterialInstanceId &&
    ...
    public static bool operator ==(DrawingSettings left,
                                   DrawingSettings right) {
