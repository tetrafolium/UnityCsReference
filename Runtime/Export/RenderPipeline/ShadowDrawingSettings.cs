...
public struct ShadowDrawingSettings : IEquatable<ShadowDrawingSettings> {
	...
	public ShadowDrawingSettings(CullingResults cullingResults,
	                             int lightIndex) {
	...
	public bool Equals(ShadowDrawingSettings other) {
		return m_CullingResults.Equals(other.m_CullingResults) &&
		       ...
		       m_UseRenderingLayerMaskTest.Equals(
			other.m_UseRenderingLayerMaskTest);
	}

	public override bool Equals(object obj) {
		if (ReferenceEquals(null, obj))
			return false;
		return obj is ShadowDrawingSettings &&
		       Equals((ShadowDrawingSettings) obj);
	}
	...
	public static bool operator ==(ShadowDrawingSettings left,
	                               ShadowDrawingSettings right) {
