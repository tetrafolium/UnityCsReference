...
public struct RenderQueueRange : IEquatable<RenderQueueRange>
{
    ...
    public static RenderQueueRange opaque => new RenderQueueRange {
        m_LowerBound = k_MinimumBound, m_UpperBound = (int)UnityEngine.Rendering.RenderQueue.GeometryLast
    };

    public static RenderQueueRange transparent => new RenderQueueRange {
        m_LowerBound = (int)UnityEngine.Rendering.RenderQueue.GeometryLast + 1, m_UpperBound = k_MaximumBound
    };
