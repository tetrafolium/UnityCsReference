...
#pragma warning restore 649
	...
	(Texture) Object.FindObjectFromInstanceID(m_TextureId);

	public ReflectionProbe reflectionProbe =>
	(ReflectionProbe) Object.FindObjectFromInstanceID(m_InstanceId);
	...
	public bool Equals(VisibleReflectionProbe other) {
		return m_Bounds.Equals(other.m_Bounds) &&
		       m_LocalToWorldMatrix.Equals(other.m_LocalToWorldMatrix) &&
		       m_HdrData.Equals(other.m_HdrData) &&
		       m_Center.Equals(other.m_Center) &&
		       m_BlendDistance.Equals(other.m_BlendDistance) &&
		       m_Importance == other.m_Importance &&
		       m_BoxProjection == other.m_BoxProjection &&
	...
	public override bool Equals(object obj) {
		if (ReferenceEquals(null, obj))
			return false;
		return obj is VisibleReflectionProbe &&
		       Equals((VisibleReflectionProbe) obj);
	}
	...
	public static bool operator ==(VisibleReflectionProbe left,
	                               VisibleReflectionProbe right) {
