...
public struct FilteringSettings : IEquatable<FilteringSettings> {
	...
	public FilteringSettings(
		[
			DefaultValue("RenderQueueRange.all")
		] RenderQueueRange? renderQueueRange = null,
		int layerMask = ~0, uint renderingLayerMask = uint.MaxValue,
	...
	public static bool operator ==(FilteringSettings left,
	                               FilteringSettings right) {
