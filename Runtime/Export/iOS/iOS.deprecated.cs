...
partial class iPhoneSettings
{
    ...
    public static iPhoneScreenOrientation screenOrientation {
        get {
            return default(iPhoneScreenOrientation);
        }
    }
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public static iPhoneNetworkReachability internetReachability {
        get {
            return default(iPhoneNetworkReachability);
        }
    }
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public static iPhoneGeneration generation {
        get {
            return default(iPhoneGeneration);
        }
    }
}
...
public struct iPhoneTouch
{
    ...
    public iPhoneTouchPhase phase {
        get {
            return default(iPhoneTouchPhase);
        }
    }
}
...
public class iPhoneInput
{
    ...
    public static iPhoneOrientation orientation {
        get {
            return default(iPhoneOrientation);
        }
    }
...
public sealed class LocalNotification
{
    ...
    public CalendarUnit repeatInterval {
        get {
            return default(CalendarUnit);
        }
        set {}
    }
    public CalendarIdentifier repeatCalendar {
        get {
            return default(CalendarIdentifier);
        }
        set {}
    }
...
public sealed class ADBannerView
{
    ...
    public ADBannerView.Layout layout  {
        get {
            return default(ADBannerView.Layout);
        }
        set {}
    }
    public Vector2 position {
