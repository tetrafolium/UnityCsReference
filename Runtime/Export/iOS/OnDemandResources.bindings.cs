...
public sealed partial class OnDemandResourcesRequest : AsyncOperation,
	      IDisposable {
extern public string error {
	get;
}
extern public float loadingPriority {
	get;
	set;
}
...
extern public static bool enabled {
	[FreeFunction("OnDemandResourcesScripting::Enabled")] get;
}

[FreeFunction(
	 "OnDemandResourcesScripting::PreloadAsync")] extern private static OnDemandResourcesRequest
PreloadAsyncImpl(string[] tags);
