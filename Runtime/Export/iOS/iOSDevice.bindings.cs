...
public enum ActivityIndicatorStyle {
	...
	WhiteLarge = 0, // The large white style of indicator
	                // (UIActivityIndicatorViewStyleWhiteLarge).
	White = 1,  // The standard white style of indicator
	            // (UIActivityIndicatorViewStyleWhite).
	Gray = 2,   // The standard gray style of indicator
...
extern public static string systemVersion {
	[FreeFunction("systeminfo::GetDeviceSystemVersion")] get;
}

extern public static DeviceGeneration generation {
	[NativeConditional("PLATFORM_IOS")]
	[FreeFunction("UnityDeviceGeneration")] get;
}

extern public static string vendorIdentifier {
	[NativeConditional("PLATFORM_IOS || PLATFORM_TVOS")]
	[FreeFunction("UnityVendorIdentifier")] get;
}

// please note that we check both
// advertisingIdentifier/advertisingTrackingEnabled
//   usage in scripts to decide if we should enable UNITY_USES_IAD macro
//   (i.e. code that uses iAD and related things)
// that's why it is VERY important that you use private extern functions
// instead of properties in internal/implementation code as another caveat,
// apple seems to grep app strings naively when checking for usages of this
// api
//   poterntially finding
//   UnityAdvertisingIdentifier/IsAdvertisingTrackingEnabled
// thats why we renamed these functions to be less like apple api

[NativeConditional("PLATFORM_IOS || PLATFORM_TVOS")]
[FreeFunction("UnityAdIdentifier")] extern private static string
GetAdIdentifier();

public static string advertisingIdentifier {
	get {
		string advertisingId = GetAdIdentifier();
		Application.InvokeOnAdvertisingIdentifierCallback(
			advertisingId, IsAdTrackingEnabled());
...
[NativeConditional("PLATFORM_IOS || PLATFORM_TVOS")]
[FreeFunction(
	 "IOSScripting::IsAdTrackingEnabled")] extern private static bool
IsAdTrackingEnabled();

public static bool advertisingTrackingEnabled {
	get { return IsAdTrackingEnabled(); }
}
...
[NativeConditional("PLATFORM_IOS || PLATFORM_TVOS")]
[NativeMethod(Name = "IOSScripting::SetNoBackupFlag", IsFreeFunction = true,
              IsThreadSafe = true)] extern public static void
SetNoBackupFlag(string path);

[NativeConditional("PLATFORM_IOS || PLATFORM_TVOS")]
[NativeMethod(Name = "IOSScripting::ResetNoBackupFlag",
              IsFreeFunction = true,
              IsThreadSafe = true)] extern public static void
ResetNoBackupFlag(string path);

[NativeConditional("PLATFORM_IOS")]
[NativeMethod(Name = "IOSScripting::RequestStoreReview",
              IsFreeFunction = true,
