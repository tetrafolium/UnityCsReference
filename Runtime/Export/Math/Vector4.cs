...
public partial struct Vector4 : IEquatable<Vector4>,
	...
	// Creates a new vector with given x, y components and sets /z/ and /w/ to
	// zero.
	...
	public static Vector4 MoveTowards(Vector4 current, Vector4 target,
		...
		float sqdist = (toVector_x * toVector_x + toVector_y * toVector_y +
		                toVector_z * toVector_z + toVector_w * toVector_w);
	...
	public Vector4 normalized {
		get { return Vector4.Normalize(this); }
	}
	...
	public static Vector4 Min(Vector4 lhs, Vector4 rhs) {
		return new Vector4(Mathf.Min(lhs.x, rhs.x), Mathf.Min(lhs.y, rhs.y),
	...
	public static Vector4 Max(Vector4 lhs, Vector4 rhs) {
		return new Vector4(Mathf.Max(lhs.x, rhs.x), Mathf.Max(lhs.y, rhs.y),
	...
	static readonly Vector4 positiveInfinityVector =
		new Vector4(float.PositiveInfinity, float.PositiveInfinity,
	...
	[MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
	public static Vector4
	operator *(Vector4 a, float d) {
		return new Vector4(a.x * d, a.y * d, a.z * d, a.w * d);
	}
	// Multiplies a vector by a number.
	[MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
	public static Vector4
	operator *(float d, Vector4 a) {
		return new Vector4(a.x * d, a.y * d, a.z * d, a.w * d);
	}
	...
	operator ==(Vector4 lhs, Vector4 rhs) {
		...
		float sqrmag =
			diffx * diffx + diffy * diffy + diffz * diffz + diffw * diffw;
