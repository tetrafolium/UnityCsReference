...
namespace UnityEngine.Rendering {
  ...
  public struct SphericalHarmonicsL2 : IEquatable<SphericalHarmonicsL2> {
    ...
    AddDirectionalLightInternal(ref SphericalHarmonicsL2 sh, Vector3 direction,
                                Color color);
    ...
    public void Evaluate(Vector3[] directions, Color[] results) {
      ...
      if (directions.Length != results.Length)
        throw new ArgumentException(
            "Length of the directions array and the results array must match.");

      EvaluateInternal(ref this, directions, results);
    }

    [FreeFunction]
    private extern static void EvaluateInternal(ref SphericalHarmonicsL2 sh,
                                                Vector3[] directions,
                                                [ Out ] Color[] results);
    ...
    public override bool Equals(object other) {
      return other is SphericalHarmonicsL2 &&
             Equals((SphericalHarmonicsL2) other);
    }

    public bool Equals(SphericalHarmonicsL2 other) { return this == other; }

    static public SphericalHarmonicsL2 operator *(SphericalHarmonicsL2 lhs,
                                                  float rhs) {
    ...
    static public SphericalHarmonicsL2 operator *(float lhs,
    ...
    public static bool operator ==(SphericalHarmonicsL2 lhs,
                                   SphericalHarmonicsL2 rhs) {
      return lhs.shr0 == rhs.shr0 && lhs.shr1 == rhs.shr1 &&
             lhs.shr2 == rhs.shr2 && lhs.shr3 == rhs.shr3 &&
             lhs.shr4 == rhs.shr4 && lhs.shr5 == rhs.shr5 &&
             lhs.shr6 == rhs.shr6 && lhs.shr7 == rhs.shr7 &&
             lhs.shr8 == rhs.shr8 && lhs.shg0 == rhs.shg0 &&
             lhs.shg1 == rhs.shg1 && lhs.shg2 == rhs.shg2 &&
             lhs.shg3 == rhs.shg3 && lhs.shg4 == rhs.shg4 &&
             lhs.shg5 == rhs.shg5 && lhs.shg6 == rhs.shg6 &&
             lhs.shg7 == rhs.shg7 && lhs.shg8 == rhs.shg8 &&
             lhs.shb0 == rhs.shb0 && lhs.shb1 == rhs.shb1 &&
             lhs.shb2 == rhs.shb2 && lhs.shb3 == rhs.shb3 &&
             lhs.shb4 == rhs.shb4 && lhs.shb5 == rhs.shb5 &&
             lhs.shb6 == rhs.shb6 && lhs.shb7 == rhs.shb7 &&
             lhs.shb8 == rhs.shb8;
    }
