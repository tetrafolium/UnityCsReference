...
public partial struct Quaternion : IEquatable<Quaternion>,
	...
	// The identity rotation (RO). This quaternion corresponds to "no rotation":
	// the object
	...
	// Is the dot product of two quaternions within tolerance for them to be
	// considered equal?
	...
	public void SetLookRotation(Vector3 view,
	                            [ uei.DefaultValue("Vector3.up") ] Vector3 up) {
	...
	public static float Angle(Quaternion a, Quaternion b) {
		float dot = Dot(a, b);
		return IsEqualUsingDot(dot) ? 0.0f
		                : Mathf.Acos(Mathf.Min(Mathf.Abs(dot), 1.0F)) *
		       2.0F * Mathf.Rad2Deg;
	}

	// Makes euler angles positive 0/360 with 0.0001 hacked to support old
	// behaviour of QuaternionToEuler
	...
	public string ToString(string format, IFormatProvider formatProvider) {
		...
		return UnityString.Format(
			"({0}, {1}, {2}, {3})", x.ToString(format, formatProvider),
			y.ToString(format, formatProvider), z.ToString(format, formatProvider),
			w.ToString(format, formatProvider));
	}

	[System.Obsolete(
		 "Use Quaternion.Euler instead. This function was deprecated because it uses radians instead of degrees.")]
	...
	[System.Obsolete(
		 "Use Quaternion.eulerAngles instead. This function was deprecated because it uses radians instead of degrees.")]
	...
	[System.Obsolete(
		 "Use Quaternion.ToAngleAxis instead. This function was deprecated because it uses radians instead of degrees.")]
	...
	[System.Obsolete(
		 "Use Quaternion.AngleAxis instead. This function was deprecated because it uses radians instead of degrees.")]
