...
public struct Vector3Int : IEquatable<Vector3Int>,
  ...
  public int this[int index] {
    get {
      ...
      case 2:
        return z;
      default:
        throw new IndexOutOfRangeException(UnityString.Format(
            "Invalid Vector3Int index addressed: {0}!", index));
      }
    }
  ...
  public static Vector3Int Min(Vector3Int lhs, Vector3Int rhs) {
    return new Vector3Int(Mathf.Min(lhs.x, rhs.x), Mathf.Min(lhs.y, rhs.y),
  ...
  public static Vector3Int Max(Vector3Int lhs, Vector3Int rhs) {
    return new Vector3Int(Mathf.Max(lhs.x, rhs.x), Mathf.Max(lhs.y, rhs.y),
  ...
  operator Vector2Int(Vector3Int v) {
  ...
  operator +(Vector3Int a, Vector3Int b) {
    return new Vector3Int(a.x + b.x, a.y + b.y, a.z + b.z);
  }
  ...
  [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
  public static Vector3Int
  operator -(Vector3Int a) {
    return new Vector3Int(-a.x, -a.y, -a.z);
  }

  [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
  public static Vector3Int
  operator *(Vector3Int a, int b) {
    return new Vector3Int(a.x * b, a.y * b, a.z * b);
  }

  [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
  public static Vector3Int
  operator *(int a, Vector3Int b) {
  ...
  [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
  public static bool
  operator ==(Vector3Int lhs, Vector3Int rhs) {
  ...
  public override int GetHashCode() {
    ...
    return x.GetHashCode() ^ (yHash << 4) ^ (yHash >> 28) ^ (zHash >> 4) ^
           (zHash << 28);
  }
