...
public partial class ColorUtility {
  ...
  public static string ToHtmlStringRGB(Color color) {
    // Round to int to prevent precision issues that, for example cause values
    // very close to 1 to become FE instead of FF (case 770904).
    Color32 col32 = new Color32(
        ...
        (byte) Mathf.Clamp(Mathf.RoundToInt(color.b * 255), 0, 255), 1);
  ...
  public static string ToHtmlStringRGBA(Color color) {
    ...
    return UnityString.Format("{0:X2}{1:X2}{2:X2}{3:X2}", col32.r, col32.g,
                              col32.b, col32.a);
  }
}
}
