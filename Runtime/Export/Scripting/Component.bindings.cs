...
public partial class Component : UnityEngine.Object {
  public extern Transform transform {
    [FreeFunction("GetTransform", HasExplicitThis = true,
                  ThrowsException = true)] get;
  }
  ...
  GetComponentFastPath(System.Type type, IntPtr oneFurtherThanResultValue);
  ...
  [FreeFunction(HasExplicitThis = true)] extern public Component
  ...
  public T
  GetComponentInChildren<T>([ DefaultValue("false") ] bool includeInactive) {
  ...
  public Component[] GetComponentsInParent(
      Type t, [ DefaultValue("false") ] bool includeInactive) {
  ...
  public bool CompareTag(string tag) { return gameObject.CompareTag(tag); }

  [FreeFunction(HasExplicitThis = true)] extern internal
      Component GetCoupledComponent();

  [FreeFunction(HasExplicitThis = true)] extern internal bool
  IsCoupledComponent();

  [FreeFunction(HasExplicitThis = true)] extern public void
  SendMessageUpwards(string methodName, [ DefaultValue("null") ] object value, [
    DefaultValue("SendMessageOptions.RequireReceiver")
  ...
  [FreeFunction("SendMessage", HasExplicitThis = true)] extern public void
  ...
  [FreeFunction("BroadcastMessage", HasExplicitThis = true)] extern public void
  BroadcastMessage(string methodName, [ DefaultValue("null") ] object parameter,
                   [
                     DefaultValue("SendMessageOptions.RequireReceiver")
                   ] SendMessageOptions options);
