...
public static class StackTraceUtility {
  ...
  [System.Security.SecuritySafeCritical] // System.Diagnostics.StackTrace cannot
                                         // be accessed from transparent code
                                         // (PSM, 2.12)
      [RequiredByNativeCode]
  ...
  [System.Security.SecuritySafeCritical] // System.Diagnostics.StackTrace cannot
                                         // be accessed from transparent code
                                         // (PSM, 2.12)
      static internal void ExtractStringFromExceptionInternal(
          System.Object exceptiono, out string message, out string stackTrace) {
    if (exceptiono == null)
      throw new ArgumentException(
          "ExtractStringFromExceptionInternal called with null exception");
    ...
    StringBuilder sb = new StringBuilder(exception.StackTrace == null ? 512
  ...
  // NB if you change this formatting/code there is a separate Mono quick path
  // in MonoManager.cpp that must be updated as well.
  [System.Security.SecuritySafeCritical] // System.Diagnostics.StackTrace cannot
                                         // be accessed from transparent code
                                         // (PSM, 2.12)
    ...
    for (iIndex = 0; iIndex < stackTrace.FrameCount; iIndex++) {
      ...
      // Add path name and line number - unless it is a Debug.Log call, then we
      // are only interested in the calling frame.
      string path = frame.GetFileName();
      if (path != null) {
        bool shouldStripLineNumbers =
            (classType.Name == "Debug" &&
             classType.Namespace == "UnityEngine") ||
            (classType.Name == "Logger" &&
             classType.Namespace == "UnityEngine") ||
            (classType.Name == "DebugLogHandler" &&
             classType.Namespace == "UnityEngine") ||
            (classType.Name == "Assert" &&
             classType.Namespace == "UnityEngine.Assertions") ||
...
#pragma warning disable 169
  ...
  public UnityException(string message) : base(message) { HResult = Result; }
...
#pragma warning disable 169
  ...
  protected MissingComponentException(SerializationInfo info,
...
#pragma warning disable 169
  ...
  protected UnassignedReferenceException(SerializationInfo info,
                                         StreamingContext context)
      : base(info, context) {}
}
...
#pragma warning disable 169
  ...
  protected MissingReferenceException(SerializationInfo info,
                                      StreamingContext context)
      : base(info, context) {}
}
}
