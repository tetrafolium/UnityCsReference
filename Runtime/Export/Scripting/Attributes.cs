...
// The RequireComponent attribute lets automatically add required component as a
// dependency.
[RequiredByNativeCode]
...
// The AddComponentMenu attribute allows you to place a script anywhere in the
// "Component" menu, instead of just the "Component->Scripts" menu.
public sealed class AddComponentMenu : Attribute {
  private string m_AddComponentMenu;
  private int m_Ordering;

  // The script will be placed in the component menu according to /menuName/.
  // /menuName/ is the path to the component
  ...
  public string componentMenu {
    get { return m_AddComponentMenu; }
  }

  //* undocumented
  public int componentOrder {
    get { return m_Ordering; }
  }
}
...
public sealed class ContextMenu : Attribute {
  // Creates a context menu item that invokes the non-static method when
  // selected
...
// Makes a script execute always: when in edit mode, play mode (also for scripts
// prefab isolation mode in play mode)
[UsedByNativeCode]
...
public sealed class HelpURLAttribute : Attribute {
  ...
  // internal ability to retarget the url on an inside field value's type's
  // HelpURL
...
public class DefaultExecutionOrder : Attribute {
  public DefaultExecutionOrder(int order) { m_Order = order; }
