...
[NativeThrows] extern static void SetMode(Mode mode);
extern static Mode GetMode();

public extern static bool isIncremental {
	[NativeMethod("GetIncrementalEnabled")] get;
}

public extern static ulong incrementalTimeSliceNanoseconds {
	get;
	set;
}
