...
public sealed partial class ReflectionProbe : Behaviour {
  ...
  [Obsolete(
      "type property has been deprecated. Starting with Unity 5.4, the only supported reflection probe type is Cube.",
      true)]
  ...
  public extern Vector4 textureHDRDecodeValues {
    [NativeName("CalculateHDRDecodeValues")] get;
  }

  public extern void Reset();

  public int RenderProbe() { return RenderProbe(null); }
  ...
  private extern int
  ScheduleRender(ReflectionProbeTimeSlicingMode timeSlicingMode,
                 RenderTexture targetTexture);

  [NativeHeader("Runtime/Camera/CubemapGPUUtility.h")]
  [FreeFunction("CubemapGPUBlend")]
  public static extern bool BlendCubemap(Texture src, Texture dst, float blend,
  ...
  [StaticAccessor("GetReflectionProbes()")]
  public static extern Vector4 defaultTextureHDRDecodeValues {
    get;
  }
  ...
  public static event Action<ReflectionProbe, ReflectionProbeEvent>
      reflectionProbeChanged;
  public static event Action<Cubemap> defaultReflectionSet;

  [UnityEngine.Scripting.RequiredByNativeCode]
  private static void
  CallReflectionProbeEvent(ReflectionProbe probe,
                           ReflectionProbeEvent probeEvent) {
  ...
  [UnityEngine.Scripting.RequiredByNativeCode]
  private static void
  CallSetDefaultReflection(Cubemap defaultReflectionCubemap) {
