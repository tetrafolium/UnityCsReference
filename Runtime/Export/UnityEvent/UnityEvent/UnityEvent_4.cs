...
namespace UnityEngine.Events {
  public delegate void UnityAction<T0, T1, T2, T3>(T0 arg0, T1 arg1, T2 arg2,
                                                   T3 arg3);
  ...
  public class UnityEvent<T0, T1, T2, T3> : UnityEventBase {
    ...
    protected override MethodInfo FindMethod_Impl(string name,
      ...
      return GetValidMethodInfo(
          targetObjType, name,
          new Type[]{typeof(T0), typeof(T1), typeof(T2), typeof(T3)});
    }
    ...
    GetDelegate(UnityAction<T0, T1, T2, T3> action) {
    ...
    internal void RegisterPersistentListener(int index,
