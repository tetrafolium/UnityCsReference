...
PlayFullScreenMovie(string path,
		    ...
		    [
			    DefaultValue("FullScreenMovieControlMode.Full")
                    ] FullScreenMovieControlMode controlMode,
		    [
			    DefaultValue("FullScreenMovieScalingMode.AspectFit")
                    ] FullScreenMovieScalingMode scalingMode) {
	return PlayFullScreenMovie_Bindings(path, bgColor, controlMode,
	                                    scalingMode);
}
...
PlayFullScreenMovie_Bindings(string path, Color bgColor,
                             FullScreenMovieControlMode controlMode,
                             FullScreenMovieScalingMode scalingMode);
...
[Obsolete(
	 "Property Handheld.use32BitDisplayBuffer has been deprecated. Modifying it has no effect, use PlayerSettings instead.")]
...
/// Sets ActivityIndicator style. See iOS.ActivityIndicatorStyle enumeration
/// for possible values. Be warned that it will take effect on next call to
/// StartActivityIndicator.
public static void
SetActivityIndicatorStyle(iOS.ActivityIndicatorStyle style) {
	SetActivityIndicatorStyleImpl_Bindings((int) style);
}

/// Sets ActivityIndicator style. See AndroidActivityIndicatorStyle
/// enumeration for possible values. Be warned that it will take effect on
/// next call to StartActivityIndicator.
public static void
