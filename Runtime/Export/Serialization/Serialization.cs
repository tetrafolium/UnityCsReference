...
/// <summary>
/// What is this : Instruct the Unity serialization backend to serialize field
/// as a reference type, as opposed to SerializeField
///                 that serializes the data in place (as if it where a Value
///                 type).
/// Motivation(s):
///  - Polymorphic serialization of plain old C# classes.
///  - Representing graph like structures without having to resort to
///  ScriptableObjects.
///  - Express null fields.
/// </summary>
[RequiredByNativeCode]
