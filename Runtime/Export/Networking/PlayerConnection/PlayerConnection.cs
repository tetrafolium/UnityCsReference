...
namespace UnityEngine.Networking.PlayerConnection {
  ...
  public class PlayerConnection : ScriptableObject,
    ...
    public void Register(Guid messageId,
      ...
      m_PlayerEditorConnectionEvents.AddAndCreate(messageId).AddListener(
          callback);
    }
    ...
    public void UnregisterDisconnection(UnityAction<int> callback) {
      m_PlayerEditorConnectionEvents.disconnectionEvent.RemoveListener(
          callback);
    }
    ...
    public void DisconnectAll() { GetConnectionNativeApi().DisconnectAll(); }
