...
public class Network {
  ...
  [Obsolete(
      "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.",
      true)]
  public static NetworkConnectionError InitializeServer(int connections,
                                                        int listenPort) {
    throw new NotSupportedException(
        "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.");
  }
  ...
  [Obsolete(
      "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.",
      true)]
  public static void CloseConnection(NetworkPlayer target,
  ...
  [Obsolete(
      "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.",
      true)]
  public static Object Instantiate(Object prefab, Vector3 position,
                                   Quaternion rotation, int group) {
    throw new NotSupportedException(
        "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.");
  }
  ...
  [Obsolete(
      "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.",
      true)]
  public static void SetReceivingEnabled(NetworkPlayer player, int group,
                                         bool enabled) {
    throw new NotSupportedException(
        "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.");
  }
  ...
  [Obsolete(
      "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.",
      true)]
  public static void SetSendingEnabled(NetworkPlayer player, int group,
                                       bool enabled) {
    throw new NotSupportedException(
        "The legacy networking system has been removed in Unity 2018.2. Use Unity Multiplayer and NetworkIdentity instead.");
  }
