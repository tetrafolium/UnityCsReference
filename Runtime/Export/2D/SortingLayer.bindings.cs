...
public struct SortingLayer {
	...
	public string name {
		get { return SortingLayer.IDToName(m_Id); }
	}

	public int value {
		get { return SortingLayer.GetLayerValueFromID(m_Id); }
	}
	...
	[FreeFunction("GetTagManager().GetSortingLayerIDs")] extern private static int
