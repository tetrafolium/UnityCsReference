...
// Interface into the native iPhone, Android, UWP, PS4 and Switch on-screen
// keyboards - stubbed on other platforms.
...
public class TouchScreenKeyboard {
  ...
  //*undocumented*
  public TouchScreenKeyboard(string text, TouchScreenKeyboardType keyboardType,
                             bool autocorrection, bool multiline, bool secure,
                             bool alert, string textPlaceholder,
                             int characterLimit) {
    TouchScreenKeyboard_InternalConstructorHelperArguments arguments =
        new TouchScreenKeyboard_InternalConstructorHelperArguments();
    ...
    m_Ptr = TouchScreenKeyboard_InternalConstructorHelper(ref arguments, text,
                                                          textPlaceholder);
  }
  ...
  private static extern IntPtr TouchScreenKeyboard_InternalConstructorHelper(
      ...
      string text, string textPlaceholder);
  ...
  public static bool isSupported {
    get {
      ...
      // Whether or not it can be used is determined automatically by the OS at
      // runtime
  ...
  public static TouchScreenKeyboard
  Open(string text,
       [
    ...
    return new TouchScreenKeyboard(text, keyboardType, autocorrection,
                                   multiline, secure, alert, textPlaceholder,
                                   characterLimit);
  }
  ...
  Open(string text, TouchScreenKeyboardType keyboardType, bool autocorrection,
       bool multiline, bool secure, bool alert, string textPlaceholder) {
    int characterLimit = 0;
    return Open(text, keyboardType, autocorrection, multiline, secure, alert,
  ...
  public static TouchScreenKeyboard
  Open(string text, TouchScreenKeyboardType keyboardType, bool autocorrection,
       bool multiline, bool secure, bool alert) {
    int characterLimit = 0;
  ...
  public extern string text {
    [NativeName("GetText")] get;
    [NativeName("SetText")] set;
  }

  // Specifies if text input field above the keyboard will be hidden when the
  // keyboard is on screen.
  public static extern bool hideInput {
    [NativeName("IsInputHidden")] get;
    [NativeName("SetInputHidden")] set;
  }

  // Specifies if the keyboard is visible or is sliding into the position on
  // screen.
  public extern bool active {
    [NativeName("IsActive")] get;
    [NativeName("SetActive")] set;
  }
  ...
  // Returns the status of the touch screen keyboard (RO). See
  // [[TouchScreenKeyboard.Status]] enumeration for possible values.
  public extern Status status { [NativeName("GetKeyboardStatus")] get; }

  // Set character limit for keyboard input
  public extern int characterLimit {
    [NativeName("GetCharacterLimit")] get;
    [NativeName("SetCharacterLimit")] set;
  }

  public extern bool canGetSelection { [NativeName("CanGetSelection")] get; }

  public extern bool canSetSelection { [NativeName("CanSetSelection")] get; }
  ...
  public RangeInt selection {
    ...
    set {
      if (value.start < 0 || value.length < 0 ||
          value.start + value.length > text.Length)
  ...
  public extern TouchScreenKeyboardType type {
    [NativeName("GetKeyboardType")] get;
  }
  ...
  public static extern bool visible { [NativeName("IsVisible")] get; }
}
}
