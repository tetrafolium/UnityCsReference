...
public enum TouchScreenKeyboardType {
  ...
  NumberPad = 4,
  // Keyboard with a layout suitable for typing telephone numbers, has the
  // numeric 0 to 9, the "*", and "#" keys
  PhonePad = 5,
  // Keyboard with alphanumeric keys designed for entering a person's name or
  // phone number.
  NamePhonePad = 6,
  // Keyboard with additional keys suitable for typing email addresses, features
  // the "@" and "."
  EmailAddress = 7,
  // Keyboard with the Nintendo Network Account key layout (only available on
  // the Wii U)
  [
