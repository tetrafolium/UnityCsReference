...
#pragma warning restore 649
    ...
    public bool readOnly {
        get {
            return Cache_IsReadonly(m_Handle);
        }
    }
    [NativeThrows]
    ...
    public int index {
        get {
            return Cache_GetIndex(m_Handle);
        }
    }
    ...
    public long spaceFree {
        get {
            return Cache_GetSpaceFree(m_Handle);
        }
    }
    [NativeThrows]
    ...
    public long spaceOccupied {
        get {
            return Cache_GetCachingDiskSpaceUsed(m_Handle);
        }
    }
    [NativeThrows]
