...
public struct FrameData {
	...
	public enum EvaluationType { Evaluate, Playback }
	...
	public float effectiveWeight {
		get { return m_EffectiveWeight; }
	}
	[Obsolete(
		 "effectiveParentDelay is obsolete; use a custom ScriptPlayable to implement this feature",
		 false)]
	public double effectiveParentDelay {
		get { return m_EffectiveParentDelay; }
	}
	public float effectiveParentSpeed {
		get { return m_EffectiveParentSpeed; }
	}
	public float effectiveSpeed {
		get { return m_EffectiveSpeed; }
	}
	public EvaluationType evaluationType {
		get {
			return HasFlags(Flags.Evaluate) ? EvaluationType.Evaluate
			                : EvaluationType.Playback;
		}
	}
	public bool seekOccurred {
		get { return HasFlags(Flags.SeekOccured); }
	}
	public bool timeLooped {
		get { return HasFlags(Flags.Loop); }
	}
	public bool timeHeld {
		get { return HasFlags(Flags.Hold); }
	}
