...
public struct FrameData
{
    ...
    public double effectiveParentDelay      {
        get {
            return m_EffectiveParentDelay;
        }
    }
    public float effectiveParentSpeed       {
        get {
            return m_EffectiveParentSpeed;
        }
    }
    ...
    public EvaluationType evaluationType    {
        get {
            return HasFlags(Flags.Evaluate) ? EvaluationType.Evaluate : EvaluationType.Playback;
        }
    }
    public bool seekOccurred                {
        get {
            return HasFlags(Flags.SeekOccured);
        }
    }
    public bool timeLooped                  {
        get {
            return HasFlags(Flags.Loop);
        }
    }
    public bool timeHeld                    {
        get {
            return HasFlags(Flags.Hold);
        }
    }
