...
//  Uses an IntPtr because XBoxOne doesn't support marshalling the struct as
//  a return value properly and UAP doesn't support out parameters
[RequiredByNativeCode]
internal static unsafe void
Internal_CreatePlayable(PlayableAsset asset, PlayableGraph graph,
                        GameObject go, IntPtr ptr) {
	Playable result;
	if (asset == null)
...
[RequiredByNativeCode]
internal static void Internal_GetPlayableAssetDuration(PlayableAsset asset,
                                                       IntPtr ptrToDouble) {
