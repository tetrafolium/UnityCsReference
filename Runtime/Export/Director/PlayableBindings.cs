...
namespace UnityEngine.Playables {
  [Obsolete(
      "DataStreamType is no longer required and will be removed in a future release.",
      false)]
  ...
  public struct PlayableBinding {
    ...
    internal delegate PlayableOutput CreateOutputMethod(PlayableGraph graph,
                                                        string name);
    ...
    public System.Type outputTargetType {
      get { return m_SourceBindingType; }
    }

    [System.ComponentModel.EditorBrowsable(
        System.ComponentModel.EditorBrowsableState.Never)]
    [Obsolete(
        "sourceBindingType is no longer supported on PlayableBinding. Use outputBindingType instead to get the required output target type, and the appropriate binding create method (e.g. AnimationPlayableBinding.Create(name, key)) to create PlayableBindings",
        true)]
    ...
    [System.ComponentModel.EditorBrowsable(
        System.ComponentModel.EditorBrowsableState.Never)]
    [Obsolete(
        "streamType is no longer supported on PlayableBinding. Use the appropriate binding create method (e.g. AnimationPlayableBinding.Create(name, key)) instead.",
        true)]
    public DataStreamType streamType {
      get { return DataStreamType.None; }
      set {}
    }
    ...
    [VisibleToOtherModules]
    internal static PlayableBinding
    CreateInternal(string name, UnityEngine.Object sourceObject,
                   System.Type sourceType, CreateOutputMethod createFunction) {
