...
[StructLayout(LayoutKind.Explicit)] unsafe struct U {
	[FieldOffset(0)]
	public byte *p8;
	[FieldOffset(0)]
	public uint *p32;
...
public static unsafe void Hash(void *message, ulong length, ulong *hash1,
                               ulong *hash2) {
	...
	if (AllowUnalignedRead || ((u.i & 0x7) == 0)) {
		while (u.p64 < end) {
			Mix(u.p64, ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6,
			    ref h7, ref h8, ref h9, ref h10, ref h11);
			u.p64 += k_NumVars;
		}
	} else {
		while (u.p64 < end) {
			UnsafeUtility.MemCpy(buf, u.p64, k_BlockSize);
			Mix(buf, ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6, ref h7,
	...
	End(buf, ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6, ref h7,
	    ref h8, ref h9, ref h10, ref h11);
	*hash1 = h0;
	*hash2 = h1;
}

static unsafe void End(ulong *data, ref ulong h0, ref ulong h1, ref ulong h2,
                       ref ulong h3, ref ulong h4, ref ulong h5, ref ulong h6,
                       ref ulong h7, ref ulong h8, ref ulong h9,
                       ref ulong h10, ref ulong h11) {
	h0 += data[0];
	h1 += data[1];
	h2 += data[2];
	h3 += data[3];
	...
	h10 += data[10];
	h11 += data[11];
	EndPartial(ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6, ref h7,
	           ref h8, ref h9, ref h10, ref h11);
	EndPartial(ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6, ref h7,
	           ref h8, ref h9, ref h10, ref h11);
	EndPartial(ref h0, ref h1, ref h2, ref h3, ref h4, ref h5, ref h6, ref h7,
...
//
static unsafe void EndPartial(ref ulong h0, ref ulong h1, ref ulong h2,
                              ref ulong h3, ref ulong h4, ref ulong h5,
                              ref ulong h6, ref ulong h7, ref ulong h8,
                              ref ulong h9, ref ulong h10, ref ulong h11) {
	h11 += h1;
	h2 ^= h11;
	Rot64(ref h1, 44);
	h0 += h2;
...
static unsafe void Short(void *message, ulong length, ulong *hash1,
                         ulong *hash2) {
...
static unsafe void ShortMix(ref ulong h0, ref ulong h1, ref ulong h2,
                            ref ulong h3) {
	Rot64(ref h2, 50);
	h2 += h3;
	h0 ^= h2;
...
//
static unsafe void Mix(ulong *data, ref ulong s0, ref ulong s1, ref ulong s2,
                       ref ulong s3, ref ulong s4, ref ulong s5, ref ulong s6,
                       ref ulong s7, ref ulong s8, ref ulong s9,
                       ref ulong s10, ref ulong s11) {
	s0 += data[0];
	s2 ^= s10;
	s11 ^= s0;
	Rot64(ref s0, 11);
