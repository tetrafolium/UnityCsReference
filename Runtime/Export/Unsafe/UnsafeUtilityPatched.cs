...
unsafe public static void CopyPtrToStructure<T>(void *ptr,
                                                out T output) where T
: struct {
	if (ptr == null)
...
unsafe static void InternalCopyPtrToStructure<T>(void *ptr,
                                                 out T output) where T
: struct {
...
[MethodImpl(256)]     // AggressiveInlining
unsafe public static void CopyStructureToPtr<T>(ref T input,
                                                void *ptr) where T
: struct {
	if (ptr == null)
		throw new ArgumentNullException();
...
unsafe static void InternalCopyStructureToPtr<T>(ref T input,
                                                 void *ptr) where T
: struct {
	// @patched at compile time
	throw new NotImplementedException("Patching this method failed");
...
unsafe public static T
ReadArrayElementWithStride<T>(void *source, int index, int stride) {
	// @patched at compile time
	throw new NotImplementedException("Patching this method failed");
}

unsafe public static void WriteArrayElement<T>(void *destination, int index,
                                               T value) {
	// @patched at compile time
	throw new NotImplementedException("Patching this method failed");
}

unsafe public static void WriteArrayElementWithStride<T>(void *destination,
                                                         int index,
                                                         int stride,
                                                         T value) {
	// @patched at compile time
...
// The address of the memory where the struct resides in memory
unsafe public static ref T ArrayElementAsRef<T>(void *ptr,
                                                int index) where T
: struct {
	// @patched at compile time
	throw new NotImplementedException("Patching this method failed");
...
public static bool EnumEquals<T>(T lhs, T rhs) where T : struct
, IConvertible {
	throw new NotImplementedException("Patching this method failed");
}
}
