...
namespace UnityEngine.SceneManagement {
  public enum LoadSceneMode { Single = 0, Additive }
  ...
  public partial class SceneManager {
    ...
    LoadScene(string sceneName,
              [ uei.DefaultValue("LoadSceneMode.Single") ] LoadSceneMode mode) {
    ...
    public static Scene LoadScene(int sceneBuildIndex,
                                  LoadSceneParameters parameters) {
    ...
    public static AsyncOperation LoadSceneAsync(int sceneBuildIndex, [
      uei.DefaultValue("LoadSceneMode.Single")
    ] LoadSceneMode mode) {
      var parameters = new LoadSceneParameters(mode);
    ...
    LoadSceneAsync(int sceneBuildIndex, LoadSceneParameters parameters) {
      return LoadSceneAsyncNameIndexInternal(null, sceneBuildIndex, parameters,
                                             false);
    }
    ...
    public static AsyncOperation
    LoadSceneAsync(string sceneName, LoadSceneParameters parameters) {
      return LoadSceneAsyncNameIndexInternal(sceneName, -1, parameters, false);
    }

    [Obsolete(
        "Use SceneManager.UnloadSceneAsync. This function is not safe to use during triggers and under other circumstances. See Scripting reference for more details.")]
    ...
    static public bool UnloadScene(int sceneBuildIndex) {
      bool success;
      UnloadSceneNameIndexInternal("", sceneBuildIndex, true,
                                   UnloadSceneOptions.None, out success);
      return success;
    }
    ...
    static public bool UnloadScene(string sceneName) {
      bool success;
      UnloadSceneNameIndexInternal(sceneName, -1, true, UnloadSceneOptions.None,
                                   out success);
      return success;
    }
    ...
    static public AsyncOperation UnloadSceneAsync(int sceneBuildIndex) {
      bool success;
      return UnloadSceneNameIndexInternal("", sceneBuildIndex, false,
                                          UnloadSceneOptions.None, out success);
    }

    static public AsyncOperation UnloadSceneAsync(string sceneName) {
      bool success;
      return UnloadSceneNameIndexInternal(sceneName, -1, false,
                                          UnloadSceneOptions.None, out success);
    }
    ...
    static public AsyncOperation UnloadSceneAsync(int sceneBuildIndex,
      ...
      bool success;
      return UnloadSceneNameIndexInternal("", sceneBuildIndex, false, options,
                                          out success);
    }
    ...
    static public AsyncOperation UnloadSceneAsync(string sceneName,
                                                  UnloadSceneOptions options) {
      bool success;
      return UnloadSceneNameIndexInternal(sceneName, -1, false, options,
                                          out success);
    }
    ...
    [RequiredByNativeCode]
    private static void Internal_ActiveSceneChanged(Scene previousActiveScene,
