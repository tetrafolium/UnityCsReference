...
internal class ShimManager {
  ...
  private static readonly ScreenShimBase s_DefaultScreenShim =
      new ScreenShimBase();

  private static SystemInfoShimBase s_ActiveSystemInfoShim;
  private static readonly SystemInfoShimBase s_DefaultSystemInfoShim =
      new SystemInfoShimBase();

  private static ApplicationShimBase s_ActiveApplicationShim;
  private static readonly ApplicationShimBase s_DefaultApplicationShim =
      new ApplicationShimBase();

  internal static ScreenShimBase screenShim =>
      s_ActiveScreenShim ?? s_DefaultScreenShim;
  internal static SystemInfoShimBase systemInfoShim =>
      s_ActiveSystemInfoShim ?? s_DefaultSystemInfoShim;
  internal static ApplicationShimBase applicationShim =>
      s_ActiveApplicationShim ?? s_DefaultApplicationShim;
  ...
  internal bool IsScreenShimActive() { return s_ActiveScreenShim != null; }
