...
public partial class Graphics
{
    ...
    public static ColorGamut activeColorGamut {
        get {
            return GetActiveColorGamut();
        }
    }

    [StaticAccessor("GetGfxDevice()", StaticAccessorType.Dot)] extern public static UnityEngine.Rendering.GraphicsTier activeTier {
        get;
        set;
    }
    ...
    public static bool preserveFramebufferAlpha {
        get {
            return GetPreserveFramebufferAlpha();
        }
    }
...
public class HDROutputSettings
{
    ...
    public bool active {
        get {
            return GetActive(m_DisplayIndex);
        }
    }
    public bool available {
        get {
            return GetAvailable(m_DisplayIndex);
        }
    }
    ...
    public ColorGamut displayColorGamut {
        get {
            return GetDisplayColorGamut(m_DisplayIndex);
        }
    }
    public RenderTextureFormat format {
        get {
            return GraphicsFormatUtility.GetRenderTextureFormat(GetGraphicsFormat(m_DisplayIndex));
        }
    }
    public GraphicsFormat graphicsFormat {
        get {
            return GetGraphicsFormat(m_DisplayIndex);
        }
    }
    ...
    public int maxFullFrameToneMapLuminance {
        get {
            return GetMaxFullFrameToneMapLuminance(m_DisplayIndex);
        }
    }
    public int maxToneMapLuminance {
        get {
            return GetMaxToneMapLuminance(m_DisplayIndex);
        }
    }
    public int minToneMapLuminance {
        get {
            return GetMinToneMapLuminance(m_DisplayIndex);
        }
    }
    public bool HDRModeChangeRequested {
        get {
            return GetHDRModeChangeRequested(m_DisplayIndex);
        }
    }
...
{
    [StaticAccessor("GetGfxDevice()", StaticAccessorType.Dot)]
    extern public static WaitForPresentSyncPoint waitForPresentSyncPoint {
        get;
        set;
    }

    [StaticAccessor("GetGfxDevice()", StaticAccessorType.Dot)]
    extern public static GraphicsJobsSyncPoint graphicsJobsSyncPoint {
        get;
        set;
    }
}
