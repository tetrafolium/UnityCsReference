...
public sealed partial class Mesh : Object
{
    ...
    public Vector3[] vertices
    {
        ...
        set {
            SetArrayForChannel(VertexAttribute.Position, value, UnityEngine.Rendering.MeshUpdateFlags.Default);
        }
    }
    public Vector3[] normals
    {
        ...
        set {
            SetArrayForChannel(VertexAttribute.Normal, value, UnityEngine.Rendering.MeshUpdateFlags.Default);
        }
    }
    public Vector4[] tangents
    {
        ...
        set {
            SetArrayForChannel(VertexAttribute.Tangent, value, UnityEngine.Rendering.MeshUpdateFlags.Default);
        }
    }
    public Vector2[] uv
    {
        ...
        set {
            SetArrayForChannel(VertexAttribute.TexCoord0, value, UnityEngine.Rendering.MeshUpdateFlags.Default);
        }
    }
    public Vector2[] uv2
    {
    ...
    {
        get {
            return GetVertexAttributeCountImpl();
        }
    }
    ...
    [uei.ExcludeFromDocs] public void RecalculateBounds() {
        RecalculateBounds(UnityEngine.Rendering.MeshUpdateFlags.Default);
    }
    [uei.ExcludeFromDocs] public void RecalculateNormals() {
        RecalculateNormals(UnityEngine.Rendering.MeshUpdateFlags.Default);
    }
    [uei.ExcludeFromDocs] public void RecalculateTangents() {
