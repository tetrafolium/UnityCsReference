...
public sealed partial class LightProbeProxyVolume : Behaviour {
  public static extern bool isFeatureSupported {
    [NativeName("IsFeatureSupported")] get;
  }

  [NativeName("GlobalAABB")]
  public extern Bounds boundsGlobal {
    get;
  }

  [NativeName("BoundingBoxSizeCustom")]
  public extern Vector3 sizeCustom {
    get;
    set;
  }

  [NativeName("BoundingBoxOriginCustom")]
  public extern Vector3 originCustom {
    get;
    set;
  }
  ...
  public void Update() { SetDirtyFlag(true); }
