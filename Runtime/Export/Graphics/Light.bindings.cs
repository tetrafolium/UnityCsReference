...
extern public LightShadows shadows {
	...
	[FreeFunction("Light_Bindings::SetShadowType", HasExplicitThis = true,
...
extern public float shadowStrength {
	get;
	[FreeFunction("Light_Bindings::SetShadowStrength",
...
extern public UnityEngine.Rendering.LightShadowResolution shadowResolution {
	get;
	[FreeFunction("Light_Bindings::SetShadowResolution", HasExplicitThis = true,
	              ThrowsException = true)] set;
}
...
extern public float[] layerShadowCullDistances {
	[FreeFunction("Light_Bindings::GetLayerShadowCullDistances",
	              HasExplicitThis = true, ThrowsException = false)] get;
	[FreeFunction("Light_Bindings::SetLayerShadowCullDistances",
	              HasExplicitThis = true, ThrowsException = true)] set;
}

extern public float cookieSize {
	get;
	set;
}

// The cookie texture projected by the light.
extern public Texture cookie {
	get;
	set;
}
...
extern public LightRenderMode renderMode {
	get;
	[FreeFunction("Light_Bindings::SetRenderMode", HasExplicitThis = true,
	              ThrowsException = true)] set;
}

// This index was used to denote lights which contribution was baked in
// lightmaps and/or lightprobes.
private int m_BakedIndex;
[System.ComponentModel.EditorBrowsable(
	 System.ComponentModel.EditorBrowsableState.Never)]
[Obsolete(
	 "warning bakedIndex has been removed please use bakingOutput.isBaked instead.",
	 true)]
public int bakedIndex {
	get { return m_BakedIndex; }
	set { m_BakedIndex = value; }
}

// The size of the area light. Editor only.
extern public Vector2 areaSize {
	get;
	set;
}
...
public void AddCommandBuffer(UnityEngine.Rendering.LightEvent evt,
...
public extern void
AddCommandBuffer(UnityEngine.Rendering.LightEvent evt,
                 UnityEngine.Rendering.CommandBuffer buffer,
                 UnityEngine.Rendering.ShadowMapPass shadowPassMask);

public void
AddCommandBufferAsync(UnityEngine.Rendering.LightEvent evt,
                      UnityEngine.Rendering.CommandBuffer buffer,
                      UnityEngine.Rendering.ComputeQueueType queueType) {
	AddCommandBufferAsync(evt, buffer, UnityEngine.Rendering.ShadowMapPass.All,
	                      queueType);
}

[FreeFunction("Light_Bindings::AddCommandBufferAsync",
...
extern public void
RemoveCommandBuffer(UnityEngine.Rendering.LightEvent evt,
                    UnityEngine.Rendering.CommandBuffer buffer);
...
[FreeFunction("Light_Bindings::GetCommandBuffers",
              HasExplicitThis = true)] extern public UnityEngine.Rendering
.CommandBuffer[] GetCommandBuffers(UnityEngine.Rendering.LightEvent evt);
...
[FreeFunction("Light_Bindings::GetLights")] extern public static Light
[] GetLights(LightType type, int layer);
...
[Obsolete("light.shadowObjectSizeBias was removed, use light.shadowBias",
          true)]
...
[Obsolete("light.attenuate was removed; all lights always attenuate now",
          true)]
