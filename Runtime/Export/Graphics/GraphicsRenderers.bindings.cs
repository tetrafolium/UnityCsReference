...
public partial class Renderer : Component
{
    extern public Bounds bounds {
        [FreeFunction(Name = "RendererScripting::GetBounds", HasExplicitThis = true)] get;
    }
...
public partial class Renderer : Component
{
    ...
    [NativeProperty("IsDynamicOccludee")] extern public bool allowOcclusionWhenDynamic {
        get;
        set;
    }


    [NativeProperty("StaticBatchRoot")] extern internal Transform staticBatchRootTransform {
        get;
        set;
    }
    ...
    public int lightmapIndex         {
        get {
            return GetLightmapIndex(LT.StaticLightmap);
        }
        set {
            SetLightmapIndex(value, LT.StaticLightmap);
        }
    }
    public int realtimeLightmapIndex {
        get {
            return GetLightmapIndex(LT.DynamicLightmap);
        }
        set {
            SetLightmapIndex(value, LT.DynamicLightmap);
        }
    }

    public Vector4 lightmapScaleOffset         {
        get {
            return GetLightmapST(LT.StaticLightmap);
        }
        set {
    ...
    public Vector4 realtimeLightmapScaleOffset {
        get {
            return GetLightmapST(LT.DynamicLightmap);
        }
        set {
            SetLightmapST(value, LT.DynamicLightmap);
        }
    }
...
public partial class SkinnedMeshRenderer : Renderer
{
    ...
    [NativeProperty("SkinnedMeshMotionVectors")]  extern public bool skinnedMotionVectors {
        get;
        set;
    }
