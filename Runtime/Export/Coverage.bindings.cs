...
namespace UnityEngine.TestTools {
  ...
  [NativeType(CodegenOptions.Custom, "ManagedCoveredSequencePoint",
              Header = "Runtime/Scripting/ScriptingCoverage.bindings.h")]
    ...
    private string GetTypeDisplayName(Type t) {
      ...
      if (t.IsGenericType && t.GetGenericTypeDefinition() ==
        ...
        return "System.Collections.Generic.List<" +
               GetTypeDisplayName(t.GetGenericArguments()[0]) + ">";
      }
  ...
  public static class Coverage {
    ...
    [FreeFunction("ScriptingCoverageGetCoverageForMethodInfoObject",
                  ThrowsException = true)]
    private extern static CoveredSequencePoint[] GetSequencePointsFor_Internal(
        MethodBase method);

    [FreeFunction("ScriptingCoverageResetForMethodInfoObject",
                  ThrowsException = true)]
    private extern static void ResetFor_Internal(MethodBase method);

    [FreeFunction("ScriptingCoverageGetStatsForMethodInfoObject",
                  ThrowsException = true)]
    private extern static CoveredMethodStats
    GetStatsFor_Internal(MethodBase method);

    public static CoveredSequencePoint[] GetSequencePointsFor(
        MethodBase method) {
      if (method == null)
    ...
    [FreeFunction("ScriptingCoverageGetStatsForAllCoveredMethodsFromScripting",
                  ThrowsException = true)]
    ...
    [FreeFunction("ScriptingCoverageResetAllFromScripting",
                  ThrowsException = true)]
